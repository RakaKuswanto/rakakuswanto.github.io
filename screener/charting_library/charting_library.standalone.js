var TradingView = (function (t) {
  ...
  let o = !1;
  function s() {
    return 'TT v26.001 (internal id 04caa94e @ 2023-08-09T11:48:59.585Z)';
  }
  const r = class {
    constructor(t) {
      var i, s;
      ...
      'dark' === (null !== (s = this._options.theme) && void 0 !== s ? s : 'light').toLowerCase() &&
        ...
        this._options.debug &&
          (o ||
            ((o = !0),
            console.log('Using TT v26.001 (internal id 04caa94e @ 2023-08-09T11:48:59.585Z)'))),
        this._create();
    }
    setDebugMode(t) {
    ...
    _render(t) {
      ...
      const n = (function (t, e) {
        ...
        const o = new URL(`${t || ''}`, location.href).href,
          s = JSON.parse(
            '["bundles/runtime.4a87f70103069307171e.js","bundles/__LANG__.3109.e4839d73e04e81d761aa.js","bundles/3416.c2a31c9e2d1caaa14aea.css","bundles/5098.7313f2bed2f155a5147a.js","bundles/library.8e22a63e4f718c679004.js"]',
          ),
          r = encodeURIComponent(e),
          a =
            null !== (n = i.find(t => t.language === r)) && void 0 !== n
              ? n
              : { iso: 'en', dir: 'ltr' },
