(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1026],
  {
    605011: (e, t, s) => {
      'use strict';
      s.r(t), s.d(t, { activeSymbolListNavigator: () => c });
      var o = s(254773),
        l = s(336349),
        n = s(376202),
        a = s(601373),
      ...
      function* c() {
        const e = (0, o.eventChannel)(e => {
          const t = (t, s) => {
              t.defaultPrevented ||
                (null === t.target.closest('[data-allow-watchlist-navigation]') &&
                  t.target !== document.body) ||
                e(s);
            },
            s = n.createGroup({ desc: 'Active Symbol List Navigation' });
          return (
            s.add({ desc: 'Select previous symbol', hotkey: 38, handler: e => t(e, 'previous') }),
            s.add({
              desc: 'Select previous symbol',
              hotkey: n.Modifiers.Shift + 32,
              handler: e => t(e, 'previous'),
            }),
            s.add({ desc: 'Select next symbol', hotkey: 32, handler: e => t(e, 'next') }),
            s.add({ desc: 'Select next symbol', hotkey: 40, handler: e => t(e, 'next') }),
            () => s.destroy()
          );
        });
        try {
          for (;;) {
            const t = yield (0, l.take)(e),
              s = (0, a.getGlobalActiveSymbolList)(yield (0, l.select)());
            if (null === s) continue;
            const o = s.symbols;
            if (0 === o.length) continue;
            const n = i.linking.symbol.value(),
              c = i.linking.symbolNamesList.value();
            let u = (0, r.getSymbolFromList)(n, o);
            !u &&
              c &&
              c.forEach(e => {
                u = (0, r.getSymbolFromList)(e, o);
              });
            const m = o.indexOf(u || '');
            switch (t) {
              case 'previous': {
                const e = -1 === m ? o.length - 1 : (m + o.length - 1) % o.length;
                if ((0, r.isValidSeparatorItem)(o[e])) {
                  const t = (0, r.findNextAvailableSymbol)(e, o, 'previous');
                  t && i.linking.symbol.setValue(t);
                  break;
                }
                i.linking.symbol.setValue(o[e]);
                break;
              }
              case 'next': {
                const e = -1 === m ? 0 : (m + o.length + 1) % o.length;
                if ((0, r.isValidSeparatorItem)(o[e])) {
                  const t = (0, r.findNextAvailableSymbol)(e, o, 'next');
                  t && i.linking.symbol.setValue(t);
                  break;
                }
                i.linking.symbol.setValue(o[e]);
    ...
    2595: (e, t, s) => {
      ...
      function u(e, t) {
        ...
        const s = [...e].sort(),
          o = [...t].sort();
        return (0, a.default)(s, o);
      }
      function m(e, t) {
        return {
          ...e,
          [t]: { ...e[t], sorting: null, symbolsBeforeSorting: null, sortingListId: null },
        };
      }
      var d = s(706474);
      const y = (0, n.combineReducers)({
        positions: function (e = {}, t) {
          switch (t.type) {
            case r.UPDATE_POSITIONS: {
              const { symbol: s, position: o } = t;
              return (0, d.isEqualRecords)(e[s], o) ? e : { ...e, [s]: o };
            }
            case r.UPDATE_BULK_POSITIONS: {
              ...
              for (const [t, n] of Object.entries(s))
                (0, d.isEqualRecords)(e[t], n) || ((l = !0), (o[t] = n));
              return l ? o : e;
            }
            default:
              return e;
        ...
        widgets: function (e = {}, t) {
          if (
            ...
            for (const o of Object.values(e)) {
              const { listId: l, sortingListId: n, symbolsBeforeSorting: a } = o;
              if (null !== l) {
                if (l === n && i.setup.match(t)) {
                  const e = t.payload.lists.find(e => e.id === n);
                  if (void 0 !== e && null !== a && u(e.symbols, a)) continue;
                }
                s = m(e, o.id);
              }
            }
          ...
          return (function (e = {}, t) {
            ...
            switch (t.type) {
              case r.INIT_WIDGET: {
                const { id: s, tickerType: o, columns: l, options: n } = t;
                return { ...e, [s]: c(s, o, l, n) };
              }
              case r.UPDATE_WIDGET: {
                const { widgetId: o, widget: l } = t,
                  n = { ...e, [o]: { ...e[o], ...l } },
                  a = e[o].tickerType,
                  i = l.tickerType,
                  r =
                    'short_name' ===
                    (null === (s = e[o].sorting) || void 0 === s ? void 0 : s.column);
                return void 0 !== i && a !== i && r ? m(n, o) : n;
              }
              case r.UPDATE_WIDGET_OPTIONS: {
                const { widgetId: s, options: o } = t;
                return { ...e, [s]: { ...e[s], options: { ...e[s].options, ...o } } };
              }
              default:
                return e;
            }
        ...
        activeSymbolList: function (e = null, t) {
          return t.type === r.UPDATE_ACTIVE_LIST ? t.id : e;
        },
        collapsedSeparators: () => ({}),
      });
      function h() {
        ...
        return {
          store: (0, o.configureStore)({
            reducer: y,
            middleware: t => [...t(), ...b(), e, null, null].filter(e => null !== e),
          }),
          runner: e,
        };
      }
    ...
    215078: (e, t, s) => {
      ...
      s.d(t, { createActionTypeFactory: () => o });
    },
    279984: e => {
      e.exports = {
