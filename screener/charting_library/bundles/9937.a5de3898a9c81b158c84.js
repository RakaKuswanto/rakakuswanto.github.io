  ...
  [9937],
  {
    ...
    285089: (e, t, n) => {
      ...
      function a(e) {
        ...
        } else if (!e && o > 0 && 0 == --o && (t.classList.remove('i-no-scroll'), l)) {
          (0, s.setStyle)(n, 'right', '0px');
          let e = 0;
          (e = n
            ? ((a = (0, s.getContentWidth)(n)), i() ? 0 : r() ? 45 : Math.min(Math.max(a, 45), 450))
            : 0),
    ...
    510618: (e, t, n) => {
      ...
      class g extends s.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
              ...
              const b = v.height > w;
              if (b) {
                ((0, o.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'),
                  (v = g.getBoundingClientRect());
              }
              const { width: M, height: S } = v,
                W = 'function' == typeof f ? f(M, S, y, x) : f,
                R =
                  null !==
                    (i =
                      null === (s = null == W ? void 0 : W.indentFromWindow) || void 0 === s
                        ? void 0
                        : s.left) && void 0 !== i
                    ? i
                    : 0,
                E =
                  ...
                  (null !==
                    (u =
                      null === (a = null == W ? void 0 : W.indentFromWindow) || void 0 === a
                        ? void 0
                        : a.right) && void 0 !== u
                    ? u
                    : 0),
                ...
                O =
                  (null !==
                    (d =
                      null === (c = null == W ? void 0 : W.indentFromWindow) || void 0 === c
                        ? void 0
                        : c.top) && void 0 !== d
                    ? d
                    : 0) + C,
                D =
                  ...
                  (null !==
                    (m =
                      null === (p = null == W ? void 0 : W.indentFromWindow) || void 0 === p
                        ? void 0
                        : p.bottom) && void 0 !== m
                    ? m
                    : 0);
              ...
              if (
                (W.forbidCorrectYCoord && T < W.y && ((w -= W.y - T), (T = W.y)),
                t &&
              ...
              const P = null !== (_ = W.overrideHeight) && void 0 !== _ ? _ : b ? w : void 0;
              this.setState(
                {
            ...
            (this._restoreScrollPosition = () => {
              ...
              else (0, o.ensureNotNull)(this._scrollWrapRef).scrollTop = this._scroll;
            }),
            (this._resizeForced = () => {
              this.setState({
        ...
        componentDidMount() {
          ...
          const { customCloseDelegate: e = c.globalCloseDelegate, customRemeasureDelegate: t } =
            this.props;
                ...
                s.createElement(
                  ...
                  s.createElement(
                    'div',
                    {
                      ...
                      style: { overflowY: void 0 !== W ? 'scroll' : 'auto', maxHeight: y },
            ...
            onMouseOver: function (e) {
              if (
                !(
                  ...
                  ((s = e.target),
                  null === (i = n.current) || void 0 === i ? void 0 : i.contains(s))
                )
              )
                return;
              var s, i;
      ...
      class a extends s.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            i.createPortal(s.createElement(u.Provider, { value: this }, this.props.children), e)
          );
        }
        moveToTop() {
