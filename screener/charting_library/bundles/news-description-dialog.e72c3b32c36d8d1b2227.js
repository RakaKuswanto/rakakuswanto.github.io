  ...
  [4664, 959, 6437],
  {
    ...
    778199: (e, t, n) => {
      ...
      function r(e, t, n, r, o) {
        ...
        return (
          o.click && r.addEventListener('click', s, !1),
          o.mouseDown && r.addEventListener('mousedown', s, !1),
          o.touchEnd && r.addEventListener('touchend', s, !1),
          o.touchStart && r.addEventListener('touchstart', s, !1),
          () => {
            r.removeEventListener('click', s, !1),
              r.removeEventListener('mousedown', s, !1),
              r.removeEventListener('touchend', s, !1),
              r.removeEventListener('touchstart', s, !1);
          }
        );
      }
      ...
      class c extends r.PureComponent {
        ...
        render() {
          const {
            ...
            p = o(c, u.dialog, e && u.rounded, t && u.shadowed, n && u.fullscreen, i && u.darker),
          ...
          return r.createElement(
            ...
            r.createElement(s.Slot, { reference: this._handleSlot }),
          );
        }
        _createStyles() {
          const {
          ...
          return { bottom: e, left: t, right: r, top: o, zIndex: s, maxWidth: n, height: i };
        }
      }
    },
    249161: (e, t, n) => {
    ...
    8361: (e, t, n) => {
      'use strict';
      n.d(t, { Portal: () => u, PortalContext: () => c });
      var r = n(50959),
        o = n(500962),
        s = n(189904),
        i = n(801808),
    ...
    695257: (e, t) => {
      ...
      (g.constructor = w), m(g, v.prototype), (g.isPureReactComponent = !0);
      var b = Array.isArray,
      ...
      function k(e, t, r) {
        ...
        if (null != t)
          for (o in (void 0 !== t.ref && (a = t.ref), void 0 !== t.key && (i = '' + t.key), t))
            x.call(t, o) && !C.hasOwnProperty(o) && (s[o] = t[o]);
        ...
        if (e && e.defaultProps) for (o in (u = e.defaultProps)) void 0 === s[o] && (s[o] = u[o]);
        return { $$typeof: n, type: e, key: i, ref: a, props: s, _owner: E.current };
      }
      function S(e) {
      ...
      var N = { current: null },
        R = { transition: null },
        L = { ReactCurrentDispatcher: N, ReactCurrentBatchConfig: R, ReactCurrentOwner: E };
      (t.Children = {
        map: P,
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          return { $$typeof: n, type: e.type, key: s, ref: i, props: o, _owner: a };
        }),
    ...
    863984: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { openLibraryNewsDescriptionDialogImpl: () => R });
      var r = n(50959),
        o = n(500962),
        s = n(509806),
        i = n(497754),
      ...
      class p extends r.PureComponent {
        ...
        render() {
          const { zIndex: e, onClickOutside: t, children: n, className: o } = this.props;
          return r.createElement(
            'div',
            {
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(l.OutsideEvent, { mouseDown: !0, touchStart: !0, handler: t }, e =>
                  r.createElement(
                    'div',
                    { className: d.modal, ref: e },
                    r.createElement(u.Dialog, { ...this.props, className: i(o, d.dialog) }, n),
                  ),
                ),
              ),
            ),
      ...
      p.defaultProps = { width: 500 };
      const h = (0, c.makeOverlapable)(p);
      var f = n(72571),
        m = n(117105),
        y = n(315130),
        v = n(238822),
      ...
      const E = r.forwardRef((e, t) => {
        const { className: n, size: o, ...s } = e,
          a = i(b()['close-button'], b()[`button-${o}`], n);
        return r.createElement(
          'button',
          { ...s, type: 'button', className: a, ref: t },
          r.createElement(f.Icon, { icon: x(o), className: b()['close-icon'], 'aria-hidden': !0 }),
        );
      });
      var C = n(249161),
        k = n(586240),
      ...
      function D(e) {
        const {
          ...
          v = s.t(null, { context: 'input' }, n(309633));
        return r.createElement(a.MatchMedia, { rule: k['media-phone-vertical'] }, e => {
          const n = 0 === y || e;
          return r.createElement(
            h,
            {
              width: O(c, n),
              className: i(S.dialog, t),
              isOpened: u,
              onClickOutside: d ? l : void 0,
              fullscreen: n,
              rounded: !n,
            },
            f &&
            ...
            l && p && r.createElement(C.KeyboardDocumentListener, { keyCode: 27, handler: l }),
            'function' == typeof o ? o(n) : o,
            m && r.createElement('div', { className: S.actions }, m(n)),
          );
        });
      }
      function O(e, t) {
      ...
      const I = n(330233);
      function P(e) {
        const { title: t, content: n, theme: o = I, header: s } = e;
        return r.createElement(
          'article',
          { className: o.container },
          t && r.createElement('h2', { className: o.title }, t),
          s,
          r.createElement('div', { className: o.body }, n),
        );
      }
      var M = n(937301);
      function N(e) {
      ...
      function R(e) {
        ...
        o.render(
          r.createElement(
            D,
            { isOpened: !0, onCloseIntent: () => o.unmountComponentAtNode(t), maxWidth: 800 },
            r.createElement(N, { ...e }),
          ),
          t,
        );
