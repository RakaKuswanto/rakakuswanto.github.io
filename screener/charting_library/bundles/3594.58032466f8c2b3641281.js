(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3594, 959, 6437],
  {
        ...
        (n = function (e) {
          ...
          (e.disableBodyScroll = function (e, r) {
            if (o) {
                ...
                (u = [].concat(t(u), [d])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ((r = e),
                      (u = (n = t).targetTouches[0].clientY - i),
                      !s(n.target) &&
                        ((r && 0 === r.scrollTop && 0 < u) ||
                  ...
                  c ||
                    (document.addEventListener('touchmove', f, n ? { passive: !1 } : void 0),
                    (c = !0));
              }
            } else {
              (m = r),
              ...
              var v = { targetElement: e, options: r || {} };
              u = [].concat(t(u), [v]);
            }
            var m;
          }),
            (e.clearAllBodyScrollLocks = function () {
              o
                ? (u.forEach(function (e) {
                  ...
                  c &&
                    (document.removeEventListener('touchmove', f, n ? { passive: !1 } : void 0),
                    (c = !1)),
                  (u = []),
                  (i = -1))
                : (d(), (u = []));
    ...
    718736: (e, t, n) => {
      'use strict';
      n.d(t, { useFunctionalRefObject: () => u });
      var r = n(50959),
        o = n(855393);
      function u(e) {
        const t = (0, r.useMemo)(
          ...
          n = (0, r.useRef)(null),
          u = t => {
            if (null === t) return c(n.current, t), void (n.current = null);
            n.current !== e && ((n.current = e), c(n.current, t));
          },
          i = (0, r.useRef)(u);
        return (
          (i.current = u),
    ...
    865266: (e, t, n) => {
      'use strict';
      n.d(t, { useRovingTabindexElement: () => c });
      var r = n(50959),
        o = n(718736),
        u = n(892932);
      function c(e, t = []) {
        const [n, c] = (0, r.useState)(!1),
          i = (0, o.useFunctionalRefObject)(e);
        return (
          (0, r.useLayoutEffect)(() => {
          ...
          [i, u.PLATFORM_ACCESSIBILITY_ENABLED ? (n ? 0 : -1) : void 0]
        );
      }
    },
    695257: (e, t) => {
      ...
      (g.constructor = h), p(g, E.prototype), (g.isPureReactComponent = !0);
      var _ = Array.isArray,
      ...
      function T(e, t, r) {
        var o,
          ...
          i = null;
        if (null != t)
          for (o in (void 0 !== t.ref && (i = t.ref), void 0 !== t.key && (c = '' + t.key), t))
            S.call(t, o) && !L.hasOwnProperty(o) && (u[o] = t[o]);
        ...
        return { $$typeof: n, type: e, key: c, ref: i, props: u, _owner: w.current };
      }
      function I(e) {
      ...
      var B = { current: null },
        x = { transition: null },
        O = { ReactCurrentDispatcher: B, ReactCurrentBatchConfig: x, ReactCurrentOwner: w };
      (t.Children = {
        map: k,
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          if (null != t) {
            if (
              (void 0 !== t.ref && ((c = t.ref), (i = w.current)),
          ...
          return { $$typeof: n, type: e.type, key: u, ref: c, props: o, _owner: i };
        }),
    ...
    179807: (e, t, n) => {
      ...
      function a(e) {
        ...
        const i = d(e.currentTarget).sort(r.navigationOrderComparator);
        if (0 === i.length) return;
        const a = document.activeElement.closest('[data-role="menuitem"]');
        ...
        switch (t) {
          case 37:
            if (!m.length) return;
            e.preventDefault(), E(0 === p ? i[l] : y ? s(m, p, -1) : m[m.length - 1]);
            break;
          case 39:
            if (!m.length) return;
            e.preventDefault(), p === m.length - 1 ? E(i[l]) : E(y ? s(m, p, 1) : m[0]);
            break;
          case 38: {
            e.preventDefault();
            const t = s(i, l, -1);
    ...
    395907: (e, t, n) => {
      ...
      const i = r.forwardRef(function (e, t) {
        const { className: n, id: i, ...a } = e;
        return r.createElement(u.ToolWidgetButton, {
          'data-name': i,
          ...a,
          ref: t,
          className: o(n, c.button),
        });
      });
    },
    332913: (e, t, n) => {
      'use strict';
      n.d(t, { ToolbarIconButton: () => i });
      var r = n(50959),
        o = n(865266),
        u = n(892932),
        c = n(395907);
      const i = (0, r.forwardRef)(function (e, t) {
        const { tooltip: n, ...i } = e,
          [a, l] = (0, o.useRovingTabindexElement)(t);
        return r.createElement(c.ToolWidgetIconButton, {
    ...
    53431: (e, t, n) => {
      ...
      const s = (0, r.forwardRef)(function (e, t) {
        const { tooltip: n, menuReference: s = null, ...f } = e,
          [d, v] = (0, c.useRovingTabindexElement)(null),
          m = (0, o.useFunctionalRefObject)(s);
        return (
          (0, a.useMouseClickAutoBlur)(m),
