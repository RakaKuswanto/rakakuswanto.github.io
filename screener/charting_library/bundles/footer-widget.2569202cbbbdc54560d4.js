  ...
  [7707],
  {
    ...
    622614: (e, t, i) => {
      ...
      const d = (0, n.forwardRef)(function (e, t) {
        const { onKeyDown: i, orientation: d, ...u } = e,
          m = r.PLATFORM_ACCESSIBILITY_ENABLED ? { role: 'toolbar', 'aria-orientation': d } : {},
        ...
        return (
          (0, n.useLayoutEffect)(() => {
            ...
            const e = (0, a.ensureNotNull)(p.current),
              t = () => {
                const t = (0, r.queryTabbableElements)(e).sort(r.navigationOrderComparator);
                if (0 === t.length) {
                  const [t] = (0, r.queryFocusableElements)(e).sort(r.navigationOrderComparator);
                  if (void 0 === t) return;
          ...
          (0, h.useMouseClickAutoBlur)(p),
          n.createElement('div', {
            ...u,
            ...m,
            ref: p,
            onKeyDown: (0, s.createSafeMulticastEventHandler)(function (e) {
              if (!r.PLATFORM_ACCESSIBILITY_ENABLED) return;
              ...
              const i = e.currentTarget,
                n = (0, r.queryFocusableElements)(i).sort(r.navigationOrderComparator);
              if (0 === n.length) return;
              const a = n.indexOf(document.activeElement);
              if (-1 === a) return;
              e.preventDefault();
              const s = () => {
                  const e = (a + n.length - 1) % n.length;
                  (0, l.becomeSecondaryElement)(n[a]), (0, l.becomeMainElement)(n[e]), n[e].focus();
                },
                c = () => {
                  const e = (a + n.length + 1) % n.length;
                  (0, l.becomeSecondaryElement)(n[a]), (0, l.becomeMainElement)(n[e]), n[e].focus();
    ...
    17212: (e, t, i) => {
      ...
      var n = i(50959),
        ...
        l = i(311138);
      function c(e) {
        const { tooltip: t, children: i, className: a, ...c } = e,
          [h, d] = (0, o.useRovingTabindexElement)(null),
          u = r.PLATFORM_ACCESSIBILITY_ENABLED ? 'button' : 'div';
        return n.createElement(
          u,
          {
            'aria-label': r.PLATFORM_ACCESSIBILITY_ENABLED ? t : void 0,
            ...c,
            ref: h,
            tabIndex: d,
            type: r.PLATFORM_ACCESSIBILITY_ENABLED ? 'button' : void 0,
            'data-tooltip': t,
            className: s()(l.tab, r.PLATFORM_ACCESSIBILITY_ENABLED && l.accessible, a),
          },
          i,
        );
      }
    ...
    754738: (e, t, i) => {
      'use strict';
      i.r(t), i.d(t, { FooterWidgetRenderer: () => S });
      var n = i(50959),
        a = i(500962),
        s = i(497754),
        o = i(53431),
      ...
      class m extends n.PureComponent {
        constructor() {
          super(...arguments),
            (this._ref = e => {
              const { name: t, reference: i } = this.props;
              i && i(t, e);
            }),
            (this._onToggle = () => {
              this._toggleWidget();
        ...
        render() {
          const {
              ...
              isActive: t,
              title: i,
              customTitleComponent: a,
              buttonOpenTooltip: o,
              buttonCloseTooltip: r,
              dataName: l,
              className: c,
            } = this.props,
            h = t ? r : o,
          ...
          return n.createElement(
            'div',
            { className: s(u.tab, m && u.customTab, t && u.active, c), ref: this._ref },
            m
              ? n.createElement(m, {
              ...
              : n.createElement(
                  ...
                  {
                    onClick: this._onToggle,
                    className: s(u.title, h && 'apply-common-tooltip'),
                    'data-name': this.props.dataName,
                    'data-active': t,
                    'aria-pressed': t,
                    tooltip: h,
                  },
                  n.createElement('span', { className: u.titleText }, i || e),
                ),
          );
        }
        _toggleWidget(e) {
          const { name: t, onToggle: i, _gaEvent: n } = this.props;
          n && (0, h.trackEvent)('Platform widgets', n), i(t, e);
        }
      }
      var p = i(844996);
      class v extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._refFakeTabs = (e, t) => {
              var i;
              (this._fakeTabs[e] = t),
                t && (null === (i = this._resizeObserver) || void 0 === i || i.observe(t));
            }),
            (this._handleMeasure = () => {
            ...
            (this._resize = e => {
              ...
              const t = (0, c.ensureNotNull)(this._fakeMenuButton).offsetWidth,
                { activeWidgetName: i } = this.props;
              let n = [],
                a = [],
                s = 0;
              'string' == typeof i &&
                ((a = [i]), (s = (0, c.ensureNotNull)(this._fakeTabs[i]).offsetWidth));
              const o = this.props.widgets.map(e => e.name),
                r = o.filter(e => e !== i);
              let l = !1;
              r.forEach(i => {
                if (!this._fakeTabs[i]) return;
                const r = (0, c.ensureNotNull)(this._fakeTabs[i]).offsetWidth,
                  h = o.length - a.length == 1 ? e : e - t;
                !l && s + r < h ? ((s += r), a.push(i)) : ((l = !0), n.push(i));
              }),
                0 === a.length && ((a = [o[0]]), (n = n.filter(e => e !== o[0]))),
                (a = o.filter(e => a.includes(e))),
                this.setState({ visibleTabs: a, hiddenTabs: n });
            }),
            (this._onToggle = (e, t) => {
              void 0 !== e &&
                (this._trackButtonClick(e),
                (0, a.flushSync)(() => this.props.setActiveWidget(e, t)),
                this._resize(this.props.width));
            }),
        ...
        componentDidUpdate(e) {
          const { widgets: t, activeWidgetName: i, width: n } = this.props;
          (e.widgets === t && e.activeWidgetName === i && e.width === n) || this._resize(n);
        }
        ...
        render() {
          const { visibleTabs: e } = this.state,
            ...
            i = t.filter(t => e.includes(t.name));
          return n.createElement(
            'div',
            { className: u.tabbar },
            n.createElement('div', { className: u.tabs }, this._renderTabs(i, !1)),
            n.createElement('div', { className: s(u.tabs, u.fakeTabs) }, this._renderTabs(t, !0)),
          );
        }
        _renderTabs(e, t) {
          const { activeWidgetName: i, widgets: a } = this.props,
            { hiddenTabs: c, isMenuOpened: h } = this.state,
            d = e.map(e =>
              n.createElement(m, {
                ...e,
                key: e.name,
                ...
                className: 'screener' === e.name && u.screenerTab,
              }),
            );
          return (
            (t || c.length > 0) &&
              d.push(
                n.createElement(
                  ...
                  {
                    key: 'menu-button',
                    className: u.menuButtonWrap,
                    ref: t ? this._refFakeMenuButton : void 0,
                  },
                  n.createElement(
                    o.ToolbarMenuButton,
                    {
                      className: s(u.menuButton, h && u.active),
                      onClick: this._handleMenuClick,
                      content: n.createElement(l.Icon, { icon: p }),
                      arrow: !1,
                    },
                    a
      ...
      var g = i(199663),
        b = i(265577);
      const _ = parseInt(b['css-value-footer-widget-horizontal-margin']);
      var f = i(509806),
        M = i(332913),
        z = i(544460),
        w = i(19182),
        ...
        E = i(587257),
        T = i(163787);
      const N = f.t(null, void 0, i(368144)),
        C = f.t(null, void 0, i(670151)),
        B = f.t(null, void 0, i(402949)),
        x = f.t(null, void 0, i(298205));
      class W extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(
            n.Fragment,
            null,
            n.createElement(M.ToolbarIconButton, {
              className: s(T.button, T.firstButton),
              tooltip: a ? N : C,
              onClick: e,
              'data-name': 'toggle-visibility-button',
              'data-active': a,
              icon: n.createElement(l.Icon, { icon: a ? w : z }),
            }),
            n.createElement(M.ToolbarIconButton, {
              ...
              'data-active': o,
              icon: n.createElement(l.Icon, { icon: o ? E : k }),
            }),
          );
        }
      }
      ...
      class I extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleActiveWidgetName = e => {
              ...
              this.setState({ activeWidgetName: e }, () => this._resize(t.width.value()));
            }),
            (this._setActiveWidget = (e, t, i) => {
              this.props.bottomWidgetBar.toggleWidget(e, t, i);
            }),
            (this._resize = e => {
              e && ((e -= _ + _), this.setState({ width: e }));
            });
          const { bottomWidgetBar: t, resizerBridge: i } = this.props;
          this.state = {
        ...
        componentDidMount() {
          ...
          e.mode().subscribe(this._handleMode),
            ...
            e.activeWidget().subscribe(this._handleActiveWidgetName, { callWithLast: !0 }),
        ...
        render() {
          const { bottomWidgetBar: e } = this.props,
            { isOverlap: t, activeWidgetName: i, width: a } = this.state,
            o = this._buttons ? this._buttons.offsetWidth : 0,
            r = e.enabledWidgets(),
            l = 'minimized' !== e.mode().value() && i;
          return n.createElement(
            A.Toolbar,
            {
              id: 'footer-chart-panel',
              className: s(T.footerPanel, t && T.overlap),
              onContextMenu: g.preventDefault,
            },
            n.createElement(v, {
              widgets: r,
              activeWidgetName: l,
              setActiveWidget: this._setActiveWidget,
              settingsActiveWidget: i,
              close: e.close,
              width: a - o,
            }),
            n.createElement(
              'div',
              { className: T.buttons, ref: this._refButtons },
              n.createElement(W, {
      ...
      class S {
        constructor(e, t, i) {
          (this._component = null),
            ...
            (this._container = e);
          const s = n.createElement(I, {
            resizerBridge: t,
            bottomWidgetBar: i,
            ref: this._handleRef,
          });
          a.render(s, this._container);
        }
        getComponent() {
