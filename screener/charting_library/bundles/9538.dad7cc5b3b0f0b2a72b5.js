(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9538],
  {
    ...
    166613: e => {
      e.exports = { container: 'container-uzBKh7Dy', top: 'top-uzBKh7Dy' };
    },
    123059: e => {
      e.exports = {
        wrap: 'wrap-Un5MtNUE',
    ...
    782536: e => {
      e.exports = { list: 'list-oxiBYNWm', item: 'item-oxiBYNWm' };
    },
    782211: e => {
      ...
      function c(e) {
        const {
          ...
          b = (0, r.useMemo)(() => {
            const e = [];
            for (let t = 0; t < u; t++)
              e.push({ isGrouped: !0, cellState: a(t, d, m), disablePositionAdjustment: c });
            return e;
          }, [u, d, m, c]),
          k = r.Children.map(t, (e, t) =>
            r.createElement(n.ControlGroupContext.Provider, { value: b[t] }, e),
          ),
          v = {
            '--ui-lib-control-group-cols': d.toString(10),
            '--ui-lib-control-group-rows': m.toString(10),
          };
        return r.createElement('span', { className: o(l().group, p), style: v, ...h }, k);
      }
    },
    718736: (e, t, s) => {
      'use strict';
      s.d(t, { useFunctionalRefObject: () => n });
      var r = s(50959),
        o = s(855393);
      function n(e) {
        const t = (0, r.useMemo)(
          ...
          s = (0, r.useRef)(null),
          n = t => {
            if (null === t) return i(s.current, t), void (s.current = null);
            s.current !== e && ((s.current = e), i(s.current, t));
          },
          l = (0, r.useRef)(n);
        return (
          (l.current = n),
    ...
    855393: (e, t, s) => {
      'use strict';
      s.d(t, { useIsomorphicLayoutEffect: () => o });
      var r = s(50959);
      function o(e, t) {
    ...
    664332: (e, t, s) => {
      'use strict';
      s.d(t, { useResizeObserver: () => l });
      var r = s(50959),
        o = s(159255),
        n = s(855393),
        i = s(718736);
      function l(e, t = []) {
        const { callback: s, ref: l = null } = (function (e) {
            return 'function' == typeof e ? { callback: e } : e;
          })(e),
          a = (0, r.useRef)(null),
          c = (0, r.useRef)(s);
        c.current = s;
        const p = (0, i.useFunctionalRefObject)(l),
          h = (0, r.useCallback)(
            e => {
              p(e),
      ...
      class c extends o.PureComponent {
        ...
        render() {
          ...
          return o.createElement(
            'span',
            { className: n(a().loader, r && a().static, this._getStateClass(), e) },
    ...
    788865: (e, t, s) => {
      ...
      function d(e) {
        const {
          ...
          v = (0, i.useObservable)(s.value$, s.getValue());
        return r.createElement(u.NumberInput, {
          inputMode: t,
          intent: h,
          highlight: d,
          highlightRemoveRoundBorder: m,
      ...
      function k(e) {
        ...
        return r.createElement(
          'span',
          {
            className: o(b.clickableText, t.clickableTextColor, e.className),
            ref: e.reference,
            tabIndex: e.tabIndex,
            onClick: e.onClick,
      ...
      class w extends r.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._onClickOutside = e => {
              (this._slTypeDropdown && this._slTypeDropdown.contains(e.target)) ||
                this.setState({ isSLTypeOpened: !1 });
            }),
        ...
        render() {
          const {
            ...
            i = g[this.props.type],
            l = n && this.context.supportTrailingStop;
          let h;
          h =
            l && !t
              ? r.createElement(
                  ...
                  e =>
                    r.createElement(
                      'span',
                      { className: C.checkboxLabelWrapper, ref: e },
                      r.createElement(k, {
                        ...
                        theme: C.clickableTextColor,
                      }),
                      r.createElement(v.DropdownList, {
                        root: 'document',
              ...
              : r.createElement('span', { className: C.checkboxLabel }, i);
          const u = r.createElement(
              'div',
              {
                className: o(l ? C.slCheckboxWrapper : C.checkboxWrapper, 'apply-common-tooltip'),
                title: l ? y : i,
              },
            ...
            w = this.props.error && this.props.error.msg,
            x = this.props.isCryptoBracket
          ...
          return r.createElement(m.SettingsContext.Consumer, null, t =>
            r.createElement(
              'div',
              { className: o(C.bracketControl, n && C.rightBlock) },
              u,
              r.createElement(
                c.ControlGroup,
                { cols: 1, className: C.inputGroup },
        ...
        _mapSLTypesNames() {
          return this.props.stopLossTypes.map(e => ({
            index: e,
            elem: r.createElement('span', null, g[e]),
          }));
        }
        ...
        _generateClassName(e) {
          return o(
            C.control,
            !this.props.enabled && C.wait,
            0 === e && C.bracketInPips,
            1 === e && C.bracketInPrice,
            2 === e && C.bracketInCurrency,
            3 === e && C.bracketInPercent,
          );
        }
      ...
      function x(e) {
        const { model: t, isCryptoBracket: s, showRiskControls: o, orderTicketFocus: n } = e,
          {
            enabled$: c,
            error$: p,
            focusedControl$: h,
            ...
            riskInCurrency: k,
            riskInPercent: v,
            roundToStopLimitPriceStepRequired: f,
            isValuesInitialized: C,
            controlState: g,
            onControlFocused: y,
            getFocusedControl: x,
            getEnabled: E,
          ...
          M = (0, i.useObservable)(h, x()),
          B = (0, i.useObservable)(u, _()),
          I = (0, i.useObservable)(c, E()),
          D = (0, i.useObservable)(p, T()),
          R = (0, r.useRef)(null),
          O = (0, r.useRef)(null);
        return (
          (0, r.useEffect)(() => {
            if (l.mobiletouch || !I) return;
            const e = e => {
              null !== e && C && (e.focus(), e.setSelectionRange(e.value.length, e.value.length));
            };
            ((B === a.BracketType.TakeProfit && 3 === n) ||
              (B === a.BracketType.StopLoss && 4 === n)) &&
              e(O.current),
              B === a.BracketType.TrailingStop && 4 === n && e(R.current);
          }, [C]),
          r.createElement(w, {
            type: B,
            enabled: I,
            ...
            handlePipsInputRef: e => (R.current = e),
            handlePriceInputRef: e => (O.current = e),
            setBracketType: L,
            isPipsControlHidden: f,
            controlState: g,
            isCryptoBracket: s,
            showRiskControls: o,
      ...
      class E extends r.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this.state = { mode: e.model.mode.value() }),
        ...
        render() {
          const e = this.props.model,
            t =
              (e.takeProfitModel && e.takeProfitModel.roundToStopLimitPriceStepRequired) ||
              (e.stopLossModel && e.stopLossModel.roundToStopLimitPriceStepRequired),
            i = 'supportCryptoBrackets' in e && !0 === e.supportCryptoBrackets,
            l = i ? 'showCryptoBracketsInCurrency' : 'showBracketsInCurrency',
            a = i ? 'showCryptoBracketsInPercent' : 'showBracketsInPercent',
            c = e.showRiskControls,
            p = e.rewardRisk.value();
          return r.createElement(m.SettingsContext.Consumer, null, h =>
            r.createElement(
              r.Fragment,
              null,
              e.takeProfitModel &&
              ...
              e.takeProfitModel &&
                ...
                r.createElement(
                  ...
                  r.createElement(
                    'div',
                    {
                      className: o(C.rewardRisk, p && 'apply-common-tooltip'),
                      title: p ? n.t(null, void 0, s(214078)) : void 0,
                    },
                    r.createElement('span', { className: C.rewardRiskText }, p),
                  ),
                  !t &&
                    r.createElement(
                      'span',
                  ...
                  r.createElement('span', null, n.t(null, void 0, s(25684))),
                  c &&
                    h.value[l] &&
                    r.createElement(
                      'span',
                  ...
                  c &&
                    ...
                    r.createElement(
                      'span',
                      { className: o('apply-common-tooltip'), title: n.t(null, void 0, s(852997)) },
                      '%',
                    ),
                ),
              e.stopLossModel &&
    ...
    40176: (e, t, s) => {
      ...
      var r = s(50959),
        ...
        a = s(114891);
      function c(e) {
        const t = r.createElement('span', { className: a.checkboxLabel }, e.checkboxTitle);
        return r.createElement(
          'div',
          null,
          e.title && e.title.length > 0 && r.createElement('div', { className: a.title }, e.title),
          r.createElement(i.InputWithError, {
        ...
        constructor(e) {
          super(e),
            ...
            (this.state = {
              ...
              errorMessage: this.props.errorMessage.value(),
            });
        }
        componentDidMount() {
          this.props.text.subscribe(this._updateText),
            this.props.checked.subscribe(this._updateCheckboxValue),
            this.props.status.subscribe(this._updateStatus),
            this.props.errorMessage.subscribe(this._updateErrorMessage);
        }
        componentDidUpdate(e) {
          e.text !== this.props.text &&
            (e.text.unsubscribe(this._updateText), this.props.text.subscribe(this._updateText)),
            e.checked !== this.props.checked &&
              (e.checked.unsubscribe(this._updateCheckboxValue),
              this.props.checked.subscribe(this._updateCheckboxValue)),
            e.errorMessage !== this.props.errorMessage &&
              (e.errorMessage.unsubscribe(this._updateErrorMessage),
              this.props.errorMessage.subscribe(this._updateErrorMessage));
        }
        componentWillUnmount() {
          this.props.text.unsubscribe(this._updateText),
            this.props.checked.unsubscribe(this._updateCheckboxValue),
            this.props.status.unsubscribe(this._updateStatus),
            this.props.errorMessage.unsubscribe(this._updateErrorMessage);
        }
        render() {
          return r.createElement(
            'div',
            { className: a.customFieldWithCheckboxContainer },
            r.createElement(c, {
              className: this.state.status === n.OrderPanelStatus.Wait && a.wait,
      ...
      var h = s(587374),
        ...
        d = s(223302);
      function m(e) {
        const { customFieldModels: t, status: s, alwaysShowAttachedErrors: i, onClose: l } = e,
          a = (0, o.useWatchedValueReadonly)({ watchedValue: s }),
          c = (0, o.useWatchedValueReadonly)({ watchedValue: i });
        return r.createElement(
          r.Fragment,
          null,
          t.map(e =>
            r.createElement(
              'div',
              { key: e.id, className: d.customField },
              ...
              'Checkbox' === e.type &&
                r.createElement(u.CheckboxCustomField, {
                  title: e.title,
                  help: e.help,
                  checked: e.checked,
                  disabled: e.disabled,
              ...
              'ComboBox' === e.type &&
                r.createElement(h.CustomComboboxContainer, {
                  title: e.title,
                  items: e.items,
                  ...
                  forceUserToSelectValue: a === n.OrderPanelStatus.Active,
    ...
    274837: (e, t, s) => {
      ...
      function a(e) {
        ...
        (0, r.useEffect)(() => {
          ...
          const r = window.matchMedia(l.DialogBreakpoints.TabletSmall),
            c = window.matchMedia('(orientation: portrait)'),
            p = () => {
              t ? null == s || s(r.matches) : null == a || a();
            };
          return (
            p(),
            (0, o.mediaQueryAddEventListener)(c, p),
            () => {
              n.unsubscribe(i.CLOSE_POPUPS_AND_DIALOGS_COMMAND, e, null),
                (0, o.mediaQueryRemoveEventListener)(c, p);
            }
          );
        }, [t, a, s]);
      }
      ...
      function i(e) {
        const t = e.rows.map((t, s) =>
          r.createElement(
            ...
            {
              key: s,
              className: o(n.row, e.disabled && n.disabled),
              'data-name': 'info-table-row',
            },
            r.createElement(
              'div',
              {
                className: o(n.cell, n.cellTitle, t.listMarker && n.marker),
        ...
        return r.createElement(
          'div',
          { className: n.wrapper },
          e.header && r.createElement('div', { className: n.header }, e.header),
          t,
        );
      }
      function l(e) {
    ...
    447538: (e, t, s) => {
      ...
      function p(e) {
        const { model: t, reference: s, buttonModel: p } = e,
          h = t.hasOwnProperty('sideModel') && 'sideModel' in t ? t.sideModel.value$ : o.EMPTY,
          [u] = (e => {
            const [t, s] = (0, r.useState)(e.value());
            return (
              (0, r.useLayoutEffect)(() => {
                const t = e => s(e);
          ...
          [d] = (0, l.useWatchedValue)(t.loading),
          m = (0, a.useObservable)(p.value$, p.getValue()),
          b = 1 === (0, a.useObservable)(h, t.side()) ? 'brand' : 'red';
        return d
          ? r.createElement(
              i.SquareButton,
              {
    ...
    930894: (e, t, s) => {
      ...
      function a(e) {
        const t = e.hideIcon
          ? null
          : r.createElement(l.Icon, { className: n.close, icon: i, onClick: e.onClose });
        return r.createElement(
          'div',
          { className: o(n.header, e.className), 'data-dragg-area': !0, ref: e.reference },
          e.children,
          t,
        );
      }
      ...
      function p(e) {
        return r.createElement(
          'div',
          { className: o(c.body, e.className), ref: e.reference },
          e.children,
        );
      }
      s(908783), s(523455);
    ...
    101614: (e, t, s) => {
      ...
      class h extends r.PureComponent {
        ...
        render() {
          const { theme: e = a } = this.props,
            t = n(e.list, { [this.props.className]: Boolean(this.props.className) }),
          ...
          return r.createElement(
            ...
            e =>
              r.createElement(
                'div',
                { className: t, style: o, ref: (0, l.mergeRefs)([this.props.reference, e]) },
        ...
        componentDidMount() {
          if (
            ((this._el = i.findDOMNode(this)),
            void 0 !== this.props.selected && this.props.shouldScrollIfNotVisible)
          ) {
        ...
        _wrapItems(e = [], t) {
          this._items = [];
          const { itemWrap: s = c, theme: o = a } = this.props,
            i = s;
          return e.map((e, s) => {
            const l = n(o.item, {
        ...
        _scrollIfNotVisible(e) {
          const t = this._el.scrollTop,
            ...
            r = e.elem.offsetTop,
            o = r + e.elem.clientHeight;
          r <= t ? e.elem.scrollIntoView(!0) : o >= s && e.elem.scrollIntoView(!1);
        }
      }
      h.defaultProps = { shouldScrollIfNotVisible: !0 };
      var u = s(841037),
        d = s(874485);
      class m extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            'div',
            { className: this.props.className, style: e, ref: this.props.reference },
            this.props.children,
          );
        }
      }
      m.displayName = 'Dropdown Container';
      const b = (0, d.makeOverlapable)((0, u.makeAttachable)(m));
      var k = s(166613),
        v = s(650151);
      class f extends r.PureComponent {
        ...
        componentWillUnmount() {
          this.props.onDropdownWheelNoPassive &&
            this._removePassiveListenerOnWheel(this.props.onDropdownWheelNoPassive);
        }
        render() {
          const { shadow: e = 'bottom', children: t, className: s } = this.props,
            o = n(k.container, k[e], s),
            i = { maxHeight: this.props.maxHeight };
          return r.createElement(
            'div',
            {
        ...
        _addPassiveListenerOnWheel(e) {
          (0, v.ensureNotNull)(this._container).addEventListener('wheel', e, { passive: !1 });
        }
        _removePassiveListenerOnWheel(e) {
          (0, v.ensureNotNull)(this._container).removeEventListener('wheel', e);
        }
      }
      var C = s(579184);
      const g =
        ((y = h),
        ((w = class extends r.PureComponent {
          constructor(e) {
          ...
          render() {
            return r.createElement(y, { ...this.props }, this.props.children);
          }
          _next() {
        ...
        w);
      var y, w;
      const x = (0, C.makeAnchorable)(b),
        E = { top: 'top', bottom: 'bottom', topRight: 'top' };
      class _ extends r.PureComponent {
        render() {
          const { anchor: e = 'bottom', fontSize: t = 14, root: s = 'parent' } = this.props,
            i = n(o.list, o[e]),
            { dropdownClassName: l, height: a, ...c } = this.props;
          return r.createElement(
            x,
            { ...c, className: l, root: s },
            r.createElement(
              f,
              {
              ...
              r.createElement(g, {
                ...
                itemsClassName: this.props.itemsClassName || o.item,
                selectedClassName: this.props.selectedClassName || o.selected,
                fontSize: t,
