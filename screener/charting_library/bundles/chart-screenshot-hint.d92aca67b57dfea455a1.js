  ...
  [92, 959, 6437],
  {
    ...
    389986: (e, t, n) => {
      ...
      const f = r.forwardRef((e, t) =>
        r.createElement(o.NavButton, { ...e, ref: t, icon: l(e.size) }),
      );
    },
    270762: (e, t, n) => {
      'use strict';
      ...
      function u(e) {
        ...
        return r.createElement(
          ...
          r.createElement(i.Icon, { icon: n, className: a.icon, 'aria-hidden': !0 }),
    ...
    918460: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        f = n(348535),
        d = n.n(f);
      const p = { danger: u, warning: u, success: l, default: c };
      function h(e) {
        const {
          informerIntent: t,
          content: n,
        ...
        return r.createElement(
          'div',
          {
            className: o(d().container, d()[`container-${t}`], y && d()[`light-container-${t}`], u),
              ...
              r.createElement(
                ...
                l &&
                  r.createElement(i.Icon, {
                    className: o(d().icon, y && d()['light-icon']),
                    icon: null != h ? h : p[t],
                  }),
                r.createElement(
                  'div',
                  { className: o(d()['text-wrap'], y && d()['light-text-wrap']) },
                  c &&
                    r.createElement(
                      'span',
                      {
          ...
          f &&
            r.createElement(a.CloseButton, {
              'aria-label': w,
              onClick: m,
              className: o(y && d()['light-close-button'], d()['close-button']),
              size: y ? 'xxsmall' : 'xsmall',
              preservePaddings: !y,
            }),
        );
      }
    ...
    548728: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { ChartScreenshotHintRenderer: () => l });
      var r = n(50959),
        o = n(500962),
        i = n(12481),
        a = n(497754),
      ...
      var u = n(544777);
      function c(e) {
        const { text: t, style: n, hideTimeout: o, informerIntent: i = 'success' } = e,
          c = (function (e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(s.Informer, {
              content: t,
              informerIntent: i,
              className: a(u.notice, c && u.noticeShowed),
            }),
          ),
        );
      }
      class l {
        ...
        show(e) {
          this._wrap &&
            ...
            o.render(
              r.createElement(c, { text: e, style: this._bottomPadding ? { bottom: 70 } : void 0 }),
              this._wrap,
            ),
            this._debouncedHide());
        }
        hide() {
          this._wrap &&
            ((this._showed = !1), o.unmountComponentAtNode(this._wrap), this._wrap.remove());
        }
        destroy() {
    ...
    695257: (e, t) => {
      ...
      var N = { current: null },
        H = { transition: null },
        $ = { ReactCurrentDispatcher: N, ReactCurrentBatchConfig: H, ReactCurrentOwner: x };
      (t.Children = {
        map: T,
