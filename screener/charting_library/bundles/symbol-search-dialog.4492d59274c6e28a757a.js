  ...
  [1754],
  {
    ...
    223392: (e, t, o) => {
      ...
      var d = o(602948),
        ...
        u = o.n(h);
      const m = (e, t) => {
        const o = (0, r.useContext)(s.CustomBehaviourContext),
          a = (0, r.useContext)(l.ControlGroupContext),
          { isInButtonGroup: d, isGroupPrimary: h } = (0, r.useContext)(c),
          {
            className: m,
            isSelected: p,
            children: b,
            ...
            variant: k = 'primary',
            size: I = 'medium',
            enableActiveStateStyles: x = o.enableActiveStateStyles,
            typography: D,
            isLink: w = !1,
            textWrap: W,
            isPills: C,
        ...
        return i(
          ...
          w && u().link,
          p && u().selected,
          (0, n.isIconOnly)(b, _) && u()['no-content'],
          y && u()['with-start-icon'],
          (f || g) && u()['with-end-icon'],
          t && u()['with-grouped'],
          S && u()[`force-direction-${S}`],
          u()[`variant-${h ? 'primary' : k}`],
          u()[`color-${h ? 'gray' : v}`],
          u()[`size-${I}`],
          z,
          !x && u()['disable-active-state-styles'],
          a.isGrouped && u().grouped,
          W && u().wrap,
          d && u()['disable-active-on-touch'],
          C && u().pills,
        );
      };
      function p(e) {
        ...
        return r.createElement(
          r.Fragment,
          null,
          t && r.createElement(a.Icon, { className: u().icon, icon: t }),
          !(0, n.isIconOnly)(m, l) &&
            r.createElement(
              'span',
              { className: i(u().content, !h && u().nowrap) },
              h || c
                ? r.createElement(
                    r.Fragment,
                    null,
                    r.createElement(
                      ...
                      {
                        className: i(
                          !h && c && u()['ellipsis-container'],
                          h && u()['text-wrap-container'],
                          h && c && u()['text-wrap-with-ellipsis'],
                        ),
                      },
                      m,
                    ),
                    r.createElement(
                      'span',
                      { className: u()['visually-hidden'], 'aria-hidden': !0 },
                      m,
                    ),
                  )
                : r.createElement(
          ...
          (o || s) &&
            (e =>
              r.createElement(a.Icon, {
                className: i(u().icon, e.showCaret && u().caret),
      ...
      function b(e) {
        const { isGrouped: t } = r.useContext(l.ControlGroupContext),
          ...
          w = v ? (null != k ? k : 2) : 1,
          W = w > 0 ? { ...I, '--ui-lib-light-button-content-max-lines': w } : I;
        return r.createElement(
          'button',
          {
            ...D,
          ...
          r.createElement(
            p,
            { showCaret: h, startIcon: n, endIcon: b, iconOnly: c, ellipsis: d, textWrap: v },
            s,
          ),
        );
      }
    ...
    591365: (e, t, o) => {
      'use strict';
      o.d(t, { CustomComponentDefaultLink: () => a });
      var r = o(50959),
        i = o(409245);
      function a(e) {
    ...
    234539: (e, t, o) => {
      'use strict';
      o.d(t, { CustomBehaviourContext: () => r });
      const r = (0, o(50959).createContext)({ enableActiveStateStyles: !0 });
      r.displayName = 'CustomBehaviourContext';
    },
    912015: (e, t, o) => {
      'use strict';
      o.d(t, { isPlatformMobile: () => i });
      var r = o(69111);
      o(156963), o(601227);
      function i() {
        return (
    ...
    723698: (e, t, o) => {
      ...
      function v(e) {
        const {
          ...
          { selectedAction: n } = (0, c.ensureNotNull)(
            (0, l.useContext)(h.SymbolSearchWatchlistContext),
          );
        return l.createElement(
          ...
          r
            ? l.createElement(
                l.Fragment,
                null,
                l.createElement(y.ListItemButton, {
                  className: p()(
                    _.action,
                    _.removeAction,
                    t && 2 === n && _.selected,
                  ...
                  onClick: s,
                  icon: f,
                  title: b.t(null, void 0, o(366702)),
                }),
                l.createElement(y.ListItemButton, {
                  className: p()(
                    _.action,
                  ...
                  onClick: i,
                  icon: S,
                  title: b.t(null, void 0, o(708682)),
                }),
              )
            : l.createElement(y.ListItemButton, {
                className: p()(
                ...
                onClick: a,
                icon: g,
                title: b.t(null, void 0, o(445976)),
              }),
        );
      }
      var k = o(180185),
      ...
      function C(e) {
        const t = (0, s.getSymbolSearchCompleteOverrideFunction)(),
          { defaultValue: o, showSpreadActions: i, source: l, onSearchComplete: c, ...d } = e,
          h = {
            ...d,
            showSpreadActions: null != i ? i : (0, a.canShowSpreadActions)(),
            onSearchComplete: (e, o) => {
              null == o || o.symbolType;
              t(e[0].symbol, e[0].result).then(e => {
                r.linking.symbol.setValue(e.symbol), null == c || c(e.symbol);
              });
            },
          };
        (0, n.showSymbolSearchItemsDialog)({ ...h, defaultValue: o });
      }
      const z = {
        SymbolSearchWatchlistDialogContentItem: function (e) {
          const {
            ...
            } = e,
            {
              ...
              searchRef: b,
              searchSpreads: y,
            } = (0, c.ensureNotNull)((0, l.useContext)(u.SymbolSearchItemsDialogContext)),
            {
              setSelectedAction: f,
              isSpreadOrMultipleMode: g,
              addAfter: S,
              clearTargetSymbol: _,
              highlighted: w,
              highlight: W,
            } = (0, c.ensureNotNull)((0, l.useContext)(h.SymbolSearchWatchlistContext)),
            C = g(y, b);
          return (
            (0, l.useLayoutEffect)(() => {
              s && f(void 0 !== a ? (a ? 2 : 0) : null);
            }, [s, a]),
            l.createElement(d.SymbolSearchDialogContentItem, {
              ...m,
              fullSymbolName: n,
              onClick: C
                ? e.onClick
                : function (r) {
                    if (void 0 === n) return;
                    if (void 0 === a) return void (0, c.ensureDefined)(e.onClick)(r);
                    a
                      ? (o(x.WATCHLIST_WIDGET_ID, n),
                        N('watchlist remove click', r),
                        S === n && _())
                      : ((0, D.runOrSignIn)(
                          () => {
                            t(x.WATCHLIST_WIDGET_ID, [n], S), e.id && W(e.id);
                          },
                          { source: 'add symbol to watchlist' },
                        ),
                        N('watchlist add click', r));
                    z(r);
                  },
              isHighlighted: w === e.id,
              isSelected: s,
              actions:
                void 0 === a || C
                  ? void 0
                  : l.createElement(v, {
                      ...
                      addToWatchlist: function (o) {
                        ...
                        (0, D.runOrSignIn)(
                          ...
                          z(o),
                          N('watchlist add button', o);
                      },
                      removeFromWatchlist: function (e) {
                        if ((e.stopPropagation(), void 0 === n)) return;
                        o(x.WATCHLIST_WIDGET_ID, n),
                          z(e),
                          N('watchlist remove button', e),
                          S === n && _();
                      },
                      findInWatchlist: function (e) {
                        if ((e.stopPropagation(), void 0 === n)) return;
                        r(x.WATCHLIST_WIDGET_ID, n), p(), N('watchlist goto button');
                      },
                    }),
            })
          );
          function z(e) {
            var t;
            e && (0, k.modifiersFromEvent)(e) === k.Modifiers.Shift
              ? p()
              : i.mobiletouch || null === (t = b.current) || void 0 === t || t.select();
          }
          function N(e, t) {
            let o = e;
            t && (0, k.modifiersFromEvent)(t) === k.Modifiers.Shift && (o += ' shift'),
              (0, I.trackEvent)('GUI', 'SS', o);
          }
        },
        SymbolSearchWatchlistDialog: function (e) {
          const { addToWatchlist: t, removeFromWatchlist: o, findInWatchlist: r, ...i } = e,
            {
              feedItems: a,
              searchRef: s,
              searchSpreads: n,
            ...
            L = a[d],
            A = 'exchange' === S;
          return l.createElement(w.AdaptivePopupDialog, {
            ...i,
            className: p()(W.dialog, !f && (g ? W.tabletDialog : W.desktopDialog)),
            dataName: 'watchlist-symbol-search-dialog',
            onKeyDown: function (e) {
              var t;
              switch ((0, k.hashFromEvent)(e)) {
                case 38:
                  if ((e.preventDefault(), 0 === d)) return;
                  if (-1 === d) return void b(0);
                  b(d - 1);
                  break;
                case 40:
                  if ((e.preventDefault(), d === a.length - 1)) return;
                  b(d + 1);
                  break;
                case 37:
                  if (!L) return;
                  1 === v && (e.preventDefault(), I(2));
                  break;
                case 39:
                  if (!L) return;
                  2 === v && (e.preventDefault(), I(1));
                  break;
                case 13:
                  if (C(n, s)) return void m(!0);
                  L ? O(!1) : m(!1), null === (t = s.current) || void 0 === t || t.select();
                  break;
                case 13 + k.Modifiers.Shift:
                  if (C(n, s)) return void m(!0);
                  L ? O(!0) : m(!0);
                  break;
                case 27:
                  if ((e.preventDefault(), A)) return void _('symbolSearch');
                  y();
              }
            },
            backdrop: !0,
          ...
          function O(e) {
            if (!L || void 0 === L.fullSymbolName) return;
            const { fullSymbolName: i } = L;
            switch (v) {
              case 0:
                (0, D.runOrSignIn)(
                  () => {
                    t(x.WATCHLIST_WIDGET_ID, [i], z), L.id && T(L.id);
                  },
                  { source: 'add symbol to watchlist' },
                );
                break;
              case 1:
                return r(x.WATCHLIST_WIDGET_ID, i), void y();
              case 2:
                o(x.WATCHLIST_WIDGET_ID, i), z === i && N();
            }
            e && y();
          }
        },
      ...
      function l(e) {
        ...
        const z = document.createElement('div'),
          N = r.createElement(
            ...
            { value: null != W ? W : null },
            r.createElement(n.SymbolSearchItemsDialog, {
              onClose: T,
              initialMode: t,
              defaultValue: l,
              showSpreadActions: c,
        ...
        function T() {
          i.unmountComponentAtNode(z), s.dialogsOpenerManager.setAsClosed('SymbolSearch'), S && S();
        }
        return (
          i.render(N, z), s.dialogsOpenerManager.setAsOpened('SymbolSearch'), _ && _(), { close: T }
        );
      }
    },
    113060: (e, t, o) => {
      'use strict';
      o.d(t, { SymbolSearchWatchlistContext: () => r });
      const r = o(50959).createContext(null);
    },
    63192: (e, t, o) => {
      'use strict';
      o.d(t, { DialogsOpenerManager: () => r, dialogsOpenerManager: () => i });
      class r {
        constructor() {
    ...
    800296: (e, t, o) => {
      ...
      var r = o(50959),
        ...
        n = o(186928);
      function l(e) {
        const { className: t, disabled: o, ...i } = e;
        return r.createElement(s.Icon, { className: a()(n.button, o && n.disabled, t), ...i });
      }
    },
    602948: e => {
      e.exports =
