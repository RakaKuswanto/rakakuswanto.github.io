  ...
  [2704, 959, 6437],
  {
    ...
    533408: (e, t, n) => {
      ...
      function _(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            'div',
            { className: a()(b.container, h, (o || p) && b.unsetAlign) },
            c,
            r.createElement(
              'div',
              { 'data-dragg-area': d, className: b.title },
              r.createElement('div', { className: a()(n ? b.textWrap : b.ellipsis) }, t),
              o && r.createElement('div', { className: a()(b.ellipsis, b.subtitle) }, o),
            ),
            u,
            i &&
              !v &&
      ...
      class N extends r.PureComponent {
        ...
        render() {
          const {
            ...
            V = 'after' !== u ? v : void 0,
            q = 'after' === u ? v : void 0,
            Q = 'string' == typeof i ? i : z || '',
            J = (0, S.filterDataProps)(this.props),
          ...
          return r.createElement(f.MatchMedia, { rule: p.DialogBreakpoints.SmallHeight }, u =>
            r.createElement(f.MatchMedia, { rule: p.DialogBreakpoints.TabletSmall }, p =>
              r.createElement(
                ...
                {
                  rounded: !(p || D) && I,
                  className: a()(x.dialog, D && $ && x.bounded, e),
                  isOpened: o,
                  reference: Y,
                  ...
                  containerAriaLabel: F,
                  containerTabIndex: K,
                  calculateDialogPosition: D && $ ? this._calculatePositionWithOffsets : void 0,
                  shadowed: W,
                  ...J,
                },
                r.createElement(
                  'div',
                  { className: a()(x.wrapper, t), 'data-name': l, 'data-dialog-name': Q },
                  void 0 !== i &&
                    r.createElement(_, {
                      draggable: N && !(p || D),
                  ...
                  E && r.createElement(h.Separator, { className: x.separator }),
    ...
    380016: (e, t, n) => {
      ...
      const S = r.memo(
        function (e) {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              f && r.createElement('span', { className: h()(w.description, y) }, s ? S(s) : ''),
            ),
            void 0 !== v &&
              r.createElement(
                'div',
        ...
        (e, t) =>
          Object.keys(t)
            .filter(e => !['onClick', 'onClose', 'onFavoriteClick'].includes(e))
            .every(n => t[n] === e[n]),
      );
      var x = n(248471),
        k = n(69311),
      ...
      function R(e) {
        const {
          ...
          [_, w] = (0, r.useState)(() => o.reduce((e, t, n) => (t.name && (e[t.id] = !0), e), {}));
        function N(e) {
          const { id: t, ...n } = e;
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement('input', {
                ...
                type: 'text',
                className: A.input,
                placeholder: p.t(null, void 0, n(252298)),
                autoComplete: 'off',
                'data-role': 'search',
                onChange: function (e) {
                  c(e.target.value);
                ...
                l
                  ...
                  : i.map((e, t) =>
                      r.createElement(
                        r.Fragment,
                        { key: e.id },
                        e.name && r.createElement('div', { className: T.section }, e.name),
                        e.actions.map((n, c) => {
                          const { id: u, ...h } = n,
                          ...
                          return r.createElement(
                            ...
                            !v && p && r.createElement('div', { className: T.separator }),
                          );
                        }),
                      ),
                    ),
      ...
      function O(e) {
        const { element: t, ...n } = e,
          ...
          { activeIdx: v, setActiveIdx: g } = (function (e, t, n, o = 'keydown') {
        ...
        return r.createElement(s.MatchMedia, { rule: c.DialogBreakpoints.TabletSmall }, e =>
          e
            ? r.createElement(M, { ...n, ...C })
            : r.createElement(R, {
                ...n,
                ...C,
      ...
      class z {
        constructor(e, t, n, r) {
          (this._rootElem = document.createElement('div')),
            ...
            this._render(),
            i.favoriteCurrencyUnitConversionService.getOnChange().subscribe(this, this._render);
        }
        _render() {
          const e = {
            title: this._title,
    ...
    512991: (e, t, n) => {
      'use strict';
      n.d(t, { createRegExpList: () => i, getHighlightedChars: () => s, rankedSearch: () => o });
      var r = n(372605);
      function o(e) {
        const {
          data: t,
            ...
            return (
              n.forEach(e => {
                ...
                if ((0, r.isString)(t) && f.test(t))
                  return (
                    (h = 3), void (d = null === (s = t.match(f)) || void 0 === s ? void 0 : s.index)
                  );
                if ((0, r.isString)(i) && f.test(i))
                  return (
                    (h = 2), void (d = null === (a = i.match(f)) || void 0 === a ? void 0 : a.index)
                  );
                if ((0, r.isString)(i) && p.test(i))
                  return (
                    (h = 2), void (d = null === (l = i.match(p)) || void 0 === l ? void 0 : l.index)
                  );
                if (Array.isArray(u))
                  for (const e of u)
                    if (f.test(e))
    ...
    260598: (e, t, n) => {
      ...
      function a(e) {
        const { queryString: t, rules: n, text: a, className: l } = e,
          c = (0, r.useMemo)(() => (0, i.getHighlightedChars)(t, a, n), [t, n, a]);
        return r.createElement(
          r.Fragment,
          null,
          c.length
            ? a
                ...
                .map((e, t) =>
                  r.createElement(
                    ...
                    { key: t },
                    c[t]
                      ? r.createElement('span', { className: o(s.highlighted, l) }, e)
    ...
    515783: (e, t, n) => {
      ...
      function l(e) {
        ...
        return r.createElement(i.Icon, { className: o(n, s.icon, { [s.dropped]: t }), icon: a });
      }
    },
    493173: (e, t, n) => {
      'use strict';
    ...
    695257: (e, t) => {
      ...
      function x(e, t, r) {
        ...
        return { $$typeof: n, type: e, key: s, ref: a, props: i, _owner: w.current };
      }
      function k(e) {
      ...
      var L = { current: null },
        T = { transition: null },
        M = { ReactCurrentDispatcher: L, ReactCurrentBatchConfig: T, ReactCurrentOwner: w };
      (t.Children = {
        map: R,
      ...
      const l = (0, r.forwardRef)(function (e, t) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            o,
            r.createElement(s.ToolWidgetCaret, { className: a.caret, dropped: Boolean(n) }),
          ),
          n && l,
        );
      });
    ...
    648997: (e, t, n) => {
      ...
      function a(e, t, a) {
        ...
        for (const e of g) {
          ...
          m.actions.push(
            (0, i.createAction)(
              ...
              () => c(e.id),
              f.has(e.id),
              () => s.favoriteCurrencyUnitConversionService.toggle('currencies', e.id),
            ),
          );
        }
        ...
        return (
          (E.length > 0 || y.length > 0) && l.push({ id: 'second_section', actions: y.concat(E) }),
          l
        );
      }
    },
    ...
    22265: (e, t, n) => {
      ...
      function a(e, t, a) {
        ...
        (C.length > 0 || y.length > 0) &&
          m.actions.push(
            ...y.sort((e, t) => e.label.toLowerCase().localeCompare(t.label.toLowerCase())),
            ...C,
          ),
          m.actions.length > 0 && l.push(m);
              ...
              n.id === u ||
                ...
                t.push(
                  (0, i.createAction)(
                    ...
                    () => c(n.id),
                    !1,
                    () => s.favoriteCurrencyUnitConversionService.toggle('units', n.id),
                  ),
                );
