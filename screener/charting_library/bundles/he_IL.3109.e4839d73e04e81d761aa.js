  ...
  [3109],
  {
    ...
    788601: t => {
      (t.exports = Object.create(null)),
        ...
        (t.exports['Multi timeframe_input'] = ['מסגרת זמן רב']),
        (t.exports.Timeframe_input = ['מסגרת זמן']),
        (t.exports['Wait for timeframe closes_input'] = ['המתן לסגירת מסגרת הזמן']),
        ...
        (t.exports['Color based on previous close_input'] = ['צבע מבוסס על סגירה קודמת']),
        ...
        (t.exports['Value Area Volume_input'] = ['איזור ערך הווליום Value Area Volume']),
    ...
    168716: t => {
      (t.exports = Object.create(null)),
        ...
        (t.exports['Enterprise value to EBIT ratio_study'] = ['מכפיל ערך ארגוני ל-EBIT']),
        (t.exports['Enterprise value to EBITDA ratio_study'] = ['ערך ארגוני למכפיל EBITDA']),
        (t.exports['Enterprise value to revenue ratio_study'] = ['מכפיל ערך ארגוני ל-EBIT']),
        ...
        (t.exports['Price to cash flow ratio_study'] = ['מכפיל מחיר לתזרים מזומנים']),
        (t.exports['Price to earnings ratio_study'] = ['מכפיל מחיר לרווח']),
        (t.exports['Price to free cash flow ratio_study'] = ['מכפיל מחיר לתזרים מזומנים חופשי']),
        (t.exports['Price to sales ratio_study'] = ['מכפיל מחיר למכירות']),
        (t.exports['Float shares outstanding_study'] = ['מניות צפות outstanding']),
        (t.exports['Total common shares outstanding_study'] = ['סך המניות בידי הציבור']),
        (t.exports['Volume Weighted Average Price_study'] = ['נפח מחיר ממוצע משוקלל VWAP']),
        (t.exports['Volume Weighted Moving Average_study'] = ['ממוצע נע משוקלל נפח']),
        (t.exports['Williams Percent Range_study'] = ['טווח אחוזים של וויליאמס']),
        ...
        (t.exports['Accounts receivables, gross_study'] = ['חשבונות חייבים, ברוטו']),
        (t.exports['Accounts receivable - trade, net_study'] = ['חשבונות חייבים - מסחר, נטו']),
        (t.exports.Accruals_study = ['צבירות']),
        (t.exports['Accrued payroll_study'] = ['שכר שנצבר']),
        (t.exports['Accumulated depreciation, total_study'] = ['פחת מצטבר, סך הכל']),
        (t.exports['Additional paid-in capital/Capital surplus_study'] = [
          'הון נוסף שנפרע/עודף הון',
        ]),
        (t.exports['After tax other income/expense_study'] = ['לאחר מס הכנסה/הוצאות אחרות']),
        (t.exports['Altman Z-score_study'] = ['ציון Z של אלטמן']),
        (t.exports.Amortization_study = 'Amortization'),
        (t.exports['Amortization of intangibles_study'] = ['הפחתת נכסים בלתי מוחשיים']),
        (t.exports['Amortization of deferred charges_study'] = ['הפחתת חיובים דחויים']),
        (t.exports['Asset turnover_study'] = ['מחזור נכסים']),
        (t.exports['Average basic shares outstanding_study'] = ['ממוצע מניות בסיסיות קיימות']),
        (t.exports['Bad debt / Doubtful accounts_study'] = ['חוב אבוד / חשבונות מפוקפקים']),
        ...
        (t.exports['Capital expenditures - fixed assets_study'] = ['הוצאות הון - רכוש קבוע']),
        (t.exports['Capital expenditures - other assets_study'] = ['הוצאות הון - נכסים אחרים']),
        (t.exports['Capitalized lease obligations_study'] = ['התחייבויות חכירה מהוונות']),
        (t.exports['Cash and short term investments_study'] = ['מזומן והשקעות לטווח קצר']),
        (t.exports['Cash conversion cycle_study'] = ['מחזור המרה במזומן']),
        (t.exports['Cash & equivalents_study'] = ['שווי מזומנים']),
        (t.exports['Cash from financing activities_study'] = ['מזומנים מפעילות פיננסית']),
        (t.exports['Cash from investing activities_study'] = ['מזומנים מפעולות השקעה']),
        (t.exports['Cash from operating activities_study'] = ['מזומנים מפעילות תפעולית']),
        (t.exports['Change in accounts payable_study'] = ['שינוי בחשבונות התשלום']),
        (t.exports['Change in accounts receivable_study'] = ['שינוי בחשבונות חייבים']),
        (t.exports['Change in accrued expenses_study'] = ['שינוי בהוצאות שנצברו']),
        (t.exports['Change in inventories_study'] = ['שינוי במאגר']),
        (t.exports['Change in other assets/liabilities_study'] = ['שינוי בנכסים/התחייבויות אחרים']),
        ...
        (t.exports['Common dividends paid_study'] = ['דיבידנדים משותפים ששולמו']),
        (t.exports['Common equity, total_study'] = ['הון משותף, סך הכל']),
        (t.exports['Common stock par/Carrying value_study'] = 'Common stock par/Carrying value'),
        ...
        (t.exports['Deferred income, current_study'] = 'Deferred income, current'),
        (t.exports['Deferred income, non-current_study'] = ['הכנסה נדחית, לא שוטפת']),
        (t.exports['Deferred tax assets_study'] = ['נכסי מס נדחים']),
        (t.exports['Deferred taxes (cash flow)_study'] = ['מסים נדחים (תזרים מזומנים)']),
        ...
        (t.exports['Depreciation/depletion_study'] = ['פחת/דלדול Depreciation/depletion']),
        ...
        (t.exports['Effective interest rate on debt %_study'] = ['שיעור ריבית אפקטיבית על החוב %']),
        (t.exports['Enterprise value_study'] = ['ערך ארגוני']),
        (t.exports['EPS basic one year growth_study'] = ['EPS צמיחה בסיסית לשנה אחת']),
        (t.exports['EPS diluted one year growth_study'] = ['EPS מדולל צמיחה של שנה אחת']),
        ...
        (t.exports['Free cash flow margin %_study'] = ["% מרג'ין תזרים מזומנים חופשי"]),
        (t.exports['Fulmer H factor_study'] = ['גורם פולמר H']),
        (t.exports['Funds from operations_study'] = ['כספים מפעילות תפעולית']),
        (t.exports['Goodwill to assets ratio_study'] = ['מכפיל מוניטין לנכסים']),
        ...
        (t.exports['Gross profit to assets ratio_study'] = ['מכפיל רווח גולמי לנכסים']),
        (t.exports['Gross property/plant/equipment_study'] = ['רכוש/מפעל/ציוד גולמי']),
        ...
        (t.exports['Income tax, current - domestic_study'] = ['מס הכנסה, שוטף - מקומי']),
        (t.exports['Income Tax, current - foreign_study'] = ['מס הכנסה, שוטף - זר']),
        (t.exports['Income tax, deferred_study'] = ['מס הכנסה, נדחה']),
        (t.exports['Income tax, deferred - domestic_study'] = ['מס הכנסה, נדחה - מקומי']),
        (t.exports['Income tax, deferred - foreign_study'] = ['מס הכנסה, נדחה - זר']),
        ...
        (t.exports['Interest expense on debt_study'] = ['הוצאות ריבית על החוב']),
        (t.exports['Inventories - finished goods_study'] = ['מלאי - סחורה מוגמרת']),
        ...
        (t.exports['Inventories - work in progress_study'] = ['מלאי - עבודות בתהליך']),
        (t.exports['Inventory to revenue ratio_study'] = ['מלאי למכפיל הכנסות']),
        ...
        (t.exports['Investing activities – other uses_study'] = ['פעילויות השקעה - שימושים אחרים']),
        (t.exports['Investments in unconsolidated subsidiaries_study'] = [
          'השקעות בחברות בת לא מאוחדות',
        ]),
        (t.exports['Issuance of long term debt_study'] = ['הנפקת חוב לטווח ארוך']),
        (t.exports['Issuance/retirement of debt, net_study'] = ['הקצאה/פרישת חוב, נטו']),
        (t.exports['Issuance/retirement of long term debt_study'] = [
          'הקצאה/פריסה של חוב לטווח ארוך',
        ]),
        (t.exports['Issuance/retirement of other debt_study'] = ['הקצאה/פרישה של חוב אחר']),
        (t.exports['Issuance/retirement of short term debt_study'] = [
          'הקצאה/פרישה של חוב לטווח קצר',
        ]),
        (t.exports['Issuance/retirement of stock, net_study'] = ['הקצאה/פרישת מלאי, נטו']),
        ...
        (t.exports['Miscellaneous non-operating expense_study'] = ['הוצאות שונות שאינן תפעוליות']),
        (t.exports['Net current asset value per share_study'] = ['שווי נכס נוכחי נטו למניה']),
        ...
        (t.exports['Net income (cash flow)_study'] = ['רווח נקי (תזרים מזומנים)']),
        ...
        (t.exports['Net property/plant/equipment_study'] = ['רכוש/מפעל/ציוד נטו']),
        (t.exports['Non-cash items_study'] = ['פריטים שאינם מזומנים']),
        (t.exports['Non-controlling/minority interest_study'] = ['זכויות חסרות שליטה/ מועטות']),
        (t.exports['Non-operating income, excl. interest expenses_study'] = [
          'הכנסה לא תפעולית, excl. הוצאות ריבית',
        ]),
        (t.exports['Non-operating income, total_study'] = ['הכנסה לא תפעולית, סך הכל']),
        (t.exports['Non-operating interest income_study'] = ['הכנסות ריבית לא תפעוליות']),
        (t.exports['Note receivable - long term_study'] = ['שטר חוב - לטווח ארוך']),
        ...
        (t.exports['Operating expenses (excl. COGS)_study'] = ['הוצאות תפעול (לא כולל COGS)']),
        (t.exports['Operating lease liabilities_study'] = ['התחייבויות חכירה תפעולית']),
        ...
        (t.exports['Other current assets, total_study'] = ['נכסים שוטפים אחרים, סך הכל']),
        (t.exports['Other current liabilities_study'] = ['התחייבויות שוטפות אחרות']),
        (t.exports['Other cost of goods sold_study'] = ['עלות אחרת של סחורה שנמכרה']),
        (t.exports['Other exceptional charges_study'] = ['חיובים חריגים אחרים']),
        (t.exports['Other financing cash flow items, total_study'] = [
          'פריטי תזרים מזומנים אחרים המממנים, סך הכל',
        ]),
        (t.exports['Other intangibles, net_study'] = ['נכסים בלתי מוחשיים אחרים, נטו']),
        ...
        (t.exports['Other liabilities, total_study'] = ['התחייבויות אחרות, סך הכל']),
        (t.exports['Other long term assets, total_study'] = ['נכסים אחרים לטווח ארוך, סך הכל']),
        (t.exports['Other non-current liabilities, total_study'] = [
          'התחייבויות לא שוטפות אחרות, סך הכל',
        ]),
        (t.exports['Other operating expenses, total_study'] = ['הוצאות תפעול אחרות, סך הכל']),
        ...
        (t.exports['Preferred dividends paid_study'] = ['דיבידנדים מועדפים ששולמו']),
        (t.exports['Preferred stock, carrying value_study'] = ['מניה מועדפת, נושאת ערך']),
        (t.exports['Prepaid expenses_study'] = ['הוצאות משולמות מראש']),
        (t.exports['Pretax equity in earnings_study'] = ['הון עצמי לפני מס ברווחים']),
        (t.exports['Pretax income_study'] = ['הכנסה לפני מס']),
        (t.exports['Price earnings ratio forward_study'] = ['מכפיל רווחים במחיר קדימה']),
        (t.exports['Price sales ratio forward_study'] = ['מכפיל מכירות מחיר קדימה']),
        (t.exports['Price to tangible book ratio_study'] = ['מכפיל מחיר לספר מוחשי']),
        (t.exports['Provision for risks & charge_study'] = ['הפרשה לסיכונים וחיובים']),
        (t.exports['Purchase/acquisition of business_study'] = ['רכישה/רכישה של עסק']),
        (t.exports['Purchase of investments_study'] = ['רכישת השקעות']),
        (t.exports['Purchase/sale of business, net_study'] = ['רכישה / מכירה של עסקים, נטו']),
        (t.exports['Purchase/sale of investments, net_study'] = ['רכישה / מכירה של השקעות, נטו']),
        (t.exports['Quality ratio_study'] = ['מכפיל איכות']),
        (t.exports['Quick ratio_study'] = ['מכפיל מהיר']),
        (t.exports['Reduction of long term debt_study'] = ['הפחתת חוב לטווח ארוך']),
        ...
        (t.exports['Research & development to revenue ratio_study'] = ['מחקר ופיתוח ביחס להכנסות']),
        ...
        (t.exports['Return on invested capital %_study'] = ['תשואה על ההון המושקע%']),
        (t.exports['Return on tangible assets %_study'] = ['תשואה על נכסים מוחשיים%']),
        (t.exports['Return on tangible equity %_study'] = ['תשואה להון מוחשי%']),
        ...
        (t.exports['Sale of common & preferred stock_study'] = ['מכירת מניות נפוצות ומועדפות']),
        (t.exports['Sale of fixed assets & businesses_study'] = ['מכירת רכוש קבוע ועסקים']),
        ...
        (t.exports['Shares buyback ratio %_study'] = ['%מכפיל רכישה חוזרת של מניות']),
        ...
        (t.exports['Sloan ratio %_study'] = ['מכפיל יציבות פיננסית Sloan ratio %']),
        (t.exports['Springate score_study'] = 'Springate score'),
        (t.exports['Sustainable growth rate_study'] = ['קצב צמיחה בר קיימא']),
        (t.exports['Tangible book value per share_study'] = ['הון מוחשי למניה']),
        (t.exports['Tangible common equity ratio_study'] = ['יחס הון משותף מוחשי']),
        ...
        (t.exports['Total cash dividends paid_study'] = ['סך דיבידנדים במזומן ששולם']),
        (t.exports['Total current assets_study'] = ['סך כל הנכסים הנוכחיים']),
        (t.exports['Total current liabilities_study'] = ['סך כל ההתחייבויות הנוכחיות']),
        ...
        (t.exports['Total non-current assets_study'] = ['סה"כ נכסים לא שוטפים']),
        (t.exports['Total non-current liabilities_study'] = ['סך ההתחייבויות הלא שוטפות']),
        ...
        (t.exports['Key stats_study'] = ['סטטיסטיקות מפתח']),
        ...
        (t.exports['Arnaud Legoux Moving Average_study'] = ['ממוצעים נעים ארנולד לגוקס (ALMA)']),
        ...
        (t.exports['Chande Momentum Oscillator_study'] = ["מתנד מומנטום צ'אנד (CMO)"]),
        (t.exports['Chop Zone_study'] = ["צ'ופ-זון"]),
        (t.exports['Choppiness Index_study'] = ["מדד צ'ופינס"]),
        (t.exports['Commodity Channel Index_study'] = ['מדד ערוץ סחורות ׁׁ(CCI)']),
        ...
        (t.exports['Fixed Range Volume Profile_study'] = ['פרופיל ווליום טווח קבוע']),
        (t.exports['Guppy Multiple Moving Average_study'] = ['ממוצע נע מרובה גופים']),
        ...
        (t.exports['Least Squares Moving Average_study'] = ['ריבועי ממוצעים נעים פשוטים (LSMA)']),
        ...
        (t.exports['Moving Average Exponential_study'] = ['ממוצע נע אקספוננציאלי']),
        (t.exports['Moving Average Weighted_study'] = ['ממוצע נע משוקלל']),
        (t.exports['Moving Average Simple_study'] = ['ממוצע נע פשוט']),
        ...
        (t.exports['Relative Strength Index_study'] = ['מדד כוח יחסי (RSIׂׂׂ)']),
        ...
        (t.exports['Session Volume Profile HD_study'] = ['פרופיל סשן ווליום HD']),
        ...
        (t.exports['Stochastic RSI_study'] = ['מדד כוח יחסי סטוכסטיק (Stochastic RSI)']),
        (t.exports.Stochastic_study = ['סטוכסטיק']),
        (t.exports['Triple EMA_study'] = ['ממוצעים נעים אקפוננציאלית פי 3 (Triple EMA)']),
        ...
        (t.exports['Visible Range Volume Profile_study'] = ['פרופיל ווליום טווח גלוי']),
        ...
        (t.exports['Linear Regression Channel_study'] = ['ערוץ רגרסיה ליניארי']),
        (t.exports['Moving Average Ribbon_study'] = ['ממוצע נע Ribbon']),
        (t.exports['Multi-Time Period Charts_study'] = ['תרשימי גרף רב-תקופתי']),
        ...
        (t.exports['Rob Booker - Knoxville Divergence_study'] = ['Rob Booker - Knoxville סטייה']),
        ...
        (t.exports['Rob Booker - Ziv Ghost Pivots_study'] = ['Rob Booker - Ziv Ghost פיווט']),
        ...
        (t.exports['Williams Fractals_study'] = ['פרקטלס של וויליאמס Fractals']),
        (t.exports['Keltner Channels Strategy_study'] = ['אסטרטגיית ערוצי קלטנר']),
        (t.exports['Rob Booker - ADX Breakout_study'] = ['Rob Booker - פריצת ADX']),
        (t.exports['Supertrend Strategy_study'] = ['אסטרטגיית סופר טרנד']),
        (t.exports['Technical Ratings Strategy_study'] = ['אסטרטגיית דירוגים טכניים']),
        (t.exports['Auto Anchored Volume Profile_study'] = ['פרופיל ווליום מעוגן אוטומטי']),
        (t.exports['Auto Fib Extension_study'] = ["הרחבת פיבונאצ'י אוטומטית"]),
        (t.exports['Auto Fib Retracement_study'] = ['תיקוני פיבונאצי אוטומטיים']),
        (t.exports['Auto Pitchfork_study'] = ['Pitchfork אוטומטי']),
        (t.exports['Bearish Flag Chart Pattern_study'] = ['תבנית גרף דגל דובי']),
        (t.exports['Bullish Flag Chart Pattern_study'] = ['תבנית גרף דגל שוורי']),
        (t.exports['Bearish Pennant Chart Pattern_study'] = ['תבנית גרף דגלון דובי']),
        (t.exports['Bullish Pennant Chart Pattern_study'] = ['תבנית גרף דגל שוורי']),
        (t.exports['Double Bottom Chart Pattern_study'] = ['תבנית גרף תחתית כפולה']),
        (t.exports['Double Top Chart Pattern_study'] = ['תבנית גרף תקרה כפולה']),
        (t.exports['Elliott Wave Chart Pattern_study'] = ['תבנית גרף גלי אליוט']),
        (t.exports['Falling Wedge Chart Pattern_study'] = ['תבנית גרף טריז נופל']),
        (t.exports['Head And Shoulders Chart Pattern_study'] = ['תבנית גרף ראש וכתפיים']),
        ...
        (t.exports['Rising Wedge Chart Pattern_study'] = ['תבנית גרף טריז עולה']),
        (t.exports['Triangle Chart Pattern_study'] = ['תבנית גרף משולש']),
        (t.exports['Triple Bottom Chart Pattern_study'] = ['תבנית גרף משולש תחתון']),
        (t.exports['Triple Top Chart Pattern_study'] = ['תבנית גרף משולשת עליונה']),
        (t.exports['VWAP Auto Anchored_study'] = ['VWAP מעוגן אוטומטי']),
        (t.exports['*All Candlestick Patterns*_study'] = ['*כל דפוסי הנרות היפניים*']),
        (t.exports['Abandoned Baby - Bearish_study'] = ['תינוק נטוש - דובי']),
        (t.exports['Abandoned Baby - Bullish_study'] = ['תינוק נטוש - שוורי']),
        (t.exports['Dark Cloud Cover - Bearish_study'] = ['כיסוי ענן כהה - דובי']),
        (t.exports['Doji Star - Bearish_study'] = ["כוכב דוג'י - דובי"]),
        (t.exports['Doji Star - Bullish_study'] = ["כוכב דוג'י - שוורי"]),
        (t.exports['Downside Tasuki Gap - Bearish_study'] = ['Tasuki גאפ למטה - דובי']),
        (t.exports['Dragonfly Doji - Bullish_study'] = ["דרגון פליי Dragonfly דוג'י - שוורי"]),
        (t.exports['Engulfing - Bearish_study'] = ['בולען - דובי']),
        (t.exports['Engulfing - Bullish_study'] = ['בולען - שוורי']),
        (t.exports['Evening Doji Star - Bearish_study'] = ["כוכב ערב דוג'י - דובי"]),
        (t.exports['Evening Star - Bearish_study'] = ['כוכב ערב - דובי']),
        (t.exports['Falling Three Methods - Bearish_study'] = ['Falling Three Methods - דובי']),
        (t.exports['Falling Window - Bearish_study'] = ['Falling Window - דובי']),
        (t.exports['Gravestone Doji - Bearish_study'] = ["Gravestone דוג'י - שוורי"]),
        ...
        (t.exports['Long Lower Shadow - Bullish_study'] = ['Long Lower Shadow - שוורי']),
        (t.exports['Long Upper Shadow - Bearish_study'] = ['Long Upper Shadow - דובי']),
        (t.exports['Marubozu Black - Bearish_study'] = ['מארובוזו שחור - דובי']),
        (t.exports['Marubozu White - Bullish_study'] = ['מארובוזו לבן - שוורי']),
        (t.exports['Morning Doji Star - Bullish_study'] = ["כוכב בקר דוג'י - שוורי"]),
        ...
        (t.exports['Rising Three Methods - Bullish_study'] = ['Rising Three Methods - שוורי']),
        (t.exports['Rising Window - Bullish_study'] = ['Rising Window - שוורי']),
        (t.exports['Shooting Star - Bearish_study'] = ['Shooting Star - דובי']),
        (t.exports['Three Black Crows - Bearish_study'] = ['שלושה עורבים שחורים - דובי']),
        (t.exports['Three White Soldiers - Bullish_study'] = ['שלושה חיילים לבנים - שוורי']),
        (t.exports['Tri-Star - Bearish_study'] = ['Tri-Star - דובי']),
        (t.exports['Tri-Star - Bullish_study'] = ['Tri-Star - שוורי']),
        (t.exports['Tweezer Top - Bearish_study'] = ['Tweezer Top פינצטה טופ - דובי']),
        (t.exports['Upside Tasuki Gap - Bullish_study'] = ['Upside Tasuki Gap - שוורי']),
        ...
        (t.exports['Moving Average Hamming_study'] = ['ממוצע נע משוקלל Hamming']),
        (t.exports['Moving Average Modified_study'] = ['ממוצע נע מותאם Modified']),
        (t.exports['Moving Average Multiple_study'] = ['ממוצע נע מרובה Multiple']),
        (t.exports['Linear Regression Slope_study'] = ['רגרסיה לינארית משופעת']),
        ...
        (t.exports['Volatility Close-to-Close_study'] = ['תנודתיות Close-to-Close']),
        ...
        (t.exports['Advance Decline Ratio_study'] = ['Advance Decline Ratio ADR']),
        (t.exports['Advance/Decline Ratio (Bars)_study'] = ['Advance Decline Ratio ADR (ברים)']),
        (t.exports['BarUpDn Strategy_study'] = ['אסטרטגיית BarUpDn']),
        (t.exports['Bollinger Bands Strategy directed_study'] = ["אסטרטגיית רצועת בולינג'ר מכוון"]),
        (t.exports['Bollinger Bands Strategy_study'] = ["אסטרטגית רצועות בולינג'ר"]),
        ...
        (t.exports['Consecutive Up/Down Strategy_study'] = ['אסטרטגיית מעלה/מטה רציפה']),
        ...
        (t.exports['Keltner Channel Strategy_study'] = ['אסטרטגיית ערוצי קלנר']),
        ...
        (t.exports['Moving Average Convergence/Divergence_study'] = ['ממוצע נע התכנסות / סטייה']),
        ...
        (t.exports['Parabolic SAR Strategy_study'] = ['אסטרטגיית Parabolic SAR']),
        (t.exports['Pivot Extension Strategy_study'] = ['אסטרטגיית הרחבת פיבוט']),
        (t.exports['Pivot Points High Low_study'] = ['נקודות פיבוט גבוה נמוך']),
        (t.exports['Pivot Reversal Strategy_study'] = ['אסטרטגיית פיבוט ריוורסל']),
        ...
        (t.exports['Stochastic Slow Strategy_study'] = ['אסטרטגיית סטוקסטית איטית']),
        (t.exports['Volatility Stop_study'] = ['סטופ תנודתי']),
        (t.exports['Volty Expan Close Strategy_study'] = ['סגור אסטרטגיית Volty Expan']),
    ...
    979393: t => {
      t.exports = ['קוד הטמעת תמונת גרף הועתק ללוח {emoji}'];
    },
    59884: t => {
    ...
    107005: t => {
      t.exports = ['הוסף התראה על {title} ב-{price}'];
    },
    303612: t => {
    ...
    655980: t => {
      t.exports = ['הוסף את {symbol} לרשימת המעקב'];
    },
    717365: t => {
      t.exports = ['אדלייד'];
    },
    ...
    219149: t => {
      t.exports = ['הפעלת הפעלה חוזרת אינה זמינה עבור סוג גרף זה. האם ברצונך לצאת מהפעלה חוזרת?'];
    },
    838660: t => {
      t.exports = [
        'ההפעלה החוזרת של בר אינו זמין לאינטרוול זמן זה. האם אתה רוצה לצאת ממצב הפעלה חוזרת?',
      ];
    },
    16812: t => {
    ...
    665287: t => {
      t.exports = ['תוויות היצע וביקוש Bid&Ask'];
    },
    240548: t => {
      t.exports = ['קווי היצע וביקוש Bid&Ask'];
    },
    530251: t => {
      t.exports = ['מברשת'];
    },
    ...
    470213: t => {
      t.exports = ["חריגה ממגבלת המחקר: {number} מחקרים בכל פריסה.\nבבקשה, הסר מס' מחקרים."];
    },
    832733: t => {
      t.exports = ['עיצוב'];
    },
    ...
    590537: t => {
      t.exports = ['תווית ערך סגירה יום קודם לסימול'];
    },
    733606: t => {
    ...
    46669: t => {
      t.exports = ['אנא תן לנו הרשאת כתיבה ללוח בדפדפן שלך או הקש על ‎{keystroke}'];
    },
    35963: t => {
      t.exports = ['לחץ לחיצה ממושכת על {key} תוך כדי הגדלה כדי לשמור על מיקום הגרף'];
    },
    336857: t => {
      t.exports = ['סגירת קו מחיר יום קודם'];
    },
    495921: t => {
    ...
    308162: t => {
      t.exports = ['לא ניתן לטעון את התצוגה המקדימה של הפרסום. השבת את תוספי הדפדפן ונסה שוב.'];
    },
    465943: t => {
      t.exports = ['מתנד זה אינו יכול להיות מיושם על מתנד נוסף'];
    },
    874986: t => {
      t.exports = ['הסקריפט הזה מיועד להזמנה בלבד. כדי לבקש גישה, אנא צור קשר עם המחבר.'];
    },
    298538: t => {
    ...
    118562: t => {
      (t.exports = Object.create(null)),
        ...
        (t.exports['#AUDCHF-symbol-description'] = ['דולר אוסטרלי/פרנק שוויצרי']),
        (t.exports['#AUDJPY-symbol-description'] = ['דולר אוסטרלי/יין יפני']),
        (t.exports['#AUDNZD-symbol-description'] = ['דולר אוסטרלי/דולר ניו זילנד']),
        (t.exports['#AUDRUB-symbol-description'] = ['דולר אוסטרלי/רובל רוסי']),
        (t.exports['#AUDUSD-symbol-description'] = ['דולר אוסטרלי/דולר אמריקאי']),
        ...
        (t.exports['#BTCKRW-symbol-description'] = ['ביטקוין / וואן דרום קוריאני']),
        ...
        (t.exports['#GB10-symbol-description'] = ['אג"ח ממשלת בריטניה 10 שנים']),
        (t.exports['#GBPAUD-symbol-description'] = ['לירה שטרלינג / דולר אוסטרלי']),
        (t.exports['#GBPCAD-symbol-description'] = ['לירה שטרלינג / דולר קנדי']),
        (t.exports['#GBPCHF-symbol-description'] = ['לירה שטרלינג / פרנק שוויצרי']),
        (t.exports['#GBPEUR-symbol-description'] = ['לירה שטרלינג / יורו']),
        (t.exports['#GBPJPY-symbol-description'] = ['לירה שטרלינג / יין יפני']),
        (t.exports['#GBPNZD-symbol-description'] = ['לירה שטרלינג / דולר ניו זילנד']),
        (t.exports['#GBPRUB-symbol-description'] = ['לירה שטרלינג / רובל רוסי']),
        (t.exports['#GBPUSD-symbol-description'] = ['לירה שטרלינג / דולר אמריקאי']),
        ...
        (t.exports['#JPYKRW-symbol-description'] = ['יין יפני / וואן דרום קוריאני']),
        ...
        (t.exports['#MSFT-symbol-description'] = ['Microsoft Corp חברת מיקרוסופט']),
        ...
        (t.exports['#NZDJPY-symbol-description'] = ['דולר ניו זילנד / יין יפני']),
        (t.exports['#NZDUSD-symbol-description'] = ['דולר ניו זילנד / דולר אמריקאי']),
        ...
        (t.exports['#USDBRL-symbol-description'] = ['דולר אמריקאי / ריאל ברזילאי']),
        (t.exports['#USDCAD-symbol-description'] = ['דולר אמריקאי / דולר קנדי']),
        (t.exports['#USDCHF-symbol-description'] = ['דולר אמריקאי / פרנק שוויצרי']),
        (t.exports['#USDCNY-symbol-description'] = ['דולר אמריקאי / יואן סיני']),
        (t.exports['#USDDKK-symbol-description'] = ['דולר אמריקאי / קורנה דנמרק']),
        (t.exports['#USDHKD-symbol-description'] = ['דולר אמריקאי / דולר הונג קונג']),
        (t.exports['#USDIDR-symbol-description'] = ['דולר אמריקאי / רופיה']),
        (t.exports['#USDINR-symbol-description'] = ['דולר אמריקאי / רופי הודי']),
        (t.exports['#USDJPY-symbol-description'] = ['דולר אמריקאי / יין יפני']),
        (t.exports['#USDKRW-symbol-description'] = ['דולר אמריקאי / וואן דרום קוראני']),
        (t.exports['#USDMXN-symbol-description'] = ['דולר אמריקאי / פאסו מקסיקני']),
        (t.exports['#USDPHP-symbol-description'] = ['דולר אמריקאי / פאסו פיליפיני']),
        (t.exports['#USDRUB-symbol-description'] = ['דולר אמריקאי / רובל רוסי']),
        (t.exports['#USDRUB_TOM-symbol-description'] = ['דולר אמריקאי / רובל רוסי']),
        (t.exports['#USDSEK-symbol-description'] = ['דולר אמריקאי / קורונה שוודי']),
        (t.exports['#USDSGD-symbol-description'] = ['דולר אמריקאי / דולר סינגפור']),
        (t.exports['#USDTRY-symbol-description'] = ['דולר אמריקאי / לירה טורקית']),
        ...
        (t.exports['#MICEXINDEXCF-symbol-description'] = ['MICEX אינדקס רוסיה']),
        ...
        (t.exports['#ITI2!-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIF2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIF2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIF2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIG2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIG2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIG2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIH2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIH2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIH2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIJ2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIJ2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIJ2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIK2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIK2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIK2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIM2017-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIM2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIM2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIM2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIN2017-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIN2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIN2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIN2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIQ2017-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIQ2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIQ2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIQ2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIU2017-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIU2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIU2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIU2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIV2017-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIV2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIV2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIV2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIX2017-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIX2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIX2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIX2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIZ2017-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIZ2018-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIZ2019-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#ITIZ2020-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#AMEX:GXF-symbol-description'] = 'Global x FTSE Nordic Region ETF'),
        (t.exports['#ASX:XAF-symbol-description'] = 'S&P/ASX All Australian 50 Index'),
        (t.exports['#ASX:XAT-symbol-description'] = 'S&P/ASX All Australian 200 Index'),
        (t.exports['#BIST:XU100-symbol-description'] = 'BIST 100 Index'),
        (t.exports['#GPW:WIG20-symbol-description'] = 'WIG20 Index'),
        (t.exports['#INDEX:JKSE-symbol-description'] = 'Jakarta Composite Index'),
        (t.exports['#INDEX:KLSE-symbol-description'] = ['אינדקס בורסת מלזיה KLCI']),
        (t.exports['#INDEX:NZD-symbol-description'] = 'NZX 50 Index'),
        (t.exports['#INDEX:STI-symbol-description'] = 'STI Index'),
        (t.exports['#INDEX:XLY0-symbol-description'] = 'Shanghai Composite Index'),
        (t.exports['#MOEX:MICEXINDEXCF-symbol-description'] = 'MOEX Russia Index'),
        (t.exports['#NYMEX:KT1!-symbol-description'] = ['חוזים עתידיים על קפה']),
        (t.exports['#OANDA:NATGASUSD-symbol-description'] = 'CFDs on Natural Gas'),
        (t.exports['#OANDA:USDPLN-symbol-description'] = ['דולר אמריקאי / זלוטי פולני']),
        ...
        (t.exports['#TVC:ES10-symbol-description'] = 'Spain Government Bonds 10 YR'),
        (t.exports['#TVC:EUBUND-symbol-description'] = 'Euro Bund'),
        (t.exports['#TVC:GB02-symbol-description'] = 'UK Government Bonds 2 YR'),
        (t.exports['#TVC:GB10-symbol-description'] = 'UK Government Bonds 10 YR'),
        (t.exports['#TVC:GOLD-symbol-description'] = ['CFDs על זהב (US$ / OZ)']),
        (t.exports['#TVC:ID03-symbol-description'] = 'Indonesia Government Bonds 3 YR'),
        (t.exports['#TVC:ID10-symbol-description'] = 'Indonesia Government Bonds 10 YR'),
        (t.exports['#TVC:PALLADIUM-symbol-description'] = 'CFDs on Palladium (US$ / OZ)'),
        (t.exports['#TVC:PT10-symbol-description'] = 'Portugal Government Bonds 10 YR'),
        (t.exports['#TVC:SILVER-symbol-description'] = 'CFDs on Silver (US$ / OZ)'),
        ...
        (t.exports['#TVC:SHCOMP-symbol-description'] = 'Shanghai Composite Index'),
        ...
        (t.exports['#TVC:AU10-symbol-description'] = 'Australia Government Bonds 10 YR'),
        (t.exports['#TVC:CN10-symbol-description'] = 'China Government Bonds 10 YR'),
        (t.exports['#TVC:KR10-symbol-description'] = 'Korea Government Bonds 10 YR'),
        (t.exports['#NYMEX:RB1!-symbol-description'] = ['חוזים עתידיים על בנזין RBOB']),
        (t.exports['#NYMEX:HO1!-symbol-description'] = ['חוזים עתידיים על נמל NY ULSD']),
        (t.exports['#NYMEX:AEZ1!-symbol-description'] = ['חוזים עתידיים אתנול ניו יורק']),
        (t.exports['#OANDA:XCUUSD-symbol-description'] = 'CFDs on Copper (US$ / lb)'),
        (t.exports['#COMEX:ZA1!-symbol-description'] = ['חוזים עתידיים אבץ']),
        (t.exports['#CBOT:ZW1!-symbol-description'] = ['חוזים עתידיים על חיטה']),
        (t.exports['#NYMEX:KA1!-symbol-description'] = ['חוזים עתידיים סוכר #11']),
        (t.exports['#CBOT:QBC1!-symbol-description'] = ['חוזים עתידיים על תירס']),
        (t.exports['#CME:E61!-symbol-description'] = ['חוזים עתידיים אירו']),
        (t.exports['#CME:B61!-symbol-description'] = ['חוזים עתידיים על הפאונד הבריטי']),
        (t.exports['#CME:QJY1!-symbol-description'] = ['חוזים עתידיים ין יפני']),
        (t.exports['#CME:A61!-symbol-description'] = ['חוזים עתידיים דולר אוסטרלי']),
        (t.exports['#CME:D61!-symbol-description'] = ['חוזים עתידיים על דולר קנדי']),
        (t.exports['#CME:SP1!-symbol-description'] = ['חוזים עתידיים S&P 500']),
        (t.exports['#CME_MINI:NQ1!-symbol-description'] = ['חוזים עתידיים נאסד"ק 100 E-mini']),
        (t.exports['#CBOT_MINI:YM1!-symbol-description'] = ["חוזים עתידיים E-mini דאו ג'ונס ($5)"]),
        (t.exports['#CME:NY1!-symbol-description'] = ['חוזים עתידיים ניקיי 225']),
        (t.exports['#EUREX:DY1!-symbol-description'] = ['מדד דאקס']),
        (t.exports['#CME:IF1!-symbol-description'] = ['חוזים עתידיים על מדד IBOVESPA-$']),
        (t.exports['#CBOT:TY1!-symbol-description'] = ['חוזים עתידיים על שטרות אג"ח ל-10 שנים']),
        (t.exports['#CBOT:FV1!-symbol-description'] = ['חוזים עתידיים על שטרות אג"ח ל-5 שנים']),
        (t.exports['#CBOT:ZE1!-symbol-description'] = ['חוזים עתידיים שטרות אג"ח -  לשלוש שנים']),
        (t.exports['#CBOT:TU1!-symbol-description'] = ['חוזים עתידיים על שטרות אג"ח לשנתיים']),
        (t.exports['#CBOT:FF1!-symbol-description'] = [
          'חוזים עתידיים על ריבית של קרנות FED ל-30 יום',
        ]),
        (t.exports['#CBOT:US1!-symbol-description'] = ['חוזים עתידיים על T-Bond']),
        (t.exports['#TVC:EXY-symbol-description'] = 'Euro Currency Index'),
        (t.exports['#TVC:JXY-symbol-description'] = 'Japanese Yen Currency Index'),
        (t.exports['#TVC:BXY-symbol-description'] = 'British Pound Currency Index'),
        (t.exports['#TVC:AXY-symbol-description'] = 'Australian Dollar Currency Index'),
        (t.exports['#TVC:CXY-symbol-description'] = 'Canadian Dollar Currency Index'),
        (t.exports['#FRED:GDP-symbol-description'] = 'Gross Domestic Product, 1 Decimal'),
        (t.exports['#FRED:UNRATE-symbol-description'] = 'Civilian Unemployment Rate'),
        ...
        (t.exports['#COMEX:HG1!-symbol-description'] = ['חוזים עתידיים על נחושת']),
        (t.exports['#INDEX:HSCE-symbol-description'] = 'Hang Seng China Enterprises Index'),
        (t.exports['#NYMEX:CL1!-symbol-description'] = ['חוזים עתידיים נפט גולמי']),
        (t.exports['#OTC:IHRMF-symbol-description'] = 'Ishares MSCI Japan SHS'),
        (t.exports['#TVC:DAX-symbol-description'] = ['מדד דאקס']),
        (t.exports['#TVC:DE10-symbol-description'] = 'German Government Bonds 10 YR'),
        (t.exports['#TVC:DJI-symbol-description'] = ["מדד דאו ג'ונס"]),
        (t.exports['#TVC:DXY-symbol-description'] = ['מדד מטבע דולר אמריקאי']),
        (t.exports['#TVC:FR10-symbol-description'] = 'France Government Bonds 10 YR'),
        ...
        (t.exports['#AMEX:SHY-symbol-description'] = 'Ishares 1-3 Year Treasury Bond ETF'),
        ...
        (t.exports['#NYMEX:NG1!-symbol-description'] = ['חוזים עתידיים גז טבעי']),
        (t.exports['#NYMEX:ZC1!-symbol-description'] = ['חוזים עתידיים תירס']),
        (t.exports['#TVC:IN10-symbol-description'] = 'India Government Bonds 10 YR'),
        (t.exports['#TVC:IT10-symbol-description'] = 'Italy Government Bonds 10 YR'),
        (t.exports['#TVC:JP10-symbol-description'] = 'Japan Government Bonds 10 YR'),
        ...
        (t.exports['#TVC:TR10-symbol-description'] = 'Turkey Government Bonds 10 YR'),
        (t.exports['#TVC:UKOIL-symbol-description'] = ['CFDs על ברנט גולמי']),
        (t.exports['#TVC:UKX-symbol-description'] = ['מדד בריטניה 100']),
        (t.exports['#TVC:US02-symbol-description'] = 'US Government Bonds 2 YR'),
        (t.exports['#TVC:US05-symbol-description'] = 'US Government Bonds 5 YR'),
        (t.exports['#TVC:US10-symbol-description'] = 'US Government Bonds 10 YR'),
        (t.exports['#TVC:USOIL-symbol-description'] = 'CFDs on WTI Crude Oil'),
        (t.exports['#NYMEX:ITI1!-symbol-description'] = ['חוזים עתידיים על עפרות ברזל']),
        (t.exports['#NASDAQ:SHY-symbol-description'] = 'Ishares 1-3 Year Treasury Bond ETF'),
        (t.exports['#AMEX:ALD-symbol-description'] = ['תעודת סל לחובות מקומיים WisdomTree אסיה']),
        (t.exports['#NASDAQ:AMD-symbol-description'] = ['מכשירי מיקרו מתקדמים בע"מ']),
        (t.exports['#NYSE:BABA-symbol-description'] = ['אחזקות קבוצת עליבאבא בע"מ']),
        ...
        (t.exports['#NASDAQ:CTRV-symbol-description'] = ['חברת ContraVir Pharmaceuticals Inc.']),
        ...
        (t.exports['#NASDAQ:IEF-symbol-description'] = 'Ishares 7-10 Year Treasury Bond ETF'),
        (t.exports['#NASDAQ:IEI-symbol-description'] = 'Ishares 3-7 Year Treasury Bond ETF'),
        (t.exports['#NYMEX:KA1-symbol-description'] = ['חוזים עתידיים סוכר #11']),
        ...
        (t.exports['#NYMEX:RB1-symbol-description'] = ['חוזים עתידיים גז RBOB']),
        (t.exports['#MOEX:SBER-symbol-description'] = 'SBERBANK'),
        (t.exports['#AMEX:SCHO-symbol-description'] = 'Schwab Short-Term U.S. Treasury ETF'),
        (t.exports['#COMEX:SI-symbol-description'] = ['כסף']),
        (t.exports['#NASDAQ:TLT-symbol-description'] = 'Ishares 20+ Year Treasury Bond ETF'),
        ...
        (t.exports['#CADUSD-symbol-description'] = ['דולר קנדי / דולר אמריקאי']),
        (t.exports['#CHFUSD-symbol-description'] = ['פרנק שוויצרי / דולר אמריקאי']),
        (t.exports['#GPW:ACG-symbol-description'] = 'Acautogaz'),
        (t.exports['#JPYUSD-symbol-description'] = ['ין יפני / דולר אמריקאי']),
        (t.exports['#USDAUD-symbol-description'] = ['דולר אמריקאי / דולר אוסטרלי']),
        (t.exports['#USDEUR-symbol-description'] = ['דולר אמריקאי / אירו']),
        (t.exports['#USDGBP-symbol-description'] = ['דולר אמריקאי / לירה שטרלינג']),
        (t.exports['#USDNZD-symbol-description'] = ['דולר אמריקאי / דולר ניו זילנדי']),
        (t.exports['#UKOIL-symbol-description'] = ['CFDs על נפט גולמי (ברנט)']),
        (t.exports['#USOIL-symbol-description'] = 'CFDs on Crude Oil (WTI)'),
        (t.exports['#US30-symbol-description'] = ["מדד דאו ג'ונס הממוצע התעשייתי"]),
        (t.exports['#BCHUSD-symbol-description'] = ['ביטקוין קאש / דולר ארה"ב']),
        (t.exports['#ETCUSD-symbol-description'] = ['אתריום קלאסיק / דולר אמריקאי']),
        ...
        (t.exports['#TVC:US30-symbol-description'] = 'US Government Bonds 30 YR'),
        (t.exports['#COMEX:SI1!-symbol-description'] = ['חוזים עתידיים על כסף']),
        (t.exports['#BTGUSD-symbol-description'] = ['ביטקוין גולד / דולר אמריקאי']),
        (t.exports['#IOTUSD-symbol-description'] = ['איוטא / דולר אמריקאי']),
        (t.exports['#CME:BTC1!-symbol-description'] = ['חוזים עתידיים ביטקוין - CME']),
        ...
        (t.exports['#DJ:DJA-symbol-description'] = ["מדד Composite Average של דאו ג'ונס"]),
        ...
        (t.exports['#GBPPLN-symbol-description'] = 'British Pound / Polish Zloty'),
        (t.exports['#MOEX:BR1!-symbol-description'] = ['חוזים עתידיים על נפט ברנט']),
        (t.exports['#NYMEX:KG1!-symbol-description'] = ['חוזים עתידיים כותנה']),
        (t.exports['#NYMEX:PL1!-symbol-description'] = ['חוזים עתידיים על פלטינום']),
        ...
        (t.exports['#USDZAR-symbol-description'] = ['דולר אמריקאי / ראנד דרום אפריקני']),
        ...
        (t.exports['#TVC:PLATINUM-symbol-description'] = 'CFDs on Platinum (US$ / OZ)'),
        (t.exports['#TVC:SSMI-symbol-description'] = ['מדד שוק שוויצרי']),
        (t.exports['#TVC:SXY-symbol-description'] = 'Swiss Franc Currency Index'),
        ...
        (t.exports['#TVC:MY10-symbol-description'] = 'Malaysia Government Bonds 10 YR'),
        ...
        (t.exports['#TVC:ZXY-symbol-description'] = 'New Zealand Dollar Currency Index'),
        ...
        (t.exports['#TVC:GB10Y-symbol-description'] = 'UK Government Bonds 10 YR Yield'),
        (t.exports['#TVC:AU10Y-symbol-description'] = 'Australia Government Bonds 10 YR Yield'),
        (t.exports['#TVC:CN10Y-symbol-description'] = 'China Government Bonds 10 YR Yield'),
        (t.exports['#TVC:DE10Y-symbol-description'] = 'German Government Bonds 10 YR Yield'),
        (t.exports['#TVC:ES10Y-symbol-description'] = 'Spain Government Bonds 10 YR Yield'),
        (t.exports['#TVC:FR10Y-symbol-description'] = 'France Government Bonds 10 YR Yield'),
        (t.exports['#TVC:IN10Y-symbol-description'] = [
          'איגרות חוב ממשלתיות בהודו בתשואה של 10 שנים',
        ]),
        (t.exports['#TVC:IT10Y-symbol-description'] = ['איגרות חוב ממשלתיות באיטליה 10 שנים']),
        (t.exports['#TVC:JP10Y-symbol-description'] = [
          'איגרות חוב ממשלתיות של יפן בתשואה של 10 שנים',
        ]),
        (t.exports['#TVC:KR10Y-symbol-description'] = 'Korea Government Bonds 10 YR Yield'),
        (t.exports['#TVC:MY10Y-symbol-description'] = 'Malaysia Government Bonds 10 YR Yield'),
        (t.exports['#TVC:PT10Y-symbol-description'] = 'Portugal Government Bonds 10 YR Yield'),
        (t.exports['#TVC:TR10Y-symbol-description'] = [
          'איגרות חוב ממשלתיות בטורקיה בתשואה של 10 שנים',
        ]),
        (t.exports['#TVC:US02Y-symbol-description'] = ['איגרות חוב ממשלתיות בארה"ב של 2 שנים']),
        ...
        (t.exports['#CME:J61!-symbol-description'] = ['חוזים עתידיים על ין יפני']),
        (t.exports['#CME_MINI:J71!-symbol-description'] = ['חוזים עתידיים E-mini על ין יפני']),
        (t.exports['#CME_MINI:WM1!-symbol-description'] = [
          'חוזים עתידיים E-micro יין יפני / דולר אמריקאי',
        ]),
        (t.exports['#CME:M61!-symbol-description'] = ['חוזים עתידיים על פזו מקסיקני']),
        (t.exports['#CME:T61!-symbol-description'] = ['חוזים עתידיים ראנד דרום אפריקאי']),
        (t.exports['#CME:SK1!-symbol-description'] = ['חוזים עתידיים על קרונה שוודית']),
        (t.exports['#CME:QT1!-symbol-description'] = ['חוזים עתידיים רנמינבי סיני / דולר אמריקאי']),
        (t.exports['#COMEX:AUP1!-symbol-description'] =
          'Aluminum MW U.S. Transaction Premium Platts (25MT) Futures'),
        (t.exports['#CME:L61!-symbol-description'] = ['חוזים עתידיים על ריאל ברזילאי']),
        (t.exports['#CME:WP1!-symbol-description'] = ['חוזים עתידיים על זלוטי פולני']),
        (t.exports['#CME:N61!-symbol-description'] = ['חוזים עתידיים על דולר ניו זילנדי']),
        ...
        (t.exports['#CME_MINI:E71!-symbol-description'] = ['חוזים עתידיים E-mini יורו']),
        (t.exports['#CBOT:ZK1!-symbol-description'] = 'Denatured Fuel Ethanol Futures'),
        (t.exports['#CME_MINI:MB1!-symbol-description'] = [
          'חוזים עתידיים E-micro לירה שטרלינג / דולר אמריקאי',
        ]),
        (t.exports['#NYMEX_MINI:QU1!-symbol-description'] = ['חוזים עתידיים E-mini בנזין']),
        (t.exports['#NYMEX_MINI:QX1!-symbol-description'] = 'E-mini Heating Oil Futures'),
        (t.exports['#COMEX_MINI:QC1!-symbol-description'] = ['חוזים עתידיים E-mini נחושת']),
        (t.exports['#NYMEX_MINI:QG1!-symbol-description'] = ['חוזים עתידיים E-mini גז טבעי']),
        (t.exports['#CME:E41!-symbol-description'] = ['חוזים עתידיים דולר אמריקאי / לירה טורקית']),
        (t.exports['#COMEX_MINI:QI1!-symbol-description'] = ['חוזים עתידיים (Mini) כסף']),
        (t.exports['#CME:DL1!-symbol-description'] = 'Milk, Class III Futures'),
        (t.exports['#NYMEX:UX1!-symbol-description'] = ['חוזים עתידיים אורניום']),
        (t.exports['#CBOT:BO1!-symbol-description'] = ['חוזים עתידיים שמן סויה']),
        (t.exports['#CME:HE1!-symbol-description'] = 'Lean Hogs Futures'),
        (t.exports['#NYMEX:IAC1!-symbol-description'] = 'Newcastle Coal Futures'),
        (t.exports['#NYMEX_MINI:QM1!-symbol-description'] = 'E-mini Light Crude Oil Futures'),
        (t.exports['#NYMEX:JMJ1!-symbol-description'] = ['מיני ברנט חוזים עתידיים פיננסיים']),
        (t.exports['#COMEX:AEP1!-symbol-description'] = 'Aluminium European Premium Futures'),
        (t.exports['#CBOT:ZQ1!-symbol-description'] = '30 Day Federal Funds Interest Rate Futures'),
        (t.exports['#CME:LE1!-symbol-description'] = 'Live Cattle Futures'),
        (t.exports['#CME:UP1!-symbol-description'] = ['חוזים עתידיים פרנק שוויצרי / ין יפני']),
        (t.exports['#CBOT:ZN1!-symbol-description'] = ['חוזים עתידיים 10 שנים T-Note']),
        (t.exports['#CBOT:ZB1!-symbol-description'] = ['חוזים עתידיים של T-Bond']),
        (t.exports['#CME:GF1!-symbol-description'] = 'Feeder Cattle Futures'),
        (t.exports['#CBOT:UD1!-symbol-description'] = 'Ultra T-Bond Futures'),
        (t.exports['#CME:I91!-symbol-description'] = 'CME Housing Futures — Washington DC'),
        (t.exports['#CBOT:ZO1!-symbol-description'] = ['חוזים עתידיים שיבולת שועל']),
        (t.exports['#CBOT:ZM1!-symbol-description'] = ['חוזים עתידיים על ארוחות סויה']),
        (t.exports['#CBOT_MINI:XN1!-symbol-description'] = ['מיני חוזים עתידיים תירס']),
        (t.exports['#CBOT:ZC1!-symbol-description'] = ['חוזים עתידיים תירס']),
        (t.exports['#CME:LS1!-symbol-description'] = ['חוזים עתידיים על עץ']),
        (t.exports['#CBOT_MINI:XW1!-symbol-description'] = ['מיני חוזים עתידיים חיטה']),
        (t.exports['#CBOT_MINI:XK1!-symbol-description'] = ['מיני חוזים עתידיים על פולי סויה']),
        (t.exports['#CBOT:ZS1!-symbol-description'] = ['חוזים עתידיים על פולי סויה']),
        (t.exports['#NYMEX:PA1!-symbol-description'] = ['חוזים עתידיים פלדיום']),
        (t.exports['#CME:FTU1!-symbol-description'] = 'E-mini FTSE 100 Index USD Futures'),
        (t.exports['#CBOT:ZR1!-symbol-description'] = ['חוזים עתידיים אורז']),
        (t.exports['#COMEX_MINI:GR1!-symbol-description'] = ['חוזים עתידיים זהב (E-micro)']),
        (t.exports['#COMEX_MINI:QO1!-symbol-description'] = ['חוזים עתידיים זהב (Mini)']),
        (t.exports['#CME_MINI:RL1!-symbol-description'] = ['חוזים עתידיים E-mini Russell 1000']),
        (t.exports['#CME_MINI:EW1!-symbol-description'] = ['חוזים עתידיים E-mini Midcap S&P 400']),
        (t.exports['#COMEX:LD1!-symbol-description'] = 'Lead Futures'),
        (t.exports['#CME_MINI:ES1!-symbol-description'] = ['חוזים עתידיים E-mini S&P 500']),
        (t.exports['#TVC:SA40-symbol-description'] = ['מדד Top 40 דרום אפריקה']),
        ...
        (t.exports['#BVL:SPBLPGPT-symbol-description'] = 'S&P / BVL Peru General Index (PEN)'),
        (t.exports['#EGX:EGX30-symbol-description'] = 'EGX 30 Price Return Index'),
        ...
        (t.exports['#NZX:NZ50G-symbol-description'] = 'S&P / NZX 50 Index Gross'),
        (t.exports['#SIX:SMI-symbol-description'] = ['מדד שוק שוויצרי']),
        (t.exports['#SZSE:399001-symbol-description'] = ['מדד SZSE Component']),
        (t.exports['#TADAWUL:TASI-symbol-description'] = ['מדד כל המניות של Tadawul']),
        (t.exports['#IDX:COMPOSITE-symbol-description'] = ['מדד IDX Composite']),
        (t.exports['#EURONEXT:PX1-symbol-description'] = ['מדד CAC 40']),
        (t.exports['#OMXHEX:OMXH25-symbol-description'] = ['מדד OMX הלסינקי 25']),
        ...
        (t.exports['#TVC:KOSPI-symbol-description'] = ['מדד מחירי המניות של קוריאה']),
        (t.exports['#FTSEMYX:FBMKLCI-symbol-description'] = ['מדד FTSE בורסת מלזיה KLCI']),
        (t.exports['#TASE:TA35-symbol-description'] = ['מדד תל אביב 35']),
        (t.exports['#OMXSTO:OMXS30-symbol-description'] = ['מדד OMX שטוקהולם 30']),
        (t.exports['#OMXICE:OMXI8-symbol-description'] = ['מדד OMX איסלנד 8']),
        (t.exports['#NSENG:NSE30-symbol-description'] = ['מדד NSE 30']),
        (t.exports['#BAHRAIN:BSEX-symbol-description'] = ['מדד כל מניות בחריין']),
        (t.exports['#OMXTSE:OMXTGI-symbol-description'] = 'OMX Tallinn GI'),
        (t.exports['#OMXCOP:OMXC25-symbol-description'] = ['מדד OMX קופנהגן 25']),
        ...
        (t.exports['#CBOE:VIX-symbol-description'] = ['מדד Volatility S&P 500']),
        (t.exports['#NASDAQ:XAU-symbol-description'] = 'PHLX Gold and Silver Sector Index'),
        (t.exports['#DJ:DJUSCL-symbol-description'] = ['מדד דאו ג\'ונס פחם ארה"ב']),
        (t.exports['#DJ:DJCIKC-symbol-description'] = ["מדד דאו ג'ונס סחורות קפה"]),
        (t.exports['#DJ:DJCIEN-symbol-description'] = ["דאו ג'ונס מדד סחורות האנרגיה"]),
        (t.exports['#NASDAQ:OSX-symbol-description'] = 'PHLX Oil Service Sector Index'),
        (t.exports['#DJ:DJCISB-symbol-description'] = ["דאו ג'ונס מדד סחורות הסוכר"]),
        (t.exports['#DJ:DJCICC-symbol-description'] = ["דאו ג'ונס מדד סחורות הקקאו"]),
        (t.exports['#DJ:DJCIGR-symbol-description'] = ["מדד דאו ג'ונס סחורות דגנים"]),
        (t.exports['#DJ:DJCIAGC-symbol-description'] =
          'Dow Jones Commodity Index Agriculture Capped Component'),
        (t.exports['#DJ:DJCISI-symbol-description'] = ["דאו ג 'ונס מדד סחורות כסף"]),
        (t.exports['#DJ:DJCIIK-symbol-description'] = ["מדד דאו ג 'ונס סחורות ניקל"]),
        (t.exports['#NASDAQ:HGX-symbol-description'] = 'PHLX Housing Sector Index'),
        (t.exports['#DJ:DJCIGC-symbol-description'] = ["מדד דאו ג'ונס סחורות זהב"]),
        (t.exports['#SP:SPGSCI-symbol-description'] = 'S&P Goldman Sachs Commodity Index'),
        (t.exports['#NASDAQ:UTY-symbol-description'] = 'PHLX Utility Sector Index'),
        (t.exports['#DJ:DJU-symbol-description'] = 'Dow Jones Utility Average Index'),
        ...
        (t.exports['#NASDAQ:SOX-symbol-description'] = ['מדד מוליכים למחצה פילדלפיה']),
        ...
        (t.exports['#NYSE:XMI-symbol-description'] = 'NYSE ARCA Major Market Index'),
        (t.exports['#NYSE:XAX-symbol-description'] = ['מדד AMEX Composite']),
        (t.exports['#NASDAQ:NDX-symbol-description'] = ['מדד נאסד"ק 100']),
        (t.exports['#NASDAQ:IXIC-symbol-description'] = ['מדד Nasdaq Composite']),
        (t.exports['#DJ:DJT-symbol-description'] = ["מדד דאו ג'ונס ממוצע תחבורה"]),
        (t.exports['#NYSE:NYA-symbol-description'] = ['מדד NYSE Composite']),
        (t.exports['#NYMEX:CJ1!-symbol-description'] = ['חוזים עתידיים על קקאו']),
        (t.exports['#USDILS-symbol-description'] = ['דולר אמריקאי / שקל ישראלי']),
        ...
        (t.exports['#TVC:PL10Y-symbol-description'] = ['אג"ח ממשלת פולין תשואה 10 שנים']),
        (t.exports['#TVC:PL05Y-symbol-description'] = ['אג"ח ממשלת פולין תשואה 5 שנים']),
        (t.exports['#SET:GC-symbol-description'] = ['חיבורים גלובליים חברה ציבורית']),
        (t.exports['#TSX:GC-symbol-description'] = ['תאגיד המשחקים הנהדר של קנדה']),
        ...
        (t.exports['#BITMEX:ETHUSD-symbol-description'] = ['ETHUSD  חוזים עתידיים תמידיים']),
        (t.exports['#DERIBIT:BTCUSD-symbol-description'] = ['BTCUSD חוזים עתידיים תמידיים']),
        (t.exports['#DERIBIT:ETHUSD-symbol-description'] = ['ETHUSD חוזים עתידיים תמידיים']),
        (t.exports['#USDHUF-symbol-description'] = ['דולר ארה"ב/פורינט הונגרי']),
        (t.exports['#USDTHB-symbol-description'] = ['דולר ארה"ב/בהט תאילנדי']),
        (t.exports['#FOREXCOM:US2000-symbol-description'] = ['Small Cap ארה"ב 2000']),
        (t.exports['#TSXV:PBR-symbol-description'] = ['Para Resources Inc.']),
        (t.exports['#NYSE:SI-symbol-description'] = ['חברת Silvergate Capital']),
        ...
        (t.exports['#NEO:HE-symbol-description'] = ['חברת שירותי אנרגיה הוואי.']),
        (t.exports['#NYSE:HE-symbol-description'] = ['תעשיות חשמל הוואי']),
        (t.exports['#OMXCOP:SCHO-symbol-description'] = 'Schouw & Co A/S'),
        (t.exports['#TSX:HE-symbol-description'] = ['חברת שירותי אנרגיה הוואי.']),
        (t.exports['#BSE:ITI-symbol-description'] = ['ITI בע"מ']),
        (t.exports['#NSE:ITI-symbol-description'] = ['תעשיות טלפון הודיות בע"מ']),
        (t.exports['#TSX:LS-symbol-description'] = [
          'קרן הדיבידנד של Middlefield Healthcare & מדעי החיים',
        ]),
        (t.exports['#BITMEX:XBT-symbol-description'] = ['מדד ביטקוין/דולר ארה"ב']),
        (t.exports['#CME_MINI:RTY1!-symbol-description'] = [
          'E-Mini ראסל 2000 אינדקס חוזים עתידיים',
        ]),
        (t.exports['#CRYPTOCAP:TOTAL-symbol-description'] = ['שווי שוק קריפטו כולל, $']),
        (t.exports['#ICEUS:DX1!-symbol-description'] = ['חוזים עתידיים על מדד דולר ארה"ב']),
        (t.exports['#NYMEX:TT1!-symbol-description'] = ['חוזים עתידיים כותנה']),
        (t.exports['#PHEMEX:BTCUSD-symbol-description'] = ['חוזה עתידי תמידי של BTC']),
        (t.exports['#PHEMEX:ETHUSD-symbol-description'] = ['חוזה עתידי תמידי של ETH']),
        (t.exports['#PHEMEX:XRPUSD-symbol-description'] = ['חוזה עתידי תמידי של XRP']),
        (t.exports['#PHEMEX:LTCUSD-symbol-description'] = ['חוזה עתידי תמידי של LTC']),
        ...
        (t.exports['#TVC:CA10-symbol-description'] = ['אגרות חוב ממשלתיות קנדיות, 10 שנים']),
        ...
        (t.exports['#TVC:NL10-symbol-description'] = ['אגרות חוב ממשלתיות בהולנד, 10 שנים']),
        (t.exports['#TVC:NL10Y-symbol-description'] = [
          'איגרות חוב של ממשלת הולנד בתשואה של 10 שנים',
        ]),
        (t.exports['#TVC:NZ10-symbol-description'] = ['איגרות חוב ממשלתיות בניו זילנד, 10 שנים']),
        ...
        (t.exports['#ETHKRW-symbol-description'] = ["את'ריום / וון דרום קוריאני"]),
        ...
        (t.exports['#TVC:EU10YY-symbol-description'] = ['#TVC:EU10YY-תיאור-סימול']);
    },
  },
]);
