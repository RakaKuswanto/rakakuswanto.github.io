(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8890, 959, 6437],
  {
            ...
            if (o) {
              ...
              if (
                ...
                (i = [].concat(t(i), [m])),
                  ...
                  a ||
                    (document.addEventListener('touchmove', d, n ? { passive: !1 } : void 0),
                    (a = !0));
              }
            } else {
              (f = r),
    ...
    171529: (e, t, n) => {
      ...
      function c(e) {
        const {
          ...
          _ = (function (e) {
            ...
            return (
              0 !== e &&
                (1 & e && (t = o(t, l()['no-corner-top-left'])),
                2 & e && (t = o(t, l()['no-corner-top-right'])),
                4 & e && (t = o(t, l()['no-corner-bottom-right'])),
                8 & e && (t = o(t, l()['no-corner-bottom-left']))),
              t
            );
      ...
      function u(e) {
        ...
        return r.createElement(
          ...
          i && r.createElement('span', { className: l().content }, i),
          s && !o && r.createElement(a.Icon, { icon: s, className: l()['end-icon-wrap'] }),
          m &&
            (function (e) {
              return (
                e.primaryText &&
      ...
      function p(e) {
        ...
        return { ...f, ...(0, m.filterDataProps)(e), ...(0, m.filterAriaProps)(e) };
      }
      function f(e) {
        const { reference: t, ...n } = e,
          ...
          s = c({ ...n, isGrouped: o, cellState: i, disablePositionAdjustment: a });
        return r.createElement(
          'button',
      ...
      function i(e) {
        ...
        return (
          (0, r.useLayoutEffect)(() => {
            ...
            return (0, o.addOutsideEventListener)(d.current, r, s, c, e);
          }, [t, n, i, a, s]),
          l || u
        );
      }
    ...
    285089: (e, t, n) => {
      ...
      function l(e) {
        ...
        if (e && 1 == ++a) {
          ...
          let e = 0;
          (e = n
            ? ((l = (0, r.getContentWidth)(n)), o() ? 0 : i() ? 45 : Math.min(Math.max(l, 45), 450))
            : 0),
    ...
    531275: (e, t, n) => {
      'use strict';
      n.d(t, { SimpleDialogContext: () => r });
      const r = n(50959).createContext({ isSmallTablet: !1, dialogCloseHandler: () => {} });
    },
    480994: (e, t, n) => {
      'use strict';
      n.r(t),
      ...
      function u(e) {
        const {
          ...
          { isSmallTablet: m } = (0, r.useContext)(s.SimpleDialogContext),
          p = r.useRef(null);
        return (
          (0, r.useLayoutEffect)(() => {
          ...
          r.createElement(
            ...
            null,
            (function () {
              if ('content' in e) return r.createElement('div', { className: c.label }, e.content);
              if ('html' in e)
      ...
      const g = function (e) {
        ...
        y = function (e) {
          const {
            ...
            C = (0, r.useRef)(null),
            [w, b] = (0, r.useState)(l || ''),
            [x, E] = (0, r.useState)(() => v(w)),
            S = a(e);
          return r.createElement(i.SimpleDialog, {
            title: t || o.t(null, void 0, n(435038)),
            content: r.createElement(u, {
              ...S,
              nameInputRef: C,
              maxLength: s,
              placeholder: c,
            ...
            actions: [
              {
                ...
                handler: ({ dialogClose: e, innerManager: t }) =>
                  g({ newValue: w, focusInput: B, dialogClose: e, innerManager: t }),
              },
              {
                name: 'cancel',
        ...
        C = function (e, t, n) {
          ...
          if (v.isOpened(i)) return (0, f.ensureDefined)(v.getDialogPayload(i)).closeHandler;
          ...
          return (
            p.render(
              r.createElement(
                ...
                { value: n || null },
                r.createElement(t, { ...e, onClose: s }),
              ),
              a,
            ),
            v.setAsOpened(i, { closeHandler: s }),
            s
          );
        };
    },
    859878: (e, t, n) => {
      ...
      function C(e) {
        const {
          ...
          { isSmallTablet: u, dialogCloseHandler: d } = (0, r.useContext)(y.SimpleDialogContext),
          m = (0, h.ensureNotNull)((0, r.useContext)(g.SlotContext)),
          C = (0, v.useIsMounted)(),
          [w, b] = (0, r.useState)(!1);
        return r.createElement(
          p.Button,
          {
            disabled: t,
            reference: c,
            className: o(_.actionButton, u && _.small),
            name: n,
            size: u ? 'l' : void 0,
            appearance: a,
            intent: s,
          ...
          r.createElement('span', { className: o(w && _.hiddenTitle) }, i),
          w && r.createElement(f.Loader, { color: 'white' }),
        );
      }
      var w = n(507720),
        b = n(854936);
      function x(e) {
        ...
        const [D, R] = (0, r.useState)(!0),
          k = (0, r.useRef)(null);
        return r.createElement(c.MatchMedia, { rule: d.DialogBreakpoints.TabletSmall }, a =>
          r.createElement(
            ...
            r.createElement(
              s.PopupDialog,
              {
                className: o(b.popupDialog, h),
                isOpened: D,
                backdrop: _,
                onClickBackdrop: B ? N : void 0,
                onClickOutside: x ? N : void 0,
                onKeyDown: P,
                autofocus: !0,
                fixedBody: !0,
              },
              r.createElement(
                'div',
                { className: o(b.wrap, g), 'data-name': f },
                r.createElement(
                  'div',
                  { className: o(b.main, !E && b.marginWithoutCloseButton, a && b.small) },
                  t && r.createElement('div', { className: o(b.title, a && b.small) }, t),
                  (function (t) {
                    if ('html' in e)
                      return r.createElement(m.TouchScrollContainer, {
                        className: o(b.content, t && b.small, b.html, v),
                        dangerouslySetInnerHTML: { __html: e.html },
                      });
                    if ('content' in e)
                      return r.createElement(
                        m.TouchScrollContainer,
                        { className: o(b.content, t && b.small, v) },
                        e.content,
                      );
                    return null;
                  })(a),
                  p &&
                    ...
                    r.createElement(
                      'div',
                      { className: o(b.footer, a && b.small) },
                      p.map((e, t) =>
                        r.createElement(C, { ...e, key: e.name, reference: 0 === t ? k : void 0 }),
                      ),
                    ),
                ),
                E &&
                  r.createElement(i.Icon, {
                    className: o(b.close, a && b.small),
                    icon: w,
                    onClick: N,
                    'data-name': 'close',
                    'data-role': 'button',
    ...
    515783: (e, t, n) => {
      ...
      function l(e) {
        ...
        return r.createElement(i.Icon, { className: o(n, a.icon, { [a.dropped]: t }), icon: s });
      }
    },
    742554: (e, t, n) => {
      'use strict';
        ...
        return (
          ...
          (0, r.useLayoutEffect)(() => {
            if (a.CheckMobile.iOS())
              return (
                null !== s.current && (0, o.disableBodyScroll)(s.current, { allowTouchMove: l(s) }),
                () => {
    ...
    695257: (e, t) => {
      ...
      var C = (_.prototype = new y());
      (C.constructor = _), h(C, g.prototype), (C.isPureReactComponent = !0);
      var w = Array.isArray,
      ...
      function S(e, t, r) {
        ...
        if (null != t)
          for (o in (void 0 !== t.ref && (s = t.ref), void 0 !== t.key && (a = '' + t.key), t))
            b.call(t, o) && !E.hasOwnProperty(o) && (i[o] = t[o]);
      ...
      var O = { current: null },
        T = { transition: null },
        L = { ReactCurrentDispatcher: O, ReactCurrentBatchConfig: T, ReactCurrentOwner: x };
      (t.Children = {
        map: P,
        ...
        (t.isValidElement = B),
        (t.lazy = function (e) {
          return { $$typeof: m, _payload: { _status: -1, _result: e }, _init: N };
        }),
        (t.memo = function (e, t) {
