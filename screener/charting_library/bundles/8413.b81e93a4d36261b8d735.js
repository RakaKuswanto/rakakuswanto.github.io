  ...
  [8413],
  {
    ...
    192063: (e, t, o) => {
      ...
      function h(e) {
        ...
        return r.createElement(
          ...
          (void 0 !== w || b) &&
            r.createElement('span', { className: R.shortcut }, (q = w) && q.split('+').join(' + ')),
          void 0 !== B &&
            r.createElement(
              'span',
              {
                onClick: S ? u : void 0,
                className: n(R.toolbox, { [R.showOnHover]: O, [R.showOnFocus]: T }),
              },
              B,
            ),
        );
    ...
    515783: (e, t, o) => {
      ...
      function l(e) {
        ...
        return r.createElement(i.Icon, { className: n(o, a.icon, { [a.dropped]: t }), icon: s });
      }
    },
    742554: (e, t, o) => {
      'use strict';
    ...
    747633: (e, t, o) => {
      'use strict';
      o.d(t, { DEFAULT_TOOL_WIDGET_BUTTON_THEME: () => s, ToolWidgetButton: () => l });
      var r = o(50959),
        n = o(497754),
        i = o(72571),
        a = o(278029);
      const s = a,
        l = r.forwardRef((e, t) => {
          const {
            ...
            N = n(b, w.button, (g || C) && 'apply-common-tooltip', {
              [w.isActive]: c,
              [w.isOpened]: d,
              [w.isInteractive]: (E || Boolean(m)) && !u && !D,
              [w.isDisabled]: Boolean(u || D),
              [w.isGrouped]: h,
              [w.hover]: p,
            }),
            _ =
              s &&
              ('string' == typeof s
                ? r.createElement(i.Icon, { className: w.icon, icon: s })
                : r.cloneElement(s, { className: n(w.icon, s.props.className) }));
          return 'button' === o
            ? r.createElement(
                'button',
                {
                ...
                v && f && r.createElement('div', { className: n('js-button-text', w.text) }, f),
                _,
                !v && f && r.createElement('div', { className: n('js-button-text', w.text) }, f),
              )
            : r.createElement(
    ...
    518799: (e, t, o) => {
      'use strict';
      o.d(t, { DEFAULT_TOOL_WIDGET_MENU_THEME: () => f, ToolWidgetMenu: () => v });
      var r = o(50959),
        n = o(497754),
        i = o(930202),
        a = o(624216),
                ...
                switch (r) {
                  case 27: {
                    ...
                    this._handleToggleDropdown(!1),
                      o && (null === (t = this._wrapperRef) || void 0 === t || t.focus());
                    break;
                  }
                }
              }
