(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5001],
  {
    ...
    648017: (i, e, t) => {
      'use strict';
      t.r(e), t.d(e, { PartiallyClosingDialog: () => c });
      var n = t(509806),
        a = t(50959),
        o = t(302946),
        s = t(960521),
      ...
      function c(i) {
        const {
            ...
            message: g,
            onClose: _,
            dialogActionHandler: k,
            onOpen: b,
          } = i,
          z = (0, a.useMemo)(() => Math.abs(e.qty), [e.qty]),
          [x, L] = (0, a.useState)(!0),
          [S, q] = (0, a.useState)(!1),
          [E, T] = (0, a.useState)(z),
          [D, I] = (0, a.useState)(!1),
          ...
          [P, j] = (0, a.useState)(),
          M = (() => {
            const [i, e] = (0, a.useState)(!window.navigator.onLine),
              t = i => e('offline' === i.type);
            return (
              (0, a.useEffect)(
                () => (
        ...
        (0, a.useEffect)(() => {
          let i;
          const e = new s.Big(z),
            a = null !== E ? new s.Big(E) : null,
            o = null == a ? void 0 : a.minus(Q).mod(f);
          null === a
            ? (i = n.t(null, void 0, t(706035)))
            : a.gt(e)
            ? (i = n.t(null, void 0, t(28136)))
            : !a.eq(e) && a.lt(Q)
            ? (i = n.t(null, void 0, t(290371)).replace('{minQty}', String(Q)))
            : !a.eq(e) && e.minus(a).lt(Q)
            ? (i = n.t(null, void 0, t(521644)).replace('{minQty}', String(Q)))
            : a.eq(e) ||
              (null == o ? void 0 : o.eq(0)) ||
              (i = n.t(null, void 0, t(757077)).replace('{step}', String(f))),
            w(D || void 0 !== i),
            j(i);
        }, [D, E, z, f, Q]),
          (0, a.useEffect)(() => {
        ...
        const W = (0, a.useMemo)(
            () => (null !== E ? (0, d.splitThousands)(c.format(E), ' ') : ''),
            [E, c],
          ),
          H = (0, a.useMemo)(
            () =>
              null !== E
                ? (0, d.splitThousands)(c.format(new s.Big(z).minus(E).toNumber()), ' ')
                : '',
            [E, z, c],
          ),
          R =
            S && null !== E && E < z ? n.t(null, void 0, t(630392)) : n.t(null, void 0, t(424356));
        return a.createElement(p.CreateConfirmDialog, {
          isOpen: x,
          isOpened: x,
          submitButtonDisabled: S && N,
          render: function () {
            const i = (0, d.splitThousands)(c.format(z), ' '),
              s = n
                .t(
                  null,
                  { context: 'close_position_total', plural: 'of {positionQty} lots', count: z },
                  t(588465),
                )
              ...
              m = n
                .t(
                  null,
                  { context: 'close_position_total', plural: 'of {positionQty} units', count: z },
                  t(185007),
                )
                .replace('{positionQty}', i),
              r = h ? s : m;
            return a.createElement(
              ...
              { className: y.scrollable, onScroll: V },
              a.createElement(
                'div',
                { className: y.content },
                a.createElement('div', { className: y.message }, g),
                a.createElement(o.Checkbox, {
                  name: 'partially-close-checkbox',
                  label: a.createElement(
                    'span',
                    { className: y.label },
                    n.t(null, void 0, t(381569)),
                  ),
                  checked: S,
                  onChange: U,
                  disabled: !1,
                ...
                S &&
                  a.createElement(
                    ...
                    a.createElement(u.NumberInput, {
                      ...
                      onValueChange: B,
                      onEmptyString: F,
                      endSlot: a.createElement('p', { className: y.endSlot }, r),
                    }),
                    C &&
                      a.createElement(
                        'div',
                        {
                          className: y.estimation,
                        },
                        a.createElement(
                          'div',
                          null,
                          n
                            .t(null, void 0, t(17693))
                        ...
                        a.createElement(
                          'div',
                          null,
                          n.t(null, void 0, t(381232)).replace('{leavingQty}', H),
                        ),
                      ),
                  ),
              ),
          ...
          onClose: Y,
          title: n.t(null, void 0, t(424356)),
          onSubmit: O,
          onCancel: () => {},
          onKeyDown: function (i) {
            27 === (0, r.hashFromEvent)(i) && Y();
          },
          ...
          submitButtonText: R,
          cancelButtonText: n.t(null, void 0, t(620036)),
          onOpen: b,
        });
        function U() {
          q(i => !i);
    ...
    941668: (i, e, t) => {
      'use strict';
      t.d(e, { CreateConfirmDialog: () => s });
      var n = t(50959),
        a = t(973044);
      const o = n.lazy(async () => ({
          default: (
            await Promise.all([
              t.e(580),
              t.e(8194),
        ...
        s = (0, a.withDialogLazyLoad)(o);
    },
    476007: (i, e, t) => {
      'use strict';
      t.d(e, { SplitThousandsFormatter: () => o });
      var n = t(793361),
        a = t(710263);
      class o {
        constructor(i = ' ') {
        ...
        format(i) {
          const e = (0, n.splitThousands)(i, this._divider);
          return (0, a.isRtl)() ? (0, a.startWithLTR)(e) : e;
        }
        parse(i) {
          const e = (0, a.stripLTRMarks)(i).split(this._divider).join(''),
            t = Number(e);
          return isNaN(t) || /e/i.test(e)
            ? { res: !1 }
    ...
    290371: i => {
      i.exports = {
        ...
        ca_ES: 'Specified value is less than the instrument minimum of {minQty}',
        cs: 'Specified value is less than the instrument minimum of {minQty}',
        de: ['Angegebener Wert ist kleiner als das Minimum des Instruments von {minQty}'],
        ...
        fr: ["La valeur spécifiée est inférieure au minimum de l'instrument {minQty}"],
        he_IL: ['הערך שצוין קטן מהמינימום של המכשיר של {minQty}'],
        hu_HU: 'Specified value is less than the instrument minimum of {minQty}',
        id_ID: ['Nilai yang ditentukan kurang dari kapasitas minimum instrumennya yaitu {minQty}'],
        it: ['Il valore specificato è inferiore al minimo dello strumento ({minQty})'],
        ja: ['指定された値が銘柄の最小値 ({minQty}) 未満です'],
        ko: ['지정한 값이 종목의 최소값인 {minQty} 보다 작습니다'],
        ms_MY: ['Nilai yang ditentukan adalah kurang daripada nilai minimum instrumen {minQty}'],
        nl_NL: 'Specified value is less than the instrument minimum of {minQty}',
        pl: [
          'Określona wartość jest mniejsza niż dozwolone minimum dla instrumentu wynoszące {minQty}',
        ],
        pt: ['O valor especificado é menor que o mínimo de {minQty} do instrumento.'],
        ro: 'Specified value is less than the instrument minimum of {minQty}',
        ru: ['Указанное значение меньше допустимого минимума для инструмента {minQty}'],
        sv: ['Det specificerade värdet är mindre än instrumentminimum för {minQty}'],
        th: ['ค่าที่ระบุน้อยกว่าค่าต่ำสุดของเครื่องมือ {minQty}'],
        tr: ['Belirtilen değer, enstrümanın minimum {minQty} değerinden düşüktür'],
        vi: ['Giá trị đã chỉ định nhỏ hơn giá trị tối thiểu của công cụ là {minQty}'],
    ...
    521644: i => {
      i.exports = {
        ar: ['الكمية المتبقية من المركز أقل من الحد الأدنى للأداة الذي يعادل {minQty}'],
        ca_ES: 'Remaining quantity of position is less than the instrument minimum of {minQty}',
        ...
        hu_HU: 'Remaining quantity of position is less than the instrument minimum of {minQty}',
        id_ID: [
        ...
        ms_MY: ['Kuantiti posisi yang tinggal adalah kurang daripada minimum instrumen {minQty}'],
        nl_NL: 'Remaining quantity of position is less than the instrument minimum of {minQty}',
        pl: [
          'Pozostała wielkość pozycji jest mniejsza niż dozwolone minimum dla instrumentu wynoszące {minQty}',
        ],
        pt: ['A quantidade restante de posição é menor que o mínimo de {minQty} do instrumento.'],
        ro: 'Remaining quantity of position is less than the instrument minimum of {minQty}',
        ru: ['Оставшееся количество меньше допустимого минимума для инструмента {minQty}'],
        sv: [
        ...
        tr: ['Kalan pozisyon miktarı, enstrümanın minimum {minQty} değerinden azdır'],
        vi: ['Số lượng vị thế còn lại nhỏ hơn mức tối thiểu của công cụ là {minQty}'],
    ...
    28136: i => {
      i.exports = {
        ...
        zh: ['输入的金额超过仓位大小'],
        zh_TW: 'The amount entered exceeds the position size',
      };
    },
    757077: i => {
      i.exports = {
