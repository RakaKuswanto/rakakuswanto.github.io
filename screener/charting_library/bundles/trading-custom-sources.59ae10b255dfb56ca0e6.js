  ...
  [2650],
  {
    289705: (t, e, i) => {
      ...
      class c extends n.BrokerService {
        ...
        _tryToStart() {
          (0, s.assert)(!this._isStarted, "Execution's service has already started"),
        ...
        _stop() {
          ...
          (0, s.ensure)(this.activeBroker()).executionUpdate.unsubscribeAll(this),
        ...
        _createExecutions() {
          ...
          e &&
            (this._actualTradingSymbolSubscription =
              null === (t = this.trading().makeActualSymbolObservable(e)) || void 0 === t
                ? void 0
                : t.subscribe(({ symbol: t }) => {
                    t !== this._symbol &&
                      ((this._symbol = t), this._requestFormatterAndExecutions());
                  }));
        }
        _clearExecutions() {
          var t;
          null === (t = this._actualTradingSymbolSubscription) || void 0 === t || t.unsubscribe(),
            (this._allExecutionsID = new Set()),
            (this._executions = []),
        ...
        async _requestFormatterAndExecutions() {
          ...
          Promise.all([t.formatter(this._symbol, !1), t.executions(this._symbol)]).then(
            ([i, s]) => {
              this._symbol === e &&
                ((this._formatter = i),
                (this._executions = s.map(t => this._createExecutionData(t)).filter(r.notNull)),
    ...
    564209: (t, e, i) => {
      ...
      class n {
        ...
        _addPoints(t) {
          ...
          r && (i = (0, s.upperbound)(this._points, e[0].time_t, (t, e) => e.time_t > t, 0)),
            (this._points = this._points.slice(0, i).concat(e).concat(this._points.slice(i)));
          const o = this._firstSeriesTimePointWV.value();
          null !== this._offsetOfFirstExistingPoint && null !== o && e[0].time_t < o
        ...
        _sendPointsToServer(t, e) {
          ...
          null !== s &&
            (s.onUpdate().subscribe(this, this._updatePointsFromServer), this._pointsets.push(s));
        }
    ...
    856628: (t, e, i) => {
      'use strict';
      i.r(e), i.d(e, { ExecutionsSource: () => D });
      var s = i(938351),
        r = i(364124),
        o = i(966949);
      class n extends s.CustomSourceBase {
        ...
        destroy() {
          this._executionsPointsManager.existingPointsChanged().unsubscribe(this, this.redraw),
            this._executionsPointsManager.destroy();
        }
        _isSourceShouldBeShown(t) {
          return (
            !!t.containsMainSeries() &&
            !(window.TradingView.printing && !(0, o.isTradingObjVisibleOnScreenshot)())
          );
        }
      }
      var a = i(650151),
      ...
      const p = u.colorsPalette['color-tv-blue-500'],
        ...
        b = {
          ...
          overlayColor: (0, d.generateColor)(u.colorsPalette['color-cold-gray-900'], 50),
          outlineColor: u.colorsPalette['color-cold-gray-900'],
        },
        f = {
          textColor: u.colorsPalette['color-cold-gray-900'],
          overlayColor: (0, d.generateColor)(u.colorsPalette['color-white'], 50),
      ...
      class k {
        constructor() {
          (this._data = { points: [], labels: [], arrowHeight: 0, arrowSpacing: 0 }),
            (this._textWidthCache = new v.TextWidthCache()),
            (this._font = (0, w.makeFont)(A, S.CHART_FONT_FAMILY, V));
        }
        setData(t) {
          this._data = t;
        }
        hitTest(t) {
          for (const e of this._data.points) {
            ...
            if (
              (e.arrowUp
                ? ((o = s), (n = s + this._data.arrowHeight + this._data.arrowSpacing))
                : ((o = s - this._data.arrowHeight - this._data.arrowSpacing), (n = s)),
              t.x >= i - C && t.x <= i + C && t.y >= o && t.y <= n && '' !== e.tooltip)
            ) {
              const t = { activeItem: e.id };
              return (
                e.tooltip &&
                  (t.tooltip = {
                    below: !1,
                    text: e.tooltip,
                    rect: { x: i - C, y: o, w: r, h: n - o },
                  }),
                new g.HitTestResult(g.HitTarget.Custom, t)
              );
            }
          }
          return null;
        ...
        draw(t, e) {
          ...
          for (const e of this._data.points) {
            const s = Math.round((e.x - C) * i),
              n = Math.round(e.y * i);
            (0, P.drawArrow)(t, s, n, e.arrowColor, e.outlineColor, !e.arrowUp, o, r, y);
          }
          for (const e of this._data.labels) {
            const s = Math.round((e.x - C) * i),
              r = Math.round(e.y * i);
            (0, P.drawOutlinedText)(
              t,
              i,
              e.text,
              s,
          ...
          if (this._data.executionEntryPoint) {
            const e = Math.round((this._data.executionEntryPoint.x - E / 2) * i),
              s = Math.round(this._data.executionEntryPoint.y * i),
              r = Math.max(1, Math.round(T * i)),
              o = Math.max(1, Math.round(E * i));
            (0, P.drawOutlinedArrowHead)(
              t,
              e,
              s,
      ...
      class L extends class {
        ...
        _updateImpl() {
          this._renderer.setData({ points: [], labels: [], arrowHeight: 0, arrowSpacing: 0 });
          const t = this._chartModel.timeScale().visibleBarsStrictRange();
          if (null === t) return;
          const e = this._source.points();
          if (0 === e.length) return;
          const i = (0, h.lowerbound)(e, t.firstBar(), (t, e) => t.index < e, 0),
        ...
        constructor(t, e) {
          super(t), (this._renderer = new k()), (this._points = []), (this._source = e);
        }
        _createRenderData(t) {
          let e;
          this._points = [];
          ...
          for (const n of t) {
            ...
            if (void 0 === u) {
              ...
              if (null === e) continue;
              t[c].y = e + h * M.ArrowToBarSpacing;
            } else t[c].y = u + h * (M.ArrowHeight + M.ArrowSpacing);
            s.set(n.index, t),
              o &&
                o === n &&
                (e = {
            ...
            for (const e of t) {
              ...
              if (t) {
                ...
                if (void 0 !== l && void 0 !== c) {
                  const i = s ? 1 : -1;
                  (t[o].y = l + i * M.LabelSpacing),
                    n.push({
                      x: c,
                      y: (0, a.ensureDefined)(t[o].y) + i * M.ArrowToLabelSpacing,
                      text: e.tooltip,
                      color: r.textColor,
                      outlineColor: r.outlineColor,
                    });
      ...
      function B(t, e) {
        ...
        return (
          ...
          { x: void 0, arrowUp: { y: void 0, color: i }, arrowDown: { y: void 0, color: s } }
        );
      }
      class D extends n {
        ...
        _createPaneViews() {
          this._paneViews = [new L(this._model, this)];
        }
        _isSourceShouldBeShown(t) {
          return (
    ...
    132193: (t, e, i) => {
      ...
      class a {
          ...
          this._setItemState(t, (t, e) => {
            this._activeWidgetChartModel().selectionMacro(i => {
              if (t) i.clearSelection(), i.addSourceToSelection(t, e);
                ...
                i.selection().customSources().find(n.isTradedGroupCustomSource) &&
                  i.clearSelection();
              }
            });
          });
        ...
        _setItemState(t, e) {
          ...
          e(
            i,
            new o.HitTestResult(o.HitTarget.Custom, { activeItem: { id: s.id(), part: 8 } }).data(),
          );
        }
        _activeWidgetChartModel() {
          return (0, s.ensureNotNull)(this._chartWidgetCollection.activeChartWidget.value())
            .model()
            .model();
        }
    ...
    13042: (t, e, i) => {
      ...
      class d extends h.PriceAxisView {
        ...
        _updateRendererData(t, e, s) {
          ...
          (t.visible = !0),
            ...
            (e.text =
              0 === this._priceType ? c.t(null, void 0, i(6205)) : c.t(null, void 0, i(987300))),
      ...
      class x extends _.HorizontalLinePaneView {
        constructor(t, e, i, s) {
          ...
          this._lineRenderer.setHitTest(new p.HitTestResult(p.HitTarget.Regular, r));
        }
        _updateImpl() {
      ...
      class f extends n.CustomSourceBase {
        ...
        _updateRealtimeData(t, e, i) {
          ...
          s === o
            ...
            : ((0, r.isNumber)(s) && (this._ask = s), (0, r.isNumber)(o) && (this._bid = o)),
