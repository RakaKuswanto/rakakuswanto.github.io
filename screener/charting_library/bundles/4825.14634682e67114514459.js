  ...
  [4825, 959, 6437],
  {
    ...
    72571: (e, t, o) => {
      ...
      const r = n.forwardRef((e, t) => {
        const { icon: o = '', ...r } = e;
        return n.createElement('span', { ...r, ref: t, dangerouslySetInnerHTML: { __html: o } });
      });
    },
    800417: (e, t, o) => {
      'use strict';
    ...
    273388: (e, t, o) => {
      ...
      o.d(t, { isomorphicRef: () => r, mergeRefs: () => n });
    },
    996038: (e, t, o) => {
      'use strict';
      o.d(t, { DialogBreakpoints: () => r });
      var n = o(488803);
      const r = {
    ...
    533408: (e, t, o) => {
      ...
      function k(e) {
        ...
        return n.createElement(
          ...
          n.createElement(
            'div',
            { className: s()(_.container, f, (r || p) && _.unsetAlign) },
            c,
            n.createElement(
              'div',
              { 'data-dragg-area': d, className: _.title },
              n.createElement('div', { className: s()(o ? _.textWrap : _.ellipsis) }, t),
              r && n.createElement('div', { className: s()(_.ellipsis, _.subtitle) }, r),
            ),
            u,
            i &&
              !v &&
      ...
      class O extends n.PureComponent {
        constructor() {
          super(...arguments),
              ...
              if (!e.defaultPrevented) {
                if (
                  ...
                  if (null !== o) {
                    if (
                      (e.preventDefault(),
                      'true' === (t = o).getAttribute('data-haspopup') &&
                        'true' !== t.getAttribute('data-expanded'))
                    )
                      return void this._handleClose();
                    if ((0, u.isTextEditingField)(o)) return void n.focus();
                    if (n.contains(o))
                      return (
                        this.props.onKeyboardClose && this.props.onKeyboardClose(),
                        void this._handleClose()
                ...
                (function (e) {
                  ...
                  ((o = e),
                  [9, l.Modifiers.Shift + 9].includes((0, l.hashFromEvent)(o)) &&
                    o.stopPropagation());
              }
            }),
            (this._requestResize = () => {
            ...
            (this._calculatePositionWithOffsets = (e, t) => {
              const o = (0, r.ensureDefined)(this.props.fullScreenViewOffsets).value();
              return {
                top: o.top,
                left: (0, c.isRtl)() ? -o.right : o.left,
                width: t.clientWidth - o.left - o.right,
                height: t.clientHeight - o.top - o.bottom,
              };
            });
        }
        componentDidMount() {
        ...
        contains(e) {
          ...
          return (
            null !==
              (o = null === (t = this._reference) || void 0 === t ? void 0 : t.contains(e)) &&
            void 0 !== o &&
            o
          );
        }
        render() {
          const {
              ...
              shadowed: H,
              fullScreenViewOffsets: $,
            } = this.props,
            q = 'after' !== u ? v : void 0,
            U = 'after' === u ? v : void 0,
            Q = 'string' == typeof i ? i : F || '',
            Y = (0, w.filterDataProps)(this.props),
            X = (0, C.mergeRefs)([this._handleReference, z]);
          return n.createElement(h.MatchMedia, { rule: p.DialogBreakpoints.SmallHeight }, u =>
            n.createElement(h.MatchMedia, { rule: p.DialogBreakpoints.TabletSmall }, p =>
              n.createElement(
                d.PopupDialog,
                {
                  rounded: !(p || R) && A,
                  className: s()(x.dialog, R && $ && x.bounded, e),
                  isOpened: r,
                  reference: X,
                  ...
                  containerAriaLabel: I,
                  containerTabIndex: K,
                  calculateDialogPosition: R && $ ? this._calculatePositionWithOffsets : void 0,
                  shadowed: H,
                  ...Y,
                },
                n.createElement(
                  'div',
                  { className: s()(x.wrapper, t), 'data-name': l, 'data-dialog-name': Q },
                  void 0 !== i &&
                    n.createElement(k, {
                      draggable: O && !(p || R),
                  ...
                  E && n.createElement(f.Separator, { className: x.separator }),
                  n.createElement(m.PopupContext.Consumer, null, e =>
                    this._renderChildren(e, p || R),
                  ),
                ),
              ),
            ),
    ...
    73572: (e, t, o) => {
      ...
      function c(e) {
        const { url: t, ...o } = e;
        return t ? n.createElement('a', { ...o, href: t }) : n.createElement('div', { ...o });
      }
      var u = o(412228);
      function d(e) {
        const {
        ...
        return n.createElement(
          ...
          {
            ...E,
            className: i()(u.itemRow, m && !v && u.active, g && u.mobile, v && u.selected),
            onClick: f.bind(null, d),
            'data-role': 'list-item',
            'data-active': m,
          },
          y &&
            p &&
            n.createElement(s.FavoriteButton, {
              className: i()(u.favoriteButton, b && u.favorite, a.CheckMobile.any() && u.mobile),
              isActive: m && !v,
              isFilled: b,
              onClick: f.bind(null, p),
              'data-name': 'list-item-favorite-button',
              'data-favorite': b,
            }),
          n.createElement(
            'div',
            { className: i()(u.itemInfo, !y && u.itemInfoWithPadding) },
            n.createElement(
              'div',
              {
                className: i()(u.title, m && !v && u.active, g && u.mobile),
            ...
            n.createElement(
              'div',
              { className: i()(u.details, m && !v && u.active, g && u.mobile) },
              o,
            ),
          ),
    ...
    190410: (e, t, o) => {
      'use strict';
      o.d(t, { DialogHeaderContext: () => n });
      const n = o(50959).createContext({ setHideClose: () => {} });
    },
    636080: (e, t, o) => {
      'use strict';
      o.d(t, { CircleLogo: () => i });
    ...
    577687: (e, t, o) => {
      ...
      var n = o(509806),
        ...
        l = o(648010),
        c = o(214877);
      const u = { add: n.t(null, void 0, o(44629)), remove: n.t(null, void 0, o(572482)) };
      function d(e) {
        const { className: t, isFilled: o, isActive: n, onClick: d, ...f } = e;
        return r.createElement(a.Icon, {
          ...f,
          className: i(c.favorite, 'apply-common-tooltip', o && c.checked, n && c.active, t),
          icon: o ? s : l,
          onClick: d,
    ...
    921258: (e, t, o) => {
      'use strict';
      o.d(t, { hoverMouseEventFilter: () => i, useAccurateHover: () => a, useHover: () => r });
      var n = o(50959);
      function r() {
    ...
    192063: (e, t, o) => {
      'use strict';
      o.d(t, { DEFAULT_POPUP_MENU_ITEM_THEME: () => u, PopupMenuItem: () => f });
      var n = o(50959),
        r = o(497754),
        i = o(370981),
        a = o(32133),
      ...
      function f(e) {
        ...
        return n.createElement(
          U,
          {
            ...
            'aria-selected': f,
            'aria-checked': p,
            className: r(h, F.item, E && F.withIcon, {
              [F.isActive]: _,
              [F.isDisabled]: k || w,
              [F.hovered]: C,
            }),
          ...
          E &&
            n.createElement('span', {
              ...
              className: r(F.icon, K && c['round-icon']),
              dangerouslySetInnerHTML: { __html: E },
            }),
          n.createElement(
            'span',
            { className: r(F.labelRow, v) },
            n.createElement('span', { className: r(F.label, b) }, x),
          ),
          (void 0 !== g || y) &&
            n.createElement('span', { className: F.shortcut }, (Q = g) && Q.split('+').join(' + ')),
          void 0 !== A &&
            n.createElement(
              'span',
              {
                onClick: M ? d : void 0,
                className: r(F.toolbox, { [F.showOnHover]: D, [F.showOnFocus]: O }),
              },
              A,
            ),
        );
    ...
    624216: (e, t, o) => {
      ...
      function f(e) {
        const {
          ...
          E = (0, n.useContext)(l.CloseDelegateContext),
          _ = n.useContext(d),
          k = (0, n.useContext)(c),
          C = (0, u.useOutsideEvent)({
            handler: function (e) {
              m && m(e);
              if (!p) return;
              const t = (0, i.default)(h) ? h() : null == h ? [] : [h];
    ...
    72621: (e, t, o) => {
      ...
      function c(e) {
        ...
        return r.createElement(a.Icon, {
          ...
          onClick: u,
          onMouseDown: d,
          title: f || n.t(null, void 0, o(734596)),
        });
      }
    },
    695257: (e, t) => {
      ...
      var h = {
        ...
        v = {};
      function b(e, t, o) {
        (this.props = e), (this.context = t), (this.refs = v), (this.updater = o || h);
      }
      function g() {}
      function y(e, t, o) {
        (this.props = e), (this.context = t), (this.refs = v), (this.updater = o || h);
      ...
      var E = (y.prototype = new g());
      (E.constructor = y), m(E, b.prototype), (E.isPureReactComponent = !0);
      var _ = Array.isArray,
      ...
      function x(e, t, n) {
        ...
        return { $$typeof: o, type: e, key: a, ref: s, props: i, _owner: C.current };
      }
      function S(e) {
      ...
      var N = { current: null },
        P = { transition: null },
        T = { ReactCurrentDispatcher: N, ReactCurrentBatchConfig: P, ReactCurrentOwner: C };
      (t.Children = {
        map: L,
        ...
        (t.useImperativeHandle = function (e, t, o) {
          return N.current.useImperativeHandle(e, t, o);
        }),
        ...
        (t.useReducer = function (e, t, o) {
          return N.current.useReducer(e, t, o);
        }),
        (t.useRef = function (e) {
        ...
        (t.useSyncExternalStore = function (e, t, o) {
          return N.current.useSyncExternalStore(e, t, o);
        }),
    ...
    476853: (e, t, o) => {
      ...
      function c(e, t) {
        return (o, c, u, d) => {
          var f, p;
          const h = (0, s.ensureNotNull)(e).getBoundingClientRect(),
            {
          ...
          let E = null !== (f = t.verticalAttachEdge) && void 0 !== f ? f : l.verticalAttachEdge,
            _ =
              null !== (p = t.verticalDropDirection) && void 0 !== p ? p : l.verticalDropDirection;
          E === n.AutoStrict &&
            (d < h.y + h.height + g + c
              ? ((E = n.Top), (_ = i.FromBottomToTop))
              : ((E = n.Bottom), (_ = i.FromTopToBottom)));
          const k = E === n.Top ? -1 * g : g,
            C = m === r.Right ? h.right : h.left,
            w = E === n.Top ? h.top : h.bottom,
            x = {
              x: C - (v === a.FromRightToLeft ? o : 0) + b,
              y: w - (_ === i.FromBottomToTop ? c : 0) + k,
            };
          return y && (x.overrideWidth = h.width), x;
        };
      }
    },
    660538: (e, t, o) => {
      'use strict';
      o.d(t, { mediaQueryAddEventListener: () => n, mediaQueryRemoveEventListener: () => r });
      const n = (e, t) => {
