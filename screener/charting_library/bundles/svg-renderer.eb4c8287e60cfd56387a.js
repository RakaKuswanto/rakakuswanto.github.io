...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2616],
  {
    586687: (t, e, i) => {
      ...
      function o(t, e) {
        const i = t.split(/[,\s]/).map(t => parseFloat(t.trim()));
        let s = 0;
        for (const t of i) {
      ...
      function a(t) {
        var e;
        const i =
          null === (e = t.getAttribute('transform')) || void 0 === e ? void 0 : e.toLowerCase();
          ...
          if (((r = l.exec(i)), null !== r)) {
            ...
            switch (t) {
              case 'matrix':
                const i = o(e, 6);
                null !== i &&
                  s.push({ type: t, a: i[0], b: i[1], c: i[2], d: i[3], e: i[4], f: i[5] });
                break;
              case 'rotate':
                const r = o(e, 1);
      ...
      function g(t) {
        var e, i;
        return null !== (i = null === (e = h.exec(t)) || void 0 === e ? void 0 : e[1]) &&
          void 0 !== i
          ? i
          : null;
      }
      function d(t, e, i) {
        ...
        if (null !== n) {
          const t = g(n);
          r.getFillStyle = null !== t ? i => (0, s.ensureDefined)(e.getStyle(t, i)) : t => n;
        }
        const o = t.getAttribute('stroke');
        if (null !== o) {
          const t = g(o);
          r.getStrokeStyle = null !== t ? i => (0, s.ensureDefined)(e.getStyle(t, i)) : t => o;
        }
      ...
      class f {
        ...
        apply(t, e) {
          ...
          'none' !== u &&
            (e.doNotApplyColors ||
              (void 0 !== l && (t.globalAlpha = l), (t.fillStyle = null != u ? u : 'black')),
            this._fill(t));
          const h = null == s ? void 0 : s(t);
          void 0 !== h &&
            'none' !== h &&
            (void 0 !== r && (t.lineWidth = r),
            e.doNotApplyColors || (void 0 !== l && (t.globalAlpha = l), (t.strokeStyle = h)),
            this._stroke(t)),
            a && t.restore();
        }
        _fill(t) {
      ...
      class y extends f {
        constructor(t, e, i) {
          ...
          (this._path = null !== r ? new Path2D(r) : null),
            (this._fillRule =
              null !== (s = t.getAttribute('fill-rule')) && void 0 !== s ? s : void 0);
        }
        _fill(t) {
      ...
      class v extends f {
        constructor(t, e, i) {
          super(t, e, i), (this._cx = u(t, 'cx')), (this._cy = u(t, 'cy')), (this._r = u(t, 'r'));
        }
        _render(t) {
      ...
      class x {
        ...
        apply(t, e) {
          ...
          t.translate(i.x, i.y),
            t.scale(i.width / this._originalViewBox.width, i.height / this._originalViewBox.height),
            t.beginPath(),
            t.rect(0, 0, this._originalViewBox.width, this._originalViewBox.height),
            t.clip(),
      ...
      function m(t) {
        ...
        if ('objectBoundingBox' === e)
          return void b.logWarn(`Unsupported linearGradient gradientUnits: ${e}`);
        const i = [],
      ...
      function F(t, e, i, s) {
        ...
        ('g' !== t.tagName && 'svg' !== t.tagName) ||
          ((l = { ...l, ...d(t, i, !1) }), (o = null !== (r = a(t)) && void 0 !== r ? r : void 0)),
