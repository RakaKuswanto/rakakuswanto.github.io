  ...
  [660],
  {
    895318: (e, t, i) => {
      ...
      const r = {
        ...
        o = { showCryptoBracketsInCurrency: !1, showCryptoBracketsInPercent: !1 },
        n = s.createContext({
          value: r,
          setValue: e => {
            console.warn(
              'unable to modify order ticket settings because context.setValue is not defined',
            );
          },
        });
    },
    ...
    362042: (e, t, i) => {
      'use strict';
      i.r(t), i.d(t, { OrderViewController: () => mt });
      var s = i(870122),
        r = i(650151),
        o = i(6835),
        n = i(148442),
      ...
      class F {
        constructor({
          ...
          (this._pinButtonClicked = new B.Delegate()),
            ...
            this._headerState.setTitle(this._title()),
            this._headerState.setDescription(this._text()),
            this._headerState.setBackFunction(this._hasBackButton() ? () => this.back() : void 0),
            this._headerState.setCloseFunction(
              this._hasCloseButton() ? () => this.close() : void 0,
            ),
            ...
            this._headerState.setHasBatsQuotes(h),
            this._headerState.setIsTradable(a),
            (this._informerMessageSubscription =
              null == c ? void 0 : c.subscribe(e => this._headerState.setInformerMessage(e))),
        ...
        unsubscribe() {
          ...
          this._mode.unsubscribe(this._onStatusChanged),
            ...
            null === (e = this._quotesSubscription) || void 0 === e || e.unsubscribe(),
            null === (t = this._informerMessageSubscription) || void 0 === t || t.unsubscribe();
        }
        showCancelButton() {
        ...
        _hasBackButton() {
          return (
            this._mode.value() === $.OrderEditorDisplayMode.Panel &&
            (this._isExistingOrder ||
              1 !== this._parentType ||
              this._status.value() === $.OrderPanelStatus.Preview)
          );
        }
        _hasCancelButton() {
          return (
            this._mode.value() === $.OrderEditorDisplayMode.Panel &&
            this._status.value() === $.OrderPanelStatus.Active &&
            !this._isExistingOrder &&
            1 === this._parentType
          );
        }
        _hasCloseButton() {
          return a.enabled('order_panel_close_button');
        }
        _title() {
          return this._status.value() === $.OrderPanelStatus.Preview
            ? d.t(null, void 0, i(147380))
            : this._displaySymbolName;
        }
        _text() {
          if (this._status.value() !== $.OrderPanelStatus.Preview) {
            if (!this._isExistingOrder || void 0 === this._data || void 0 === this._formatter)
              return this._brokerName || void 0;
            if (1 === this._parentType) return d.t(null, void 0, i(35387)) + ' ' + this._data.id;
            if (2 === this._parentType || 3 === this._parentType) {
              const e = this._data.side,
                t = this._data.qty,
                s = this._formatter.format(
                  this._data.price || this._data.avgPrice || this._data.limitPrice,
                );
              return (
                (1 === e ? d.t(null, void 0, i(273064)) : d.t(null, void 0, i(777851))) +
                ' ' +
                t +
                ' @ ' +
                s
      ...
      var R = i(446685),
        ...
        N = (function (e) {
          ...
          return (
            ...
            (t.prototype.requestAsyncId = function (e, t, i) {
              return void 0 === i && (i = 0), E.setInterval(e.flush.bind(e, this), i);
            }),
            (t.prototype.recycleAsyncId = function (e, t, i) {
              if ((void 0 === i && (i = 0), null != i && this.delay === i && !1 === this.pending))
                return t;
              E.clearInterval(t);
            }),
            ...
            (t.prototype._execute = function (e, t) {
              ...
              try {
                ...
                (s = !0), (i = e || new Error('Scheduled action threw falsy error'));
              }
        ...
        W = (function () {
          ...
          return (
            ...
            (e.now = Q.dateTimestampProvider.now),
            e
          );
        })(),
        A = new ((function (e) {
          function t(t, i) {
            void 0 === i && (i = W.now);
            var s = e.call(this, t, i) || this;
            return (s.actions = []), (s._active = !1), (s._scheduled = void 0), s;
          }
          return (
            (0, R.__extends)(t, e),
        ...
        z = i(116217),
        U = i(138966),
        H = { leading: !0, trailing: !1 };
      var G = i(337160);
      function K(e, t, i) {
        void 0 === e && (e = 0), void 0 === i && (i = j);
        var s = -1;
        return (
          null != t && ((0, G.isScheduler)(t) ? (i = t) : (s = t)),
          new P.Observable(function (t) {
            var r,
              o = (r = e) instanceof Date && !isNaN(r) ? +e - i.now() : e;
            o < 0 && (o = 0);
            var n = 0;
            return i.schedule(function () {
              t.closed || (t.next(n++), 0 <= s ? this.schedule(void 0, s) : t.complete());
            }, o);
          })
        );
      }
      function J(e, t, i) {
        void 0 === t && (t = A), void 0 === i && (i = H);
        var s,
          r,
          o,
          n,
        ...
        return (
          ...
          (n = (o = void 0 === (r = i) ? H : r).leading),
          (a = o.trailing),
          (0, z.operate)(function (e, t) {
            var i = !1,
              r = null,
              o = null,
              l = !1,
              u = function () {
                null == o || o.unsubscribe(), (o = null), a && (c(), l && t.complete());
              },
              d = function () {
                (o = null), l && t.complete();
              },
              h = function (e) {
                return (o = (0, k.innerFrom)(s(e)).subscribe(new U.OperatorSubscriber(t, u, d)));
              },
              c = function () {
                if (i) {
                  i = !1;
                  var e = r;
                  (r = null), t.next(e), !l && h(e);
                }
              };
            e.subscribe(
      ...
      class X {
        constructor({
          ...
          (this.baseCurrency = null),
            ...
            (this._formattedQuotes$ = new y.BehaviorSubject({ ask: ' ', bid: ' ' })),
            ...
            (this.getRestrictionTypes = () => this._restrictionTypes$.getValue()),
        ...
        subscribe() {
          ...
          const e = this._quotes$.subscribe(e => {
            ...
            t = this._quotes$.pipe(J(2e3, A, { leading: !0, trailing: !0 })).subscribe(e => {
        ...
        _generateText(e) {
          ...
          return (
            ...
            (t.spread = (0, Y.isNumber)(e.spread)
        ...
        _generateRestrictionTypes(e) {
          const t = [];
          return (
            e.isHalted && t.push(T.RestrictionType.Halted),
            e.isHardToBorrow && t.push(T.RestrictionType.HardToBorrow),
            e.isNotShortable && t.push(T.RestrictionType.NotShortable),
            t
          );
        }
      }
      ...
      function ne() {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        var i = (0, oe.popResultSelector)(e);
        return (0, z.operate)(function (t, s) {
          for (
            var r = e.length,
              o = new Array(r),
              n = e.map(function () {
              ...
              l = function (t) {
                (0, k.innerFrom)(e[t]).subscribe(
                  new U.OperatorSubscriber(
                    ...
                    function (e) {
                      (o[t] = e),
                        a || n[t] || ((n[t] = !0), (a = n.every(se.identity)) && (n = null));
                    },
                    re.noop,
                  ),
                );
            ...
            l(u);
          t.subscribe(
            new U.OperatorSubscriber(s, function (e) {
              if (a) {
                var t = (0, R.__spreadArray)([e], (0, R.__read)(o), !1);
                s.next(i ? i.apply(void 0, (0, R.__spreadArray)([], (0, R.__read)(t), !1)) : t);
              }
            }),
          );
        });
      ...
      var ae = i(957877);
      const le = d.t(null, void 0, i(145088));
      function ue(e, t, i, s) {
        const r = new Z.Big(t),
          o = r.mul(e).div(100);
      ...
      class de {
        constructor({
          ...
          (this.id = (0, I.randomHashN)(6)),
            ...
            (this.setAbsolutePrice = e => {
              ...
              if (
                ...
                const i =
                  null !== (t = this.getPriceControlData()) && void 0 !== t
                    ? t
                    : { index: 0, value: 0, absolutePrice: '', offset: 0, base: 'ask' };
              ...
              (0, S.combineLatest)({
                ...
                .pipe((0, te.take)(1))
                .subscribe(t => {
                  const { quotes: i, stopPriceControlData: n, side: a, orderType: l } = t,
                    u = this._getBase(a, l);
                  switch (u) {
                    case 'stop':
                  ...
                  this._setPrice({ index: r, value: s, absolutePrice: e, offset: o, base: u });
                });
            }),
            (this.setPriceValue = (e, t = !1) => {
              (0, S.combineLatest)({
                ...
                .pipe((0, te.take)(1))
                .subscribe(i => {
                  const { quotes: s, stopPriceControlData: r, side: o, orderType: n } = i;
                  (this._roundToStepRequired() || t) &&
                    (e = (0, u.roundToStepByPriceTypeAndSide)(
                      e,
                      this.getStep(e),
                      this.priceType,
                      o,
            ...
            (this.setPriceOffset = e => {
              (0, S.combineLatest)({
                ...
                .pipe((0, te.take)(1))
                .subscribe(t => {
                  const { quotes: i, stopPriceControlData: s, side: r, orderType: o } = t;
                  let n = 0;
            ...
            (this.forcePriceUpdate = e => {
              null !== e &&
                (this.setControlError(!1), this.setFocusedControl(0), this.setPriceValue(e, !0));
            }),
            (this.getPriceControlData = () => this._priceControlData$.getValue()),
            (this.getPrice = () => {
              var e, t;
              return null !==
                (t =
                  null === (e = this.getPriceControlData()) || void 0 === e ? void 0 : e.value) &&
                void 0 !== t
                ? t
                : null;
            }),
            ...
            (this._setError = e => {
              ...
              if (a === $.OrderPanelStatus.Wait) return void this._error$.next({ res: !1 });
              if (n.res) return void this._error$.next(n);
              let l = { res: !1 },
                u = { res: !1 };
              if (null === t) l = { res: !0, severity: 'error', msg: d.t(null, void 0, i(347957)) };
              else {
                const e = this.getStep(t.value);
                if (((u = this._checkPriceWarning(t.value, s, r)), null !== o && 2 !== o)) {
                  ...
                  for (const s of this._stopLimitPercentPriceRuleCheckers)
                    if (
                      ((l = s({
                        ...
                        priceStep: e,
                        priceType: this.priceType,
                        isStatusEditing: a === $.OrderPanelStatus.Editing,
                      })),
                      l.res)
                    )
                      break;
            ...
            (this.supportStopOrdersInBothDirections = Boolean(m)),
            (this.supportStopLimitOrdersInBothDirections = Boolean(P)),
            ...
            (this._variableMinTickData = r.variableMinTick
              ? (0, q.makeVariableMinTickData)(this._minTick, r.variableMinTick)
              : void 0);
          const C = this.getStep();
          (this.indexToPrice = (0, q.makePriceIndexToPriceConverter)(C, this._variableMinTickData)),
            (this._priceToIndex = (0, q.makePriceToPriceIndexConverter)(
              C,
            ...
            (this.error$ = this._error$.pipe((0, ie.distinctUntilChanged)())),
          ...
          !g &&
            ...
            (this.modifiedAbsolutePriceControlStat =
              null !== c
                ? () => c.setPriceControlModifiedProperty($.PriceSubControlType.Absolute)
                : () => {}),
            (this.modifiedRelativePriceControlStat =
              null !== c
                ? () => c.setPriceControlModifiedProperty($.PriceSubControlType.Relative)
                : () => {}),
            void 0 !== p && this.setPriceValue(p, !0);
          const T = null != _ ? _ : [];
          this._priceRules = null !== (k = T.filter(this._isPriceRules)) && void 0 !== k ? k : [];
          const O =
              null !== (f = T.filter(V.isStopLimitPercentValidationRule)) && void 0 !== f ? f : [],
            D =
              1 === this.priceType ? V.isLimitPercentValidationRule : V.isStopPercentValidationRule;
          O.filter(D).forEach(e => {
              ...
              (function (e, t) {
                ...
                return r => {
                  const {
                    ...
                    y = ue(e, n, _, b),
                    g = ue(t, n, _, b),
                    v = (0, u.roundToStepByPriceTypeAndSide)(y, h, c, a),
                    m = (0, u.roundToStepByPriceTypeAndSide)(g, h, c, a);
                  let P = Math.min(v, m),
                    k = Math.max(v, m);
                  return (
                    p && (void 0 === s && (s = o), (P = Math.min(P, s)), (k = Math.max(k, s))),
                    o >= P && o <= k
                      ? { res: !1 }
                      : {
                          res: !0,
        ...
        subscribe() {
          ...
          const e = (0, S.combineLatest)({
            ...
            i = (0, S.combineLatest)({
              ...
              this._value$.next((i.res && 'error' === i.severity) || null === t ? null : t.value);
            });
        ...
        resetPrice() {
          this.setControlError(!1),
            this.setFocusedControl(
              this._settings.value().showRelativePriceControl && !this.isRelativePriceControlHidden
                ? 1
                : 0,
            ),
            (0, S.combineLatest)([this.quotes$, this.side$])
              .pipe((0, te.take)(1))
              .subscribe(([e, t]) => {
                this.setPriceValue(1 === t ? (0, w.getAsk)(e) : (0, w.getBid)(e), !1);
              });
        }
        _checkPriceWarning(e, t, i) {
          const s = this._priceRules.find(s => this._isDistanceRuleViolated(e, t, s, i));
          return s
            ? { res: !0, severity: s.severity, msg: le.format({ brokerTitle: this._brokerTitle }) }
            : { res: !1, msg: void 0 };
        }
        _isDistanceRuleViolated(e, t, i, s) {
          ...
          let n = null;
          if (
            (r && 'buyDirectionPips' in i.options && (n = i.options.buyDirectionPips),
            !r && 'sellDirectionPips' in i.options && (n = i.options.sellDirectionPips),
            null === n)
          )
            return !1;
        ...
        _getBase(e, t) {
          return 1 === this.priceType && 4 === t ? 'stop' : 1 === e ? 'ask' : 'bid';
        }
          ...
          (this._subscriptions = []),
            (this._calculateLimitModelPrice = e => {
              ...
              const i = this._limitPriceModel.getStep(t),
                s = 1 === e ? 1 : -1;
              return new (ee())(i).mul(s).plus(t).toNumber();
            }),
            (this._orderType$ = i),
            (this._side$ = s),
            ...
            (this.price$ = (0, S.combineLatest)({
              ...
              (0, b.map)(e => {
                const { orderType: t, side: i, quotes: s, stopPrice: r, limitPrice: o } = e;
                switch (t) {
                  case 1:
                  case 4:
                    return o || he(s, i);
            ...
            .pipe(
              (0, z.operate)(function (e, t) {
                var i,
                  s = !1;
                e.subscribe(
                  new U.OperatorSubscriber(t, function (e) {
                    var r = i;
      ...
      var pe = i(316230),
        ...
        be = Array.isArray;
      function ye(e) {
        return 1 === e.length && be(e[0]) ? e[0] : e;
      }
      var ge = i(423869);
      function ve() {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                      ...
                      new U.OperatorSubscriber(
                        ...
                        function (s) {
                          if (
                            ...
                            e.next(
                              i
                                ? i.apply(void 0, (0, R.__spreadArray)([], (0, R.__read)(n), !1))
                                : n,
                            ),
                              t.some(function (e, t) {
                                return !e.length && r[t];
      ...
      class Te {
        constructor({
          ...
          (this.formatter = new me.SplitThousandsFormatter()),
            (this.riskInCurrencyFormatter = new O.PriceFormatter(100)),
            (this.riskInPercentFormatter = new O.PriceFormatter(100)),
            (this.riskStep = 0.01),
            (this.onControlFocused = new B.Delegate()),
            (this._subscriptions = []),
            (this._value$ = new y.BehaviorSubject(null)),
            ...
            (this._setQuantity = e => {
              this._quantity$.next((0, D.formatValue)(e, this.formatter));
            }),
            (this._setRiskInCurrency = e => {
              this._riskInCurrency$.next((0, D.formatValue)(e, this.riskInCurrencyFormatter));
            }),
            (this._setRiskInPercent = e => {
              this._riskInPercent$.next((0, D.formatValue)(e, this.riskInPercentFormatter));
            }),
            (this.qty = n.qty),
            (this.units = n.units),
            (this._lotSize = n.lotSize),
            (this.showRiskControls = u),
            (this.currency = a),
            (this._equity$ = i),
            (this._pipValue$ = s),
            ...
            (this._quantity$ = new y.BehaviorSubject(
              null !== (d = null != o ? o : this.qty.default) && void 0 !== d ? d : null,
            )),
            (this.value$ = this._value$.asObservable()),
            (this.focusedControl$ = this._focusedControl$.asObservable()),
            ...
            (this.quantity = {
              ...
              onModifiedCallback: () =>
                null !== l
                  ? l.setQtyControlModifiedProperty($.QuantitySubControlType.Units)
                  : () => {},
              calculatorUsedStat: () => (null !== l ? l.setCalculatorUsedProperty() : () => {}),
            }),
            (this.riskInCurrency = {
              value$: this._riskInCurrency$.asObservable(),
              getValue: () => this._riskInCurrency$.getValue(),
              setValue: this._setRiskInCurrency,
              onModifiedCallback: () =>
                null !== l
                  ? l.setQtyControlModifiedProperty($.QuantitySubControlType.RiskInCurrency)
                  : () => {},
              calculatorUsedStat: () => (null !== l ? l.setCalculatorUsedProperty() : () => {}),
            }),
            (this.riskInPercent = {
              value$: this._riskInPercent$.asObservable(),
              getValue: () => this._riskInPercent$.getValue(),
              setValue: this._setRiskInPercent,
              onModifiedCallback: () =>
                null !== l
                  ? l.setQtyControlModifiedProperty($.QuantitySubControlType.RiskInPercent)
                  : () => {},
              calculatorUsedStat: () => (null !== l ? l.setCalculatorUsedProperty() : () => {}),
            }),
        ...
        subscribe() {
          this._settings.subscribe(this._updateFocusIfNeeded);
          const e = this._stopLossAvailable$.subscribe(e => {
              this._isRiskAvailable$.next(e), e || this.setFocusedControl(0);
            }),
            t = (0, S.combineLatest)({
              quantityValuesWithFocusedControl: this._quantityValuesWithFocusedControl$,
              ...
              ({
                ...
                const { focusedControl: r, quantity: o, riskInCurrency: n, riskInPercent: a } = e,
                  {
                    quantity: l,
                    riskInCurrency: u,
                    riskInPercent: d,
                ...
                (o === l && n === u && a === d) || this._setUnfocusedControlsValues(r, l, u, d);
              },
            ),
            i = (0, S.combineLatest)({
              ...
              .pipe((0, ie.distinctUntilChanged)(pe.default))
              .subscribe(e => {
                const { qty: t, controlError: i, focus: s } = e,
                  r = (0, Pe.checkQtyError)(this.qty, t, !0),
                  o = i.res ? i.msg : r.msg;
                this._error$.next({ res: r.res || i.res, msg: o }),
                  this._value$.next(r.res || i.res || null === s ? null : t);
              });
          this._subscriptions = [e, t, i];
        }
        unsubscribe() {
        ...
        _calculateQuantityValues(e) {
          return {
            quantity: (0, D.formatValue)(this._calculateQuantity(e), this.formatter),
            riskInCurrency: (0, D.formatValue)(
              this._calculateRiskInCurrency(e),
              this.riskInCurrencyFormatter,
            ),
            riskInPercent: (0, D.formatValue)(
        ...
        _quantityObservable(e) {
          return this._quantity$.pipe(
            (0, _e.switchMap)(t =>
              ve([this._riskInCurrency$, this._riskInPercent$]).pipe(
                (0, b.map)(i => {
                  const [s, r] = i;
                  return { focusedControl: e, quantity: t, riskInCurrency: s, riskInPercent: r };
                }),
              ),
            ),
          );
        ...
        _riskInCurrencyObservable(e) {
          return this._riskInCurrency$.pipe(
            (0, _e.switchMap)(t =>
              ve([this._quantity$, this._riskInPercent$]).pipe(
                (0, b.map)(i => {
                  const [s, r] = i;
                  return { focusedControl: e, quantity: s, riskInCurrency: t, riskInPercent: r };
                }),
              ),
            ),
          );
        ...
        _riskInPercentObservable(e) {
          return this._riskInPercent$.pipe(
            (0, _e.switchMap)(t =>
              ve([this._quantity$, this._riskInCurrency$]).pipe(
                (0, b.map)(i => {
                  const [s, r] = i;
                  return { focusedControl: e, quantity: s, riskInCurrency: r, riskInPercent: t };
                }),
              ),
            ),
          );
        ...
        _calculateQuantity(e) {
          ...
          switch (t) {
            ...
            default:
              return s;
            case 1:
              return null === r || null === n ? null : ke(r, n, i, this.qty.step, this._lotSize);
            case 2:
              return null === o || null === n ? null : fe(o, a, n, i, this.qty.step, this._lotSize);
          }
        }
        _calculateRiskInCurrency(e) {
          ...
          switch (t) {
            case 0:
              return null === s || null === n ? null : Ce(s, n, i, this._lotSize);
            case 1:
              return r;
            case 2:
              if (null === o || null === n) return null;
              return Ce(fe(o, a, n, i, this.qty.step, this._lotSize), n, i, this._lotSize);
            default:
              return null === s || null === n ? null : Ce(s, n, i);
          }
        }
        _calculateRiskInPercent(e) {
          ...
          switch (t) {
            case 0:
            default:
              return null === s || l ? null : Se(s, n, i, a, this._lotSize);
            case 1:
              if (null === r || l) return null;
              return Se(ke(r, n, i, this.qty.step, this._lotSize), n, i, a, this._lotSize);
            case 2:
              return o;
          }
        }
      ...
      class we {
        constructor({
          ...
          (this.formatter = new $e.QuantityFormatter()),
            (this.onControlFocused = new B.Delegate()),
            (this._value$ = new y.BehaviorSubject(null)),
            ...
            (this._controlError$ = new y.BehaviorSubject({ res: !1 })),
            (this._baseCurrencyCryptoBalanceValue$ = new y.BehaviorSubject(null)),
            (this._quoteCurrencyCryptoBalanceValue$ = new y.BehaviorSubject(null)),
            (this._subscriptions = []),
            (this.setControlError = e => {
              this._controlError$.next({ res: e });
            }),
            ...
            (this._setBaseCurrencyQuantity = e => {
              this._baseCurrencyQuantity$.next((0, D.formatValue)(e, this.formatter));
            }),
            (this._setQuoteCurrencyQuantity = e => {
              this._quoteCurrencyQuantity$.next((0, D.formatValue)(e, this.formatter));
            }),
            (this.info = e),
            (this.side$ = o),
            (this.getSide = n),
            ...
            (this.quoteCurrencyUiParams$ = t.pipe(
              (0, b.map)(t => {
                const i = (0, Z.Big)(t).mul(e.qty.step),
                  s = (0, u.roundDownToPowerOf10)(i.toNumber()),
                  r = (0, Z.Big)(Math.ceil(i.div(s).toNumber())).mul(s),
                  o = (0, Z.Big)(e.qty.min).div(e.qty.step);
                return { min: r.mul(o).toNumber(), step: s };
              }),
            )),
            (this.quantity = {
              ...
              onModifiedCallback:
                null !== a
                  ? () => a.setQtyControlModifiedProperty($.QuantitySubControlType.BaseCurrency)
                  : () => {},
            }),
            (this.quoteCurrencyQuantity = {
              ...
              onModifiedCallback:
                null !== a
                  ? () => a.setQtyControlModifiedProperty($.QuantitySubControlType.QuoteCurrency)
                  : () => {},
            }),
            (this._quantityValuesWithFocusedControl$ =
              this._quantityValuesWithFocusedControlObservable());
        ...
        subscribe() {
          null !== this._baseCurrencyCryptoBalance$ &&
            this._subscriptions.push(
              (0, S.combineLatest)([this.side$, this._baseCurrencyCryptoBalance$]).subscribe(e => {
                const [t, i] = e;
            ...
            null !== this._quoteCurrencyCryptoBalance$ &&
              this._subscriptions.push(
                (0, S.combineLatest)([this.side$, this._quoteCurrencyCryptoBalance$]).subscribe(
                  e => {
                    const [t, i] = e;
          ...
          const e = (0, S.combineLatest)({
              ...
              const { price: t, quantityValuesWithFocusedControl: i } = e,
                { focusedControl: s, baseCurrencyQuantity: r, quoteCurrencyQuantity: o } = i,
            ...
            t = (0, S.combineLatest)({
              ...
              const {
                ...
                l = (0, Pe.checkQtyError)(this.info.qty, t),
                u = this._isSellSide(o)
                  ? this._checkBalanceError(t, n)
                  : this._checkBalanceError(i, a);
              this._error$.next({ res: l.res || u.res || s.res, msg: l.msg || u.msg || s.msg }),
                this._value$.next(l.res || u.res || s.res || null === r ? null : t);
            });
        ...
        _quantityValuesWithFocusedControlObservable() {
          return this._focusedControl$.pipe(
            (0, _e.switchMap)(e => {
              const t = 3 === e,
                i = t ? this._baseCurrencyQuantity$ : this._quoteCurrencyQuantity$,
                s = t ? this._quoteCurrencyQuantity$ : this._baseCurrencyQuantity$;
              return i.pipe(
                (0, _e.switchMap)(i =>
                  s.pipe(
                    (0, b.map)(s => ({
        ...
        _checkBalanceError(e, t) {
          return null !== e && null !== t && e > t
            ? { res: !0, msg: Pe.qtyErrors.balance }
            : { res: !1 };
        }
        _getBalance(e, t) {
        ...
        _makeOrderBalanceValue(e) {
          return this._isExistingOrder && this._orderQty && this._orderPrice
            ? this._isSellSide(e)
              ? new Z.Big(this._orderQty)
              : new Z.Big(this._orderQty).mul(this._orderPrice)
            : new Z.Big(0);
        }
        _isSellSide(e) {
          return -1 === e;
        ...
        _setUnfocusedControlsValues(e, t, i) {
          3 !== e && this._setBaseCurrencyQuantity(t), 4 !== e && this._setQuoteCurrencyQuantity(i);
        }
        _calculateQuantityValues(e) {
          const {
            focusedControl: t,
          ...
          switch (t) {
            case 3:
              null !== s && (n = (0, Z.Big)(s).mul(i).toNumber());
              break;
            case 4:
              null !== r &&
                (o = (0, Z.Big)(r)
          ...
          return {
            baseCurrencyQuantity: (0, D.formatValue)(o, this.formatter),
            quoteCurrencyQuantity: (0, D.formatValue)(n, this.formatter),
          };
        }
      }
      var Ve = i(346849),
      ...
      class Be {
        constructor({
          ...
          supportAddBracketsToExistingOrder: q,
          hasTrailingStopBracket: F,
        }) {
          if (
            ((this.isValuesInitialized = !1),
            (this.onControlFocused = new B.Delegate()),
            (this.stopLossTypes = [T.BracketType.StopLoss, T.BracketType.TrailingStop]),
            ...
            (this._setPips = e => {
              this._pips$.next((0, D.formatValue)(e, this._pipsFormatter));
            }),
            (this._setPrice = e => {
              this._price$.next((0, D.formatValue)(e, this._priceFormatter));
            }),
            (this._setRiskInCurrency = e => {
              this._riskInCurrency$.next((0, D.formatValue)(e, this._riskInCurrencyFormatter));
            }),
            (this._setRiskInPercent = e => {
              this._riskInPercent$.next((0, D.formatValue)(e, this._riskInPercentFormatter));
            }),
            ...
            (this._pipValue$ = l),
            (this._side$ = u),
            (this._sideSign$ = u.pipe(
              (0, b.map)(e => (s !== T.BracketType.TakeProfit ? -1 : 1) * e),
            )),
            (this._quotes$ = n),
            (this._amount$ = h),
            ...
            (this._settings = m),
            (this._parentType = g),
            (this._priceType = s === T.BracketType.TakeProfit ? 1 : 2),
            (this._supportCryptoBrackets = Boolean(I)),
            (this._isStatusEditing = 1 !== g || f === $.OrderPanelStatus.Editing),
            (this._pipsFormatter = new O.PriceFormatter(a.pipSize !== a.minTick ? 10 : 1)),
            (this._priceFormatter = r),
            (this._riskInCurrencyFormatter = new O.PriceFormatter(100)),
            (this._riskInPercentFormatter = new O.PriceFormatter(100)),
            ...
            (this._parentPrice$ = (0, S.combineLatest)({
              ...
              (0, b.map)(e => {
                ...
                if (s === T.BracketType.TrailingStop) {
                  if (2 === i) return 1 === o ? (0, w.getAsk)(r) : (0, w.getBid)(r);
                  if (1 !== this._parentType) return 1 === o ? (0, w.getBid)(r) : (0, w.getAsk)(r);
                }
                return t;
              }),
            )),
            ...
            for (const e of C)
              this._bracketPercentPriceRuleCheckers.push(
                (0, Ve.makeBracketPercentPriceRuleChecker)(e.options.min, e.options.max),
              );
          (this._priceStep = (0, w.getPriceStep)({
            ...
            (this.roundToStopLimitPriceStepRequired = (0, w.roundToStepRequired)({
              priceType: this._priceType,
              minTick: a.minTick || a.pipSize,
              limitPriceStep: a.limitPriceStep,
              stopPriceStep: a.stopPriceStep,
            ...
            (0, S.combineLatest)({
              ...
              .pipe((0, te.take)(1))
              .subscribe(t => {
                const { parentPrice: i, sideSign: r, pipValue: o, equity: n, amount: a } = t;
                let l,
                  u,
                  d = 0;
                null !== e
            ...
            (this.pips = {
              ...
              onModifiedCallback:
                null !== P
                  ? () => P.setBracketControlModifiedProperty(s, $.BracketSubControlType.Pips)
                  : () => {},
            }),
            (this.price = {
              ...
              onModifiedCallback:
                null !== P
                  ? () => P.setBracketControlModifiedProperty(s, $.BracketSubControlType.Price)
                  : () => {},
            }),
            (this.riskInCurrency = {
              value$: this._riskInCurrency$.asObservable(),
              ...
              onModifiedCallback:
                null !== P
                  ? () => P.setBracketControlModifiedProperty(s, $.BracketSubControlType.Money)
                  : () => {},
            }),
            (this.riskInPercent = {
              value$: this._riskInPercent$.asObservable(),
              ...
              onModifiedCallback:
                null !== P
                  ? () => P.setBracketControlModifiedProperty(s, $.BracketSubControlType.Percent)
                  : () => {},
            }),
            (this.value$ = this._value$.asObservable()),
            ...
            (this.focusedControl$ = this._focusedControl$.asObservable()),
            (this.error$ = this._error$.asObservable()),
            (this.controlState = this._computeControlState(g, s, M, V, q)),
            (this.currency = _.length > 0 ? _ : d.t(null, void 0, i(470500))),
        ...
        subscribe() {
          ...
          const e = (0, S.combineLatest)({
              ...
              const {
                ...
                { focusedControl: l, pips: u, price: d, riskInCurrency: h, riskInPercent: c } = a,
                {
                  pips: p,
                  price: _,
                  riskInCurrency: b,
            ...
            i = (0, S.combineLatest)({
              ...
              this._value$.next(
                i.res || !s || null === t
                  ? null
                  : (0, Z.Big)(t).div(this._priceMagnifier).toNumber(),
              );
            });
        ...
        _getDefaultPips(e) {
          return e === T.BracketType.TakeProfit
            ? $.BracketDefaultPips.TakeProfit
            : $.BracketDefaultPips.StopLoss;
        }
          ...
          o.res
            ...
            : this._error$.next(
                (0, Ve.checkBracketError)({
                  ...
                  isRoundToPriceStep: this.roundToStopLimitPriceStepRequired && 1 === n,
                }),
              );
        }
        _pipsObservable(e) {
          return this._pips$.pipe(
            (0, _e.switchMap)(t =>
              ve([this._price$, this._riskInCurrency$, this._riskInPercent$]).pipe(
                (0, b.map)(i => {
                  const [s, r, o] = i;
                  return {
                    focusedControl: e,
        ...
        _priceObservable(e) {
          return this._price$.pipe(
            (0, _e.switchMap)(t =>
              ve([this._pips$, this._riskInCurrency$, this._riskInPercent$]).pipe(
                (0, b.map)(i => {
                  const [s, r, o] = i;
                  return {
                    focusedControl: e,
        ...
        _riskInCurrencyObservable(e) {
          return this._riskInCurrency$.pipe(
            (0, _e.switchMap)(t =>
              ve([this._pips$, this._price$, this._riskInPercent$]).pipe(
                (0, b.map)(i => {
                  const [s, r, o] = i;
                  return {
                    focusedControl: e,
        ...
        _riskInPercentObservable(e) {
          return this._riskInPercent$.pipe(
            (0, _e.switchMap)(t =>
              ve([this._pips$, this._price$, this._riskInCurrency$]).pipe(
                (0, b.map)(i => {
                  const [s, r, o] = i;
                  return {
                    focusedControl: e,
        ...
        _calculateBracketValues(e) {
          return {
            pips: (0, D.formatValue)(this._calculatePips(e), this._pipsFormatter),
            price: (0, D.formatValue)(this._calculatePrice(e), this._priceFormatter),
            riskInCurrency: (0, D.formatValue)(
              this._calculateRiskInCurrency(e),
        ...
        _calculatePips(e) {
          ...
          switch (n) {
            ...
            default:
              return a;
            case 1:
              return null === l ? null : (0, Ie.priceToPips)(l, r, t, this._pipSize);
            case 2:
              return null === u || null === o
                ? null
                : (0, Ie.riskInCurrencyToPips)(u, o, i, this._priceMagnifier, this._lotSize);
            case 3:
              return null === d || null === o
                ? null
                : (0, Ie.riskInPercentToPips)(d, o, s, i, this._priceMagnifier, this._lotSize);
          }
        }
        _calculatePrice(e) {
          const {
          ...
          switch (n) {
            ...
            default:
              ...
              p = (0, Ie.pipsToPrice)(a, r, t, this._pipSize);
              break;
            case 1:
              return l;
            case 2:
              if (null === d || null === o) return null;
              (c = (0, Ie.riskInCurrencyToPips)(d, o, i, this._priceMagnifier, this._lotSize)),
                (p = (0, Ie.pipsToPrice)(c, r, t, this._pipSize));
              break;
            case 3:
              if (null === h || null === o) return null;
              (c = (0, Ie.riskInPercentToPips)(h, o, s, i, this._priceMagnifier, this._lotSize)),
                (p = (0, Ie.pipsToPrice)(c, r, t, this._pipSize));
          }
          return this.roundToStopLimitPriceStepRequired
            ? (0, u.roundToStepByPriceTypeAndSide)(p, this._priceStep, this._priceType, t)
            : p;
        }
        _calculateRiskInCurrency(e) {
          const {
          ...
          let h;
          const c = null === a || null === o;
          switch (n) {
            case 0:
            default:
              return c
                ? null
                : (0, Ie.pipsToRiskInCurrency)(a, o, i, this._priceMagnifier, this._lotSize);
            case 1:
              return null === l || c
                ? null
                : ((h = (0, Ie.priceToPips)(l, r, t, this._pipSize)),
                  (0, Ie.pipsToRiskInCurrency)(h, o, i, this._priceMagnifier, this._lotSize));
            case 2:
              return u;
            case 3:
              return null === d || c
                ? null
                : ((h = (0, Ie.riskInPercentToPips)(
                    d,
                    o,
                    s,
                    i,
        ...
        _calculateRiskInPercent(e) {
          ...
          switch (n) {
            ...
            default:
              return c
                ? null
                : (0, Ie.pipsToRiskInPercent)(a, o, s, i, this._priceMagnifier, this._lotSize);
            case 1:
              return null === l || c
                ? null
                : ((h = (0, Ie.priceToPips)(l, r, t, this._pipSize)),
                  (0, Ie.pipsToRiskInPercent)(h, o, s, i, this._priceMagnifier, this._lotSize));
            case 2:
              return null === u || null === o
                ? null
                : ((h = (0, Ie.riskInCurrencyToPips)(u, o, i, this._priceMagnifier, this._lotSize)),
                  (0, Ie.pipsToRiskInPercent)(h, o, s, i, this._priceMagnifier, this._lotSize));
            case 3:
              return d;
          }
        ...
        _computeControlState(e, t, i, s, r) {
          const o =
              ...
              t === T.BracketType.TrailingStop &&
              !s &&
              this._hasTrailingStopBracket,
            n =
              this._isStatusEditing &&
              t !== T.BracketType.TakeProfit &&
              this.getEnabled() &&
              !s &&
              this._hasTrailingStopBracket,
      ...
      function Oe(e) {
        return (0, z.operate)(function (t, i) {
      ...
      class De {
        constructor({
          ...
          (this.onControlFocused = new B.Delegate()),
            (this._stop$ = new m.Subject()),
            (this.durationMetaInfoList =
              void 0 !== s ? (0, w.filterDurationsBySymbolDurations)(s, r) : []),
            (this.orderType = t);
          const o = this._getDurationByOrderType(e, t.value());
          (this.$value = new y.BehaviorSubject(o)),
            (this.currentDuration = new qe.WatchedObject(o, D.comparator)),
            (this._currentDurationSubscription = (0, D.makeSubjectFromWatchedValue)(
              this.currentDuration,
            )),
            (this._orderTypeSubscription = (0, D.makeSubjectFromWatchedValue)(this.orderType)),
            this._currentDurationSubscription.subject.pipe(Oe(this._stop$)).subscribe(e => {
              this.$value.next(e);
            }),
            this._orderTypeSubscription.subject.pipe(Oe(this._stop$)).subscribe(e => {
              const t = this._getDurationByOrderType(this.getValue(), e);
              this.currentDuration.setValue(t);
            }),
            (this.onModifiedCallback =
              null !== i ? () => i.setDurationControlModifiedProperty() : () => {});
        }
        isDurationsAvailable() {
          return (
            null !==
            this._getDurationByOrderType(this.currentDuration.value(), this.orderType.value())
          );
        }
        unsubscribe() {
          this._stop$.next(),
        ...
        _getDurationByOrderType(e, t) {
          const i = (0, w.filterDurationsByOrderType)(this.durationMetaInfoList, t);
      ...
      function Re(e, t = 100, i) {
        ...
        return function (...o) {
          ...
          const a = String(i ? i.apply(null, o) : o),
            l = Date.now();
          if (s.has(a) && (null !== (n = r.get(a)) && void 0 !== n ? n : -1 / 0) > l)
            return s.get(a);
          const u = e.apply(this, o);
          return s.set(a, u), r.set(a, l + t), u;
        };
      }
      const Le = (0, o.getLogger)('Trading.LeverageViewModel');
      class Ee {
        constructor({
          ...
          (this.onControlFocused = new B.Delegate()),
            ...
            (this.leveragePreviewResult = () => this._leveragePreviewResult$.getValue()),
            (this.setLeverage = async e => {
              try {
                const t = await this._adapterSetLeverage(e),
                  i = this.leverageInfo();
                null !== i && this._leverageInfo$.next({ ...i, leverage: t.leverage });
              } catch (e) {
                throw (
                  (Le.logError(`Failed to set leverage: ${(0, u.getLoggerMessage)(e)}`),
                  new Error(d.t(null, void 0, i(368662))))
                );
              }
            }),
            (this.previewLeverage = async e => {
              try {
                ...
                throw (
                  ...
                  Le.logError(`Failed to preview leverage: ${(0, u.getLoggerMessage)(e)}`),
                  new Error(d.t(null, void 0, i(575681))))
                );
              }
            }),
            ...
            (this._orderType$ = l),
            (this._side$ = h),
            (this._customFieldModels = p),
            (this.brokerName = o),
            (this.leverageInfo$ = this._leverageInfo$.asObservable()),
            (this.orderType = (0, r.ensureNotNull)(l.value)),
            (this.side = c),
            (this.customFields = _(this._customFieldModels.value())),
            (this._customFieldsGetter = _),
            (this._blocked$ = b),
            (this.blocked$ = this._blocked$.asObservable()),
            (this.onBlockedClick = g),
            (this._selectedItems$ = this._customFieldModels
              .value()
              .filter(e => 'ComboBox' === e.type && 'selectedItem' in e)
              .map(e => {
                const t = (0, D.makeSubjectFromWatchedValue)(e.selectedItem);
                return (e.subscription = t), t.subject;
              })),
            this._subscribe(),
            (this.getLeverageInfo = Re(this.getLeverageInfo));
        }
        unsubscribe() {
        ...
        async getLeverageInfo(e) {
          try {
            ...
            return Le.logError(`Failed to get leverage info: ${(0, u.getLoggerMessage)(e)}`), null;
          }
        }
        getBlocked() {
        ...
        _subscribe() {
          const e = (0, S.combineLatest)([this._orderType$, this._side$])
              .pipe((0, Fe.skip)(1))
              .subscribe(async ([e, t]) => {
            ...
            t = (0, S.combineLatest)(this._selectedItems$)
              .pipe((0, Fe.skip)(1))
              .subscribe(() => {
                (this.customFields = this._customFieldsGetter(this._customFieldModels.value())),
                  this._updateLeverageInfo();
              }),
            i = this.blocked$.pipe((0, Fe.skip)(1)).subscribe(this._updateLeverageInfo);
          this._subscriptions = [e, t, i];
        }
      }
      i(336379);
      const xe = ' ',
        Ne = (e, t) =>
          d.t(null, void 0, i(896582)).format({ qty: e, symbol: t, whitespaceNoBreak: xe }),
        Qe = (e, t, s) =>
          d
            .t(null, void 0, i(111828))
            .format({ qty: e, symbol: t, stopPrice: s, whitespaceNoBreak: xe }),
        We = (e, t, s) =>
          d
            .t(null, void 0, i(518088))
            .format({ qty: e, symbol: t, limitPrice: s, whitespaceNoBreak: xe }),
        Ae = (e, t, s, r) =>
          d
            .t(null, void 0, i(828749))
            .format({ qty: e, symbol: t, stopPrice: s, limitPrice: r, whitespaceNoBreak: xe }),
        [je, ze] = d.t(null, void 0, i(134569)).split(/{line_break}/);
      class Ue {
        constructor(e, t) {
          (this.getValue = () => this._value.getValue()),
            (this.subscribe = () => {
              const e = (0, r.ensureDefined)(this._props);
              if (e.existingOrder || this._tradingEntityType === T.TradingEntityType.Position)
                return;
              const t = {
                status: e.status,
            ...
            (this._orderSubscriptionValues = e => {
              ...
              if (s === $.OrderPanelStatus.Preview)
                return this._value.next({ primaryText: d.t(null, void 0, i(68160)) });
              if (s === $.OrderPanelStatus.Wait)
                return n === $.OrderPlacingStatus.Placed
                  ? this._value.next({ primaryText: d.t(null, void 0, i(862349)) })
                  : this._value.next({ primaryText: je, secondaryText: ze });
              const c = null !== u ? t.formatter.format(u) : '',
                p = null !== h ? t.formatter.format(h) : '',
                _ = null !== l ? t.quantityFormatter.format(l) : '',
                b = 1 === a ? d.t(null, void 0, i(618156)) : d.t(null, void 0, i(392553));
              switch (o) {
                case 2:
                  return this._value.next({ primaryText: b, secondaryText: Ne(_, t.symbol) });
                case 3:
                  return this._value.next({ primaryText: b, secondaryText: Qe(_, t.symbol, c) });
                case 1:
                  return this._value.next({ primaryText: b, secondaryText: We(_, t.symbol, p) });
                case 4:
                  return this._value.next({ primaryText: b, secondaryText: Ae(_, t.symbol, c, p) });
              }
            }),
        ...
        _setInitialValue() {
          ...
          switch (this._tradingEntityType) {
            case T.TradingEntityType.Order:
              const t =
                !0 === (null === (e = this._props) || void 0 === e ? void 0 : e.existingOrder)
                  ? d.t(null, void 0, i(305806))
                  : '';
              this._value.next({ primaryText: t });
              break;
            case T.TradingEntityType.Position:
              this._value.next({ primaryText: d.t(null, void 0, i(768527)) });
          }
        }
      }
      class He {
        constructor({
          ...
          (this._infoTableData$ = new y.BehaviorSubject({ rows: [] })),
            ...
            (this._riskFormatter = new O.PriceFormatter(100)),
            ...
            (this._hasMarginMeter = h && (void 0 !== p || void 0 !== this._marginRate)),
            (this._price$ = r),
        ...
        subscribe() {
          (this._subscriptions = [
            (0, S.combineLatest)({
              ...
              side: this._side$,
              qty: this._qty$,
              leverageInfo: void 0 !== this._leverageInfo$ ? this._leverageInfo$ : (0, M.of)(null),
              tpEnabled: null !== this._tpEnabled$ ? this._tpEnabled$ : (0, M.of)(null),
              tpRiskInCurrency:
                null !== this._tpRiskInCurrency$ ? this._tpRiskInCurrency$ : (0, M.of)(null),
              tpRiskInPercent:
                null !== this._tpRiskInPercent$ ? this._tpRiskInPercent$ : (0, M.of)(null),
              slEnabled: null !== this._slEnabled$ ? this._slEnabled$ : (0, M.of)(null),
              slRiskInCurrency:
                null !== this._slRiskInCurrency$ ? this._slRiskInCurrency$ : (0, M.of)(null),
              slRiskInPercent:
                null !== this._slRiskInPercent$ ? this._slRiskInPercent$ : (0, M.of)(null),
            }).subscribe(e => {
              const {
                price: t,
                pipValue: i,
              ...
              if (
                ...
                (this._pipValueForCurrentQuantity = (0, D.convertToBaseMonetaryUnit)(
                  (0, D.calculatePipValue)(r, i, this._lotSize),
                  this._priceMagnifier,
                )),
                null === r)
              )
                ...
                const e =
                  'crypto' === this._type
                    ? (0, Z.Big)(r).mul(t).toNumber()
                    : (0, D.calculateTradeValue)(r, t, i, this._symbolPipSize, this._lotSize);
                this._tradeValue = (0, D.convertToBaseMonetaryUnit)(e, this._priceMagnifier);
                const s = (0, D.calculateTradeValueByBigPointValue)(
                  r,
                  t,
                  this._bigPointValue,
                  this._lotSize,
                );
                this._tradeValueInSymbolCurrency = (0, D.convertToBaseMonetaryUnit)(
                  s,
                  this._priceMagnifier,
                );
              }
              ...
              c.push(
                ...
                ...this._makeRiskInfo(u, d, h),
              );
              const p = this._getMarginRate();
              null === o && c.unshift(...this._makeLeverageInfo()),
                this._usedMargin$.next((0, D.calculateUsedMargin)(this._tradeValue, p)),
                this._infoTableData$.next({ rows: c });
            }),
          ]),
        ...
        title() {
          return d.t(null, void 0, i(163003));
        }
        infoTableData() {
        ...
        availableMargin() {
          return this._availableMargin$.asObservable();
        }
        usedMargin() {
          return this._usedMargin$.asObservable();
        }
        _getTradeValue() {
          ...
          if (
            ...
            return (0, D.formatInfoValue)(this._tradeValue * (null != e ? e : 1));
        }
        _updateAvailableMargin(e) {
          this._availableMargin$.next(e);
        }
        _makeLeverageInfo() {
          const e = (0, D.displayedLeverage)(this._leverage, this._marginRate);
          return null === e ? [] : [{ title: d.t(null, void 0, i(956220)), value: e }];
        }
        _makeLotSizeInfo() {
          return 'number' == typeof this._lotSize && Number.isFinite(this._lotSize)
            ? [{ title: d.t(null, void 0, i(127531)), value: String(this._lotSize) }]
            : [];
        }
        _makePipValueInfo(e) {
          return this._showRiskControls &&
            e !== T.PipValueType.None &&
            Number.isFinite(this._pipValueForCurrentQuantity)
            ? [
                {
                  title:
                    e === T.PipValueType.Pips
                      ? d.t(null, void 0, i(419489))
                      : d.t(null, void 0, i(696709)),
                  value: `${(0, D.formatInfoValue)(this._pipValueForCurrentQuantity)} ${
                    this._currency
                  }`,
                },
              ]
        ...
        _makeTradeValueInfo() {
          ...
          const t = this._showTotalInsteadOfTradeValue
              ? d.t(null, void 0, i(613937))
              : d.t(null, void 0, i(207710)),
          ...
          return void 0 === s
            ...
            : [
                { title: t },
                {
                  title: d.t(null, void 0, i(278770)),
                  value: `${e} ${this._currency}`,
                  listMarker: !0,
                },
                {
                  title: d.t(null, void 0, i(689544)),
        ...
        _getTradeValueInSymbolCurrency() {
          ...
          if (
            ...
            return (0, D.formatInfoValue)(this._tradeValueInSymbolCurrency * t);
        }
        _getMarginRate() {
          return null !== this._leverageInfo
            ? 0 !== this._leverageInfo.leverage
              ? (0, Z.Big)(1).div(this._leverageInfo.leverage).toNumber()
              : void 0
        ...
        _isSymbolTypeSupportTradeValue() {
          return (
            void 0 !== this._type &&
            ['stock', 'dr', 'right', 'bond', 'warrant', 'structured'].includes(this._type)
          );
        }
        _makeRewardInfo(e, t, s) {
          return this._showRiskControls && e && null !== t && null !== s
            ? [
                {
                  title: d.t(null, void 0, i(356979)),
                  value: `${this._riskFormatter.format(s)}% (${this._riskFormatter.format(t)} ${
                    this._currency
                  })`,
                },
              ]
        ...
        _makeRiskInfo(e, t, s) {
          return this._showRiskControls && e && null !== t && null !== s
            ? [
                {
                  title: d.t(null, void 0, i(563833)),
                  value: `${this._riskFormatter.format(s)}% (${this._riskFormatter.format(t)} ${
                    this._currency
                  })`,
                },
      ...
      const Ge = (0, o.getLogger)('PromiseWithDefault');
      function Ke(e, t, i) {
        return e.catch(e => (Ge.logError(e), i && i(), t));
      }
      const Je = {
        symbol: d.t(null, void 0, i(589053)),
        ask: d.t(null, void 0, i(987300)),
        bid: d.t(null, void 0, i(6205)),
        orderType: d.t(null, void 0, i(158416)),
        side: d.t(null, void 0, i(750441)),
        quantity: d.t(null, void 0, i(766596)),
        price: d.t(null, void 0, i(25684)),
        stopPrice: d.t(null, void 0, i(722028)),
        limitPrice: d.t(null, void 0, i(627262)),
        currency: d.t(null, void 0, i(50985)),
        stopLoss: d.t(null, void 0, i(241648)),
        takeProfit: d.t(null, void 0, i(129266)),
        buy: d.t(null, void 0, i(618156)),
        sell: d.t(null, void 0, i(392553)),
        warning: d.t(null, void 0, i(658028)),
      };
      class Ye {
        constructor(e, t, i, s, r, o, n, a) {
          (this.warnings = []),
            (this.errors = []),
            (this._infoTableQuotesData = new qe.WatchedObject({ rows: [] }, D.comparator)),
            ...
            this._fillOrderInfo(),
            (e.takeProfit || e.stopLoss) && this.warnings.push(Je.warning),
        ...
        _fillQuotesInfo(e) {
          const t = [
            { title: Je.symbol, value: this.order.symbol },
            { title: Je.ask, value: e ? this._formatter.format(e.ask) : '' },
            { title: Je.bid, value: e ? this._formatter.format(e.bid) : '' },
          ];
          this._infoTableQuotesData.setValue({ rows: t });
        }
        _fillOrderInfo() {
          this._infoTableOrderData.rows.push(
            { title: Je.orderType, value: this.order.type ? $.orderTypes[this.order.type] : '' },
            {
              title: Je.side,
              value: 1 === this.order.side ? Je.buy : Je.sell,
              type: 1 === this.order.side ? 0 : 1,
            },
            { title: Je.quantity, value: this._quantityFormatter.format(this.order.qty) },
          ),
            (3 !== this.order.type && 1 !== this.order.type) ||
              this._infoTableOrderData.rows.push({
                title: Je.price,
                value: this._formatter.format(
                  3 === this.order.type ? this.order.stopPrice : this.order.limitPrice,
                ),
              }),
            4 === this.order.type &&
              this._infoTableOrderData.rows.push(
                { title: Je.stopPrice, value: this._formatter.format(this.order.stopPrice) },
                { title: Je.limitPrice, value: this._formatter.format(this.order.limitPrice) },
              ),
            this.order.stopLoss &&
              this._infoTableOrderData.rows.push({
                title: Je.stopLoss,
            ...
            this._currency.length > 0 &&
              this._infoTableOrderData.rows.push({ title: Je.currency, value: this._currency });
        }
      }
      var Xe = i(80423),
        Ze = i(73359),
        et = i(350146);
      const tt = a.enabled('order_panel_undock');
      function it(e) {
        const {
            pin: t,
            mode: s,
            ...
            supportBrackets: u,
            supportPlaceOrderPreview: h,
            supportModifyOrderPreview: c,
            isUndockAllowed: p,
          } = e,
          _ = e => () => r.setValue({ ...r.value(), [e]: !r.value()[e] }),
          y = e => (0, Xe.makeObservableFromWatchedValue)(r).pipe((0, b.map)(t => !!t[e])),
          g = [];
        if (
          (p &&
            tt &&
            g.push({
              settingType: 1,
              onLabel: d.t(null, void 0, i(515632)),
              offLabel: d.t(null, void 0, i(980280)),
              onIcon: Ze,
              offIcon: et,
              onClick: () => t(),
              value$: (0, Xe.makeObservableFromWatchedValue)(s).pipe(
                (0, b.map)(e => e === $.OrderEditorDisplayMode.Panel),
              ),
            }),
          n &&
            g.push({
              settingType: 0,
              label: d.t(null, void 0, i(9540)),
              onClick: _('showRelativePriceControl'),
              value$: y('showRelativePriceControl'),
            }),
          a)
        ) {
          const e = l ? d.t(null, void 0, i(555198)) : d.t(null, void 0, i(377562));
          if (
            (g.push(
              {
                settingType: 0,
            ...
            const e = d.t(null, void 0, i(511327));
            g.push(
              {
                settingType: 0,
                label: e.replace('{units}', o || 'Money'),
        ...
        return (
          (h || c) &&
            g.push({
              settingType: 0,
              label: d.t(null, void 0, i(878506)),
      ...
      const st = (0, o.getLogger)('Trading.OrderViewModel');
      function rt(e) {
      ...
      class ot {
        constructor({
          ...
          isTradable: n,
          isUndockAllowed: a,
          orderWidgetStat: u = null,
          pipValueType$: b,
          onNeedSelectBroker: m,
          trackEvent: P,
          ...
          forceAbsolutePriceUpdate: F,
          qtySuggester: R,
          isVisible: L,
          orderDialogOptions: E,
          informerMessage$: x,
          warningMessage$: N,
          headerState: Q,
        }) {
          var W, A, j;
          if (
            ((this.orderType = new l.WatchedValue(null)),
            (this.orderInfoModel = null),
            (this.orderPreviewModel = null),
            (this.customFieldModels = new l.WatchedValue([])),
            (this.onDoneButtonClicked = (0, h.createDeferredPromise)()),
            (this.status = new l.WatchedValue($.OrderPanelStatus.Active)),
            (this.rewardRisk = new l.WatchedValue('')),
            (this.disabled = new l.WatchedValue(!0)),
            (this.loading = new l.WatchedValue(!1)),
            (this.needSignIn = !1),
            (this.noBroker = !1),
            (this.isNoQuotes = new l.WatchedValue(!1)),
            (this.symbolHasLotSize = !1),
            (this.id = (0, I.randomHashN)(6)),
            (this.existingOrder = !1),
            (this._isEmptyRequiredCustomFieldsHighlighted = new l.WatchedValue(!1)),
            ...
            (this._orderPlacingStatus = new y.BehaviorSubject($.OrderPlacingStatus.Creating)),
            (this._destroyed = !1),
            ...
            (this.doneButtonClick = () => {
              ...
              const t = this.sideModel.currentQuotes(),
                s = this.sideModel.getValue(),
                o = null !== (e = 1 === s ? t.ask : t.bid) && void 0 !== e ? e : 0;
              let n = {
                symbol: this.symbol,
                type: (0, r.ensureNotNull)(this.orderType.value()),
                side: s,
                qty: 0,
                seenPrice: o,
              };
              (n.qty = (0, r.ensureNotNull)(this.quantityModel.getValue())),
                void 0 !== t.ask &&
                  void 0 !== t.bid &&
                  (n.currentQuotes = { ask: t.ask, bid: t.bid }),
                4 === this.orderType.value()
                  ? ((n.stopPrice = (0, r.ensureNotNull)(this.stopPriceModel.getValue())),
                    (n.limitPrice = (0, r.ensureNotNull)(this.limitPriceModel.getValue())))
                  : 3 === this.orderType.value()
                  ? (n.stopPrice = (0, r.ensureNotNull)(this.stopPriceModel.getValue()))
                  : 1 === this.orderType.value() &&
                    (n.limitPrice = (0, r.ensureNotNull)(this.limitPriceModel.getValue()));
              const a = this.durationModel.getValue();
              null !== a && (n.duration = a),
                this.stopLossModel &&
                  (delete n.stopLoss,
                  delete n.trailingStopPips,
                  this.stopLossModel.getBracketType() === T.BracketType.StopLoss &&
                    ((n.stopLoss = this.stopLossModel.getEnabled()
                      ? (0, r.ensureNotNull)(
                          this.stopLossModel.getValue() && this.stopLossModel.price.getValue(),
                        )
                      : void 0),
                    (n.trailingStopPips = void 0)),
                  this.stopLossModel.getBracketType() === T.BracketType.TrailingStop &&
                    ((n.trailingStopPips = this.stopLossModel.getEnabled()
                      ? (0, r.ensureNotNull)(this.stopLossModel.getValue())
                      : void 0),
                    (n.stopLoss = void 0 !== n.trailingStopPips ? void 0 : n.stopLoss))),
                this.takeProfitModel &&
                  (n.takeProfit = this.takeProfitModel.getEnabled()
                    ? (0, r.ensureNotNull)(
                        this.takeProfitModel.getValue() && this.takeProfitModel.price.getValue(),
                      )
                    : void 0),
                Array.isArray(this.customFieldModels.value()) &&
                  (n.customFields = this._getCustomFields());
              if (
                (this.existingOrder
                ...
                if (null === this.orderPreviewModel) {
                  const e =
                    this.supportModifyOrderPreview && null !== this._existingPlacedOrder
                      ? { ...n, id: this._existingPlacedOrder.id }
                      : n;
                  return void this._adapter
                    .previewOrder(e)
                    .then(t => {
                      const i =
                        this.supportCurrencyInOrderPreview && void 0 !== this._symbolInfo.currency
                          ? this._symbolInfo.currency
                          : '';
                      (this.orderPreviewModel = new Ye(
                        e,
                        t,
                        this._quotes$,
                        this._back,
                        ...
                        this._subscriptions.push(this.orderPreviewModel.subscribe()),
                        this.loading.setValue(!1),
                        this.status.setValue($.OrderPanelStatus.Preview);
                    })
                    .catch(e => {
                      this.loading.setValue(!1),
                        this._showErrorNotification(
                          d.t(null, void 0, i(455897)),
                          'object' == typeof e ? e.message : e,
                        );
                    });
                }
                n = this.orderPreviewModel.order;
              }
              this._doneHandler(
                n,
                null !== this.orderPreviewModel ? this.orderPreviewModel.confirmId : void 0,
              ).then(e => {
                this.loading.setValue(!1),
                  e &&
                    (this.onDoneButtonClicked.resolve(!0),
                    this.mode.value() === $.OrderEditorDisplayMode.Popup
                      ? this.headerModel.close()
                      : this._cancel(),
                    this.existingOrder ||
                      this._orderPlacingStatus.next($.OrderPlacingStatus.Placed)),
                  e ||
                    this.mode.value() !== $.OrderEditorDisplayMode.Panel ||
            ...
            (this.activateOrderTicket = () => {
              this.status.setValue(
                this.existingOrder ? $.OrderPanelStatus.Editing : $.OrderPanelStatus.Active,
              ),
                this.orderType.unsubscribe(this.activateOrderTicket),
                this.sideModel &&
                  this.sideModel.onControlFocused.unsubscribe(this, this.activateOrderTicket),
                this.limitPriceModel &&
                  this.limitPriceModel.onControlFocused.unsubscribe(this, this.activateOrderTicket),
                this.stopPriceModel &&
                  this.stopPriceModel.onControlFocused.unsubscribe(this, this.activateOrderTicket),
                this.quantityModel &&
                  this.quantityModel.onControlFocused.unsubscribe(this, this.activateOrderTicket),
                this.leverageModel &&
                  this.leverageModel.onControlFocused.unsubscribe(this, this.activateOrderTicket),
                this.takeProfitModel &&
                  this.takeProfitModel.onControlFocused.unsubscribe(this, this.activateOrderTicket),
                this.stopLossModel &&
                  this.stopLossModel.onControlFocused.unsubscribe(this, this.activateOrderTicket),
                this.durationModel &&
                  this.durationModel.onControlFocused.unsubscribe(this, this.activateOrderTicket),
                Array.isArray(this.customFieldModels.value()) &&
                  this.customFieldModels.value().length > 0 &&
                  this.customFieldModels.value().forEach(e => {
                    e.onControlFocused.unsubscribe(this, this.activateOrderTicket);
                  }),
                this._orderPlacingStatus.next($.OrderPlacingStatus.Creating);
            }),
            ...
            (this._updateMode = () => {
              this.mode.value() === $.OrderEditorDisplayMode.Popup &&
                this.status.value() !== $.OrderPanelStatus.Preview &&
                this.activateOrderTicket(),
                this.toggleCancelButton();
            }),
            (this._handleStatusChange = e => {
              const t =
                e !== $.OrderPanelStatus.Preview && this._isTradable
                  ? this._makeHeaderSettings()
                  : void 0;
              this._headerState.setSettings(t);
            }),
            (this._mergeInputStateDiff = e => {
              void 0 !== e.duration && (this._currentInputState.duration = null),
            ...
            (this._checkIsCustomFieldNotSelected = () => {
              const e = [];
              for (const t of this.customFieldModels.value()) rt(t) && e.push(t);
            ...
            })(t) && ((this.existingOrder = !0), (this._existingPlacedOrder = t)),
            (this.warningMessage$ = N),
            (this.status = new l.WatchedValue(
              this.existingOrder ? $.OrderPanelStatus.Editing : $.OrderPanelStatus.Active,
            )),
            (this.isEmptyRequiredCustomFieldsHighlighted =
              this._isEmptyRequiredCustomFieldsHighlighted.readonly()),
            (this.symbol = t.symbol),
            (this._orderStatusSubscription = (0, D.makeSubjectFromWatchedValue)(this.status)),
            (this._loadingSubscription = (0, D.makeSubjectFromWatchedValue)(this.loading)),
          ...
          if (((this._adapter = e), (this.brokerName = e.metainfo().title), !n.tradable))
            return void (this.onReady = this._prepareTradableSolution(n));
          (this._handler = M),
          ...
          const z = e.metainfo().configFlags;
          (this.supportModifyOrderPrice = z.supportModifyOrderPrice),
            (this.supportModifyQuantity =
              !this.existingOrder || Boolean(this.existingOrder && z.supportEditAmount)),
            (this.showQuantityInsteadOfAmount = z.showQuantityInsteadOfAmount),
            (this.supportMarketOrders = z.supportMarketOrders),
            (this.supportLimitOrders = z.supportLimitOrders),
            (this.supportStopOrders = z.supportStopOrders),
            (this.supportStopLimitOrders = z.supportStopLimitOrders),
            (this.supportBrackets =
              z.supportOrderBrackets && !(t.hasOwnProperty('parentId') && t.parentId)),
            (this.supportModifyBrackets = this.supportBrackets && z.supportModifyBrackets),
            (this.supportAddBracketsToExistingOrder =
              this.supportModifyBrackets && z.supportAddBracketsToExistingOrder),
            (this.supportTrailingStop = this.supportBrackets && z.supportTrailingStop),
            (this.supportModifyTrailingStop =
              this.supportTrailingStop && z.supportModifyTrailingStop),
            (this.supportMarketBrackets = this.supportBrackets && z.supportMarketBrackets),
            (this.supportModifyDuration = z.supportModifyDuration),
            (this.supportLeverage = z.supportLeverage),
            (this.supportLeverageButton = z.supportLeverage && z.supportLeverageButton),
            (this.supportPlaceOrderPreview = z.supportPlaceOrderPreview),
            (this.supportModifyOrderPreview = z.supportModifyOrderPreview),
            (this.supportBalances = z.supportBalances),
            (this.supportCryptoBrackets = z.supportCryptoBrackets),
            (this.supportStopOrdersInBothDirections = z.supportStopOrdersInBothDirections),
            (this.supportStopLimitOrdersInBothDirections =
              z.supportStopLimitOrdersInBothDirections),
            (this.supportCurrencyInOrderPreview = z.supportCurrencyInOrderPreview),
            (this.supportModifyOrderType = z.supportModifyOrderType),
                  ...
                  null !==
                    (A =
                      null !== (W = t.type) && void 0 !== W
                        ...
                        : null == V
                        ? void 0
                        : V.orderType) && void 0 !== A
                    ? A
                    : (0, w.getDefaultOrderType)(z)) && void 0 !== j
                ? j
                : null,
            ),
            (this._orderTypeSubscription = (0, D.makeSubjectFromWatchedValue)(this.orderType)),
            (this._orderType = this._orderTypeSubscription.subject),
            (this.onReady = Promise.all([
              e.symbolInfo(t.symbol),
              Ke(e.accountMetainfo(), { id: e.currentAccount(), name: e.metainfo().title }),
              Ke(e.quotesSnapshot(t.symbol), {}, this._noQuotesCallback),
              Ke(e.formatter(t.symbol, !1), new O.PriceFormatter()),
              Ke(e.spreadFormatter(t.symbol), new O.PriceFormatter()),
            ])
              .then(async ([i, s, r, o, a]) => {
                var l;
                if (
                  ((this._isBats = (0, w.isBatsQuotes)(r)),
                  (this._supportCryptoExchangeOrderTicket =
                    z.supportCryptoExchangeOrderTicket ||
                    (z.supportSymbolSpecificCryptoOrderTicket && 'crypto' === i.type)),
                  (this._symbolInfo = i),
                  this._destroyed)
                )
                  return;
                (this.displaySymbolName =
                  i.brokerSymbol || ('brokerSymbol' in t && t.brokerSymbol) || this.symbol),
                  (this.symbolType = i.type),
                  (this.currency = (0, w.getCurrency)(s)),
                  (this._currencyName = (0, w.getCurrency)(s, !0)),
                  (this.formatter = o),
                  (this.symbolHasLotSize = i.hasOwnProperty('lotSize')),
                  (this.showRiskControls = z.supportRiskControls && 0 !== i.pipValue),
                  (this._suggestedQty = await this._qtySuggester.getQty(this.symbol)),
                  (this._initialInputState = this._getInitialInputState(t, i, V)),
                  (this._currentInputState = Object.assign({}, this._initialInputState)),
                  this.customFieldModels.setValue(
                    (0, D.createCustomFieldModels)(
                      this.existingOrder,
                      this.status,
                      this._isEmptyRequiredCustomFieldsHighlighted,
                      E,
                      null !== (l = this._initialInputState.customFields) && void 0 !== l
                        ? l
                        : void 0,
                    ),
                  ),
                ...
                const u = i.variableMinTick
                  ? (0, q.makeVariableMinTickData)(i.minTick, i.variableMinTick)
                  : void 0;
                (this._quotes$ = (0, g.fromEventPattern)(
                  i => e.subscribeRealtime(t.symbol, i),
                  i => e.unsubscribeRealtime(t.symbol, i),
                  (e, t) => (0, D.alignQuotesToMinTick)(t, i.minTick, u),
                ).pipe((0, p.share)({ connector: () => new v.ReplaySubject(1) }))),
                  (this._equity$ = (0, g.fromEventPattern)(
                    ...
                    (0, _.startWith)(NaN),
                    (0, p.share)({ connector: () => new v.ReplaySubject(1) }),
                  )),
                  (this._marginAvailable$ = z.supportMargin
                    ? C(
                    ...
                    : null),
                  (this._baseCurrencyCryptoBalance$ = z.supportBalances
                    ? C(
                        (0, g.fromEventPattern)(
                          t => e.subscribeCryptoBalance(i.baseCurrency || '', t),
                          t => e.unsubscribeCryptoBalance(i.baseCurrency || '', t),
                          (e, t) => t,
                        ).pipe(
                          (0, _.startWith)({
                    ...
                    : null),
                  (this._quoteCurrencyCryptoBalance$ = z.supportBalances
                    ? C(
                        (0, g.fromEventPattern)(
                          t => e.subscribeCryptoBalance(i.quoteCurrency || '', t),
                          t => e.unsubscribeCryptoBalance(i.quoteCurrency || '', t),
                          (e, t) => t,
                        ).pipe(
                          (0, _.startWith)({
                  ...
                  (this._pipValues$ = C(
                    (0, g.fromEventPattern)(
                      ...
                      (e, t) => t,
                    ).pipe((0, _.startWith)({ buyPipValue: i.pipValue, sellPipValue: i.pipValue })),
                  )),
                  void 0 === this._orderTemplate.limitPrice &&
                    !1 === this.existingOrder &&
                    (this._orderTemplate.limitPrice =
                      1 === this._initialInputState.side ? (0, w.getAsk)(r) : (0, w.getBid)(r)),
                  void 0 === this._orderTemplate.stopPrice &&
                    !1 === this.existingOrder &&
                    (this._orderTemplate.stopPrice =
                      1 === this._initialInputState.side ? (0, w.getBid)(r) : (0, w.getAsk)(r)),
                  this._createModels(t, i, a, n.tradable, F, E),
                  this._subscribe(),
                  this._onInputStateChanged.fire(this._getCurrentInputState()),
                  this._headerState.setSettings(this._makeHeaderSettings());
              })
              .catch(e => {
                throw (st.logError('Failed to create order model: ' + e), e);
              }));
        }
        destroy() {
          var e;
          (this._destroyed = !0),
            this.onInputStateChanged().unsubscribe(this, this._mergeInputStateDiff),
            this._subscriptions.forEach(e => e && e.unsubscribe()),
            null === (e = this.orderInfoModel) || void 0 === e || e.unsubscribe(),
            this._orderStatusSubscription.unsubscribe(),
            this._loadingSubscription.unsubscribe(),
            this._orderTypeSubscription && this._orderTypeSubscription.unsubscribe(),
            this.headerModel &&
              (this.headerModel.unsubscribe(),
              this.headerModel.pinButtonClicked().unsubscribe(this, this._toggleMode),
              this.headerModel.cancelButtonClicked().unsubscribe(this, this._cancel),
              this.headerModel.closeButtonClicked().unsubscribe(this, this._closeWidget),
              this.headerModel.backButtonClicked().unsubscribe(this, this._back)),
            this.sideModel &&
            ...
            this._customFieldsSubscription && this._customFieldsSubscription.unsubscribe(),
            this._adapter && this._adapter.orderUpdate.unsubscribe(this, this._orderUpdate),
            this.orderType.unsubscribe(this.activateOrderTicket),
        ...
        deactivateOrderTicket() {
          this.status.value() !== $.OrderPanelStatus.Wait &&
            (this.status.setValue($.OrderPanelStatus.Wait),
            this.orderType.subscribe(this.activateOrderTicket),
            this.sideModel &&
              this.sideModel.onControlFocused.subscribe(this, this.activateOrderTicket),
            this.limitPriceModel &&
              this.limitPriceModel.onControlFocused.subscribe(this, this.activateOrderTicket),
            this.stopPriceModel &&
              this.stopPriceModel.onControlFocused.subscribe(this, this.activateOrderTicket),
            this.quantityModel &&
              this.quantityModel.onControlFocused.subscribe(this, this.activateOrderTicket),
            void 0 !== this.leverageModel &&
              this.leverageModel.onControlFocused.subscribe(this, this.activateOrderTicket),
            this.takeProfitModel &&
              (this.takeProfitModel.setEnabled(!1),
              this.takeProfitModel.onControlFocused.subscribe(this, this.activateOrderTicket)),
            this.stopLossModel &&
              (this.stopLossModel.setEnabled(!1),
              this.stopLossModel.onControlFocused.subscribe(this, this.activateOrderTicket)),
            this.durationModel &&
              this.durationModel.onControlFocused.subscribe(this, this.activateOrderTicket),
            Array.isArray(this.customFieldModels.value()) &&
              this.customFieldModels.value().length > 0 &&
              this.customFieldModels.value().forEach(e => {
                e.onControlFocused.subscribe(this, this.activateOrderTicket);
              }),
            this._setDisabledIfNeeded({
              ...
              limitPrice: this.limitPriceModel ? this.limitPriceModel.getValue() : null,
              stopPrice: this.stopPriceModel ? this.stopPriceModel.getValue() : null,
              quantity: this.quantityModel ? this.quantityModel.getValue() : null,
              isTakeProfitIncorrect:
                !!this.takeProfitModel && this.takeProfitModel.isValueIncorrect(),
        ...
        toggleCancelButton() {
          this.mode.value() === $.OrderEditorDisplayMode.Panel &&
          this.status.value() === $.OrderPanelStatus.Active
        ...
        _createSimpleDialog(e) {
          this.orderType.setValue(null),
            ...
            this.headerModel.closeButtonClicked().subscribe(this, this._closeWidget);
        }
        _createModels(e, t, i, s, o, n) {
          var a, l, u, d;
          const h = this.supportCryptoExchangeOrderTicket();
          (this.sideModel = new X({
            initialSide: this._initialInputState.side,
            quotes$: this._quotes$,
            priceFormatter: this.formatter,
            spreadFormatter: i,
            status: this.status,
            baseCurrency: (h && 'crypto' === t.type && t.baseCurrency) || null,
          })),
            (this._pipValue$ = (0, S.combineLatest)([this._pipValues$, this.sideModel.value$]).pipe(
              (0, b.map)(([e, t]) => (1 === t ? e.buyPipValue : e.sellPipValue)),
            ));
          const { orderRules: c = [], title: p } = this._adapter.metainfo();
          let _ = [],
            y = [];
          (this.supportStopOrdersInBothDirections && this.supportStopLimitOrdersInBothDirections) ||
            ((_ =
              null !== (a = (0, V.extractLimitValidationRules)(this._adapter, this.symbol)) &&
              void 0 !== a
                ? a
                : []),
            (y =
              null !== (l = (0, V.extractStopValidationRules)(this._adapter, this.symbol)) &&
              void 0 !== l
                ? l
                : [])),
            (this.stopPriceModel = new de({
              priceType: 2,
              quotes$: this._quotes$,
            ...
            (this.quantityModel = h
              ...
              : new Te({
                  ...
                  pipValue$: this._pipValue$,
                  info: t,
                  currency: null !== (u = this.currency) && void 0 !== u ? u : '',
                  initialQty: this._initialInputState.quantity,
                  settings: this._settings,
                  orderWidgetStat: this._orderWidgetStat,
                  showRiskControls: this.showRiskControls,
                })),
            (this.supportBrackets || this.supportCryptoBrackets) &&
              this._createBracketsModels(e, t, (0, r.ensureDefined)(this.currency)),
            (this.headerModel = new F({
          ...
          const g = (0, D.shouldShowTotal)(n);
          this.supportLeverage &&
            (this.leverageModel = new Ee({
            ...
            h ||
              (this.orderInfoModel = new He({
                ...
                info: t,
                tpInfo:
                  this.supportBrackets && this.takeProfitModel
                    ? {
                    ...
                    : null,
                slInfo:
                  this.supportBrackets && this.stopLossModel
                    ? {
                ...
                pipValueType$: this._pipValueType$,
                leverageInfo$:
                  null === (d = this.leverageModel) || void 0 === d ? void 0 : d.leverageInfo$,
              })),
            (this.durationModel = new De({
              initialDuration: this._initialInputState.duration,
              orderType: this.orderType,
              orderWidgetStat: this._orderWidgetStat,
              orderDurations: this._adapter.metainfo().durations,
              symbolDurations: this._symbolInfo.allowedDurations,
            }));
          const v = {
            orderType: (0, D.makeSubjectFromWatchedValue)(this.orderType).subject.asObservable(),
            side: this.sideModel.value$,
            ...
            status: (0, D.makeSubjectFromWatchedValue)(this.status).subject.asObservable(),
            existingOrder: this.existingOrder,
          };
          this.buttonModel = new Ue(T.TradingEntityType.Order, v);
        }
        _createBracketsModels(e, t, i) {
          const s = (0, V.extractTakeProfitValidationRules)(this._adapter, this.symbol),
            r = (0, V.extractStopLossValidationRules)(this._adapter, this.symbol);
          this.takeProfitModel = new Be({
            initialPrice: e.takeProfit || null,
            initialEnabled: Boolean(e.takeProfit),
            initialBracketType: T.BracketType.TakeProfit,
            formatter: this.formatter,
            equity$: this._equity$,
            quotes$: this._quotes$,
            info: t,
          ...
          this.stopLossModel = new Be({
            initialPrice: o ? null : e.stopLoss || null,
            initialEnabled: Boolean(o ? e.trailingStopPips : e.stopLoss),
            initialBracketType: o ? T.BracketType.TrailingStop : T.BracketType.StopLoss,
            formatter: this.formatter,
            equity$: this._equity$,
            quotes$: this._quotes$,
            info: t,
        ...
        _subscribe() {
          ...
          this.mode.subscribe(this._updateMode),
            ...
            this.headerModel.pinButtonClicked().subscribe(this, this._toggleMode),
            this.headerModel.cancelButtonClicked().subscribe(this, this._cancel),
            this.headerModel.closeButtonClicked().subscribe(this, this._closeWidget),
            ...
            (this._buttonDataSubscription = (0, S.combineLatest)({
              ...
              takeProfitPips:
                null !==
                  (t = null === (e = this.takeProfitModel) || void 0 === e ? void 0 : e.value$) &&
                void 0 !== t
                  ? t
                  : (0, M.of)(null),
              stopLossPips:
                null !==
                  (s = null === (i = this.stopLossModel) || void 0 === i ? void 0 : i.value$) &&
                void 0 !== s
                  ? s
                  : (0, M.of)(null),
              takeProfitEnabled:
                null !==
                  (o = null === (r = this.takeProfitModel) || void 0 === r ? void 0 : r.enabled$) &&
                void 0 !== o
                  ? o
                  : (0, M.of)(!1),
              stopLossEnabled:
                null !==
                  (a = null === (n = this.stopLossModel) || void 0 === n ? void 0 : n.enabled$) &&
                void 0 !== a
                  ? a
                  : (0, M.of)(!1),
              ...
              this._setDisabledIfNeeded({
                ...
                stopPrice: a,
                quantity: l,
                isTakeProfitIncorrect: h && null === u,
                isStopLossIncorrect: c && null === d,
                customFields: this._getCustomFields(this.customFieldModels.value()),
              }),
            ...
            (this._waitQuotesTimeout = setTimeout(() => this.isNoQuotes.setValue(!0), 5e3));
          const u = (0, S.combineLatest)([this._quotes$, this.sideModel.value$]).subscribe(
              ([e, t]) => {
                const i = 1 === t ? (0, w.getAsk)(e) : (0, w.getBid)(e);
                (this._initialInputState.limitPrice = i), (this._initialInputState.stopPrice = i);
              },
            ),
            d = this._quotes$.subscribe(e => {
              this.isNoQuotes.setValue((0, w.isNoQuotes)(e)), clearTimeout(this._waitQuotesTimeout);
            });
          if (this.customFieldModels) {
            const e = [];
            for (const t of this.customFieldModels.value()) {
              const i =
                  'Checkbox' === t.type
                    ? t.checked
                    : 'ComboBox' === t.type
                    ? t.selectedItem
                    : t.text,
                s = (0, D.makeSubjectFromWatchedValue)(i);
          ...
          if (
            ...
            null === (l = this.orderInfoModel) || void 0 === l || l.subscribe(),
            ...
            if (!this.supportCryptoExchangeOrderTicket()) {
              const e = (0, S.combineLatest)([
                ...
                t = this.stopLossModel.focusedControl$.subscribe(e => {
                  (2 !== e && 3 !== e) || this.quantityModel.setFocusedControl(0);
                }),
          ...
          if (void 0 !== this.takeProfitModel && void 0 !== this.stopLossModel) {
            const e = (0, S.combineLatest)([
              ...
              this.rewardRisk.setValue((0, D.formatRiskReward)(e, t));
            });
            this._subscriptions.push(e);
          }
          this._subscriptions.push(this._buttonDataSubscription, u, d, this._pipValues$.connect()),
            null !== this._marginAvailable$ &&
              this._subscriptions.push(this._marginAvailable$.connect()),
            null !== this._baseCurrencyCryptoBalance$ &&
              this._subscriptions.push(this._baseCurrencyCryptoBalance$.connect()),
            null !== this._quoteCurrencyCryptoBalance$ &&
              this._subscriptions.push(this._quoteCurrencyCryptoBalance$.connect()),
        ...
        async _getAndSendStatistics(e) {
          ...
          const i = this.stopLossModel && this.stopLossModel.getEnabled(),
            ...
            h = ['Limit', 'Market', 'Stop', 'StopLimit'][e.type - 1],
            c = this.durationModel.getValue(),
            ...
            v =
              (this.limitPriceModel && !this.limitPriceModel.isRelativePriceControlHidden) ||
              (this.stopPriceModel && !this.stopPriceModel.isRelativePriceControlHidden),
            m = Boolean(this.supportBrackets);
          function P(e, t) {
            return t[null !== e ? e : 0];
          }
          (g.showRelativePriceControl = g.showRelativePriceControl && v),
            (g.showCurrencyRiskInQty = g.showCurrencyRiskInQty && m),
            (g.showPercentRiskInQty = g.showPercentRiskInQty && m),
            (g.showBracketsInCurrency = g.showBracketsInCurrency && m),
            (g.showBracketsInPercent = g.showBracketsInPercent && m),
            (g.showOrderPreview =
              g.showOrderPreview &&
              Boolean(this.supportPlaceOrderPreview || this.supportModifyOrderPreview)),
            null !== this._orderWidgetStat &&
              (this._orderWidgetStat.setStaticSnowplowEventDataProperty({
                ...
                stopLoss: i ? (0, r.ensureDefined)(this.stopLossModel).getValue() : null,
                takeProfit: s ? (0, r.ensureDefined)(this.takeProfitModel).getValue() : null,
                trailingStop: o ? (0, r.ensureDefined)(this.stopLossModel).getValue() : null,
                guaranteedStop: null,
                focusedTPField: s
                  ? P((0, r.ensureDefined)(this.takeProfitModel).getFocusedControl(), d)
                  : null,
                focusedSLField: i
                  ? P((0, r.ensureDefined)(this.stopLossModel).getFocusedControl(), d)
                  : null,
                focusedQtyField: null !== (t = l[null !== u ? u : 0]) && void 0 !== t ? t : null,
                focusedLimitPriceField:
                  y || (_ && this.limitPriceModel)
                    ? P(this.limitPriceModel.getFocusedControl(), a)
                    : null,
                focusedStopPriceField:
                  b && this.stopPriceModel ? a[this.stopPriceModel.getFocusedControl()] : null,
                duration: null !== c ? c.type : null,
                isDefaultDuration: null !== c ? c.type === this._getDefaultDuration().value : null,
        ...
        _getInitialInputState(e, t, i) {
          var s, r, o, n, a, l;
          const u = void 0 !== e.customFields ? { ...e.customFields } : void 0;
          return {
            symbol: this.symbol,
            orderType: this.orderType.value(),
            side:
              null !==
                (r = null !== (s = e.side) && void 0 !== s ? s : null == i ? void 0 : i.side) &&
              void 0 !== r
                ? r
                : 1,
            ...
            takeProfitPips:
              null !== (o = null == i ? void 0 : i.takeProfitPips) && void 0 !== o
                ? o
                : $.BracketDefaultPips.TakeProfit,
            stopLossPips:
              null !== (n = null == i ? void 0 : i.stopLossPips) && void 0 !== n
                ? n
                : $.BracketDefaultPips.StopLoss,
            customFields:
              null !== (a = null != u ? u : null == i ? void 0 : i.customFields) && void 0 !== a
                ? a
                : {},
            duration: (0, w.getOrderDuration)({
              ...
              orderType: this.orderType.value(),
              savedDuration:
                null !== (l = null == i ? void 0 : i.duration) && void 0 !== l ? l : null,
              orderDurations: this._adapter.metainfo().durations,
              symbolDurations: this._symbolInfo.allowedDurations,
            }),
          };
        ...
        _compareInputStates({
          ...
          let u = null === i;
          if (null !== i) {
            const t = this.formatter.format(i),
              s =
          ...
          e !== this._currentInputState.orderType && (l.orderType = e), u && (l.limitPrice = i);
          let d = null !== s;
          if (null !== s) {
            const t = this.formatter.format(s),
              i =
          ...
          d && (l.stopPrice = s),
            null !== r && this._currentInputState.quantity !== r && (l.quantity = r),
            null !== o && this._currentInputState.takeProfitPips !== o && (l.takeProfitPips = o),
            null !== n && this._currentInputState.stopLossPips !== n && (l.stopLossPips = n),
            null === a ||
              null === this._currentInputState.duration ||
              (this._currentInputState.duration.type === a.type &&
                this._currentInputState.duration.datetime === a.datetime) ||
              (l.duration = a),
            null !== t && this._currentInputState.side !== t && (l.side = t),
            this._currentInputState.symbol !== this.symbol && (l.symbol = this.symbol),
            0 !== Object.keys(l).length && this._onInputStateChanged.fire(l);
        }
        _getSavableComboBoxModels() {
          return this.customFieldModels
            .value()
            .filter(e => e.saveToSettings && 'ComboBox' === e.type);
        }
        _getSavableCheckboxModels() {
          return this.customFieldModels
            .value()
            .filter(e => e.saveToSettings && 'Checkbox' === e.type);
        }
          ...
          return (
            e.forEach(e => {
              'TextWithCheckBox' === e.type &&
                ...
                'Checkbox' === e.type && (t[e.id] = e.checked.value()),
                'ComboBox' === e.type && (t[e.id] = e.selectedItem.value());
            }),
            t
          );
        }
        ...
        _setDisabledIfNeeded({
          ...
          this.disabled.setValue(
            (this.mode.value() === $.OrderEditorDisplayMode.Panel &&
              e === $.OrderPanelStatus.Wait) ||
              t ||
              (0, w.isNoQuotes)(i) ||
              null === s ||
              (0, D.checkPriceByOrderType)(this.orderType.value(), r, o) ||
              null === n ||
              a ||
              l ||
              Object.values(u).some(e => void 0 === e) ||
              this.customFieldModels.value().some(e => !e.isValid.value()),
          );
        }
        _toggleMode() {
          this.mode.setValue(
            this.mode.value() === $.OrderEditorDisplayMode.Panel
              ? $.OrderEditorDisplayMode.Popup
              : $.OrderEditorDisplayMode.Panel,
          ),
        ...
        _cancel() {
          this._cleanUp(),
            ...
            this.quantityModel &&
              void 0 !== this._suggestedQty &&
              this.quantityModel.quantity.setValue(this._suggestedQty),
            this._orderPlacingStatus.next($.OrderPlacingStatus.Creating),
        ...
        async _prepareTradableSolution(e) {
          (this.tradableSolution = await (0, D.prepareTradableSolution)(e, this._adapter)),
      ...
      class nt {
        constructor({
          ...
          (this._infoTableData$ = new y.BehaviorSubject({ rows: [] })),
            ...
            (this._pipValue = (0, D.calculatePipValue)(e, r.pipValue, this._lotSize)),
            (this._pipValueType$ = o),
            null === e
              ? (this._tradeValue = 0)
              : 'crypto' === this._type
              ? (this._tradeValue = e * i)
              : (this._tradeValue = (0, D.calculateTradeValue)(
                  e,
                  i,
                  r.pipValue,
                  r.pipSize,
        ...
        title() {
          return d.t(null, void 0, i(440339));
        }
        infoTableData() {
          return this._infoTableData$.asObservable();
        }
            ...
            ? [
                {
                  title:
                    e === T.PipValueType.Pips
                      ? d.t(null, void 0, i(419489))
                      : d.t(null, void 0, i(696709)),
                  value: `${(0, D.formatInfoValue)(this._pipValue)} ${this._currency}`,
                },
              ]
            : [];
        }
      ...
      class lt {
        constructor({
          ...
          (this.positionInfoModel = null),
            ...
            (this.onDoneButtonClicked = (0, h.createDeferredPromise)()),
            (this.rewardRisk = new l.WatchedValue('')),
            (this.disabled = new l.WatchedValue(!1)),
            (this.loading = new l.WatchedValue(!1)),
            (this.status = new l.WatchedValue($.OrderPanelStatus.Active)),
            (this.id = (0, I.randomHashN)(6)),
            (this.warning = new l.WatchedValue(void 0)),
            (this.isEmptyRequiredCustomFieldsHighlighted = new l.WatchedValue(!1)),
            (this._onModeChanged = new B.Delegate()),
            (this._onBackButtonClicked = new B.Delegate()),
            (this._onCloseButtonClicked = new B.Delegate()),
            (this._loadingSubscription = (0, D.makeSubjectFromWatchedValue)(this.loading)),
            ...
            (this._isVisible = a);
          const m = this._adapter.metainfo().configFlags;
          (this.supportBrackets =
            u === at.Trade ? m.supportTradeBrackets : m.supportPositionBrackets),
            (this.supportTrailingStop = this.supportBrackets && m.supportTrailingStop),
            (this.supportModifyTrailingStop =
              this.supportTrailingStop && m.supportModifyTrailingStop),
            (this.supportPositions = u === at.Position && m.supportPositions),
            (this.supportTrades = u === at.Trade && m.supportTrades),
            (this.supportOnlyPairPositionBrackets = m.supportOnlyPairPositionBrackets),
            (this.supportCryptoExchangeOrderTicket = m.supportCryptoExchangeOrderTicket),
            ...
            (this.onReady = Promise.all([
              e.symbolInfo(t.symbol),
              Ke(e.accountMetainfo(), { id: e.metainfo().id, name: e.metainfo().title }),
              Ke(e.formatter(t.symbol, !1), new O.PriceFormatter()),
            ]).then(([s, r, n]) => {
              (this.showRiskControls = m.supportRiskControls && 0 !== s.pipValue),
                (this.currency = (0, w.getCurrency)(r)),
                (this.symbolType = s.type),
                (this.brokerSymbol = s.brokerSymbol || t.brokerSymbol || this.symbol),
                (this._quotes$ = C(
                  (0, g.fromEventPattern)(
                ...
                (this._pipValues$ = C(
                  (0, g.fromEventPattern)(
                    ...
                    i => e.unsubscribePipValue(t.symbol, i),
                    (e, t) => t,
                  ).pipe((0, _.startWith)({ buyPipValue: s.pipValue, sellPipValue: s.pipValue })),
                )),
                (this._pipValue$ = this._pipValues$.pipe(
                  (0, b.map)(e => (1 === t.side ? e.buyPipValue : e.sellPipValue)),
                )),
                this._createModels(i, s, r, this.mode, n, y),
                this._subscribe(),
        ...
        destroy() {
          this._subscriptions && this._subscriptions.forEach(e => e.unsubscribe()),
            this.headerModel &&
              ...
              this.headerModel.backButtonClicked().unsubscribe(this, this._back),
              this.headerModel.closeButtonClicked().unsubscribe(this, this._closeWidget)),
            null !== this.positionInfoModel && this.positionInfoModel.unsubscribe(),
            this.supportPositions &&
              this._adapter.positionUpdate.unsubscribe(this, this._positionOrTradeUpdate),
            this.supportTrades &&
              this._adapter.tradeUpdate.unsubscribe(this, this._positionOrTradeUpdate),
            ...
            this._doneHandler().then(e => {
              e &&
                ...
                this._trackEvent(
                  'Position Ticket',
                  'Modify Position',
                  this.mode.value() === $.OrderEditorDisplayMode.Panel ? 'Panel' : 'Popup',
                )),
                this.loading.setValue(!1);
            });
        }
        ...
        _createModels(e, t, i, s, r, o) {
          var n;
          const a = (0, V.extractTakeProfitValidationRules)(this._adapter, this.symbol),
            l = (0, V.extractStopLossValidationRules)(this._adapter, this.symbol),
            u = (0, w.getCurrency)(i) || '$',
          ...
          (this.headerModel = new F({
            ...
            quotes$: this._quotes$,
            data: this._position,
            formatter: this._position.priceFormatter ? this._position.priceFormatter : r,
            headerState: this._headerState,
          })),
            (this.takeProfitModel = new Be({
              ...
              parentPrice$: new y.BehaviorSubject(
                null !== (n = this._position.avgPrice) && void 0 !== n ? n : this._position.price,
              ),
          ...
          const h = null !== this._position.trailingStopPips,
            ...
            p = e.stopLoss || this._position.stopLoss,
            _ = Boolean(c);
          this.stopLossModel = new Be({
            initialPrice: _ ? null : p || null,
            initialEnabled: Boolean(_ ? c : p),
            initialBracketType: _ ? T.BracketType.TrailingStop : T.BracketType.StopLoss,
            formatter: r,
            equity$: this._equity$,
            quotes$: this._quotes$,
            info: t,
          ...
          this.supportCryptoExchangeOrderTicket ||
            ...
            (this.buttonModel = new Ue(T.TradingEntityType.Position));
        }
        _updateWarning() {
          this._adapter.orders().then(e => {
            const t = e.find(
            ...
            this.warning.setValue(t ? d.t(null, void 0, i(698311)) : void 0);
          });
        }
        _subscribe() {
          if (
            ...
            (this._buttonDataSubscription = (0, S.combineLatest)({
              ...
              this.disabled.setValue(
                t || (0, w.isNoQuotes)(i) || (o && null === s) || (n && null === r),
              );
            })),
            ...
            null !== this.positionInfoModel && this.positionInfoModel.subscribe(),
            this.supportPositions &&
              this._adapter.positionUpdate.subscribe(this, this._positionOrTradeUpdate),
            this.supportTrades &&
              this._adapter.tradeUpdate.subscribe(this, this._positionOrTradeUpdate),
            this.supportOnlyPairPositionBrackets)
          ) {
            this._adapter.orderUpdate.subscribe(this, this._updateWarning);
            const e = this.stopLossModel.enabled$
                .pipe(ne(this.takeProfitModel.enabled$))
                .subscribe(e => {
                  const [t, i] = e;
                  i !== t && this.takeProfitModel.setEnabled(t);
                }),
              t = this.takeProfitModel.enabled$
                .pipe(ne(this.stopLossModel.enabled$))
                .subscribe(e => {
                  const [t, i] = e;
        ...
        _doneHandler() {
          const e =
              null !== this.stopLossModel.getValue() ? this.stopLossModel.price.getValue() : null,
          ...
          if (
            (null !== t &&
              null !== e &&
              (this.stopLossModel.getBracketType() === T.BracketType.StopLoss && (s.stopLoss = e),
              this.stopLossModel.getBracketType() === T.BracketType.TrailingStop &&
                (s.trailingStopPips = t)),
            null !== i && (s.takeProfit = i),
            Array.isArray(this.customFieldModels.value()))
          ) {
            const e = {};
            return (
              this.customFieldModels.value().forEach(t => {
                'TextWithCheckBox' === t.type &&
                  (e[t.id] = {
                    text: t.text.value().replace(/&quote;/g, '"'),
                    checked: t.checked.value(),
                  }),
                  'Checkbox' === t.type && (e[t.id] = { checked: t.checked.value() }),
        ...
        _getAndSendStatistics() {
          const e = this.stopLossModel.getEnabled(),
            ...
            l = { SL: { active: n[+e], mode: o[t] }, TP: { active: n[+i], mode: o[s] } };
          this.supportTrailingStop && (l.SLType = { active: n[+e], mode: a[r] });
          const u = this._settings.value();
          Object.keys(u)
            .filter(e => ['showBracketsInCurrency', 'showBracketsInPercent'].includes(e))
            .forEach(e => {
      ...
      class dt {
        ...
        saveSettings(e) {
          this._settingsAdapter.setValue(
            this._makeKey(ut.settingsKeys.ORDER_PANEL_SETTINGS, this._brokerId),
            JSON.stringify(e),
          );
        }
        getSettings() {
        ...
        setWidgetMode(e) {
          this._settingsAdapter.setValue(ut.settingsKeys.ORDER_WIDGET_MODE, e);
        }
        widgetMode() {
          const e = this._settingsAdapter.getValue(ut.settingsKeys.ORDER_WIDGET_MODE);
          return e || null;
        }
        _makeKey(e, t, i) {
      ...
      const yt = (0, o.getLogger)('Trading.OrderViewController');
      function gt() {
        return Promise.all([
          i.e(2452),
          i.e(580),
      ...
      class mt {
        constructor(e, t, i, r, o) {
          if (
            ...
            (this._dialogVisibility = new bt.DialogVisibility()),
            (this._orderWidgetStat = null),
            (this._settings = new l.WatchedValue(pt.defaultSettings)),
            (this._mode = new l.WatchedValue($.OrderEditorDisplayMode.Panel)),
            (this.openPanel = async () => {
              try {
                await this._closeOrderDialog(),
                  await this._closePositionDialog(),
                  this._setDisplayMode($.OrderEditorDisplayMode.Panel),
                  this._openTradingPanelPage(ct.TradingPage.OrderPanel),
                  await this._recreateOrderViewModel(null),
                  this._resetOrderPanel(),
                  await this._openOrderPanel();
              } catch (e) {
                yt.logWarn(`Failed to open panel: ${(0, u.getLoggerMessage)(e)}`);
              }
            }),
            (this.closePanel = () => {
            ...
            (this._onActiveTradingPanelChanged = e => {
              e !== ct.TradingPage.OrderPanel &&
                (null !== this._positionViewModel &&
                  (this._unmountPositionPanel(), this._unsubscribePositionViewModel()),
                null !== this._orderViewModel &&
                  this._mode.value() === $.OrderEditorDisplayMode.Panel &&
                  (this._orderViewModel.existingOrder &&
                    this._orderViewModel.onDoneButtonClicked.reject(),
              ...
              try {
                ...
                (i.symbol === t.symbol &&
                  ...
                  !(null == e ? void 0 : e.aborted) &&
                    ...
                    this._mode.value() === $.OrderEditorDisplayMode.Panel &&
                    this._tradingPanelActivePage.value() === ct.TradingPage.OrderPanel &&
                    (await this._recreateOrderViewModel(e),
                    this._deactivateOrderTicket(),
                    this._openOrderPanel()));
              } catch (e) {
                yt.logWarn(`Failed to change status: ${(0, u.getLoggerMessage)(e)}`);
              }
            }),
            ...
            (this._recreateOrderViewModel = async (e, t) => {
              ...
              const { broker: a, symbol: l, side: u } = this._state;
              let d = null;
              if (null === a)
                d = new ot({
                ...
                const h = await (0, n.respectAbort)(e, a.isTradable(l)),
                  c = (null == t ? void 0 : t.hasOwnProperty('id'))
                    ? a.modifyOrder.bind(a)
                    : a.placeOrder.bind(a);
                let p = null;
                h.tradable &&
                  (p =
                        ...
                        null !==
                          (r =
                            null !== (i = null == t ? void 0 : t.type) && void 0 !== i
                              ? i
                              : null === (s = this._getTradingSettingsStorage()) || void 0 === s
                              ? void 0
                              : s.orderType(l)) && void 0 !== r
                          ? r
                          : (0, w.getDefaultOrderType)(a.config)) && void 0 !== o
                      ? o
                      : null);
                const _ = await (0, n.respectAbort)(e, a.getOrderDialogOptions(l)),
                  b = this._makeOrderViewInputState(l, p, u, _);
                this._setState({ orderType: p }),
                  (d = new ot({
                    ...this._commonOrderViewModelProps(),
                    adapter: a,
                    isTradable: h,
                    handler: c,
                    orderViewInputState: b,
                    forceAbsolutePriceUpdate: !0,
                    orderDialogOptions: _,
                  }));
              }
              if (
                ((this._orderViewModel = d),
                await (0, n.respectAbort)(e, d.onReady),
                this._orderViewModel !== d)
              )
                return Promise.reject('OrderViewModel was recreated during the initialization');
              this._subscribeOrderViewModel();
            }),
            (this._onOrderWidgetModeChanged = async e => {
              e === $.OrderEditorDisplayMode.Panel
                ? (await this._closeOrderDialog(), await this._openOrderPanel())
                : (await this._closeOrderPanel(), await this._showOrderDialog()),
                this._setDisplayMode(e);
            }),
            (this._onOrderWidgetInputStateChanged = e => {
              const { symbol: t, orderType: i } = this._state;
              if (
                ((0, w.isDefined)(e.side) && this._setState({ side: e.side }), !(0, w.isDefined)(i))
              )
                return;
              const s = this._getTradingSettingsStorage();
              if (null !== s) {
                if (
                  ((0, w.isDefined)(e.quantity) && s.setSymbolQty(t, e.quantity),
                  (0, w.isDefined)(e.takeProfitPips) &&
                    s.setTakeProfitPips(t, e.takeProfitPips, $.BracketDefaultPips.TakeProfit),
                  (0, w.isDefined)(e.stopLossPips) &&
                    s.setStopLossPips(t, e.stopLossPips, $.BracketDefaultPips.StopLoss),
                  (0, w.isDefined)(e.orderType) && s.setOrderType(t, e.orderType),
                  (0, w.isDefined)(e.duration))
                ) {
                  const t = this._state.broker && this._state.broker.metainfo().durations,
                    r = t && (t.find(e => e.default) || t[0]),
                    o = r && r.name === e.duration.type ? null : e.duration;
                  s.setDuration(this._state.symbol, i, o);
                }
                (0, w.isDefined)(e.customFields) && s.setCustomFields(t, i, e.customFields);
              }
            }),
            ...
            (this._onOrderWidgetBackButtonClicked = () => {
              if (
                ...
                this._orderViewModel.status.value() === $.OrderPanelStatus.Preview
              )
                return (
                  this._activateOrderTicket(),
                  void (this._mode.value() === $.OrderEditorDisplayMode.Panel
                    ? this._openOrderPanel()
                    : this._showOrderDialog())
                );
              this.showOrderView({ order: this._createOrderStub(), isDeactivated: !0 });
            }),
            (this._onPositionWidgetModeChanged = async e => {
              e === $.OrderEditorDisplayMode.Panel
                ? (await this._closePositionDialog(), await this._openPositionPanel())
                : (await this._closePositionPanel(), await this._showPositionDialog()),
                this._setDisplayMode(e);
            }),
            ...
            (this._orderViewHeaderState = o),
            (this._tradingCommands = e),
            (this._trackEvent = e.trackEvent),
            (this._realtimeProvider = e.realtimeProvider),
            (this._resizerBridge = e.resizerBridge),
            (this._orderViewDataStorage = new dt(s)),
            (this._tradingPanelContainer = t.container),
            (this._isOpeningTradingPanelAvailable = t.isOpeningAvailable),
            (this._isTradingPanelOpened = t.isOpened),
            (this._qtySuggester = i),
            (this._tradingLinking = r),
            (this._tradingPanelActivePage = t.activePage),
            (this._closeTradingPanel = t.close),
            (this._openTradingPanelPage = t.openPage),
            (this._getTradingSettingsStorage = e.getTradingSettingsStorage),
            (this.dialogVisibility = this._dialogVisibility.value$),
            window.matchMedia(_t.TradingLayoutBreakpoint.Mobile).matches)
          )
            this._setDisplayMode($.OrderEditorDisplayMode.Popup);
          else if (a.enabled('order_panel')) {
            const e = this._orderViewDataStorage.widgetMode();
            this._setDisplayMode(null != e ? e : $.OrderEditorDisplayMode.Panel);
          } else this._setDisplayMode($.OrderEditorDisplayMode.Popup);
          t.isOpeningAvailable.subscribe(e => {
            e ||
              this._mode.value() !== $.OrderEditorDisplayMode.Panel ||
              this._setDisplayMode($.OrderEditorDisplayMode.Popup);
          }),
            (this._state = this._makeState()),
            (this.stateChanging = ht.value),
            (this._onStatusChanged = (0, n.respectLatest)(this._onStatusChanged)),
            (this._recreateOrderViewModel = ht.wrap(
              (0, n.respectLatest)(this._recreateOrderViewModel),
            )),
            (this.openPanel = ht.wrap(this.openPanel)),
            this._realtimeProvider.onStatusChanged.subscribe(null, () =>
              this._onStatusChanged(null),
            ),
            this._tradingLinking.valueObservable().subscribe(() => this._onStatusChanged(null)),
            window.loginStateChange &&
              window.loginStateChange.subscribe(this, () => this._onStatusChanged(null)),
            t.activePage.subscribe(this._onActiveTradingPanelChanged);
        }
        async showOrderView(e) {
          try {
            const { order: t, focus: i, forceOrderDialog: s, isDeactivated: o = !1 } = e;
            await this._closeOrderDialog(),
              await this._closePositionDialog(),
              s && this._setDisplayMode($.OrderEditorDisplayMode.Popup);
            const n = Object.assign(this._createOrderStub(), t);
            return (
              t.symbol !== this._state.symbol && this._setState({ symbol: t.symbol }),
              await this._recreateOrderViewModel(null, n),
              o && this._deactivateOrderTicket(),
              this._mode.value() === $.OrderEditorDisplayMode.Panel
                ? this._openOrderPanel(i)
                : this._showOrderDialog(i),
              (0, r.ensureNotNull)(this._orderViewModel).onDoneButtonClicked.promise
            );
          } catch (e) {
            return yt.logWarn(`Failed to show order view: ${(0, u.getLoggerMessage)(e)}`), !1;
          }
        }
        async showPositionView(e, t, i) {
          try {
            return this._createAndShowPositionViewModel({
              position: e,
              viewType: at.Position,
              brackets: t,
              focus: i,
            });
          } catch (e) {
            return yt.logWarn(`Failed to show position view: ${(0, u.getLoggerMessage)(e)}`), !1;
          }
        }
        async showTradeView(e, t, i) {
          try {
            ...
            return yt.logWarn(`Failed to show trade view: ${(0, u.getLoggerMessage)(e)}`), !1;
          }
        }
        mode() {
          return this._mode;
                  ...
                  null !==
                    (t =
                      null === (e = this._orderViewModel) || void 0 === e
                        ? void 0
                        : e.orderType.value()) && void 0 !== t
                    ? t
                    : l) && void 0 !== i
                ? i
                : null,
            d = null !== (s = null == n ? void 0 : n.currentAccount()) && void 0 !== s ? s : null,
            h = n ? n.metainfo().id : '';
          return (
            this._orderViewDataStorage.setBrokerId(h),
            { isAuthenticated: r, broker: n, symbol: o, accountId: d, side: 1, orderType: u }
          );
        }
        async _createAndShowPositionViewModel({ position: e, viewType: t, brackets: i, focus: s }) {
          ...
          const a = await r.getOrderDialogOptions(o),
            l = t === at.Position ? r.editPositionBrackets.bind(r) : r.editTradeBrackets.bind(r),
            u = new lt({
              adapter: r,
              position: e,
              brackets: i,
        ...
        _activateOrderTicket() {
          var e;
          null === (e = this._orderViewModel) || void 0 === e || e.activateOrderTicket();
        }
        _deactivateOrderTicket() {
          var e;
          null === (e = this._orderViewModel) || void 0 === e || e.deactivateOrderTicket();
        }
        _resetOrderPanel() {
          var e;
          null === (e = this._orderViewModel) || void 0 === e || e.resetOrderPanel();
        }
        async _openOrderPanel(e) {
          await this._mountOrderPanel(e), this._openTradingPanelPage(ct.TradingPage.OrderPanel);
        }
        async _mountOrderPanel(e) {
          const { mountOrderPanel: t } = await gt();
          null !== this._orderViewModel &&
            t(
              this._orderViewModel,
              this._settings,
        ...
        async _showOrderDialog(e) {
          ...
          null !== this._orderViewModel &&
            t({
              ...
              onOpen: e => {
                this._dialogVisibility.setValue({ isVisible: !0, isFullScreen: e });
              },
              onClose: () => {
        ...
        async _closeOrderDialog() {
          const { closeOrderDialog: e } = await gt();
        ...
        _subscribeOrderViewModel() {
          (0, r.ensureNotNull)(this._orderViewModel)
            ...
            (0, r.ensureNotNull)(this._orderViewModel).orderType.subscribe(
              this._onOrderTypeChanged,
            );
        }
        _unsubscribeOrderViewModel() {
          (0, r.ensureNotNull)(this._orderViewModel)
            ...
            (0, r.ensureNotNull)(this._orderViewModel).orderType.unsubscribe(
              this._onOrderTypeChanged,
            ),
        ...
        async _openPositionPanel(e) {
          await this._mountPositionPanel(e), this._openTradingPanelPage(ct.TradingPage.OrderPanel);
        }
        async _mountPositionPanel(e) {
          const { mountPositionPanel: t } = await vt();
          if (null !== this._positionViewModel)
            return t(this._positionViewModel, this._settings, this._tradingPanelContainer, e);
        }
        async _closePositionPanel() {
          await this._unmountPositionPanel(), this._closeTradingPanel();
        }
        async _unmountPositionPanel() {
          const { unmountPositionPanel: e } = await vt();
          e(this._tradingPanelContainer);
        }
        async _showPositionDialog(e) {
          const { showPositionDialog: t } = await vt();
          null !== this._positionViewModel &&
            t({
        ...
        async _closePositionDialog() {
          const { closePositionDialog: e } = await vt();
          e(() => this._dialogVisibility.setValue({ isVisible: !1 }));
        }
        ...
        _unsubscribePositionViewModel() {
          (0, r.ensureNotNull)(this._positionViewModel)
            ...
            (0, r.ensureNotNull)(this._positionViewModel).onDoneButtonClicked.resolve(!1),
            ...
            (u =
              null === (r = this._getTradingSettingsStorage()) || void 0 === r
                ...
                : r.customFields(
                    e,
                    t,
                    s.customFields.map(e => e.id),
                  ));
          const d =
            null !== t
              ? null === (o = this._getTradingSettingsStorage()) || void 0 === o
                ? void 0
                : o.duration(e, t)
              : null;
          return {
        ...
        _commonOrderViewModelProps() {
          return {
            ...
            toggleTradingPanelPopup: this._tradingCommands.toggleTradingPanelPopup,
