  ...
  [4079],
  {
    130399: (t, e, a) => {
      ...
      var i = a(650151),
        ...
        h = a(104947),
        c = a(620218);
      const _ = s.t(null, void 0, a(924450)),
      ...
      class m extends h.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(t) {
          const e = this._data;
          if (null === e) return;
          const { dateString: a, timeString: l, eod: r, point: s, direction: h } = e,
            m = Math.round(4.5),
            T = t.context;
          let f,
            g = 0,
          ...
          if (e.eod) {
            ...
            if ((T.fillText((0, i.ensureDefined)(e.dateString), t + a, B + m + 8), e.timeString)) {
      ...
      class T {
        ...
        _updateImpl() {
          ...
          let m, T;
          if (!t) {
            const t = (0, i.ensureNotNull)(e.timeScale().indexToUserTime((0, i.ensureNotNull)(n)));
            (m = e.dateFormatter().format(t)),
              this._series.isDWM() || (T = e.timeFormatter().format(t));
          }
          (this._data = { point: b, direction: u, eod: t, dateString: m, timeString: T }),
