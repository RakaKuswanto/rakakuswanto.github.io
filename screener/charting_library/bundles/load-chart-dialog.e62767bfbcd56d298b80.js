(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5009],
  {
    ...
    231862: (e, t, n) => {
      ...
      function c(e) {
        ...
        return a.createElement(
          ...
          a.createElement(
            'div',
            { className: r()(u.inputContainer, h, c && u.withCancel) },
            o || a.createElement(m, { ...y }),
          ),
          t,
          a.createElement(l.Icon, { className: r()(u.icon, g), icon: s }),
          c &&
            a.createElement(
              'div',
              { className: u.cancel, onClick: c },
              i.t(null, void 0, n(620036)),
            ),
        );
      }
      function m(e) {
    ...
    73288: (e, t, n) => {
      'use strict';
      n.d(t, { OverlayScrollContainer: () => y });
      var a = n(50959),
        o = n(497754),
        r = n.n(o),
        i = n(710263),
      ...
      function d(e) {
        const {
          ...
          w = (0, a.useRef)(0),
          {
            ...
            sizePropName: L,
            minSizePropName: D,
            startPointPropName: k,
            currentMousePointPropName: z,
            progressBarTransform: E,
          } = c[h];
        (0, a.useEffect)(() => {
          const e = (0, l.ensureNotNull)(v.current).ownerDocument;
          return (
            b
              ? (y && y(),
                e && (e.addEventListener('mousemove', B), e.addEventListener('mouseup', H)))
              : f && f(),
            () => {
              e && (e.removeEventListener('mousemove', B), e.removeEventListener('mouseup', H));
            }
          );
        }, [b]);
        const x = t / n || 0,
          ...
          T = N ? -P : 0,
          Z = N ? 0 : P,
          R = W((0, s.clamp)(i, T, Z)) || 0;
        return a.createElement(
          'div',
          {
            ref: v,
            className: r()(g.wrap, C && g['wrap--horizontal']),
            style: { [L]: t },
            onMouseDown: function (e) {
              if (e.isDefaultPrevented()) return;
              e.preventDefault();
              const t = F(e.nativeEvent, (0, l.ensureNotNull)(v.current)),
                n = Math.sign(t),
                a = (0, l.ensureNotNull)(_.current).getBoundingClientRect();
              w.current = (n * a[L]) / 2;
              let o = Math.abs(t) - Math.abs(w.current);
              const r = W(P);
              o < 0 ? ((o = 0), (w.current = t)) : o > r && ((o = r), (w.current = t - n * r));
              d(j(n * o)), S(!0);
            },
          },
          a.createElement(
            ...
            {
              ref: _,
              className: r()(g.bar, C && g['bar--horizontal']),
              style: { [D]: p, [L]: M, transform: `${E}(${R}px)` },
              onMouseDown: function (e) {
                e.preventDefault(),
                  (w.current = F(e.nativeEvent, (0, l.ensureNotNull)(_.current))),
                  S(!0);
              },
            },
            a.createElement('div', { className: r()(g.barInner, C && g['barInner--horizontal']) }),
          ),
        );
        function B(e) {
          const t = F(e, (0, l.ensureNotNull)(v.current)) - w.current;
          d(j(t));
        }
        function H() {
          S(!1);
      ...
      function y(e) {
        ...
        return a.createElement(
          'div',
          {
            ..._,
            ref: t,
            className: o(n, g.scrollWrap),
            style: { visibility: p || v || b ? 'visible' : 'hidden' },
          },
          w &&
            a.createElement(d, {
              size: r - N,
          ...
          .map(e => {
            ...
            return (
              n.forEach(e => {
                ...
                if (
                  ((h.lastIndex = 0),
                  (0, a.isString)(t) && t && t.toLowerCase() === o.toLowerCase())
                )
                  return (
                    (d = 4), void (m = null === (n = t.match(g)) || void 0 === n ? void 0 : n.index)
                  );
                if ((0, a.isString)(t) && g.test(t))
                  return (
                    (d = 3), void (m = null === (i = t.match(g)) || void 0 === i ? void 0 : i.index)
                  );
                if ((0, a.isString)(r) && g.test(r))
                  return (
                    (d = 2), void (m = null === (l = r.match(g)) || void 0 === l ? void 0 : l.index)
                  );
                if ((0, a.isString)(r) && h.test(r))
                  return (
                    (d = 2), void (m = null === (s = r.match(h)) || void 0 === s ? void 0 : s.index)
                  );
                if (Array.isArray(c))
                  for (const e of c)
                    if (g.test(e))
                      return (
                        (d = 1),
                        void (m = null === (u = e.match(g)) || void 0 === u ? void 0 : u.index)
                      );
              }),
    ...
    260598: (e, t, n) => {
      ...
      function l(e) {
        const { queryString: t, rules: n, text: l, className: s } = e,
          u = (0, a.useMemo)(() => (0, r.getHighlightedChars)(t, l, n), [t, n, l]);
        return a.createElement(
          a.Fragment,
          null,
          u.length
        ...
        const [e, t] = (0, a.useState)(null),
          n = (0, a.useCallback)(
            ([n]) => {
              ...
              (a.width === (null == e ? void 0 : e.width) && a.height === e.height) || t(a);
            },
            [e],
          );
        ...
        const n = (0, a.useRef)(null),
          ...
          [m, d] = (0, a.useState)({
            ...
            onVerticalChange: function (e) {
              d(t => ({ ...t, scrollPosTop: e })), ((0, o.ensureNotNull)(s.current).scrollTop = e);
            },
    ...
    208955: (e, t, n) => {
      ...
      function v(e) {
        ...
        return a.createElement(
          ...
          a.createElement(g.Icon, { className: p.icon, icon: 0 === t ? y : f }),
          a.createElement(
            d.PopupMenu,
            {
      ...
      function S(e) {
        ...
        return a.createElement(_.PopupMenuItem, {
          ...c,
          className: r(b.container, u),
          label: a.createElement(
            'div',
            { className: b.labelWrap },
            a.createElement(g.Icon, { className: b.icon, icon: 0 === l ? y : f }),
      ...
      function N(e) {
        ...
        return a.createElement('div', { className: i()(C.container, n) }, t);
      }
      function L(e) {
        const { title: t } = e;
        return a.createElement('div', { className: C.title }, t);
      }
      var D = n(150335);
      var k = n(220037),
        z = n(710263),
      ...
      function I(e) {
        const {
          ...
          [m, d] = (0, E.useDimensions)(),
          [h, g, y, f] = (0, x.useOverlayScroll)();
        return (
          (0, a.useEffect)(() => {
            const e = () => {};
            return c.isFF
          ...
          a.createElement(
            ...
            'overlay' === s &&
              a.createElement(A.OverlayScrollContainer, { ...h, className: M.overlayScrollWrap }),
            a.createElement(k.FixedSizeList, {
              ref: r,
      ...
      var F = n(906355),
        ...
        Y = n(512991),
        q = n(629276);
      const O = new F.DateFormatter('dd-MM-yyyy'),
        U = new W.TimeFormatter(W.hourMinuteFormat),
        K = T.enabled('items_favoriting');
      function V(e) {
        const {
            chart: t,
          ...
          _ = t.url
            ? (function (e) {
                ...
                return (
                  ...
                  (0, P.urlWithMobileAppParams)(n.href)
                );
              })({ chartId: t.url })
            : void 0,
          b = (0, a.useContext)(B.SlotContext),
          S = (0, a.useMemo)(() => new Date(1e3 * t.modified), [t]),
          w = (0, a.useMemo)(() => (0, Y.createRegExpList)(m), [m]),
          C = i()(q.highlight, y && q.active);
        return (
          (0, a.useEffect)(
            () => (
          ...
          a.createElement(Z.DialogContentItem, {
            url: _,
            title: a.createElement(j.HighlightedText, {
              className: C,
              queryString: m,
              rules: w,
              text: t.title,
            ...
            subtitle: a.createElement(
              a.Fragment,
              null,
              a.createElement(j.HighlightedText, {
                className: C,
                queryString: m,
                rules: w,
                text: t.description,
            ...
            onClickRemove: async function () {
              ...
              const e = await (async function (e) {
                return s.t(null, { replace: { name: e.title } }, n(569368));
              })(t);
              v(!1),
                (function (e, t, n, a) {
                  (0, H.showConfirm)(
        ...
        X = (function (e) {
          ...
          return (0, a.forwardRef)(({ style: e, ...o }, r) => {
            ...
            return a.createElement('div', {
              ref: r,
              style: { ...e, height: `${((0, D.isNumber)(i) ? i : parseFloat(i)) + t + n}px` },
              ...o,
            });
          });
        })({ paddingBottom: 6 });
      ...
      const te = T.enabled('items_favoriting'),
        ne = s.t(null, void 0, n(375789));
      function ae(e) {
        const { charts: t, onClose: o, favoriteChartsService: r, chartWidgetCollection: d } = e,
          ...
          [k, z] = (0, a.useState)(() => u.getJSON('loadChartDialog.viewState', J)),
          E = (0, a.useRef)(null),
          x = (0, a.useRef)(null),
          A = (0, a.useMemo)(
            () => t.map(e => ({ ...e, description: `${e.symbol}, ${ee(e.interval)}` })),
            [t],
          );
        (0, a.useEffect)(() => {
          c.CheckMobile.any() || (0, l.ensureNotNull)(E.current).focus();
        }, []);
        const M = (0, a.useRef)();
        (0, a.useEffect)(
          () => (
        ...
        const P = (0, a.useCallback)(() => !0, []),
          T = (0, a.useMemo)(() => {
            return (0, Y.rankedSearch)({
              data: A.filter(e => !p.includes(e.id)).sort(
                ((e = k.sortDirection),
                (t, n) => {
                  if (C[t.id] && !C[n.id]) return -1;
                  if (!C[t.id] && C[n.id]) return 1;
                  const a = 0 === e ? 1 : -1;
                  return 'modified' === k.sortField
                    ? a * (t.modified - n.modified)
                    : a * t.title.localeCompare(n.title);
                }),
              ),
              rules: (0, Y.createRegExpList)(h),
              queryString: h,
              primaryKey: 'title',
        ...
        return a.createElement(m.AdaptivePopupDialog, {
          ...
          render: function () {
            return a.createElement(
              ...
              a.createElement(
                N,
                { className: i()(!te && Q.contentHeader) },
                a.createElement(L, { title: s.t(null, void 0, n(425653)) }),
                a.createElement(
                  v,
                  {
                    sortDirection: k.sortDirection,
                    title: s.t(null, void 0, n(141583)),
                    'data-name': 'load-chart-dialog-sort-button',
                  },
                  a.createElement(S, {
                    label: s.t(null, void 0, n(263479)),
                    listSortField: k.sortField,
                    itemSortField: 'title',
                    listSortDirection: k.sortDirection,
                    itemSortDirection: 0,
                    onClick: U,
                  ...
                  a.createElement(S, {
                    label: s.t(null, void 0, n(463037)),
                    listSortField: k.sortField,
                    itemSortField: 'modified',
                    listSortDirection: k.sortDirection,
                    itemSortDirection: 1,
        ...
        function U(e, t) {
          ...
          z(n), u.setValue('loadChartDialog.viewState', JSON.stringify(n), { forceFlush: !0 }), W();
        }
      }
      var oe = n(19406);
      class re extends oe.DialogRenderer {
        ...
        show() {
          o.render(
            a.createElement(ae, { ...this._options, onClose: () => this.hide() }),
            this._container,
          ),
