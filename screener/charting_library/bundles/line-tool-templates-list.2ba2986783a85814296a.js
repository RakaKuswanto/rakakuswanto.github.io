(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3177],
  {
    ...
    580384: (e, a, t) => {
      'use strict';
      t.r(a), t.d(a, { LinetoolTemplatesList: () => p });
      var l = t(509806),
        n = t(986661),
        o = t(855342),
        i = t(357739),
      ...
      class p {
              ...
              (0, m.showRename)({
                ...
                onRename: a => {
                  if (-1 !== (this.getData() || []).indexOf(a.newValue)) {
                    const n = l.t(null, { replace: { name: a.newValue } }, t(571527));
                    (0, m.showConfirm)(
                      {
                        text: n,
                        onConfirm: t => {
        ...
        async _loadData() {
          return new Promise(e => {
            this.getData() ? e() : n.store.dispatch((0, o.getTemplates)(this._toolName, e));
          });
        }
      }
    },
    855342: (e, a, t) => {
      ...
      function s(e, a, t) {
        return { type: l.SAVE_TEMPLATE, templateName: a, toolName: e, content: t };
      }
      function p(e, a, t) {
        return { type: l.LOAD_TEMPLATE, toolName: e, templateName: a, callback: t };
      }
    },
    765827: (e, a, t) => {
      'use strict';
    ...
    986661: (e, a, t) => {
      ...
      function* c() {
        for (;;) {
          const {
            ...
            templateName: a,
            content: t,
          } = T(r.SAVE_TEMPLATE, yield (0, o.take)(r.SAVE_TEMPLATE));
          try {
      ...
      function* E() {
        for (;;) {
          const { toolName: e, templateName: a } = T(
            r.START_REMOVE_TEMPLATE,
            yield (0, o.take)(r.START_REMOVE_TEMPLATE),
          );
          try {
      ...
      function* g() {
        ...
        for (;;) {
          const { toolName: t, callback: l } = T(
            r.GET_TEMPLATES,
            yield (0, o.take)(r.GET_TEMPLATES),
          );
          e.has(t)
            ? (0, i.ensureDefined)(e.get(t)).push(l)
        ...
        function* a(a) {
          ...
          (0, i.ensureDefined)(e.get(a)).forEach(e => (null == e ? void 0 : e())), e.delete(a);
        }
      }
      function* h() {
        for (;;) {
          const {
            ...
            templateName: a,
            callback: t,
          } = T(r.LOAD_TEMPLATE, yield (0, o.take)(r.LOAD_TEMPLATE));
          try {
            const l = p(
      ...
      function* _() {
        yield (0, o.all)([(0, o.call)(g), (0, o.call)(c), (0, o.call)(E), (0, o.call)(h)]);
      }
      const D = { templates: {} };
      function y(e, a) {
      ...
      function w(e = D, a) {
        switch (a.type) {
          ...
          case r.SET_TEMPLATES: {
            const { toolName: t, templates: l } = a;
            return { ...e, templates: { ...e.templates, [t]: [...l].sort(y) } };
          }
          case r.REMOVE_TEMPLATE: {
            const { toolName: t, templateName: l } = a;
            return {
              ...e,
              templates: { ...e.templates, [t]: e.templates[t].filter(e => e !== l) },
            };
          }
          default:
            return e;
    ...
    571527: e => {
      e.exports = {
        ...
        de: ["Zeichenvorlage '{name}' existiert bereits. Wollen Sie diese wirklich ersetzen?"],
        ...
        pt: ["O Template de Desenho '{name}' já existe. Você realmente quer substitui-lo?"],
        ...
        tr: ["Çizim Şablonu '{name}' zaten var. Gerçekten değiştirmek istiyor musun?"],
