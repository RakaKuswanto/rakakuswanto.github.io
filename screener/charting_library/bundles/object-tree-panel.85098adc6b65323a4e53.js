(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5031],
  {
    ...
    506909: e => {
      e.exports = { wrap: 'wrap-ukH4sVzT', space: 'space-ukH4sVzT', tree: 'tree-ukH4sVzT' };
    },
    106690: (e, t, n) => {
      'use strict';
    ...
    420779: (e, t, n) => {
      ...
      function L(e) {
        const {
          ...
          D = (0, o.useContext)(u.ObjectTreeContext),
          { viewModel: B } = (0, r.ensureNotNull)(D),
          G = (0, o.useContext)(_.ObjectTreeNodeRendererContext),
          { size: V } = (0, o.useContext)(c.SizeContext),
          [H, P] = (0, o.useState)(!1),
          R = (0, o.useRef)(null),
          [F, W] = (0, o.useState)(z.title()),
          [U, K] = (0, o.useState)(z.getIcon()),
          [Z, Y] = (0, o.useState)(z.isLocked()),
          [$, q] = (0, o.useState)(z.isVisible()),
          [Q, J] = (0, o.useState)(z.isActualInterval()),
          [X, ee] = (0, o.useState)(z.getDrawingSyncState()),
          [te, ne] = (0, o.useState)(!1),
          oe = (0, b.useWatchedValueReadonly)({ watchedValue: B.getChartLayout() }),
          [ie, re] = (0, o.useState)(!1),
          se = (0, o.useRef)(null);
        (0, o.useEffect)(() => {
          const e = {};
          z.onLockChanged().subscribe(e, () => Y(z.isLocked())),
            z.onVisibilityChanged().subscribe(e, () => q(z.isVisible()));
          const t = z.onTitleChanged();
          t && t.subscribe(e, () => W(z.title())),
            z.onIsActualIntervalChange().subscribe(e, () => J(z.isActualInterval())),
            z.onSyncStateChanged().subscribe(e, () => ee(z.getDrawingSyncState()));
          const n = z.onIconChanged ? z.onIconChanged() : void 0;
          return (
            n && n.subscribe(e, () => K(z.getIcon())),
            () => {
              z.onIsActualIntervalChange().unsubscribeAll(e),
                z.onLockChanged().unsubscribeAll(e),
                z.onVisibilityChanged().unsubscribeAll(e),
                z.onSyncStateChanged().unsubscribeAll(e),
          ...
          (0, o.useEffect)(() => {
            H && R.current && (R.current.focus(), R.current.setSelectionRange(0, F.length));
          }, [H]),
          (0, o.useEffect)(() => {
            const e = {};
            return (
          ...
          (0, o.useEffect)(() => {
            !A && se.current && (clearTimeout(se.current), (se.current = null)), P(!1);
          }, [A]);
        const le = {};
        if (O) {
          const e = B.entity(O);
          e && (le['data-parent-name'] = e.title()),
            (le['data-type'] = z.hasChildren() ? 'group' : 'data-source');
        }
        const ae = l.enabled('test_show_object_tree_debug')
            ? `<${z.id()}> (${z.zOrder()}) ${z.title()}`
            : z.title(),
          ...
          ge = !!G && G.isDialog,
          pe = Q && $ ? k : j,
          _e = z.hasChildren() ? a.t(null, void 0, n(438207)) : a.t(null, void 0, n(839781));
        let ve = null;
        return (
          U &&
            U.type === d.IconType.Svg &&
            (ve = o.createElement(s.Icon, { icon: U.content || '', className: M.icon })),
          o.createElement(
            'span',
            {
              className: i(
              ...
              onMouseDown: function (e) {
                H && !(0, r.ensureNotNull)(R.current).contains(e.target) && re(!0);
              },
              onClick:
                1 === V
                  ? be
                  : function (e) {
                      ...
                      if (0 !== (0, p.modifiersFromEvent)(e)) return;
                      if (se.current)
                        e.preventDefault(),
                        ...
                        se.current = setTimeout(() => {
                          (se.current = null),
                            A && !ie && 1 === e.length && B.rename(z, () => P(!0)),
                            re(!1);
                        }, 500);
                      }
                    },
              onContextMenu: he ? void 0 : be,
            },
            !de &&
              o.createElement(
                o.Fragment,
                ...
                ce &&
                  ...
                  o.createElement(
                    ...
                    o.createElement(s.Icon, { icon: ce, className: M.syncIcon }),
                  ),
                o.createElement(
                  'span',
                  {
                ...
                o.createElement(
                  ...
                  z.canBeLocked() &&
                    o.createElement(v.ListItemButton, {
                      title: Z ? m.unlockTitle : m.lockTitle,
                      icon: Z ? y : I,
                      className: i(M.button, (ue || Z) && M.visible, 'apply-common-tooltip'),
                      onClick: function (e) {
                        if (e.defaultPrevented) return;
                        e.preventDefault(), B.setIsLocked(t, !z.isLocked());
                      },
                      'data-role': 'button',
                      'data-name': 'lock',
                      'data-active': Z,
                  ...
                  o.createElement(v.ListItemButton, {
                    ...
                    onClick: Q
                      ? function (e) {
                          if (e.defaultPrevented) return;
                          e.preventDefault(), B.setIsVisible(t, !z.isVisible());
                        }
                      : function (e) {
                          if (e.defaultPrevented) return;
                          e.preventDefault(), B.openProperties(z, C.TabNames.visibility);
                        },
                    title: (function () {
                      if (!Q) return _e;
                      return $ ? m.hideTitle : m.showTitle;
                    })(),
                    'data-role': 'button',
                    'data-name': 'hide',
                    'data-active': !$,
                  ...
                  z.canBeRemoved() &&
                    o.createElement(v.ListItemButton, {
                      title: m.removeTitle,
                      icon: w,
                      className: i(M.button, (he || ue) && M.visible, 'apply-common-tooltip'),
                      onClick: function (e) {
                        if (e.defaultPrevented) return;
            ...
            de &&
              o.createElement(h.InputControl, {
                ...
                onClick: g.preventDefault,
                className: M.renameInput,
                onKeyDown: function (e) {
                  27 === (0, p.hashFromEvent)(e)
                    ? (e.preventDefault(), W(z.title()), P(!1))
                    : 13 === (0, p.hashFromEvent)(e) && (e.preventDefault(), me());
                },
        ...
        function be(e) {
          e.defaultPrevented ||
            H ||
            !z.fullyConstructed() ||
            (e.preventDefault(), e.persist(), B.openContextMenu(z, () => P(!0), e));
        }
        function me() {
          '' !== F && z.setName(F), W(z.title()), P(!1);
        }
        function fe(e) {
          if (z.hasChildren() && !x) {
            const t = null !== e && z.childrenIds().has(e);
            ne(t);
          } else ne(t === e);
        }
      }
    ...
    993321: (e, t, n) => {
      ...
      function S(e) {
        const { hideTitle: t } = e,
          { viewModel: i } = (0, l.ensureNotNull)((0, o.useContext)(p.ObjectTreeContext)),
          r = (0, g.useForceUpdate)(),
          s = i.selection();
        (0, o.useEffect)(() => {
          const e = {};
          return (
        ...
        const S = !i.canSelectionBeUnmerged(),
          T = i.isSelectionCopiable(),
          C = i.isSelectionCloneable(),
          w = !T && !C,
          y = i.canSelectionBeGrouped(),
          I = !1;
        return o.createElement(
          ...
          !t &&
            o.createElement(
              'div',
              { className: a(f.title, f.withoutIcon) },
          ...
          o.createElement(
            'div',
            { className: f.buttons },
            o.createElement(_.ToolWidgetIconButton, {
              className: a(f.button, !y && f.disabled),
              icon: m,
              onClick: function () {
                i.createGroupFromSelection();
              },
              isDisabled: !y,
              title: c.t(null, void 0, n(391073)),
              'data-name': 'group-button',
            }),
            o.createElement(
              h.ToolWidgetMenu,
              {
                className: a(f.button, w && f.disabled),
                isDisabled: w,
                content: o.createElement(u.Icon, { icon: v }),
                title: c.t(null, void 0, n(598129)),
                arrow: !1,
                isShowTooltip: !0,
            ...
            o.createElement(
              h.ToolWidgetMenu,
              {
                className: a(f.button, S && f.disabled),
                isDisabled: S,
                content: o.createElement(u.Icon, { icon: b }),
                title: c.t(null, void 0, n(745828)),
                arrow: !1,
                isShowTooltip: !0,
            ...
            t &&
              o.createElement(
                o.Fragment,
                null,
                o.createElement('div', { className: f.spacing }),
                o.createElement(_.ToolWidgetIconButton, {
                  className: f.button,
                  icon: manageDrawingsIcon,
                  title: c.t(null, void 0, n(72357)),
      ...
      var T = n(317447),
        ...
        j = n(129881);
      function M(e) {
        return (0, C.eventChannel)(t => {
          const n = {};
          return (
            e.onChange().subscribe(n, () => t((0, w.resetTree)())),
            e.onGroupCreated().subscribe(n, e => t((0, w.setIsExpanded)(e, !0))),
            e
              .selection()
              .onChange()
              .subscribe(n, e => t((0, w.setSelectedIds)(e))),
            () => {
      ...
      function* A() {
        for (;;)
          yield (0, i.take)([I.SELECT_NEXT, I.SELECT_PREVIOUS]),
            (0, k.trackObjectTreeEvent)('Select', 'Arrow');
      }
      function* E() {
        for (;;) {
          const { mode: e } = yield (0, i.take)(I.SET_IS_SELECTED);
          1 === e && (0, k.trackObjectTreeEvent)('Multi select', 'Ctrl'),
            2 === e && (0, k.trackObjectTreeEvent)('Multi select', 'Shift');
        }
      }
      function* L(e) {
        for (;;) {
          yield (0, i.take)(I.DROP_SELECTION);
          const { node: t, dropType: n } = (0, j.dropTargetSelector)(yield (0, i.select)());
          if (t) {
            const o = (0, j.selectedNodesSelector)(yield (0, i.select)()),
              r = o.map(t => (0, l.ensureNotNull)(e.entity(t.id)));
            let s = 'Drag';
            1 === t.level && 'inside' !== n && o.some(e => 2 === e.level)
              ? (s = 'From the group')
              : (2 !== t.level && 'inside' !== n) || !o.some(e => 1 === e.level)
              ? 1 === o.length && o[0].parentId !== t.parentId && (s = 'Existing pane')
              : (s = 'To the group'),
              (0, k.trackObjectTreeEvent)(s, (0, k.getGaAction)(r));
          }
        }
      }
      function* N(e) {
        yield (0, i.fork)(A), yield (0, i.fork)(E), yield (0, i.fork)(L, e);
      }
      function* O(e) {
        yield (0, i.fork)(N, e);
        const t = yield (0, i.call)(M, e);
        y.logger.logNormal('Opened object tree data source channel');
        try {
          for (;;) {
          ...
          y.logger.logNormal('Closed object tree data source channel'), t.close();
        }
      }
      var z = n(106690),
        x = n(199663),
        D = n(330344),
        B = n(506909);
      const G = r.mobiletouch ? 'touch' : 'native';
      function V(e) {
        const {
            viewModel: t,
            showHeader: n = !0,
          ...
          [h, g] = (0, D.useDimensions)(),
          [_, v] = (0, o.useState)(null),
          b = (0, o.useMemo)(() => ({ isTouch: r.touch, isDialog: a }), [a]);
        return o.createElement(
          z.ObjectTreeNodeRendererContext.Provider,
          { value: b },
          o.createElement(
            p.ObjectTreeContext.Provider,
            { value: { viewModel: t } },
            o.createElement(
              'div',
              { className: B.wrap, onContextMenu: x.preventDefaultForContextMenu },
              n && o.createElement(S, { hideTitle: c }),
              o.createElement(
                'div',
                {
                  className: B.space,
                  onClick: function (e) {
                    if (e.defaultPrevented) return;
                    if (!(e.target instanceof Element) || null === u.current) return;
                    e.target === u.current && t.selection().set([]);
                  },
                  ref: h,
                },
                null !== g &&
                  o.createElement(T.Tree, {
                    key: d,
                    height: g.height,
                    width: g.width,
    ...
    715489: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { ObjectTree: () => ce, logger: () => ne });
      var o = n(650151),
        i = n(466052);
      var r = n(989348);
      function s(e, t) {
      ...
      class c {
        constructor(e) {
          (this._onChange = new i.Delegate()),
            (this._recalculate = () => {
              const e = this._groupModel.groups().map(e => s(e.id, e.instanceId())),
            ...
            for (const n of this._groupModel.groups()) {
              ...
              if (r.pane() === t) {
                const o = [...n.lineTools()]
                  ...
                  .map(e => s(e.id(), e.instanceId()));
                (e[r.id()] = d(r.id(), 1, t.id(), o)), e[t.id()].children.push(r.id());
      ...
      var h = n(509806),
        ...
        I = n(57674),
        k = n(562051);
      const j = new g.TranslatedString('show {title}', h.t(null, void 0, n(787358))),
        M = new g.TranslatedString('hide {title}', h.t(null, void 0, n(470301))),
        A = new g.TranslatedString('lock {title}', h.t(null, void 0, n(850193))),
        E = new g.TranslatedString('unlock {title}', h.t(null, void 0, n(192421))),
        L = new g.TranslatedString(
          'change {sourceTitle} title to {newSourceTitle}',
          h.t(null, void 0, n(328065)),
        ),
        N = new g.TranslatedString('insert source(s) after', h.t(null, void 0, n(8343))),
        O = !1;
      function z(e, t) {
        return t.every(t => !(t.pane() !== e && !t.allowsMovingbetweenPanes()));
      }
      function x(e) {
        return e instanceof m.DataSource && e.showInObjectTree() ? s(e.id(), e.instanceId()) : null;
      }
      function D(e) {
        return new g.TranslatedString(e.name(), e.title(k.TitleDisplayTarget.DataWindow));
      }
      const B = new i.Delegate();
      class G {
        constructor(e, t) {
        ...
        title() {
          ...
          return (0, _.isLineTool)(e)
            ...
            : (0, f.isSeries)(e) && this._undoModel.mainSeries() === e
            ? e.symbolTitle(
                k.TitleDisplayTarget.DataWindow,
                void 0,
                void 0,
                (0, p.onWidget)() ? 'exchange' : 'listed_exchange',
              )
            : e.title(k.TitleDisplayTarget.DataWindow);
        }
        gaLabel() {
          return (0, v.isStudy)(this._dataSource)
            ? 'Study'
            : (0, _.isLineTool)(this._dataSource)
            ? 'Drawing'
            : 'Symbol';
        ...
        canBeLocked() {
          return (0, _.isLineTool)(this._dataSource) && this._dataSource.userEditEnabled();
        }
        canBeRemoved() {
          return (
            this._undoModel.mainSeries() !== this._dataSource && this._dataSource.isUserDeletable()
          );
        }
        canBeHidden() {
        ...
        canBeRenamed() {
          return (0, _.isLineTool)(this._dataSource);
        }
        fullyConstructed() {
        ...
        isActualInterval() {
          return (
            (!(0, _.isLineTool)(this._dataSource) && !(0, v.isStudy)(this._dataSource)) ||
            this._dataSource.isActualInterval()
          );
        }
        onIsActualIntervalChange() {
          return (0, _.isLineTool)(this._dataSource) || (0, v.isStudy)(this._dataSource)
            ? this._dataSource.onIsActualIntervalChange()
            : B;
        }
        isLocked() {
          return (
            !!(0, _.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value()
          );
        }
        onVisibilityChanged() {
        ...
        getIcon() {
          const e = (0, b.getAllSourcesIcons)(),
            t = this._dataSource.getSourceIcon(),
            n = (0, v.isStudyStrategy)(this._dataSource);
          let o = { type: C.IconType.Svg, content: n ? w : y };
          if (e && t)
            if ('loadSvg' === t.type) {
              const [n, i] = t.svgId.split('.'),
                r = 'linetool' === n ? e.linetool[i] : e.series[Number(i)];
              o = { type: C.IconType.Svg, content: r || y };
            } else 'svgContent' === t.type && (o = { type: C.IconType.Svg, content: t.content });
          return o;
        }
        onIconChanged() {
        ...
        setVisible(e) {
          const t = (e ? j : M).format({ title: D(this._dataSource) });
          this._undoModel.setProperty(this._dataSource.properties().visible, e, t);
        }
        setLocked(e) {
          if ((0, _.isLineTool)(this._dataSource)) {
            const t = (e ? A : E).format({ title: D(this._dataSource) });
        ...
        setName(e) {
          if ((0, _.isLineTool)(this._dataSource)) {
            const t = L.format({
              sourceTitle: this._dataSource.properties().title.value() || D(this._dataSource),
              newSourceTitle: e,
            });
            this._undoModel.setProperty(this._dataSource.properties().title, e, t, O);
          }
        }
        isCopiable() {
        ...
        canBeAddedToGroup() {
          return (0, _.isLineTool)(this._dataSource) && this._dataSource.boundToSymbol();
        }
        ...
        canBeSyncedInLayout() {
          return (0, _.isLineTool)(this._dataSource) && this._dataSource.isSynchronizable();
        }
        onSyncStateChanged() {
        ...
        getDrawingSyncState() {
          return this.canBeSyncedInLayout()
            ? this.fullyConstructed() && null !== this._dataSource.linkKey().value()
              ? 1
              : 0
            : null;
        }
        doNotAffectChartInvalidation() {
          return (0, _.isLineTool)(this._dataSource) && O;
        }
        _canInsertBeforeOrAfter(e) {
          const t = this._undoModel.model();
          if (!z(this.pane(), e)) return !1;
          if ((0, _.isLineTool)(this._dataSource)) {
            if (
        ...
        _insertSources(e, t) {
          ...
          this._undoModel.beginUndoMacro(N);
          const r = () => {
          ...
          if ((0, _.isLineTool)(this._dataSource)) {
            ...
            null !== t
              ? ((0, o.assert)(!e.some(e => e.hasChildren())),
                s.forEach(e => {
                  (0, _.isLineTool)(e) && (t.containsLineTool(e) || i.addLineToolToGroup(t, e));
                }))
              : r();
          } else r();
      ...
      class V {
        constructor(e, t) {
          (this._onTitleChanged = new i.Delegate()),
            ...
            (this._paneId = (0, o.ensureNotNull)(e.model().paneForSource(this._lineTools[0])).id());
          const n = () => {
            this._lineTools.forEach(e => {
              e
                ...
                e
                  .onIsActualIntervalChange()
                  .subscribe(this, () => this._onIsActualIntervalChanged.fire()),
        ...
        getIcon() {
          return { type: C.IconType.Svg, content: I };
        }
        canBeRemoved() {
          return !0;
        }
      ...
      class H {
        ...
        invalidateCache(e) {
          Array.from(this._entitiesCache.keys()).forEach(t => {
            var n;
            e.has(t) ||
              (null === (n = this._entitiesCache.get(t)) || void 0 === n || n.destroy(),
        ...
        canBeGroupped(e) {
          ...
          if (
            ...
            t.some(e => !(0, _.isLineTool)(e) || !e.boundToSymbol()))
          )
            return !1;
          const n = this._undoModel.model(),
        ...
        contextMenuActions(e, t, n) {
          const o = new S.ActionsProvider(e, n),
            i = [];
      ...
      var P = n(888740),
        ...
        ee = n(535149),
        te = n(80465);
      const ne = (0, Z.getLogger)('Platform.GUI.ObjectTree');
      const oe = new g.TranslatedString('move objects', h.t(null, void 0, n(340566))),
        ie = new g.TranslatedString('lock objects', h.t(null, void 0, n(168163))),
        re = new g.TranslatedString('unlock objects', h.t(null, void 0, n(766824))),
        se = new g.TranslatedString('show objects', h.t(null, void 0, n(963549))),
        le = new g.TranslatedString('hide objects', h.t(null, void 0, n(928506))),
        ae = new g.TranslatedString('remove objects', h.t(null, void 0, n(857428)));
      class ce {
        constructor(e) {
          (this._nodes = {}),
            (this._onChange = new i.Delegate()),
            ...
            (this._isContextMenuOpened = new Y.WatchedValue(!1)),
            ...
            (this._init = () => {
              ...
              e.hasModel() &&
                ...
                (this._groupModel = this._model.lineToolsGroupModel()),
                (this._facade = new H(this._controller)),
                (this._subscriptions = [
            ...
            (this._ensuredEntity = e => (0, o.ensureNotNull)(this._getEntityById(e))),
            (this._chart = e),
            this._init();
        }
        destroy() {
        ...
        setIsLocked(e, t) {
          ...
          this._controller.withMacro(
            ...
            (0, R.trackObjectTreeEvent)('Lock', (0, R.getGaAction)(n));
        }
        setIsVisible(e, t) {
          const n = this._getObjectsToModify(e),
            o = n.every(e => e.doNotAffectChartInvalidation()),
          ...
          this._controller.withMacro(
            ...
            (0, R.trackObjectTreeEvent)('Hide', (0, R.getGaAction)(n));
        }
        remove(e) {
          const t = () => {
              ...
              this._controller.withMacro(
                ...
                (0, R.trackObjectTreeEvent)('Delete', (0, R.getGaAction)(n)),
                this._update();
            },
        ...
        createGroupFromSelection() {
          ...
          (0, R.trackObjectTreeEvent)('Create Group');
        ...
        openProperties(e, t) {
          ...
          this.selection().selected().length > 1 && this.selection().selected().includes(e.id())
            ...
            : (this.selection().set([e]),
              null !== n
                ? this._controller.mainSeries() === n
                  ...
                  : ((0, _.isLineTool)(n) || (0, v.isStudy)(n)) &&
        ...
        canSelectionBeUnmerged() {
          const e = this._getSelectedEntities();
          return 1 === e.length && this.canNodeWithIdBeUnmerged(l(e[0].id()).persistentId);
        }
        canNodeWithIdBeUnmerged(e) {
          const t = this._model.dataSourceForId(e);
          return (
            null !== t && (0, F.isPriceDataSource)(t) && this._model.isUnmergeAvailableForSource(t)
          );
        }
        unmergeSelectionUp() {
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map(e =>
              (0, o.ensureNotNull)(this._model.dataSourceForId(l(e.id()).persistentId)),
            );
          this._chart.value().chartWidgetCollection().clipboard.uiRequestCopy(t),
            (0, R.trackObjectTreeEvent)('Copy', (0, R.getGaAction)(e));
        }
        cloneSelection() {
          const e = this._getSelectedEntities(),
            t = e.map(e =>
          ...
          t.every(_.isLineTool) &&
            (this._controller.cloneLineTools([...t], !1),
            (0, R.trackObjectTreeEvent)('Clone', (0, R.getGaAction)(e)));
        }
        rename(e, t) {
          const n = this._getObjectsToModify(e.id());
          1 === n.length &&
            n.some(e => e.canBeRenamed()) &&
            (t(), (0, R.trackObjectTreeEvent)('Rename', (0, R.getGaAction)(n)));
        }
        async openContextMenu(e, t, n) {
          ...
          let r;
          if (this._objects.some(e => e.hasChildren())) r = this._getActionsForGroupItem(e, t, i);
          else {
            ...
            if (
              ((r = Array.from(e).filter(
                (e, t, n) => 'separator' !== e.type || !n[t + 1] || 'separator' !== n[t + 1].type,
              )),
          ...
          if (r.length > 0) {
            ...
            (c = s
              ...
              : {
                  menuName: 'ObjectTreeContextMenu',
                  detail: { type: 'study', id: (null == i ? void 0 : i.id()) || null },
                }),
              W.ContextMenuManager.showMenu(r, n, { takeFocus: !0, returnFocus: !0 }, c, () => {
        ...
        getNextNodeIdAfterRemove(e) {
          ...
          if (
            (null === (t = s.pane().mainDataSource()) || void 0 === t ? void 0 : t.id()) === i &&
          ...
          const a = (0, o.ensureDefined)(n.find(e => e.id === r.parentId)).children;
          return 1 === a.length
        ...
        _getRenameAction(e) {
          return new U.Action({
            ...
            onExecute: () => {
              e(),
                (0, R.trackObjectTreeEvent)(
                  'Context menu rename',
                  (0, R.getGaAction)(this._objects),
                );
            },
          });
        }
        _getActionsForGroupItem(e, t, n) {
          ...
          const i = [];
          1 === this._objects.length && i.unshift(this._getRenameAction(t), new U.Separator()),
            n && i.unshift(this._getGroupAction(), new U.Separator());
          const r = (0, S.createSyncDrawingActions)(this._chart.value(), o.filter(_.isLineTool));
          r.length && (r.shift(), r.push(new U.Separator()), i.push(...r));
          const s = this._chart.value().actions().format.getState();
          return (
            i.push(
              new U.Action({
                actionId: 'ObjectsTree.ToggleItemLocked',
                label: e.isLocked() ? P.unlockTitle : P.lockTitle,
                icon: e.isLocked() ? $ : q,
                onExecute: () => this.setIsLocked(e.id(), !e.isLocked()),
              }),
              new U.Action({
                actionId: 'ObjectsTree.ToggleItemVisibility',
                label: e.isVisible() ? P.hideTitle : P.showTitle,
                icon: e.isVisible() ? Q : J,
        ...
        _unmergeSelection(e) {
          ...
          const n = t[0],
            i = (0, o.ensureNotNull)(this._model.dataSourceForId(l(n.id()).persistentId));
          if (!(0, F.isPriceDataSource)(i)) throw new Error('Entity is not IPriceDataSource');
          (0 === e ? this._controller.unmergeSourceUp : this._controller.unmergeSourceDown).call(
            this._controller,
            i,
          );
          const r = 0 === e ? 'New pane above' : 'New pane below';
          (0, R.trackObjectTreeEvent)(r, (0, R.getGaAction)([n]));
        }
        _recalculateTree() {
        ...
        _normalizeTargetAndDropType(e, t) {
          ...
          return (
            'inside' === t &&
              ((t = 'before'),
              (n = (0, o.ensureNotNull)(this.entity([...n.childrenIds()].shift() || '')))),
            [n, t]
          );
        }
        _getSelectedEntities() {
          ...
          return (
            t.length &&
              ne.logWarn(
                `Detected dangling sources in selection. They will be ignored: ${JSON.stringify(
                  t,
                )}`,
              ),
            e
        ...
        const [e, t] = (0, o.useState)(null),
          n = (0, o.useCallback)(
            ([n]) => {
              ...
              (o.width === (null == e ? void 0 : e.width) && o.height === e.height) || t(o);
            },
            [e],
          );
        return [(0, i.useResizeObserver)(n), e];
      }
    },
    703011: (e, t, n) => {
      'use strict';
