(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6456, 959, 6437],
  {
    ...
    876797: e => {
      e.exports = { container: 'container-XOHpda28' };
    },
    395988: e => {
      e.exports = {
    ...
    805184: (e, t, n) => {
      ...
      function l(e) {
        const { intent: t, size: n, appearance: r, useFullWidth: i, icon: l, ...c } = e;
        return { ...c, color: a(t), size: s(n), variant: o(r), stretch: i, startIcon: l };
      }
      function c(e) {
        return r.createElement(i.SquareButton, { ...l(e) });
      }
    },
    171529: (e, t, n) => {
      'use strict';
      n.d(t, { SquareButton: () => f });
      var r = n(50959),
        i = n(497754),
        o = n(331774),
        a = n(72571),
      ...
      function c(e) {
        const {
          ...
          _ = (function (e) {
            ...
            return (
              0 !== e &&
                (1 & e && (t = i(t, l()['no-corner-top-left'])),
                2 & e && (t = i(t, l()['no-corner-top-right'])),
                4 & e && (t = i(t, l()['no-corner-bottom-right'])),
                8 & e && (t = i(t, l()['no-corner-bottom-left']))),
              t
            );
        ...
        return i(
          ...
          _,
          p && l().grouped,
          p && !m && l()['adjust-position'],
          p && f.isTop && l()['first-row'],
          p && f.isLeft && l()['first-col'],
          v && g && l()['multiline-content'],
          y && l().link,
        );
      }
      function u(e) {
        ...
        return r.createElement(
          r.Fragment,
          null,
          d && r.createElement(a.Icon, { icon: d, className: l()['start-icon-wrap'] }),
          o && r.createElement('span', { className: l().content }, o),
          s && !i && r.createElement(a.Icon, { icon: s, className: l()['end-icon-wrap'] }),
          h &&
            (function (e) {
              return (
                e.primaryText &&
      ...
      function p(e) {
        ...
        return { ...f, ...(0, h.filterDataProps)(e), ...(0, h.filterAriaProps)(e) };
      }
      function f(e) {
        const { reference: t, ...n } = e,
          ...
          } = (0, r.useContext)(d.ControlGroupContext),
          s = c({ ...n, isGrouped: i, cellState: o, disablePositionAdjustment: a });
        return r.createElement(
          'button',
    ...
    72571: (e, t, n) => {
      ...
      const i = r.forwardRef((e, t) => {
        const { icon: n = '', ...i } = e;
        return r.createElement('span', { ...i, ref: t, dangerouslySetInnerHTML: { __html: n } });
      });
    },
    800417: (e, t, n) => {
      'use strict';
      ...
      function l(e) {
        ...
        if (e && 1 == ++a) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (t.style.paddingRight = `${i + (0, r.getScrollbarWidth)()}px`),
            (s = !0)),
            t.classList.add('i-no-scroll');
        } else if (!e && a > 0 && 0 == --a && (t.classList.remove('i-no-scroll'), s)) {
          (0, r.setStyle)(n, 'right', '0px');
          let e = 0;
          (e = n
            ? ((l = (0, r.getContentWidth)(n)), i() ? 0 : o() ? 45 : Math.min(Math.max(l, 45), 450))
            : 0),
    ...
    533408: (e, t, n) => {
      ...
      function E(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            'div',
            { className: s()(C.container, h, (i || p) && C.unsetAlign) },
            c,
            r.createElement(
              'div',
              { 'data-dragg-area': d, className: C.title },
              r.createElement('div', { className: s()(n ? C.textWrap : C.ellipsis) }, t),
              i && r.createElement('div', { className: s()(C.ellipsis, C.subtitle) }, i),
            ),
            u,
            o &&
              !v &&
      ...
      class P extends r.PureComponent {
        constructor() {
          super(...arguments),
              ...
              if (!e.defaultPrevented) {
                if (
                  ...
                  const { activeElement: n } = document,
                    r = (0, i.ensureNotNull)(this._reference);
                  if (null !== n) {
                    if (
                      (e.preventDefault(),
            ...
            (this._calculatePositionWithOffsets = (e, t) => {
              const n = (0, i.ensureDefined)(this.props.fullScreenViewOffsets).value();
              return {
                top: n.top,
        ...
        componentDidMount() {
          this.props.ignoreClosePopupsAndDialog ||
            g.subscribe(v.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          this.props.ignoreClosePopupsAndDialog ||
            g.unsubscribe(v.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
        ...
        render() {
          const {
            ...
            K = 'after' !== u ? v : void 0,
            V = 'after' === u ? v : void 0,
            G = 'string' == typeof o ? o : z || '',
            $ = (0, k.filterDataProps)(this.props),
            Y = (0, w.mergeRefs)([this._handleReference, W]);
          return r.createElement(f.MatchMedia, { rule: p.DialogBreakpoints.SmallHeight }, u =>
            r.createElement(f.MatchMedia, { rule: p.DialogBreakpoints.TabletSmall }, p =>
              r.createElement(
                d.PopupDialog,
                {
                  rounded: !(p || I) && R,
                  className: s()(x.dialog, I && U && x.bounded, e),
                  isOpened: i,
                  reference: Y,
                  ...
                  containerAriaLabel: F,
                  containerTabIndex: j,
                  calculateDialogPosition: I && U ? this._calculatePositionWithOffsets : void 0,
                  shadowed: Z,
                  ...$,
                },
                r.createElement(
                  'div',
                  { className: s()(x.wrapper, t), 'data-name': l, 'data-dialog-name': G },
                  void 0 !== o &&
                    r.createElement(E, {
                      draggable: P && !(p || I),
                  ...
                  b && r.createElement(h.Separator, { className: x.separator }),
                  r.createElement(m.PopupContext.Consumer, null, e =>
                    this._renderChildren(e, p || I),
                  ),
                ),
              ),
            ),
      ...
      function u(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            i || r.createElement(d, { ...m }),
          ),
          t,
          r.createElement(s.Icon, { className: o()(c.icon, f), icon: l }),
          u &&
            r.createElement(
              'div',
              { className: c.cancel, onClick: u },
              a.t(null, void 0, n(620036)),
            ),
        );
      }
      function d(e) {
    ...
    104502: (e, t, n) => {
      'use strict';
      n.d(t, {
        DialogSidebarContainer: () => u,
        DialogSidebarItem: () => h,
        DialogSidebarWrapper: () => d,
      });
      var r = n(50959),
        i = n(497754),
        o = n.n(i),
      ...
      function u(e) {
        const { mode: t, className: n, ...i } = e,
          { isMobile: a, isTablet: l } = s(t),
          u = o()(c.container, l && c.isTablet, a && c.isMobile, n);
        return r.createElement('div', { ...i, className: u, 'data-role': 'dialog-sidebar' });
      }
      function d(e) {
        return r.createElement('div', { className: c.wrapper, ...e });
      }
      function h(e) {
        const { mode: t, title: n, icon: i, isActive: u, onClick: d, ...h } = e,
          { isMobile: p, isTablet: f } = s(t),
          m = u ? (null == i ? void 0 : i.active) : null == i ? void 0 : i.default;
        return r.createElement(
          'div',
          {
            ...h,
            className: o()(c.tab, f && c.isTablet, p && c.isMobile, u && c.active),
            onClick: d,
          },
          i && r.createElement(a.Icon, { className: c.icon, icon: m }),
          !f &&
            r.createElement(
              'span',
              { className: o()(c.title, !i && c.withoutIcon) },
              r.createElement('span', { className: c.titleText }, n),
              p && r.createElement(a.Icon, { className: c.nested, icon: l }),
            ),
        );
      }
    },
    570839: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { IndicatorsLibraryContainer: () => ce });
      var r = n(50959),
        i = n(500962),
        o = n(509806),
        a = n(683471);
      const s = o.t(null, void 0, n(144463));
      var l = n(597399),
        c = n(156963),
        u = n(919577);
      function d(e, t) {
      ...
      function f(e, t) {
        return (null == t ? void 0 : t.isChartPattern)
          ? 'tv-chart_patterns'
          : (null == t ? void 0 : t.isAuto)
          ? 'auto-java'
          : l.StudyMetaInfo.getPackageName(e);
      }
      var m = n(497754),
        v = n.n(m),
        g = n(665276),
      ...
      function x(e) {
        ...
        return r.createElement('span', { className: v()(k.title, i && k.disabled, n) }, t);
      }
      ...
      function L(e) {
        ...
        const i = (0, r.useContext)(S),
          ...
          { isFavorite: E, isLocked: w, public: k, editorsPick: B } = l,
          L = void 0 !== E,
          M = A(y, l),
          z = (0, r.useCallback)(e => e.stopPropagation(), []),
          O =
            null !== (t = e.favoriteClickHandler) && void 0 !== t
              ? t
              : (null == i ? void 0 : i.toggleFavorite)
              ? A(i.toggleFavorite, l)
              : void 0,
          F =
            (0, P.useWatchedValueReadonly)({ watchedValue: I.watchedTheme }) === D.StdTheme.Dark
              ? T.dark
              : T.light,
          W = v()(
            T.container,
            l.isGrayed && T.disabled,
            f && T.selected,
            m && T.highlighted,
            m && F,
          );
        return r.createElement(
          ...
          r.createElement(
            ...
            L &&
              r.createElement(R.FavoriteButton, {
            ...
            r.createElement(
              x,
              { disabled: l.isGrayed },
              r.createElement(N.HighlightedText, { queryString: c, rules: u, text: l.title }),
            ),
            !1,
            d && r.createElement(BadgeIndicator, { type: 'beta', className: T.badge }),
            h && r.createElement(BadgeIndicator, { type: 'new', className: T.badge }),
            p && r.createElement(BadgeIndicator, { type: 'updated', className: T.badge }),
            B &&
              r.createElement(BadgeIndicator, {
                type: 'ep',
                className: T.badge,
                tooltip: o.t(null, void 0, n(192490)),
              }),
            !1,
          ),
          k &&
            r.createElement(
              'a',
              { href: k.authorLink, className: T.author, target: '_blank', onClick: z },
              k.authorName,
            ),
          'mobile' !== s && k && r.createElement('span', { className: T.likes }, k.likesCount),
          !1,
        );
      }
      function A(e, t) {
        return n => {
          const r = 0 === (0, B.modifiersFromEvent)(n) && 0 === n.button;
      ...
      function F(e) {
        ...
        return r.createElement('div', { style: t, className: O.container }, n);
      }
      var W = n(72571),
        j = n(805184),
        H = n(770722);
      function q(e) {
        ...
        return r.createElement(
          ...
          n && r.createElement(W.Icon, { icon: n, className: H.image }),
          i && r.createElement('h3', { className: H.title }, i),
          o && r.createElement('p', { className: H.description }, o),
          a && s && r.createElement(j.Button, { onClick: s, className: H.button }, a),
        );
      }
      function Z(e) {
      ...
      function ne() {
        var e, t;
        J = [];
        const n = Boolean(void 0 === (0, G.getValue)('chart.favoriteLibraryIndicators')),
          r = (0, G.getJSON)('chart.favoriteLibraryIndicators', []);
        if ((J.push(...r), 0 === J.length && n && 'undefined' != typeof window)) {
          const n = JSON.parse(
            null !== (t = null === (e = window.urlParams) || void 0 === e ? void 0 : e.favorites) &&
              void 0 !== t
              ? t
              : '{}',
          ).indicators;
          n && Array.isArray(n) && J.push(...n);
        }
        Q.fire();
      }
      function re() {
      ...
      function ie(e) {
        const {
          ...
          [u, d] = (0, r.useState)(''),
          p = (0, r.useMemo)(() => (0, U.createRegExpList)(u, h), [u]),
          f = (0, r.useMemo)(
            () =>
              u
                ? (0, U.rankedSearch)({
            ...
            return (
              ...
              ),
              {
                ...
                handleKeyDown: function (e) {
                  ...
                  if (
                    (40 === (0, B.hashFromEvent)(e) && (e.preventDefault(), h(), m(r)),
                    38 === (0, B.hashFromEvent)(e) && (e.preventDefault(), p(), m(t)),
                    13 === (0, B.hashFromEvent)(e) && u)
                  ) {
                    if (!n) return;
                    n(u), s(u);
                  }
        ...
        return (
          (0, r.useEffect)(() => {
            var e;
            a || d(''),
              _.CheckMobile.any() || null === (e = S.current) || void 0 === e || e.focus();
          }, [a]),
          r.createElement(y.AdaptivePopupDialog, {
            isOpened: a,
            onClose: s,
            onClickOutside: s,
            ...
            render: function () {
              return r.createElement(
                r.Fragment,
                null,
                r.createElement(b.DialogSearch, {
                  reference: S,
                  placeholder: o.t(null, void 0, n(252298)),
                  onChange: D,
                  onFocus: R,
                }),
                r.createElement(
                  C.DialogSidebarWrapper,
                  null,
                  r.createElement(
                    w,
                    { reference: x, className: K.scroll },
                    I
                      ...
                      ? r.createElement(
                          ...
                          r.createElement(
                            F,
                            null,
                            r.createElement(z, { title: o.t(null, void 0, n(515491)) }),
                          ),
                          f
                            .slice()
                            .sort(oe)
                            .map(e => {
                              const t = (null == E ? void 0 : E.id) === e.id;
                      ...
                      : r.createElement(q, {
                          ...
                          description: o.t(null, void 0, n(353170)),
                        }),
                  ),
                ),
              );
            },
            title: o.t(null, void 0, n(561142)),
      ...
      class ce extends class {
        constructor(e) {
          (this._searchInputRef = r.createRef()),
            (this._dialog = r.createRef()),
            (this._visibility = new se.WatchedValue(!1)),
        ...
        _applyStudy(e, t) {
          var n;
          e.isGrayed
            ? ae.emit('onGrayedObjectClicked', { type: 'study', name: e.shortDescription })
            : (_.CheckMobile.any() ||
                null === (n = this._searchInputRef.current) ||
                void 0 === n ||
                n.select(),
              (async function (e, t, n, r, i) {
                ...
                const l = s.descriptor;
                if ('java' === l.type) {
                  const e = (0, u.tryFindStudyLineToolNameByStudyId)(l.studyId);
                  if (null !== e) return a.tool.setValue(e), null;
                }
                return o.insertStudy(s.descriptor, n, t.shortDescription);
              })(this._chartWidgetCollection, e, this._parentSources, 0, this._symbol).then(() => {
                var e;
        ...
        _focus() {
          ...
          this._getProps().value().isOpened &&
            (null === (e = this._dialog.current) || void 0 === e || e.focus());
        }
        _getContainer() {
        ...
        constructor(e, t) {
          super(e),
            ...
            (this._indicatorData = []),
            t && (this._options = t),
            (this._props = new se.WatchedValue({
              data: [],
        ...
        async _init() {
          const e = (function (e) {
            ...
            })((await this._requestBuiltInJavaStudies()).map(p)),
          );
          (this._indicatorData = await (async function (e, t) {
            let n = { ...t };
            return [
              ...le(n, 'tv-basicstudies'),
              ...le(n, 'Script$STD'),
              ...le(n, 'tv-volumebyprice'),
            ]
            ...
            $.subscribe(null, () => this._refreshFavorites()),
            Y.subscribe(null, () => this._refreshFavorites());
        }
        _setFavorites() {
          c.enabled('items_favoriting') &&
        ...
        _render() {
          ...
          i.render(r.createElement(ie, { ...e }), t);
        }
      }
    },
    577687: (e, t, n) => {
      ...
      var r = n(509806),
        ...
        l = n(648010),
        c = n(214877);
      const u = { add: r.t(null, void 0, n(44629)), remove: r.t(null, void 0, n(572482)) };
      function d(e) {
    ...
    512991: (e, t, n) => {
      'use strict';
      n.d(t, { createRegExpList: () => o, getHighlightedChars: () => a, rankedSearch: () => i });
      var r = n(372605);
      function i(e) {
        const {
          data: t,
          ...
          .map(e => {
            ...
            return (
              n.forEach(e => {
                ...
                if (
                  ((p.lastIndex = 0),
                  (0, r.isString)(t) && t && t.toLowerCase() === i.toLowerCase())
                )
                  return (
                    (h = 4), void (d = null === (n = t.match(f)) || void 0 === n ? void 0 : n.index)
                  );
                if ((0, r.isString)(t) && f.test(t))
                  return (
                    (h = 3), void (d = null === (a = t.match(f)) || void 0 === a ? void 0 : a.index)
                  );
                if ((0, r.isString)(o) && f.test(o))
                  return (
                    (h = 2), void (d = null === (s = o.match(f)) || void 0 === s ? void 0 : s.index)
                  );
                if ((0, r.isString)(o) && p.test(o))
                  return (
                    (h = 2), void (d = null === (l = o.match(p)) || void 0 === l ? void 0 : l.index)
                  );
                if (Array.isArray(u))
                  for (const e of u)
                    if (f.test(e))
                      return (
                        (h = 1),
                        void (d = null === (c = e.match(f)) || void 0 === c ? void 0 : c.index)
                      );
              }),
              { matchPriority: h, matchIndex: d, item: e }
            );
          })
          .filter(e => o || e.matchPriority)
          .sort((e, t) => {
      ...
      function a(e, t, n) {
        ...
        return e && n
          ? (n.forEach(e => {
              const { fullMatch: n, re: i, reserveRe: o } = e;
    ...
    260598: (e, t, n) => {
      ...
      function s(e) {
        const { queryString: t, rules: n, text: s, className: l } = e,
          c = (0, r.useMemo)(() => (0, o.getHighlightedChars)(t, s, n), [t, n, s]);
        return r.createElement(
          r.Fragment,
          null,
          c.length
            ? s
                ...
                .map((e, t) =>
                  r.createElement(
                    ...
                    { key: t },
                    c[t]
                      ? r.createElement('span', { className: i(a.highlighted, l) }, e)
    ...
    494707: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        o = n(345719);
      function a(e) {
        return r.createElement('div', { className: i(o.separator, e.className) });
      }
    },
    8361: (e, t, n) => {
      'use strict';
      ...
      class l extends r.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            i.createPortal(r.createElement(c.Provider, { value: this }, this.props.children), e)
          );
        }
        moveToTop() {
    ...
    695257: (e, t) => {
      ...
      function x(e, t, r) {
        ...
        return { $$typeof: n, type: e, key: a, ref: s, props: o, _owner: w.current };
      }
      function S(e) {
      ...
      var B = { current: null },
        T = { transition: null },
        L = { ReactCurrentDispatcher: B, ReactCurrentBatchConfig: T, ReactCurrentOwner: w };
      (t.Children = {
        map: D,
    ...
    660538: (e, t, n) => {
      'use strict';
      n.d(t, { mediaQueryAddEventListener: () => r, mediaQueryRemoveEventListener: () => i });
      const r = (e, t) => {
