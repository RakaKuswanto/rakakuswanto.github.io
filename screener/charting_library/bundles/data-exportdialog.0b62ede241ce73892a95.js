(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2985],
  {
    ...
    805184: (e, t, n) => {
      ...
      function l(e) {
        const { intent: t, size: n, appearance: o, useFullWidth: r, icon: l, ...c } = e;
        return { ...c, color: a(t), size: s(n), variant: i(o), stretch: r, startIcon: l };
      }
      function c(e) {
        return o.createElement(r.SquareButton, { ...l(e) });
      }
    },
    171529: (e, t, n) => {
      'use strict';
      ...
      function c(e) {
        const {
          ...
          })((0, i.getGroupCellRemoveRoundBorders)(m));
        return r(
          h,
          l().button,
          l()[`size-${n}`],
          ...
          l()[`variant-${o}`],
          a && l().stretch,
          (s || c) && l()['with-start-icon'],
          u && l()['with-end-icon'],
          d && l()['icon-only'],
          v,
          p && l().grouped,
          p && !f && l()['adjust-position'],
          p && m.isTop && l()['first-row'],
          p && m.isLeft && l()['first-col'],
          b && g && l()['multiline-content'],
          C && l().link,
        );
      }
      function u(e) {
        ...
        return o.createElement(
          o.Fragment,
          null,
          d && o.createElement(a.Icon, { icon: d, className: l()['start-icon-wrap'] }),
          i && o.createElement('span', { className: l().content }, i),
          s && !r && o.createElement(a.Icon, { icon: s, className: l()['end-icon-wrap'] }),
          h &&
            (function (e) {
              return (
                e.primaryText &&
      ...
      function m(e) {
        const { reference: t, ...n } = e,
          ...
          s = c({ ...n, isGrouped: r, cellState: i, disablePositionAdjustment: a });
        return o.createElement(
          'button',
          { ...p(n), className: s, ref: t },
          o.createElement(u, { ...n }),
        );
      }
    },
    ...
    34735: (e, t, n) => {
      'use strict';
      n.d(t, { ControlSkeleton: () => C, InputClasses: () => f });
      var o = n(50959),
        r = n(497754),
        i = n(650151),
        a = n(525388),
      ...
      function p(e, t, n, o) {
        const {
          ...
          v = h(null != i ? i : (0, c.getGroupCellRemoveRoundBorders)(n));
        return r(
          d().container,
          d()[`container-${u}`],
          d()[`intent-${s}`],
      ...
      function m(e, t, n) {
        ...
        const a = h(null != i ? i : (0, c.getGroupCellRemoveRoundBorders)(t));
        return r(d().highlight, d().shown, d()[`size-${n}`], a);
      }
      const f = {
      ...
      function g(e, t) {
        const {
            ...
            endSlot: S,
            onWheel: E,
            onWheelNoPassive: D = null,
            size: N,
          } = e,
          {
            isGrouped: R,
            cellState: k,
            disablePositionAdjustment: B = !1,
          } = (0, o.useContext)(l.ControlGroupContext),
          P = (function (e, t = null, n) {
            ...
            return (0, o.useEffect)(() => ((i.current = [e, t, n]), a(), s), [e, t, n]), l;
          })('wheel', D, b);
        return o.createElement(
          'span',
          {
          ...
          y,
          S,
          o.createElement('span', { className: m(e, k, N) }),
        );
      }
      g.displayName = 'ControlSkeleton';
      const C = o.forwardRef(g);
    },
    102691: (e, t, n) => {
      'use strict';
      n.d(t, {
      ...
      function s(e) {
        ...
        return o.createElement('span', { className: r(a()['before-slot'], t) }, n);
      }
      function l(e) {
        const { className: t, interactive: n = !0, icon: i = !1, children: s } = e;
        return o.createElement(
          'span',
          { className: r(a()['inner-slot'], n && a().interactive, i && a().icon, t) },
          s,
        );
      }
      function c(e) {
      ...
      function d(e) {
        const { className: t, children: n } = e;
        return o.createElement('span', { className: r(a()['after-slot'], t) }, n);
      }
    },
    865968: (e, t, n) => {
      'use strict';
    ...
    942544: (e, t, n) => {
      ...
      function r(e) {
        const { intent: t, highlight: n, ...r } = e,
          { isFocused: i, ...a } = (0, o.useDisclosure)(r);
        return {
          ...a,
          isFocused: i,
          highlight: null != n ? n : i,
          intent: null != t ? t : i ? 'primary' : 'default',
        };
      }
    },
    772069: (e, t, n) => {
      ...
      function c(e) {
        const {
          ...
          [b, g] = (0, a.useFocus)(),
          C = b || m,
          v = (null != n ? n : void 0 !== t) ? (0, l.createDomId)(t, 'listbox') : void 0,
          x = (0, o.useRef)(null),
          w = (0, o.useCallback)(
            e => {
              var t;
              return null === (t = x.current) || void 0 === t ? void 0 : t.focus(e);
            },
            [x],
          ),
          y = (0, o.useRef)(null),
          S = (0, o.useCallback)(() => (0, r.ensureNotNull)(y.current).focus(), [y]),
          E = (0, o.useCallback)(() => f(!0), [f]),
          D = (0, o.useCallback)(
            (e = !1, t = !1) => {
              f(!1);
              const { activeElement: n } = document;
              (n && (0, i.isTextEditingField)(n)) || t || w({ preventScroll: e });
            },
            [f, w],
          ),
          N = (0, o.useCallback)(() => {
          ...
          k = c ? [] : [h, g.onBlur],
          B = c ? [] : [p, N],
          P = (0, s.createSafeMulticastEventHandler)(...R),
          _ = (0, s.createSafeMulticastEventHandler)(...k),
          O = (0, s.createSafeMulticastEventHandler)(...B);
        return {
          listboxId: v,
          isOpened: m,
          isFocused: C,
          ...
          toggle: N,
          onOpen: S,
          buttonFocusBindings: { onFocus: P, onBlur: _ },
          onButtonClick: O,
          buttonRef: x,
          listboxRef: y,
          buttonAria: { 'aria-controls': m ? v : void 0, 'aria-expanded': m, 'aria-disabled': c },
        };
      }
    },
    383836: (e, t, n) => {
    ...
    648621: (e, t, n) => {
      ...
      function a(e, t, n, a, s, l = {}, c) {
        const u = (0, o.useCallback)(
          ...
          { next: f = m.next, previous: b = m.previous, first: g = m.first, last: C = m.last } = l;
        return (0, r.useComposedKeyboardActionHandlers)(
          (0, r.useKeyboardActionHandler)(f, u),
          (0, r.useKeyboardActionHandler)(b, d),
          (0, r.useKeyboardActionHandler)(g, h),
          (0, r.useKeyboardActionHandler)(C, p),
        );
      }
    },
    930617: (e, t, n) => {
      ...
      var o = n(50959),
        r = n(650151),
        i = n(549423);
      const a = { duration: 200, additionalScroll: 0 },
        s = {
          vertical: {
      ...
      function c(e, t, n, o, r, a) {
        ...
        return (function (e) {
          ...
          (c = null != c ? c : a.getBoundingClientRect()),
          ...
          return (
            (f = window.requestAnimationFrame(function e(t) {
              let i;
              if ((m ? (i = t - m) : ((i = 0), (m = t)), i >= n))
                return (s[h] = p + d), void (r && r());
              const a = p + d * o(i / n);
              (s[h] = Math.floor(a)), (f = window.requestAnimationFrame(e));
            })),
            function () {
        ...
        scrollTo(e, t = a) {
          if (
            ...
            !(function (e, t) {
              ...
              return (
                n.top >= o.top && n.bottom <= o.bottom && n.left >= o.left && n.right <= o.right
              );
            })(e, this._container)
          ) {
            const n = e.getBoundingClientRect(),
      ...
      function d(e = {}) {
        const { activeItem: t, getKey: n, ...i } = e,
          ...
          c = (0, o.useCallback)(() => {
            null !== l.current &&
              null !== a.current &&
              l.current.getContainer() !== a.current &&
              l.current.setContainer(a.current);
          }, [l, a]),
          d = (0, o.useCallback)(
            e => {
              a.current = e;
          ...
          p = (0, o.useCallback)(
            (e, t) => {
              ...
              const o = n ? n(e) : e,
                i = s.current.get(o);
              i && (c(), (0, r.ensureNotNull)(l.current).scrollTo(i, t));
            },
            [s, l, n],
          );
        return (0, o.useEffect)(() => p(t, i), [p, t]), [d, h, p];
      }
    },
    525388: (e, t, n) => {
      'use strict';
      ...
      class c extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            'span',
            { className: i(l().loader, o && l().static, this._getStateClass(), e) },
    ...
    414823: (e, t, n) => {
      ...
      function l(...e) {
        const t = e.map(i).filter(r).filter(a).map(s);
        return (t.length > 0 && t[0].startsWith('id_') ? t : ['id', ...t]).join('_');
      }
      function c(...e) {
        return e.map(i).filter(r).filter(a).join(' ');
      }
    },
    269842: (e, t, n) => {
      'use strict';
    ...
    533408: (e, t, n) => {
      ...
      function y(e) {
        ...
        return o.createElement(
          ...
          { value: { setHideClose: g } },
          o.createElement(
            'div',
            { className: s()(w.container, h, (r || p) && w.unsetAlign) },
            c,
            o.createElement(
              'div',
              { 'data-dragg-area': d, className: w.title },
              o.createElement('div', { className: s()(n ? w.textWrap : w.ellipsis) }, t),
              r && o.createElement('div', { className: s()(w.ellipsis, w.subtitle) }, r),
            ),
            u,
            i &&
              !b &&
      ...
      class k extends o.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._handleKeyDown = e => {
              if (!e.defaultPrevented) {
                if (
                  ...
                  const { activeElement: n } = document,
                    o = (0, r.ensureNotNull)(this._reference);
                  if (null !== n) {
                    if (
                      (e.preventDefault(),
                    ...
                    if ((0, u.isTextEditingField)(n)) return void o.focus();
                    if (o.contains(n))
                      return (
                        this.props.onKeyboardClose && this.props.onKeyboardClose(),
                        void this._handleClose()
                ...
                (function (e) {
                  ...
                  ((n = e),
                  [9, l.Modifiers.Shift + 9].includes((0, l.hashFromEvent)(n)) &&
                    n.stopPropagation());
              }
            }),
            (this._requestResize = () => {
            ...
            (this._calculatePositionWithOffsets = (e, t) => {
              const n = (0, r.ensureDefined)(this.props.fullScreenViewOffsets).value();
              return {
                top: n.top,
        ...
        componentDidMount() {
          this.props.ignoreClosePopupsAndDialog ||
            g.subscribe(b.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
              ((this._orientationMediaQuery = window.matchMedia('(orientation: portrait)')),
              (0, i.mediaQueryAddEventListener)(this._orientationMediaQuery, this._handleOpen)),
        ...
        componentWillUnmount() {
          this.props.ignoreClosePopupsAndDialog ||
            g.unsubscribe(b.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            null !== this._orientationMediaQuery &&
              (0, i.mediaQueryRemoveEventListener)(this._orientationMediaQuery, this._handleOpen),
            this.props.fullScreenViewOffsets &&
              this.props.fullScreen &&
        ...
        render() {
          const {
            ...
            U = 'after' !== u ? b : void 0,
            q = 'after' === u ? b : void 0,
            G = 'string' == typeof i ? i : L || '',
            Q = (0, E.filterDataProps)(this.props),
            $ = (0, S.mergeRefs)([this._handleReference, M]);
          return o.createElement(m.MatchMedia, { rule: p.DialogBreakpoints.SmallHeight }, u =>
            o.createElement(m.MatchMedia, { rule: p.DialogBreakpoints.TabletSmall }, p =>
              o.createElement(
                d.PopupDialog,
                {
                  rounded: !(p || B) && _,
                  className: s()(D.dialog, B && j && D.bounded, e),
                  isOpened: r,
                  reference: $,
                  onKeyDown: this._handleKeyDown,
                  onClickOutside: c,
                  ...
                  containerAriaLabel: Z,
                  containerTabIndex: K,
                  calculateDialogPosition: B && j ? this._calculatePositionWithOffsets : void 0,
                  shadowed: H,
                  ...Q,
                },
                o.createElement(
                  'div',
                  { className: s()(D.wrapper, t), 'data-name': l, 'data-dialog-name': G },
                  void 0 !== i &&
                    o.createElement(y, {
                      draggable: k && !(p || B),
                  ...
                  x && o.createElement(h.Separator, { className: D.separator }),
                  o.createElement(f.PopupContext.Consumer, null, e =>
      ...
      const h = o.forwardRef((e, t) => {
        const {
          ...
          I =
            ...
            o.createElement(
              l.EndSlot,
              null,
              o.createElement(u.Caret, { isDropped: C, disabled: g, className: _ }),
            );
        return o.createElement(c.PopupMenuDisclosureView, {
          ...
          button: o.createElement(s.ControlSkeleton, {
            ...
            'data-role': 'listbox',
            disabled: g,
            className: i()(d.button, r),
            size: S,
            ref: (0, a.useMergedRefs)([A, t]),
            middleSlot: o.createElement(
              l.MiddleSlot,
              null,
              o.createElement(
                'span',
                { className: i()(d['button-children'], m && d.hiddenArrow) },
                B,
              ),
            ),
            endSlot: I,
    ...
    904925: (e, t, n) => {
      ...
      function s(e, t, n) {
        return (0, o.useCallback)(
          () =>
            (function (e, t, { x: n = a.x, y: o = a.y } = a) {
      ...
      function u(e) {
        const {
            ...
            popupPositionCorrection: S = { x: 0, y: 0 },
            popupPosition: E,
          } = e,
          D = s(i, d, S),
          N = y ? c : 0;
    ...
    364228: (e, t, n) => {
      ...
      function c(e) {
        const { isDropped: t } = e;
        return o.createElement(a.Icon, { className: i()(l.icon, t && l.dropped), icon: s });
      }
      function u(e) {
        const { className: t, disabled: n, isDropped: r } = e;
        return o.createElement(
          'span',
          { className: i()(l.button, n && l.disabled, t) },
          o.createElement(c, { isDropped: r }),
        );
      }
      function d(e) {
        const { className: t, tabIndex: n = -1, disabled: r, isDropped: a, ...s } = e;
        return o.createElement(
          'button',
          {
            ...s,
            ...
            tabIndex: n,
            disabled: r,
            className: i()(l.button, r && l.disabled, t),
          },
          o.createElement(c, { isDropped: a }),
        );
      }
    },
    529631: (e, t, n) => {
      ...
      function C(e) {
        var t, n;
        const { selectedItem: r, placeholder: i } = e;
        if (!r) return o.createElement('span', { className: f.placeholder }, i);
        const a =
          null !== (n = null !== (t = r.selectedContent) && void 0 !== t ? t : r.content) &&
          void 0 !== n
            ? n
            : r.value;
      ...
      const v = o.forwardRef((e, t) => {
        ...
        let { items: Z } = e;
        if (D && N) {
          Z = [{ value: void 0, content: D, id: (0, r.createDomId)(n, 'placeholder') }, ...Z];
        }
        const {
            listboxId: M,
            isOpened: K,
          ...
          ne = Z.filter(b),
          oe = ne.find(e => e.value === R),
          [re, ie, ae] = (0, a.useKeepActiveItemIntoView)({ activeItem: oe }),
          se = (0, r.joinDomIds)(k, n),
          le = se.length > 0 ? se : void 0,
          ce = (0, o.useMemo)(
            () => ({ role: 'listbox', 'aria-labelledby': k, 'aria-activedescendant': g(n, oe) }),
            [k, oe],
          ),
          ue = (0, o.useCallback)(e => e.value === R, [R]),
          de = (0, o.useCallback)(e => O && O(e.value), [O]),
          he = (0, u.useItemsKeyboardNavigation)(m.isRtl, ne, ue, de, !1, {
            next: [40],
            previous: [38],
          }),
          pe = (0, d.useKeyboardToggle)($, K || I),
          me = (0, d.useKeyboardClose)(K, Q),
          fe = (0, d.useKeyboardOpen)(K, q),
          be = (0, d.useKeyboardEventHandler)([pe, me, fe]),
          ge = (0, d.useKeyboardEventHandler)([he, pe, me]),
          Ce = (function (e) {
            const t = (0, o.useRef)(''),
              n = (0, o.useMemo)(
                () =>
              ...
              return e.find(e => {
                ...
                return (
                  ...
                  (n
                    ...
                    : !e.readonly &&
                      (('string' == typeof e.content && e.content.toLowerCase().startsWith(r)) ||
            ...
            void 0 !== o && O && (n.stopPropagation(), K || q(), O(o.value));
          });
        return o.createElement(
          h.ControlDisclosureView,
          {
            ...
            onListboxKeyDown: function (e) {
              ge(e), e.defaultPrevented || Ce(e);
            },
            buttonChildren: o.createElement(C, { selectedItem: oe, placeholder: D }),
            repositionOnScroll: A,
          },
          Z.map((e, t) => {
            var r;
            if (e.readonly)
    ...
    494707: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        i = n(345719);
      function a(e) {
        return o.createElement('div', { className: r(i.separator, e.className) });
      }
    },
    678469: e => {
      e.exports = { body: 'body-pdhUiHjR', text: 'text-pdhUiHjR', exporting: 'exporting-pdhUiHjR' };
    },
    432177: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { ExportDataDialogImpl: () => m });
      var o = n(50959),
        r = n(509806),
        i = n(234404),
        a = n(6835),
        ...
        c = n(529631),
        u = n(678469);
      const d = (0, a.getLogger)('Trading.ExportData'),
        h = 'Export Trading Data';
      function p(e) {
        const { isExporting: t } = e;
        return o.createElement(
          'span',
          { className: t ? u.exporting : void 0 },
          r.t(null, void 0, n(912191)),
          t && o.createElement(i.Loader, null),
        );
      }
      function m(e) {
        const { isOpened: t, onClose: i, dataExportController: a, trackEvent: m } = e,
          f = a.tabs();
        (0, o.useEffect)(() => {
          t && (null == m || m(h, 'Open dialog'));
        }, [t]);
        const [b, g] = (0, o.useState)(!1),
          [C, v] = (0, o.useState)(f[0].value);
        return o.createElement(l.AdaptiveConfirmDialog, {
          title: r.t(null, void 0, n(125769)),
          isOpened: t,
          onClose: function () {
            g(!1), null == m || m(h, 'Close dialog'), i();
          },
          showSeparator: !0,
          render: function () {
            return o.createElement(
              'div',
              { className: u.body },
              o.createElement('p', { className: u.text }, r.t(null, void 0, n(841214))),
              o.createElement(c.Select, {
          ...
          dataName: 'data-export-dialog',
          onCancel: () => {},
          onSubmit: async function () {
            g(!0), null == m || m(h, `Export ${C}`);
            try {
              await a.exportData(C);
            } catch (e) {
              d.logError((0, s.getLoggerMessage)(e));
            }
            g(!1);
          },
          submitButtonText: o.createElement(p, { isExporting: b }),
    ...
    660538: (e, t, n) => {
      'use strict';
      n.d(t, { mediaQueryAddEventListener: () => o, mediaQueryRemoveEventListener: () => r });
      const o = (e, t) => {
    ...
    841214: e => {
      e.exports = {
        ar: [
          'حدد علامة تبويب التداول التي تريد تصديرها. سيتم حفظ المعلومات من علامة التبويب المحددة في ملف CSV.',
        ],
        ca_ES:
          'Select which trading tab to export. Information from the selected tab will be saved to a CSV file.',
        cs: 'Select which trading tab to export. Information from the selected tab will be saved to a CSV file.',
        de: [
          'Wählen Sie, welche Trading-Tab Sie exportieren möchten. Die Informationen der ausgewählten Tab werden in einer CSV-Datei gespeichert.',
        ],
        el: 'Select which trading tab to export. Information from the selected tab will be saved to a CSV file.',
        en: 'Select which trading tab to export. Information from the selected tab will be saved to a CSV file.',
        es: [
          'Seleccione la pestaña de trading que desea exportar. La información de la pestaña seleccionada se guardará en un archivo CSV.',
        ],
        fa: 'Select which trading tab to export. Information from the selected tab will be saved to a CSV file.',
        fr: [
          "Sélectionnez l'onglet de trading à exporter. Les informations de l'onglet sélectionné seront enregistrées dans un fichier CSV.",
        ],
        he_IL: ['בחר איזו לשונית מסחר לייצא. מידע מהכרטיסייה שנבחרה יישמר בקובץ CSV.'],
        hu_HU:
          'Select which trading tab to export. Information from the selected tab will be saved to a CSV file.',
        id_ID: [
          'Pilih tab trading yang mana untuk di ekspor, informasi dari tab yang dipilih akan disimpan menjadi file CSV.',
        ],
        it: [
          'Seleziona quale scheda di trading esportare. Le informazioni saranno salvate in un file CSV.',
        ],
        ja: [
          'エクスポートするトレードのタブを選択します。選択したタブの情報がCSVファイルに保存されます。',
        ],
        ko: ['익스포트할 트레이딩 탭을 고르면 그 탭의 정보가 CSV 화일로 세이브됩니다.'],
        ms_MY: [
          'Pilih tab dagangan mana untuk dieksport. Maklumat dari tab yang dipilih akan disimpan di dalam satu fail CSV.',
        ],
        nl_NL:
          'Select which trading tab to export. Information from the selected tab will be saved to a CSV file.',
        pl: [
          'Wybierz, którą zakładkę handlową chcesz wyeksportować. Informacje z wybranej zakładki zostaną zapisane do pliku CSV.',
        ],
        pt: [
          'Selecione qual aba de negociação exportar. As informações da aba selecionada serão salvas em um arquivo CSV.',
        ],
        ro: 'Select which trading tab to export. Information from the selected tab will be saved to a CSV file.',
        ru: [
          'Выберите вкладку с торговыми данными для экспорта. Информация будет сохранена в CSV-файл.',
        ],
        sv: [
          'Välj vilken handelsflik som ska exporteras. Informationen från den valda fliken sparas i en CSV-fil.',
        ],
        th: ['เลือกแท็บการซื้อขายที่จะส่งออก ข้อมูลจากแท็บที่เลือกจะถูกบันทึกเป็นไฟล์ CSV'],
        tr: [
          'Hangi işlem sekmesinin dışa aktarılacağını seçin. Seçilen sekmedeki bilgiler bir CSV dosyasına kaydedilecektir.',
        ],
        vi: ['Chọn tab giao dịch để xuất. Thông tin từ tab đã chọn sẽ được lưu vào tệp CSV.'],
        zh: ['选择要导出的交易标签。所选标签中的信息将保存到CSV文件中。'],
        zh_TW: ['選擇要匯出的交易標籤。所選標籤的資訊將會保存到CSV檔案中。'],
      };
    },
  },
]);
