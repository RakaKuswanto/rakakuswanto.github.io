  ...
  [3030],
  {
    259142: function (t, e) {
      ...
      (n = [e]),
                ...
                (o = [].concat(e(o), [d])),
                  ...
                  (t.ontouchmove = function (e) {
                    ...
                    1 === e.targetTouches.length &&
                      ((n = t),
                      (o = (i = e).targetTouches[0].clientY - u),
                      !l(i.target) &&
                        ((n && 0 === n.scrollTop && 0 < o) ||
                        ((r = n) && r.scrollHeight - r.scrollTop <= r.clientHeight && o < 0)
                          ? a(i)
                          : i.stopPropagation()));
                  }),
                  s ||
                    (document.addEventListener('touchmove', a, i ? { passive: !1 } : void 0),
                    (s = !0));
              }
            } else {
              (S = n),
                setTimeout(function () {
                  ...
                  void 0 === p &&
                    ((p = document.body.style.overflow), (document.body.style.overflow = 'hidden'));
                });
            ...
            (t.clearAllBodyScrollLocks = function () {
              r
                ? (o.forEach(function (t) {
                  ...
                  s &&
                    (document.removeEventListener('touchmove', a, i ? { passive: !1 } : void 0),
                    (s = !1)),
                  (o = []),
                  (u = -1))
                : (d(), (o = []));
        ...
        void 0 === (r = 'function' == typeof i ? i.apply(e, n) : i) || (t.exports = r);
    },
    231988: t => {
      t.exports = { separator: 'separator-EI7Qsb2Q', scrollable: 'scrollable-EI7Qsb2Q' };
    },
    876207: (t, e, i) => {
      'use strict';
      ...
      function h(t) {
        ...
        return (
          (0, r.useEffect)(() => {
            if (!a.CheckMobile.any() && T && 'symbol' === f && w.current) {
              const t = w.current.querySelector('input');
              t && t.focus();
            }
          }, [T]),
          r.createElement(s.AdaptiveConfirmDialog, {
            ...
            render: () =>
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(c.InputsTabContent, {
                    reference: w,
                    property: h,
                    studyMetaInfo: S,
                    model: y,
            ...
            submitButtonText: o.t(null, void 0, i(773226)),
        ...
        function M() {
          ...
          for (const e of n) if ('symbol' === e.type && !e.optional && '' === t[e.id]) return !0;
          return !1;
        }
        function C(t, e) {
          null == g || g(t, e), E(M());
    ...
    759393: (t, e, i) => {
      ...
      async function p(t, e, r, p, c) {
        ...
        async function d(t) {
          if ((0, s.isGroup)(t))
            if ((0, s.isInputInlines)(t)) {
              ...
              if (e) {
                const { time: n, price: r } = e,
                  s = n.inline
                    ? o.t(
                        null,
                        { replace: { inputInline: n.inline, studyShortDescription: p } },
                        i(359877),
                      )
                    : o.t(null, { replace: { studyShortDescription: p } }, i(580481)),
                  u = y(t.id);
                await S(t, 'all', null != u ? u : s, n.id, r.id);
          ...
          const e = 'time' === t.type,
            ...
            r = (function () {
              ...
              const n = t.name
                  ? o.t(
                      null,
                      { replace: { inputTitle: t.name, studyShortDescription: p } },
                      i(718571),
                    )
                  : o.t(null, { replace: { studyShortDescription: p } }, i(742917)),
                r = t.name
                  ? o.t(
                      null,
                      { replace: { inputTitle: t.name, studyShortDescription: p } },
                  ...
                  : o.t(null, { replace: { studyShortDescription: p } }, i(306083));
              return e ? n : r;
            })(),
            s = e ? t.id : void 0,
            u = e ? void 0 : t.id;
        ...
        async function S(e, i, o, s, p) {
          const c = await t.requestSelectPoint(
            { pointType: i, pane: l, lineColor: void 0, selectPointMode: u.SelectPointMode.Study },
            o,
          );
          void 0 === l && (l = c.pane);
          const a = r.childs().inputs;
          a &&
            (s && (0, n.ensureDefined)(a.child(s)).setValue(1e3 * (c.point.time || 0)),
    ...
    756254: (t, e, i) => {
      'use strict';
      i.d(e, { getInputGroups: () => s, isGroup: () => r, isInputInlines: () => o });
      var n = i(650151);
      function r(t) {
        return t.hasOwnProperty('groupType');
      }
      function o(t) {
        return r(t) && 'inline' === t.groupType;
      }
      function s(t) {
        const e = [],
          i = new Map(),
          ...
          t.forEach(t => {
            ...
            if (void 0 !== o || void 0 !== s)
              if (void 0 !== o)
                if (void 0 !== s)
                  if (i.has(o)) {
                    const e = (0, n.ensureDefined)(i.get(o));
                    let p;
                    r.has(e)
                      ? (p = (0, n.ensureDefined)(r.get(e)))
                      : ((p = new Map()), r.set(e, p)),
                      u(t, 'inline', s, p, e.children);
                  } else {
                    const n = { id: s, groupType: 'inline', children: [t] },
                      u = { id: o, groupType: 'group', children: [n] },
                      p = new Map();
                    p.set(s, n), r.set(u, p), i.set(o, u), e.push(u);
                  }
                else u(t, 'group', o, i, e);
              else {
                const i = (0, n.ensureDefined)(r.get(void 0));
                u(t, 'inline', (0, n.ensureDefined)(s), i, e);
              }
            else e.push(t);
          }),
          e
      ...
      function u(t, e, i, r, o) {
        if (r.has(i)) (0, n.ensureDefined)(r.get(i)).children.push(t);
        else {
          const n = { id: i, groupType: e, children: [t] };
          r.set(i, n), o.push(n);
        }
      }
    },
