  ...
  [2306],
  {
    266783: t => {
      ...
      t.exports = function (t, i) {
        ...
        for (var s = 0; s < n.length; s++) if (!e.call(i, n[s]) || !o(t[n[s]], i[n[s]])) return !1;
        return !0;
      };
    },
    226006: t => {
    ...
    135257: t => {
      t.exports = { saturation: 'saturation-NFNfqP2w', pointer: 'pointer-NFNfqP2w' };
    },
    487466: t => {
      t.exports = {
    ...
    805184: (t, e, o) => {
      ...
      function l(t) {
        const { intent: e, size: o, appearance: i, useFullWidth: n, icon: l, ...c } = t;
        return { ...c, color: s(e), size: a(o), variant: r(i), stretch: n, startIcon: l };
      }
      function c(t) {
        return i.createElement(n.SquareButton, { ...l(t) });
      }
    },
    171529: (t, e, o) => {
      'use strict';
      o.d(e, { SquareButton: () => m });
      var i = o(50959),
        n = o(497754),
        r = o(331774),
        s = o(72571),
      ...
      function c(t) {
        ...
        return n(
          ...
          y,
          u && l().grouped,
          u && !g && l()['adjust-position'],
          u && m.isTop && l()['first-row'],
          u && m.isLeft && l()['first-col'],
          _ && v && l()['multiline-content'],
          f && l().link,
        );
      }
      function d(t) {
        ...
        return i.createElement(
          i.Fragment,
          null,
          h && i.createElement(s.Icon, { icon: h, className: l()['start-icon-wrap'] }),
          r && i.createElement('span', { className: l().content }, r),
          a && !n && i.createElement(s.Icon, { icon: a, className: l()['end-icon-wrap'] }),
          p &&
            (function (t) {
              return (
                t.primaryText &&
                ...
                i.createElement(
                  ...
                  'string' == typeof t.secondaryText
                    ...
                    : i.createElement(
                        'span',
                        { className: l()['secondary-text'] },
                        i.createElement('span', null, t.secondaryText.firstLine),
                        i.createElement('span', null, t.secondaryText.secondLine),
                      ),
                )
              );
            })(t),
      ...
      function u(t) {
        ...
        return { ...m, ...(0, p.filterDataProps)(t), ...(0, p.filterAriaProps)(t) };
      }
      function m(t) {
        const { reference: e, ...o } = t,
          ...
          a = c({ ...o, isGrouped: n, cellState: r, disablePositionAdjustment: s });
        return i.createElement(
          'button',
    ...
    65160: (t, e, o) => {
      ...
      function n(t, e = !1) {
        ...
        return (
          'border-box' !== o.boxSizing &&
            i.push(o.paddingTop, o.paddingBottom, o.borderTopWidth, o.borderBottomWidth),
      ...
      function r(t, e = !1) {
        ...
        return (
          'border-box' !== o.boxSizing &&
            i.push(o.paddingLeft, o.paddingRight, o.borderLeftWidth, o.borderRightWidth),
          e && i.push(o.marginLeft, o.marginRight),
          i.reduce((t, e) => t + (parseFloat(e) || 0), 0)
        );
      }
      o.d(e, { contentHeight: () => i, outerHeight: () => n, outerWidth: () => r });
    },
    496818: (t, e, o) => {
      'use strict';
      o.d(e, { Draggable: () => a, PointerBackend: () => l });
      var i = o(650151),
        n = o(821205),
        r = o(601227),
        s = o(972535);
      ...
      class a {
        constructor(t) {
          ...
          (this._helper = null),
                ...
                containment:
                  this._containment instanceof HTMLElement
                    ...
                    ? [
                        window.scrollX,
                        window.scrollY,
                        window.scrollX + document.documentElement.offsetWidth - i,
                        window.scrollY + document.documentElement.offsetHeight - r,
                      ]
                    : null,
              }),
            ...
            (this._handleDragMove = t => {
              ...
              const { current: o, initial: i } = t.detail,
                ...
                a = 'y' === this._axis || !1 === this._axis || 0 !== o.movementY;
              if (a) {
              ...
              if (null !== this._helper.containment) {
                ...
                a &&
                  ...
                  l &&
                    ...
                    ((this._helper.nextLeft = Math.min(this._helper.nextLeft, o)),
          ...
          const r = (this._handle =
            null !== (e = t.handle ? i.querySelector(t.handle) : null) && void 0 !== e ? e : i);
      ...
      class l {
        constructor(t) {
          (this._initial = null),
            (this._handlePointerDown = t => {
              ...
              if (
                ((this._initial = t),
                !this._dispatchEvent(this._createEvent('pointer-drag-start', t)))
              )
        ...
        destroy() {
          ...
          t.removeEventListener('pointerdown', this._handlePointerDown),
            ...
            null !== this._initial &&
              (t.releasePointerCapture(this._initial.pointerId), (this._initial = null));
        }
        _getEventTarget() {
    ...
    821205: (t, e, o) => {
      ...
      function r(t, e) {
        return (
          void 0 === e ||
            (null === e && (t.innerHTML = ''),
            ('string' != typeof e && 'number' != typeof e) || (t.innerHTML = String(e))),
          t
        );
      }
      function s(t) {
    ...
    523847: (t, e, o) => {
      ...
      function v(t) {
        const {
          ...
          b = (0, m.useProperty)(e),
          C = (0, i.useRef)(null),
          T = b ? (0, l.parseRgba)(b)[3] : void 0,
          E = '' === b,
          S = String(L()).toLowerCase() === p.white,
          [P, x, W] = (0, d.useCustomColors)();
        return i.createElement(
          u.ToolWidgetMenu,
          {
            className: w,
            verticalDropDirection: y ? g.VerticalDropDirection.FromBottomToTop : void 0,
            horizontalDropDirection: y ? g.HorizontalDropDirection.FromLeftToRight : void 0,
            ...
            content: i.createElement(
              ...
              i.createElement(
                ...
                { className: _.colorBg },
                i.createElement('div', {
                  className: r()(_.color, E && _.multicolor, S && _.white),
                  style: E ? void 0 : { backgroundColor: b },
                }),
              ),
            ),
            arrow: !1,
          ...
          i.createElement(h.ColorPicker, {
            ...
            onColorChange: function (t, e) {
              const o = b ? (0, c.alphaToTransparency)((0, l.parseRgba)(b)[3]) : 0;
              D((0, c.generateColor)(String(t), o, true)),
                e || (0, s.ensureNotNull)(C.current).close();
            },
            onOpacityChange: function (t) {
              D((0, c.generateColor)(b, (0, c.alphaToTransparency)(t), !0));
            },
            selectOpacity: void 0 !== T,
            selectCustom: !0,
            customColors: P,
            onAddColor: function (t) {
              x(t), (0, s.ensureNotNull)(C.current).close();
            },
            onRemoveCustomColor: W,
          }),
        );
        function L() {
          return b ? (0, l.rgbToHexString)((0, l.parseRgb)(b)) : null;
        }
        function D(t) {
          n.setProperty(e, t, f);
        }
    ...
    822598: (t, e, o) => {
      ...
      var i = o(50959),
        ...
        _ = o(266611),
        v = o(820835);
      const f = (0, d.mergeThemes)(c.DEFAULT_POPUP_MENU_ITEM_THEME, v),
        y = [
          { value: 1, icon: p },
          { value: 2, icon: u },
          { value: 3, icon: m },
      ...
      function w(t) {
        const {
          ...
          w = (0, l.useProperty)((0, r.ensureDefined)(e)),
          b = 'mixed' === w || !w,
          C = (function (t) {
        ...
        return i.createElement(
          a.ToolWidgetMenu,
          {
            ...
            'data-name': t['data-name'],
            menuDataName: `${t['data-name']}-menu`,
            verticalDropDirection: u ? h.VerticalDropDirection.FromBottomToTop : void 0,
            horizontalDropDirection: u ? h.HorizontalDropDirection.FromRightToLeft : void 0,
            horizontalAttachEdge: u ? h.HorizontalAttachEdge.Right : void 0,
            verticalAttachEdge: u ? h.VerticalAttachEdge.Top : void 0,
            content: i.createElement(
              'div',
              null,
              b
                ...
                : i.createElement(
                    ...
                    i.createElement('div', { className: n(!g && v.buttonLabel) }, `${w}px`),
                  ),
            ),
          },
    ...
    557630: (t, e, o) => {
      ...
      var u = o(860184),
        ...
        g = o(487466);
      function _(t) {
        const { index: e, color: r, selected: a, onSelect: _ } = t,
          [v, f] = (0, i.useState)(!1),
          y = (0, i.useContext)(p),
          w = (0, i.useRef)(null),
          b = Boolean(y) && !c.CheckMobile.any();
        return i.createElement(
          i.Fragment,
          null,
          i.createElement('div', {
            ...
            className: n(
              ...
              a && g.selected,
              !r && g.empty,
              String(r).toLowerCase() === u.white && g.white,
            ),
            onClick: function () {
              _(r);
            },
            onContextMenu: b ? C : void 0,
          }),
          b &&
            i.createElement(
              d.PopupMenu,
              {
                ...
                onClose: C,
                position: function () {
                  const t = (0, l.ensureNotNull)(w.current).getBoundingClientRect();
      ...
      class T extends i.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._mouseMove = (0, b.default)(this._handlePosition, 100)),
            (this._handleTouch = t => {
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('div', { className: E.pointer, style: { top: 100 * e + '%' } }),
            ),
          );
        }
      }
      var P = o(580679);
      const x = '#000000',
        W = s.t(null, { context: 'Color Picker' }, o(340276));
      class L extends i.PureComponent {
        constructor(t) {
          super(t),
              ...
              const e =
                (function (t) {
                  ...
                  return (
                    ...
                    [255 * n, 255 * r, 255 * s]
                      .map(t =>
                        ('0' + Math.round(t).toString(16)).replace(/.+?([a-f0-9]{2})$/i, '$1'),
                      )
                      .join('')
                  );
                })(t) || x;
              this.setState({ color: e, inputColor: e.replace(/^#/, ''), hsv: t }),
            ...
            (this._handleInput = t => {
              ...
              try {
                const t = w(e),
                  o = `#${e}`;
                this.setState({ color: o, inputColor: e, hsv: t }), this.props.onSelect(o);
              } catch (t) {
          ...
          const e = t.color || x;
          this.state = { color: e, inputColor: e.replace(/^#/, ''), hsv: w(e) };
        }
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              'div',
              { className: P.form },
              i.createElement('div', { className: P.swatch, style: { backgroundColor: t } }),
              i.createElement(
                'div',
              ...
              i.createElement(
                ...
                i.createElement(y.Button, { size: 's', onClick: this._handleAddColor }, W),
              ),
            ),
            i.createElement(
              'div',
              { className: P.hueSaturationWrap },
              i.createElement(T, { className: P.saturation, hsv: e, onChange: this._handleHSV }),
              i.createElement(S, { className: P.hue, hsv: e, onChange: this._handleHSV }),
            ),
          );
        }
      }
      var D = o(993402);
      const B = s.t(null, { context: 'Color Picker' }, o(453585)),
        k = s.t(null, { context: 'Color Picker' }, o(681865));
        ...
        render() {
          ...
          return l
            ...
            : i.createElement(
                ...
                i.createElement('div', { className: D.separator }),
                i.createElement(
                  p.Provider,
                  { value: a },
                  i.createElement(
                    v,
                    { colors: s, color: t, onSelect: this._handleSelectColor },
                    o &&
                      i.createElement('div', {
                        className: r()(D.customButton, 'apply-common-tooltip'),
                ...
                n &&
                  i.createElement(
                    i.Fragment,
                    null,
                    i.createElement('div', { className: D.sectionTitle }, k),
                    i.createElement(f.Opacity, {
                      color: t,
                      opacity: c,
      ...
      class l extends i.PureComponent {
            ...
            (this._handlePosition = t => {
              null === this._raf &&
                (this._raf = requestAnimationFrame(() => {
                  ...
                  this.setState({ inputOpacity: Math.round(100 * l).toString() }),
        ...
        render() {
          const { color: t, opacity: e, hideInput: o } = this.props,
            { inputOpacity: r, isPointerDragged: s } = this.state,
            l = { color: t || void 0 };
          return i.createElement(
            'div',
            { className: a.opacity },
            ...
            !o &&
              i.createElement(
                ...
                i.createElement('span', { className: a.opacityInputPercent }, '%'),
              ),
          );
        }
        _dragSubscribe() {
      ...
      function l() {
        ...
        const o = (0, i.useCallback)(
            e => {
              ...
              t.some(t => null !== t && null !== o && (0, a.areEqualRgb)((0, a.parseRgb)(t), o)) ||
          ...
          l = (0, i.useCallback)(
            e => {
              (e >= 0 || e < t.length) &&
                (r.emit('remove_custom_color', e), (0, n.setJSON)('pickerCustomColors', d(e, t)));
            },
            [t],
          );
        return [t, o, l];
    ...
    395907: (t, e, o) => {
      ...
      var i = o(50959),
        ...
        r = o(747633),
        s = o(502869);
      const a = i.forwardRef(function (t, e) {
      ...
      class _ extends n.FloatingToolbar {
        constructor(t) {
          super({
            ...
            (this._canBeShownValue = new m.WatchedValue(!1)),
        ...
        showAndSaveSettingsValue() {
          this._canBeShownValue.value() &&
            (u.TVLocalStorage.setItem('ChartFavoriteDrawingToolbarWidget.visible', 'true'),
            this.show());
        }
        hideAndSaveSettingsValue() {
          u.TVLocalStorage.setItem('ChartFavoriteDrawingToolbarWidget.visible', 'false'),
            this.hide();
        }
        canBeShown() {
        ...
        _onFavoriteAdded(t) {
          this.addWidget(this._createLinetoolWidget(t)),
            r.LinetoolsFavoritesStore.favorites().filter(v).length > 0 &&
              (this._canBeShownValue.setValue(!0), this.showAndSaveSettingsValue());
        }
        ...
        _createLinetoolWidget(t) {
          const e = `<span class="tv-favorited-drawings-toolbar__widget apply-common-tooltip ${
            ...
            }" title="${h.lineToolsInfo[t].localizedName}" data-name="FavoriteToolbar${t}">${
        ...
        _attachHandlers() {
          r.LinetoolsFavoritesStore.favoriteAdded.subscribe(this, this._onFavoriteAdded),
            r.LinetoolsFavoritesStore.favoriteRemoved.subscribe(this, this._onFavoriteRemoved),
            ...
            this.onWidgetsReordered().subscribe(this, (t, e) => {
              if (
                (r.LinetoolsFavoritesStore.favoriteMoved.unsubscribe(this, this._onFavoriteMoved),
                !r.LinetoolsFavoritesStore.moveFavorite(r.LinetoolsFavoritesStore.favorite(t), e))
              )
        ...
        _loadVisibilityState() {
          const t = r.LinetoolsFavoritesStore.favorites().filter(v).length > 0;
          this._canBeShownValue.setValue(t);
          const e = r.LinetoolsFavoritesStore.favoritesCount() > 0;
          let o;
          const i = p.getValue('ChartFavoriteDrawingToolbarWidget.visible');
          void 0 !== i
            ? (p.remove('ChartFavoriteDrawingToolbarWidget.visible', { forceFlush: !0 }),
              (o = 'false' !== i),
              u.TVLocalStorage.setItem('ChartFavoriteDrawingToolbarWidget.visible', i))
            : (o =
                'false' !== u.TVLocalStorage.getItem('ChartFavoriteDrawingToolbarWidget.visible')),
    ...
    43066: (t, e, o) => {
      'use strict';
      o.d(e, { FLOATING_TOOLBAR_REACT_WIDGETS_CLASS: () => _, FloatingToolbar: () => f });
      var i = o(370981),
        n = o(972535),
        r = o(49630),
        s = o(870122),
      ...
      var h = o(131595),
        ...
        g = o(25388);
      o(419619);
      const _ = 'floating-toolbar-react-widgets',
        v = `<div class="tv-floating-toolbar i-closed i-hidden"><div class="tv-floating-toolbar__widget-wrapper"><div class="tv-floating-toolbar__drag js-drag">${g}</div><div class="tv-floating-toolbar__content js-content"></div><div class="${_}"></div></div></div>`;
      class f {
        constructor(t) {
          (this._widget = document.createElement('div')),
            ...
            f._toolbars.push(this),
            (this._options = t),
            (this._widget = (0, u.parseHtmlElement)(v)),
            (this._content = this._widget.getElementsByClassName('js-content').item(0)),
            (this._reactWidgetsContainer = this._widget.getElementsByClassName(_).item(0)),
            this._setZIndex(f._startZIndex + f._toolbars.length - 1),
        ...
        destroy() {
          this.hide(!0),
            f._toolbars.splice(f._toolbars.indexOf(this), 1),
        ...
        raise() {
          f._toolbars.length + f._startZIndex !== this._zIndex() &&
            (f._toolbars.splice(f._toolbars.indexOf(this), 1),
            f._toolbars.push(this),
            f._updateAllZIndexes());
        }
        hideDuration() {
          return 0.75 * r.dur;
        }
        ...
        _getSavedPosition() {
          ...
          if ('device' === this._options.positionStorageType) {
            const t = h.TVLocalStorage.getItem(this._options.positionSettingsKey);
            e = null !== t ? JSON.parse(t) : null;
          } else
            e =
              null !== (t = (0, s.getJSON)(this._options.positionSettingsKey)) && void 0 !== t
                ? t
                : null;
          return null !== e && 'top' in e && 'left' in e ? e : null;
        }
        _setHiddingTimeout(t) {
          null !== this._hiddingTimeoutId && clearTimeout(this._hiddingTimeoutId),
        ...
        _onWindowResize() {
          if ('auto' === (this._options.layout || 'auto')) {
            ...
            (this._isVertical = this._determineCurrentLayoutVertical(e)),
              this._updateLayoutType(),
              t !== this._isVertical &&
                (this._onVerticalChanged(this._isVertical, t), this._updateAxisOption());
          }
        ...
        _savePosition() {
          ...
          else (0, s.setJSON)(this._options.positionSettingsKey, { left: t.left, top: t.top });
        }
        _init() {
          this._loadPosition(),
            (this._draggable = new p.Draggable({
              source: this._widget,
              containment: 'window',
              handle: '.js-drag',
        ...
        _initSortable() {
          ...
          lazyJqueryUI(this._content).sortable({
            ...
            stop: (e, o) => {
              ...
              t !== i &&
                ((0, m.trackEvent)('Floating Toolbar', 'User Sort'),
        ...
        static _updateAllZIndexes() {
          f._toolbars.forEach((t, e) => {
            t._setZIndex(f._startZIndex + e);
          });
        }
      }
      (f._startZIndex = 20), (f._toolbars = []);
    },
    477693: (t, e, o) => {
      'use strict';
      o.d(e, {
        LineToolPropertiesWidgetBase: () => Lt,
      });
      var i = o(50959),
        n = o(500962),
        r = o(509806),
      ...
      class g extends m() {
        ...
        unsubscribe(t, e) {
          var o;
          const i = (0, p.ensureDefined)(
            null === (o = this._listenersMappers.find(o => o.obj === t && o.method === e)) ||
              void 0 === o
              ? void 0
              : o.callback,
          );
      ...
      var _ = o(29742),
        ...
        w = o(43066),
        b = o(996038);
      const C = w.FLOATING_TOOLBAR_REACT_WIDGETS_CLASS + '__button';
      function T(t) {
        const {
            templateButton: e,
            propertyButtons: o,
        ...
        return i.createElement(S.ToolWidgetIconButton, {
          ...
          onClick: async function () {
            ...
            const t = o.model().selection().lineDataSources(),
              e = t.length;
            1 === e
              ? await o.showChartPropertiesForSource(t[0], void 0, { onWidget: o.onWidget() })
      ...
      function A(t) {
        ...
        const a = s[0].properties().frozen,
          l = (0, W.useProperty)(a),
          c = l
            ? { title: r.t(null, void 0, o(715101)), icon: k }
            : { title: r.t(null, void 0, o(642284)), icon: N };
        return i.createElement(B, {
          className: n,
          isActive: Boolean(l),
          onClick: function () {
            (0, E.trackEvent)('GUI', 'Context action on drawings', 'Lock'),
      ...
      function I(t) {
        ...
        return i.createElement(S.ToolWidgetIconButton, {
          ...
          'data-name': 'remove',
          onClick: function () {
            (0, E.trackEvent)('GUI', 'Context action on drawings', 'Remove'),
      ...
      function G(t, e) {
        const i = [
            (0, H.createVisualOrderAction)(t, e),
            (0, H.createChangeIntervalsVisibilitiesAction)(t, e),
          ],
          n = (function (t, e) {
            const i = [],
              n = U.isMacKeyboard ? ' +' : '',
                ...
                new Z.Action({
                  ...
                  onExecute: () => {
                    t.model().cloneLineTools(s, !1),
                      (0, E.trackEvent)('GUI', 'Context action on drawings', 'Clone');
                  },
                }),
              );
            ...
            if (a.length > 0) {
              ...
              i.push(new Z.Action(e, 'Copy'));
            }
            return (function (t, e) {
              return (
                !!(null == t ? void 0 : t.isMultipleLayout().value()) &&
                e.some(t => t.isSynchronizable())
              );
            })(t, e)
              ? (i.push(...(0, H.createSyncDrawingActions)(t, e)), i)
              : i;
          })(t, e);
        return (
      ...
      var q = o(844996);
      function Y(t) {
        const { title: e, activeChartWidget: o, isSmallScreen: n, className: r } = t,
          s = o.model().selection().lineDataSources(),
          [a, l] = (0, i.useState)([]),
          c = (0, i.useRef)(null),
          d = (0, i.useMemo)(() => new H.ActionsProvider(o), [o]),
          h = (0, i.useCallback)(() => d.contextMenuActionsForSources(s), [d, s]),
          p = (0, i.useCallback)(() => {
            if (n) return;
            const t = G(o, s);
            l(X(t));
          ...
          u = (0, i.useCallback)(
            t => {
              n &&
                h().then(e => {
                  window.matchMedia(b.DialogBreakpoints.TabletSmall).matches
                    ? O.ContextMenuManager.showMenu(X(e), t, {
                        mode: 'drawer',
                        'data-name': 'more-menu',
                      })
                    : l(X(e));
        ...
        return (
          ...
          i.createElement(
            ...
            i.createElement(z.ActionsTable, { parentIsOpened: !0, items: a }),
          )
        );
      }
      function X(t) {
        if (F.touch && !window.matchMedia('(pointer:fine)').matches) {
          ...
          return (
            e.forEach(t => {
              ('separator' !== t.type || (o.length > 0 && 'separator' !== o[o.length - 1].type)) &&
                o.push(t);
            }),
            o
          );
      ...
      function ot(t) {
          ...
          h = (0, i.useMemo)(
            () => [
              new Z.Action({
                ...
                active: K.LineStyle.Solid === d,
                onExecute: () => n.setProperty(e, K.LineStyle.Solid, a),
              }),
              new Z.Action({
                actionId: 'Chart.LineTool.Toolbar.ChangeLineStyleToDashed',
                icon: tt,
                label: r.t(null, void 0, o(459317)),
                active: K.LineStyle.Dashed === d,
                onExecute: () => n.setProperty(e, K.LineStyle.Dashed, a),
              }),
              new Z.Action({
                actionId: 'Chart.LineTool.Toolbar.ChangeLineStyleToDotted',
                icon: et,
                label: r.t(null, void 0, o(842973)),
                active: K.LineStyle.Dotted === d,
                onExecute: () => n.setProperty(e, K.LineStyle.Dotted, a),
              }),
            ],
            [n, e, d],
          );
        return i.createElement(
          V.ToolWidgetMenu,
          {
            className: c,
            arrow: !1,
            content: i.createElement(R.Icon, { icon: it(d) }),
            title: s,
            'data-name': t['data-name'],
            menuDataName: `${t['data-name']}-menu`,
          ...
          i.createElement(z.ActionsTable, { items: h }),
        );
      }
      function it(t) {
        switch (t) {
          case K.LineStyle.Solid:
            return Q;
          case K.LineStyle.Dashed:
            return tt;
          case K.LineStyle.Dotted:
            return et;
          default:
            return '';
        }
      ...
      function rt(t) {
        ...
        return i.createElement(
          ...
          i.createElement(z.ActionsTable, { items: c }),
        );
      }
      var st = o(466052);
      o(951338), o(226006);
      class at extends w.FloatingToolbar {
        constructor(t) {
          super(at._prepareOptions(t)),
            (this._onWidgetStateChangedDelegate = new st.Delegate()),
            (this._statedWidgets = []),
        ...
        addGroupedWidget(t, e = {}) {
          (0, p.assert)(
            t.states.length > 0 && -1 !== at._getStateIndexById(t, t.currentStateId),
            `Argument is invalid (count: ${t.states.length}, state: ${t.currentStateId})`,
          );
          const o = document.createElement('div');
          (o.className = 'tv-grouped-floating-toolbar__widget-wrapper apply-common-tooltip'),
        ...
        removeGroupedWidget(t) {
          ...
          (0, p.assert)(!1, `Unknown groupId(${t})`);
        }
        ...
        setGroupedWidgetState(t, e) {
          const o = this._ensuredGetWidgetDataForId(t);
          (0, p.assert)(-1 !== at._getStateIndexById(o.statedWidget, e), `Unknown stateId (${e})`),
        ...
        _createPopup(t) {
          ...
          t.statedWidget.states.forEach((i, n) => {
            ...
            r.addEventListener('click', s),
              e.widgets.push({ clickListener: s, stateWidget: i, widget: r }),
              r.classList.add(`tv-grouped-floating-toolbar__sub-widget--slide-right-${n}`),
              r.classList.add('tv-grouped-floating-toolbar__sub-widget--slide-left-' + (o - n + 1)),
              i.readonly || e.element.appendChild(r);
          }),
        ...
        _updateWidgetPreview(t) {
          const e = at._getStateIndexById(t.statedWidget, t.statedWidget.currentStateId);
          (0, p.assert)(-1 !== e, `Unknown state id: ${t.statedWidget.currentStateId}`);
          ...
          t.toolbarWidget.firstChild
            ...
            : (t.toolbarWidget.appendChild(o), t.toolbarWidget.appendChild(at._createCaret()));
        }
        ...
        _updatePopupPosition() {
          ...
          if (this.isVertical())
            r.classList.remove('tv-grouped-floating-toolbar__popup--at-top'),
              (r.style.top = i.top - e.top + 1 + 'px'),
              (r.style.left = ''),
              e.left > window.innerWidth - e.right
                ? r.classList.add('tv-grouped-floating-toolbar__popup--at-left')
            ...
            i.left + n.width > window.innerWidth
              ...
              e.bottom + n.height > window.innerHeight
                ? r.classList.add('tv-grouped-floating-toolbar__popup--at-top')
                : (r.classList.remove('tv-grouped-floating-toolbar__popup--at-top'),
                  (r.style.top = ''));
          }
        }
        ...
        _onWindowClicked(t) {
          if (
            this.isVisible() &&
            this._currentPopup &&
            !at._isEventInElement(t, this._currentPopup.element)
          ) {
            for (let e = 0; e < this._statedWidgets.length; ++e)
              if (at._isEventInElement(t, this._statedWidgets[e].toolbarWidget)) return;
            this._closePopup();
          }
        }
        static _getStateIndexById(t, e) {
          for (let o = 0; o < t.states.length; ++o) if (t.states[o].id === e) return o;
          return -1;
        }
        static _createCaret() {
        ...
        static _prepareOptions(t) {
          const e = ' tv-grouped-floating-toolbar';
      ...
      function mt(t) {
        ...
        const _ = (0, i.useMemo)(() => {
            if (s)
              return () => {
                e.showSaveDialog(t => {
                  e.saveTemplate(t, JSON.stringify(s()));
                });
              };
          }, [e, s]),
          v = (0, i.useMemo)(() => {
            ...
            return (
              a &&
                ...
                t.push(
                  new Z.Action({
                    ...
                    label: (0, ht.appendEllipsis)(r.t(null, void 0, o(933751))),
                    onExecute: _,
                  }),
                ),
              t.push(
              ...
              h
                ? t.push(new Z.Loader('Chart.LineTool.Templates.Apply'))
                : !h &&
                  (null == u ? void 0 : u.length) &&
                  (t.push(new Z.Separator()),
                  t.push(
                    ...u.map(
                      t =>
                        new Z.Action({
                          ...
                          toolbox: { type: pt.ToolboxType.Delete, action: () => e.deleteAction(t) },
                        }),
                    ),
                  )),
              t
        ...
        return i.createElement(
          V.ToolWidgetMenu,
          {
            ...
            content: i.createElement(R.Icon, { icon: ut }),
            onOpen: function () {
              p(!0),
                e.templatesLoaded().then(() => {
                  const t = e.getData();
                  void 0 !== t && (m(t), p(!1));
                }),
            ...
            verticalDropDirection: l ? J.VerticalDropDirection.FromBottomToTop : void 0,
            horizontalDropDirection: l ? J.HorizontalDropDirection.FromLeftToRight : void 0,
            horizontalAttachEdge: l ? J.HorizontalAttachEdge.Left : void 0,
            verticalAttachEdge: l ? J.VerticalAttachEdge.Top : void 0,
            ref: g,
            ...d,
          },
          i.createElement(z.ActionsTable, { items: v }),
        );
      }
      var gt = o(602164),
        _t = o(577461),
        ...
        ft = o(946839);
      const yt =
          (!a.enabled('widget') || window.is_authenticated) &&
          a.enabled('linetoolpropertieswidget_template_button'),
        wt = !1,
        bt = new s.TranslatedString('change line tool(s) font size', r.t(null, void 0, o(436819))),
        Ct = new s.TranslatedString('change line tool(s) line style', r.t(null, void 0, o(654769))),
        Tt = new s.TranslatedString('apply drawing template', r.t(null, void 0, o(349037))),
        Et = r.t(null, void 0, o(389517)),
        St = r.t(null, void 0, o(734596)),
        Pt = r.t(null, void 0, o(141610)),
        xt = r.t(null, void 0, o(832733)),
        Wt = r.t(null, void 0, o(417006));
      class Lt {
        constructor(t) {
          (this._isDrawingFinished = new l.WatchedValue(!0)),
            ...
            (this._fixedContainer = null),
            (this._fixedToolbarRendered = !1),
            ...
            (this._handleSourceEdit = t => {
              d.isDirectionalMovementActive.value() ||
                (t
                  ? (this._fixedContainer && (this._fixedContainer.style.display = 'none'),
                    this._floatingToolbar.hide(!0))
                  : (this._fixedToolbarRendered &&
                      this._fixedContainer &&
                      (this._fixedContainer.style.display = 'block'),
                    this._floatingToolbarRendered && this._floatingToolbar.show()));
            }),
            (this._handleMediaChange = () => {
              this._updateVisibility();
            }),
            (this._chartWidgetCollection = t),
            (this._floatingToolbar = new at({
              defaultPosition: {
            ...
            (this._floatingContainer = this._floatingToolbar.getReactWidgetContainer()),
            (this._isToolMovingNowSpawn = d.isToolMovingNow.spawn()),
            (this._isToolEditingNowSpawn = d.isToolEditingNow.spawn()),
            (this._toolSpawn = d.tool.spawn()),
            (this._iconToolSpawn = d.iconTool.spawn()),
            (this._emojiToolSpawn = d.emojiTool.spawn()),
            ...
            this._toolSpawn.subscribe(this._onToolChanged.bind(this), { callWithLast: !0 }),
            this._iconToolSpawn.subscribe(() => this._onToolChanged(d.tool.value())),
            this._emojiToolSpawn.subscribe(() => this._onToolChanged(d.tool.value())),
        ...
        onSourceChanged(t) {
          if (!(null == t ? void 0 : t.length))
            return (this._propertiesVisible = !1), (this._toolbarVisible = !1), void this.hide();
          if (
            ...
            this.activeChartWidget().model().model().dataSourceForId(e.id())
              ? (!e.userEditEnabled() ||
                  (!(0, _t.isLineDrawnWithPressedButton)(e.toolname) &&
        ...
        hide() {
          this._updateVisibilityTimeout && clearTimeout(this._updateVisibilityTimeout),
            (this._updateVisibilityTimeout = setTimeout(() => {
              (0, ct.unsetNewToolProperties)(),
                Dt() && this._fixedContainer
        ...
        _onToolChanged(t, e) {
          ...
          if (this._isDrawingToolExcludingCustomUrlEventTool(t)) {
            if ((this._isDrawingFinished.setValue(!1), yt)) {
              const o =
                e instanceof gt.DefaultProperty
                  ? e
                  : (0, ct.setNewToolProperties)(
                      t,
                      'LineToolIcon' === t
                        ? d.iconTool.value()
                        : 'LineToolEmoji' === t
                        ? d.emojiTool.value()
                        : void 0,
                      this._chartWidgetCollection.activeChartWidget.value().model().model(),
                    );
              this.showPropertiesOf(t, o, e instanceof gt.DefaultProperty),
                this._showTemplatesOf({ tool: t, properties: o }),
                (this._toolbarVisible = !0);
            }
            this._updateVisibility();
          } else
        ...
        _propertyApplierImpl() {
          return (
            this._propertyApplier ||
              (this._propertyApplier = new ft.PropertyApplierWithoutSavingChart(
                () => this.activeChartWidget().model(),
                new l.WatchedValue(false),
              )),
            this._propertyApplier
          );
        }
        _clearProperties() {
          this._clearPropertyButtons(),
            this._lineWidthsProperty &&
              (this._lineWidthsProperty.destroy(), (this._lineWidthsProperty = null)),
            this._lineColorsProperty &&
              (this._lineColorsProperty.destroy(), (this._lineColorsProperty = null)),
          ...
          this._updateVisibilityTimeout && clearTimeout(this._updateVisibilityTimeout),
            (this._updateVisibilityTimeout = setTimeout(() => {
              this._renderToolbar(),
                Dt() && this._fixedContainer
                  ? (this._fixedContainer.style.display = 'block')
                  : (this._floatingToolbar.show(), this._floatingToolbar.checkPosition());
            }, 0));
        }
        ...
        _createSettingsButton() {
          const t = {
            component: x,
            props: { title: Et, activeChartWidget: this.activeChartWidget() },
          };
        ...
        _createLockButton() {
          const t = {
            component: A,
            props: { title: 'Lock', activeChartWidget: this.activeChartWidget() },
          };
          this._addCommonButton(t);
        }
        _createRemoveButton() {
          const t = {
            component: I,
            props: { title: St, activeChartWidget: this.activeChartWidget() },
        ...
        _createDotsButton() {
          this._addCommonButton({
            component: Y,
            props: { title: Pt, activeChartWidget: this.activeChartWidget() },
            showForSmallScreen: !0,
          });
        }
        _createAlertButton() {}
        ...
        _createLineStyleButton(t) {
          ...
          const o = e[0];
          if (!(0, vt.isDataSource)(o)) return !1;
          const i = {
            component: ot,
            props: {
        ...
        _createProperty(t, e, o, i) {
          if (e) {
            ...
            return this._isWidthProperty(t[0])
              ? new g(new h.MultipleLineWidthsProperty(t), this._propertyApplierImpl(), i)
              : new _.CollectibleColorPropertyUndoWrapper(
                  new h.MultipleLineColorsProperty(t),
          ...
          if (t && t.visible())
            return this._isWidthProperty(t)
              ? new h.MultipleLineWidthsProperty([t])
              : new _.CollectibleColorPropertyDirectWrapper(new h.MultipleLineColorsProperty([t]));
        }
        ...
        _isDrawingToolExcludingCustomUrlEventTool(t) {
          return (
            Boolean(null == t ? void 0 : t.toLowerCase().includes('linetool')) &&
            'LineToolTweet' !== t &&
            'LineToolIdea' !== t &&
            'LineToolImage' !== t
          );
        ...
        _updateVisibility() {
          ((yt && !Dt()) || this._isDrawingFinished.value()) &&
        ...
        _showTemplatesOf(t) {
          ...
          if ((this._templatesButton && this._clearTemplatesButton(), !yt)) return;
          let e, o, i, n;
          if ('sources' in t) {
            if (((e = t.sources), (o = e[0].toolname), (i = e[0].properties()), 1 === e.length)) {
              const t = e[0];
              n = () => t.template();
            }
          } else (o = t.tool), (i = t.properties);
          (this._templatesList = new dt.LinetoolTemplatesList(o, t => {
            if (e) {
              const o = this.activeChartWidget().model();
              o.beginUndoMacro(Tt),
                e.forEach(e => o.applyLineToolTemplate(e, t, Tt)),
                o.endUndoMacro(),
                this.onSourceChanged(e);
            } else i.mergeAndFire(t), i.saveDefaults(), this._onToolChanged(o, i);
          })),
            this._addTemplatesButton({
              ...
              props: {
                ...
                onRestore: () => {
                  void 0 !== e
                    ? this.activeChartWidget().model().restoreLineToolsFactoryDefaults(e)
        ...
        _renderFixedToolbar() {
          null !== this._fixedContainer &&
            this.activeChartWidget() &&
            this.activeChartWidget().hasModel() &&
            (n.render(
              i.createElement(FixedDrawingToolbar, {
                templateButton: this._templatesButton,
                propertyButtons: this._propertyButtons,
                commonButtons: this._commonButtons,
                isDrawingFinished: this._isDrawingFinished.value(),
            ...
            (this._fixedToolbarRendered = !0));
        }
        _renderToolbar() {
          this._renderFloatingToolbar();
        }
        _unmountFixedToolbar() {
          null !== this._fixedContainer &&
            (n.unmountComponentAtNode(this._fixedContainer), (this._fixedToolbarRendered = !1));
        }
        _unmountToolbar() {
          this._floatingToolbarRendered && this._unmountFloatingToolbar(),
            this._fixedToolbarRendered && this._unmountFixedToolbar();
        }
      }
      function Dt() {
        return wt;
    ...
    580384: (t, e, o) => {
      'use strict';
      o.r(e), o.d(e, { LinetoolTemplatesList: () => d });
      var i = o(509806),
        n = o(986661),
        r = o(855342),
        s = o(357739),
      ...
      class d {
        constructor(t, e) {
          (this._toolName = t),
            (this._applyTemplate = e),
            (this._templatesDeferred = this._loadData());
        }
        getData() {
        ...
        loadTemplate(t, e) {
          n.store.dispatch(
            (0, r.loadTemplate)(this._toolName, t, t => {
        ...
        deleteAction(t) {
          (0, a.runOrSignIn)(
            () => {
              const e = i.t(null, { replace: { name: t } }, o(774935));
              (0, l.showConfirm)({
                text: e,
                onConfirm: e => {
              ...
              (0, l.showRename)({
                ...
                onRename: e => {
                  if (-1 !== (this.getData() || []).indexOf(e.newValue)) {
                    const n = i.t(null, { replace: { name: e.newValue } }, o(571527));
                    (0, l.showConfirm)(
                      {
                        text: n,
                        onConfirm: o => {
    ...
    227009: (t, e, o) => {
      ...
      var i = o(664902).TranslatedString,
        n = o(477693).LineToolPropertiesWidgetBase;
      const r = o(523847).ColorPickerButton,
        s = o(822598).LineWidthButton;
      var a = o(394071),
        l = o(621065),
        c = o(448984),
        d = new i('change line tool(s) color', o(509806).t(null, void 0, o(368519))),
        h = new i('change line tool(s) background color', o(509806).t(null, void 0, o(674350))),
        p = new i('change line tool(s) text color', o(509806).t(null, void 0, o(16631))),
        u = new i('change line tool(s) line width', o(509806).t(null, void 0, o(141648))),
        m = o(509806).t(null, void 0, o(940054)),
        g = o(509806).t(null, void 0, o(712928)),
        _ = o(509806).t(null, void 0, o(319221)),
        v = o(509806).t(null, void 0, o(121327)),
        f = o(509806).t(null, void 0, o(938455)),
        y = o(509806).t(null, void 0, o(671845)),
        w = o(509806).t(null, void 0, o(832733)),
        b = o(509806).t(null, void 0, o(23886)),
        C = o(509806).t(null, void 0, o(286327)),
        T = o(509806).t(null, void 0, o(447059)),
        E = o(509806).t(null, void 0, o(36785)),
        S = o(509806).t(null, void 0, o(749593)),
        P = o(509806).t(null, void 0, o(867455)),
        x = o(509806).t(null, void 0, o(179964)),
        W = o(509806).t(null, void 0, o(745320));
      class L extends n {
        constructor(t) {
        ...
        _createWidthsButton(t, e) {
          if (
            (this._lineWidthsProperty &&
              (this._lineWidthsProperty.destroy(), (this._lineWidthsProperty = null)),
            (this._lineWidthsProperty = this._createProperty(t, e, 'linesWidths', u)),
            !this._lineWidthsProperty)
          )
            return !0;
          var o = C;
          e &&
            1 !== this.selectedSources().filter(t => t.properties().linesWidths).length &&
            (o = T);
          return (
        ...
        _createColorsButton(t, e) {
          return (
            this._lineColorsProperty &&
              (this._lineColorsProperty.destroy(), (this._lineColorsProperty = null)),
            (this._lineColorsProperty = this._createProperty(t, e, 'linesColors', d)),
            !this._lineColorsProperty ||
              (this._addPropertyButton({
                component: r,
                props: {
        ...
        _createBackgroundsButton(t, e) {
          return (
            this._backgroundsProperty &&
              (this._backgroundsProperty.destroy(), (this._backgroundsProperty = null)),
            (this._backgroundsProperty = this._createProperty(t, e, 'backgroundsColors', h)),
            !this._backgroundsProperty ||
              (this._addPropertyButton({
                component: r,
                props: {
        ...
        _createTextColorsButton(t, e) {
          return (
            this._textColorsProperty &&
              (this._textColorsProperty.destroy(), (this._textColorsProperty = null)),
            (this._textColorsProperty = this._createProperty(t, e, 'textsColors', p)),
            !this._textColorsProperty ||
              (this._addPropertyButton({
                component: r,
                props: {
    ...
    855342: (t, e, o) => {
      ...
      function r(t, e) {
        return { type: i.SET_TEMPLATES, templates: e, toolName: t };
      }
      function s(t, e) {
        return { type: i.ADD_TEMPLATE, templateName: e, toolName: t };
      }
      function a(t, e) {
        return { type: i.START_REMOVE_TEMPLATE, templateName: e, toolName: t };
      }
      function l(t, e) {
        return { type: i.REMOVE_TEMPLATE, templateName: e, toolName: t };
      }
      function c(t, e, o) {
        return { type: i.SAVE_TEMPLATE, templateName: e, toolName: t, content: o };
      }
      function d(t, e, o) {
        return { type: i.LOAD_TEMPLATE, toolName: t, templateName: e, callback: o };
      }
    },
    765827: (t, e, o) => {
      'use strict';
    ...
    986661: (t, e, o) => {
      ...
      function* m() {
        for (;;) {
          ...
          try {
            yield (0, r.call)(h.backend.saveDrawingTemplate, t, e, o),
              yield (0, r.put)((0, c.addTemplate)(t, e));
          } catch (t) {
            p.logWarn(t);
          }
        }
      ...
      function* g() {
        for (;;) {
          const { toolName: t, templateName: e } = u(
            a.START_REMOVE_TEMPLATE,
            yield (0, r.take)(a.START_REMOVE_TEMPLATE),
          );
          try {
            yield (0, r.call)(h.backend.removeDrawingTemplate, t, e),
              yield (0, r.put)((0, c.removeTemplate)(t, e));
          } catch (t) {
            p.logWarn(t);
          }
        }
      ...
      function* _() {
        ...
        for (;;) {
          const { toolName: o, callback: i } = u(
            a.GET_TEMPLATES,
            yield (0, r.take)(a.GET_TEMPLATES),
          );
          t.has(o)
            ? (0, s.ensureDefined)(t.get(o)).push(i)
            : (t.set(o, [i]), yield (0, r.fork)(e, o));
        }
        function* e(e) {
          try {
            const t = d(
              h.backend.getDrawingTemplates,
              yield (0, r.call)(h.backend.getDrawingTemplates, e),
            );
      ...
      function* v() {
        for (;;) {
          ...
          try {
            const i = d(
              h.backend.loadDrawingTemplate,
              yield (0, r.call)(h.backend.loadDrawingTemplate, t, e),
            );
            o && o(i);
          } catch (t) {
            p.logWarn(t);
      ...
      const y = { templates: {} };
      function w(t, e) {
        return t.localeCompare(e, void 0, { numeric: !0 });
      }
      function b(t = y, e) {
        switch (e.type) {
          case a.ADD_TEMPLATE: {
            const { toolName: o, templateName: i } = e;
            if (!t.templates[o].includes(i)) {
              const e = [...t.templates[o], i].sort(w);
              return { ...t, templates: { ...t.templates, [o]: e } };
            }
            return t;
          }
          case a.SET_TEMPLATES: {
            const { toolName: o, templates: i } = e;
            return { ...t, templates: { ...t.templates, [o]: [...i].sort(w) } };
          }
          case a.REMOVE_TEMPLATE: {
            const { toolName: o, templateName: i } = e;
            return {
              ...t,
              templates: { ...t.templates, [o]: t.templates[o].filter(t => t !== i) },
            };
          }
          default:
            return t;
      ...
      const C = (function () {
        const t = (0, n.default)(),
          e = (0, i.createStore)(b, (0, i.applyMiddleware)(t));
        return t.run(f), e;
      })();
    },
    29742: (t, e, o) => {
    ...
    980458: (t, e, o) => {
      'use strict';
      function i(t, e) {
        return Boolean('' === t || (t && -1 !== e.toLowerCase().indexOf(t.toLowerCase())));
      }
      o.d(e, { autocompleteFilter: () => i });
    },
    844996: t => {
      t.exports =
