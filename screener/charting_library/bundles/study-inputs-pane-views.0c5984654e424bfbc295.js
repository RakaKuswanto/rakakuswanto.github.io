  ...
  [2183],
  {
    422452: (t, e, i) => {
      ...
      class y extends c.BitmapCoordinatesPaneRenderer {
        ...
        doesIntersectWithBox(t) {
          return null !== this._data && this._data.points.some(e => (0, r.pointInBox)(e, t));
        }
        _drawImpl(t) {
        ...
        _drawPoints(t, e, i, n, r) {
          const { context: o, horizontalPixelRatio: l, verticalPixelRatio: u } = t,
          ...
          for (let t = 0; t < e.length; ++t) {
            ...
            if (!((0, a.isInteger)(s.data) && c.linePointBeingEdited === s.data)) {
              if (
                (n(
                  o,
                  new h(Math.round(s.x * l) + y, Math.round(s.y * u) + y, s.data, s.square),
                  f / 2,
                  P,
                ),
          ...
          this._inputs.forEach(t => {
            if (Array.isArray(t)) {
              ...
              if (null !== n && null !== r) {
                ...
                null !== t && null !== s && (this._renderer.append(t), this._renderer.append(s));
              }
            } else {
    ...
    151247: (t, e, i) => {
      ...
      class s {
        ...
        renderer(t, e) {
          return (
            this._invalidated && (this._updateImpl(t, e), (this._invalidated = !1)), this._renderer
          );
        }
        _updateImpl(t, e) {
