  ...
  [1969],
  {
    316167: (t, e, o) => {
      ...
      var r = o(827147),
        ...
        s = o(724377);
      const l = (t, e) =>
        (0, s.rgbaToString)((0, s.blendRgba)((0, s.parseRgba)(t), (0, s.parseRgba)(e)));
      function a(t, e) {
    ...
    914090: (t, e, o) => {
      ...
      const n = (0, r.forwardRef)((t, e) => {
        const { onClose: o, onForceClose: n, onClickOutside: d, className: c, ...h } = t,
          u = (0, r.useRef)(null);
        (0, r.useEffect)(
          () => (
        ...
        return r.createElement(
          i.PopupMenu,
          {
            ...
            tabIndex: -1,
            reference: t => {
              'function' == typeof e ? e(t) : (0, a.isObject)(e) && (e.current = t),
                (u.current = t);
            },
            onClose: o,
            onClickOutside: d,
    ...
    163915: (t, e, o) => {
      ...
      var r = o(50959),
        ...
        s = o(144242);
      function l(t) {
        return r.createElement('div', { className: i(t.className, s.title) }, t.children);
      }
    },
    27938: (t, e, o) => {
      'use strict';
    ...
    281969: (t, e, o) => {
      'use strict';
      o.d(e, { TradedGroupBase: () => _t, isTradedGroupCustomSource: () => ct });
      var r,
        i = o(822914),
        s = o(650151),
        l = o(509806),
      ...
      class D {
        ...
        hitTest(t, e) {
          ...
          const h = {
            cursorType: x.PaneCursorType.Default,
            hideCrosshairLinesOnHover: !0,
            activeItem: { id: this._data.id, part: 8 },
          };
          if (this._data.disabled) return new C.HitTestResult(C.HitTarget.Custom, h);
          let u = {};
          if (void 0 !== this._data.callbacks.onMove) {
            ...
            u = {
              cursorType: x.PaneCursorType.Pointer,
          ...
          const p = this._data.callbacks.onContextMenu,
            ...
            m = Math.round(r.body.left / i),
            v = Math.round(r.top / i);
          if (l >= r.close.left && d && void 0 !== this._data.callbacks.onClose) {
            const t = Math.round(r.body.right / i),
              e = Math.round(r.close.left / i);
            return new C.HitTestResult(C.HitTarget.Custom, {
              ...y,
              ...
              tooltip: {
                ...
                rect: { x: e, y: v, w: t - e, h: this._height },
              },
            });
          }
          if (
            null === (o = this._data.callbacks) || void 0 === o ? void 0 : o.allInteractionsHandler
          )
            return new C.HitTestResult(C.HitTarget.Custom, {
              ...h,
          ...
          if (l >= r.text.left && l < r.close.left) {
            ...
            if (void 0 !== s) {
              const r = r => {
                  const i = r.clientX - r.localX,
                    ...
                    a = new T.Point(t + i, e + l);
                  s(r => r.x > t && r.x <= t + o && r.y > v && r.y <= e, a);
                },
                i = r,
                l = t => {
              ...
              return new C.HitTestResult(C.HitTarget.Custom, {
                ...
                tooltip: {
                  ...
                  rect: { x: t, y: v, w: o, h: this._height },
                },
              });
            }
            ...
            return new C.HitTestResult(C.HitTarget.Custom, {
              ...
              tooltip: {
                extendMargin: !0,
                text: this._data.text.title,
                rect: { x: t, y: v, w: l - t, h: this._height },
              },
            });
          }
          ...
          if (l > r.qty.left && l < r.text.left && void 0 !== f) {
            const t = Math.round(r.qty.left / i),
              ...
              l = r => {
                const i = r.clientX - r.localX,
                  ...
                  l = new T.Point(t + o + i, e + s);
                f(r => r.x > t && r.x <= t + o && r.y > v && r.y <= e, l);
              },
              a = l,
              n = t => {
            ...
            return new C.HitTestResult(C.HitTarget.Custom, {
              ...
              tooltip: {
                ...
                rect: { x: t, y: v, w: d - t, h: this._height },
              },
            });
          }
          if (n && l < r.text.left && void 0 !== this._data.callbacks.onModify) {
            const t = Math.round(r.text.left / i);
            return new C.HitTestResult(C.HitTarget.Custom, {
              ...y,
              ...
              tooltip: {
                extendMargin: !0,
                text: (0, s.ensureDefined)(this._data.qty).title,
                rect: { x: m, y: v, w: t - m, h: this._height },
              },
            });
          }
          return new C.HitTestResult(C.HitTarget.Custom, y);
        }
        drawBackground(t, e) {
        ...
        drawPointOnLine(t, e, o) {
          if (!this._isDataVisibleInViewport(e) || !this._data.point.visible || !this._data.visible)
            return;
          const r = this.rectWithOffsets(e),
        ...
        draw(t, e) {
          ...
          (0, g.drawRoundRectWithInnerBorder)(
            t,
            r.body.left,
            r.top,
            n,
          ...
          if (i) {
            ...
            this._drawQtyWithBackground(t, o, r, !0, !a && !l),
              ...
              r.qty.rightDividerWidth &&
                (w(t, p, c, r.qty.rightDividerWidth, h, e.dividerColor),
          ...
          if (
            (l &&
              ...
              r.text.rightDividerWidth &&
                (w(t, p, c, r.text.rightDividerWidth, h, this._data.text.dividerColor),
                (p += r.text.rightDividerWidth))),
            a)
          ) {
            const e = (0, s.ensureDefined)(this._data.close),
              i = r.body.right - p - r.borderWidth;
            (0, g.drawRoundRectWithInnerBorder)(t, p, c, i, h, e.backgroundColor, [0, u, u, 0]),
              e.active.visible &&
                (0, g.drawRoundRectWithInnerBorder)(t, p, c, i, h, e.active.backgroundColor, [
                  0,
                  u,
                  u,
                  0,
                ]),
              this._drawCloseButton(t, o, p, r.top, r.close.width, d, r.borderWidth);
          }
        }
        rect(t) {
        ...
        _calculateCacheRect(t) {
          ...
          const _ = a && (d || h),
            y = d && h;
          (p += _ && 1), (p += y && 1);
          const m = n + c + u + i * p + 2 * i;
          let v = Math.round(this._height * o);
          const f = Math.max(1, Math.floor(o));
          v % 2 != f % 2 && (v += 1);
          const b = Math.round(this._data.y * o),
            C = Math.floor(b + f / 2 - v / 2) - Math.floor(0.5 * o),
            g =
              this._data.bodyAlignment === P.TradedGroupHorizontalAlignment.Center
                ? Math.round((40 * r) / 100)
                : Math.round(this._data.rightPadding * o);
          let k = g;
          this._data.bodyAlignment === P.TradedGroupHorizontalAlignment.Left && (k = r - g - m);
          const T = r - k,
            x = T - m,
            S = x + n + (n && i) + (n && i),
            M = S + c + (c && i);
          return {
            ...
            qty: {
              ...
              left: x + (n && i),
              rightDividerWidth:
                _ && (null === (e = this._data.qty) || void 0 === e ? void 0 : e.isDividerVisible)
                  ? i
                  : 0,
            },
            text: { width: c, left: S, rightDividerWidth: y ? i : 0 },
            close: { width: u, left: M },
          };
        }
        _calculateCacheRectWithOffsets(t) {
          const e = this.rect(t),
            { left: o, right: r } = this._calcCoordinateWithOffset(e.left, e.right),
            { left: i, right: s } = this._calcCoordinateWithOffset(e.body.left, e.body.right);
          return {
            ...e,
            left: o,
            right: r,
        ...
        _quantityWidth(t) {
          ...
          return Math.round(
            Math.max(
              ...
              14 + i,
              null !==
                (r = null === (o = this._data.qty) || void 0 === o ? void 0 : o.minTextWidth) &&
                void 0 !== r
                ? r
                : 0,
            ),
        ...
        _drawLine(t, e) {
          ...
          t.save(),
            ...
            (0, g.setLineStyle)(t, this._data.line.style),
            (0, g.drawHorizontalLine)(t, r.yMid, r.body.right, i),
            this._data.line.extend && (0, g.drawHorizontalLine)(t, r.yMid, 0, r.body.right),
            t.restore();
        }
        ...
        _drawText(t, e, o, r, i, l, a) {
          ...
          (0, M.drawText)(t, e, o, i, l, d, r, (0, s.ensureNotNull)(this._font), a);
        }
        _drawUnderlinedText(t, e, o, r, i, l) {
          const a = this._getTextYMidCorrection(t, o) * e,
            n = this._getTextMetrics(t, o);
          (0, M.drawUnderlinedText)(t, e, o, i, l, a, r, (0, s.ensureNotNull)(this._font), n);
        }
        ...
        _drawCloseButton(t, e, o, r, i, l, a) {
          ...
          const d = r + l,
            ...
            h = Math.round((i - c) / 2),
            u = Math.round((l - c) / 2);
          (0, g.drawPoly)(t, [new T.Point(o + h, r + u), new T.Point(o + h + c, d - u)], !0),
            (0, g.drawPoly)(t, [new T.Point(o + h + c, r + u), new T.Point(o + h, d - u)], !0),
            t.restore();
        }
        _initCtx() {
      ...
      class I extends D {
        ...
        hitTest(t, e) {
          ...
          if (this._data.disabled) return new C.HitTestResult(C.HitTarget.Custom, u);
          const p = Math.round(l.top / i),
            _ =
              void 0 !== this._data.callbacks.onMoveProjectionTP &&
              1 === (null === (o = this._data.tp) || void 0 === o ? void 0 : o.visibility);
          if (_ && a >= l.tp.left && a < l.tp.left + l.tp.width) {
            ...
            return new C.HitTestResult(C.HitTarget.Custom, {
              ...u,
              cursorType: x.PaneCursorType.Pointer,
              activeItem: { id: (0, s.ensureDefined)(this._data.tp).id, part: 5 },
          ...
          const y = l.sl.left + l.sl.width,
            m =
              ...
              1 === (null === (r = this._data.sl) || void 0 === r ? void 0 : r.visibility);
          if (m && a >= l.sl.left && a < y) {
            ...
            return new C.HitTestResult(C.HitTarget.Custom, {
              ...u,
              cursorType: c ? x.PaneCursorType.Default : x.PaneCursorType.Pointer,
              activeItem: { id: (0, s.ensureDefined)(this._data.sl).id, part: 6 },
          ...
          const v =
            y - l.body.left < 0 ? a >= y && a < l.body.left : a >= l.body.right && a < l.tp.left;
          if ((_ || m) && v) return new C.HitTestResult(C.HitTarget.Custom, u);
          if (this._hasConfirmButton() && (0, s.ensureDefined)(this._data.confirm)) {
            ...
            if (a >= l.confirm.left && a < t) {
              ...
              return new C.HitTestResult(C.HitTarget.Custom, {
                ...u,
                ...t,
                activeItem: { id: this._data.id, part: 7 },
            ...
            if (
              ...
              return new C.HitTestResult(C.HitTarget.Custom, u);
          }
        ...
        draw(t, e) {
          ...
          this._isTPSLVisible() &&
            ...
            0 !== o.sl.width &&
              ...
              this._drawButton(t, e, r, o.borderRadius, i, o.sl, this._data.sl)),
            this._hasConfirmButton() &&
              this._drawButton(t, e, r, o.borderRadius, i, o.confirm, this._data.confirm);
        }
        rect(t) {
          return super.rect(t);
        }
        ...
        _calculateCacheRect(t) {
          ...
          let i = 0,
            s = 0;
          const l = this._data.bodyAlignment === P.TradedGroupHorizontalAlignment.Left;
          l
            ? ((s = e.body.right + o.offset), (i = s + o.tp - (o.tp > 0 ? e.borderWidth : 0)))
            : ((i = e.body.left - o.offset - o.sl),
              (s = i - (o.tp > 0 ? o.tp - e.borderWidth : 0)));
          let a = 0;
          r.confirm > 0 && (a = l ? i + o.sl + r.offset : s - r.confirm - r.offset - e.borderWidth);
          let n = a || s,
            d = e.right;
          return (
        ...
        _drawLine(t, e) {
          var o, r;
          if (!this._data.callbacks.onFinishMoveSL && !this._data.callbacks.onFinishMoveTP)
          ...
          if (
            ...
            (0, g.setLineStyle)(t, this._data.line.style),
            (0, g.drawHorizontalLine)(t, s.yMid, s.body.right, l),
            this._data.line.extend)
          )
            (0, g.drawHorizontalLine)(t, s.yMid, 0, s.body.left);
          else {
            ...
            if (e || i) {
              ...
              (0, g.drawHorizontalLine)(t, s.yMid, e, s.body.left);
            }
        ...
        _calcAllWidth(t, e, o, r, i, s) {
          ...
          if (!this._data.tp && !this._data.sl && !this._hasConfirmButton()) return l;
        ...
        _calcConfirmRect(t, e) {
          ...
          const o = 2 * e,
            r = Math.round(11 * t),
            i = this._textWidth(this._ctxInternal, (0, s.ensureDefined)(this._data.confirm).text);
          return { confirm: Math.round(i * t) + (i && o) + (i && r), offset: Math.round(10 * t) };
        }
        _calcTPSLRect(t, e) {
          const o = 2 * e,
            r = this._textWidth(
          ...
          return { tp: i, sl: l, offset: l > 0 || i > 0 ? Math.round(10 * t) : 0 };
        }
        _drawButton(t, e, o, r, i, s, l) {
          if (void 0 === l) return;
          const a = this.rectWithOffsets(e);
          (0, g.drawRoundRectWithInnerBorder)(t, s.left, a.top, s.width, o, l.backgroundColor, r),
            l.active.visible &&
              (0, g.drawRoundRectWithInnerBorder)(
                t,
                s.left,
          ...
          l.underlineText
            ? this._drawUnderlinedText(t, e.pixelRatio, l.text, l.textColor, d, i)
      ...
      class O extends D {
        ...
        hitTest(t, e) {
          ...
          return this._data.disabled
            ? new C.HitTestResult(C.HitTarget.Custom, d)
            : new C.HitTestResult(C.HitTarget.Custom, {
                ...d,
                activeItem: { id: this._data.id, part: 8 },
              });
        }
        ...
        _drawTextWithBackground(t, e, o, r, i) {
          ...
          this._drawText(t, e, this._data.text.text, this._data.text.textColor, l, s);
        }
        _calculateCacheRect(t) {
          ...
          return (
            ...
            this._data.bodyAlignment !== P.TradedGroupHorizontalAlignment.Left
              ...
              : {
                  ...
                  body: {
                    left:
                      o.body.left - o.text.width - Number(o.qty.rightDividerWidth) - o.borderWidth,
                    right: o.qty.left + o.qty.width + o.borderWidth,
                  },
                  text: {
                    left: o.body.left - o.text.width - Number(o.qty.rightDividerWidth),
      ...
      class W extends I {
        ...
        hitTest(t, e) {
          ...
          if (this._data.disabled) return new C.HitTestResult(C.HitTarget.Custom, u);
          const p = this._hasReverseButton() && (0, s.ensureDefined)(this._data.reverse);
          if (p && 1 === p.visibility) {
            ...
            if (i >= r.reverse.left && i < t) {
              ...
              return new C.HitTestResult(C.HitTarget.Custom, {
                activeItem: { id: this._data.id, part: 4 },
                cursorType: x.PaneCursorType.Default,
                hideCrosshairLinesOnHover: !0,
                contextMenuHandler: this._data.callbacks.onContextMenu,
                touchContextMenuHandler: this._data.callbacks.onContextMenu,
                ...
                tooltip: { text: p.title, rect: { x: t, y: h, w: e, h: this._height } },
              });
            }
        ...
        draw(t, e) {
          if (
            (super.draw(t, e),
            !this._isReverseVisible() || !this._isDataVisibleInViewport(e) || !this._data.visible)
          )
            return;
          const o = this.rectWithOffsets(e);
        ...
        _calculateCacheRect(t) {
          ...
          const r = this._calcReverseRect(t.pixelRatio),
            i = this._data.bodyAlignment === P.TradedGroupHorizontalAlignment.Left,
            s = i ? o.right + r.offset : o.left - r.width - r.offset,
            l = i ? o.left : s,
            a = i ? s + r.width : o.right;
          return { ...o, left: l, right: a, reverse: { width: r.width, left: s } };
        }
        _calcAllWidth(t, e, o, r, i, s) {
          var l;
          const a = super._calcAllWidth(t, e, o, r, i, s);
          if (
            !(null === (l = this._data) || void 0 === l ? void 0 : l.callbacks.onReverse) ||
            !this._hasReverseButton()
          )
            return a;
        ...
        _drawLine(t, e) {
          var o;
          if (!(null === (o = this._data) || void 0 === o ? void 0 : o.callbacks.onReverse))
            return void super._drawLine(t, e);
          ...
          if (
            (t.save(),
            (t.strokeStyle = this._data.line.color),
            (t.lineWidth = Math.max(1, Math.floor(this._data.line.thickness * r))),
            (0, g.setLineStyle)(t, this._data.line.style),
            (0, g.drawHorizontalLine)(t, i.yMid, i.body.right, s),
            this._isReverseVisible() && (0, g.drawHorizontalLine)(t, i.yMid, l, i.body.left),
            this._data.line.extend)
          ) {
            const e = this._isReverseVisible() ? i.reverse.left : i.body.left;
            (0, g.drawHorizontalLine)(t, i.yMid, 0, e);
          }
          t.restore();
        }
        _calcReverseRect(t) {
        ...
        _drawReverseButton(t, e, o, r, i, l, a, n) {
          ...
          const h = Math.round(3 * e),
            ...
            y = Math.round(_ + h),
            m = r + a + Math.round((l - p) / 2 - a),
            v = m + p,
            f = d.iconColor;
          (t.lineWidth = a),
            (0, M.drawHalfArrow)(t, _, m, f, !1, p, u),
            (0, M.drawHalfArrow)(t, y, v, f, !0, p, u),
            t.restore();
        }
        _isReverseVisible() {
          return (
            this._hasReverseButton() && 1 === (0, s.ensureDefined)(this._data.reverse).visibility
          );
        }
        _hasReverseButton() {
      ...
      class R {
        constructor(t, e) {
          (this._itemsRectsInfoCache = null),
            (this._textWidthCache = new k.TextWidthCache()),
            (this._minMainTextWidthCache = new Map()),
            (this._items = []),
            (this._font = (0, b.makeFont)(t, f.CHART_FONT_FAMILY, '', 'normal')),
        ...
        clearCache() {
          (this._itemsRectsInfoCache = null), this._items.forEach(t => t.clearCache());
        }
        clearTextCache() {
        ...
        addItem(t) {
          const e = (function (t, e, o, i) {
            if (t.type === r.Position) return new W(t, e, o, i);
            if (t.type === r.WithBracketButtons) return new I(t, e, o, i);
            if (t.type === r.Projection) return new O(t, e, o, i);
            if (t.type === r.Default) return new D(t, e, o, i);
        ...
        applyHorizontalOffset(t, e) {
          ...
          const o = this._items.filter(t => t.data().visible).map(t => t.rect(e));
          ...
          let a,
            ...
            c = t.leftmostBorder;
          const h = d - c;
          if (this._data.horizontalAlignment === P.TradedGroupHorizontalAlignment.Left)
            d > e.physicalWidth &&
        ...
        hitTest(t, e) {
          ...
          return (null === (o = this._data) || void 0 === o ? void 0 : o.disableNoOverlap)
            ? new C.HitTestResult(C.HitTarget.MovePointBackground, {
        ...
        draw(t, e) {
          ...
          const l =
            ...
            c = this._data.horizontalAlignment === P.TradedGroupHorizontalAlignment.Left,
            h = c ? a : l,
            u = c ? -1 : 1;
          if (null !== h && h + u * d <= n) {
            const o = c ? 0 : n,
        ...
        _minTextWidth(t, e) {
          ...
          return (
            e.restore(),
            null !== (o = this._minMainTextWidthCache.get(t.id)) && void 0 !== o ? o : 0
          );
        }
        _drawVertLine(t, e, o) {
          ...
          (t.strokeStyle = r.color),
            ...
            (0, g.setLineStyle)(t, r.style),
            (0, g.drawVerticalLine)(
              t,
              o,
      ...
      class F {
        ...
        _isHoveredItemPart(t, e) {
          ...
          return (
            ...
            (null === (o = this._source.hoveredItem()) || void 0 === o ? void 0 : o.part) === e
          );
        }
        _isSelectedItem(t) {
          var e;
        ...
        _isHoveredItemWithButtons(t) {
          ...
          const {
            ...
            stopLoss: o,
            trailingStop: r,
          } = (0, q.bracketsByType)(this._source.items().projectionBrackets);
          return (
            this._isHoveredItem(t) ||
        ...
        _isHoveredStopItemStopLimit() {
          ...
          return !!(t && e && (0, p.isLimitPartStopLimitOrderItem)(e)) && this._isHoveredItem(t);
        }
        _isActiveSource() {
        ...
        _renderDataForQty(t, e) {
          return {
            text:
              ...
              null === o
                ? '0'
                : ((0, H.isNumber)(o) && o < 0 && (o = `− ${Math.abs(o)}`),
                  (0, j.forceLTRStr)((0, N.splitThousands)(o, ' ')))),
            minTextWidth: this._minQtyWidth(),
            textColor: t.textColor,
            backgroundColor: t.backgroundColor,
            dividerColor: t.dividerColor,
            isDividerVisible: !0,
            active: { visible: this._isHoveredItemPart(this._item, 1), backgroundColor: e },
          };
          var o;
        }
        _renderDataForText(t, e) {
          return {
            ...
            backgroundColor: t.backgroundColor,
            dividerColor: t.dividerColor,
            active: { visible: this._isHoveredItemPart(this._item, 2), backgroundColor: e },
          };
        }
        _renderDataForPoint() {
          const {
        ...
        _renderDataForClose(t, e) {
          if (this._item.supportClose() && this._isCloseVisible())
            return {
              ...
              active: { visible: this._isHoveredItemPart(this._item, 3), backgroundColor: e },
            };
        }
        _renderDataForConfirm() {
          ...
          const t = (0, m.getDefaultStyleForOrderItem)(this._item, this._source, () =>
              this._chartModel.dark().value(),
            ),
            ...
            l = r ? (0, s.ensureDefined)(e.borderColor) : e.disableBackgroundColor,
          ...
          return {
            ...
            active: { visible: o && r, backgroundColor: e.activeColor, borderColor: e.activeColor },
          };
        }
        _renderDataGeneral(t) {
          ...
          if (null !== o) {
            e = (this._chartModel.mainSeries().priceScale().isInverted() ? -1 : 1) * o;
          }
          return {
            y: this._y,
        ...
        _callbacks(t = []) {
          ...
          const { takeProfit: r, stopLoss: i, trailingStop: s } = (0, q.bracketsByType)(t),
            l = i || s;
          return (
            r &&
            ...
            this._isNoOverlapMode &&
              (e.allInteractionsHandler = () => this._externalCallbacks.setNoOverlapMode(!1)),
        ...
        _borderBackgroundColor(t) {
          return t.borderStyle === V.LineStyle.Solid ? 'transparent' : t.borderBackgroundColor;
        }
        _modeGaLabel() {
        ...
        _itemWithConfirmButton() {
          if (!this._source.isPlaced() && !this._source.isConfirmButtonOnDomWidget())
            return this._itemWithButtons();
        }
      }
      const G = (0, A.appendEllipsis)(l.t(null, void 0, o(911810))),
        z = l.t(null, void 0, o(419780)),
        Q = l.t(null, void 0, o(437431));
      class $ extends F {
        rendererData() {
          const t = (0, v.getDefaultStyleForPositionItem)(
          ...
          return (
            void 0 !== o && (e = { ...o, title: Q }),
            {
              ...
              qty: { ...this._renderDataForQty(t.qty, t.qty.activeColor), title: G },
              text: {
        ...
        _callbacks(t = []) {
          ...
          return (
            ...
            this._shouldReverseShown() && (e.onReverse = () => this._item.onReverse(o)),
            this._item.supportModify() && (e.onModify = () => this._item.onModify(o)),
            e
          );
        }
      ...
      const U = l.t(null, void 0, o(137172)),
        Y = l.t(null, void 0, o(316075));
      class K extends F {
        rendererData() {
          const t = this._item === this._itemWithButtons(),
            e = (0, m.getDefaultStyleForOrderItem)(this._item, this._source, () =>
              this._chartModel.dark().value(),
            ),
          ...
          return (
            void 0 !== s && (i = { ...s, title: Y }),
            {
              ...
              qty: { ...this._renderDataForQty(e.qty, o), title: U },
              text: {
        ...
        _callbacks(t = []) {
          ...
          return (
            ...
            this._item.supportModify() && (o.onModify = () => this._item.onModify(r)),
            this._item.supportClose() &&
              this._isCloseVisible() &&
          ...
          return (
            ...
            this._isNoOverlapMode ||
              (this._item.isMovingEnabled() &&
                ...
                (e.onFinishMove = () => this._source.onFinishMove(this._item.id(), o))),
              this._item.canSwitchType() && (e.onText = (t, e) => this._item.toggleType(t, e, o))),
            e
          );
        }
      }
      class Z extends F {
        rendererData() {
          ...
          return {
            type: r.Projection,
            ...this._renderDataGeneral(t),
            drawWithTPOffset: this._item.bracketType() === d.BracketType.TakeProfit,
            drawWithSLOffset:
      ...
      function J(t, e, o, r, i, s) {
        if ((0, p.isPositionItem)(t)) return new $(t, e, o, r, i, s);
        if ((0, p.isPreOrderItem)(t)) return new X(t, e, o, r, i, s);
        if ((0, p.isProjectionBracketItem)(t)) return new Z(t, e, o, r, i, s);
        if ((0, u.isOrderLikeItem)(t)) return new K(t, e, o, r, i, s);
      ...
      class et {
        constructor(t, e, o) {
          (this._prevItemTokens = new Map()),
            ...
            (this._renderer = new R(13, this._tradedGroupRenderersController)),
            this._tradedGroupRenderersController.registerRenderer(this._renderer),
            this._source
              .positionDisplayMode()
        ...
        destroy() {
          this._tradedGroupRenderersController.removeRenderer(this._renderer),
            this._source
              .positionDisplayMode()
              .unsubscribe(this._renderer, this._renderer.clearMinTextWidthCache),
            this._source
              .bracketsDisplayMode()
              .unsubscribe(this._renderer, this._renderer.clearMinTextWidthCache);
        }
        ...
        makeSureIsUpdated(t, e) {
          if (this._invalidated) {
            ...
            this._calculateMode(e),
              t !== this._displayMode && this._renderer.clearMinTextWidthCache(),
        ...
        _calculateMode(t) {
          ...
          const e = t < tt.Large ? (t < tt.Small ? 0 : 1) : 2;
          this._displayMode = e;
        }
        _mainItemStyle() {
          ...
          return void 0 === t
            ...
            ? (0, v.getDefaultStyleForPositionItem)(
                t.isBuyDirection(),
                this._source.isBlocked(),
                () => this._chartModel.dark().value(),
                t.lineStyle(),
              )
            : ((0, s.assert)((0, u.isOrderLikeItem)(t), 'Unexpected traded item type'),
        ...
        _sortedItems() {
          ...
          if (
            ...
            return n;
          for (const i of n)
            (null === (t = this._source.movingItem()) || void 0 === t ? void 0 : t.id) === i.id()
              ? (a = i)
              : (null === (e = this._source.hoveredItem()) || void 0 === e ? void 0 : e.id) ===
                i.id()
              ? (l = i)
              : (null === (o = this._source.selectedItem()) || void 0 === o ? void 0 : o.id) ===
                i.id()
              ? (s = i)
              : r.push(i);
          return null !== s && r.push(s), null !== l && r.push(l), null !== a && r.push(a), r;
        }
        _updateImpl() {
          if (
          ...
          (this._source.isHovered() || e) &&
            (i.vertLine = { thickness: this._source.lineWidth(), style: t.lineStyle, color: o }),
            this._tradedGroupRenderersController.isNoOverlapMode() &&
              (i.disableNoOverlap = () =>
          ...
          for (const e of this._sortedItems()) {
            ...
            const s = J(
              ...
              {
                setNoOverlapMode: t => this._tradedGroupRenderersController.setNoOverlapMode(t),
              },
            ).rendererData();
            this._renderer.addItem(s), l.set(`${s.id} ${e.isBuyDirection()}`, s.id);
          }
      ...
      var ot = o(630432);
      class rt extends ot.PriceAxisView {
        constructor(t, e, o, r) {
          super(),
            (this._model = t),
            (this._data = e),
        ...
        _formatPrice(t) {
          return this._priceScaleFormatter().format(t, void 0, void 0, void 0, void 0, false);
        }
      }
      var it = o(377884);
      class st extends it.PriceLineAxisView {
      ...
      function lt(t, e, o) {
        if ((0, p.isPositionItem)(o)) {
          ...
          return {
            priceAxisView: new rt(t, o, () => e.priceScaleFormatter(), r),
            priceLineAxisView: new st(t, o, e, 19, 0, e.showPositionProperty(), r),
          };
        }
        (0, s.assert)((0, u.isOrderLikeItem)(o), 'Unexpected traded item type');
        const r = () => (0, m.getDefaultStyleForOrderItem)(o, e, () => t.dark().value());
        return {
          priceAxisView: new rt(t, o, () => e.priceScaleFormatter(), r),
          priceLineAxisView: new st(t, o, e, 17, 1, e.showOrderProperty(), r),
        };
      }
      class at {
        constructor(t, e) {
        ...
        views(t, e) {
          ...
          m.push(...this._views.project.brackets),
            this._views.main && m.push(this._views.main),
            this._views.stopLimit && m.push(this._views.stopLimit);
          for (const t of m)
        ...
        recreateViews() {
          const t = this._source.items(),
            e = t.projectionBrackets
              ...
              .map(t => lt(this._model, this._source, t));
          (this._views = {
            brackets: t.brackets.map(t => lt(this._model, this._source, t)),
            project: { brackets: e },
          }),
            void 0 !== t.main && (this._views.main = lt(this._model, this._source, t.main)),
            void 0 !== t.stopLimit &&
              (this._views.stopLimit = lt(this._model, this._source, t.stopLimit));
        }
      }
      var nt = o(764533),
        dt = o(966949);
      ...
      const ht = l.t(null, void 0, o(619397)),
        ut = l.t(null, void 0, o(360538));
      function pt(t) {
        return (
          void 0 !== t &&
      ...
      class _t extends a.CustomSourceBase {
        constructor(t, e, o, r, i, s, l, a, n) {
          super(t, e),
            ...
            (this._paneView = new et(this._model, this, n)),
            (this._tradedGroupRenderersController = n),
            (this._priceViewsGroup = new at(this._model, this)),
            ...
            this._model.hoveredSourceChanged().subscribe(this, () => {
              ...
              (null === t || (t !== this && ct(t))) && this.redraw();
            });
        }
        destroy() {
          var t, e;
        ...
        isTrailingStopSupported() {
          var t;
          return Boolean(
            null === (t = this.items().main) || void 0 === t
              ? void 0
              : t.data().supportTrailingStop,
          );
        }
        isReverseVisible() {
        ...
        isHoveredOtherTradedGroup() {
          return !this.isHovered() && ct(this._model.hoveredSource());
        }
        isSelected() {
        ...
        items(t, e) {
          if (t) {
            ...
            return (
              ...
              this._items.main && !(null == e ? void 0 : e.exceptMain) && t.push(this._items.main),
              (null == e ? void 0 : e.exceptBrackets) || t.push(...this._items.brackets),
        ...
        baseItem() {
          var t;
          return null !== (t = this._items.stopLimit) && void 0 !== t ? t : this._items.main;
        }
        findItem(t) {
          const e = this.items(!0).find(e => e.id() === t);
          return (0, s.assert)(void 0 !== e, `Traded item with id ${t} is not found`), e;
        }
        findItemWithType(t, e) {
          const o = e === h.TradedItemType.Position ? p.isPositionItem : u.isOrderLikeItem;
          return this.items(!0, { exceptStopLimit: !0 }).find(e => o(e) && e.data().id === t);
        }
        movingItem() {
          const t =
        ...
        updateAllViews() {
          this._paneView.update(),
            this._priceViewsGroup.updateAllViews((0, n.sourceChangeEvent)(this.id()));
        }
        ...
        allItemsSupportMove(t) {
          ...
          for (const t of this._items.projectionBrackets) if (null !== t.price()) return !1;
          return !(t.length < 2) && t.every(t => (0, u.isOrderLikeItem)(t) && t.isMovingEnabled());
        }
        onMove(t, e, o = !1) {
          ...
          null === i && null !== r.price() && this._priceViewsGroup.recreateViews(), this.redraw();
        }
        _updateStopLimit(t) {
          ...
          pt(t.main) && void 0 === o
            ...
            : void 0 !== o &&
              (this._convertStopLimitOrderToMainItem(t.main, o), this._deleteStopLimitItem());
        }
        ...
        _setData(t, e = !0) {
          ...
          if (this.isBlocked())
            ...
            const s =
              null !==
                (a =
                  null !== (r = null === (o = t.main) || void 0 === o ? void 0 : o.symbol) &&
                  void 0 !== r
                    ? r
        ...
        _createStopLimitItem(t, e) {
          ...
          if (
            void 0 !== t.main &&
            ((0, u.isOrderItemRawData)(t.main) || (0, u.isPreOrderItemRawData)(t.main)) &&
        ...
        _isSourceShouldBeShown() {
          return (
            ...
            !(window.TradingView.printing && !(0, dt.isTradingObjVisibleOnScreenshot)())
          );
        }
        _getToggleStopTypeMenuHandler() {
          const t = [{ title: ht, value: c.StopType.StopLoss }];
          return (
            this.isTrailingStopSupported() && t.push({ title: ut, value: c.StopType.TrailingStop }),
            (e, o, r, i, s) => {
              var l;
              const a = this.mainItem();
              if (e) {
                const t = a && (0, p.isPositionItem)(a) ? 'Chart Position' : 'Chart Order';
        ...
        _updateItems(t) {
          void 0 === this._items.main && void 0 !== t.main
            ...
            : void 0 !== this._items.main && void 0 === t.main && this._deleteMainItem(),
        ...
        _updateBrackets(t) {
          ...
          this._items.brackets.forEach(o => {
            ...
            -1 !== r ? (o.setData(this._processedBracketData(t[r])), t.splice(r, 1)) : e.push(o);
          }),
            e.forEach(t => {
              const e = this._items.brackets.findIndex(e => e.data().id === t.data().id);
              -1 !== e && (this._items.brackets[e].destroy(), this._items.brackets.splice(e, 1));
            }),
            t.forEach(t => {
        ...
        _updateProjectionBracketsItems(t = !1) {
          ...
          const {
            ...
            s = null != r ? r : i,
            {
              ...
              stopLoss: a,
              trailingStop: n,
            } = (0, q.bracketsByType)(this._items.projectionBrackets),
            h = null != a ? a : n;
          [
            [o, l],
            [s, h],
          ...
          const u = e.data();
          if (!o && !l) {
            const t = (0, q.buildProjectionBracketData)(
                'ProjectionBracket',
                d.BracketType.TakeProfit,
                u,
              ),
              e = (0, _.createItem)(_.TradedGroupItemType.ProjectionBracket, t, this, this._model, {
                itemExternalServices: {
                  symbolDataProvider: this._symbolDataProvider,
                  qtySuggester: this._qtySuggester,
                  tradedGroupRenderersController: this._tradedGroupRenderersController,
          ...
          if ((!s && !h) || t) {
            const t =
              ...
              e = (0, q.buildProjectionBracketData)('ProjectionBracket', t, u);
            if (h) h.setData(e);
            else {
              const t = {
                itemExternalServices: {
    ...
    735415: (t, e, o) => {
      ...
      class b {
        ...
        priceText() {
          return (0, r.ensureNotNull)(this._symbolDataProvider.symbolData()).priceFormatter.format(
            (0, r.ensureNotNull)(this.price()),
          );
        }
        supportBrackets() {
        ...
        percentageText(t, e) {
          ...
          const r = y(t, e),
            ...
            l = null !== (o = null == i ? void 0 : i.price()) && void 0 !== o ? o : null;
          if (null === l) return '';
          const a = ((100 * t) / l) * this._data.side;
          return `${r}${(0, s.splitThousands)(m.twoDecimalFormatter.format(Math.abs(a)), ' ')}%`;
        }
        moneyText(t, e) {
          const o = this._symbolDataProvider.pipValue();
          if (null === o || (0, l.isNaN)(o.sellPipValue) || (0, l.isNaN)(o.buyPipValue)) return '';
          const i = y(t, e),
            ...
            d = Math.abs(
              (0, _.pipsToRiskInCurrency)(a, this._data.qty, n, s.priceMagnifier, s.lotSize),
            );
          return `${i}${m.twoDecimalFormatter.format(d)} ${this.currency()}`;
        }
        pipsText(t, e) {
          const l = y(t, e),
            ...
            n =
              isFinite(a.pipSize) && a.pipSize !== a.minTick
                ? m.oneDecimalFormatter
                : m.integerFormatter,
            d = parseFloat(n.format(t / (a.pipSize || a.minTick))) * this._data.side;
          switch (this._symbolDataProvider.pipValueType()) {
            case p.PipValueType.Pips:
              return `${l}${i
                .t(null, { plural: '{pips} pips', count: Math.abs(d) }, o(777772))
                .replace('{pips}', (0, s.splitThousands)(Math.abs(d).toFixed(1), ' '))}`;
            case p.PipValueType.Ticks:
              return `${l}${i
                .t(null, { plural: '{ticks} ticks', count: Math.abs(d) }, o(564225))
                .replace('{ticks}', (0, s.splitThousands)(Math.abs(d).toFixed(0), ' '))}`;
          }
          return '';
        }
        tryBasePlOnLast() {
    ...
    182665: (t, e, o) => {
      ...
      var f = o(690839),
        ...
        C = o(74516),
        g = o(735415);
      const P = (0, i.appendEllipsis)(r.t(null, void 0, o(305806))),
        k = r.t(null, void 0, o(709498)),
        T = r.t(null, void 0, o(555937)),
        x = r.t(null, void 0, o(937385));
      class S extends g.BaseItem {
        constructor(t, e, o, r, i, l, a, n = 'Chart Order') {
          super(t, e, o, r, n, i, l),
            ...
            (this._handleQtyModifyDestroy = () => {
              this.applyQty(this.data().qty), (this._isQtyModifyOpened = !1), this._closeQtyCalc();
            }),
            this._isBracket() &&
              this._source.bracketsDisplayMode().subscribe(this, this.fireProfitLossChange),
            a &&
              ...
              this._suggestedQty.subscribe(
                (0, s.ensureDefined)(this._qtyModifyCallbacks.onQtyApplyHandler),
              ));
        }
        destroy() {
          var t, e;
          (this._isQtyModifyOpened = !1),
            this._closeQtyCalc(),
            this._source.bracketsDisplayMode().unsubscribe(this, this.fireProfitLossChange),
        ...
        toggleQtyModify(t, e, o = {}) {
          this.canQtyCalcModify() &&
            ((this._isQtyModifyOpened = !this._isQtyModifyOpened), this._toggleQtyCalc(t, e, o));
        }
        modifyQty(t) {
          this.canQtyCalcModify() &&
        ...
        applyQty(t) {
          var e;
          this.modifyQty(t),
            null === (e = this._qtyProvider) || void 0 === e || e.applySuggestedQty(this._data.qty);
        }
        currency() {
          var t;
        ...
        setData(t) {
          this._inEdit ||
            (super.setData(t), this.fireProfitLossChange(), (this._id = this._calcId()));
        }
        setInEdit(t) {
          this._inEdit = t;
        }
        ...
        bracketType() {
          return this._isBracket() ? (0, C.getBracketType)(this._data) : null;
        }
        qty() {
        ...
        profitLossText(t) {
          ...
          return this._data &&
            ...
            (null === (e = this._source.isBracketsPLVisible()) || void 0 === e
              ? void 0
              : e.value()) &&
            this.bracketType() !== p.BracketType.TrailingStop
        ...
        profitLossTooltip() {
          ...
          switch (this._infoGetters.displayMode.value()) {
            ...
            default:
              return `${this._bracketTypeText()} ${this.pipsText(r)} ${this.percentageText(
                r,
              )} ${this.moneyText(r)}`;
          }
        }
        ...
        onMove(t) {
          ...
          null !== e &&
            ...
            t.isTouch && (0, s.ensureDefined)(this._itemCommands.exitTrackingMode)());
        }
        async onFinishMove(t = {}, e = {}, o = !0, r, i = !0) {
          ...
          (c.limitPrice = null !== (l = e.limitPrice) && void 0 !== l ? l : c.limitPrice),
            (c.takeProfit = null !== (a = e.takeProfit) && void 0 !== a ? a : c.takeProfit),
            (c.stopLoss = null !== (d = e.stopLoss) && void 0 !== d ? d : c.stopLoss),
            c.stopPrice ? (c.stopPrice = h) : c.limitPrice && (c.limitPrice = h),
        ...
        async onContextMenu(t, e) {
          this.fireProfitLossChange(),
            (e = (0, b.mergeGaParams)(e, { origin: 'Chart Order Context Menu' }));
          const o = this._composeContextMenuActions(e),
            r = {
              side: (0, y.sideToText)(this._data.side),
              qty: this.qtyText(),
              price: this.priceText(),
              orderType: (0, y.orderTypeToText)({ orderType: this._data.type }),
              formatPlWV: this._isBracket() ? this.formatPlWV() : void 0,
            },
            i = await (async function (t, e) {
              const o = [],
                r = await (0, v.createContextMenuTitle)(e);
              r && o.push(r);
              for (const { actionId: e, label: r, onExecute: i } of t)
                o.push(new d.Action({ actionId: e, label: r, onExecute: i }));
              return o;
            })(o, r),
            s = this._infoGetters.noOverlapAction(e, t => this._trackEventGA(t));
          s && (i.push(new d.Separator()), i.push(s)),
            (this._contextMenu = await (0, v.showContextMenu)(i, t, () => {
              this._contextMenu = null;
            }));
        }
          ...
          return (
            this.supportModify() &&
              e.push({
                ...
                label: this._source.isPlaced() ? P : x,
                onExecute: () => this.onModify(t),
              }),
            this.supportClose() &&
              e.push({
                actionId: 'Trading.CancelOrder',
                label: this._source.isPlaced() ? k : T,
        ...
        _calcPriceByDiff(t) {
          const { minTick: e, variableMinTickData: o } = (0, s.ensureNotNull)(
            ...
            i = (0, h.getMinTick)({ minTick: e, price: r, variableMinTickData: o });
        ...
        _addTrailingStopPipsData(t, e) {
          ...
          if (o) {
            const { side: r, stopPrice: i, limitPrice: l } = o.data(),
              { pipSize: a } = (0, s.ensureNotNull)(this._symbolDataProvider.symbolData());
            if (void 0 !== e) {
              const o = (0, s.ensureDefined)(t.stopPrice || t.limitPrice);
              t.trailingStopPips = (0, m.calcPipsByPrice)(e, o, r, a);
            } else if (
              (0, f.isBracketOrderRawData)(t) &&
              t.parentId &&
              t.stopType === _.StopType.TrailingStop
            ) {
              const { bid: e, ask: n } = (0, s.ensureNotNull)(this._symbolDataProvider.lastData());
              let d;
        ...
        _bracketTypeText(t) {
          if (!this._data) return '';
          if (this._isBracket()) {
            const e = (0, C.getBracketTypeToText)(this._data.type, this._data.stopType, t);
            if (null !== e) return e;
          }
          return t
            ? (0, y.orderTypeToText)({ orderType: this._data.type, uppercase: !0, shorten: !0 })
            : `${(0, y.sideToText)(this._data.side)} ${(0, y.orderTypeToText)({
        ...
        _potentialProfitLoss() {
          ...
          const e = this.price(),
            ...
            i =
              t.tryBasePlOnLast() &&
              3 === this._data.type &&
              this._data.stopType === _.StopType.TrailingStop;
        ...
        _isBracket() {
          const t = this.data();
          if (!(0, f.isBracketOrderRawData)(t)) return !1;
          const e = this._source.mainItem();
        ...
        _toggleQtyCalc(t, e = new a.Point(0, 0), o = {}) {
          ...
          const { onToggleQtyCalcHandler: r, qtyInfoGetter: i } = (0, s.ensureDefined)(
            this._qtyModifyCallbacks,
          );
          r(
    ...
    279460: (t, e, o) => {
      ...
      class l extends s.OrderBaseItem {
        ...
        destroy() {
          var t;
          null === (t = this._typeMenuCallbacks) || void 0 === t || t.closeDropdownMenuHandler(),
            super.destroy();
        }
        isMovingEnabled() {
          return !0;
        ...
        toggleType(t, e, o = {}) {
          this._typeMenuCallbacks &&
            ((this._isTypeMenuOpened = !this._isTypeMenuOpened), this._toggleTypeMenu(t, e, o));
        }
        async onClose(t) {}
        async onModify(t) {
          return !1;
        ...
        _toggleTypeMenu(t, e = new i.Point(0, 0), o = {}) {
          (0, r.ensureDefined)(this._typeMenuCallbacks).onToggleTypeMenuHandler(
    ...
    566884: (t, e, o) => {
      'use strict';
      o.d(e, { TradedGroupItemType: () => r, createItem: () => v });
      var r,
        i = o(650151),
        s = o(822914),
        l = o(781585),
      ...
      class m {
        ...
        destroy() {
          var t;
          null === (t = this._qtySuggesterSubscription) || void 0 === t || t.unsubscribe();
        }
        suggestedQty() {
          return this._suggestedQty;
        }
        applySuggestedQty(t) {
          void 0 === this._qtySuggesterSubscription && this._subscribeQtySuggester(),
            this._qtySuggester.setQty(this._symbol, t),
            this._lastSuggestedQty !== t && this._suggestedQty.setValue(this._lastSuggestedQty, !0);
        }
      ...
      function v(t, e, o, y, v) {
        const f = y.mainSeries(),
          b = (t, e) =>
            (0, l.createNoOverlapMenuAction)(
              v.itemExternalServices.tradedGroupRenderersController,
              t,
              e,
            );
        if (t === r.Order && (0, a.isOrderItemRawData)(e)) {
          const { dataType: t, ...r } = e,
            i = t => (0, u.getDefaultStyleForOrderItem)(t, o, () => y.dark().value());
          return new c.OrderItem(
            r,
            o,
            f,
            v.itemExternalServices.symbolDataProvider,
            {
              displayMode: o.bracketsDisplayMode(),
              style: i,
              visibility: v.visibilityGetters.order,
              noOverlapAction: b,
            },
            {
              trackEvent: v.sourceCallbacks.trackEvent,
              exitTrackingMode: v.sourceCallbacks.exitTrackingMode,
            },
            void 0,
            v.gaOrigin,
          );
        ...
        if (t === r.Position && (0, a.isPositionItemRawData)(e)) {
          ...
          return new p.PositionItem(
            ...
            v.itemExternalServices.symbolDataProvider,
            {
              ...
              style: t,
              visibility: v.visibilityGetters.position,
              noOverlapAction: b,
            },
            { trackEvent: v.sourceCallbacks.trackEvent },
          );
        ...
        if (t === r.LimitPartStopLimitOrder && (0, a.isOrderItemRawData)(e)) {
          const t = t => (0, u.getDefaultStyleForOrderItem)(t, o, () => y.dark().value()),
            r = {
              ...(0, s.default)(e),
            ...
            { dataType: l, ...a } = r;
          let n;
          if (v.qtyModifyCallbacks) {
            n = {
              qtyProvider: new m(a.symbol, a.qty, v.itemExternalServices.qtySuggester),
              ...(0, i.ensureDefined)(v.qtyModifyCallbacks),
            };
          }
        ...
        if (t === r.PreOrder && (0, a.isPreOrderItemRawData)(e)) {
          const t = t => (0, u.getDefaultStyleForOrderItem)(t, o, () => y.dark().value()),
            { dataType: r, ...s } = e,
            l = new m(s.symbol, s.qty, v.itemExternalServices.qtySuggester);
          return new _.PreOrderItem(
            ...
            v.menuCallbacks,
            { qtyProvider: l, ...(0, i.ensureDefined)(v.qtyModifyCallbacks) },
          );
        }
        throw new Error('Unknown traded item type');
      }
      ...
      class a extends l.OrderItem {
        ...
        async onFinishMove(t, e = {}, o = !0, s) {
          ...
          (l.limitPrice = a),
            ...
            void 0 === s && (s = 1),
            this._trackEventGA(t);
          const n = await (0, r.ensureDefined)(this._data.callbacks.moveOrder)(l.id, l, s);
          return (this._inEdit = !1), this._source.setIsBlocked(!1), this._source.syncData(), n;
        }
        profitLossText(t) {
          return this._source.isPlaced()
            ? this._bracketTypeText(t)
            : (0, s.orderTypeToText)({ orderType: this.data().type, uppercase: t, shorten: t });
        }
        supportClose() {
          return !1;
        }
    ...
    962881: (t, e, o) => {
      ...
      class h extends n.OrderBaseItem {
        ...
        async onModify(t = {}, e, o) {
          ...
          const l = await (0, r.ensureDefined)(this._data.callbacks.modifyOrder)(s.id, s, e, o);
          return this._source.setIsBlocked(!1), this._source.syncData(), l;
        }
        async onClose(t = {}) {
          this._source.isBlocked() ||
            (this._source.setIsBlocked(!0),
            this._trackEventGA((0, a.mergeGaParams)(t, { event: 'Cancel Order' })),
            await (0, r.ensureDefined)(this._data.callbacks.cancelOrder)(this._data.id),
            this._source.setIsBlocked(!1),
            this._source.syncData());
        }
        _onFinishMoveOrder(t, e, o = !0) {
          return this._data.callbacks.moveOrder || this._data.supportModifyOrderPrice
            ? (0, r.ensureDefined)(this._data.callbacks.moveOrder)(t.id, t, e)
            : (0, r.ensureDefined)(this._data.callbacks.modifyOrder)(t.id, t, e, o);
        }
        _calcId() {
    ...
    531979: (t, e, o) => {
      ...
      const l = (0, i.generateColor)(r.colorsPalette['color-tv-blue-500'], 85),
        ...
        b = {
          ...
          sell: { normal: m, disabled: (0, s.generateBlendColors)(m, _) },
          takeProfit: { normal: v, disabled: (0, s.generateBlendColors)(v, _) },
    ...
    998952: (t, e, o) => {
      'use strict';
      o.d(e, { getDefaultStyleForOrderItem: () => a, getStyleForOppositeDirection: () => n });
      var r = o(694454),
        i = o(656846),
        s = o(310328),
        l = o(531979);
      function a(t, e, o, a = {}) {
        ...
        return { ...h, lineStyle: u, borderStyle: u, labelBorderVisible: !0, ...a };
      }
      function n(t, e, o) {
    ...
    25412: (t, e, o) => {
      ...
      var r = o(650151),
        ...
        _ = o(735415),
        y = o(509806);
      const m = (0, o(350299).appendEllipsis)(y.t(null, void 0, o(888310))),
        v = y.t(null, void 0, o(424356)),
        f = y.t(null, void 0, o(920848));
      const b = (0, d.getLogger)('Trading.Positions'),
        C = l.enabled('chart_hide_close_position_button');
      class g extends _.BaseItem {
        constructor(t, e, o, r, i, s) {
          super(t, e, o, r, 'Chart Position', i, s),
            this._source.positionDisplayMode().subscribe(this, this.fireProfitLossChange);
        }
        destroy() {
          this._source.positionDisplayMode().unsubscribe(this, this.fireProfitLossChange),
            super.destroy();
        }
        currency() {
          var t;
          return null !== (t = this._symbolDataProvider.positionCurrency()) && void 0 !== t
            ? t
            : '';
        }
        profitLossTextColor() {
        ...
        supportClose() {
          return !C && this._data.supportClose;
        }
        async onClose(t = {}) {
        ...
        async onModifyWithBracket(t = {}, e = {}, o = !0, i, s = !0) {
          ...
          const n = this._symbolDataProvider.lastData(),
            d = null !== (l = null == n ? void 0 : n.bid) && void 0 !== l ? l : null,
            c = null !== (a = null == n ? void 0 : n.ask) && void 0 !== a ? a : null;
          if (void 0 !== e.trailingStop && d && c) {
            const t = 1 === this._data.side ? d : c,
              { pipSize: o } = (0, r.ensureNotNull)(this._symbolDataProvider.symbolData());
            (e.trailingStopPips = (0, u.calcPipsByPrice)(e.trailingStop, t, this._data.side, o)),
        ...
        async onContextMenu(t, e) {
          this.fireProfitLossChange();
          const o = {};
          (e = (0, p.mergeGaParams)(e, { origin: 'Chart Position Context Menu' })),
            this.supportClose() && (o.closePosition = this.onClose.bind(this, e)),
            this.supportReverse() && (o.reversePosition = this.onReverse.bind(this, e)),
            this.supportModify() && (o.modifyPosition = this.onModify.bind(this, e));
          const r = {
            ...
            i = await (async function (t, e) {
              const o = [],
                r = await (0, h.createContextMenuTitle)(e);
              return (
                r && o.push(r),
          ...
          l && (i.push(new s.Separator()), i.push(l)),
            (this._contextMenu = await (0, h.showContextMenu)(i, t, () => {
              this._contextMenu = null;
            }));
        }
        tryBasePlOnLast() {
        ...
        _potentialProfitLoss() {
          ...
          const { trade: s, ask: l, bid: n } = this._symbolDataProvider.lastData() || {},
            d =
              null !== (t = this._data.plBasedOnLast ? s : this.isBuyDirection() ? n : l) &&
              void 0 !== t
                ? t
                : r;
        ...
        async _doActionWithBlock(t, e, o = {}, i = {}, s, l) {
          ...
          try {
            a =
              'modifyPosition' === t
                ? await (0, r.ensureDefined)(this._data.callbacks.modifyPosition)(
                    this._data.id,
                    i,
                    s,
                    l,
                  )
                : await (0, r.ensureDefined)(this._data.callbacks[t])(this._data.id);
          } catch (e) {
            b.logWarn(`Try to ${t}, but got error: ${(0, n.errorToString)(e)}`);
          } finally {
    ...
    423757: (t, e, o) => {
      ...
      const a = {
        ...
        d = {
          buy: { normal: a, disabled: (0, l.generateBlendColors)(a, s.overlayColor) },
          sell: { normal: n, disabled: (0, l.generateBlendColors)(n, s.overlayColor) },
        };
      var c = o(310328);
      const h = {
        ...
        p = {
          buy: { normal: h, disabled: (0, l.generateBlendColors)(h, c.overlayColor) },
          sell: { normal: u, disabled: (0, l.generateBlendColors)(u, c.overlayColor) },
        };
    ...
    874833: (t, e, o) => {
      ...
      class n extends l.OrderWithMenuItem {
        ...
        profitLossText(t) {
          return (0, s.orderTypeToText)({ orderType: this.data().type, uppercase: t, shorten: t });
        }
        profitLossTooltip() {
          return a;
        }
    ...
    483186: (t, e, o) => {
      ...
      const u = l.t(null, { context: 'Stop loss' }, o(653315)),
        ...
        m = l.t(null, void 0, o(46742)),
        v = l.t(null, void 0, o(416976));
      class f extends h.OrderWithMenuItem {
        style() {
          return this._infoGetters.style(this);
        }
        setPrice(t) {
          const { minTick: e } = (0, r.ensureNotNull)(this._symbolDataProvider.symbolData());
        ...
        profitLossText(t) {
          var e;
          return (null === (e = this._source.isBracketsPLVisible()) || void 0 === e
            ? void 0
        ...
        async onMove(t) {
          ...
          this.setPrice(l),
            t.isTouch && (0, r.ensureDefined)(this._itemCommands.exitTrackingMode)();
        }
        lineStyle() {
    ...
    74516: (t, e, o) => {
      ...
      function v(t, e, o) {
        const r = e === s.BracketType.TrailingStop ? l.StopType.TrailingStop : void 0,
    ...
    781585: (t, e, o) => {
      ...
      function n(t, e, o) {
        const r = (0, l.mergeGaParams)(e, { event: 'No overlap orders and positions' });
        return new i.Action({
    ...
    764533: (t, e, o) => {
      ...
      function m(t) {
        const {
          ...
          onDestroy: l,
          onSelect: m,
          customCloseSubscriptions: v = [],
        } = t;
        (0, n.useGlobalCloseOnScrollAndCustomEvents)(v);
        const f = t.items.map(
          t => (
        ...
        return r.createElement(
          h.DrawerManager,
          null,
          r.createElement(d.MatchMedia, { rule: 'screen and (max-width: 430px)' }, t =>
            t
              ? r.createElement(
                  c.Drawer,
              ...
              : r.createElement(
                  a.TooltipPopup,
                  { position: e, onClose: s, onClickOutside: b, onForceClose: l },
                  f,
                ),
          ),
        );
      ...
      function f() {
        i.unmountComponentAtNode((0, l.ensureNotNull)(v));
      }
      function b(t, e, o, a, n, d, c, h, u) {
        ...
        i.render(r.createElement(m, { ...p }), v);
      }
    },
    645254: (t, e, o) => {
      'use strict';
      ...
      function c(t, e, o, l, a, n, d, c, h) {
        ...
        let k = Math.trunc(m / (C + P));
        const T = Math.trunc((m % (C + P)) / 2),
          x = [];
        for (x.push(g + T); k > 1; ) x.push(P, C), k--;
        x.push(P, g + T),
          t.setLineDash(x),
          (0, i.drawHorizontalLine)(t, b, f, f + Math.round(m)),
          t.translate(l, a + n),
          (0, s.drawScaled)(t, e, e, () => {
            t.fillText(o, 0, 0);
          }),
