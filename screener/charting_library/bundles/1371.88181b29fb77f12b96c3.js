(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1371, 4773, 1277],
  {
                ...
                (c = [].concat(t(c), [d])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !f(n.target) &&
                        ((r && 0 === r.scrollTop && 0 < c) ||
                        ((o = r) && o.scrollHeight - o.scrollTop <= o.clientHeight && c < 0)
                          ? l(n)
                          : n.stopPropagation()));
                  }),
                  u ||
                    (document.addEventListener('touchmove', l, n ? { passive: !1 } : void 0),
                    (u = !0));
              }
            } else {
              (v = r),
            ...
            (e.clearAllBodyScrollLocks = function () {
              o
                ? (c.forEach(function (e) {
                  ...
                  u &&
                    (document.removeEventListener('touchmove', l, n ? { passive: !1 } : void 0),
                    (u = !1)),
                  (c = []),
                  (a = -1))
                : (d(), (c = []));
    ...
    386942: (e, t, n) => {
      ...
      function w(e, t, n, r, { areStatesEqual: o, areOwnPropsEqual: c, areStatePropsEqual: u }) {
        let a,
          i,
          s,
          f,
        ...
        function p(d, p) {
          ...
          return (
            ...
            (i = p),
            v && y
              ? ((s = e(a, i)), t.dependsOnOwnProps && (f = t(r, i)), (l = n(s, f, i)), l)
              : v
        ...
        return function (o, c) {
          return d
            ? p(o, c)
            : ((a = o), (i = c), (s = e(a, i)), (f = t(r, i)), (l = n(s, f, i)), (d = !0), l);
        };
      }
      function x(e) {
        return function (t) {
      ...
      function N(e, t) {
        ...
        for (let r = 0; r < n.length; r++)
          if (!Object.prototype.hasOwnProperty.call(t, n[r]) || !j(e[n[r]], t[n[r]])) return !1;
        return !0;
      }
      ...
      function L(e, t, n, r, o, c) {
        (e.current = r), (n.current = !1), o.current && ((o.current = null), c());
      }
      function D(e, t) {
        return e === t;
      }
      const q = function (
        ...
        const d = l,
          p = (function (e) {
            return e ? ('function' == typeof e ? P(e) : T(e, 'mapStateToProps')) : x(() => ({}));
          })(e),
          v = (function (e) {
        ...
        return e => {
          ...
          function s(t) {
            const [n, o, c] = (0, i.useMemo)(() => {
              ...
              u = (0, i.useMemo)(
                () =>
                  n && n.Consumer && (0, b.isContextConsumer)(i.createElement(n.Consumer, null))
                    ? n
                    : d,
                [n, d],
              ),
            ...
            const N = (0, i.useMemo)(
              ...
              D = (0, i.useMemo)(
                () => e =>
                  y
                    ? (function (e, t, n, r, o, c, u, a, i, s, f) {
                        if (!e) return () => {};
                        let l = !1,
                          d = null;
                        const p = () => {
                          ...
                          p || (d = null),
                            n === c.current
                              ? u.current || s()
                              : ((c.current = n), (i.current = n), (u.current = !0), f());
                        };
                        return (
                          (n.onStateChange = p),
                          n.trySubscribe(),
          ...
          const l = i.memo(s);
          if (((l.WrappedComponent = e), (l.displayName = s.displayName = n), f)) {
            const t = i.forwardRef(function (e, t) {
              return i.createElement(l, (0, m.default)({}, e, { reactReduxForwardedRef: t }));
            });
      ...
      const B = function ({ store: e, context: t, children: n, serverState: r }) {
        const o = (0, i.useMemo)(() => {
            const t = k(e);
    ...
    254773: (e, t, n) => {
      ...
      var P = { type: r.CHANNEL_END_TYPE },
        T = function (e) {
          return e && e.type === r.CHANNEL_END_TYPE;
        };
      function M(e) {
        void 0 === e && (e = (0, a.e)());
        var t = !1,
      ...
      var _ =
        ...
        (j[a.C] = function (e, t, n, r) {
          ...
          try {
            ...
            if ((0, u.iterator)(f)) return void U(e, f, s.context, N, (0, a.j)(c), !1, n);
            n(f);
          } catch (e) {
            n(e, !0);
          }
        ...
        (j[a.b] = function (e, t, n, o) {
          var c = o.task;
          t === r.SELF_CANCELLATION ? A(c) : (0, u.array)(t) ? t.forEach(A) : A(t), n();
        }),
        (j[a.S] = function (e, t, n) {
          var r = t.selector,
            o = t.args;
          try {
        ...
        (j[a.g] = function (e, t, n) {
          t.flush(n);
        }),
        (j[a.G] = function (e, t, n, r) {
          n(r.task.context[t]);
        }),
        (j[a.h] = function (e, t, n, r) {
          var o = r.task;
          (0, a.p)(o.context, t), n();
        }),
        j);
      ...
      var B = null,
        ...
        z = function () {
          var e,
            ...
            o = n.crashedEffect
              ? ((e = n.crashedEffect),
                (t = (0, a.v)(e)) ? t.code + '  ' + L(t.fileName, t.lineNumber) : '')
              : null;
          return [
      ...
      function W(e, t, n, o, c, u, i) {
              ...
              o.push(t),
                (t.cont = function (i, s) {
                  c ||
                    ((0, a.r)(o, t),
                    (t.cont = a.t),
                    s ? u(i) : (t === e && (r = i), o.length || ((c = !0), n(r))));
                });
            }
            function s() {
              c ||
        ...
        function g(t, n) {
          if (n) {
            ...
            (d = t), v && v.reject(t);
          } else t === r.TASK_CANCEL ? (p = 1) : 1 !== p && (p = 3), (l = t), v && v.resolve(t);
          S.cont(t, n),
        ...
        var S =
          ...
          (s.toPromise = function () {
            return v || ((v = f()), 2 === p ? v.reject(d) : 0 !== p && v.resolve(l)), v.promise;
          }),
        ...
        function v(e, n) {
          try {
            ...
            n
              ...
              : (c = (0, a.z)(e) ? ((0, u.func)(t.return) ? t.return() : { done: !0 }) : t.next(e)),
              c.done ? (1 !== l.status && (l.status = 3), l.cont(c.value)) : y(c.value, o, v);
          } catch (e) {
        ...
        function y(t, n, r, o) {
          ...
          function i(n, o) {
            c ||
              ...
              (r.cancel = a.t),
              e.sagaMonitor &&
                (o ? e.sagaMonitor.effectRejected(u, n) : e.sagaMonitor.effectResolved(u, n)),
              o &&
                (function (e) {
                  B = e;
                })(t),
          ...
          e.sagaMonitor &&
            e.sagaMonitor.effectTriggered({ effectId: u, parentEffectId: n, label: o, effect: t }),
            (i.cancel = a.t),
            (r.cancel = function () {
              c ||
                ((c = !0),
      ...
      function V(e, t) {
        var n = e.channel,
          ...
          d = e.onError,
          p = void 0 === d ? a.B : d;
        for (var v = arguments.length, m = new Array(v > 2 ? v - 2 : 0), h = 2; h < v; h++)
          m[h - 2] = arguments[h];
