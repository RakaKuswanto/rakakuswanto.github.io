  ...
  [607],
  {
    487816: (e, t, i) => {
      ...
      const d = new a.TranslatedString(
          ...
          n.t(null, void 0, i(616688)),
        ),
        c = new a.TranslatedString('change {title} base line color', n.t(null, void 0, i(397029))),
        h = new a.TranslatedString('change {title} base line width', n.t(null, void 0, i(951676))),
        u = new a.TranslatedString('change {title} base line style', n.t(null, void 0, i(303868))),
        p = new a.TranslatedString(
          'change {title} up line visibility',
          n.t(null, void 0, i(117564)),
        ),
        y = new a.TranslatedString('change {title} up line color', n.t(null, void 0, i(325253))),
        g = new a.TranslatedString('change {title} up line width', n.t(null, void 0, i(666118))),
        b = new a.TranslatedString('change {title} up line style', n.t(null, void 0, i(758003))),
        _ = new a.TranslatedString(
          'change {title} down line visibility',
          n.t(null, void 0, i(23527)),
        ),
        m = new a.TranslatedString('change {title} down line color', n.t(null, void 0, i(315438))),
        v = new a.TranslatedString('change {title} down line width', n.t(null, void 0, i(344470))),
        f = new a.TranslatedString('change {title} down line style', n.t(null, void 0, i(541970))),
        w = new a.TranslatedString('change {title} extend lines', n.t(null, void 0, i(896902))),
        k = new a.TranslatedString("change {title} show pearson's r", n.t(null, void 0, i(38317))),
        S = n.t(null, void 0, i(455719)),
        P = n.t(null, void 0, i(798802)),
        z = n.t(null, void 0, i(741361)),
        I = n.t(null, void 0, i(814105)),
        D = n.t(null, void 0, i(513611));
    ...
    746418: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        c = i(650802),
        h = i(311757);
      const u = new a.TranslatedString('change {inputName} property', n.t(null, void 0, i(621547)));
      function p(e, t) {
        const i = e.id;
        return (
      ...
      function g(e) {
        return n.t(e, { context: 'input' }, i(788601));
      }
      var b = i(44520),
        _ = i(597399),
        m = i(739343),
        v = i(412548),
        f = i(562051);
      const w = n.t(null, void 0, i(832733)),
        k = n.t(null, void 0, i(666304)),
        S = n.t(null, void 0, i(221852)),
        P = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'].map(
          e => ({ value: e, title: (0, m.getTranslatedResolutionModel)(e).hint }),
        );
      var z = i(738597),
        I = i(681434);
      const D = new a.TranslatedString('change study overlay style', n.t(null, void 0, i(705529))),
        T = new a.TranslatedString('change price line visibility', n.t(null, void 0, i(867761))),
        L = new a.TranslatedString('change study overlay min tick', n.t(null, void 0, i(470016))),
        N = n.t(null, void 0, i(16812)),
        M = n.t(null, void 0, i(463528)),
        j = n.t(null, void 0, i(661582)),
        Y = n.t(null, void 0, i(636018)),
        x = n.t(null, void 0, i(301277)),
        W = n.t(null, void 0, i(542097)),
        A = n.t(null, void 0, i(134911)),
        U = n.t(null, void 0, i(117712)),
        E = n.t(null, void 0, i(631994)),
        C = n.t(null, void 0, i(938397)),
        B = n.t(null, void 0, i(79511)),
        H = n.t(null, void 0, i(832733)),
        R = n.t(null, void 0, i(491492)),
        V = n.t(null, void 0, i(836993)),
        X = [
          { title: N, value: 0 },
          { title: M, value: 1 },
          { title: j, value: 9 },
      ...
      class O extends class {
        ...
        destroy() {
          null !== this._inputSourceItems &&
            this._undoModel.model().dataSourceCollectionChanged().unsubscribeAll(this),
        ...
        _inputsPropertyDefinitions() {
          ...
          return (
            null !== this._sourceInput &&
              (this._inputSourceItems = new c.WatchedValue(this._getInputSourceItems())),
            (function (e, t, l, o, d) {
              const h = [];
              for (const b of t) {
                if (!p(b, o)) continue;
                ...
                if ('resolution' === b.type)
                  f = (0, s.createOptionsPropertyDefinition)(
                    ...
                    { id: _, title: m, options: new c.WatchedValue(d.resolutionItems) },
                  );
                  ...
                  for (const e of b.options) {
                    const a = (b.optionsTitles && b.optionsTitles[e]) || e,
                      l = n.t(a, { context: 'input' }, i(788601));
                ...
                else if ('integer' === b.type || 'float' === b.type || 'price' === b.type) {
                  const t = {
                    id: _,
                    title: m,
        ...
        _getInputSourceItems() {
          ...
          if (this._source && this._source.isChildStudy()) {
            ...
            for (const t of Object.keys(l)) e.push({ id: t, value: t, title: l[t] });
          }
          if (
            l.enabled('study_on_study') &&
            this._source &&
            (this._source.isChildStudy() || _.StudyMetaInfo.canBeChild(this._source.metaInfo()))
          ) {
            ...
            this._undoModel
              ...
              .forEach(t => {
                const i = t.title(f.TitleDisplayTarget.StatusLine, !0, void 0, !0),
                  n = t.sourceId() || '#' + t.id(),
                  a = t.metaInfo(),
                  l = a.styles,
                  s = a.plots || [];
            ...
            this._source
              ...
              .style.subscribe(this, e => {
                ...
                null !== this._stylesPropertyPage &&
                  ((0, s.destroyDefinitions)(this._stylesPropertyPage.definitions.value()),
        ...
        _stylePropertyDefinitions() {
          void 0 === this._availableStylesWV &&
            ((this._availableStylesWV = new c.WatchedValue(this._availableStyles())),
          ...
          const e = this._source.properties().childs(),
            t = (0, s.createOptionsPropertyDefinition)(
              ...
              { id: 'StudyOverlayStyle', title: H, options: this._availableStylesWV },
            ),
        ...
        _getSeriesStylesDefinitions() {
          ...
          return (0, z.getSeriesStylePropertiesDefinitions)(
            ...
            e,
            t,
            { seriesPriceSources: b.basePriceSources, isJapaneseChartsAvailable: !1 },
            'mainSeries',
          );
        }
        _availableStyles() {
          ...
          return X.map(t =>
            t.readonly
              ...
              : {
                  ...
                  title: t.title,
                  disabled:
                    (0, I.isCloseBasedSymbol)(e) && !(0, I.isSingleValueBasedStyle)(t.value),
                },
          );
        }
      }
