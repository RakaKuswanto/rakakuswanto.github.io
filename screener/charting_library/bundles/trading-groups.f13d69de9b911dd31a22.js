...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    16951: (e, t, i) => {
      i.r(t), i.d(t, { TradedSourcesManager: () => Q, canCreateOrUpdateSourceByContext: () => z });
      var r,
        s = i(822914),
        a = i(650151),
        o = i(372605),
      ...
      class v {
        ...
        _alignItemsHorizontally(e) {
          if (null === this._horizontalBorderPoint) {
            ...
            let r = i[0].right,
              s = i[0].left;
            for (const e of i) e.right > r && (r = e.right), e.left < s && (s = e.left);
            (this._horizontalBorderPoint = { rightmostBorder: r, leftmostBorder: s }),
              this._renderers.forEach(t =>
                t.applyHorizontalOffset((0, a.ensureNotNull)(this._horizontalBorderPoint), e),
              );
          }
        }
        _checkIfItemsOverlap(e) {
          ...
          for (let s = 1; s < t.length; s++) {
            const a = t[s],
              o = t[s - 1];
            if (a.rect(e).top - o.rect(e).bottom + r.Threshold <= 0) {
              i = !0;
              break;
            }
          }
        ...
        _alignItemsVertically(e) {
          ...
          for (let i = 1; i < t.length; i++) {
            const s = t[i],
              a = t[i - 1];
            s.rectWithOffsets(e).top - a.rectWithOffsets(e).bottom + r.Threshold <= 0 &&
              (s.clearCache(), s.setAlignedTopCoordinate(a.rectWithOffsets(e).bottom));
          }
        }
        _getSortedRenderers(e) {
          return (
            null === this._sortedItemRenderers &&
              (this._sortedItemRenderers = this._getVisibleItemRenderers(e).sort(
                (e, t) => t.data().sortingIndex - e.data().sortingIndex,
              )),
          ...
          if (null === this._visibleItemsRenderers) {
            ...
            for (const t of this._renderers) {
              const i = t.itemRenderers().filter(t => {
                const i = t.rect(e);
                return t.data().visible && i.top < e.physicalHeight && i.bottom > 0;
              });
      ...
      var f = i(807107),
        ...
        k = i(815628),
        P = i(466052);
      const S = (0, d.getLogger)('Trading.Source.SymbolDataProvider');
      class T {
        constructor(e, t, i, r, s, a) {
          (this._symbol = null),
            ...
            (this._symbolData = {
              ...
              priceFormatter: new k.PriceFormatter(),
            }),
            (this._currencyGetters = { 1: i, 0: r }),
            (this._pipValueType$ = s),
            S.logNormal(
              `[Symbol_${this._symbol}] Init with default values: minTick ${
                this._symbolData.minTick
              }, pipSize ${this._symbolData.pipSize}, pipValue: ${JSON.stringify(
                this.pipValue(),
              )}, pipValueType ${this._pipValueType}`,
            ),
            (this._updateLastHandler = this._updateLast.bind(this)),
            (this._makeActualTradingSymbolObservable = a),
            this._mainSeries
              .dataEvents()
              .symbolResolved()
        ...
        start(e) {
          if (
            (null !== this._symbol &&
              null === e &&
              (this._stop(), S.logNormal('Current symbol null')),
            (this._symbol = e),
            !this.isActualSymbol() || this._isStarted)
          )
            return;
          const t = (0, a.ensureNotNull)(this._symbol);
          S.logNormal(`Start symbol ${t}`),
            (this._isStarted = !0),
            this._realtimeProvider.subscribeRealtime(t, this._updateLastHandler),
            this._realtimeProvider.onStatusChanged.subscribe(this, this._updateSymbolData),
        ...
        pipValue() {
          var e, t;
          return null !==
            (t = null === (e = this._pipValuesSpawn) || void 0 === e ? void 0 : e.value()) &&
            void 0 !== t
            ? t
            : null;
        }
        ...
        getMinTick(e) {
          const t = (0, a.ensureNotNull)(this._symbolData);
        ...
        _updateActualTradingSymbol() {
          var e;
          (this._actualTradingSymbol = null),
            null === (e = this._actualTradingSymbolSubscription) || void 0 === e || e.unsubscribe();
          const t = this._mainSeries.symbolInfo();
          null !== t
            ? (this._actualTradingSymbolSubscription = this._makeActualTradingSymbolObservable(
                t.pro_name,
              ).subscribe(({ symbol: e }) => {
                e !== this._actualTradingSymbol &&
                  ((this._actualTradingSymbol = e), this.start(this._symbol));
              }))
            : this.start(this._symbol);
        }
        _stop() {
          var e, t, i;
          S.logNormal(`Stop symbol ${this._symbol}`),
            this._realtimeProvider.unsubscribeRealtime(
              (0, a.ensureNotNull)(this._symbol),
            ...
            (this._pipValuesSpawn = null),
            null === (t = this._pipValueTypeSubscription) || void 0 === t || t.unsubscribe(),
            null === (i = this._actualTradingSymbolSubscription) || void 0 === i || i.unsubscribe(),
        ...
        async _updateSymbolData() {
          ...
          if (!this._isValidSymbol())
            return void S.logNormal(
              `Can't update symbol data because symbol '${
                this._symbol
              }' not valid (isActualSymbol ${this.isActualSymbol()})`,
            );
          const t = (0, a.ensureNotNull)(this._symbol),
          ...
          (this._symbolData = {
            ...
            variableMinTickData: s.variableMinTick
              ...
              : void 0,
            lotSize: s.lotSize,
            priceMagnifier: null !== (e = s.priceMagnifier) && void 0 !== e ? e : 1,
          }),
            S.logNormal(
              `[Symbol_${this._symbol}] Update symbol data values: minTick ${
                this._symbolData.minTick
              }, pipSize ${this._symbolData.pipSize}, pipValue: ${JSON.stringify(
                this.pipValue(),
              )}, pipValueType ${this._pipValueType}`,
        ...
        _updateLast(e, t) {
          var i, r, s, a, o, n;
          ((null === (i = this._last) || void 0 === i ? void 0 : i.ask) !== t.ask ||
            (null === (r = this._last) || void 0 === r ? void 0 : r.bid) !== t.bid ||
            (null === (s = this._last) || void 0 === s ? void 0 : s.trade) !== t.trade) &&
            this._isValidSymbol() &&
            ((this._last = {
              trade: null !== (a = t.trade) && void 0 !== a ? a : NaN,
              ask: null !== (o = t.ask) && void 0 !== o ? o : NaN,
        ...
        _createPipsHelpersSpawns() {
          ...
          if (e) {
            const e = (0, a.ensureNotNull)(this._realtimeProvider.activeBroker());
            (this._pipValuesSpawn = (function (e, t, i, r) {
              const s = e => ({ sellPipValue: e, buyPipValue: e }),
                a = new b.WatchedValue(s(1));
              let o = !1;
              (async () => {
                if (!o) {
                  const i = await t(e);
                  a.setValue(s(i.pipValue));
                }
              })();
              const n = (e, t) => {
                (o = !0), a.setValue(t);
              };
              return i(e, n), a.readonly().spawn(() => r(e, n));
            })(
              (0, a.ensureNotNull)(this._symbol),
          ...
          t &&
            (this._pipValueTypeSubscription = this._pipValueType$.subscribe(e =>
              this._updatePipValueType(e),
            )),
            (e || t) && this._onUpdate.fire();
        }
        _updatePipValueType(e) {
          (this._pipValueType = e),
            S.logNormal(`[Symbol_${this._symbol}] Update pipValueType ${this._pipValueType}`),
            this._onUpdate.fire();
        }
        _isValidSymbol() {
      ...
      function I(e, t, i, r, s) {
        const o = (function (e) {
            const t = e.properties().childs().tradingProperties.childs(),
              i = (0, l.combineProperty)(
                (e, t) => t,
                (0, l.createPrimitivePropertyFromGetterAndSubscription)(
                  e.isInReplay.bind(e),
                  e.onInReplayStateChanged(),
                ).ownership(),
                t.showOrders.weakReference(),
              ),
              r = (0, l.combineProperty)(
                (e, t) => t,
                (0, l.createPrimitivePropertyFromGetterAndSubscription)(
                  e.isInReplay.bind(e),
                  e.onInReplayStateChanged(),
            ...
            return {
              lineProperties: { width: t.lineWidth, style: t.lineStyle, extend: t.extendLeft },
          ...
          n = (function (e, t) {
            return e.has(t) || e.set(t, new v()), (0, a.ensureDefined)(e.get(t));
          })(r, t),
          {
            realtimeProvider: d,
            qtySuggester: c,
            pipValueType$: h,
            positionCurrencyGetter: u,
            orderCurrencyGetter: p,
            makeActualTradingSymbolObservable: m,
          } = i,
          _ = new T(t.mainSeries(), d, u, p, h, m),
          f = void 0 !== window.widgetbar ? window.widgetbar.visible() : new b.WatchedValue(!1);
        return s(
          o,
          ...
          _,
          c,
          (0, y.combine)(e => !e, f.weakReference()).ownership(),
        );
      }
      var D = i(637401),
        w = i(764533),
      ...
      async function M(e, t, r, s, a, o, n) {
        ...
        if (null === d) return void l.render(!1, G);
        const c = {
          ...d,
          withInput: !0,
          valueGetter: s,
          position: function (e, i, r) {
            return new B.Point(t.x - e, t.y);
          },
          targetEl: null,
          onClickOutside: function (e) {
            if (e) {
              const t = e.target.getBoundingClientRect() || { left: 0, top: 0 };
              o(new B.Point(e.clientX - t.left, e.clientY - t.top));
            }
          },
          onClose: () => {},
      ...
      var R = i(281969),
        ...
        x = i(74516),
        W = i(113211);
      class F extends R.TradedGroupBase {
        constructor(e, t, i, r, s, a, o, n, l, d, c, h, p, m) {
          super(e, t, i, r, s, n, l, d, c),
            (this._supportedOrderTypes = []),
            (this._dataUpdated = new P.Delegate()),
            ...
            (this.onQtyModify = async e => {
              ...
              this._callbacks.trackEvent('Chart Place Order', 'Change quantity'),
            ...
            this._isActiveSource.subscribe(() => this._updateConfirmButtonDisplay()),
            (this._isConfirmButtonOnDomWidgetWV = m),
            this._isConfirmButtonOnDomWidgetWV.subscribe(() => this._updateConfirmButtonDisplay(), {
              callWithLast: !0,
            }),
            ...
            (this._errors = (0, y.combine)(e => e, a.ownership())),
        ...
        async setMainOrderType(e) {
          ...
          t.type = e;
          const i = this._makePreOrderData(t),
            r = (0, D.orderTypeToText)({ orderType: e, uppercase: !1, shorten: !1 });
          this._callbacks.trackEvent('Chart Place Order', 'Change order type', r),
            await this._modifyPlaceOrder(i),
            this.redraw();
        }
        onClose(e) {
          const { origin: t = 'Chart Place Order', event: i = 'Cancel order', label: r = '' } = e;
          this._callbacks.trackEvent(t, i, r), this._cancelPlaceOrder();
        }
        onModify(e) {
          const { origin: t = 'Chart Place Order', event: i = 'Modify order', label: r = '' } = e;
        ...
        async onFinishMove(e, t) {
          this.setIsBlocked(!1);
          const { origin: i = 'Chart Place Order', event: r = 'Move Order', label: s = '' } = t;
          return (
            (t = (0, L.mergeGaParams)(
        ...
        async modifyAllItems(e, t) {
          if (void 0 !== t) {
            const { origin: e = 'Chart Place Order', event: i = 'Modify order', label: r = '' } = t;
        ...
        _createMainItem(e) {
          const t = (0, a.ensureDefined)(e.main);
          if ('PreOrder' !== t.dataType)
            throw new Error(
              `Unexpected data type for main item, it should be pre-order, not ${t.dataType}`,
            );
          const i = (0, N.createItem)(N.TradedGroupItemType.PreOrder, t, this, this._model, {
        ...
        _updateMainItem(e) {
          ...
          if (!(0, A.isPreOrderItemRawData)(e) || !(0, V.isPreOrderItem)(t)) return;
          const { dataType: i, ...r } = e;
          t.setData(r);
        }
        _createStopLimitItem(e, t) {
          let i;
          const r = (0, a.ensureDefined)(e.main);
          ...
          if (4 === t.type()) {
            ...
            i = (0, N.createItem)(
              N.TradedGroupItemType.LimitPartStopLimitOrder,
              e,
              this,
              this._model,
              {
        ...
        _dataForStopLimitOrder(e) {
          const { seenPrice: t, supportTrailingStop: i, ...r } = (0, s.default)(e);
          return {
            ...r,
            ...
            status: 6,
            considerFilledQty: !1,
            price: (0, a.ensureDefined)(e.limitPrice),
        ...
        _convertStopLimitOrderToMainItem(e, t) {
          ...
          if (
            void 0 === i ||
            !(0, A.isOrderLikeItem)(i) ||
            void 0 === e ||
            (0, A.isPositionItemRawData)(e)
          )
            return;
          const r = this._calculateSeenPrice(e),
            a = this._getCurrentQuotes();
          i.setData({
            ...(0, s.default)(t.data()),
            seenPrice: r,
            currentQuotes: a,
        ...
        _createBracketItem(e) {
          return (0, N.createItem)(
            N.TradedGroupItemType.Order,
        ...
        async _updateConfirmButtonDisplay() {
          ...
          if (e && t && !this._confirmWidgetShown) {
            ...
            const { ConfirmWidgetRenderer: e } = await Promise.all([i.e(3321), i.e(3989)]).then(
              i.bind(i, 722131),
            );
            if (this._confirmWidgetShown && !this._isDestroyed) {
              const t = (0, a.ensureDefined)(this.baseItem()),
                i = (0, l.createWVFromGetterAndSubscription)(
                  () => t.confirmText(!1),
                  this._dataUpdated,
                ),
                r = (0, l.createWVFromGetterAndSubscription)(
                  () => t.data().side,
                  this._dataUpdated,
                ),
                s = (0, y.combine)(() => this.hasError(), this._errors.weakReference());
        ...
        _makePreOrderData(e) {
          var t, i, r, s, o, n, l, d, c, h;
          const u = this._calculateSeenPrice(e),
            p = this._getCurrentQuotes(),
            { symbol: m, type: _, side: y, qty: b, isClose: v } = e,
            f = { symbol: m, type: _, side: y, qty: b, isClose: v, seenPrice: u, currentQuotes: p },
            g = (0, a.ensureNotNull)(e.price);
          switch (e.type) {
            case 4:
              ...
              f.limitPrice =
                null !==
                  (i =
                    null === (t = this.items().stopLimit) || void 0 === t ? void 0 : t.price()) &&
                void 0 !== i
                  ? i
                  : g + r * e;
              break;
          ...
          (f.takeProfit =
            ...
            (f.stopLoss =
              null !==
                (n =
                  null !== (o = null == O ? void 0 : O.price()) && void 0 !== o
                    ? o
                    : null == P
                    ? void 0
                    : P.price()) && void 0 !== n
                ...
                : void 0);
          const I = C || S,
            D = null !== (l = null == I ? void 0 : I.price()) && void 0 !== l ? l : void 0;
          if (void 0 !== I && void 0 !== D) {
            const e = (0, a.ensureNotNull)(this._symbolDataProvider.lastData()),
              t = null !== (d = null == e ? void 0 : e.bid) && void 0 !== d ? d : void 0,
              i = null !== (c = null == e ? void 0 : e.ask) && void 0 !== c ? c : void 0,
              { pipSize: r } =
                null !== (h = this._symbolDataProvider.symbolData()) && void 0 !== h ? h : {};
        ...
        _calculateSeenPrice(e) {
          var t;
          const i = (0, a.ensureNotNull)(this._symbolDataProvider.lastData());
          return null !==
            (t = 1 === e.side ? (null == i ? void 0 : i.ask) : null == i ? void 0 : i.bid) &&
            void 0 !== t
            ? t
            : 0;
        }
        _getCurrentQuotes() {
          const { ask: e, bid: t } = (0, a.ensureNotNull)(this._symbolDataProvider.lastData());
          return { ask: e, bid: t };
        }
        _getToggleOrderTypeMenuHandler() {
          return (e, t, i, r, s) => {
            var a;
            const o = this.mainItem();
            if (o.canSwitchType()) {
              this._callbacks.trackEvent(
                'Chart Place Order',
                'Order type menu opening',
                null !== (a = i.label) && void 0 !== a ? a : '',
              );
              const n = o
                  .orderTypesItems()
      ...
      const E = [1, 3, 4];
      class $ extends R.TradedGroupBase {
        constructor(e, t, i, r, s, a, o, n, l) {
          super(e, t, i, r, s, a, o, n, l),
        ...
        async onFinishMove(e, t) {
          ...
          (0, a.assert)((0, A.isOrderLikeItem)(i), 'This item does not support move'),
            (t = (0, L.mergeGaParams)(t, { event: 'Move Order', label: 'single' }));
          ...
          return (
            ...
            this.syncData(),
            this.redraw(),
            this.allItemsSupportMove(this.items(!0)) && this._callbacks.showChartHint(),
            r)
          );
        }
        async onFinishMoveProjectionBracket(e, t) {
        ...
        async modifyAllItems(e, t) {
          ...
          const {
            ...
            v = {
              limitPrice:
                null !==
                  (r =
                    null === (i = this.items().stopLimit) || void 0 === i ? void 0 : i.price()) &&
                void 0 !== r
                  ? r
                  : void 0,
              takeProfit:
                null !==
                  (o =
                    null !== (s = null == _ ? void 0 : _.price()) && void 0 !== s
                      ? s
                      : null == u
                      ? void 0
                      : u.price()) && void 0 !== o
              ...
              stopLoss:
                null !==
                  (l =
                    null !== (n = null == y ? void 0 : y.price()) && void 0 !== n
                      ? n
                      : null == p
                      ? void 0
                      : p.price()) && void 0 !== l
              ...
              trailingStop:
                null !==
                  (c =
                    null !== (d = null == b ? void 0 : b.price()) && void 0 !== d
                      ? d
                      : null == m
                      ? void 0
                      : m.price()) && void 0 !== c
            ...
            f = (0, a.ensureDefined)(this.items().main),
            g = this.findItem(e);
          (0, a.assert)((0, A.isOrderLikeItem)(g), 'This item does not support move');
          const k = this._hadBeenModifiedAllItems ? 'Move Order' : 'Add bracket from button',
            P = (function (e, t, i) {
              return (0, A.isPositionLikeItem)(i) || 'Move Order' === e
                ? 'group'
                : (0, V.isPositionItem)(t) && t.supportOnlyPairBrackets()
                ? 'both bracket'
          ...
          t = (0, L.mergeGaParams)(t, { event: k, label: P });
          const S = this._ticketFocus(g);
          let T = !1;
          return (
            (0, A.isPositionLikeItem)(f)
              ? (T = await f.onModifyWithBracket(t, v, !1, S))
              : ((T = await f.onFinishMove(t, v, !1, S)),
                this.items(!0).forEach(e => {
                  e.setInEdit(!1);
                })),
            !this._isDestroyed &&
        ...
        _createMainItem(e) {
          ...
          return (
            void 0 !== t &&
              ((0, A.isOrderItemRawData)(t)
                ? (i = (0, N.createItem)(N.TradedGroupItemType.Order, t, this, this._model, {
                    itemExternalServices: {
                      symbolDataProvider: this._symbolDataProvider,
                      qtySuggester: this._qtySuggester,
                      tradedGroupRenderersController: this._tradedGroupRenderersController,
                ...
                : (0, A.isPositionItemRawData)(t) &&
                  (i = (0, N.createItem)(N.TradedGroupItemType.Position, t, this, this._model, {
                    itemExternalServices: {
                      symbolDataProvider: this._symbolDataProvider,
                      qtySuggester: this._qtySuggester,
                      tradedGroupRenderersController: this._tradedGroupRenderersController,
        ...
        _updateMainItem(e) {
          ...
          if (void 0 !== t && void 0 !== e)
            if ((0, V.isPositionItem)(t) && (0, A.isPositionItemRawData)(e)) {
              const { dataType: i, ...r } = e;
              t.setData(r);
            } else {
              if (!(0, A.isOrderLikeItem)(t) || !(0, A.isOrderItemRawData)(e))
                throw new Error(
                  `Main item and main data are incompatible, main item type ${typeof t}, main data type ${
                    e.dataType
                  }`,
                );
              {
        ...
        _dataForStopLimitOrder(e) {
          return (
            (0, a.assert)(!(0, A.isPositionItemRawData)(e) && void 0 !== e.limitPrice),
        ...
        _ticketFocus(e) {
          if (!(0, A.isPositionLikeItem)(e)) {
            if (null !== e.bracketType())
              return e.bracketType() === h.BracketType.TakeProfit ? 3 : 4;
            switch (e.type()) {
              case 4:
                return (0, V.isLimitPartStopLimitOrderItem)(e) ? 1 : 2;
              case 1:
                return 1;
              case 3:
                return 2;
      ...
      var U = i(397728);
      const j = (0, d.getLogger)('Trading.Source.Manager');
      function q(e) {
        let t = '',
          i = '',
          r = '';
        return (
          e.main &&
            ('Position' === e.main.dataType
              ? ((t = 'Position'), (i = JSON.stringify((0, m.cropPositionData)(e.main))))
              : 'Order' === e.main.dataType
              ? ((t = 'Order'), (i = JSON.stringify((0, p.cropOrderData)(e.main))))
      ...
      window.createPlaceContext = (e, t) =>
        (0, a.ensureNotNull)(e.activeBroker()).createPlaceOrderContext(t);
      class Q {
        constructor(e, t, i, r) {
          (this._tradedGroupData = new Map()),
            ...
            (this._makeActualTradingSymbolObservable = r.makeActualSymbolObservable),
            ...
            this._addPositionItems(
              this._positionsService
                .positions()
                .map(e => ({ data: e, type: m.PositionsUpdateType.Full })),
            ),
            this._positionsService
              .positionUpdate()
        ...
        _updateTradedGroupFromLinking(e) {
          if ((0, u.isContextPlaceOrderContext)(e) && z(e)) {
            ...
            null !== this._tradedGroupPlaceData
              ...
              : ((this._tradedGroupPlaceData = new n.WatchedObject(u)),
                ...
                (l = {
                  ...
                  makeActualTradingSymbolObservable: this._makeActualTradingSymbolObservable,
                }),
                (d = this._tradedGroupRenderersControllerMap),
                (c = this._createCallbacksForPlaceOrder()),
                (h = this._trackEvent),
                o.addCustomSource(
                  'tradedPlaceOrder',
                  (e, n) =>
                    I(o, n, l, d, (d, u, p, m, _, b) => {
                      const v = (function (e) {
                          ...
                          return i && t.push(2), r && t.push(1), s && t.push(3), a && t.push(4), t;
                        })(l.realtimeProvider.activeBroker()).filter(e => E.includes(e)),
                        f = (0, y.combine)(
                          e => e.model().model() === n,
                          o.activeChartWidget.weakReference(),
                        );
                      return new F(
                        e,
                        n,
            ...
            null !== this._tradedGroupPlaceData &&
              ...
              (this._tradedGroupPlaceData = null));
          var t, i, r, s, a, o, l, d, c, h;
        }
        _createProjectionOrderErrorWV() {
          return (0, l.createWVFromGetterAndSubscription)(() => {
            var e, t;
            return null !==
              (t =
                null === (e = this._tradedContextLinking.context()) || void 0 === e
                  ? void 0
                  : e.errors()) && void 0 !== t
              ? t
              : {};
        ...
        _createPlaceSourceData(e) {
          ...
          (0, o.isNumber)(i) || j.logError('pre-order price is not defined');
          const r = this._supportBracketsForOrder(),
            a = {
              dataType: 'PreOrder',
              ...t,
              price: i,
              ...
              supportCancel: !0,
              supportBrackets: r,
              supportTrailingStop: r && (0, U.checkTrailingStopAvailability)(this._configFlags()),
              plBasedOnLast: !0,
            };
          return { main: a, brackets: this._createBracketsFromPlaceContextData(a) };
        }
        _createBracketsFromPlaceContextData(e) {
          ...
          return (
            e.supportBrackets &&
              (void 0 !== e.takeProfit &&
                t.push(
                  this._createBracketDataForPlaceOrder(e, h.BracketType.TakeProfit, e.takeProfit),
                ),
              void 0 !== e.stopLoss &&
                t.push(this._createBracketDataForPlaceOrder(e, h.BracketType.StopLoss, e.stopLoss)),
              void 0 !== e.trailingStopPips &&
                t.push(
                  this._createBracketDataForPlaceOrder(
                    e,
                    h.BracketType.TrailingStop,
                    (0, a.ensureDefined)(e.trailingStopPrice),
                  ),
                )),
            t
          );
        ...
        _recreateTradedGroupSource(e, t = !0, i = '') {
          ...
          if (void 0 !== s) s.setValue(r), t && j.logNormal(`Source updated${i}: ${q(r)}`);
          else {
            const t = new n.WatchedObject(r);
            (a = e),
              (o = t),
              (l = this._ordersService.orderRejected()),
              (d = this._showTradedGroup),
        ...
        _configFlags() {
          return (0, a.ensureNotNull)(this._realtimeProvider.activeBroker()).metainfo().configFlags;
        }
        ...
        async _findAndUpdateParentPosition(e, t = !1) {
          ...
          if (
            (null !== i &&
              ...
              (j.logNormal(`Position update (brackets unlink from position), id: ${e}`),
            ...
            void 0 !== t &&
              void 0 === t.value().main &&
              (j.logNormal(`Position remove (brackets link to position), id: ${e}`),
        ...
        _addPositionItems(e) {
          for (const t of e) {
            ...
            this._positionsData.set(i, e),
              this._recreateTradedGroupSource(i, t.type === m.PositionsUpdateType.Full);
            this._ordersService
              .activeOrders()
          ...
          for (const t of e) {
            ...
            if (!this._tradedGroupData.has(t))
              for (const i of this._tradedGroupData.keys()) {
                for (const r of (0, a.ensureDefined)(this._tradedGroupData.get(i)).value().brackets)
                  if (r.id === t) {
                    e = i;
                    break;
                  }
            ...
            if (void 0 === i.main && 0 === i.brackets.length) this._removeTradedGroupEditSource(e);
              ...
              const t = this._tradedGroupData.get(e);
              void 0 !== t && (t.setValue(i), j.logNormal(`Source updated: ${q(i)}`));
            }
          }
        }
          ...
          return {
            modifyOrder: async e => {
              const t = (0, s.default)(e),
                i = await (0, a.ensureNotNull)(
                  this._realtimeProvider.activeBroker(),
                ).createPlaceOrderContext(t);
            ...
            sendOrder: async () => {
              const e = await (0, a.ensureNotNull)(this._tradedContextLinking.context()).send();
        ...
        async _processingModifyOrder(e, t, i, r) {
          let s = !1;
          try {
            s = await (0, a.ensureNotNull)(this._brokerCommandsUIGetter()).modifyOrder(e, i, r);
          } catch (e) {
            j.logError(`Try to modify order with error ${(0, c.errorToString)(e)}`);
          }
          return s;
        }
        _modifyOrder(e, t, i, r) {
          const s = (0, a.ensureNotNull)(this._ordersService.find(e));
          return this._processingModifyOrder(t, s, r, i);
        }
        _moveOrder(e, t, i) {
          const r = (0, a.ensureNotNull)(this._ordersService.find(e));
          return this._processingModifyOrder(t, r, !0, i);
        }
        _cancelOrder(e) {
          return (0, a.ensureNotNull)(this._brokerCommandsUIGetter()).cancelOrder(e);
        }
        _reversePosition(e) {
          return (0, a.ensureNotNull)(this._brokerCommandsUIGetter()).reversePosition(e);
        }
        _modifyPosition(e, t = {}, i, r) {
          const s = (0, a.ensureNotNull)(this._brokerCommandsUIGetter());
          return this._positionsService.isDisplayModeTrades()
            ? (0, a.ensureDefined)(s.editTradeBrackets).call(s, e, t, i, r)
            : s.editPositionBrackets(e, t, i, r);
        }
        _closePosition(e) {
          const t = (0, a.ensureNotNull)(this._brokerCommandsUIGetter());
          return this._positionsService.isDisplayModeTrades()
            ? t.closeTrade(e)
            : t.closePosition(e);
        }
