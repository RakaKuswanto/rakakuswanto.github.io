(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8244, 959, 6437],
  {
    805912: t => {
      t.exports = {
        'toast-positioning-wrapper': 'toast-positioning-wrapper-txdnDvZo',
    ...
    801808: (t, e, n) => {
      'use strict';
      n.d(e, { OverlapManager: () => i, getRootOverlapManager: () => a });
      var o = n(650151);
      class r {
        constructor() {
          this._storage = [];
      ...
      class i {
        ...
        ensureWindow(t, e = { position: 'fixed', direction: 'normal' }) {
          ...
          if (
            ...
            if (e.index >= t) this._container.appendChild(o);
            else if (e.index <= 0) this._container.insertBefore(o, this._container.firstChild);
            else {
              const t = this._container.childNodes[e.index];
              this._container.insertBefore(o, t);
            }
          } else
            'reverse' === e.direction
        ...
        unregisterWindow(t) {
          ...
          void 0 !== e &&
            (null !== e.parentElement && e.parentElement.removeChild(e), this._windows.delete(t));
        }
        getZindex(t) {
      ...
      function a(t = document) {
        ...
        if (null !== e) return (0, o.ensureDefined)(s.get(e));
        {
          const e = new i(t),
            n = (function (t) {
    ...
    703011: (t, e, n) => {
      'use strict';
      n.d(e, { useForceUpdate: () => r });
      var o = n(50959);
      const r = () => {
        const [, t] = (0, o.useReducer)(t => t + 1, 0);
        return t;
      };
    },
    8361: (t, e, n) => {
      'use strict';
      n.d(e, { Portal: () => u, PortalContext: () => c });
      var o = n(50959),
        r = n(500962),
        i = n(189904),
        s = n(801808),
      ...
      class u extends o.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            r.createPortal(o.createElement(c.Provider, { value: this }, this.props.children), t)
          );
        }
        moveToTop() {
    ...
    106056: (t, e, n) => {
      'use strict';
      var o, r, i;
      n.d(e, { CloseTrigger: () => o, ToastAnimationStage: () => r, ToastPriority: () => i }),
        (function (t) {
    ...
    358244: (t, e, n) => {
      ...
      class f {
        constructor(t) {
          (this._animationStage = h.ToastAnimationStage.Add),
            (this._keys = new Map()),
            (this._element = null),
        ...
        migrate(t) {
          (this._currentToastsLayer = t), (this._animationStage = h.ToastAnimationStage.Add);
        }
        getCurrentLayer() {
      ...
      function p(t, e) {
        const n = (0, r.useRef)({ x: 0, y: 0 }),
          [i, s] = (0, r.useState)(o.Unset);
        return [
          i,
          {
            onTouchStart: (0, r.useCallback)(t => {
              n.current = { x: t.changedTouches[0].clientX, y: t.changedTouches[0].clientY };
            }, []),
            onTouchEnd: (0, r.useCallback)(
              r => {
                s(
                  (function (t, e, n, r, i) {
                    ...
                    r,
                    n.current,
                    { x: r.changedTouches[0].clientX, y: r.changedTouches[0].clientY },
                    t,
                    e,
                  ),
                );
      ...
      var g = n(710263),
        y = n(805912);
      const m = { position: 'fixed', left: '0', bottom: '0', right: '0', zIndex: 145 };
      class _ {
        constructor(t, e, n = m, o) {
          (this._toasts = {
            [h.ToastPriority.Low]: [],
            [h.ToastPriority.Medium]: [],
            [h.ToastPriority.High]: [],
          }),
            (this._container = void 0 !== e ? e : document.body),
            (this._suggestedLayout = void 0 !== t ? t : 'loose'),
            (this._location = null != o ? o : 'bottom-left'),
            (this._manager = new l.OverlapManager(document)),
            (this._overlapManagerContainer = (function (t, e = {}) {
              const n = t.createElement('div');
              return (n.dataset.role = 'toast-container'), w(n, { ...m, ...e }), n;
            })(document, n)),
        ...
        showToast(t) {
          const {
              render: e,
              priority: n = h.ToastPriority.Medium,
              index: r,
              origin: i = this,
              onLayerChange: s,
              onRemoveEnd: a,
            ...
            l = (function (t) {
              const e = (0, g.isRtl)() ? o.Right : o.Left;
          ...
          return (
            d.setKey(this, p),
            'compact' === this._suggestedLayout && n === h.ToastPriority.Low
              ? Promise.all(this._toasts[h.ToastPriority.Low].map(t => this.removeToast(t))).then(
                  () => {
                    this._add(d, r), this._render();
                  },
                )
              : (this._add(d, r), this._render()),
            d
        ...
        removeToast(t) {
          return new Promise(e => {
            t.setAnimationStage(h.ToastAnimationStage.Remove),
              this._render(),
              setTimeout(() => {
        ...
        update(t) {
          const { suggestedLayout: e, location: n, container: o, rootContainerOptions: r } = t;
          let i = !1,
            s = !1;
          void 0 !== e && e !== this._suggestedLayout && (this._setSuggestedLayout(e), (i = !0)),
            void 0 !== n && (this._setLocation(n), (s = !0)),
            void 0 !== o && (this._setContainer(o), (s = !0)),
            void 0 !== r && (this._updateRootContainer(r), (s = !0)),
            i
              ? 'compact' === this._suggestedLayout &&
                this._toasts[h.ToastPriority.Low].slice(0, -1).forEach(t => this.removeToast(t))
              : s && this._render();
        }
        getToasts() {
          return this._toasts;
        ...
        merge(t) {
          v(t.getToasts()).forEach(async e => {
            const n = e.getStaticData();
            await e.remove(),
              e.migrate(this),
              this.showExistingToast(e),
              void 0 !== n.onLayerChange && n.onLayerChange(t, this);
          });
        }
        split(t) {
          v(this._toasts)
            ...
            .forEach(async e => {
              ...
              await e.remove(),
                ...
                void 0 !== n.onLayerChange && n.onLayerChange(this, t);
            });
        }
        reset() {
          (this._toasts = {
        ...
        _removeRootContainer() {
          i.unmountComponentAtNode(this._detachedContainer),
        ...
        _add(t, e) {
          const n = this._getToastsList(t);
          if (void 0 !== e) {
            const o = this._normalizeIndex(e, n);
            n.splice(o, 0, t);
          } else n.push(t);
        }
        _remove(t) {
        ...
        _setContainer(t) {
          t !== this._container &&
            ((this._container = t), this._container.appendChild(this._overlapManagerContainer));
        }
        _updateRootContainer(t) {
          w(this._overlapManagerContainer, t);
        }
        _getNextKey() {
          return (0, a.randomHashN)(5);
        }
      }
      function v(t) {
        return [
          ...t[h.ToastPriority.Low],
          ...t[h.ToastPriority.Medium],
          ...t[h.ToastPriority.High],
        ];
      }
      function w(t, e) {
        const { top: n, right: o, bottom: r, left: i, position: s, zIndex: a } = e;
        void 0 !== s && (t.style.position = s),
          void 0 !== a && (t.style.zIndex = String(a)),
          void 0 !== n && (t.style.top = n),
          void 0 !== o && (t.style.right = o),
          void 0 !== r && (t.style.bottom = r),
          void 0 !== i && (t.style.left = i);
      }
      function C(t, e, n) {
        return t.getKey(n) || e.toString(10);
      }
      function S(t) {
        const {
            toast: e,
          ...
          d = (0, r.useRef)(null),
          f = e.getStaticData().swipeToCloseDirection,
          [m, _] = p(0.2, 0.7),
          v = e.getAnimationStage(),
          w = v !== h.ToastAnimationStage.None,
          S = v === h.ToastAnimationStage.Add,
          [T, x] = (function (t, e, n, r) {
            var i, s;
            const a = e.indexOf(t),
              u = C(t, a, n);
            let c = 0,
            ...
            for (const t of e) {
              const d = e.indexOf(t),
                f = C(t, d, n),
                p = (null === (i = t.getElement()) || void 0 === i ? void 0 : i.offsetHeight) || 0,
                y = (null === (s = t.getElement()) || void 0 === s ? void 0 : s.offsetWidth) || 0,
                m = (0, g.isRtl)() ? y : -y,
                _ = t.getAnimationStage() !== h.ToastAnimationStage.None && r === o.Unset,
                v = r === t.getStaticData().swipeToCloseDirection;
              let w = 0;
              _ && f === u ? (w = 1) : !_ && a < d && (w = -1), (c += w * p), (l = v ? m : 0);
            }
            return [c, l];
          })(e, n, i, m),
          E = s(
            y['toast-positioning-wrapper'],
            w && y.hidden,
            S && y.added,
            'compact' === a && y.compact,
            c && y[`location-${c}`],
        ...
        return (
          (0, r.useEffect)(() => {
            if (
              e.getCurrentLayer() !== i ||
              e.getAnimationStage() !== h.ToastAnimationStage.Add ||
              null === d.current
            )
              return;
            const t = e.getElement();
            null === t || t !== d.current
              ? (e.setElement(d.current), l())
              : (e.setAnimationStage(h.ToastAnimationStage.None), l());
          }),
          (0, r.useEffect)(() => {
            m === f && m !== o.Unset && e.remove(h.CloseTrigger.Swipe);
          }, [m, e]),
          r.createElement(
            u.Portal,
            { layerOptions: { position: 'absolute' }, left: '0', right: '0' },
            r.createElement(
              'div',
              {
                onTouchStart: f ? _.onTouchStart : void 0,
                onTouchEnd: f ? _.onTouchEnd : void 0,
                onMouseOver: e.getStaticData().onMouseOver,
                onMouseOut: e.getStaticData().onMouseOut,
                className: E,
                style: { transform: `translate(${x}px, ${T}px)` },
                ref: d,
              },
              e.render({ onRemove: e.remove, suggestedLayout: a }),
            ),
          )
        );
      }
      function T(t) {
        const { toasts: e, suggestedLayout: n, location: o, manager: i, layer: s } = t,
          a = (0, d.useForceUpdate)();
    ...
    695257: (t, e) => {
      ...
      (w.constructor = v), g(w, m.prototype), (w.isPureReactComponent = !0);
      var C = Array.isArray,
      ...
      function E(t, e, o) {
        var r,
          ...
          a = null;
        if (null != e)
          for (r in (void 0 !== e.ref && (a = e.ref), void 0 !== e.key && (s = '' + e.key), e))
            S.call(e, r) && !x.hasOwnProperty(r) && (i[r] = e[r]);
        ...
        return { $$typeof: n, type: t, key: s, ref: a, props: i, _owner: T.current };
      }
      function b(t) {
      ...
      function M(t, e, r, i, s) {
        ...
        if (((u = 0), (i = '' === i ? '.' : i + ':'), C(t)))
          ...
          for (t = l.call(t), c = 0; !(a = t.next()).done; )
            u += M((a = a.value), e, r, (l = i + R(a, c++)), s);
        else if ('object' === a)
          throw (
            ((e = String(t)),
            Error(
      ...
      var P = { current: null },
        k = { transition: null },
        A = { ReactCurrentDispatcher: P, ReactCurrentBatchConfig: k, ReactCurrentOwner: T };
      (e.Children = {
        map: O,
        ...
        (e.cloneElement = function (t, e, o) {
          ...
          if (null != e) {
            if (
              (void 0 !== e.ref && ((s = e.ref), (a = T.current)),
          ...
          return { $$typeof: n, type: t.type, key: i, ref: s, props: r, _owner: a };
        }),
        ...
        (e.isValidElement = b),
        (e.lazy = function (t) {
          return { $$typeof: h, _payload: { _status: -1, _result: t }, _init: D };
        }),
        (e.memo = function (t, e) {
        ...
        (e.useCallback = function (t, e) {
          return P.current.useCallback(t, e);
        }),
        ...
        (e.useEffect = function (t, e) {
          return P.current.useEffect(t, e);
        }),
        (e.useId = function () {
          return P.current.useId();
        }),
        (e.useImperativeHandle = function (t, e, n) {
          return P.current.useImperativeHandle(t, e, n);
        }),
        (e.useInsertionEffect = function (t, e) {
          return P.current.useInsertionEffect(t, e);
        }),
        (e.useLayoutEffect = function (t, e) {
          return P.current.useLayoutEffect(t, e);
        }),
        (e.useMemo = function (t, e) {
          return P.current.useMemo(t, e);
        }),
        (e.useReducer = function (t, e, n) {
          return P.current.useReducer(t, e, n);
        }),
        (e.useRef = function (t) {
        ...
        (e.useSyncExternalStore = function (t, e, n) {
          return P.current.useSyncExternalStore(t, e, n);
        }),
