(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3809],
  {
    ...
    713191: (e, t, n) => {
      ...
      function s(e, t, n) {
        e
          ? i.render(a.createElement(o.QuantityCalculator, { ...(0, r.ensureDefined)(n) }), t)
    ...
    129018: (e, t, n) => {
      ...
      var a = n(50959),
        ...
        _ = n(672197),
        b = n(115356);
      const y = { isGrouped: !1, cellState: { isTop: !1, isRight: !1, isBottom: !1, isLeft: !1 } };
      function E(e) {
        const {
            min: t,
            max: i,
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(x.Button, {
                  ...
                  icon: a.createElement(h.Icon, { className: b.buttonIcon, icon: k }),
                  onClick: W,
                ...
                a.createElement(x.Button, {
                  value: r,
                  buttonType: x.ButtonType.IncDec,
                  icon: a.createElement(h.Icon, { className: b.buttonIcon, icon: I }),
                  onClick: W,
                  className: b.buttonWithOperation,
                }),
                a.createElement(x.Button, {
                ...
                a.createElement(x.Button, {
                  ...
                  icon: a.createElement(h.Icon, { className: b.buttonIcon, icon: C }),
                  onClick: W,
                }),
                a.createElement(x.Button, {
                  value: t || r,
                  buttonType: x.ButtonType.Default,
                  icon: a.createElement(h.Icon, { className: b.buttonIcon, icon: _ }),
                  onClick: W,
                }),
              ),
            ),
      ...
      class w extends a.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._calculatorStepHandler = (e, t) => {
              const { min: n, max: a, uiStep: r, trackEventTarget: o, trackEvent: s } = this.props;
              if (
                (void 0 !== s &&
                  void 0 !== o &&
                  s(o, 'Calculator Button', (0, u.prepareCalculatorEventText)(e, t)),
              ...
              if ((m < n || a < m) && t !== x.ButtonType.IncDec) return this._updateValueByCalc(l);
              if (t === x.ButtonType.IncDec) {
                if (((m = this._calcByStep(l, e, n, r)), a < m)) return this._updateValueByCalc(a);
            ...
            (this._updateValueByCalc = e => {
              ...
              this._handlerValueInput(e),
                ...
                null === (n = (t = this.props).onFocus) || void 0 === n || n.call(t);
            }),
            (this._onInputClick = () => {
        ...
        _calcByStep(e, t, n, a) {
          const r = Math.sign(t),
            ...
            u = s.minus(n).mod(t);
          let l = s.plus(r * o);
          return u.eq(0) || (l = l.plus((r > 0 ? 0 : 1) * o).minus(u)), l.toNumber();
        }
