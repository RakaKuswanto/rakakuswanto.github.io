  ...
  [8537],
  {
    485778: (e, t, i) => {
      ...
      const a = new o.TranslatedString(
        ...
        c = new o.TranslatedString('change {title} extension', n.t(null, void 0, i(286647))),
      ...
      function y(e, t, i) {
        ...
        if ('showTime' in t) {
          const r = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showTime, d.format({ title: i })) },
    ...
    359663: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        l = i(664902),
        s = i(620004);
      const a = new l.TranslatedString('lines width', n.t(null, void 0, i(673043))),
        ...
        p = new l.TranslatedString('backgrounds color', n.t(null, void 0, i(321926))),
        u = new l.TranslatedString('backgrounds filled', n.t(null, void 0, i(552241))),
    ...
    461290: (e, t, i) => {
      ...
      const d = new o.TranslatedString(
        ...
        T = new o.TranslatedString('change {title} angle visibility', n.t(null, void 0, i(245537))),
        D = new o.TranslatedString(
          'change {title} always show stats',
          n.t(null, void 0, i(137913)),
        ),
        w = new o.TranslatedString('change {title} stats position', n.t(null, void 0, i(800588))),
        _ = [
      ...
      function W(e, t, i, n) {
        const o = (0, c.removeSpaces)(i.originalText()),
          ...
          B = (0, r.createLineStyleDefinition)(
            e,
            { ...W, lineColor: t.linecolor, lineWidth: t.linewidth, lineStyle: t.linestyle },
            i,
            'Line',
          );
        a.push(B);
        ...
        const N = (0, l.createCheckablePropertyDefinition)(
          ...
          { id: `${o}ShowPriceLabels`, title: (n && n.showPriceLabelsTitle) || S },
        );
        a.push(N);
        const R = [],
        ...
        const U = (0, l.createCheckablePropertyDefinition)(
          {
            checked: (0, l.convertToDefinitionProperty)(e, t.showBarsRange, f.format({ title: i })),
          },
        ...
        if ('showAngle' in t) {
          const r = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showAngle, T.format({ title: i })) },
        ...
        const I = (0, l.createOptionsPropertyDefinition)(
          {
            option: (0, l.convertToDefinitionProperty)(e, t.statsPosition, w.format({ title: i })),
          },
          {
            id: `${o}StatsPosition`,
        ...
        return (
          R.push(I),
          a.push((0, l.createPropertyDefinitionsGeneralGroup)(R, `${o}StatsGroup`, M)),
          { definitions: a }
        );
      }
    },
    154951: (e, t, i) => {
      ...
      const s = new o.TranslatedString(
        ...
        c = new o.TranslatedString('change {toolName} line style', n.t(null, void 0, i(635422))),
        ...
        u = new o.TranslatedString('change {toolName} line left end', n.t(null, void 0, i(562603))),
        h = new o.TranslatedString(
      ...
      function T(e, t, i, n, o) {
        const T = {},
          D = { id: `${(0, l.removeSpaces)(i.originalText())}${n}`, title: (o && o.line) || f };
        return (
          void 0 !== t.showLine &&
    ...
    876894: (e, t, i) => {
      ...
      const s = new o.TranslatedString(
        ...
        a = new o.TranslatedString('change {toolName} text color', n.t(null, void 0, i(906500))),
        ...
        u = new o.TranslatedString('change {toolName} text', n.t(null, void 0, i(777690))),
        h = new o.TranslatedString(
        ...
        _ = new o.TranslatedString('change {toolName} text wrap', n.t(null, void 0, i(625878))),
        P = n.t(null, void 0, i(527331)),
        S = n.t(null, void 0, i(248848)),
        m = n.t(null, void 0, i(617932));
      function b(e, t, i, n) {
        const o = {},
          b = {
        ...
        if (
          ...
          void 0 !== t.fontSize &&
            (o.size = (0, r.convertToDefinitionProperty)(e, t.fontSize, c.format({ toolName: i }))),
          void 0 !== t.bold &&
            (o.bold = (0, r.convertToDefinitionProperty)(e, t.bold, d.format({ toolName: i }))),
          void 0 !== t.italic &&
            (o.italic = (0, r.convertToDefinitionProperty)(e, t.italic, p.format({ toolName: i }))),
          void 0 !== t.text &&
            ((o.text = (0, r.convertToDefinitionProperty)(e, t.text, u.format({ toolName: i }))),
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (b.backgroundTitle = (n.customTitles && n.customTitles.backgroundTitle) || P),
          ...
          (void 0 === t.borderVisible && void 0 === t.borderColor && void 0 === t.borderWidth) ||
            (b.borderTitle = (n.customTitles && n.customTitles.borderTitle) || S),
          void 0 !== t.wrap &&
            ((o.wrap = (0, r.convertToDefinitionProperty)(e, t.wrap, _.format({ toolName: i }))),
    ...
    41220: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        l = i(70207),
        s = i(620004);
      const a = new o.TranslatedString('change arrow color', n.t(null, void 0, i(238829))),
    ...
    905902: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        s = i(311757),
        a = i(876894);
      const c = new o.TranslatedString('change {title} color', n.t(null, void 0, i(920216))),
    ...
    128905: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        c = i(849303),
        d = i(311757);
      const p = new o.TranslatedString('change {title} color', n.t(null, void 0, i(920216))),
        u = new o.TranslatedString('change {title} mode', n.t(null, void 0, i(294441))),
        h = new o.TranslatedString('change {title} mirrored', n.t(null, void 0, i(136618))),
        ...
        D = [
          { value: a.LineToolBarsPatternMode.Bars, title: n.t(null, void 0, i(825264)) },
          { value: a.LineToolBarsPatternMode.OpenClose, title: n.t(null, void 0, i(366049)) },
          { value: a.LineToolBarsPatternMode.Line, title: n.t(null, void 0, i(447669)) },
          { value: a.LineToolBarsPatternMode.LineOpen, title: n.t(null, void 0, i(17676)) },
          { value: a.LineToolBarsPatternMode.LineHigh, title: n.t(null, void 0, i(471899)) },
          { value: a.LineToolBarsPatternMode.LineLow, title: n.t(null, void 0, i(683394)) },
          { value: a.LineToolBarsPatternMode.LineHL2, title: n.t(null, void 0, i(949286)) },
        ];
    ...
    182032: (e, t, i) => {
      ...
      const c = new o.TranslatedString(
        ...
        d = new o.TranslatedString('change {title} background color', n.t(null, void 0, i(975312))),
        p = n.t(null, void 0, i(527331));
      class u extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
    ...
    673412: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        a = i(650802),
        c = i(311757);
      const d = new o.TranslatedString('change {title} color', n.t(null, void 0, i(920216))),
        p = new o.TranslatedString('change {title} degree', n.t(null, void 0, i(203400))),
    ...
    414396: (e, t, i) => {
      ...
      const p = new r.TranslatedString(
        ...
        v = new r.TranslatedString('change {title} all lines color', o.t(null, void 0, i(615521))),
    ...
    931830: (e, t, i) => {
      ...
      const h = new r.TranslatedString(
        ...
        D = new r.TranslatedString('change {title} reverse', o.t(null, void 0, i(852877))),
        w = new r.TranslatedString(
          'change {title} prices visibility',
          o.t(null, void 0, i(156175)),
        ),
        _ = new r.TranslatedString('change {title} labels alignment', o.t(null, void 0, i(981170))),
        P = new r.TranslatedString('change {title} labels font size', o.t(null, void 0, i(622775))),
        S = new r.TranslatedString('change {title} style', o.t(null, void 0, i(474428))),
        m = new r.TranslatedString(
          'change {title} fib levels based on log scale',
          o.t(null, void 0, i(945739)),
        ),
        b = o.t(null, void 0, i(404372)),
        ...
        E = [
          { id: 'bottom', value: 'bottom', title: o.t(null, void 0, i(865994)) },
          { id: 'middle', value: 'middle', title: o.t(null, void 0, i(876476)) },
          { id: 'top', value: 'top', title: o.t(null, void 0, i(691757)) },
        ],
        O = [10, 11, 12, 14, 16, 20, 24].map(e => ({ title: String(e), value: e }));
      class U extends a.LineDataSourceDefinitionsViewModel {
        constructor(e, t) {
          ...
          if ('fibLevelsBasedOnLogScale' in this._source.properties().childs()) {
            ...
            null !== e &&
              ((this._disabledBasedOnLog = new d.WatchedValue(Boolean(!e.mode().log))),
        ...
        _stylePropertyDefinitions() {
          ...
          const U = t.levelsStyle.childs(),
            ...
            I = { line: C };
          'extendLines' in t && ((F.extendRight = t.extendLines), (I.extendRightTitle = k)),
            'extendLinesLeft' in t && ((F.extendLeft = t.extendLinesLeft), (I.extendLeftTitle = A)),
            'extendRight' in t && ((F.extendRight = t.extendRight), (I.extendRightTitle = L)),
            'extendLeft' in t && ((F.extendLeft = t.extendLeft), (I.extendLeftTitle = x));
          ...
          const X = (0, s.createPropertyDefinitionsLeveledLinesGroup)(j, `${o}LeveledLinesGroup`);
    ...
    69584: (e, t, i) => {
      ...
      const d = new r.TranslatedString(
        ...
        h = new r.TranslatedString('change {title} all lines color', o.t(null, void 0, i(615521))),
        y = new r.TranslatedString(
          'change {title} background visibility',
          o.t(null, void 0, i(64548)),
        ),
        ...
        w = new r.TranslatedString('change {title} reverse', o.t(null, void 0, i(852877))),
        _ = new r.TranslatedString('change {title} grid visibility', o.t(null, void 0, i(153770))),
        P = new r.TranslatedString('change {title} grid line color', o.t(null, void 0, i(29145))),
        S = new r.TranslatedString('change {title} grid line width', o.t(null, void 0, i(693548))),
        m = new r.TranslatedString('change {title} grid line style', o.t(null, void 0, i(364949))),
      ...
      class B extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const N = (0, l.createPropertyDefinitionsLeveledLinesGroup)(B, `${o}HLeveledLinesGroup`),
            ...
            E = (0, l.createPropertyDefinitionsGeneralGroup)([N, R, G], `${o}HLevelGroup`, L);
          e.push(E);
          const O = [],
          ...
          const F = (0, l.createPropertyDefinitionsLeveledLinesGroup)(O, `${o}VLeveledLinesGroup`),
            ...
            j = (0, l.createPropertyDefinitionsGeneralGroup)([F, I, H], `${o}VLevelGroup`, x);
          e.push(j);
    ...
    77857: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        l = i(70207),
        s = i(311757);
      const a = new o.TranslatedString('change {title} line color', n.t(null, void 0, i(920563))),
        c = new o.TranslatedString('change {title} line width', n.t(null, void 0, i(244643))),
        d = new o.TranslatedString('change {title} line style', n.t(null, void 0, i(266982))),
        p = new o.TranslatedString('change {title} counterclockwise', n.t(null, void 0, i(431804))),
    ...
    799464: (e, t, i) => {
      ...
      const p = new r.TranslatedString(
        ...
        w = new r.TranslatedString('change {title} labels alignment', o.t(null, void 0, i(981170))),
        _ = o.t(null, void 0, i(812374)),
        P = o.t(null, void 0, i(527331)),
        ...
        m = [
          ...
          { id: 'middle', value: 'middle', title: o.t(null, void 0, i(876476)) },
          { id: 'bottom', value: 'bottom', title: o.t(null, void 0, i(691757)) },
        ],
        b = [
        ...
        _stylePropertyDefinitions() {
          const e = [],
            ...
            m = (0, l.createLineStyleDefinition)(
              this._propertyApplier,
              { showLine: S.visible, lineColor: S.color, lineWidth: S.linewidth },
              a,
              'TrendLine',
              { line: D },
            );
    ...
    197553: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        r = i(70207),
        l = i(620004);
      const s = new o.TranslatedString('change flag color', n.t(null, void 0, i(72080))),
    ...
    626431: (e, t, i) => {
      ...
      const y = new r.TranslatedString(
        ...
        g = new r.TranslatedString('change {title} all lines color', o.t(null, void 0, i(615521))),
        T = new r.TranslatedString(
          'change {title} background visibility',
          o.t(null, void 0, i(64548)),
        ),
        ...
        L = new r.TranslatedString('change top margin', o.t(null, void 0, i(598905))),
      ...
      class N extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const R = (0, s.createPropertyDefinitionsLeveledLinesGroup)(c, `${o}LeveledLinesGroup`);
          e.push((0, s.createPropertyDefinitionsGeneralGroup)([R], `${o}LevelGroup`, M));
          const G = [],
          ...
          for (let e = 0; e < E; e++) {
            const i = t.fanlines.childs()[e].childs(),
              n = (0, s.createLeveledLinePropertyDefinition)(
                ...
                { id: `${o}FanLineLevel${e}`, title: `${i.x.value()}x${i.y.value()}` },
              );
            G.push(n);
          }
          ...
          e.push((0, s.createPropertyDefinitionsGeneralGroup)([O], `${o}FanLinesGroup`, W));
          const U = [],
            F = t.arcs.childCount();
          for (let e = 0; e < F; e++) {
            const i = t.arcs.childs()[e].childs(),
              n = (0, s.createLeveledLinePropertyDefinition)(
                ...
                { id: `${o}ArcsLineLevel${e}`, title: `${i.x.value()}x${i.y.value()}` },
              );
            U.push(n);
          }
          ...
          e.push((0, s.createPropertyDefinitionsGeneralGroup)([I], `${o}ArcsLinesGroup`, B));
          ...
          if ((e.push(X), z(this._source))) {
              ...
              n = (0, s.createNumberPropertyDefinition)(
                {
                  value: (0, s.convertToDefinitionProperty)(
                    ...
                    [
                      ...
                      e =>
                        null !== e ? parseFloat(t.getScaleRatioFormatter().format(`${e}`)) : null,
                    ],
                  ),
                },
                {
            ...
            const o = i.labelsStyle.childs(),
              r = (0, l.createTextStyleDefinition)(
                this._propertyApplier,
                { showText: i.showLabels, fontSize: o.fontSize, bold: o.bold, italic: o.italic },
                a,
                { customTitles: { text: $ } },
              );
            e.push(r);
    ...
    719540: (e, t, i) => {
      ...
      const d = new r.TranslatedString(
        ...
        y = new r.TranslatedString('change {title} all lines color', o.t(null, void 0, i(615521))),
        f = new r.TranslatedString(
          'change {title} background visibility',
          o.t(null, void 0, i(64548)),
        ),
          ...
          for (let i = 1; i <= _; i++) {
            const n = t[`level${i}`].childs(),
              r = (0, l.createLeveledLinePropertyDefinition)(
                ...
                { id: `${o}LineLevel${i}`, title: `${n.coeff1.value()}/${n.coeff2.value()}` },
              );
            e.push(r);
          }
    ...
    699041: (e, t, i) => {
      ...
      const d = new r.TranslatedString(
        ...
        v = new r.TranslatedString('change {title} reverse', o.t(null, void 0, i(852877))),
        g = new r.TranslatedString(
          'change {title} left labels visibility',
          o.t(null, void 0, i(302359)),
        ),
        ...
        _ = new r.TranslatedString('change {title} fans visibility', o.t(null, void 0, i(478142))),
        P = new r.TranslatedString('change {title} fans line color', o.t(null, void 0, i(379467))),
        S = o.t(null, void 0, i(812374)),
        m = o.t(null, void 0, i(527331)),
        b = o.t(null, void 0, i(516103)),
      ...
      class M extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const B = (0, l.createPropertyDefinitionsLeveledLinesGroup)(M, `${o}HLeveledLinesGroup`),
            ...
            G = (0, l.createPropertyDefinitionsGeneralGroup)([B, z, N, R], `${o}HLevelGroup`, b);
          e.push(G);
          const E = [],
          ...
          const U = (0, l.createPropertyDefinitionsLeveledLinesGroup)(E, `${o}VLeveledLinesGroup`),
            ...
            j = (0, l.createPropertyDefinitionsGeneralGroup)([U, F, I, H], `${o}VLevelGroup`, C);
          e.push(j);
          const Y = (0, l.createColorPropertyDefinition)(
            {
              color: (0, l.getColorDefinitionProperty)(
    ...
    631070: (e, t, i) => {
      ...
      const d = new o.TranslatedString(
        ...
        p = new o.TranslatedString('change {title} background color', n.t(null, void 0, i(975312))),
        u = new o.TranslatedString('change {title} extend top', n.t(null, void 0, i(300896))),
        h = new o.TranslatedString('change {title} extend bottom', n.t(null, void 0, i(801447))),
        y = new o.TranslatedString('change {title} extend left', n.t(null, void 0, i(215258))),
        f = n.t(null, void 0, i(301277)),
      ...
      class b extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const C = (0, l.createTextStyleDefinition)(
            ...
            s,
            { isEditable: !0, isMultiLine: !0, customTitles: { text: P, backgroundTitle: S } },
          );
          ...
          return {
            definitions: [
              (0, l.createTextStyleDefinition)(
                this._propertyApplier,
                { ...e, showText: e.visible, textColor: e.color, fontSize: e.fontsize },
                new o.TranslatedString(this._source.name(), this._source.translatedType()),
    ...
    885798: (e, t, i) => {
      ...
      const d = new o.TranslatedString(
        ...
        p = new o.TranslatedString('change {title} background color', n.t(null, void 0, i(975312))),
        u = n.t(null, void 0, i(729072)),
        h = n.t(null, void 0, i(527331));
    ...
    316563: (e, t, i) => {
      ...
      const c = new o.TranslatedString(
        ...
        v = new o.TranslatedString('change {title} transparency', n.t(null, void 0, i(684321))),
        g = new o.TranslatedString('change {title} average HL value', n.t(null, void 0, i(78680))),
        T = new o.TranslatedString('change {title} variance value', n.t(null, void 0, i(712355))),
          ...
          return {
            definitions: [
              (0, r.createCoordinatesPropertyDefinition)(
                { y: i.property },
                { id: (0, s.removeSpaces)(`${this._source.name()}Point`), title: u, ...i.info },
              ),
            ],
          };
        }
    ...
    911751: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        l = i(620004),
        s = i(311757);
      const a = new o.TranslatedString('change {title} color', n.t(null, void 0, i(920216))),
    ...
    554157: (e, t, i) => {
      ...
      const c = new o.TranslatedString(
        ...
        d = new o.TranslatedString('change {title} extending right', n.t(null, void 0, i(45719))),
        p = new o.TranslatedString(
          'change {title} background visibility',
          n.t(null, void 0, i(64548)),
        ),
        u = new o.TranslatedString('change {title} background color', n.t(null, void 0, i(975312))),
        h = n.t(null, void 0, i(527331)),
        y = n.t(null, void 0, i(325892)),
        f = n.t(null, void 0, i(974395)),
        v = n.t(null, void 0, i(599120)),
        g = n.t(null, void 0, i(876476));
    ...
    979942: (e, t, i) => {
      ...
      var n = i(650151),
        ...
        c = i(311757),
        d = i(29742);
      const p = new r.TranslatedString('change {title} extend lines', o.t(null, void 0, i(896902))),
        u = new r.TranslatedString(
          'change {title} level {index} line visibility',
          o.t(null, void 0, i(345463)),
        ),
      ...
      class m extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const b = i.median.childs(),
            C = (0, l.createLineStyleDefinition)(
              this._propertyApplier,
              { lineColor: b.color, lineStyle: b.linestyle, lineWidth: b.linewidth },
              m,
              'Median',
              { line: w },
            );
    ...
    419365: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        s = i(149356),
        a = i(650802);
      const c = new o.TranslatedString('change {title} style', n.t(null, void 0, i(474428))),
        d = n.t(null, void 0, i(832733)),
        p = [
          { value: s.LineToolPitchforkStyle.Original, title: n.t(null, void 0, i(825595)) },
          { value: s.LineToolPitchforkStyle.Schiff2, title: n.t(null, void 0, i(151464)) },
          { value: s.LineToolPitchforkStyle.Schiff, title: n.t(null, void 0, i(966276)) },
          { value: s.LineToolPitchforkStyle.Inside, title: n.t(null, void 0, i(809114)) },
        ];
        ...
        _stylePropertyDefinitions() {
          const e = super._stylePropertyDefinitions(),
            ...
            l = (0, r.createOptionsPropertyDefinition)(
              ...
              { id: `${i}PitchStyle`, title: d, options: new a.WatchedValue(p) },
            );
    ...
    774760: (e, t, i) => {
      ...
      const c = new o.TranslatedString(
        ...
        m = n.t(null, void 0, i(789258)),
        b = n.t(null, void 0, i(169835)),
    ...
    35405: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        s = i(620004),
        a = i(311757);
      const c = new o.TranslatedString('change {title} line color', n.t(null, void 0, i(920563))),
    ...
    199974: (e, t, i) => {
      ...
      const a = new o.TranslatedString(
        ...
        c = new o.TranslatedString('change {title} extending right', n.t(null, void 0, i(45719))),
        d = n.t(null, void 0, i(37229)),
        p = n.t(null, void 0, i(545809)),
        u = n.t(null, void 0, i(714025)),
        h = [
    ...
    207787: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        d = i(650802),
        p = i(311757);
      const u = new o.TranslatedString('change {title} stop color', n.t(null, void 0, i(254659))),
        h = new o.TranslatedString('change {title} target color', n.t(null, void 0, i(597573))),
        y = new o.TranslatedString(
          'change {title} price labels visibility',
          n.t(null, void 0, i(588577)),
        ),
        ...
        g = new o.TranslatedString('change {title} account size', n.t(null, void 0, i(431775))),
        T = new o.TranslatedString('change {title} lot size', n.t(null, void 0, i(345025))),
        D = new o.TranslatedString('change {title} risk', n.t(null, void 0, i(31553))),
        w = new o.TranslatedString(
          'change {title} risk display mode',
          n.t(null, void 0, i(740344)),
        ),
        _ = new o.TranslatedString('change {title} entry price', n.t(null, void 0, i(859354))),
        P = new o.TranslatedString('change {title} profit level', n.t(null, void 0, i(344539))),
        S = new o.TranslatedString('change {title} profit price', n.t(null, void 0, i(641646))),
        m = new o.TranslatedString('change {title} stop level', n.t(null, void 0, i(969780))),
        b = new o.TranslatedString('change {title} stop price', n.t(null, void 0, i(882224))),
      ...
      class I extends s.LineDataSourceDefinitionsViewModel {
        constructor(e, t) {
          ...
          (this._riskMaxWV = new d.WatchedValue(this._getRiskMax(n))),
            ...
            (this._riskPrecisionWV = new d.WatchedValue(this._getRiskPrecision(n))),
            (this._riskUnitWV = new d.WatchedValue(this._getRiskUnit())),
            (this._riskUnitOptionsWV = new d.WatchedValue(this._getRiskUnitOptions())),
        ...
        _inputsPropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            h = (0, a.createPropertyDefinitionsGeneralGroup)([l, s, c, u], `${i}AccountRisk`),
            ...
            v = (0, a.createPropertyDefinitionsGeneralGroup)([y, f], `${i}ProfitLevel`, W),
            C = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(
                  this._propertyApplier,
          ...
          return {
            definitions: [
              h,
              v,
              (0, a.createPropertyDefinitionsGeneralGroup)([C, L], `${i}StopLevel`, B),
            ],
          };
        }
        ...
        _onAccountSizeChanged() {
          this._riskMaxWV.setValue(
            this._getRiskMax(this._source.properties().childs().riskDisplayMode.value()),
          );
        }
        _onLotSizeChanged() {
    ...
    496728: (e, t, i) => {
      ...
      const p = new o.TranslatedString(
        ...
        u = new o.TranslatedString('change {title} emoji visibility', n.t(null, void 0, i(765899))),
        h = new o.TranslatedString(
          'change {title} image background color',
          n.t(null, void 0, i(248983)),
        ),
        y = new o.TranslatedString('change {title} emoji', n.t(null, void 0, i(565056))),
          ...
          return {
            definitions: [
              (0, s.createCoordinatesPropertyDefinition)(
                ...
                { id: (0, r.removeSpaces)(`${t}Coordinates${f}`), title: f, ...i.info, ...n.info },
              ),
            ],
          };
        }
    ...
    32844: (e, t, i) => {
      ...
      var n = i(509806),
        ...
        a = i(105037),
        c = i(461290);
      const d = new o.TranslatedString('change angle', n.t(null, void 0, i(701670))),
    ...
    315372: (e, t, i) => {
      ...
      const h = new r.TranslatedString(
        ...
        T = new r.TranslatedString('change {title} all lines color', o.t(null, void 0, i(615521))),
        D = new r.TranslatedString(
          'change {title} background visibility',
          o.t(null, void 0, i(64548)),
        ),
        ...
        P = new r.TranslatedString('change {title} labels alignment', o.t(null, void 0, i(981170))),
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, r.createCoordinatesPropertyDefinition)(
                { x: t.property },
                { id: (0, a.removeSpaces)(`${this._source.name()}Point1`), title: u, ...t.info },
              ),
            ],
          };
        }
    ...
    422474: (e, t, i) => {
      ...
      const c = new o.TranslatedString(
        ...
        d = new o.TranslatedString('change {title} VWAP line width', n.t(null, void 0, i(455218))),
        p = new o.TranslatedString(
        ...
        A = new o.TranslatedString('change {title} background color', n.t(null, void 0, i(975312))),
        V = new o.TranslatedString('change {title} price visibility', n.t(null, void 0, i(294028))),
        ...
        return (0, r.createLinePropertyDefinition)(
          {
            ...
            width: (0, r.convertToDefinitionProperty)(e, t.linewidth, o.format({ title: d })),
          },
          { id: `${c}${s}`, title: l },
        );
      }
        ...
        _stylePropertyDefinitions() {
          ...
          if (
            ...
            const e = U.styles.childs().LowerBand.childs(),
              t = O(this._propertyApplier, e, p, u, h, M, 'LowerBandLine', I, H),
          ...
          if (
            (null === (i = X.styles) || void 0 === i ? void 0 : i.UpperBand_2) &&
            (null === (n = X.styles) || void 0 === n ? void 0 : n.LowerBand_2) &&
            (null === (l = X.styles) || void 0 === l ? void 0 : l.UpperBand_3) &&
            (null === (a = X.styles) || void 0 === a ? void 0 : a.LowerBand_3)
          ) {
            const e = U.styles.childs().LowerBand_2.childs(),
              t = O(this._propertyApplier, e, g, T, D, B, 'LowerBand2Line', I, H),
              i = U.styles.childs().UpperBand_2.childs(),
              n = O(this._propertyApplier, i, w, _, P, z, 'UpperBand2Line', I, H),
              o = U.styles.childs().LowerBand_3.childs(),
              r = O(this._propertyApplier, o, S, m, b, N, 'LowerBand3Line', I, H),
              l = U.styles.childs().UpperBand_3.childs(),
              s = O(this._propertyApplier, l, C, L, x, R, 'UpperBand3Line', I, H);
            Y.push(t, n, r, s);
          }
      ...
      class l extends r() {
        ...
        unsubscribe(e, t) {
          ...
          const o = (0, n.ensureDefined)(
            null === (i = this._listenersMappers.find(i => i.obj === e && i.method === t)) ||
              void 0 === i
              ? void 0
              : i.callback,
          );
