(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3566],
  {
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handleKeyDown = e => {
              ...
              13 === (0, c.hashFromEvent)(e) && a && (e.preventDefault(), n || t());
            });
        }
        render() {
          const {
    ...
    531275: (e, t, n) => {
      ...
      const a = n(50959).createContext({ isSmallTablet: !1, dialogCloseHandler: () => {} });
    },
    480994: (e, t, n) => {
      'use strict';
      n.r(t),
      ...
      function u(e) {
        ...
        return (
          ...
          a.createElement(
            ...
            null,
            (function () {
              if ('content' in e) return a.createElement('div', { className: c.label }, e.content);
              if ('html' in e)
      ...
      var h = n(500962),
        p = n(650151),
        f = n(630795);
      const C = new (n(63192).DialogsOpenerManager)();
      const g = function (e) {
          const {
              title: t,
              onClose: i = () => {},
            ...
            actions: [
              {
                ...
                handler: ({ dialogClose: e, innerManager: t }) =>
                  g({ newValue: x, focusInput: B, dialogClose: e, innerManager: t }),
              },
              {
                name: 'cancel',
        ...
        k = function (e, t, n) {
          const { title: o } = e,
            l = `${o}_${'text' in e ? e.text : e.html}`;
          if (C.isOpened(l)) return (0, p.ensureDefined)(C.getDialogPayload(l)).closeHandler;
          ...
          return (
            ...
            C.setAsOpened(l, { closeHandler: i }),
            i
          );
        };
    },
    859878: (e, t, n) => {
      ...
      function k(e) {
        const {
          ...
          { isSmallTablet: u, dialogCloseHandler: m } = (0, a.useContext)(b.SimpleDialogContext),
          d = (0, f.ensureNotNull)((0, a.useContext)(g.SlotContext)),
          k = (0, C.useIsMounted)(),
          [x, E] = (0, a.useState)(!1);
        return a.createElement(
          h.Button,
          {
            disabled: t,
            reference: c,
            className: o(v.actionButton, u && v.small),
            name: n,
            size: u ? 'l' : void 0,
            appearance: s,
            intent: i,
            onClick: function () {
              if (x) return;
              const e = r({ dialogClose: m, innerManager: d });
              e &&
                (E(!0),
                e.then(() => {
                  k.current && E(!1);
          ...
          a.createElement('span', { className: o(x && v.hiddenTitle) }, l),
          x && a.createElement(p.Loader, { color: 'white' }),
        );
      }
      var x = n(507720),
        E = n(854936);
      function N(e) {
        ...
        const [O, S] = (0, a.useState)(!0),
          w = (0, a.useRef)(null);
        return a.createElement(c.MatchMedia, { rule: m.DialogBreakpoints.TabletSmall }, s =>
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                { className: o(E.wrap, g), 'data-name': p },
                a.createElement(
                  'div',
                  { className: o(E.main, !_ && E.marginWithoutCloseButton, s && E.small) },
                  t && a.createElement('div', { className: o(E.title, s && E.small) }, t),
                  (function (t) {
                    if ('html' in e)
                      return a.createElement(d.TouchScrollContainer, {
                        className: o(E.content, t && E.small, E.html, C),
                        dangerouslySetInnerHTML: { __html: e.html },
                      });
                    if ('content' in e)
                      return a.createElement(
                        d.TouchScrollContainer,
                        { className: o(E.content, t && E.small, C) },
                        e.content,
                      );
                    return null;
                  })(s),
                  h &&
                    ...
                    a.createElement(
                      ...
                      h.map((e, t) =>
                        a.createElement(k, { ...e, key: e.name, reference: 0 === t ? w : void 0 }),
                      ),
                    ),
                ),
                _ &&
    ...
    537954: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { ConfirmDialogRenderer: () => m });
      var a = n(500962),
        o = n(50959),
        l = n(509806),
        s = n(302946),
      ...
      class m {
        constructor(e) {
          (this._root = document.createElement('div')), (this._disabledConfirmations = e);
        }
        open(e) {
        ...
        _open(e, t) {
          const {
              ...
              confirmButton: s,
              closeButton: i,
              showDisableConfirmationsCheckbox: m,
              onOpen: h,
              onClose: p,
            } = t,
            f = () => {
          ...
          a.render(o.createElement(d, { ...C }), this._root);
        }
        _close() {
      ...
      function d(e) {
        const { showDisableConfirmationsCheckbox: t, message: a, onSubmit: r, ...c } = e,
          [m, d] = (0, o.useState)(!1),
          h = () => d(!m);
        return o.createElement(i.CreateConfirmDialog, {
          ...
          render: () =>
            o.createElement(
              ...
              o.createElement(
                'div',
                { className: t ? u.messageWithCheckbox : u.message },
                Array.isArray(a)
                  ? a.map((e, t) =>
                      o.createElement('span', { className: u.messageBlock, key: t }, e),
                    )
                  : a,
              ),
      ...
      function m(e) {
        const {
          ...
          w = a.createElement(
            a.Fragment,
            null,
            a.createElement('div', { className: u.text, dangerouslySetInnerHTML: { __html: m } }),
            f &&
              a.createElement(l.Checkbox, {
                className: u.checkbox,
                label: null != C ? C : o.t(null, void 0, n(237233)),
                checked: O,
                tabIndex: -1,
                onChange: () => S(e => !e),
              }),
      ...
      function l(e) {
        return t => {
          ...
          return ((e => {
            ...
            t.isOpen) &&
            n
            ? a.createElement(a.Suspense, { fallback: null }, a.createElement(e, { ...t }))
            : null;
        };
      }
    },
