  ...
  [8762],
  {
    105037: (e, t, i) => {
      ...
      class l extends s.UndoCommand {
        ...
        redo() {
          const e = (0, n.ensureNotNull)(this._model.dataSourceForId(this._lineToolId));
      ...
      var a = i(620004),
        ...
        p = i.n(c),
        u = i(311757);
      const h = new r.TranslatedString('change price Y coordinate', o.t(null, void 0, i(466266))),
        y = new r.TranslatedString('change bar X coordinate', o.t(null, void 0, i(623723))),
        P = new r.TranslatedString('move drawings', o.t(null, void 0, i(972223)));
      function f(e, t, i) {
        return {
      ...
      function w(e, t, i, n, o, r) {
        ...
        return (0, a.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, u.removeSpaces)(`${r}Coordinates${o}`), title: o, ...s.info, ...l.info },
        );
      }
      const m = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/;
      function _(e, t, i) {
                ...
                e.forEach(e => {
                  ...
                  switch (a) {
                    case '': {
                      ...
                      (r -= e.price),
                        (t -= e.index),
                        (o = i.map(e => ({ ...e, index: e.index + t, price: e.price + r })));
                      break;
                    }
                    case '-':
                    case '+': {
                      ...
                      '-' === a && ((e *= -1), (t *= -1)),
                        (o = i.map(i => ({ ...i, index: i.index + e, price: i.price + t })));
                      break;
                    }
                    case '*': {
                  ...
                  t.undoHistory().pushUndoCommand(
                    new l({ lineToolId: e.id(), chartModel: t.model(), newPositionPoints: o }),
                  );
                });
              });
            } finally {
      ...
      function b(e, t) {
        ...
        return (0, a.createSelectionCoordinatesPropertyDefinition)(
          { x: n, y: r },
          {
            ...
            title: o.t(null, void 0, i(537067)),
            mathOperationsX: '+',
            mathOperationsY: '+/*',
            modeX: 'integer',
            modeY: 'float',
    ...
    412548: (e, t, i) => {
      ...
      const p = new o.TranslatedString(
        ...
        h = new o.TranslatedString('change {title} seconds from', n.t(null, void 0, i(602822))),
        y = new o.TranslatedString('change {title} seconds to', n.t(null, void 0, i(566161))),
        P = new o.TranslatedString(
          'change {title} visibility on minutes',
          n.t(null, void 0, i(64370)),
        ),
        f = new o.TranslatedString('change {title} minutes from', n.t(null, void 0, i(715106))),
        g = new o.TranslatedString('change {title} minutes to', n.t(null, void 0, i(891633))),
        w = new o.TranslatedString(
          'change {title} visibility on hours',
          n.t(null, void 0, i(468971)),
        ),
        m = new o.TranslatedString('change {title} hours from', n.t(null, void 0, i(435388))),
        _ = new o.TranslatedString('change {title} hours to', n.t(null, void 0, i(478586))),
        b = new o.TranslatedString(
          'change {title} visibility on days',
          n.t(null, void 0, i(229088)),
        ),
        v = new o.TranslatedString('change {title} days from', n.t(null, void 0, i(541377))),
        S = new o.TranslatedString('change {title} days to', n.t(null, void 0, i(713355))),
        ...
        V = new o.TranslatedString('change {title} weeks to', n.t(null, void 0, i(468643))),
        D = new o.TranslatedString(
          'change {title} visibility on months',
          n.t(null, void 0, i(606659)),
        ),
        W = new o.TranslatedString('change {title} months from', n.t(null, void 0, i(459635))),
        k = new o.TranslatedString('change {title} months to', n.t(null, void 0, i(974266))),
        x =
          (new o.TranslatedString(
            'change {title} visibility on ranges',
            n.t(null, void 0, i(229091)),
          ),
        ...
        F =
          (n.t(null, void 0, i(686672)),
          new o.TranslatedString('ticks', n.t(null, void 0, i(659523)))),
        N = new o.TranslatedString('seconds', n.t(null, void 0, i(132925))),
        Y = new o.TranslatedString('seconds from', n.t(null, void 0, i(706049))),
        E = new o.TranslatedString('seconds to', n.t(null, void 0, i(939017))),
        X = new o.TranslatedString('minutes', n.t(null, void 0, i(516465))),
        H = new o.TranslatedString('minutes from', n.t(null, void 0, i(425586))),
        $ = new o.TranslatedString('minutes to', n.t(null, void 0, i(872317))),
        j = new o.TranslatedString('hours', n.t(null, void 0, i(903143))),
        K = new o.TranslatedString('hours from', n.t(null, void 0, i(84775))),
        O = new o.TranslatedString('hours to', n.t(null, void 0, i(711255))),
        z = new o.TranslatedString('days', n.t(null, void 0, i(282211))),
        B = new o.TranslatedString('days from', n.t(null, void 0, i(914077))),
        q = new o.TranslatedString('days to', n.t(null, void 0, i(133486))),
        G = new o.TranslatedString('weeks', n.t(null, void 0, i(193016))),
        J = new o.TranslatedString('weeks from', n.t(null, void 0, i(32002))),
        Q = new o.TranslatedString('weeks to', n.t(null, void 0, i(428091))),
        Z = new o.TranslatedString('months', n.t(null, void 0, i(58964))),
        ee = new o.TranslatedString('months from', n.t(null, void 0, i(671770))),
        te = new o.TranslatedString('months to', n.t(null, void 0, i(737179))),
        ie = (new o.TranslatedString('ranges', n.t(null, void 0, i(413604))), [1, 59]),
        ne = [1, 59],
        oe = [1, 24],
        re = [1, 366],
        se = [1, 52],
      ...
      function ae(e, t, i) {
        ...
        if (r.enabled('tick_resolution')) {
          const o = (0, s.createCheckablePropertyDefinition)(
            { checked: (0, s.convertToDefinitionProperty)(e, t.ticks, p.format({ title: i })) },
        ...
        if ((0, a.isSecondsEnabled)()) {
          const o = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.seconds, u.format({ title: i })),
              from: (0, s.convertToDefinitionProperty)(e, t.secondsFrom, h.format({ title: i })),
              to: (0, s.convertToDefinitionProperty)(e, t.secondsTo, y.format({ title: i })),
            },
            {
        ...
        const o = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.minutes, P.format({ title: i })),
              from: (0, s.convertToDefinitionProperty)(e, t.minutesFrom, f.format({ title: i })),
              to: (0, s.convertToDefinitionProperty)(e, t.minutesTo, g.format({ title: i })),
            },
            {
          ...
          d = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.hours, w.format({ title: i })),
              from: (0, s.convertToDefinitionProperty)(e, t.hoursFrom, m.format({ title: i })),
              to: (0, s.convertToDefinitionProperty)(e, t.hoursTo, _.format({ title: i })),
            },
            {
          ...
          c = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.days, b.format({ title: i })),
              from: (0, s.convertToDefinitionProperty)(e, t.daysFrom, v.format({ title: i })),
              to: (0, s.convertToDefinitionProperty)(e, t.daysTo, S.format({ title: i })),
            },
            {
        ...
        const F = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.weeks, T.format({ title: i })),
              from: (0, s.convertToDefinitionProperty)(e, t.weeksFrom, C.format({ title: i })),
              to: (0, s.convertToDefinitionProperty)(e, t.weeksTo, V.format({ title: i })),
            },
            {
          ...
          N = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.months, D.format({ title: i })),
              from: (0, s.convertToDefinitionProperty)(e, t.monthsFrom, W.format({ title: i })),
              to: (0, s.convertToDefinitionProperty)(e, t.monthsTo, k.format({ title: i })),
            },
            {
    ...
    70207: (e, t, i) => {
      ...
      var n = i(650151),
        ...
        p = i(946839),
        u = i(562051);
      const h = o.t(null, void 0, i(221852)),
        y = o.t(null, void 0, i(4639)),
        P = o.t(null, void 0, i(832733)),
        f = o.t(null, void 0, i(37229)),
        g = o.t(null, void 0, i(666304)),
        w = o.t(null, { context: 'linetool point' }, i(309671));
      class m {
        constructor(e, t) {
          (this._yCoordinateStepWV = null),
            ...
            (this._source = t),
            (this._undoModel = e),
            (this._ownerSource = (0, n.ensureNotNull)(this._source.ownerSource())),
