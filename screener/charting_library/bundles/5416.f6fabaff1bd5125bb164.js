...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5416],
  {
    377145: (e, t, o) => {
      ...
      var i = (function (e) {
        for (var t = arguments.length, o = Array(t > 1 ? t - 1 : 0), s = 1; s < t; s++)
          o[s - 1] = arguments[s];
        return function () {
          ...
          var i = 0,
            ...
            d = e(function () {
              for (var e = [], t = u.length, o = 0; o < t; o++) e.push(u[o].apply(null, arguments));
        ...
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : s,
          ...
          r = null;
        return function () {
          return n(t, o, arguments) || (r = e.apply(null, arguments)), (o = arguments), r;
        };
      });
    },
    207809: (e, t, o) => {
      ...
      class r {
        ...
        get delayTouchStart() {
          ...
          return null !==
            (s =
              null !==
                (o = null === (e = this.args) || void 0 === e ? void 0 : e.delayTouchStart) &&
              void 0 !== o
                ? o
        ...
        get delayMouseStart() {
          ...
          return null !==
            (s =
              null !==
                (o = null === (e = this.args) || void 0 === e ? void 0 : e.delayMouseStart) &&
              void 0 !== o
                ? o
                : null === (t = this.args) || void 0 === t
                ? void 0
      ...
      class v {
        ...
        setup() {
          ...
          e &&
            ((0, n.invariant)(!v.isSetUp, 'Cannot have two Touch backends at the same time.'),
            (v.isSetUp = !0),
        ...
        connectDragSource(e, t) {
          ...
          return (
            ...
            () => {
              this.sourceNodes.delete(e), this.removeEventListener(t, 'start', o);
            }
          );
        }
          ...
          const s = s => {
            ...
            switch (s.type) {
              ...
              case c.touch.move:
                var r, i;
                n = {
                  x: (null === (r = s.touches[0]) || void 0 === r ? void 0 : r.clientX) || 0,
                  y: (null === (i = s.touches[0]) || void 0 === i ? void 0 : i.clientY) || 0,
                };
            }
            const a = null != n ? this.document.elementFromPoint(n.x, n.y) : void 0,
              u = a && t.contains(a);
            ...
            (this.handleTopMove = e => {
                ...
                (!this.monitor.isDragging() &&
                  (function (e, t, o, s, n) {
                    ...
                    for (let e = 0; e < n.length; ++e) {
                      const t = n[e];
                      if (t && (null == t.start || r >= t.start) && (null == t.end || r <= t.end))
                        return !0;
                    }
                    return !1;
                  })(
              ...
              if (
                (!this.monitor.isDragging() &&
                  ...
                  (a = n.x),
                  (u = n.y),
                  Math.sqrt(Math.pow(Math.abs(a - r), 2) + Math.pow(Math.abs(u - i), 2)) >
              ...
              const l = (o || []).map(e => this.targetNodes.get(e)).filter(e => !!e),
