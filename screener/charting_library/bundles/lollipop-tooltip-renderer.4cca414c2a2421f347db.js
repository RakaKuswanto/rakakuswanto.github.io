  ...
  [9039, 959, 6437],
  {
    ...
    759339: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        d = n(966076);
      function f(e) {
        const { position: t = 'Bottom', onClose: n, children: u, className: f, theme: m = d } = e,
          h = (0, r.ensureNotNull)((0, o.useContext)(s.DrawerContext)),
    ...
    624216: (e, t, n) => {
      ...
      function f(e) {
        const {
          ...
          E = (0, o.useContext)(s.CloseDelegateContext),
          w = o.useContext(d),
          C = (0, o.useContext)(c),
    ...
    734602: (e, t, n) => {
      'use strict';
      n.d(t, { useGlobalCloseOnScrollAndCustomEvents: () => l });
      var o = n(50959),
        r = n(370981);
      function l(e) {
        (0, o.useEffect)(() => {
    ...
    914090: (e, t, n) => {
      ...
      const s = (0, o.forwardRef)((e, t) => {
        const { onClose: n, onForceClose: s, onClickOutside: c, className: u, ...d } = e,
          f = (0, o.useRef)(null);
        (0, o.useEffect)(
          () => (
        ...
        return o.createElement(
          r.PopupMenu,
          {
            ...
            tabIndex: -1,
            reference: e => {
              'function' == typeof t ? t(e) : (0, a.isObject)(t) && (t.current = e),
                (f.current = e);
            },
            onClose: n,
            onClickOutside: c,
        ...
        return (
          ...
          (0, o.useLayoutEffect)(() => {
            if (i.CheckMobile.iOS())
              return (
                null !== a.current && (0, r.disableBodyScroll)(a.current, { allowTouchMove: s(a) }),
                () => {
    ...
    695257: (e, t) => {
      ...
      function T(e, t, o) {
        ...
        return { $$typeof: n, type: e, key: i, ref: a, props: l, _owner: k.current };
      }
      function x(e) {
      ...
      var M = { current: null },
        F = { transition: null },
        D = { ReactCurrentDispatcher: M, ReactCurrentBatchConfig: F, ReactCurrentOwner: k };
      (t.Children = {
        map: R,
        ...
        (t.cloneElement = function (e, t, o) {
          ...
          return { $$typeof: n, type: e.type, key: l, ref: i, props: r, _owner: a };
        }),
        ...
        (t.isValidElement = x),
        (t.lazy = function (e) {
          return { $$typeof: f, _payload: { _status: -1, _result: e }, _init: B };
        }),
        (t.memo = function (e, t) {
    ...
    698793: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { showLollipopTooltip: () => N });
      var o = n(50959),
        r = n(500962),
        l = n(650151),
        i = n(497754),
      ...
      function g(e) {
        ...
        return o.createElement(
          ...
          {
            className: a()(
              y.lollipopTooltipTitle,
              [
                'mob' === i && y.lollipopTooltipTitle_mobile,
                'mini' === i && y.lollipopTooltipTitle_minimal,
              ],
              l,
            ),
          },
          n &&
            o.createElement(v.Icon, { icon: n, className: y.lollipopTooltipTitle__icon, style: r }),
          o.createElement('span', { className: y.lollipopTooltipTitle__title }, t),
        );
      }
      var b,
        E = n(713668);
      ...
      function C(e) {
        ...
        return o.createElement(
          'div',
          { className: a()(E.groupRow, c), style: r },
          t &&
            o.createElement(
              'div',
              { className: E.groupCell },
              o.createElement('span', { className: E.text }, t),
            ),
          o.createElement(
            'div',
            { className: E.groupCell },
            o.createElement('span', { className: E.text, style: l, onClick: i }, n),
            s &&
              o.createElement(v.Icon, {
                icon: s.iconContent,
                className: a()(E.groupIcon, s.iconClass, 'apply-common-tooltip'),
                title: s.tooltipText,
              }),
          ),
        );
      ...
      function k(e) {
        const { content: t = [], subTitle: n, cardRowClass: r } = e,
          l = t.map((e, t) => {
            ...
            return o.createElement(
              'div',
              { key: `group${t}`, className: E.group },
              n && o.createElement('span', { className: E.groupTitle }, n),
              r.map((e, t) => o.createElement(C, { key: `contentRow${t}`, ...e })),
            );
          }),
          i =
            'string' == typeof n
              ? n
              : n.map((e, t) => o.createElement(C, { key: `subTitle${t}`, ...e }));
        return o.createElement(
          'div',
          { className: r },
          o.createElement('span', { className: E.subtitle }, i),
          l.length > 0 && o.createElement('div', null, l),
        );
      }
      !(function (e) {
        (e[(e.BeforeMarketOpen = E.beforeMarketOpen)] = 'BeforeMarketOpen'),
          (e[(e.AfterMarketClose = E.afterMarketClose)] = 'AfterMarketClose');
      })(b || (b = {}));
      function _(e) {
        var t;
        const { cardType: n, anchor: r, title: l, tooltipIcon: i, ...s } = e,
          c = n ? a()(E.content, E[n]) : E.content,
          u = (0, o.useMemo)(() => {
            var t;
            return l && i
        ...
        return o.createElement(
          'div',
          { className: c },
          l && o.createElement(g, { title: l, icon: i, iconStyle: u, cardType: n }),
          'common' === s.type && o.createElement(k, { ...s }),
          r &&
            ('mob' !== n || !r.hideInMobileMode) &&
            o.createElement('div', { className: E.group }, o.createElement(w, { ...r })),
        );
      }
      var T = n(825105);
      const x = (0, m.mergeThemes)(h.DEFAULT_MENU_THEME, {
        menuWrap: T.menuWrap,
        menuBox: T.menuBox,
      });
      function S(e) {
        ...
        const R = { display: O ? 'block' : 'none', width: C },
          [B, M] = (0, o.useState)(!1);
        (0, s.useVisibility)(
          w,
          () => M(!1),
        ...
        const F = { display: B ? 'block' : 'none', width: C };
        (0, p.useGlobalCloseOnScrollAndCustomEvents)(m);
        const D = v ? a()(T.card, T[v]) : T.card;
        return o.createElement(
          d.DrawerManager,
          null,
          o.createElement(c.MatchMedia, { rule: 'screen and (max-width: 419px)' }, e =>
            e
              ? o.createElement(
                  u.Drawer,
                  { className: T.drawer, onClose: r || n, position: 'Bottom' },
                  t.map((e, t) =>
                    o.createElement(
                      'div',
                      { key: `${t}`, className: T.drawerItem },
                      o.createElement(_, { cardType: 'mob', ...e }),
                    ),
                  ),
                )
              : o.createElement(
                  ...
                  h &&
                    o.createElement(
                      o.Fragment,
                      null,
                      o.createElement('div', { ref: g, className: T.fadeTop, style: R }),
                  ...
                  o.createElement(
                    ...
                    t.map((e, t) => {
                      ...
                      return o.createElement(
                        ...
                        o.createElement(_, { cardType: v, ...e }),
                      );
                    }),
                  ),
                  h &&
                    o.createElement(
                      ...
                      o.createElement('div', { ref: b, className: T.fadeBottom, style: F }),
                    ),
                ),
          ),
        );
      ...
      function N(e) {
        ...
        const t = {
          ...
          onClose: R,
          onForceClose: () => {
            R(), 'function' == typeof e.onCustomClose && e.onCustomClose();
          },
        ...
        return (
          null === O && ((O = document.createElement('div')), document.body.appendChild(O)),
          r.render(o.createElement(S, { ...t }), O),
          R
        );
      }
      function R() {
        null !== O && (r.unmountComponentAtNode(O), O.remove(), (O = null));
      }
      function B(e, t, n) {
        const o = e.target,
          ...
          s = (0, l.ensureNotNull)(o.closest('.chart-container')),
          c = s.getBoundingClientRect(),
          u = (0, l.ensureNotNull)(s.parentElement).getBoundingClientRect(),
        ...
        const y = c.bottom - (r.top + e.point.y + a),
