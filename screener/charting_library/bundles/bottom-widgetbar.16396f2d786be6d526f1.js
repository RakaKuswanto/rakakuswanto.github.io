(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4193],
  {
    ...
    65160: (t, e, i) => {
      ...
      i.d(e, { contentHeight: () => s, outerHeight: () => n, outerWidth: () => a });
    },
    496818: (t, e, i) => {
      'use strict';
      ...
      class o {
        constructor(t) {
          ...
          const a = (this._handle =
            null !== (e = t.handle ? s.querySelector(t.handle) : null) && void 0 !== e ? e : s);
    ...
    306643: (t, e, i) => {
      ...
      var s = i(650151),
        ...
        d = i(174924);
      i(904585), i(826512);
      const g = parseInt(d['css-value-chart-controls-bar-height-with-border']);
      class c {
        constructor(t, e) {
          ...
          return new Promise(s => {
            'boolean' == typeof t
              ...
              : this.isWidgetEnabled(t) &&
                (e
                  ? this.open()
                  : this.activeWidget().value() === t && 'minimized' !== this.mode().value()
                  ? this.close()
                  : i || this.open(),
            ...
            i = () => {
              ...
              if ('minimized' !== this._mode.value()) {
                ...
                if (
                  ...
                  (this._container.style.height = this._actualHeight.value() + 'px'),
                  Array.from(this._container.querySelectorAll('.bottom-widgetbar-content'), t => {
        ...
        _createLayout(t) {
          (t.innerHTML = ''),
            ...
            (this._footerWidgetContainer.style.height = r.footerWidgetHeight + 'px'),
          ...
          (this._draggable = new l.PointerBackend({
            ...
            onDragStart: t => {
              const e = this._mode.value(),
                ...
                n = 'minimized' === this._mode.value() ? 0 : (0, h.contentHeight)(this._container);
                ...
                isFinite(r) &&
                  (('minimized' === this._mode.value()) !== a
                    ...
                    : this._normalHeight.value() !== r &&
                      (r >= this._getContentBoxHeight(this._resizerAvailHeight())
                        ? (this._mode.setValue('maximized'), this.setNormalHeight(e))
                        : (this._mode.setValue('normal'), this.setNormalHeight(r))));
            },
            onDragStop: () => {
              if (null === i) return;
            ...
            (this._loadingOverlay.className = 'bottom-widgetbar-loading-overlay js-hidden'),
        ...
        _checkOverlap() {
          ...
          this._isOverlap.setValue(
            'maximized' === e || ('normal' === e && this._resizerAvailHeight() - t <= 300 + g),
          );
        }
        _resizerAvailHeight() {
        ...
        _loadState() {
          ...
          this._activeWidget.setValue(
            this.isWidgetEnabled(t.activeWidget) ? t.activeWidget : this._enabledWidgets[0],
          ),
