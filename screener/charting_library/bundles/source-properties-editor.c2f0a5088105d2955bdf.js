(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6780],
  {
    ...
    674609: (e, t, a) => {
      ...
      class p extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            o.ControlDisclosure,
            {
              ...
              className: l()('normal' === e && d.defaultsButtonText),
        ...
        _getPlaceHolderItem(e) {
          return e
            ? i.createElement(r.Icon, { className: d.defaultsButtonIcon, icon: u })
            : m.defaults;
        }
      }
    },
    944316: (e, t, a) => {
      ...
      function h(e) {
        return e.isTabletWidth
          ? i.createElement(c.Icon, { className: m.themesButtonIcon, icon: p })
          : i.createElement(i.Fragment, null, s.t(null, void 0, a(419611)));
      }
      function _(e) {
        return i.createElement(d.MatchMedia, { rule: 'screen and (max-width: 768px)' }, t =>
          i.createElement(
            u.ControlDisclosure,
            {
              className: !t && m.themesButtonText,
              hideArrowButton: t,
              buttonChildren: i.createElement(h, { isTabletWidth: t }),
            },
            e.children,
          ),
        );
      ...
      function b(e) {
        ...
        return i.createElement(
          ...
          i.createElement(g.PopupMenuItem, {
            ...
            onClick: s,
            toolbox:
              a && i.createElement(T.RemoveButton, { hidden: !v.mobiletouch && !l, onClick: o }),
          }),
        );
      }
      var S = a(917850),
      ...
      const z = (0, n.connect)(
        ...
        function (e, t) {
          ...
          return {
            getTemplates: () => e((0, L.getTemplates)(a)),
            loadTemplate: i ? t => e((0, L.loadTemplate)(a, t, i)) : void 0,
            removeTemplate: t => e((0, L.startRemoveTemplate)(a, t)),
            saveTemplate: n ? t => e((0, L.saveTemplate)(a, t, JSON.stringify(n()))) : void 0,
          };
        },
      )(function (e) {
        const {
          ...
          c = (0, i.useContext)(E.SlotContext);
        return (
          (0, i.useEffect)(() => {
            o && !t && n();
          }, [t, n, o]),
          i.createElement(
            ...
            r &&
              i.createElement(b, {
                      ...
                      (0, y.showRename)(
                        {
                          ...
                          onRename: ({
                            ...
                            var o;
                            if (t && -1 !== t.indexOf(i)) {
                              const t = s.t(null, void 0, a(572405)).format({ name: i });
                              (0, y.showConfirm)(
                                {
                                  text: t,
                              ...
                              null === (o = e.saveTemplate) || void 0 === o || o.call(e, i), l();
                          },
                        },
                        c,
                      );
                ...
                name: (0, k.appendEllipsis)(s.t(null, void 0, a(309908))),
              }),
            i.createElement(b, { onClick: l, name: s.t(null, void 0, a(473169)) }),
            o &&
              t &&
              t.length > 0 &&
              i.createElement(
                ...
                t.map(e => i.createElement(b, { key: e, name: e, onRemove: u, onClick: d })),
              ),
          )
        );
        function u(t) {
          window.runOrSignIn(
            () => {
              const i = s.t(null, void 0, a(506705)).format({ name: t });
              (0, y.showConfirm)(
                {
                  text: i,
                  onConfirm: ({ dialogClose: a }) => {
                    e.removeTemplate(t), a();
                  },
                },
                c,
              );
      ...
      function x(e) {
        const { sources: t, chartUndoModel: a } = e,
          n = (0, i.useMemo)(() => t.every(e => e.toolname === t[0].toolname), [t]);
        return i.createElement(z, {
          ...
          applyTemplate: n
            ? function (e) {
                1 === t.length
                  ? a.applyLineToolTemplate(t[0], e, w)
                  : (a.beginUndoMacro(M),
                    t.forEach(t => {
      ...
      function C(e) {
        return (0, l.onWidget)()
          ? i.createElement(A, { ...e })
          : i.createElement(n.Provider, { store: r.store }, i.createElement(x, { ...e }));
      }
    },
    380865: (e, t, a) => {
      'use strict';
      a.d(t, { PropertiesEditorTab: () => c });
      var i = a(50959),
        n = a(633064);
      const l = {
          ...
          i.createElement(
            ...
            t &&
              i.createElement(
                ...
                t.definitions
                  .value()
                  .map(e => i.createElement(o.Section, { key: e.id, definition: e })),
              ),
          ),
        );
      }
    ...
    284145: (e, t, a) => {
      'use strict';
      a.r(t), a.d(t, { SourcePropertiesEditorRenderer: () => C });
      var i = a(50959),
        n = a(500962),
        l = a(559410),
        r = a(650151),
        ...
        z = a(156963),
        w = a(255309);
      const M = new k.TranslatedString(
        'change {sourceTitle} title to {newSourceTitle}',
        u.t(null, void 0, a(328065)),
      );
      class x extends i.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._getTranslatedStringForSource = e =>
              new k.TranslatedString(e.name(), e.title(g.TitleDisplayTarget.StatusLine))),
            (this._setTitle = e => {
              const { source: t, model: a } = this.props,
                i = M.format({
                  sourceTitle:
                    t.properties().title.value() || this._getTranslatedStringForSource(t),
                  newSourceTitle: e,
                });
            ...
            (this._renderFooterLeft = () => {
              ...
              return (0, T.isLineTool)(e)
                ? i.createElement(p.FooterMenu, { sources: [e], chartUndoModel: t })
                : i.createElement(
                    E.MatchMedia,
                    { rule: 'screen and (max-width: 430px)' },
                    a =>
                      (0, v.isStudy)(e) &&
                      i.createElement(f.StudyDefaultsManager, {
                        model: t,
                        source: e,
          ...
          (this.state = { activePageId: a, tableKey: Date.now(), isRenaming: !1 }),
        ...
        render() {
          ...
          const { onCancel: t, source: a } = this.props,
            ...
            r =
              (null === (e = a.properties().title) || void 0 === e ? void 0 : e.value()) ||
              a.title(g.TitleDisplayTarget.StatusLine),
            s = i.createElement(L.Title, {
              isRenaming: l,
              onChangeMode: this._handleChangeMode,
              setTitle: this._setTitle,
              defaultTitle: r,
              canBeRenamed: (0, T.isLineTool)(a) && !z.enabled('widget'),
            });
          return i.createElement(d.AdaptiveConfirmDialog, {
            dataName: (0, v.isStudy)(a)
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            const { pages: a, source: n } = this.props,
              ...
              s = a.map(({ title: e, id: t }) => ({ label: e, id: t, dataId: `${r}-${t}` }));
            return i.createElement(
              i.Fragment,
              null,
        ...
        return (
          ...
          i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('span', { className: d.ellipsis }, ' ', f),
              h &&
                i.createElement(
                  i.Fragment,
                  null,
                  i.createElement(r.Icon, {
                    ...
                    icon: u,
                    onClick: function () {
                      (0, c.trackEvent)('GUI', 'Rename', 'Drawing settings'), T(f), a(!0);
                    },
                    'data-name': 'edit',
                    'data-role': 'button',
                  }),
                  i.createElement('div', { className: n(d.empty, !t && d.hideEmpty) }),
                ),
            ),
            h &&
              i.createElement(
                ...
                i.createElement(l.InputControl, {
                  ...
                  onKeyDown: function (e) {
                    27 === (0, o.hashFromEvent)(e) && (e.preventDefault(), T(p), a(!1));
                    13 === (0, o.hashFromEvent)(e) && (e.preventDefault(), b());
                  },
                  'data-disable-drag': !0,
                  stretch: !0,
                }),
    ...
    772551: (e, t, a) => {
      'use strict';
      a.r(t), a.d(t, { SourcesPropertiesEditorRenderer: () => T });
      var i = a(50959),
        n = a(500962),
        l = a(19406),
        r = a(509806),
      ...
      function g(e) {
        const {
          ...
          y = !!(
            ...
            T.every(e => {
              ...
              return (
                (null == S ? void 0 : S.id) ===
                (null === (t = f.model().lineToolsGroupModel().groupForLineTool(e)) || void 0 === t
                  ? void 0
                  : t.id)
              );
            })
        ...
        const x = i.createElement(d.Title, {
          isRenaming: D,
        ...
        return i.createElement(o.AdaptiveConfirmDialog, {
          ...
          footerLeftRenderer: function () {
            return i.createElement(c.FooterMenu, { sources: T, chartUndoModel: f });
          },
          render: function () {
            ...
            return i.createElement(
              ...
              i.createElement(
                ...
                null,
                i.createElement(u.PropertiesEditorTab, { page: e, tableKey: E }),
              ),
            );
          },
          submitOnEnterKey: !1,
    ...
    855342: (e, t, a) => {
      ...
      function r(e, t) {
        return { type: i.ADD_TEMPLATE, templateName: t, toolName: e };
      }
      function s(e, t) {
      ...
      function c(e, t, a) {
        return { type: i.SAVE_TEMPLATE, templateName: t, toolName: e, content: a };
      }
      function u(e, t, a) {
        return { type: i.LOAD_TEMPLATE, toolName: e, templateName: t, callback: a };
      }
    },
    765827: (e, t, a) => {
      'use strict';
    ...
    986661: (e, t, a) => {
      ...
      var d = a(362830);
      const m = (0, o.getLogger)('Chart.LineToolTemplatesList');
      function p(e, t) {
        return t;
      }
      function* h() {
        for (;;) {
          const {
            ...
            templateName: t,
            content: a,
          } = p(s.SAVE_TEMPLATE, yield (0, l.take)(s.SAVE_TEMPLATE));
          try {
            yield (0, l.call)(d.backend.saveDrawingTemplate, e, t, a),
              yield (0, l.put)((0, c.addTemplate)(e, t));
          } catch (e) {
            m.logWarn(e);
          }
        }
      ...
      function* _() {
        for (;;) {
          const { toolName: e, templateName: t } = p(
            s.START_REMOVE_TEMPLATE,
            yield (0, l.take)(s.START_REMOVE_TEMPLATE),
          );
          try {
            yield (0, l.call)(d.backend.removeDrawingTemplate, e, t),
              yield (0, l.put)((0, c.removeTemplate)(e, t));
          } catch (e) {
            m.logWarn(e);
          }
        }
      ...
      function* g() {
        const e = new Map();
        for (;;) {
          const { toolName: a, callback: i } = p(
            s.GET_TEMPLATES,
            yield (0, l.take)(s.GET_TEMPLATES),
          );
          e.has(a)
            ? (0, r.ensureDefined)(e.get(a)).push(i)
            : (e.set(a, [i]), yield (0, l.fork)(t, a));
        }
        function* t(t) {
          try {
            const e = u(
              d.backend.getDrawingTemplates,
              yield (0, l.call)(d.backend.getDrawingTemplates, t),
            );
            yield (0, l.put)((0, c.setTemplates)(t, e));
          } catch (e) {
            m.logWarn(e);
          }
          (0, r.ensureDefined)(e.get(t)).forEach(e => (null == e ? void 0 : e())), e.delete(t);
        }
      }
      function* T() {
        for (;;) {
          const {
            ...
            templateName: t,
            callback: a,
          } = p(s.LOAD_TEMPLATE, yield (0, l.take)(s.LOAD_TEMPLATE));
          try {
            const i = u(
              d.backend.loadDrawingTemplate,
              yield (0, l.call)(d.backend.loadDrawingTemplate, e, t),
            );
            a && a(i);
          } catch (e) {
            m.logWarn(e);
      ...
      function* f() {
        yield (0, l.all)([(0, l.call)(g), (0, l.call)(h), (0, l.call)(_), (0, l.call)(T)]);
      }
      const v = { templates: {} };
      function b(e, t) {
        ...
        switch (t.type) {
          case s.ADD_TEMPLATE: {
            ...
            if (!e.templates[a].includes(i)) {
              ...
              return { ...e, templates: { ...e.templates, [a]: t } };
            }
            return e;
          }
          case s.SET_TEMPLATES: {
            const { toolName: a, templates: i } = t;
            return { ...e, templates: { ...e.templates, [a]: [...i].sort(b) } };
          }
          case s.REMOVE_TEMPLATE: {
            const { toolName: a, templateName: i } = t;
            return {
              ...e,
              templates: { ...e.templates, [a]: e.templates[a].filter(e => e !== i) },
            };
          }
          default:
            return e;
      ...
      const y = (function () {
        const e = (0, n.default)(),
          t = (0, i.createStore)(S, (0, i.applyMiddleware)(e));
        return e.run(f), t;
      })();
    },
    980458: (e, t, a) => {
