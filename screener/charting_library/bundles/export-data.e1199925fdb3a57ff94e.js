    ...
    138988: (e, t, i) => {
      ...
      function h(e, t = {}) {
        ...
        const x = (function (e, t, i, s, n) {
          const r = (0, l.ensureNotNull)(e.range().value(), 'time scale points range'),
            u = (function (e, t, i, s) {
              var n, r;
              const u = s.from,
                d = s.to,
                f = e.range().value(),
                h = (0, l.ensureNotNull)(
                  void 0 !== u ? e.indexOf(u, !0) : (0, l.ensureNotNull)(f).firstIndex,
                ),
                m = (0, l.ensureNotNull)(
                  void 0 !== d ? e.indexOf(d, !0) : (0, l.ensureNotNull)(f).lastIndex,
                );
              let p = m,
                T = h;
              for (let e = 0; e < t.length; e++) {
                const l = t[e],
                  o = s.includeOffsetStudyValues
                    ? (0, c.max)(
                        null !==
                          (r = null === (n = i[e]) || void 0 === n ? void 0 : n.fieldPlotOffsets) &&
                          void 0 !== r
                          ? r
                          : [0],
                      )
          ...
          for (let e = d; e <= f; e++) {
            const t = {
              index: e,
              time: (0, l.ensureNotNull)(s.convertTimePointIndexToInternalTime(e)),
              publicTime: (0, l.ensureNotNull)(s.convertTimePointIndexToPublicTime(e)),
            };
        ...
        for (let e = P; e <= S; ++e) {
          ...
          e.fill(NaN),
            s.data.push(e),
            i.includeDisplayedValues && s.displayedData.push(new Array(D).fill(''));
        }
        ...
        if (i.includeSeries) {
          ...
          e.each((e, l) => {
            const n = s.data[e - P],
              ...
              u = v(l[4]);
            if (
              ((n[b] = o), (n[b + 1] = a), (n[b + 2] = r), (n[b + 3] = u), i.includeDisplayedValues)
            ) {
              const i = s.displayedData[e - P];
              (i[b] = t(o)), (i[b + 1] = t(a)), (i[b + 2] = t(r)), (i[b + 3] = t(u));
            }
            return !1;
          });
        }
            ...
            t.data()
              ...
              .each((e, t) => {
                const l = s.data[e - r],
                  o = v(t[a]);
                return (
                  (l[c] = o), i.includeDisplayedValues && (s.displayedData[e - r][c] = n(o)), !1
                );
              });
          }
          w += l.fields.length;
