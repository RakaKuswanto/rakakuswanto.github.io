(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    803801: e => {
      e.exports = { 'toast-wrapper': 'toast-wrapper-obA6wWzN', compact: 'compact-obA6wWzN' };
    },
    355485: (e, t, s) => {
      'use strict';
      s.r(t), s.d(t, { globalToasts: () => u, showToast: () => c });
      var a = s(50959),
        o = s(497754),
        i = s(358244),
        r = s(586240),
        n = s(803801);
      const h = r['media-mf-phone-landscape'];
      function d(e) {
        const { suggestedLayout: t, children: s } = e;
        return a.createElement(
          'div',
          { className: o(n['toast-wrapper'], 'compact' === t && n.compact) },
          s,
        );
      }
      const u = new (class {
        constructor() {
          var e;
          (this._mediaQuery = window.matchMedia(h)),
            (this._handleMediaQueryChange = () => {
              this._toastsLayer.update({ suggestedLayout: this._getSuggestedLayout() });
            }),
            (this._handleLoginStateChange = () => {
              this._toastsLayer.update({ location: this._getLocation() });
            }),
            (this._toastsLayer = new i.ToastsLayer(
        ...
        showCustomToast(e) {
          ...
          return this._toastsLayer.showToast({
            render:
              ((o = t),
              e => a.createElement(d, { suggestedLayout: e.suggestedLayout, children: o(e) })),
            ...s,
          }).remove;
        }
        reset() {
