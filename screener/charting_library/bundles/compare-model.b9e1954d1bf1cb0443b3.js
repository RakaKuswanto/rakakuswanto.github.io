  ...
  [7271],
  {
      ...
      function o() {
        ...
        return null !==
          (s =
            ...
            void 0 === t
              ? void 0
              : t.map(e => ({ ...e, country: '', providerId: '', flag: '' }))) && void 0 !== s
          ? s
          : [];
      }
    ...
    542923: (e, t, s) => {
      ...
      !(function (e) {
        ...
        function s(e) {
          {
            const t = n.enabled('pay_attention_to_ticker_not_symbol') ? e.ticker : e.full_name;
    ...
    384327: (e, t, s) => {
      ...
      function i(e) {
        ...
        return new Map([...t.entries()].sort(([e], [t]) => o.indexOf(e) - o.indexOf(t)));
      }
      function a(e, t) {
    ...
    926163: (e, t, s) => {
      ...
      const m = (0, u.getExchanges)(),
        y = {};
      for (const e of m) y[e.value] = { country: e.country, providerId: e.providerId };
      var S = s(372037);
      function _(e) {
          ...
          };
        {
          ...
          t.logo_urls &&
            ...
            (t.logo_urls.length > 1
              ? ((n.baseCurrencyLogoId = t.logo_urls[0]), (n.currencyLogoId = t.logo_urls[1]))
      ...
      class k {
        constructor(e) {
          (this._contentItemList = new a.WatchedValue([])),
            ...
            (this._recentSymbolsEnabled = r.enabled('compare_recent_symbols_enabled')),
            ...
            (this._getResolveSymbolPromise = (e, t) =>
              new Promise(s => {
                const r = (0, o.ensureNotNull)(this._chartSession).resolveSymbol(
        ...
        applyStudy(e, t, s) {
          (0, I.runOrSignIn)(
            () => {
              ...
              if (!o) return;
              if ((0, v.isSeparatorItem)(e)) return;
              let r;
              switch (t) {
              ...
              Promise.all([this._getResolveSymbolPromise(e), r]).then(t =>
                this._handleApplyProcess(
                  ...
                  (e, t, s) =>
                    'symbol_resolved' === e.method ? p(e.params[1], !0, s) : f(t, !0, s),
                ),
              ),
                b.emit('add_compare');
            },
            { source: 'Compare apply study' },
          );
        }
        _snapshoter() {
        ...
        _handleInitProcess(e, t, s, o) {
          ...
          for (const n of e) {
            ...
            if (void 0 === a || c) this._recentSymbolsEnabled && r.push(o(e, i, !1));
            else for (const t of a) r.push(o(e, i, !0, this._idToStudyMap.get(t)));
          }
        ...
        _updateContentItemList(e, t) {
          ...
          if (this._recentSymbolsEnabled) {
            const e = new Set(),
              t = s
                .reduce(
                  (t, s) => (s.checked || e.has(s.symbol) || (t.push(s), e.add(s.symbol)), t),
                  [],
                )
        ...
        _loadRecent() {
          ...
          return g.getJSON('CompareDialog.recent', []).filter(e => 'string' == typeof e);
        }
        _saveRecent(e) {
          if (!this._recentSymbolsEnabled) return;
          ...
          t.has(e) && t.delete(e),
            t.add(e),
            g.setJSON('CompareDialog.recent', Array.from(t).slice(-this._recentLength));
        }
    ...
    398171: (e, t, s) => {
      'use strict';
      s.d(t, { isSeparatorItem: () => r });
      var o = s(173850);
      function r(e) {
        return (0, o.isSeparatorItem)(e);
      }
    },
    190266: (e, t, s) => {
      'use strict';
