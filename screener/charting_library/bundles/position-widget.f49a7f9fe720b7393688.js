(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8751],
  {
    ...
    106315: e => {
      e.exports = { dialog: 'dialog-YZ_qHmON', dialogBody: 'dialogBody-YZ_qHmON' };
    },
    608987: e => {
      e.exports = { positionInfo: 'positionInfo-oWbWR7tt', title: 'title-oWbWR7tt' };
    },
    583014: e => {
    ...
    389986: (e, t, n) => {
      ...
      const d = i.forwardRef((e, t) =>
        i.createElement(o.NavButton, { ...e, ref: t, icon: u(e.size) }),
      );
    },
    270762: (e, t, n) => {
      'use strict';
      ...
      function l(e) {
        ...
        return i.createElement(
          ...
          i.createElement(r.Icon, { icon: n, className: a.icon, 'aria-hidden': !0 }),
      ...
      const c = (0, i.forwardRef)((e, t) => {
        ...
        return i.createElement(
          'button',
          { ...d, className: s({ ...e, children: u }), ref: t, type: o },
          i.createElement(l, { icon: n }, u),
        );
      });
      ...
      var u = n(591365),
        d = n(273388);
      (0, i.forwardRef)((e, t) => {
        const { icon: n, renderComponent: o, 'aria-label': r, ...a } = e,
          c = null != o ? o : u.CustomComponentDefaultLink;
        return i.createElement(
          c,
          {
            ...a,
            className: s({ ...e, children: r, isLink: !0 }),
            reference: (0, d.isomorphicRef)(t),
          },
          i.createElement(l, { icon: n }, r),
        );
    ...
    865968: (e, t, n) => {
      ...
      function u(e, t) {
        return a(
          [9, (0, i.useCallback)(() => o.Modifiers.Shift + 9, []), 27],
          t,
          (0, i.useCallback)(() => e, [e]),
        );
      }
    ...
    772069: (e, t, n) => {
      ...
      function c(e) {
        const {
          ...
          [g, v] = (0, a.useFocus)(),
          b = g || h,
          C = (null != n ? n : void 0 !== t) ? (0, l.createDomId)(t, 'listbox') : void 0,
          k = (0, i.useRef)(null),
          w = (0, i.useCallback)(
            e => {
              var t;
              return null === (t = k.current) || void 0 === t ? void 0 : t.focus(e);
            },
            [k],
          ),
          x = (0, i.useRef)(null),
          _ = (0, i.useCallback)(() => (0, o.ensureNotNull)(x.current).focus(), [x]),
          S = (0, i.useCallback)(() => f(!0), [f]),
          y = (0, i.useCallback)(
            (e = !1, t = !1) => {
              f(!1);
              const { activeElement: n } = document;
              (n && (0, r.isTextEditingField)(n)) || t || w({ preventScroll: e });
            },
            [f, w],
          ),
          E = (0, i.useCallback)(() => {
          ...
          z = c ? [] : [m, v.onBlur],
          T = c ? [] : [p, E],
          N = (0, s.createSafeMulticastEventHandler)(...P),
          M = (0, s.createSafeMulticastEventHandler)(...z),
          I = (0, s.createSafeMulticastEventHandler)(...T);
        return {
          listboxId: C,
          isOpened: h,
          isFocused: b,
          ...
          toggle: E,
          onOpen: _,
          buttonFocusBindings: { onFocus: N, onBlur: M },
          onButtonClick: I,
          buttonRef: k,
          listboxRef: x,
          buttonAria: { 'aria-controls': h ? C : void 0, 'aria-expanded': h, 'aria-disabled': c },
        };
      }
    },
    648621: (e, t, n) => {
      ...
      function a(e, t, n, a, s, l = {}, c) {
        const u = (0, i.useCallback)(
          ...
          { next: f = h.next, previous: g = h.previous, first: v = h.first, last: b = h.last } = l;
        return (0, o.useComposedKeyboardActionHandlers)(
          (0, o.useKeyboardActionHandler)(f, u),
          (0, o.useKeyboardActionHandler)(g, d),
          (0, o.useKeyboardActionHandler)(v, m),
          (0, o.useKeyboardActionHandler)(b, p),
        );
      }
    },
    930617: (e, t, n) => {
      ...
      function c(e, t, n, i, o, a) {
        const l = (function (e, t, n, i = 0) {
          const o = s[e];
          return {
            start: -1 * i,
            middle: -1 * (Math.floor(n[o.size] / 2) - Math.floor(t[o.size] / 2)),
            end: -1 * (n[o.size] - t[o.size]) + i,
          };
        })(e, i, o, a.additionalScroll);
        let c = 0;
        if (
          (function (e, t, n) {
            const i = s[e];
            return t[i.start] < n[i.start] - n[i.size] / 2 || t[i.end] > n[i.end] + n[i.size] / 2;
          })(e, i, o)
        )
          c = l.middle;
        else {
          const t = (function (e, t, n, i = 0) {
              const o = s[e],
                r = t[o.start] + Math.floor(t[o.size] / 2),
                a = n[o.start] + Math.floor(n[o.size] / 2);
              return {
                start: t[o.start] - n[o.start] - i,
                middle: r - a,
                end: t[o.end] - n[o.end] + i,
              };
            })(e, i, o, a.additionalScroll),
            n = (function (e) {
              const { start: t, middle: n, end: i } = e,
                o = new Map([
                  [Math.abs(t), { key: 'start', value: Math.sign(t) }],
                  [Math.abs(n), { key: 'middle', value: Math.sign(n) }],
                  [Math.abs(i), { key: 'end', value: Math.sign(i) }],
                ]),
                r = Math.min(...o.keys());
              return o.get(r);
            })(t);
        ...
        return (function (e) {
          const {
            ...
            duration: n = r.dur,
            func: i = r.easingFunc.easeInOutCubic,
            onScrollEnd: o,
            target: a,
            wrap: s,
          ...
          const d = ('vertical' === l ? c.top - u.top : c.left - u.left) + t,
            m = 'vertical' === l ? 'scrollTop' : 'scrollLeft',
            p = s ? s[m] : 0;
          let h,
            f = 0;
          return (
            (f = window.requestAnimationFrame(function e(t) {
              let r;
              if ((h ? (r = t - h) : ((r = 0), (h = t)), r >= n))
                return (s[m] = p + d), void (o && o());
              const a = p + d * i(r / n);
              (s[m] = Math.floor(a)), (f = window.requestAnimationFrame(e));
            })),
            function () {
              window.cancelAnimationFrame(f), o && o();
            }
          );
        })({
          ...a,
        ...
        scrollTo(e, t = a) {
          if (
            ...
            !(function (e, t) {
              ...
              return (
                n.top >= i.top && n.bottom <= i.bottom && n.left >= i.left && n.right <= i.right
              );
            })(e, this._container)
          ) {
            const n = e.getBoundingClientRect(),
      ...
      function d(e = {}) {
        const { activeItem: t, getKey: n, ...r } = e,
          ...
          l = (function (e) {
            ...
            return (
              (0, i.useEffect)(
                () => ((t.current = new u(e)), () => (0, o.ensureNotNull)(t.current).destroy()),
                [],
              ),
              t
            );
          ...
          m = (0, i.useCallback)(
            (e, t) => {
              const i = n ? n(e) : e;
              t ? s.current.set(i, t) : s.current.delete(i);
            },
            [s, n],
          ),
          p = (0, i.useCallback)(
            (e, t) => {
              ...
              const i = n ? n(e) : e,
                r = s.current.get(i);
              r && (c(), (0, o.ensureNotNull)(l.current).scrollTo(r, t));
            },
            [s, l, n],
          );
        return (0, i.useEffect)(() => p(t, r), [p, t]), [d, m, p];
      }
    },
    918460: (e, t, n) => {
      'use strict';
      ...
      var i = n(50959),
        ...
        d = n(348535),
        m = n.n(d);
      const p = { danger: l, warning: l, success: u, default: c };
      function h(e) {
        const {
          informerIntent: t,
          content: n,
        ...
        return i.createElement(
          'div',
          {
            className: o(m().container, m()[`container-${t}`], C && m()[`light-container-${t}`], l),
            ...(0, s.filterDataProps)(e),
            ...(0, s.filterAriaProps)(e),
          },
          i.createElement(
            'div',
            { className: m().informerBody },
            n &&
              i.createElement(
                'div',
                { className: m().mainProblem },
                u &&
                  i.createElement(r.Icon, {
                    className: o(m().icon, C && m()['light-icon']),
                    icon: null != h ? h : p[t],
                  }),
                i.createElement(
                  'div',
                  { className: o(m()['text-wrap'], C && m()['light-text-wrap']) },
                  c &&
                    i.createElement(
                      'span',
                      {
          ...
          d &&
            i.createElement(a.CloseButton, {
              'aria-label': g,
              onClick: f,
              className: o(C && m()['light-close-button'], m()['close-button']),
    ...
    414823: (e, t, n) => {
      ...
      function l(...e) {
        const t = e.map(r).filter(o).filter(a).map(s);
        return (t.length > 0 && t[0].startsWith('id_') ? t : ['id', ...t]).join('_');
      }
      function c(...e) {
        return e.map(r).filter(o).filter(a).join(' ');
      }
    },
    904925: (e, t, n) => {
      'use strict';
      ...
      function s(e, t, n) {
        return (0, i.useCallback)(
          () =>
            (function (e, t, { x: n = a.x, y: i = a.y } = a) {
              const o = (0, r.ensureNotNull)(e).getBoundingClientRect(),
                s = {
                  x: o.left + n,
                  y: o.top + o.height + i,
    ...
    382799: (e, t, n) => {
      ...
      n.r(t),
        n.d(t, {
          closePositionDialog: () => H,
          mountPositionPanel: () => K,
          showPositionDialog: () => L,
          unmountPositionPanel: () => D,
        });
      var i = n(50959),
        o = n(500962),
        r = n(930894),
      ...
      function k(e) {
        const { model: t } = e,
          n = (0, v.useObservable)(t.infoTableData(), { rows: [] });
        return i.createElement(
          'div',
          { className: C.positionInfo },
          i.createElement('div', { className: C.title }, t.title()),
          i.createElement(b.InfoTable, {
            rows: n.rows,
            header: n.header,
            disabled: !1,
      ...
      var w = n(40176),
        x = n(895318),
        _ = n(398327);
      const S = (0, d.getLogger)('Trading.OrderPanel');
        ...
        constructor(e) {
          super(e),
            ...
            (this._onEnter = e => {
              ...
              if (!((13 !== t && t !== c.hashShiftPlusEnter) || this.props.model.disabled.value()))
                return l.CheckMobile.any() ? this._blur() : void this.props.model.doneButtonClick();
            }),
            (this._blur = () => {
              document.activeElement instanceof HTMLElement
                ? document.activeElement.blur()
                : S.logWarn('Failed to deselect: active element is not HTMLElement');
            }),
            (this._callback = () => this.forceUpdate());
        }
        componentDidMount() {
          this._subscribeToModel(this.props.model),
            this.props.settings.subscribe(this._callback),
            null !== this._block && void 0 === this.props.focus && this._block.focus();
        }
        componentWillUnmount() {
          this._unsubscribeFromModel(this.props.model),
            this.props.settings.unsubscribe(this._callback);
        }
        render() {
          const { model: e, settings: t, focus: n } = this.props,
            o = { value: t.value(), setValue: t.setValue.bind(t) },
            r = e.warning.value();
          return i.createElement(
            x.SettingsContext.Provider,
            { value: o },
            i.createElement(
              'div',
              {
              ...
              e.mode.value() === g.OrderEditorDisplayMode.Popup &&
                i.createElement(p.HeaderContainer, { ...this.props.model.headerStateValue }),
              i.createElement(
                'div',
                { className: _.brackets },
                i.createElement(h.BracketControlGroup, { model: e, focus: n }),
              ),
              Array.isArray(e.customFieldModels.value()) &&
                ...
                i.createElement(
                  ...
                  i.createElement('div', { className: _.separator }),
                  i.createElement(w.CustomFields, {
              ...
              void 0 !== e.buttonModel &&
                i.createElement(
                  'div',
                  { className: _.button },
                  i.createElement(f.PlaceAndModifyButton, { model: e, buttonModel: e.buttonModel }),
                ),
              this._shouldShowPositionInfo() &&
                i.createElement(
                  'div',
                  ...
                  i.createElement(k, {
                    ...
                    model: (0, m.ensureNotNull)(e.positionInfoModel),
                  }),
                ),
            ),
          );
        }
        _shouldShowPositionInfo() {
          const { model: e } = this.props;
          return (
            e.mode.value() === g.OrderEditorDisplayMode.Panel &&
            null !== e.positionInfoModel &&
            e.positionInfoModel.getOrderInfoTableRowsCount() > 0
          );
        }
        _subscribeToModel(e) {
          this.props.model.disabled.subscribe(this._callback),
            this.props.model.loading.subscribe(this._callback),
            this.props.model.mode.subscribe(this._callback),
            this.props.model.warning.subscribe(this._callback);
        }
        _unsubscribeFromModel(e) {
          this.props.model.disabled.unsubscribe(this._callback),
            this.props.model.loading.unsubscribe(this._callback),
            this.props.model.mode.unsubscribe(this._callback),
            this.props.model.warning.unsubscribe(this._callback);
        }
      }
      var E = n(996038),
        P = n(274837),
        z = n(106315);
      const T = i.memo(e => {
        const { model: t, isOpened: n, settings: o, focus: l, onOpen: c, onClose: u } = e;
        return (
          (0, P.useCommonDialogHandlers)({ isOpened: n, onOpen: c, onClose: u }),
          i.createElement(s.MatchMedia, { rule: E.DialogBreakpoints.TabletSmall }, e =>
            i.createElement(
              a.PopupDialog,
              { className: z.dialog, isOpened: n, onKeyDown: d, width: 414, fullscreen: e },
              i.createElement(
                r.Body,
                { className: z.dialogBody },
                t && o && i.createElement(y, { settings: o, model: t, key: t.id, focus: l }),
              ),
            ),
          )
        );
      ...
      let I = null,
        R = !1;
      function L(e) {
        const { viewModel: t, settings: n, focus: i, onClose: r, onOpen: a } = e;
        H(r);
        const s = {
          model: t,
          settings: n,
          ...
          onClose: () => {
            H(r),
              void 0 !== s.onClose &&
                (t.headerModel.pinButtonClicked().unsubscribe(null, s.onClose),
                t.headerModel.closeButtonClicked().unsubscribe(null, s.onClose)),
              I && (o.unmountComponentAtNode(I), (R = !1));
          },
        };
        B(s),
          (R = !0),
          void 0 !== s.onClose &&
            (t.headerModel.pinButtonClicked().subscribe(null, s.onClose),
            t.headerModel.closeButtonClicked().subscribe(null, s.onClose));
      }
      function H(e) {
        R && (B({ model: null, isOpened: !1 }), null == e || e());
      }
      function B(e) {
        I || ((I = document.createElement('div')), document.body.appendChild(I));
        const t = i.createElement(
          g.Context.Provider,
          {
            value: {
              mode: (e.model && e.model.mode.value()) || g.OrderEditorDisplayMode.Panel,
      ...
      function K(e, t, n, r) {
        ...
        const a = {
          ...
          onClose: () => {
            D(n),
              a.model.headerModel.pinButtonClicked().unsubscribe(null, a.onClose),
              a.model.headerModel.closeButtonClicked().unsubscribe(null, a.onClose);
          },
          onCancel: () => {
            a.model.headerModel && a.model.headerModel.back();
          },
        };
        a.model.headerModel.pinButtonClicked().subscribe(null, a.onClose),
          a.model.headerModel.closeButtonClicked().subscribe(null, a.onClose),
          (function (e, t) {
    ...
    782806: e => {
      e.exports = {
        ...
        es: ['Cambiar el tipo de órdenes con punto máximo de pérdida (stop loss)'],
    ...
    602607: e => {
      e.exports = {
        ...
        ca_ES: ["El valor especificat és més gran que el màxim de l'instrument: {max}"],
        cs: 'Specified value is more than the instrument maximum of {max}.',
        de: ['Der angegebene Wert ist größer als das Instrumentenmaximum von {max}.'],
        ...
        es: ['El valor especificado es mayor al máximo del instrumento: {max}.'],
        fa: 'Specified value is more than the instrument maximum of {max}.',
        fr: ["La valeur spécifiée est supérieure au maximum de {max} de l'instrument."],
        he_IL: ['הערך שצוין הוא יותר מהמקסימום של המכשיר {max}.'],
        hu_HU: 'Specified value is more than the instrument maximum of {max}.',
        id_ID: ['Nilai yang ditentukan lebih dari maksimum instrumen yaitu {max}.'],
        it: ['Il valore specificato è superiore al massimo dello strumento: {max}.'],
        ja: ['指定された値が銘柄の最大値 {max} を超えています。'],
        ko: ['지정값이 인스트루먼트 맥시멈인 {max} 보다 큽니다.'],
        ms_MY: ['Nilai yang ditentukan adalah lebih daripada instrumen maksimum {max}.'],
        ...
        tr: ['Belirtilen değer, enstrümanın en fazla değerinden daha fazladır {max}.'],
        vi: ['Giá trị đã chỉ định lớn hơn giá trị tối đa của công cụ là {max}.'],
        zh: ['指定值大于商品最大值{max}。'],
    ...
    53669: e => {
      e.exports = {
        ...
        ca_ES: ["El valor especificat és més petit que el mínim de l'instrument: {min}"],
        cs: 'Specified value is less than the instrument minimum of {min}.',
        de: ['Der angegebene Wert ist kleiner als das Instrumentenminimum von {min}.'],
        ...
        fr: ["La valeur spécifiée est inférieure au minimum de {min} de l'instrument."],
        he_IL: ['הערך שצוין הוא פחות מהמינימום של המכשיר {min}.'],
        hu_HU: 'Specified value is less than the instrument minimum of {min}.',
        id_ID: ['Nilai yang ditentukan kurang dari minimum instrumen yaitu {min}.'],
        it: ['Il valore specificato è inferiore al minimo dello strumento: {min}.'],
        ja: ['指定された値が銘柄の最小値 {min} 未満です。'],
        ko: ['지정값이 인스트루먼트 미니멈인 {min} 보다 작습니다.'],
        ms_MY: ['Nilai yang ditentukan adalah kurang daripada instrumen minimum {min}.'],
        nl_NL: 'Specified value is less than the instrument minimum of {min}.',
        pl: ['Podana wartość jest mniejsza niż minimum instrumentu wynoszące {min}.'],
        ...
        vi: ['Giá trị đã chỉ định nhỏ hơn giá trị tối thiểu của công cụ là {min}.'],
        zh: ['指定值小于商品最小值{min}。'],
