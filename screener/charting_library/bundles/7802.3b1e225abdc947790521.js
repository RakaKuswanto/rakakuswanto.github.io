(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7802],
  {
    ...
    855395: e => {
      e.exports = {
        'info-icon': 'info-icon-WcwkbGic',
        'size-s': 'size-s-WcwkbGic',
        'size-m': 'size-m-WcwkbGic',
        'info-icon-wrap': 'info-icon-wrap-WcwkbGic',
      };
    },
    760673: e => {
    ...
    942544: (e, t, n) => {
      ...
      function s(e) {
        const { intent: t, highlight: n, ...s } = e,
          { isFocused: r, ...l } = (0, o.useDisclosure)(s);
        return {
          ...l,
          isFocused: r,
      ...
      function v(e) {
        ...
        return s.createElement(
          'span',
          {
            ...
            role: 'img',
            'aria-label': e.text,
            className: i('apply-common-tooltip', d['info-icon-wrap'], e.className),
            onClick: null !== (t = e.customClickHandler) && void 0 !== t ? t : b,
          },
          s.createElement(a.Icon, {
            icon: r,
            className: i(d['info-icon'], d[`size-${n}`]),
            'aria-hidden': 'true',
          }),
        );
      }
      !(function (e) {
        (e.Small = 's'), (e.Medium = 'm');
      })(o || (o = {}));
      var f = n(794476);
      function w(e) {
        const { title: t, help: n, disabled: i, checked: a, onControlFocused: c } = e,
          [u, d] = (0, l.useWatchedValue)(a);
        return s.createElement(
          'div',
          {
            className: f.wrapper,
          ...
          void 0 !== n &&
            '' !== n &&
            s.createElement(v, { size: o.Small, text: n, className: f.help }),
        );
      }
    },
    587374: (e, t, n) => {
      'use strict';
      n.d(t, { CustomComboboxContainer: () => w });
      var o = n(50959),
        s = n(509806),
        r = n(497754),
        l = n.n(r),
      ...
      const d = o.forwardRef((e, t) => {
        ...
        const {
          ...
          y = (0, a.useControlValidationLayout)({
            hasErrors: m,
            hasWarnings: p,
            errors: b,
            warnings: v,
          ...
          k = (0, c.createSafeMulticastEventHandler)(r, y.onFocus),
          M = (0, c.createSafeMulticastEventHandler)(l, y.onBlur),
          S = (0, c.createSafeMulticastEventHandler)(d, y.onMouseOver),
        ...
        return o.createElement(
          ...
          o.createElement(i.Select, {
            ...E,
            intent: null !== (n = y.intent) && void 0 !== n ? n : s,
            onFocus: k,
            onBlur: M,
            onMouseOver: S,
            onMouseOut: I,
      ...
      function f(e) {
        const {
          ...
          x = (0, o.useMemo)(
            () =>
              (function (e) {
                return e.map(e => ({ value: e.value, content: e.text }));
              })(t),
            [t],
          ),
          E = (0, o.useMemo)(
            () =>
              Object.values(x).map((e, t) => {
                var n;
        ...
        function k(e) {
          return o.createElement(d, {
            ...
            items: x,
            className: v.select,
            menuClassName: e ? v.selectMenu : void 0,
            onClick: M,
            onChange: S,
            disabled: u,
            placeholder: void 0 === c ? s.t(null, void 0, n(880280)) : void 0,
            addPlaceholderToItems: !1,
            hasErrors: y,
            messagesPosition: a.MessagesPosition.Static,
            inheritMessagesWidthFromTarget: !0,
            hideArrowButton: x.length <= 1,
            stretch: !0,
            alwaysShowAttachedErrors: i && y,
            matchButtonAndListboxWidths: !0,
          });
        }
        return o.createElement(p.MatchMedia, { rule: b.DialogBreakpoints.TabletSmall }, e =>
          o.createElement(
            o.Fragment,
            null,
            o.createElement(
              'div',
              { className: l()(v.title, y && v.titleWithError) },
              y ? s.t(null, { replace: { fieldTitle: f } }, n(693251)) : f,
            ),
            e
              ? o.createElement(m.ToolWidgetMenu, {
                  className: v.menuButton,
                  content: k(e),
                  children: E,
                  arrow: !1,
                  onClose: I,
      ...
      const h = o.forwardRef((e, t) => {
        const {
          ...
          T =
            ...
            o.createElement(
              a.EndSlot,
              null,
              o.createElement(u.Caret, { isDropped: w, disabled: f, className: D }),
            );
        return o.createElement(c.PopupMenuDisclosureView, {
          ...
          button: o.createElement(i.ControlSkeleton, {
            ...
            size: y,
            ref: (0, l.useMergedRefs)([B, t]),
            middleSlot: o.createElement(
              a.MiddleSlot,
              null,
              o.createElement(
                'span',
                { className: r()(d['button-children'], p && d.hiddenArrow) },
                N,
              ),
            ),
            endSlot: T,
    ...
    364228: (e, t, n) => {
      ...
      function c(e) {
        const { isDropped: t } = e;
        return o.createElement(l.Icon, { className: r()(a.icon, t && a.dropped), icon: i });
      }
      function u(e) {
        const { className: t, disabled: n, isDropped: s } = e;
        return o.createElement(
          'span',
          { className: r()(a.button, n && a.disabled, t) },
          o.createElement(c, { isDropped: s }),
        );
      }
      function d(e) {
        const { className: t, tabIndex: n = -1, disabled: s, isDropped: l, ...i } = e;
        return o.createElement(
          'button',
          {
            ...i,
            ...
            tabIndex: n,
            disabled: s,
            className: r()(a.button, s && a.disabled, t),
          },
    ...
    529631: (e, t, n) => {
      ...
      function w(e) {
        ...
        if (!s) return o.createElement('span', { className: b.placeholder }, r);
        const l =
      ...
      const C = o.forwardRef((e, t) => {
        ...
        let { items: P } = e;
        if (M && S) {
          P = [{ value: void 0, content: M, id: (0, s.createDomId)(n, 'placeholder') }, ...P];
        }
        const {
            listboxId: R,
            isOpened: H,
          ...
          [se, re, le] = (0, l.useKeepActiveItemIntoView)({ activeItem: oe }),
          ie = (0, s.joinDomIds)(O, n),
          ae = ie.length > 0 ? ie : void 0,
          ce = (0, o.useMemo)(
            () => ({ role: 'listbox', 'aria-labelledby': O, 'aria-activedescendant': f(n, oe) }),
            [O, oe],
          ),
          ue = (0, o.useCallback)(e => e.value === I, [I]),
          de = (0, o.useCallback)(e => W && W(e.value), [W]),
          he = (0, u.useItemsKeyboardNavigation)(p.isRtl, ne, ue, de, !1, {
            next: [40],
            previous: [38],
          }),
          me = (0, d.useKeyboardToggle)(q, H || T),
          pe = (0, d.useKeyboardClose)(H, $),
          be = (0, d.useKeyboardOpen)(H, X),
          ve = (0, d.useKeyboardEventHandler)([me, pe, be]),
          fe = (0, d.useKeyboardEventHandler)([he, me, pe]),
          we = (function (e) {
            const t = (0, o.useRef)(''),
              n = (0, o.useMemo)(
                () =>
            ...
            void 0 !== o && W && (n.stopPropagation(), H || X(), W(o.value));
          });
        return o.createElement(
          h.ControlDisclosureView,
          {
            ...
            onListboxKeyDown: function (e) {
              fe(e), e.defaultPrevented || we(e);
            },
            buttonChildren: o.createElement(w, { selectedItem: oe, placeholder: M }),
    ...
    686989: e => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="none"><path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M14 4a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM3 14a11 11 0 1 1 22 0 11 11 0 0 1-22 0z"/><path fill="currentColor" d="M13.5 20v-7.5H12V11h3v9h-1.5z"/><circle fill="currentColor" cx="14" cy="9" r="1"/></svg>';
    },
  },
]);
