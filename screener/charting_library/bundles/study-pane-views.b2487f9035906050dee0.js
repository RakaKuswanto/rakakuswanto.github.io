    ...
    596184: (t, e, i) => {
      ...
      class p extends d.MediaCoordinatesPaneRenderer {
        constructor(t) {
          super(),
            (this._data = null),
            (this._backHittest = new o.HitTestResult(o.HitTarget.MovePointBackground)),
            (this._points = []),
            (this._hittest = null != t ? t : new o.HitTestResult(o.HitTarget.MovePoint));
        }
        setData(t) {
        ...
        hitTest(t) {
          ...
          for (let s = 1; s < i; s++) {
            const i = this._points[s - 1],
              n = this._points[s];
            if ((0, r.distanceToSegment)(i, n, t).distance <= e) return this._hittest;
          }
          if (this._data.filled && this._data.fillBackground && i > 0) {
            const s = this._points[0],
              n = this._points[i - 1];
            if ((0, r.distanceToSegment)(s, n, t).distance <= e) return this._hittest;
          }
        ...
        _drawImpl(t) {
          ...
          s.beginPath();
          const o = this._data.linestyle === u.LINESTYLE_SOLID ? 'round' : 'butt',
            d = null !== (e = this._data.linecap) && void 0 !== e ? e : o;
          (s.lineCap = d),
            (s.strokeStyle = this._data.color),
            (s.lineWidth = this._data.linewidth),
            (s.lineJoin = null !== (i = this._data.linejoin) && void 0 !== i ? i : 'round'),
          ...
          if (
            (this._data.filled &&
              this._data.fillBackground &&
              ((s.fillStyle = (0, l.generateColor)(this._data.backcolor, this._data.transparency)),
              s.fill()),
            this._data.filled && !this._data.skipClosePath && s.closePath(),
            r > 1)
          ) {
            if (this._data.leftend === a.LineEnd.Arrow) {
              const t = this._correctArrowPoints(this._points[1], this._points[0], s.lineWidth, d);
      ...
      class l {
        ...
        _updateViewInternal() {
          ...
          const n = r.firstBar(),
            a = r.lastBar(),
            o = (0, s.ensureDefined)(
              this._provider.properties().childs().graphics.childs().backgrounds,
            );
          i.forEach((t, i) => {
            ...
            t.forEach(t => {
              const i =
                  null !== t.start
                    ? t.start
                    : (0, s.ensureNotNull)(e.points().range().value()).firstIndex,
                o = t.stop;
              if (o < n || a < i) return;
    ...
    635135: (t, e, i) => {
        ...
        hitTest(t, e) {
          ...
          for (const s of i.histograms) {
            ...
            for (const o of s.bars) {
              ...
              const d = f(s.xRange, l, e.cssWidth),
                { xBasePoint: h, sign: c, xRangeWidth: u } = d,
                p = Math.max((l.percentWidth * u) / 100 - o.subBarValues.length, 0);
              let _ = h;
              for (let e = 0; e < o.subBarValues.length; e++) {
                ...
                if (
                  ((_ = l),
                  ((t.x >= a && t.x <= l) || (t.x >= l && t.x <= a)) && t.y >= i && t.y <= s)
                )
            ...
            i.histograms.forEach(n => {
              ...
              if (
                (n.bars.forEach(s => {
                  ...
                  const d = f(n.xRange, l, e.cssWidth),
                    { xBasePoint: u, sign: p, xRangeWidth: _ } = d;
                  if (s.y > e.cssHeight || s.y + s.height < 0) return;
                  const m = Math.max((l.percentWidth * _) / 100 - s.subBarValues.length, 0);
                  let x = u;
                  for (let e = 0; e < s.subBarValues.length; e++) {
                    ...
                    const c = Math.round(a * r),
                      u = Math.round(i * r),
                      _ = Math.round(d * r) - c,
                      f = Math.max(Math.round(n * r) - u - h, 1);
                    t.rect(c, u, _, f), t.fill();
                  }
      ...
      function f(t, e, i) {
        ...
        if (s && n) (l = t.min), (d = 1);
          ...
          if (!r || !o)
            throw new Error(`Unknown location/direction values: ${e.location}/${e.direction}`);
          (l = i), (d = -1);
        }
        var h;
        return { xBasePoint: l, sign: d, xRangeWidth: r ? i : (h = t).max - h.min };
      }
      function v(t, e) {
      ...
      function g(t, e, i, s, r, n) {
        const o = Math.min(Math.round((1.7 * t) / n.length), Math.round(0.6 * i)),
          l = r.direction === a.HHistDirection.LeftToRight ? 'left' : 'right',
          { xBasePoint: h, sign: c } = s,
          u = h + 3 * c,
          p = e + 0.7 * i;
        return { text: n, color: r.valuesColor, fontSize: o, align: l, point: new d.Point(u, p) };
      }
      function m(t, e, i) {
        ...
        (t.font = `${n}px ${u.CHART_FONT_FAMILY}`),
          (t.fillStyle = r),
          (t.textAlign = a),
          (0, h.drawScaled)(t, e.pixelRatio, e.pixelRatio, () => t.fillText(s, o.x, o.y));
      }
      var x = i(32240);
      class y {
        ...
        renderer() {
          ...
          for (const e of this._textData)
            t.append(new l.TextRenderer(e, new n.HitTestResult(n.HitTarget.Regular)));
          return t;
        }
        _resetRenderersData() {
        ...
        _prepareStyles() {
          ...
          const i = (0, r.ensureDefined)(this._provider.graphicsInfo().hhists),
            ...
            o =
              (null ===
                (e =
                  null === (t = this._provider.properties().child('inputs')) || void 0 === t
                    ? void 0
          ...
          for (const t of s) {
            ...
            if (o)
              ...
              const i = (0, x.generateColor)(e.colors[0].value(), e.transparencies[0].value()),
                r = e.colors[1]
                  ? (0, x.generateColor)(e.colors[1].value(), e.transparencies[1].value())
                  : i;
          ...
          this._prepareStyles(),
            (0, r.ensureDefined)(i).forEach((i, s) => {
              ...
              i.forEach(t => {
                ...
                (!this._alwaysVisible && (o < n || r > a)) || this._updateDataForRenderers(i, t, e);
            });
        }
        _updateDataForRenderers(t, e, i) {
          ...
          const d =
              (null ===
                (n =
                  null === (s = this._provider.properties().child('inputs')) || void 0 === s
                    ? void 0
              ...
              r < l ||
                ...
                this._data.push({
                  ...
                  bottom: i.extendBottom
                    ? void 0
                    : t.priceToCoordinate((0, s.ensureDefined)(i.startPrice), o),
                  color: c.color.value(),
