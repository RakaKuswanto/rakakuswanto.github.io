(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4013],
  {
    ...
    805184: (e, t, n) => {
      ...
      function a(e) {
        const { intent: t, size: n, appearance: o, useFullWidth: r, icon: a, ...c } = e;
        return { ...c, color: l(t), size: i(n), variant: s(o), stretch: r, startIcon: a };
      }
      function c(e) {
        return o.createElement(r.SquareButton, { ...a(e) });
      }
    },
    171529: (e, t, n) => {
      'use strict';
      ...
      function c(e) {
        const {
          ...
          C = (function (e) {
            ...
            return (
              0 !== e &&
                (1 & e && (t = r(t, a()['no-corner-top-left'])),
                2 & e && (t = r(t, a()['no-corner-top-right'])),
                4 & e && (t = r(t, a()['no-corner-bottom-right'])),
                8 & e && (t = r(t, a()['no-corner-bottom-left']))),
              t
            );
          })((0, s.getGroupCellRemoveRoundBorders)(m));
        return r(
          h,
          a().button,
          a()[`size-${n}`],
          ...
          a()[`variant-${o}`],
          l && a().stretch,
          (i || c) && a()['with-start-icon'],
          u && a()['with-end-icon'],
          d && a()['icon-only'],
          C,
          p && a().grouped,
          p && !f && a()['adjust-position'],
          p && m.isTop && a()['first-row'],
          p && m.isLeft && a()['first-col'],
          b && g && a()['multiline-content'],
          v && a().link,
        );
      }
      function u(e) {
        ...
        return o.createElement(
          o.Fragment,
          null,
          d && o.createElement(l.Icon, { icon: d, className: a()['start-icon-wrap'] }),
          s && o.createElement('span', { className: a().content }, s),
          i && !r && o.createElement(l.Icon, { icon: i, className: a()['end-icon-wrap'] }),
          h &&
            (function (e) {
              return (
                e.primaryText &&
      ...
      function m(e) {
        const { reference: t, ...n } = e,
          ...
          i = c({ ...n, isGrouped: r, cellState: s, disablePositionAdjustment: l });
        return o.createElement(
          'button',
          { ...p(n), className: i, ref: t },
          o.createElement(u, { ...n }),
        );
      }
    },
    ...
    34735: (e, t, n) => {
      'use strict';
      n.d(t, { ControlSkeleton: () => v, InputClasses: () => f });
      var o = n(50959),
        r = n(497754),
        s = n(650151),
        l = n(525388),
      ...
      function p(e, t, n, o) {
        const {
          ...
          C = h(null != s ? s : (0, c.getGroupCellRemoveRoundBorders)(n));
        return r(
          d().container,
          d()[`container-${u}`],
          d()[`intent-${i}`],
      ...
      function m(e, t, n) {
        ...
        const l = h(null != s ? s : (0, c.getGroupCellRemoveRoundBorders)(t));
        return r(d().highlight, d().shown, d()[`size-${n}`], l);
      }
      const f = {
      ...
      function g(e, t) {
        const {
          ...
          _ = (function (e, t = null, n) {
            ...
            return (0, o.useEffect)(() => ((s.current = [e, t, n]), l(), i), [e, t, n]), a;
          })('wheel', N, b);
        return o.createElement(
          'span',
          {
          ...
          D,
          R,
          o.createElement('span', { className: m(e, P, S) }),
        );
      }
    ...
    102691: (e, t, n) => {
      ...
      function i(e) {
        ...
        return o.createElement('span', { className: r(l()['before-slot'], t) }, n);
      }
      function a(e) {
        const { className: t, interactive: n = !0, icon: s = !1, children: i } = e;
        return o.createElement(
          'span',
      ...
      function d(e) {
        const { className: t, children: n } = e;
        return o.createElement('span', { className: r(l()['after-slot'], t) }, n);
      }
    },
    654936: (e, t, n) => {
      'use strict';
      ...
      function g(e) {
        const {
          ...
          V = (0, s.filterProps)(U, b),
          G = {
            ...(0, s.filterAriaProps)(U),
      ...
      function v(e) {
        ...
        const {
          ...
          x = t ? void 0 : v ? -1 : r,
          y = t ? void 0 : v ? r : -1,
          { isMouseDown: D, handleMouseDown: R, handleMouseUp: w } = (0, d.useIsMouseDown)(),
          N = (0, l.createSafeMulticastEventHandler)(
            C.onFocus,
            function (e) {
              n && !D.current && (0, i.selectAllContent)(e.currentTarget);
            },
            s,
          ),
          S = (0, l.createSafeMulticastEventHandler)(C.onBlur, h),
          E = (0, o.useCallback)(
            e => {
              (f.current = e),
                p && ('function' == typeof p && p(e), 'object' == typeof p && (p.current = e));
            },
            [f, p],
          );
        return o.createElement(g, {
          ...
          onContainerFocus: function (e) {
            b.current === e.target && null !== f.current && f.current.focus();
          },
          onFocus: N,
          onBlur: S,
          reference: E,
          containerReference: (0, a.useMergedRefs)([b, m]),
          onMouseDown: R,
          onMouseUp: w,
        });
      }
    ...
    942544: (e, t, n) => {
      ...
      function r(e) {
        const { intent: t, highlight: n, ...r } = e,
          { isFocused: s, ...l } = (0, o.useDisclosure)(r);
        return {
          ...l,
          isFocused: s,
    ...
    21778: (e, t, n) => {
      ...
      var o = n(269842),
        r = n(383836);
      function s(e) {
        const { onFocus: t, onBlur: n, intent: s, highlight: l, disabled: i } = e,
          [a, c] = (0, r.useFocus)(void 0, i),
    ...
    772069: (e, t, n) => {
      ...
      function c(e) {
        const {
          ...
          [b, g] = (0, l.useFocus)(),
          v = b || m,
          C = (null != n ? n : void 0 !== t) ? (0, a.createDomId)(t, 'listbox') : void 0,
          x = (0, o.useRef)(null),
          y = (0, o.useCallback)(
            e => {
              var t;
          ...
          D = (0, o.useRef)(null),
          R = (0, o.useCallback)(() => (0, r.ensureNotNull)(D.current).focus(), [D]),
          w = (0, o.useCallback)(() => f(!0), [f]),
          N = (0, o.useCallback)(
            (e = !1, t = !1) => {
              f(!1);
              const { activeElement: n } = document;
              (n && (0, s.isTextEditingField)(n)) || t || y({ preventScroll: e });
            },
            [f, y],
          ),
          S = (0, o.useCallback)(() => {
          ...
          P = c ? [] : [h, g.onBlur],
          B = c ? [] : [p, S],
          _ = (0, i.createSafeMulticastEventHandler)(...E),
          k = (0, i.createSafeMulticastEventHandler)(...P),
          z = (0, i.createSafeMulticastEventHandler)(...B);
        return {
          listboxId: C,
          isOpened: m,
          isFocused: v,
          ...
          toggle: S,
          onOpen: R,
          buttonFocusBindings: { onFocus: _, onBlur: k },
          onButtonClick: z,
          buttonRef: x,
          listboxRef: D,
          buttonAria: { 'aria-controls': m ? C : void 0, 'aria-expanded': m, 'aria-disabled': c },
        };
      }
    },
    383836: (e, t, n) => {
    ...
    648621: (e, t, n) => {
      ...
      function l(e, t, n, l, i, a = {}, c) {
        const u = (0, o.useCallback)(
          ...
          { next: f = m.next, previous: b = m.previous, first: g = m.first, last: v = m.last } = a;
        return (0, r.useComposedKeyboardActionHandlers)(
          ...
          (0, r.useKeyboardActionHandler)(v, p),
        );
      }
    },
    930617: (e, t, n) => {
      ...
      function c(e, t, n, o, r, l) {
        ...
        return (function (e) {
          ...
          (c = null != c ? c : l.getBoundingClientRect()),
          ...
          return (
            (f = window.requestAnimationFrame(function e(t) {
              ...
              const l = p + d * o(s / n);
              (i[h] = Math.floor(l)), (f = window.requestAnimationFrame(e));
            })),
            function () {
      ...
      function d(e = {}) {
        ...
        return (0, o.useEffect)(() => p(t, s), [p, t]), [d, h, p];
      }
    },
    525388: (e, t, n) => {
      'use strict';
    ...
    414823: (e, t, n) => {
      ...
      function a(...e) {
        const t = e.map(s).filter(r).filter(l).map(i);
                ...
                o.createElement(
                  ...
                  m &&
                    o.createElement(
                      ...
                      null != p ? p : a.t(null, void 0, n(620036)),
                    ),
                  o.createElement(
                    'span',
                    ...
                    o.createElement(
                      ...
                      null != c ? c : a.t(null, void 0, n(468988)),
                    ),
                  ),
                ),
              ),
    ...
    533408: (e, t, n) => {
      ...
      function D(e) {
        const {
          ...
          [b, g] = (0, o.useState)(!1);
        return o.createElement(
          C.DialogHeaderContext.Provider,
          { value: { setHideClose: g } },
          o.createElement(
            'div',
            { className: i()(y.container, h, (r || p) && y.unsetAlign) },
            c,
            o.createElement(
              'div',
              { 'data-dragg-area': d, className: y.title },
              o.createElement('div', { className: i()(n ? y.textWrap : y.ellipsis) }, t),
              r && o.createElement('div', { className: i()(y.ellipsis, y.subtitle) }, r),
            ),
            u,
            s &&
              !b &&
      ...
      class P extends o.PureComponent {
          ...
          super(...arguments),
            ...
            (this._handleKeyDown = e => {
              if (!e.defaultPrevented) {
                if (
                  (this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, a.hashFromEvent)(e))
                ) {
                ...
                (function (e) {
                  ...
                  ((n = e),
                  [9, a.Modifiers.Shift + 9].includes((0, a.hashFromEvent)(n)) &&
                    n.stopPropagation());
              }
            }),
            (this._requestResize = () => {
        ...
        componentDidMount() {
          this.props.ignoreClosePopupsAndDialog ||
            ...
            void 0 !== this.props.onOpen &&
              ...
              (0, s.mediaQueryAddEventListener)(this._orientationMediaQuery, this._handleOpen)),
        ...
        componentWillUnmount() {
          this.props.ignoreClosePopupsAndDialog ||
            ...
            null !== this._orientationMediaQuery &&
              (0, s.mediaQueryRemoveEventListener)(this._orientationMediaQuery, this._handleOpen),
            this.props.fullScreenViewOffsets &&
              this.props.fullScreen &&
        ...
        render() {
          const {
            ...
            V = 'after' !== u ? b : void 0,
            G = 'after' === u ? b : void 0,
            Q = 'string' == typeof s ? s : I || '',
            $ = (0, w.filterDataProps)(this.props),
            q = (0, R.mergeRefs)([this._handleReference, Z]);
          return o.createElement(m.MatchMedia, { rule: p.DialogBreakpoints.SmallHeight }, u =>
            o.createElement(m.MatchMedia, { rule: p.DialogBreakpoints.TabletSmall }, p =>
              o.createElement(
                ...
                {
                  rounded: !(p || B) && k,
                  className: i()(N.dialog, B && U && N.bounded, e),
                  isOpened: r,
                  reference: q,
                  onKeyDown: this._handleKeyDown,
                  onClickOutside: c,
                  ...
                  containerAriaLabel: W,
                  containerTabIndex: K,
                  calculateDialogPosition: B && U ? this._calculatePositionWithOffsets : void 0,
                  shadowed: j,
                  ...$,
                },
                o.createElement(
                  'div',
                  { className: i()(N.wrapper, t), 'data-name': a, 'data-dialog-name': Q },
                  void 0 !== s &&
                    o.createElement(D, {
                      draggable: P && !(p || B),
                  ...
                  x && o.createElement(h.Separator, { className: N.separator }),
        ...
        const {
          ...
          T =
            ...
            o.createElement(
              a.EndSlot,
              null,
              o.createElement(u.Caret, { isDropped: v, disabled: g, className: k }),
            );
    ...
    904925: (e, t, n) => {
      ...
      function i(e, t, n) {
        return (0, o.useCallback)(
          () =>
            (function (e, t, { x: n = l.x, y: o = l.y } = l) {
              const r = (0, s.ensureNotNull)(e).getBoundingClientRect(),
                i = {
                  x: r.left + n,
                  y: r.top + r.height + o,
      ...
      function u(e) {
        const {
            ...
            onListboxKeyDown: C,
            listboxAria: x,
            repositionOnScroll: y = !0,
            closeOnHeaderOverlap: D = !1,
            popupPositionCorrection: R = { x: 0, y: 0 },
            popupPosition: w,
          } = e,
          N = i(s, d, R),
          S = D ? c : 0;
    ...
    364228: (e, t, n) => {
      ...
      function c(e) {
        const { isDropped: t } = e;
        return o.createElement(l.Icon, { className: s()(a.icon, t && a.dropped), icon: i });
      }
      function u(e) {
        const { className: t, disabled: n, isDropped: r } = e;
        return o.createElement(
          'span',
          { className: s()(a.button, n && a.disabled, t) },
          o.createElement(c, { isDropped: r }),
        );
      }
      function d(e) {
        const { className: t, tabIndex: n = -1, disabled: r, isDropped: l, ...i } = e;
        return o.createElement(
          'button',
          {
            ...i,
            ...
            tabIndex: n,
            disabled: r,
            className: s()(a.button, r && a.disabled, t),
          },
    ...
    529631: (e, t, n) => {
      ...
      const C = o.forwardRef((e, t) => {
        ...
        let { items: W } = e;
        if (N && S) {
          W = [{ value: void 0, content: N, id: (0, r.createDomId)(n, 'placeholder') }, ...W];
        }
        const {
            listboxId: Z,
            isOpened: K,
          ...
          ne = W.filter(b),
          oe = ne.find(e => e.value === E),
          [re, se, le] = (0, l.useKeepActiveItemIntoView)({ activeItem: oe }),
          ie = (0, r.joinDomIds)(P, n),
          ae = ie.length > 0 ? ie : void 0,
          ce = (0, o.useMemo)(
            () => ({ role: 'listbox', 'aria-labelledby': P, 'aria-activedescendant': g(n, oe) }),
            [P, oe],
          ),
          ue = (0, o.useCallback)(e => e.value === E, [E]),
          de = (0, o.useCallback)(e => z && z(e.value), [z]),
          he = (0, u.useItemsKeyboardNavigation)(m.isRtl, ne, ue, de, !1, {
            next: [40],
            previous: [38],
          }),
          pe = (0, d.useKeyboardToggle)(q, K || T),
          me = (0, d.useKeyboardClose)(K, $),
          fe = (0, d.useKeyboardOpen)(K, G),
          ...
          ve = (function (e) {
            ...
            void 0 !== o && z && (n.stopPropagation(), K || G(), z(o.value));
          });
        return o.createElement(
          h.ControlDisclosureView,
          {
            ...
            onListboxKeyDown: function (e) {
              ge(e), e.defaultPrevented || ve(e);
            },
            buttonChildren: o.createElement(v, { selectedItem: oe, placeholder: N }),
    ...
    494707: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        s = n(345719);
      function l(e) {
        return o.createElement('div', { className: r(s.separator, e.className) });
      }
    },
    889872: e => {
      e.exports = {
    ...
    494357: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        u = n(479289),
        d = n(889872);
      const h = u.INTERVALS.map(e => ({ value: e.name, content: e.label }));
      function p(e) {
        const { onAdd: t, onClose: p, onUnmount: m } = e,
          [f, b] = (0, o.useState)(u.INTERVALS[0].name),
          [g, v] = (0, o.useState)('1');
        return (
          (0, o.useEffect)(
            () => () => {
          ...
          o.createElement(s.AdaptiveConfirmDialog, {
            ...
            title: r.t(null, void 0, n(892746)),
            isOpened: !0,
            onSubmit: function () {
              t(g, f), p();
            },
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement(
                    'div',
                    { className: d.row },
                    o.createElement('div', { className: d.title }, r.t(null, void 0, n(158416))),
                    o.createElement(l.Select, {
                      id: 'metric-items',
                      className: d.control,
                      value: f,
                      items: h,
                  ...
                  o.createElement(
                    'div',
                    { className: d.row },
                    o.createElement('div', { className: d.title }, r.t(null, void 0, n(469466))),
            ...
            submitButtonText: r.t(null, void 0, n(954777)),
            submitOnEnterKey: !1,
            fullScreen: !0,
          })
        );
