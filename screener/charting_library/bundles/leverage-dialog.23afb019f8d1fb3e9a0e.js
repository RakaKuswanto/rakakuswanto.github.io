  ...
  [6112],
  {
    839391: e => {
      ...
      function t() {
        var e = {};
        return (
          (e.promise = new Promise(function (a, t) {
      ...
      e.exports = function (e) {
        ...
        return function () {
          var u = a(i),
            ...
            d = !r || c - r > u;
          r = c;
          for (var p = arguments.length, v = Array(p), f = 0; f < p; f++) v[f] = arguments[f];
          if (d && n.leading)
            return n.accumulate
        ...
        function m() {
          var a = l;
          clearTimeout(s),
            Promise.resolve(n.accumulate ? e.call(this, o) : e.apply(this, o[o.length - 1])).then(
              a.resolve,
              a.reject,
            ),
            (o = []),
    ...
    958006: (e, a, t) => {
      ...
      function x(e) {
        ...
        return n.createElement('span', { ...t, className: u(a, h().tag, h().disabled) });
      }
      var k = t(200730);
      const b = {
      ...
      function S(e) {
        const { side: a, orderType: r, customFields: l } = e,
          s = [
            {
              text: 1 === a ? i.t(null, void 0, t(618156)) : i.t(null, void 0, t(392553)),
        ...
        return (
          ...
          n.createElement(
            ...
            { className: k.tags },
            s.map(e =>
              n.createElement(x, { key: e.text, className: c()(k.tag, e.className) }, e.text),
            ),
          )
        );
      }
      ...
      function E(e) {
        ...
        const a = new (l())(e.min),
          ...
          s = (function (e, a, t) {
            return a.minus(e).div(t + 1);
          })(a, t, r),
          o = [n.toNumber()];
        for (let e = 1; e <= r; e++) {
          const r = M(n, s, e);
          let l = _(r, a, i);
          if (((void 0 === l || l.eq(o[e - 1])) && (l = w(r, a, i)), !l.eq(o[e - 1]))) {
            if (l.gte(t)) break;
            o.push(l.toNumber());
          }
        }
      ...
      function T(e) {
        ...
        (0, n.useEffect)(() => {
          ...
          void 0 !== G.errors && G.errors.length > 0
            ...
            : q
            ? (e = void 0)
            : a.eq(0) || (e = i.t(null, { replace: { step: String(y) } }, t(757077))),
              ...
              n.createElement(
                ...
                n.createElement(v.NumberInput, {
                  ...
                  boundariesErrorMessages: {
                    greaterThanMax: i.t(null, { replace: { max: String(b) } }, t(842652)),
                    lessThanMin: i.t(null, { replace: { min: String(k) } }, t(666992)),
                  },
                  errorHandler: ee,
                  onValueChange: J,
                  stretch: !0,
                ...
                I(G.infos) &&
                  n.createElement(
                    ...
                    null === (e = G.infos) || void 0 === e ? void 0 : e.join('. '),
                  ),
                I(G.warnings) &&
                  n.createElement(
                    'div',
                    { className: c()(C.previewMessage, C.warnings) },
                    null === (a = G.warnings) || void 0 === a ? void 0 : a.join('. '),
                  ),
              ),
            );
          },
        ...
        function Z(e) {
          return { side: _, symbol: g, leverage: e, customFields: D, orderType: w };
        }
        function J(e) {
          P(e);
        }
    ...
    842652: e => {
      e.exports = {
        ...
        de: ['Der angegebene Wert ist größer als das Maximum der Hebelwirkung von {max}'],
        ...
        fr: ["La valeur spécifiée est supérieure au maximum de l'effet de levier de {max}"],
        he_IL: ['הערך שצוין גדול ממקסימום המינוף של {max}'],
        hu_HU: 'Specified value is greater than the leverage maximum of {max}',
        id_ID: ['Nilai yang ditentukan lebih besar dari leverage maksimum {max}'],
        it: ['Il valore specificato è maggiore rispetto alla leva massima di {max}'],
        ja: ['指定した値がレバレッジの最大値 {max} を超えています'],
        ko: ['지저 밸류가 {max} 의 레버리지 맥시멈보다 큽니다'],
        ms_MY: ['Nilai tertentu adalah lebih besar daripada keumpilan maksimum {max}'],
        nl_NL: 'Specified value is greater than the leverage maximum of {max}',
        pl: ['Określona wartość jest większa niż maksymalna dźwignia wynosząca {max}'],
        pt: ['O valor especificado é maior que o máximo de alavancagem de {max}.'],
        ro: 'Specified value is greater than the leverage maximum of {max}',
        ru: ['Указанное значение больше, чем максимальное значение плеча {max}'],
        sv: ['Det angivna värdet är större än det maximala hävstångsvärdet för {max}.'],
    ...
    666992: e => {
      e.exports = {
        ...
        de: ['Der angegebene Wert ist kleiner als das Minimum der Hebelwirkung von {min}'],
        el: 'Specified value is less than the leverage minimum of {min}',
        en: 'Specified value is less than the leverage minimum of {min}',
        es: ['El valor especificado es inferior al apalancamiento mínimo establecido en {min}'],
        fa: 'Specified value is less than the leverage minimum of {min}',
        fr: ["La valeur spécifiée est inférieure au minimum de l'effet de levier de {min}"],
        he_IL: ['הערך שצוין קטן ממינימום המינוף של {min}'],
        hu_HU: 'Specified value is less than the leverage minimum of {min}',
        id_ID: ['Nilai yang ditentukan kurang dari minimum leverage dari {min}'],
        it: ['Il valore specificato è maggiore rispetto alla leva minima di {min}'],
        ja: ['指定した値がレバレッジの最小値 {min} を下回っています'],
        ko: ['지정된 값이 레버리지 최소값인 {min} 보다 작습니다.'],
        ms_MY: ['Nilai yang diperincikan adalah kurang daripada minimum keumpilan {min}'],
        ...
        pt: ['O valor especificado é menor do que o valor de alavancagem mínimo de {min}.'],
        ...
        sv: ['Det angivna värdet är lägre än det lägsta hävstångsvärdet för {min}'],
