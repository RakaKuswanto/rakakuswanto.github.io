(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3005, 959, 6437],
  {
    ...
    718736: (e, t, r) => {
      ...
      function i(e) {
        const t = (0, n.useMemo)(
          ...
          r = (0, n.useRef)(null),
          i = t => {
            if (null === t) return a(r.current, t), void (r.current = null);
            r.current !== e && ((r.current = e), a(r.current, t));
          },
          o = (0, n.useRef)(i);
        return (
          (o.current = i),
    ...
    855393: (e, t, r) => {
      'use strict';
      r.d(t, { useIsomorphicLayoutEffect: () => s });
      var n = r(50959);
      function s(e, t) {
    ...
    664332: (e, t, r) => {
      'use strict';
      r.d(t, { useResizeObserver: () => o });
      var n = r(50959),
        s = r(159255),
        i = r(855393),
        a = r(718736);
      function o(e, t = []) {
        const { callback: r, ref: o = null } = (function (e) {
    ...
    72571: (e, t, r) => {
      ...
      const s = n.forwardRef((e, t) => {
        const { icon: r = '', ...s } = e;
        return n.createElement('span', { ...s, ref: t, dangerouslySetInnerHTML: { __html: r } });
      });
    },
    111706: (e, t, r) => {
      'use strict';
    ...
    438980: (e, t, r) => {
      ...
      var n = r(664332);
      function s(e) {
        const { children: t, onResize: r } = e;
        return t((0, n.useResizeObserver)(r || (() => {}), [null === r]));
      }
    },
    921258: (e, t, r) => {
      'use strict';
      r.d(t, { hoverMouseEventFilter: () => i, useAccurateHover: () => a, useHover: () => s });
      var n = r(50959);
      function s() {
    ...
    695257: (e, t) => {
      ...
      (_.constructor = g), f(_, y.prototype), (_.isPureReactComponent = !0);
      var b = Array.isArray,
      ...
      function M(e, t, n) {
        var s,
          ...
          o = null;
        if (null != t)
          for (s in (void 0 !== t.ref && (o = t.ref), void 0 !== t.key && (a = '' + t.key), t))
            E.call(t, s) && !w.hasOwnProperty(s) && (i[s] = t[s]);
        ...
        if (e && e.defaultProps) for (s in (l = e.defaultProps)) void 0 === i[s] && (i[s] = l[s]);
        return { $$typeof: r, type: e, key: a, ref: o, props: i, _owner: C.current };
      }
      function I(e) {
      ...
      var F = { current: null },
        T = { transition: null },
        W = { ReactCurrentDispatcher: F, ReactCurrentBatchConfig: T, ReactCurrentOwner: C };
      (t.Children = {
        map: L,
        ...
        (t.cloneElement = function (e, t, n) {
          ...
          if (null != t) {
            if (
              (void 0 !== t.ref && ((a = t.ref), (o = C.current)),
          ...
          return { $$typeof: r, type: e.type, key: i, ref: a, props: s, _owner: o };
        }),
        ...
        (t.isValidElement = I),
        (t.lazy = function (e) {
          return { $$typeof: h, _payload: { _status: -1, _result: e }, _init: O };
        }),
        (t.memo = function (e, t) {
    ...
    27164: (e, t, r) => {
      ...
      r.d(t, { becomeMainElement: () => n, becomeSecondaryElement: () => s });
    },
    869194: (e, t, r) => {
      'use strict';
      r.d(t, { useMouseClickAutoBlur: () => a });
      var n = r(50959),
        s = r(111706),
        i = r(892932);
      function a(e) {
    ...
    479289: (e, t, r) => {
      ...
      var n = r(509806);
      const s = [
        { name: '', label: n.t(null, { context: 'interval' }, r(537830)) },
        { name: 'H', label: n.t(null, { context: 'interval' }, r(705285)) },
        { name: 'D', label: n.t(null, { context: 'interval' }, r(306174)) },
        { name: 'W', label: n.t(null, { context: 'interval' }, r(725042)) },
        { name: 'M', label: n.t(null, { context: 'interval' }, r(179410)) },
      ];
    },
    622614: (e, t, r) => {
      'use strict';
      ...
      const d = (0, n.forwardRef)(function (e, t) {
        const { onKeyDown: r, orientation: d, ...h } = e,
          p = o.PLATFORM_ACCESSIBILITY_ENABLED ? { role: 'toolbar', 'aria-orientation': d } : {},
          m = (0, c.useFunctionalRefObject)(t);
        return (
          (0, n.useLayoutEffect)(() => {
            if (!o.PLATFORM_ACCESSIBILITY_ENABLED) return;
            const e = (0, s.ensureNotNull)(m.current),
              t = () => {
          ...
          n.createElement('div', {
            ...
            onKeyDown: (0, i.createSafeMulticastEventHandler)(function (e) {
              ...
              const r = e.currentTarget,
                n = (0, o.queryFocusableElements)(r).sort(o.navigationOrderComparator);
              ...
              const i = () => {
                  ...
                  (0, l.becomeSecondaryElement)(n[s]), (0, l.becomeMainElement)(n[e]), n[e].focus();
                },
                c = () => {
                  const e = (s + n.length + 1) % n.length;
                  (0, l.becomeSecondaryElement)(n[s]), (0, l.becomeMainElement)(n[e]), n[e].focus();
    ...
    325154: (e, t, r) => {
      'use strict';
      r.r(t), r.d(t, { HeaderToolbarRenderer: () => Le });
      var n = r(50959),
        s = r(500962),
        i = r(650151),
        a = r(497754),
        ...
        v = r(63869);
      function y(e) {
        return n.createElement('div', { className: o()(v.separator, e.className) });
      }
      var S = r(721043);
      function g(e) {
        const {
        ...
        return n.createElement(
          ...
          !c &&
            n.createElement(
              ...
              n.createElement(y, { className: S.separator }),
            ),
          n.createElement(
            'div',
            {
              className: a(r, S.group, {
                [S.noMinimalWidth]: o,
                [S.noLeftDecoration]: s,
      ...
      var _ = r(438980),
        ...
        w = r(245820);
      const M = {
        text: b.t(null, void 0, r(255646)),
      };
      function I(e) {
        return n.createElement(
          'div',
          { className: C.wrap },
          n.createElement(E.Icon, { className: C.icon, icon: w }),
          M.text,
        );
      }
      var k = r(350136),
        ...
        L = r(661380),
        O = r(164553);
      const F = { isVisibleScrollbar: !0, shouldMeasure: !0, hideButtonsFrom: 1 };
      function T(e) {
        return n.createElement('div', {
          className: a(O.fadeLeft, e.className, { [O.isVisible]: e.isVisible }),
        });
      }
      function W(e) {
        return n.createElement('div', {
          className: a(O.fadeRight, e.className, { [O.isVisible]: e.isVisible }),
        });
      }
      function A(e) {
        return n.createElement(B, { ...e, className: O.scrollLeft });
      }
      function N(e) {
        return n.createElement(B, { ...e, className: O.scrollRight });
      }
      function B(e) {
        return n.createElement(
          'div',
          { className: a(e.className, { [O.isVisible]: e.isVisible }), onClick: e.onClick },
          n.createElement(
            'div',
            { className: O.iconWrap },
            n.createElement(E.Icon, { icon: L, className: O.icon }),
          ),
        );
      }
      const D = (function (e = A, t = N, r = T, s = W) {
        var o;
        return (
          ((o = class extends n.PureComponent {
            constructor(e) {
              super(e),
                ...
                (this._handleScrollRight = () => {
                  ...
                  this.animateTo(
                    Math.min(
                      (this.state.widthContent || 0) - (this.state.widthWrap || 0),
                ...
                (this._handleResizeContent = ([e]) => {
                  ...
                  const { shouldDecreaseWidthContent: r, buttonsWidthIfDecreasedWidthContent: n } =
                    this.props;
                  r && n
            ...
            isAtLeft() {
              return (
                !this._isOverflowed() ||
                this.currentPosition() <= (0, i.ensureDefined)(this.props.hideButtonsFrom)
              );
            }
            isAtRight() {
              return (
            ...
            animateTo(e, t = R.dur) {
              ...
              r &&
                ((0, V.isRtl)() && (e = (0, V.getLTRScrollLeftOffset)(r, e)),
                t <= 0
            ...
            render() {
              const {
                ...
                { isVisibleRightButton: y, isVisibleLeftButton: S } = this.state,
                g = d && h;
              return n.createElement(
                _.Measure,
                ...
                d =>
                  n.createElement(
                    'div',
                    { className: O.wrapOverflow, onMouseOver: p, onMouseOut: m, ref: d },
                    n.createElement(
                      'div',
                      { className: a(O.wrap, g ? O.wrapWithArrowsOuting : '') },
                      n.createElement(
                        'div',
                        {
                          className: a(O.scrollWrap, f, { [O.noScrollBar]: !o }),
                      ...
                      l && n.createElement(r, { isVisible: S, className: v }),
                      l && n.createElement(s, { isVisible: y, className: v }),
                      c && n.createElement(e, { onClick: this._handleScrollLeft, isVisible: S }),
                      c && n.createElement(t, { onClick: this._handleScrollRight, isVisible: y }),
                    ),
                  ),
              );
            }
      ...
      class X extends n.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleMouseOver = e => {
              (0, z.hoverMouseEventFilter)(e) && this.setState({ isHovered: !0 });
            }),
            (this._handleMouseOut = e => {
              (0, z.hoverMouseEventFilter)(e) && this.setState({ isHovered: !1 });
            }),
            (this._handleInnerResize = ([e]) => {
              const t = e.contentRect.width,
                { onWidthChange: r } = this.props;
              r && r(t);
            }),
            ...
            (this._processCustoms = e => {
              const { isFake: t, displayMode: r } = this.props,
              ...
              return e.map(e =>
                n.createElement(
                  ...
                  (e => {
                    switch (e.type) {
                      case 'Button':
                        return n.createElement(s.Custom, {
                          ...e.params,
                          isFake: t,
                        });
                      case 'TradingViewStyledButton':
                        return n.createElement(s.CustomTradingViewStyledButton, {
                          ...e.params,
                          className: G.button,
                          displayMode: r,
                        });
                      case 'Dropdown':
                        return n.createElement(s.Dropdown, { displayMode: r, params: e.params });
                      default:
                        return null;
                    }
                  })(e),
            ...
            (0, H.validateRegistry)(t, { tools: p.any.isRequired }),
        ...
        render() {
          const { tools: e } = this.context,
            ...
            y = this._processCustoms(u),
            S = d.includes(r);
          return n.createElement(
            q.Toolbar,
            {
              className: a(G.inner, { [G.fake]: h }),
              onContextMenu: x.preventDefaultForContextMenu,
              'data-is-fake-main-panel': h,
              'aria-hidden': j.PLATFORM_ACCESSIBILITY_ENABLED ? h : void 0,
            },
            n.createElement(
              D,
              {
                isVisibleFade: m.mobiletouch && S,
                isVisibleButtons: !m.mobiletouch && S && p,
              ...
              c =>
                n.createElement(
                  'div',
                  {
                    className: G.content,
                    ref: c,
                    role: j.PLATFORM_ACCESSIBILITY_ENABLED ? 'none' : void 0,
                  },
                  n.createElement(_.Measure, { onResize: h ? this._handleInnerResize : null }, c =>
                    n.createElement(
                      'div',
                      { className: G.innerWrap, ref: c },
                      n.createElement(
                        f.FragmentMap,
                        ...
                        (function (e) {
                                  ...
                                  if (n.isValidElement(e)) {
                                    switch ([t - 1, t, t + 1].indexOf(r)) {
                                      case 0:
                                        ...
                                        break;
                                      case 1:
                                        const r = { noLeftDecoration: !0, noRightDecoration: !0 };
                          ...
                          n.Children.toArray([
                            o &&
                              n.createElement(
                                g,
                                { key: 'view-only-badge', removeSeparator: !0 },
                            ...
                            !o &&
                              ...
                              n.createElement(
                                g,
                                { key: 'undo-redo' },
                                n.createElement(e.UndoRedo, { id: h ? void 0 : P.UndoRedo }),
                              ),
                            n.createElement(g, {
                              removeSeparator: !0,
                              key: 'gap-1',
                              className: a(G.fill, h && G.collapse),
                            }),
                            (e.Layout || e.SaveLoad) &&
                              n.createElement(
                                g,
                                ...
                                !o &&
                                  e.Layout &&
                                  n.createElement(e.Layout, { id: h ? void 0 : P.Layouts }),
                                e.SaveLoad &&
                            ...
                            !o &&
                              (e.Properties || e.Fullscreen || (!$ && e.Screenshot)) &&
                              n.createElement(
                                g,
                            ...
                            $ &&
                              ...
                              n.createElement(
                                ...
                                n.createElement(e.Fullscreen, { id: h ? void 0 : P.Fullscreen }),
                              ),
                            $ &&
                              e.Screenshot &&
                              n.createElement(
                            ...
                            !o &&
                              ...
                              n.createElement(
                                g,
                                { key: 'publish', className: G.mobilePublish, removeSeparator: !0 },
                                n.createElement(e.Publish, { id: h ? void 0 : P.PublishMobile }),
                              ),
                            ...y,
                          ]),
                        ),
            ...
            e.Publish &&
              !o &&
              !h &&
              n.createElement(e.Publish, { id: P.PublishDesktop, className: G.desktopPublish }),
          );
        }
      ...
      var Y = r(650802),
        Q = r(584776);
      class K extends Q.CommonJsonStoreService {
        constructor(e, t, r = []) {
      ...
      class ee extends Q.AbstractJsonStoreService {
        ...
        _serialize(e) {
          return (0, Z.uniq)(e.map(J.normalizeIntervalString));
        }
        _deserialize(e) {
          return (0, Z.uniq)(
            (0, J.convertResolutionsFromSettings)(e)
              .filter(J.isResolutionMultiplierValid)
              .map(J.normalizeIntervalString),
          );
        }
      }
      var te = r(688401),
      ...
      const ae = new ie(se.TVXWindowEvents, ne);
      var oe = r(479289);
      class le {
        constructor(e) {
          (this._customIntervalsService = ae),
            (this._supportedIntervalsMayChange = new re.Delegate()),
            (this._fireSupportedIntervalsMayChange = () => {
              this._supportedIntervalsMayChange.fire();
            }),
            (this._chartApiInstance = e),
            te.linking.supportedResolutions.subscribe(this._fireSupportedIntervalsMayChange),
            ...
            te.linking.intraday.subscribe(this._fireSupportedIntervalsMayChange),
            te.linking.dataFrequencyResolution.subscribe(this._fireSupportedIntervalsMayChange);
        }
        destroy() {
          te.linking.supportedResolutions.unsubscribe(this._fireSupportedIntervalsMayChange),
            te.linking.range.unsubscribe(this._fireSupportedIntervalsMayChange),
            te.linking.seconds.unsubscribe(this._fireSupportedIntervalsMayChange),
            te.linking.ticks.unsubscribe(this._fireSupportedIntervalsMayChange),
            te.linking.intraday.unsubscribe(this._fireSupportedIntervalsMayChange),
            te.linking.dataFrequencyResolution.unsubscribe(this._fireSupportedIntervalsMayChange);
        }
        getDefaultIntervals() {
          return null === this._chartApiInstance
            ? []
            : this._chartApiInstance.defaultResolutions().map(J.normalizeIntervalString);
        }
        getCustomIntervals() {
        ...
        add(e, t, r) {
          ...
          const n = (0, J.normalizeIntervalString)(`${e}${t}`),
            s = this.getCustomIntervals();
          return this._isIntervalDefault(n) || s.includes(n)
            ? null
            : (this._customIntervalsService.set((0, J.sortResolutions)([...s, n])), n);
        }
        remove(e) {
          this._customIntervalsService.set(this.getCustomIntervals().filter(t => t !== e));
        }
        isValidInterval(e, t) {
          return (0, J.isResolutionMultiplierValid)(`${e}${t}`);
        }
        isSupportedInterval(e) {
          return (0, J.isAvailable)(e);
        }
        ...
        getResolutionUtils() {
          return {
            getMaxResolutionValue: J.getMaxResolutionValue,
            getTranslatedResolutionModel: J.getTranslatedResolutionModel,
            mergeResolutions: J.mergeResolutions,
            sortResolutions: J.sortResolutions,
          };
        }
      ...
      class me {
        constructor(e = ne) {
          (this._favorites = []),
            (this._favoritesChanged = new re.Delegate()),
            (this._settings = e),
            se.TVXWindowEvents.on('StudyFavoritesChanged', e => {
        ...
        addFavorite(e) {
          const t = this.favId(e);
          this._favorites.push(ve(t)), this._favoritesChanged.fire(), this._saveFavs();
        }
        removeFavorite(e) {
          const t = this.favId(e),
            r = this._findFavIndex(t);
          -1 !== r && (this._favorites.splice(r, 1), this._favoritesChanged.fire()),
            this._saveFavs();
        }
        favId(e) {
        ...
        _saveFavs() {
          ...
          this._settings.setJSON('studyMarket.favorites', e, { forceFlush: !0 }),
            se.TVXWindowEvents.emit('StudyFavoritesChanged', JSON.stringify({ favorites: e }));
        }
        _stateToSave() {
      ...
      var ye = r(628589);
      const Se = {
        [ye.ResolutionKind.Ticks]: !1,
        [ye.ResolutionKind.Seconds]: !1,
        [ye.ResolutionKind.Minutes]: !1,
        [ye.SpecialResolutionKind.Hours]: !1,
        [ye.ResolutionKind.Days]: !1,
        [ye.ResolutionKind.Range]: !1,
      };
      class ge extends Q.CommonJsonStoreService {
      ...
      const be = {
        ...
        Ee = ['1', '30', '60'];
      function Ce(e = []) {
        let t = e.map(e => be[e]) || [1, 4, 5, 6];
        return d.enabled('widget') && (t = [0, 1, 3]), t;
      }
      function we(e = []) {
        return (0, J.mergeResolutions)(e, d.enabled('star_some_intervals_by_default') ? Ee : []);
      }
      new ee(se.TVXWindowEvents, ne, we()),
        new K(se.TVXWindowEvents, ne, Ce()),
        new _e.FavoriteStudyTemplateService(se.TVXWindowEvents, ne);
      const Me = {
      ...
      class Ve extends n.PureComponent {
        constructor(e) {
          ...
          (this._showScrollbarWhen = (0, i.ensureDefined)(e.allowedModes).slice(-1)),
          ...
          const b = Ce(this.props.defaultFavoriteStyles);
          this._favoriteChartStylesService = h || new K(se.TVXWindowEvents, ne, b);
          const E = we(this.props.defaultFavoriteIntervals);
          (this._favoriteIntervalsService = l || new ee(se.TVXWindowEvents, ne, E)),
            (this._intervalsMenuViewStateService = new ge(se.TVXWindowEvents, ne)),
            (this._intervalService = new le(s)),
            (this._registry = {
              tools: t,
              isFundamental: o,
              chartWidgetCollection: n,
              ...
              favoriteScriptsModel: me.getInstance(),
            ...
            (this._features = {
              ...
              allowSymbolSearchSpread:
                d.enabled('header_symbol_search') && d.enabled('show_spread_operators'),
        ...
        componentDidUpdate(e, t) {
          const { isVisible: r, measureValid: n } = this.state;
          r !== t.isVisible && (h.emit('toggle_header', r), this._negotiateResizer()),
            n || this._setDisplayMode();
        }
        render() {
          const { resizerBridge: e, allowedModes: t, ...r } = this.props,
            {
              displayMode: s,
              isVisible: o,
            ...
            p = this.props.tools.PublishButtonManager || n.Fragment;
          return n.createElement(
            H.RegistryProvider,
            ...
            n.createElement(
              ...
              n.createElement(
                'div',
                { className: a(ke.toolbar, { [ke.isHidden]: !o }), onClick: this.props.onClick },
                n.createElement(
                  'div',
        ...
        addDropdown(e, t) {
          const { leftCustomElements: r, rightCustomElements: n } = this.state,
            s = { type: 'Dropdown', id: e, params: t };
          'left' === t.align
            ? this.setState({ leftCustomElements: [...r, s] })
            : this.setState({ rightCustomElements: [...n, s] });
        }
        updateDropdown(e, t) {
        ...
        removeDropdown(e) {
          ...
          this.setState({ leftCustomElements: r, rightCustomElements: n });
        }
        _negotiateResizer() {
        ...
        _setDisplayMode() {
          const { availableWidth: e } = this.state,
            ...
            r = { full: this._fullWidth, medium: this._favoritesWidth, small: this._collapseWidth },
            n = (0, i.ensureDefined)(t);
          let s = n.map(e => r[e]).findIndex(t => e >= t);
          -1 === s && (s = n.length - 1);
          const a = n[s];
          this.setState({ measureValid: !0, displayMode: a });
        }
        _addCustomHTMLButton(e, t = 'left') {
          const r = new Y.WatchedValue(0),
            n = (0, Ie.parseHtmlElement)(`<div class="apply-common-tooltip ${ke.customButton}">`),
            s = {
              type: 'Button',
              id: e,
              params: { key: Number(new Date()), element: n, width: r },
            };
          return this._addCustomElementToState(t, s), n;
        }
        _addCustomTradingViewStyledButton(e, t) {
          const r = {
            type: 'TradingViewStyledButton',
            id: e,
            params: { key: Number(new Date()), text: t.text, title: t.title, onClick: t.onClick },
          };
        ...
        _addCustomElementToState(e, t) {
          const { leftCustomElements: r, rightCustomElements: n } = this.state;
          'left' === e
            ? this.setState({ leftCustomElements: [...r, t] })
    ...
    261401: (e, t, r) => {
      ...
      function l(e) {
        const { validation: t, value: r } = e;
        return o(r, t), n.createElement(a.Provider, { value: r }, e.children);
      }
      function c() {
        return a;
      }
