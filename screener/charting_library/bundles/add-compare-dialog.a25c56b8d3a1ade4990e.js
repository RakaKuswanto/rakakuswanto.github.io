(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [731],
  {
                ...
                (n = [].concat(t(n), [m])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !d(o.target) &&
                        ((a && 0 === a.scrollTop && 0 < n) ||
                        ((r = a) && r.scrollHeight - r.scrollTop <= r.clientHeight && n < 0)
                          ? u(o)
                          : o.stopPropagation()));
                  }),
                  l ||
                    (document.addEventListener('touchmove', u, o ? { passive: !1 } : void 0),
                    (l = !0));
              }
            } else {
              (p = a),
            ...
            (e.clearAllBodyScrollLocks = function () {
              r
                ? (n.forEach(function (e) {
                  ...
                  l &&
                    (document.removeEventListener('touchmove', u, o ? { passive: !1 } : void 0),
                    (l = !1)),
                  (n = []),
                  (i = -1))
                : (m(), (n = []));
    ...
    785286: e => {
      e.exports = { wrap: 'wrap-oc7l8ZQg', header: 'header-oc7l8ZQg', item: 'item-oc7l8ZQg' };
    },
    344467: e => {
    ...
    223392: (e, t, o) => {
      ...
      var a = o(50959),
        ...
        i = o(959189),
        s = o(380327);
      const c = a.createContext({ isInButtonGroup: !1, isGroupPrimary: !1 });
      var d = o(602948),
        u = o(758222),
        m = o.n(u);
      const h = (e, t) => {
        const o = (0, a.useContext)(l.CustomBehaviourContext),
          n = (0, a.useContext)(s.ControlGroupContext),
          { isInButtonGroup: d, isGroupPrimary: u } = (0, a.useContext)(c),
          {
            className: h,
            isSelected: p,
            children: b,
            ...
            variant: _ = 'primary',
            size: x = 'medium',
            enableActiveStateStyles: w = o.enableActiveStateStyles,
            typography: I,
            isLink: C = !1,
            textWrap: N,
            isPills: E,
        ...
        return r(
          ...
          C && m().link,
          p && m().selected,
          (0, i.isIconOnly)(b, S) && m()['no-content'],
          v && m()['with-start-icon'],
          (y || f) && m()['with-end-icon'],
          t && m()['with-grouped'],
          g && m()[`force-direction-${g}`],
          m()[`variant-${u ? 'primary' : _}`],
          m()[`color-${u ? 'gray' : k}`],
          m()[`size-${x}`],
          D,
          !w && m()['disable-active-state-styles'],
          n.isGrouped && m().grouped,
          N && m().wrap,
          d && m()['disable-active-on-touch'],
          E && m().pills,
        );
      };
      function p(e) {
        ...
        return a.createElement(
          a.Fragment,
          null,
          t && a.createElement(n.Icon, { className: m().icon, icon: t }),
          !(0, i.isIconOnly)(h, s) &&
            a.createElement(
              'span',
              { className: r(m().content, !u && m().nowrap) },
              u || c
                ? a.createElement(
                    a.Fragment,
                    null,
                    a.createElement(
                      ...
                      {
                        className: r(
                          !u && c && m()['ellipsis-container'],
                          u && m()['text-wrap-container'],
                          u && c && m()['text-wrap-with-ellipsis'],
                        ),
                      },
                      h,
                    ),
      ...
      function b(e) {
        const { isGrouped: t } = a.useContext(s.ControlGroupContext),
          {
            reference: o,
            className: r,
            isSelected: n,
          ...
          C = k ? (null != _ ? _ : 2) : 1,
          N = C > 0 ? { ...x, '--ui-lib-light-button-content-max-lines': C } : x;
        return a.createElement(
          'button',
          {
            ...I,
          ...
          a.createElement(
            p,
            { showCaret: u, startIcon: i, endIcon: b, iconOnly: c, ellipsis: d, textWrap: k },
            l,
          ),
        );
      }
      ...
      function d(e) {
        ...
        return a.createElement(
          ...
          a.createElement(
            'span',
            { className: t },
            a.createElement(l.Icon, { icon: i, className: c().icon }),
          ),
        );
      }
    },
    ...
    591365: (e, t, o) => {
      'use strict';
      o.d(t, { CustomComponentDefaultLink: () => n });
      var a = o(50959),
        r = o(409245);
      function n(e) {
        return a.createElement('a', { ...(0, r.renameRef)(e) });
      }
      a.PureComponent;
    },
    234539: (e, t, o) => {
      'use strict';
      o.d(t, { CustomBehaviourContext: () => a });
      const a = (0, o(50959).createContext)({ enableActiveStateStyles: !0 });
    ...
    881748: (e, t, o) => {
      ...
      function E(e) {
        ...
        return a.createElement(
          ...
          {
            type: 'button',
            className: c()(s, t.button, n && t.selected, l && !n && !i && t.bordersVisible),
            name: u,
            value: d,
            onClick: r,
          },
      ...
      var z = o(6519),
        M = o(785286);
      const L = {
        samePctScale: r.t(null, void 0, o(882642)),
        newPriceScale: r.t(null, void 0, o(534420)),
        newPane: r.t(null, void 0, o(167242)),
        sameScale: r.t(null, void 0, o(17547)),
      };
      function T(e) {
        const { fullSymbolName: t, isSelected: n, className: l, isYield: s } = e,
          {
            isMobile: d,
            searchRef: u,
            setMode: m,
          } = (0, _.useEnsuredContext)(f.SymbolSearchItemsDialogContext),
          {
            compareModel: h,
            selectedCompareOption: p,
            setHoveredItemId: b,
            clearInput: v,
            allowExtendTimeScale: y,
          } = (0, _.useEnsuredContext)(S),
          { callback: g } = (0, _.useEnsuredContext)(x),
          k = h.comparableOnSameScale({ isYield: s }),
          N = k ? z.CompareOption.SameScale : z.CompareOption.SamePctScale,
          E = k ? L.sameScale : L.samePctScale;
        return d
          ? a.createElement(
              C.DrawerManager,
              null,
              a.createElement(
                ...
                a.createElement('div', { className: M.header }, r.t(null, void 0, o(279589))),
                a.createElement(w.PopupMenuItem, {
                  className: M.item,
                  onClick: O,
                  onClickArg: N,
                  label: E,
          ...
          : a.createElement(
              'div',
              { className: c()(M.wrap, l), 'data-name': 'compare-buttons-group' },
              a.createElement(
                D,
                { onClick: O, value: N, isItemSelected: Boolean(n), isSelected: n && p === N },
                E,
              ),
              a.createElement(
                D,
                {
                  ...
                  isSelected: n && p === z.CompareOption.NewPriceScale,
                },
                L.newPriceScale,
              ),
              a.createElement(
                D,
                {
                  ...
                  isItemSelected: Boolean(n),
                  isSelected: n && p === z.CompareOption.NewPane,
                },
                L.newPane,
              ),
            );
        ...
        function O(e, o) {
          if ((o.preventDefault(), h && t && void 0 !== e)) {
            (0, i.getSymbolSearchCompleteOverrideFunction)()(t).then(t => {
              h.applyStudy(t.symbol, e, y), b(''), T(!0);
            });
          }
        }
      }
      function O(e) {
        const {
          ...
          [E, D] = (0, a.useState)(!1),
          M = (0, a.useRef)(null),
          L = (0, k.useAccurateHover)(M),
          O = (0, a.useMemo)(() => ({ callback: j }), [j]),
          A = !Boolean(r) && !Boolean(l),
          B = s === w;
        return a.createElement(
          x.Provider,
          { value: O },
          a.createElement(g.SymbolSearchDialogContentItem, {
            ...
            reference: M,
            onClick: function (t) {
              if (Boolean(r) && s && !c) return null == t || t.preventDefault(), void m(s);
              if (!E && u) return void D(!0);
              if (h && e.onClick) return void e.onClick(t);
              if ((n.mobiletouch ? B : !E) && o) {
                (0, i.getSymbolSearchCompleteOverrideFunction)()(o).then(e => {
                  const t = y.comparableOnSameScale({ isYield: d })
                    ? z.CompareOption.SameScale
                    : z.CompareOption.SamePctScale;
                  y.applyStudy(e.symbol, t, N);
                }),
                  I(''),
                  C && C(p, b);
              }
              n.mobiletouch && !u && !B && s && I(s);
            },
      ...
      function Y(e) {
        const { handleListWidth: t } = (0, d.ensureNotNull)(
            (0, a.useContext)(f.SymbolSearchItemsDialogContext),
          ),
          {
            compareModel: n,
          ...
          s = (0, h.useWatchedValueReadonly)({ watchedValue: n.isDataReady() }),
          k = (0, h.useWatchedValueReadonly)({ watchedValue: n.studies() }),
          _ = (0, h.useWatchedValueReadonly)({ watchedValue: n.highlightedSymbol() }),
          x = (0, a.useMemo)(() => k.filter(e => e.checked), [k]),
          w = (0, a.useMemo)(() => k.filter(e => !e.checked), [k]);
        return (
          (0, a.useEffect)(
            () => (
              ...
              a.createElement(
                ...
                (function () {
                  ...
                  if (!Boolean(x.length) && !Boolean(w.length)) {
                    const e = v.watchedTheme.value() === b.StdTheme.Dark ? B : A;
                    return a.createElement(
                      'div',
                      { className: P.emptyState },
                      a.createElement(u.Icon, { className: P.image, icon: e }),
                      a.createElement('div', { className: P.text }, r.t(null, void 0, o(542078))),
                    );
                  }
                  return a.createElement(
                    a.Fragment,
      ...
      class R extends a.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._toggleAllowExtendTimeScale = () => {
              ...
              H.setValue('showAddSymbolDialog.extendCheckboxState', e),
        ...
        render() {
          ...
          return a.createElement(S.Provider, { value: this._getContextValue() }, e);
        }
      }
      var W = o(180185),
        F = o(533408),
        U = o(610341);
      const Q = Object.keys(z.CompareOption).length / 2;
      function K(e) {
        const {
            openedItems: t,
            searchRef: o,
          ...
          z = (0, h.useWatchedValueReadonly)({ watchedValue: y.studies() }),
          M = r[n],
          L = 'compare' === c,
          T = 'exchange' === c;
        return (
          ...
          a.createElement(F.AdaptivePopupDialog, {
            ...e,
            className: s(U.dialog, !m && p && U.tablet),
            onKeyDown: function (e) {
              var a;
              const s = (0, W.hashFromEvent)(e),
                c = L ? I : n,
                u = L ? z : r;
              switch (s) {
                case 38:
                  if ((e.preventDefault(), 0 === c)) return;
                  if (-1 === c) return void O(0);
                  O(c - 1);
                  break;
                case 40:
                ...
                case 13: {
                  ...
                  e.preventDefault();
                  const r =
                    null === (a = null == o ? void 0 : o.current) || void 0 === a
                      ? void 0
                      : a.value.trim();
                  r &&
                    E &&
      ...
      var V = o(500962),
        q = o(21922),
        G = o(19406);
      class Z extends G.DialogRenderer {
        constructor(e) {
          super(), (this._props = e);
        }
        show(e) {
          if (this.visible().value()) return;
          const t = a.createElement(q.SymbolSearchItemsDialog, {
            ...this._props,
      ...
      var J = o(721167),
        ...
        $ = o(159223);
      function ee(e) {
        const { searchRef: t, setMode: o } = (0, _.useEnsuredContext)(
            f.SymbolSearchItemsDialogContext,
          ),
          { currentMode: r } = (0, _.useEnsuredContext)($.SymbolSearchDialogBodyContext);
        return (
          (0, a.useEffect)(() => {
            const e = t.current;
            if (e)
          ...
          a.createElement(X.DialogSearch, { ...e })
        );
        function n() {
          var e, a, n, l;
          t.current &&
      ...
      var te = o(408323),
        ...
        ae = o(344467);
      function re(e) {
        const { allowExtendTimeScale: t, toggleAllowExtendTimeScale: n } = (0, d.ensureNotNull)(
          (0, a.useContext)(S),
        );
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(te.CheckboxInput, { checked: t, value: t ? 'on' : 'off', onChange: n }),
            a.createElement('span', { className: ae.label }, r.t(null, void 0, o(471046))),
          ),
        );
      }
      ...
      function le(e) {
        return new Z({
          wrapper: ((t = e), e => a.createElement(R, { ...e, compareModel: t })),
          dialog: K,
          contentItem: O,
          initialScreen: Y,
          searchInput: ee,
          ...
          onSearchComplete: t => {
            ...
            if (void 0 !== o) {
              (0, i.getSymbolSearchCompleteOverrideFunction)()(t[0].symbol, t[0].result).then(t => {
                e.applyStudy(t.symbol, o, a);
              });
            }
          },
          symbolTypes: (0, J.getAvailableSymbolTypes)(),
          showSpreadActions:
    ...
    759339: (e, t, o) => {
      ...
      var a = o(50959),
        ...
        u = o(966076);
      function m(e) {
        const { position: t = 'Bottom', onClose: o, children: d, className: m, theme: p = u } = e,
          b = (0, r.ensureNotNull)((0, a.useContext)(s.DrawerContext)),
          [v] = (0, a.useState)(() => (0, l.randomHash)()),
          y = (0, a.useRef)(null),
          f = (0, a.useContext)(c.CloseDelegateContext);
        return (
          (0, a.useLayoutEffect)(
            () => (
              ...
              b.addDrawer(v),
              () => {
                b.removeDrawer(v), f.unsubscribe(b, o);
              }
            ),
            [],
          ),
    ...
    921258: (e, t, o) => {
      'use strict';
      o.d(t, { hoverMouseEventFilter: () => n, useAccurateHover: () => l, useHover: () => r });
      var a = o(50959);
      function r() {
      ...
      function m(e) {
        ...
        return a.createElement(
          V,
          {
            ...
            'aria-selected': m,
            'aria-checked': h,
            className: r(p, j.item, S && j.withIcon, {
              [j.isActive]: k,
              [j.isDisabled]: _ || w,
              [j.hovered]: x,
            }),
            ...
            onClick: function (t) {
              const { dontClosePopup: o, onClick: a, onClickArg: r, trackEventObject: i } = e;
              if (_) return;
            ...
            onContextMenu: function (t) {
              const { trackEventObject: o, trackRightClick: a } = e;
              o && a && (0, l.trackEvent)(o.category, o.event, `${o.label}_rightClick`);
            },
            onMouseUp: function (t) {
              const { trackEventObject: o, trackMouseWheelClick: a } = e;
              if (1 === t.button && C && o) {
                let e = o.label;
                a && (e += '_mouseWheelClick'), (0, l.trackEvent)(o.category, o.event, e);
              }
            },
            onMouseOver: O,
            onMouseOut: T,
          ...
          S &&
            a.createElement('span', {
              ...
              className: r(j.icon, R && c['round-icon']),
              dangerouslySetInnerHTML: { __html: S },
            }),
          a.createElement(
            'span',
            { className: r(j.labelRow, v) },
            a.createElement('span', { className: r(j.label, y) }, I),
          ),
          (void 0 !== f || g) &&
            a.createElement('span', { className: j.shortcut }, (q = f) && q.split('+').join(' + ')),
          void 0 !== M &&
            a.createElement(
              'span',
              {
                onClick: B ? u : void 0,
                className: r(j.toolbox, { [j.showOnHover]: N, [j.showOnFocus]: E }),
              },
              M,
            ),
        );
    ...
    742554: (e, t, o) => {
      ...
      const i = (0, a.forwardRef)((e, t) => {
        const { children: o, ...n } = e,
          i = (0, a.useRef)(null);
        return (
          (0, a.useImperativeHandle)(t, () => i.current),
          (0, a.useLayoutEffect)(() => {
      ...
      function s(e) {
        return t => {
          ...
          return !o.contains(t) || (null !== a && o.contains(a) && a.contains(t));
        };
      }
    },
    602948: e => {
