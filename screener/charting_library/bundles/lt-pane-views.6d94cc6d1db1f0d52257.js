(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1583],
  {
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (
            ...
            const e = i(a.add(d).scaled(0.5), this._numericFormatter.format(this._abRetracement));
          ...
          if (this._points.length >= 5) {
            ...
            const n = i(a.add(c).scaled(0.5), this._numericFormatter.format(this._xdRetracement));
        ...
        _updateBaseData() {
          if (this._source.points().length >= 3) {
            ...
            this._abRetracement =
              Math.round(1e3 * Math.abs((i.price - t.price) / (t.price - e.price))) / 1e3;
          }
          ...
          if (this._source.points().length >= 5) {
            ...
            (this._cdRetracement =
              Math.round(1e3 * Math.abs((r.price - n.price) / (n.price - i.price))) / 1e3),
              (this._xdRetracement =
                Math.round(1e3 * Math.abs((r.price - t.price) / (t.price - e.price))) / 1e3);
          }
        }
      }
    },
    ...
    441314: (e, t, i) => {
        ...
        _drawImpl(e) {
          ...
          t.scale(1, l / (p * m)),
            this._data.clockwise
              ? t.arc(0.5 * p, (p * Math.sqrt(3)) / 2, p, (-2 * Math.PI) / 3, -Math.PI / 3, !1)
              : t.arc(0.5 * p, (-p * Math.sqrt(3)) / 2, p, Math.PI / 3, (2 * Math.PI) / 3, !1),
            t.restore(),
            t.stroke(),
            this._data.fillBackground &&
              ((t.fillStyle = (0, d.generateColor)(this._data.backcolor, this._data.transparency)),
              t.fill());
        }
      }
      class _ extends l.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          (b = (0, s.transformPoint)(P, b)),
            (P = (0, s.rotationMatrix)(-T)),
            (b = (0, s.transformPoint)(P, b)),
            (P = (0, s.scalingMatrix)(1, w / (2 * g))),
            (b = (0, s.transformPoint)(P, b));
          const L = b.y >= 0 ? new r.Point(_.x, _.y) : new r.Point(m.x, m.y);
          (L.data = 2), d.push(L);
          const S = [
          ...
          for (let e = u.length - 2; e >= 0; e--) {
            ...
            if (s >= t.x) {
              const i = u[e + 1],
                ...
                o = (s - t.x) / n,
                a = t.y + r * o;
              return h.length() <= a + c ? new l.HitTestResult(l.HitTarget.MovePoint) : null;
            }
          }
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          const i = this._data.points[0].x - (this._geometryCache.paddingLeft + 20),
            ...
            r = (0, a.box)(
              new a.Point(i, n),
              new a.Point(i + this._geometryCache.innerWidth, n + this._geometryCache.innerHeight),
            );
          return (0, l.pointInBox)(e, r)
            ? new u.HitTestResult(u.HitTarget.MovePoint, { areaName: u.AreaName.Text })
            : null;
        }
        _drawImpl(e) {
          ...
          const i = this._measureInfo(t, this._data.label, this._data.fontSize),
            { paddingLeft: n, innerHeight: r, innerWidth: s, textHorizontalPadding: o } = i;
        ...
        _updateImpl() {
          ...
          if (_ > 0 && 2 === u.length) {
            ...
            if (t === g.LineToolBarsPatternMode.Bars || t === g.LineToolBarsPatternMode.OpenClose) {
              ...
              const e = v[t],
                i = p.map((t, i) => new n.Point(T + i * d, m(e(t)) + b));
              x.append(
        ...
        hitTest(e, t) {
          ...
          if (4 === i.points.length) {
            ...
            if (
              ...
              (0, a.cubicBezierHitTest)(s, l, p, g, e, t) ||
            ...
            return null === v && (v = (0, h.hitTestExtendedPoints)(e, t, i.extendRightPoints)), v;
          }
          return null;
        }
        _drawImpl(e) {
          ...
          if (2 === this._data.points.length)
            t.beginPath(),
              ...
              t.lineTo(n.x, n.y),
              t.stroke(),
              this._data.leftEnd === d.LineEnd.Arrow && (0, l.drawArrow)(n, i, t, t.lineWidth, 1),
              this._data.rightEnd === d.LineEnd.Arrow && (0, l.drawArrow)(i, n, t, t.lineWidth, 1);
          else {
            ...
            this._data.fillBack &&
              ...
              this._data.leftEnd === d.LineEnd.Arrow && (0, l.drawArrow)(o, i, t, t.lineWidth, 1),
              this._data.rightEnd === d.LineEnd.Arrow && (0, l.drawArrow)(p, n, t, t.lineWidth, 1),
              t.stroke();
          }
        }
      }
        ...
        _updateImpl(e, t) {
          ...
          if (4 === this._source.points().length) {
            const n = (0, f.ensureNotNull)(
              ...
              o = (0, f.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[1])),
              a = (0, f.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[2])),
              l = (0, f.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[3])),
              d = l.subtract(n),
              h = a.subtract(d.scaled(0.25)),
              c = o.subtract(a),
              u = l.add(c.scaled(0.25));
            i.extendLeft.value() && (r = this._extendSegmentLeft(a, n, h, t, e)),
              i.extendRight.value() && (s = this._extendSegmentRight(l, o, u, t, e));
          }
          const o = this._points.slice(),
            a = this._source.controlPoints();
          null !== a &&
            (o.push((0, f.ensureNotNull)(this._source.pointToScreenPoint(a[0]))),
        ...
        _updateImpl(e, t) {
          ...
          if (3 === this._source.points().length) {
            const r = (0, n.ensureNotNull)(
              ...
              o = (0, n.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[1])),
            ...
            i.extendLeft.value() && (s = this._extendSegmentLeft(l, r, h, t, e)),
              i.extendRight.value() && (a = this._extendSegmentRight(l, o, c, t, e));
          }
        ...
        _drawImpl(e) {
          ...
          if (
            ...
            this._data.fillBack &&
              ...
              this._data.leftEnd === s.LineEnd.Arrow && (0, l.drawArrow)(o, t, r, r.lineWidth, 1),
              this._data.rightEnd === s.LineEnd.Arrow && (0, l.drawArrow)(a, i, r, r.lineWidth, 1),
              r.stroke();
          }
        }
      }
    ...
    881685: (e, t, i) => {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        constructor() {
          super(),
            (this._data = null),
            (this._textSizeCache = { totalHeight: NaN, totalWidth: NaN });
        }
        setData(e) {
          this._data = e;
        }
        ...
        _drawImpl(e) {
          ...
          const r = this._data.textData.fontSize * this._data.textData.lines.length,
          ...
          t.x > c + o ? (p = 20) : t.x > c && (p = 10),
            ...
            10 === p
              ...
              : n.lineTo(o - 8, 0),
            20 === p ? (n.lineTo(t.x, t.y), n.lineTo(o, 8)) : n.arcTo(o, 0, o, 8, 8),
            21 === p
              ? g
                ? (n.lineTo(o, i.y - 8),
                  n.lineTo(t.x, t.y),
              ...
              : n.lineTo(o, a - 8),
            22 === p ? (n.lineTo(t.x, t.y), n.lineTo(o - 8, a)) : n.arcTo(o, a, o - 8, a, 8),
            12 === p
              ? _
                ? (n.lineTo(i.x + 8, a), n.lineTo(t.x, t.y), n.lineTo(i.x - 8, a), n.lineTo(8, a))
                : (n.lineTo(t.x, t.y), n.lineTo(8, a))
              : n.lineTo(8, a),
            2 === p ? (n.lineTo(t.x, t.y), n.lineTo(0, a - 8)) : n.arcTo(0, a, 0, a - 8, 8),
            1 === p
              ? g
                ? (n.lineTo(0, i.y + 8), n.lineTo(t.x, t.y), n.lineTo(0, i.y - 8), n.lineTo(0, 8))
                : (n.lineTo(t.x, t.y), n.lineTo(0, 8))
              : n.lineTo(0, 8),
            0 === p ? (n.lineTo(t.x, t.y), n.lineTo(8, 0)) : n.arcTo(0, 0, 8, 0, 8),
            n.stroke(),
            (n.fillStyle = (0, d.generateColor)(this._data.backcolor, this._data.transparency)),
            n.fill(),
      ...
      class v extends _.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const h = {
            ...
            backcolor: e.backgroundColor.value(),
            transparency: e.transparency.value(),
            textData: { lines: l, maxWidth: d, font: o, fontSize: e.fontsize.value() },
          ...
          if (
            ...
            (t.data = 1), this._renderer.append(this.createLineAnchor({ points: [t] }, 1));
          }
        }
        _fontStyle() {
          const e = this._source.properties().childs(),
    ...
    887610: (e, t, i) => {
      'use strict';
      var n = i(86441).Point,
        r = i(197062).LineSourcePaneView,
        s = i(820151).VerticalLineRenderer,
        o = i(305227).TrendLineRenderer,
        a = i(353795).HitTarget,
        l = i(734792).CompositeRenderer,
        d = i(243939).LineEnd;
      t.LineToolCircleLinesPaneView = class extends r {
        constructor(e, t) {
          super(e, t), (this._lines = []), (this._trendRenderer = new o()), (this._renderer = null);
        }
        _updateImpl() {
          if ((super._updateImpl(), (this._renderer = null), !(this._source.points().length < 2))) {
            ...
            if (this._source.priceScale() && !this._source.priceScale().isEmpty() && !e.isEmpty()) {
              ...
              if (((this._lines = []), 0 !== r)) {
                ...
                if (r > 0)
                  for (var h = t.index; h <= o.lastBar(); h += r)
                    this._lines.push({ x: e.indexToCoordinate(h) });
                else
                  for (h = t.index; h >= o.firstBar(); h += r)
                    this._lines.push({ x: e.indexToCoordinate(h) });
                  ...
                  if (2 === this._source.points().length) {
                    ...
                    c.append(
                      this.createLineAnchor(
                        {
                          points: [
                            new n(this._points[0].x, this._source.priceScale().height() / 2),
                          ],
      ...
      class g extends u.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          const i = this._data.points[0].x,
            ...
            r = (0, l.box)(
              new l.Point(i, n),
              new l.Point(i + this._geometryCache.innerWidth, n + this._geometryCache.innerHeight),
            );
          return (0, d.pointInBox)(e, r)
            ? new p.HitTestResult(p.HitTarget.MovePoint, { areaName: p.AreaName.Text })
            : null;
        }
        _drawImpl(e) {
          if (null === this._data || 0 === this._data.points.length) return;
      ...
      class l extends n.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            ...
            this._horizLineRenderer.setHitTest(new a.HitTestResult(a.HitTarget.MovePoint));
        }
        update() {
          this._invalidated = !0;
        }
      ...
      class r extends n.Pattern5pointsPaneView {
        _updateBaseData() {
          ...
          if (this._source.points().length >= 4) {
            const [e, t, , i] = this._source.points();
            this._bcRetracement =
              Math.round(1e3 * Math.abs((i.price - e.price) / (t.price - e.price))) / 1e3;
          }
          if (this._source.points().length >= 5) {
            ...
            (this._cdRetracement =
              ...
              (this._xdRetracement =
                Math.round(1e3 * Math.abs((n.price - i.price) / (e.price - i.price))) / 1e3);
          }
        }
      }
    },
    ...
    958003: (e, t, i) => {
      ...
      const m = new _.TimeSpanFormatter(),
        ...
        T = s.t(null, { context: 'study' }, i(32819));
      class b extends x.DateAndPriceRangeBasePaneView {
        constructor() {
          super(...arguments),
        ...
        _updateImpl(e, t) {
          ...
          this._distanceLineRenderer.setData({
            ...
            rightend:
              Math.abs(h.x - c.x) >= 25 * d.linewidth.value() ? p.LineEnd.Arrow : p.LineEnd.Normal,
          ...
          this._distancePriceRenderer.setData({
            ...
            leftend: p.LineEnd.Normal,
            rightend:
              Math.abs(S.y - C.y) >= 25 * d.linewidth.value() ? p.LineEnd.Arrow : p.LineEnd.Normal,
            excludeBoundaries: null != f ? f : void 0,
          }),
          ...
          if (E && H) {
            ...
            O = ', ' + (0, o.startWithLTR)(m.format(e));
          }
          const V = this._model.mainSeries().symbolInfo();
          V &&
          ...
          const W = (0, n.ensureNotNull)(this._source.ownerSource()).formatter(),
            F =
              (null !==
                (s = null === (i = W.formatChange) || void 0 === i ? void 0 : i.call(W, I, M)) &&
              void 0 !== s
                ? s
                : W.format(A)) +
              ' (' +
          ...
          Number.isNaN(j) || (Y += `\n${T} ${R.format(j)}`),
            (U =
              I > M
                ...
                : new r.Point(0.5 * (h.x + c.x), c.y + 0.7 * d.fontsize.value()));
          const q = { x: 0, y: 10 },
            Q = d.fontsize.value(),
            Z = {
              points: [U],
          ...
          (null === (l = d.fillLabelBackground) || void 0 === l ? void 0 : l.value()) &&
            ((Z.boxShadow = { shadowColor: d.shadow.value(), shadowBlur: 4, shadowOffsetY: 1 }),
      ...
      class m extends g.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          w(this._leftBorderRenderer, new n.Point(d.x, g), new n.Point(d.x, m)),
            w(this._rightBorderRenderer, new n.Point(p.x, g), new n.Point(p.x, m));
          ...
          this._distancePriceRenderer.setData({
            ...
            leftend: c.LineEnd.Normal,
            rightend:
              Math.abs(y.x - T.x) >= 15 * r.linewidth.value() ? c.LineEnd.Arrow : c.LineEnd.Normal,
          ...
          const A = this._source.volume(),
            k = Number.isNaN(A) ? '' : `\n${x} ${f.format(A)}`,
            N = v.format({ count: (0, s.forceLTRStr)(S.toString()) }) + I + k,
            D = { x: 0, y: 10 },
            B = r.fontsize.value(),
            z = {
              text: N,
          ...
          (null === (i = r.fillLabelBackground) || void 0 === i ? void 0 : i.value()) &&
            ((z.boxShadow = { shadowColor: r.shadow.value(), shadowBlur: 4, shadowOffsetY: 1 }),
    ...
    17006: (e, t, i) => {
      'use strict';
      var n = i(71960).DisjointChannelRenderer,
        r = i(305227).TrendLineRenderer,
        s = i(787672).TextRenderer,
        o = i(734792).CompositeRenderer,
        a = i(131616).PaneCursorType,
        l = i(526019),
        d = i(605809).AlertableLineSourcePaneView,
          ...
          if (
            ...
            if (!(this._points.length < 2)) {
              ...
              if (
                ...
                w(this._p1LabelRenderer, this._p2LabelRenderer, e, t, this._price1, this._price2),
              ...
              this._trendLineRendererPoints43.setData(x(s, n)),
                ...
                w(this._p3LabelRenderer, this._p4LabelRenderer, n, s, this._price3, this._price4);
              var R = [e, t, n, s];
              this._model.lineBeingCreated() === this._source && R.pop(),
                a.append(this.createLineAnchor({ points: R, pointsCursorType: h }, 0)),
                e && t && this._addAlertRenderer(a, [e, t]),
                (this._renderer = a);
            }
          }
        }
        ...
        draw(e, t) {
          ...
          (e.font = (0, u.makeFont)(
            ...
            (0, c.drawScaled)(e, i, i, () => {
              e.fillText(this._data.letter, s / i, o / i + 0.05 * this._data.fontSize);
            }),
            e.restore();
        }
        _center() {
      ...
      class v extends n.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          for (let e = 0; e < this._points.length - g; e++, u = -u) {
            ...
            const r = f[t.group],
              s = new l.HitTestResult(l.HitTarget.ChangePoint, { pointIndex: e });
            h.append(
              new p(
                {
    ...
    256182: (e, t, i) => {
      ...
      class f extends _.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          return Math.abs(m - 0.5 * h) <= w
            ...
            : this._data.fillBackground && !this._data.noHitTestOnBackground && m <= 0.5 * h
        ...
        _drawImpl(e) {
          ...
          (v = (0, c.transformPoint)(x, v)),
            ...
            s.rotate(f),
            s.scale(1, (2 * a) / p),
            s.arc(0, 0, 0.5 * p, this._data.angleFrom, this._data.angleTo, this._data.clockwise),
            s.restore(),
            s.stroke(),
            this._data.fillBackground &&
              ((s.fillStyle = (0, u.generateColor)(this._data.backcolor, this._data.transparency)),
              s.fill());
        }
      }
      class v extends h.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          s.append(this.createLineAnchor({ points: [v, x, m, w], pointsCursorType: y }, 0)),
            (this._renderer = s);
        }
    ...
    677437: (e, t, i) => {
      ...
      class d extends r.LineSourcePaneView {
        constructor() {
          super(...arguments), (this._executionRenderer = new a()), (this._renderer = null);
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        }
    ...
    78759: (e, t, i) => {
      ...
      class c extends a.ParallelChannelRenderer {
        ...
        _extendAndDrawLineSegment(e, t, i, n) {
          var r;
          const s = null === (r = this._data) || void 0 === r ? void 0 : r.excludeBoundaries;
          if (void 0 !== s) {
          ...
          super._extendAndDrawLineSegment(e, t, i, n), void 0 !== s && e.restore();
        }
      }
      class u extends d.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e, t) {
          ...
          this._renderer = null;
          const d =
            null === (i = this._source.ownerSource()) || void 0 === i ? void 0 : i.firstValue();
          if (null == d) return;
          ...
          if (this._points.length < 3) {
            ...
            return (
              ...
              u.append(this._baseLineRenderer),
              this.addAnchors(u),
              void (this._renderer = u)
            );
          }
          const f = this._source.levelsCount(),
            v = (0, n.ensureNotNull)(this._norm);
          for (let i = 1; i < f; i++) {
            const s = (0, n.ensureDefined)(this._source.properties().child('level' + i)).childs();
            if (!s.visible.value()) continue;
            let o = null;
            for (let e = i + 1; e <= f; e++) {
              const t = (0, n.ensureDefined)(this._source.properties().child('level' + e)).childs();
              if (t.visible.value()) {
                o = t;
                break;
              }
            ...
            if (!o) break;
            const a = v.scaled(s.coeff.value()),
              x = _.add(a),
              m = g.add(a),
              w = v.scaled(o.coeff.value()),
              R = _.add(w),
              y = g.add(w),
              T = l.coordinateToPrice(x.y, d),
            ...
            null !== b &&
              (u.append(b),
              (P = null !== (r = (0, h.getTextBoundaries)(b, t, e)) && void 0 !== r ? r : void 0));
            const L = {
                points: [x, m, R, y],
                color: s.color.value(),
                linewidth: p.levelsStyle.childs().linewidth.value(),
          ...
          if (null !== x) {
            const i = (0, n.ensureDefined)(this._source.properties().child('level' + x)).childs();
            if (i.visible.value()) {
              const n = v.scaled(i.coeff.value()),
                r = _.add(n),
                o = g.add(n),
                c = l.coordinateToPrice(r.y, d),
              ...
              null !== f &&
                (u.append(f),
                (m =
                  null !== (a = (0, h.getTextBoundaries)(f, t, e)) && void 0 !== a ? a : void 0));
              const w = {
                points: [r, o],
                color: i.color.value(),
                linewidth: p.levelsStyle.childs().linewidth.value(),
    ...
    644763: (e, t, i) => {
      'use strict';
      var n = i(86441).Point;
      const { LineToolPaneViewFibWithLabels: r } = i(776195);
      var s = i(305227).TrendLineRenderer,
        o = i(353795).HitTestResult,
        a = i(353795).HitTarget,
        l = i(734792).CompositeRenderer,
        d = i(9780).EllipseRendererSimple,
        h = i(243939).LineEnd;
      t.FibCirclesPaneView = class extends r {
        ...
        _updateImpl() {
          if (
            ...
            this._levels = [];
            for (
              var s = this._source.properties(), c = this._source.levelsCount(), u = 1;
              u <= c;
              u++
            ) {
              var p = s['level' + u];
              if (p.visible.value()) {
                var _ = p.coeff.value(),
                  g = p.color.value(),
                  f = [];
                f.push(new n(this._center.x - 0.5 * i * _, this._center.y - 0.5 * r * _)),
                  f.push(new n(this._center.x + 0.5 * i * _, this._center.y + 0.5 * r * _));
    ...
    333164: (e, t, i) => {
      ...
      function r(e, t, i, r, s, o) {
        if (o)
          return Math.round(
            (0, n.ensureDefined)(e.coordinate) + (0, n.ensureDefined)(t.coordinate) * i,
          );
      ...
      function s(e, t, i, r, s, o) {
        ...
        const a = (0, n.ensureDefined)(e.coordinate) + (0, n.ensureDefined)(t.coordinate) * i;
    ...
    781906: (e, t, i) => {
      ...
      class u extends c.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e, t) {
          var i, l;
          if ((super._updateImpl(), this._renderer.clear(), this._source.points().length < 2))
            return;
          ...
          const S = f ? p.price : _.price,
            ...
            A = { price: S, coordinate: I },
            k = { price: M, coordinate: c.priceToCoordinate(C, u) - I },
            ...
            for (let e = 0; e < this._levels.length; e++)
              if (e > 0 && R) {
                const t = this._levels[e - 1],
                  i = {
                    points: [new n.Point(m, this._levels[e].y), new n.Point(w, t.y)],
          ...
          for (let i = 0; i < this._levels.length; i++) {
            ...
            if ((null === c || c.isOutOfScreen(t, e) || this._renderer.append(c), L)) {
              ...
              null !== c &&
                ...
                (n = null !== (l = (0, o.getTextBoundaries)(c, t, e)) && void 0 !== l ? l : void 0);
              const u = {
                  points: [r, h],
                  color: this._levels[i].color,
    ...
    120204: (e, t, i) => {
      ...
      class u extends c.MediaCoordinatesPaneRenderer {
        constructor(e, t, i) {
          super(),
            ...
            (this._backHittest = i || new s.HitTestResult(s.HitTarget.MovePointBackground));
        }
        hitTest(e) {
          const t = this._data;
      ...
      class _ extends p.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl() {
          ...
          if (
            null ==
            (null === (e = this._source.ownerSource()) || void 0 === e ? void 0 : e.firstValue())
          )
            return;
          ...
          for (let e = 1; e <= c; e++) {
            ...
            const o = s.coeff.value(),
              a = s.color.value(),
              h = l.subtract(i).length() * o,
              c = (0, r.sign)(l.y - i.y),
              u = new n.Point(i.x, i.y + c * d * o);
            this._levels.push({
              color: a,
              radius: h,
              dir: c,
    ...
    555868: (e, t, i) => {
      ...
      class p extends u.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          var i;
          if ((super._updateImpl(), this._renderer.clear(), this._source.points().length < 1))
            return;
          ...
          if (p.fillBackground.value()) {
            ...
            for (let i = 1; i < this._levels.length; i++) {
              const r = this._levels[i - 1],
                s = {
                  points: [new n.Point(this._levels[i].x, 0), new n.Point(r.x, e)],
                  color: this._levels[i].color,
                  linewidth: 0,
          ...
          for (let o = 0; o < this._levels.length; o++) {
            ...
            if (p.showLabels.value()) {
              ...
              this._needLabelExclusionPath(h) &&
                (a = null !== (i = (0, s.getTextBoundaries)(h, t, e)) && void 0 !== i ? i : void 0),
            ...
            const h = {
              ...
              u = new l.HitTestResult(l.HitTarget.MovePoint, void 0, this._levels[o].index),
          ...
          2 === this._source.points().length
            ? this._renderer.append(this.createLineAnchor({ points: this._points }, 0))
    ...
    826524: (e, t, i) => {
      'use strict';
      const { LineToolPaneViewFibWithLabels: n } = i(776195);
      var r = i(86441).Point,
        s = i(305227).TrendLineRenderer,
        o = i(353795).HitTestResult,
        a = i(353795).HitTarget,
        l = i(734792).CompositeRenderer,
        d = i(410055).ArcWedgeRenderer,
        h = i(243939).LineEnd;
      t.FibWedgePaneView = class extends n {
        ...
        _updateImpl() {
          if (
            ...
            o.dotProduct(l) < 0 && (h = 2 * Math.PI - h),
              (this._edge2 = h),
              d < h &&
                ((this._edge1 = Math.max(d, h)), (this._edge2 = Math.min(d, h) + 2 * Math.PI)),
            ...
            for (var c = this._source.properties(), u = 1; u <= this._source.levelsCount(); u++) {
              ...
              if (p.visible.value()) {
                var _ = p.coeff.value(),
                  ...
                  v = s.add(o).scaled(0.5).normalized().scaled(f),
                  x = t.add(v);
                this._levels.push({
                  coeff: _,
                  color: g,
        ...
        _updateRenderer() {
          if (!((x = this._points).length < 2)) {
            ...
            if (
              (this._baseTrendRenderer.setData(r), e.append(this._baseTrendRenderer), x.length < 3)
            )
            ...
            for (var _ = this._levels.length - 1; _ >= 0; _--) {
              ...
              (f.center = this._points[0]),
                (f.radius = g.radius),
                (f.prevRadius = _ > 0 ? this._levels[_ - 1].radius : 0),
                (f.edge = this._edge),
                (f.color = g.color),
            ...
            var x = [i, n];
            this._model.lineBeingCreated() !== this._source && x.push(s),
    ...
    724861: (e, t, i) => {
      ...
      var n = i(71960).DisjointChannelRenderer,
        ...
        o = i(734792).CompositeRenderer,
        a = i(526019),
        l = i(605809).AlertableLineSourcePaneView;
      ...
      class a extends o.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          return Math.abs(a - o) < 5 && t.x * e.x >= 0 && t.y * e.y >= 0
            ...
            : this._data.fillBack && a >= d && a <= o && t.x * e.x >= 0 && t.y * e.y >= 0
        ...
        _drawImpl(e) {
          ...
          this._data.fillBack &&
            ...
            (t.fillStyle = (0, r.generateColor)(this._data.color, this._data.transparency, !0)),
            t.fill()),
            t.beginPath(),
    ...
    250292: (e, t, i) => {
      ...
      class u extends r.LineSourcePaneView {
        ...
        _prepareLevels(e, t) {
          const { startPoint: i, endPoint: r, barsCoordsRange: s, priceCoordsRange: o } = t,
        ...
        _prepareFanLines(e, t) {
          const { p1: i, startPoint: r, endPoint: s, barsCoordsRange: o, priceCoordsRange: a } = t,
        ...
        _getLabelData(e, t) {
          const i = this._getSource(),
            { textColor: n, font: r, fontSize: s, bold: o, italic: a } = i.getLabelsStyle();
          return {
            points: [e],
        ...
        _updateImpl() {
          ...
          for (let e = 1; e <= 9; e++) {
            ...
            const s = r.coeff1.value(),
              ...
              d = s + '/' + o;
            let c, _;
            s > o ? ((c = i.x), (_ = t.y + p / a)) : ((c = t.x + u * a), (_ = i.y)),
              h.push({
                label: d,
                color: l,
                x: c,
          ...
          for (let e = 0; e < h.length; e++) {
              ...
              }
            {
              ...
              s.setData(n),
                s.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, h[e].index)),
                g.append(s);
            }
    ...
    880152: (e, t, i) => {
      ...
      class h extends r.LineSourcePaneView {
        ...
        _prepareFanLines(e, t) {
          const { p1: i, startPoint: r, endPoint: s, barsCoordsRange: o, priceCoordsRange: d } = t,
            h = this._getSource().fanLines();
          for (const t of h) {
            if (!t.visible) continue;
            const h = t.x,
    ...
    515866: (e, t, i) => {
      ...
      var n = i(86441).Point,
        r = i(197062).LineSourcePaneView,
        s = i(787672).TextRenderer,
        o = i(250654).RectangleRenderer,
        a = i(305227).TrendLineRenderer,
        l = i(734792).CompositeRenderer,
        d = i(424030).NumericFormatter,
        h = i(243939).LineEnd,
        c = i(526019);
        ...
        _updateImpl() {
          if (
            ...
            if (((this._hfans = []), (this._vfans = []), C.fans.visible.value()))
              for (p = 1; p <= 7; p++) {
                (R = Math.round(m + C['hlevel' + p].coeff.value() * x)),
                  (f = d + C['vlevel' + p].coeff.value() * r);
            ...
            for (p = 0; p < this._hlevels.length; p++) {
              if (p > 0 && M) {
                ...
                ((E = {}).points = [e, t]),
                  ...
                  (E.extendLeft = !1),
                  (E.extendRight = !1),
                  (O = new o(void 0, void 0, !0)).setData(E),
                  T.append(O);
              }
              var D = {
            ...
            (j.data = 3),
              T.append(this.createLineAnchor({ points: [...this._points, Y, j] }, 0)),
              (this._renderer = T);
          }
          function U(e, t, i) {
            var r = new n(b, P),
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          for (let e = 1; e < this._points.length; e++) {
            ...
            i.setData(t), i.setHitTest(new o.HitTestResult(o.HitTarget.MovePoint)), f.append(i);
          }
    ...
    101324: (e, t, i) => {
      ...
      var n = i(5531),
        ...
        p = i(526019);
      const _ = {
        leftShoulder: r.t(null, void 0, i(268589)),
        rightShoulder: r.t(null, void 0, i(278934)),
        head: r.t(null, void 0, i(963706)),
      };
      ...
      class u extends h.AlertableLineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            ...
            this._lineRenderer.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint));
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        }
        _updateImpl(e, t) {
          ...
          if (s.showLabel.value() && 1 === this._points.length && s.text.value().length > 0) {
            ...
            this._labelRenderer.setData(_),
              ...
              this._needLabelExclusionPath(this._labelRenderer) &&
                (h =
                  null !== (i = (0, o.getTextBoundaries)(this._labelRenderer, t, e)) && void 0 !== i
                    ? i
                    : void 0),
          ...
          if (((u = u && (p.y < -_ || p.y > e + _)), a.append(this._lineRenderer), !u)) {
            if (1 === this._points.length) {
              ...
              (e.data = 0),
                (e.square = !0),
                a.append(this.createLineAnchor({ points: [e], pointsCursorType: c }, 0));
            }
            if (1 === this._points.length) {
    ...
    613031: (e, t, i) => {
      ...
      class _ extends u.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          if (null === this._data || 0 === this._data.points.length) return;
          const { context: t, horizontalPixelRatio: i, verticalPixelRatio: n, bitmapSize: r } = e,
            s = r.width,
            o = this._data.points[0].y,
            a = Math.max(0, this._data.points[0].x),
            l = Math.max(s, this._data.points[0].x);
          (t.lineCap =
            void 0 === this._data.linestyle || this._data.linestyle === p.LINESTYLE_SOLID
              ? 'round'
              : 'butt'),
            (t.strokeStyle = this._data.color),
            (t.lineWidth = Math.max(1, Math.floor(this._data.linewidth * i))),
            void 0 !== this._data.linestyle && (0, d.setLineStyle)(t, this._data.linestyle);
          const h = this._data.excludeBoundaries;
          void 0 !== h && (0, c.addExclusionAreaByScope)(e, h),
            (0, d.drawHorizontalLine)(t, Math.round(o * n), Math.round(a * i), Math.round(l * i));
        }
      }
        ...
        _updateImpl(e, t) {
          ...
          if (l.showLabel.value() && 1 === this._points.length) {
            ...
            if ('right' === a) {
              ...
              'center' === a &&
                (c = (0, n.point)((c.x + this._model.timeScale().width()) / 2, c.y));
            const m = {
              points: [c],
              text: _,
            ...
            this._labelRenderer.setData(m),
              ...
              this._needLabelExclusionPath(this._labelRenderer) &&
                (h =
                  null !== (i = (0, s.getTextBoundaries)(this._labelRenderer, t, e)) && void 0 !== i
                    ? i
                    : void 0);
          }
          const u = {
          ...
          this._horzRayRenderer.setData(u),
            ...
            this.addAnchors(d),
            1 === this._points.length && this._addAlertRenderer(d, [u.points[0]]),
            (this._renderer = d);
        }
      }
    },
    ...
    197062: (e, t, i) => {
      'use strict';
      i.d(t, { LineSourcePaneView: () => p, thirdPointCursorType: () => u });
      var n = i(168019),
        r = i(650151),
        s = i(596853),
        o = i(353795),
      ...
      class p {
        ...
        areAnchorsVisible() {
          return (
            ((this.isHoveredSource() && !this.isLocked()) || this.isSelectedSource()) &&
            this.isEditMode()
          );
        }
        update() {
          ...
          return (
            r.setData({
              ...
              linePointBeingEdited: this.isBeingEdited()
                ...
                : null,
              hittestResult:
                null !== (i = e.hittestResult) && void 0 !== i ? i : o.HitTarget.ChangePoint,
        ...
        _anchorRadius() {
          return (0, s.lastMouseOrTouchEventInfo)().isTouch
            ? c.TouchAnchorRadius
            : c.RegularAnchorRadius;
        }
        _lineAnchorColors(e) {
          const t = (0, r.ensureNotNull)(this._model.paneForSource(this._source)).height();
    ...
    776195: (e, t, i) => {
      ...
      class d extends r.LineSourcePaneView {
        ...
        _updateLabelForLevel({
          ...
          if (!w && !R) return null;
          const y =
            null === (_ = this._source.ownerSource()) || void 0 === _ ? void 0 : _.firstValue();
          if (null == y) return null;
          const T = !((i.x > this._model.timeScale().width() && !h) || (r.x < 0 && !c));
          let b,
            P,
            L = a;
          switch (L) {
            ...
            case 'right':
              (P = r.y),
                c ? (b = T ? this._model.timeScale().width() : i.x) : ((b = r.x), (L = 'left'));
              break;
            default:
              (b = (i.x + r.x) / 2), (P = (i.y + r.y) / 2);
          }
          const S = m['level' + t].coeff.value();
          let C = '';
          if (w) {
            C +=
              null !==
                (f = null === (g = m.coeffsAsPercents) || void 0 === g ? void 0 : g.value()) &&
              void 0 !== f &&
              f
                ? this._percentageFormatter.format(100 * S, !1, 2)
                : this._numericFormatter.format(S);
          }
          return (
            R && (C += '(' + x.formatPrice(s, y) + ')'),
            v.setData({
    ...
    782920: (e, t, i) => {
        ...
        _createSource(e, t, i) {
          (this._sourceCanvas = (0, u.createDisconnectedCanvas)(
            ...
            this._translate.x % 1 == 0 &&
              (this._translate = new g.Point(this._translate.x + 0.5, this._translate.y));
      ...
      class x {
        ...
        _drawTooltipOn(e, t) {
          ...
          e.font =
            (i.bold ? 'bold ' : '') + (i.italic ? 'italic ' : '') + i.fontSize + 'px ' + i.font;
          ...
          f < 10 ? (f = a.y + 13) : (x = 'bottom'),
            g < 10
              ? (g += Math.abs(g - 10))
              : g + p + 10 > i.vpWidth && (g -= g + p + 10 - i.vpWidth),
            (e.fillStyle = (0, h.generateColor)(i.backgroundColor, i.backgroundTransparency)),
            (e.strokeStyle = i.borderColor),
            (e.lineWidth = 1),
            e.beginPath();
          const w = Math.round(g * t.pixelRatio),
            R = Math.round(f * t.pixelRatio);
          (m = Math.round(m * t.pixelRatio)),
            (_ = Math.round(_ * t.pixelRatio)),
            (p = Math.round(p * t.pixelRatio));
          const y = Math.round(7 * t.pixelRatio);
          e.moveTo(w, R),
            v || 'top' !== x || (e.lineTo(m - y, R), e.lineTo(m, R - y), e.lineTo(m + y, R)),
            e.lineTo(w + p, R),
            e.lineTo(w + p, R + _),
            v ||
              'bottom' !== x ||
              (e.lineTo(m + y, R + _), e.lineTo(m, R + _ + y), e.lineTo(m - y, R + _)),
            e.lineTo(w, R + _),
            e.closePath(),
            e.fill(),
            e.stroke(),
          ...
          (0, u.drawScaled)(e, t.pixelRatio, t.pixelRatio, () => {
            for (let t = 0; t < o.length; t++)
              e.fillText(o[t].replace(/^\s+/, ''), b, P), (P += i.fontSize + l);
          }),
            e.restore();
        }
      }
    ...
    765970: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        c = i(350299),
        u = i(158929);
      const p = o.t(null, void 0, i(433241)),
        _ = o.t(null, void 0, i(316075));
      class g extends d.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          if (this._adapter.getEditable() && e.x >= i.left && e.x < i.bodyRight) {
            const e = this._adapter.hasMoveCallback() ? h.HitTarget.MovePoint : h.HitTarget.Regular;
        ...
        _drawImpl(e) {
          ...
          const t = e.context,
            ...
            o = i - s,
            a = Math.max((this._adapter.getLineLength() / 100) * i, 1),
            l = Math.round(i - Math.min(o, a)),
            d = l - s,
          ...
          (this._cache.bodyRight = d + n),
            ...
            (this._cache.left = d),
            (this._cache.right = l),
            this._drawLines(t, d, l, h, i);
          let u = !1;
          0 !== n &&
            (this._drawBody(t, d, c),
            this._adapter.hasMoveCallback() && this._drawMovePoints(t, d, c),
            this._drawBodyText(t, d, c),
            (u = !0)),
            0 !== r &&
              (this._drawQuantity(t, d + n, c, u), this._drawQuantityText(t, d + n, c), (u = !0)),
            0 !== this._cancelButtonWidth() && this._drawCancelButton(t, d + n + r, c, u);
        }
        _height() {
          return Math.max(
            20,
        ...
        _drawCancelButton(e, t, i, r) {
          ...
          e.fillRect(t + 0.5, i + 0.5, s - 1, o - 1),
            this._adapter.getBlocked() &&
              ...
              e.fillRect(t + 0.5, i + 0.5, s - 1, o - 1)),
            e.save(),
            r && e.clip && (e.beginPath(), e.rect(t + 0.5, i - 0.5, s + 1, o + 1), e.clip()),
          ...
          const h = (this._cancelButtonWidth() - 8) / 2,
            c = (this._height() - 8) / 2;
          (0, l.drawPoly)(e, [new n.Point(t + h, i + c), new n.Point(a - h, d - c)], !0),
            (0, l.drawPoly)(e, [new n.Point(a - h, i + c), new n.Point(t + h, d - c)], !0);
        }
      }
      var f = i(707555);
      class v extends r.LineSourcePaneView {
        ...
        _updateImpl(e) {
          if (
            ...
            const t = this._points[0].y,
              i = e - 3.5 - 1,
              r = this._adapter.hasMoveCallback() ? h.HitTarget.MovePoint : h.HitTarget.Regular,
              s = [new n.Point(i, t)];
            this._selectionData = {
              barSpacing: this._model.timeScale().barSpacing(),
              points: s,
    ...
    548220: (e, t, i) => {
      ...
      class d extends a.AlertableLineSourcePaneView {
        constructor() {
          super(...arguments),
            (this._channelRenderer = new o.ParallelChannelRenderer()),
            (this._renderer = null);
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        ...
        _updateImpl() {
          ...
          const a = new s.CompositeRenderer();
          ...
          if (
            ...
            a.append(this.createLineAnchor({ points: d, pointsCursorType: l }, 0)),
            this._points.length >= 2)
          ) {
            const e = this._points;
            this._addAlertRenderer(a, [e[0], e[1]]);
          }
          this._renderer = a;
        }
      }
    ...
    371022: (e, t, i) => {
      ...
      class d extends l.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (
            (3 === this._points.length
              ? ((this._medianPoint = this._points[1].add(this._points[2]).scaled(0.5)),
          ...
          for (let t = 0; t <= 8; t++) {
            ...
            if (s.childs().visible.value()) {
              ...
              h = s.childs().coeff.value();
              {
                ...
                l.setData(r),
                  l.setHitTest(new n.HitTestResult(n.HitTarget.MovePoint, void 0, t)),
                  e.append(l);
              }
              {
                const i = {
                ...
                r.setData(i),
                  r.setHitTest(new n.HitTestResult(n.HitTarget.MovePoint, void 0, t)),
                  e.append(r);
              }
            }
          }
        ...
        _updateRenderer() {
          ...
          for (let t = 0; t <= 8; t++) {
            ...
            if (o.childs().visible.value()) {
              const n = this._medianPoint.addScaled(h, o.childs().coeff.value()),
                d = n.add(c),
              ...
              x.setData(v),
                x.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, t)),
                i.append(x);
              const m = {
                  points: [g, f],
                  color: o.childs().color.value(),
              ...
              w.setData(m),
                w.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, t)),
                i.append(w);
            }
          }
      ...
      class c extends h {
            ...
            for (let c = 0; c <= 8; c++) {
              ...
              if (p.childs().visible.value()) {
                ...
                const v = {
                  ...
                  x = new l.TrendLineRenderer();
                x.setData(v),
                  x.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, c)),
                  t.append(x);
                const m = {
                    points: [g, f],
                    color: p.childs().color.value(),
                  ...
                  w = new l.TrendLineRenderer();
                w.setData(m),
                  w.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, c)),
                  t.append(w);
              }
            }
          }
        ...
        _calcMofifiedBase() {
          this._points.length > 1 &&
            (this._modifiedBase = this._points[0].add(this._points[1]).scaled(0.5));
        }
      }
      class u extends c {
        _calcMofifiedBase() {
            ...
            for (let i = 0; i <= 8; i++) {
              ...
              if (p.visible.value()) {
                ...
                const v = {
                  ...
                  x = new l.TrendLineRenderer();
                x.setData(v),
                  x.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, i)),
                  e.append(x);
                const m = {
                    points: [g, f],
                    color: p.color.value(),
                  ...
                  w = new l.TrendLineRenderer();
                w.setData(m),
                  w.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, i)),
                  e.append(w);
              }
            }
          }
    ...
    608122: (e, t, i) => {
      'use strict';
      i.r(t), i.d(t, { PolylinePaneView: () => o });
      var n = i(596184),
        r = i(734792),
        s = i(197062);
      class o extends s.LineSourcePaneView {
    ...
    13005: (e, t, i) => {
      'use strict';
      var n = i(197062).LineSourcePaneView,
        r = i(158929),
        s = i(353795).HitTestResult,
        o = i(353795).HitTarget,
        a = i(793361).splitThousands,
        l = i(710263),
        d = i(350299).appendEllipsis,
        h = i(104947).MediaCoordinatesPaneRenderer;
      const { setLineStyle: c, drawLine: u, drawPoly: p } = i(741253),
        { LINESTYLE_SOLID: _ } = i(549696);
      class g extends h {
        constructor(e, t) {
        ...
        _drawLines(e, t, i, n, r) {
          e.save(),
            ...
            (e.lineWidth = this._adapter.getLineWidth()),
            u(e, i, n, r, n),
            this._adapter.getExtendLeft() && u(e, 0, n, t, n),
            e.restore();
        }
        _drawBody(e, t, i) {
          (e.strokeStyle = this._adapter.getBodyBorderColor()),
        ...
        _drawReverseButton(e, t, i) {
          ...
          var s = function (e, t) {
              c(e, _), u(e, 0, 0, 0, t), u(e, -1, 1, 1, 1), u(e, -2, 2, 2, 2);
            },
        ...
        _drawImpl(e) {
          if (null !== this._data && this._data.points && !(this._data.points.length < 1)) {
            var t = e.context,
              ...
              d = Math.round(i - Math.min(a, l)),
              h = d - o,
              c = Math.round(this._data.points[0].y),
              u = Math.round(c - (this._height() + 1) / 2);
            (this._cache.bodyRight = h + n),
              (this._cache.quantityRight = this._cache.bodyRight + r),
              (this._cache.reverseButtonRight = this._cache.quantityRight + s),
              (this._cache.top = u),
              (this._cache.bottom = u + this._height()),
              (this._cache.left = h),
              (this._cache.right = d),
              this._drawLines(t, h, d, c, i),
              0 !== n && (this._drawBody(t, h, u), this._drawBodyText(t, h, u)),
              0 !== r &&
                (this._drawQuantity(t, this._cache.bodyRight, u),
                this._drawQuantityText(t, this._cache.bodyRight, u)),
              0 !== s && this._drawReverseButton(t, this._cache.quantityRight, u),
        ...
        hitTest(e) {
          return null === this._data ||
            ...
            ? new s(o.Custom, {
                ...
                tooltip: {
                  text:
                    this._adapter.getProtectTooltip() || d(i(509806).t(null, void 0, i(911810))),
                  rect: {
            ...
            ? new s(o.Custom, {
                ...
                tooltip: {
                  text: this._adapter.getReverseTooltip() || i(509806).t(null, void 0, i(419780)),
                  rect: {
            ...
            ? new s(o.Custom, {
                ...
                tooltip: {
                  text: this._adapter.getCloseTooltip() || i(509806).t(null, void 0, i(437431)),
                  rect: {
      ...
      t.PositionPaneView = class extends n {
        constructor(e, t) {
          super(e, t),
            (this._rendererCache = {}),
            (this._renderer = new g(this._rendererCache, e._adapter));
        }
        renderer(e, t) {
          return (
            this._invalidated && this._updateImpl(),
    ...
    271473: (e, t, i) => {
      ...
      var n = i(86441).Point,
        ...
        d = i(741134).getImage,
        h = i(44681),
        c = i(637927).PercentageFormatter,
        u = i(906355).DateFormatter,
        p = i(981011).TimeFormatter,
        _ = i(981011).hourMinuteFormat,
        g = i(981011).hourMinuteSecondFormat,
        f = i(388853).TimeSpanFormatter,
        v = i(32240),
        x = i(141663),
        m = i(620218).calcTextHorizontalShift,
        w = i(710263).isRtl,
        R = i(741253).drawRoundRect,
        y = i(384341).makeFont,
        T = i(104947).MediaCoordinatesPaneRenderer,
        b = i(710263),
        P = b.forceLTRStr,
        L = b.startWithLTR,
        S = i(526019).CHART_FONT_FAMILY;
      class C extends T {
        constructor() {
          super(),
            (this._data = null),
        ...
        drawTargetLabel(e) {
          ...
          (e.fillStyle = v.generateColor(this._data.targetBackColor, this._data.transparency)),
            e.fill(),
            (e.lineWidth = 2),
          ...
          if ((e.fillText(a, P + c + _ + 2 * p + N, I), this._data.status)) {
            ...
            switch (((e.font = y(this._targetFontSize1, this._font, 'bold')), this._data.status)) {
              case x.AlertStatus.Success:
                (D = i(509806).t(null, void 0, i(826787))),
                  (B = v.generateColor(this._data.successBackground, this._data.transparency)),
                  (z = this._data.successTextColor),
                  (E = this._data.successIcon);
                break;
              case x.AlertStatus.Failure:
                (D = i(509806).t(null, void 0, i(100968))),
                  (B = v.generateColor(this._data.failureBackground, this._data.transparency)),
            ...
            (e.fillStyle = B),
              'up' === this._data.direction
                ? (R(e, b.x - 1, b.y - H - 2, this._targetWidth + 2, H, 5),
                  e.fill(),
                  (e.fillStyle = z),
                  e.fillText(D, b.x + V + W, b.y - H + 1),
                  E &&
                    e.drawImage(E, b.x + V - E.width - 4, b.y - H - 2 + Math.abs(H - E.height) / 2))
                : (R(e, b.x - 1, b.y + this._targetHeight + 2, this._targetWidth + 2, H, 5),
                  e.fill(),
                  (e.fillStyle = z),
                  ...
                  E &&
                    e.drawImage(
                      E,
                      b.x + V - E.width - 4,
                      b.y + this._targetHeight + 10 - Math.abs(H - E.height) / 2,
                    )),
              e.restore();
          } else e.restore();
        }
        drawStartLabel(e) {
          ...
          (e.fillStyle = v.generateColor(this._data.sourceBackColor, this._data.transparency)),
            e.fill(),
            (e.lineWidth = 2),
            (e.strokeStyle = v.generateColor(
        ...
        _drawImpl(e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            Math.abs(r.x) < 1 || Math.abs(r.y) < 1
              ? (t.beginPath(), t.moveTo(i.x, i.y), t.lineTo(n.x, n.y), t.stroke())
              : (t.save(),
                t.beginPath(),
                t.translate(i.x, i.y),
                t.scale(1, r.y / r.x),
        ...
        targetLabelHitTest(e) {
          ...
          var i = 'up' === this._data.direction ? -1 : 1,
            ...
            h = Math.min(l, d),
            c = Math.max(l, d);
          return e.x >= s && e.x <= s + this._targetWidth && e.y >= h && e.y <= c
            ? new o(a.MovePoint)
            : null;
        }
        sourceLabelHitTest(e) {
          ...
          var t = 'up' === this._data.direction ? 1 : -1,
            ...
            d = Math.min(s, l),
            h = Math.max(s, l);
          return e.x >= r && e.x <= r + this._sourceWidth && e.y >= d && e.y <= h
            ? new o(a.MovePoint)
            : null;
        }
        hitTest(e) {
      ...
      t.PredictionPaneView = class extends r {
        constructor(e, t) {
          ...
          (this._clockWhite = null),
            ...
            d('prediction-clock-white', i(999620)).then(function (e) {
              (n._clockWhite = e), r();
            }),
            d('prediction-success-white', i(614012)).then(function (e) {
              (n._successIcon = e), r();
            }),
            d('prediction-failure-white', i(888249)).then(function (e) {
              (n._failureIcon = e), r();
            }),
            (this._percentageFormatter = new c()),
            (this._predictionRenderer = new C()),
            (this._renderer = null);
        }
        iconsReady() {
        ...
        _updateImpl() {
          if (
            ...
            n.time &&
              t.time &&
              ((a = TradingView.isString(n.time) ? new Date(Date.parse(n.time)) : n.time),
            ...
            if (d && a) {
              (this._targetLine4 = new u().format(d)),
                h || (this._targetLine4 = this._targetLine4 + '  ' + new p(v ? g : _).format(d));
              var m = (d.valueOf() - a.valueOf()) / 1e3;
              this._targetLine2 =
                i(509806).t(null, { context: 'dates' }, i(491481)) + ' ' + L(new f().format(m));
            }
            ...
            w &&
              ...
              h || (this._sourceLine2 = this._sourceLine2 + ' ' + new p(v ? g : _).format(w))),
              (this._direction = this._source.direction() === x.Direction.Up ? 'up' : 'down'),
              (this._finished =
                this._model.lineBeingCreated() !== this._source &&
            ...
            (R.points = this._points),
              ...
              (R.targetBackColor = this._source.properties().targetBackColor.value()),
              (R.targetStrokeColor = this._source.properties().targetStrokeColor.value()),
              (R.targetTextColor = this._source.properties().targetTextColor.value()),
              (R.sourceBackColor = this._source.properties().sourceBackColor.value()),
              (R.sourceStrokeColor = this._source.properties().sourceStrokeColor.value()),
              (R.sourceTextColor = this._source.properties().sourceTextColor.value()),
              (R.successBackground = this._source.properties().successBackground.value()),
              (R.successTextColor = this._source.properties().successTextColor.value()),
              (R.failureBackground = this._source.properties().failureBackground.value()),
              (R.failureTextColor = this._source.properties().failureTextColor.value()),
              (R.intermediateBackColor = this._source.properties().intermediateBackColor.value()),
              (R.intermediateTextColor = this._source.properties().intermediateTextColor.value()),
    ...
    207828: (e, t, i) => {
      ...
      var n = i(86441),
        r = n.Point,
        s = n.box,
        o = i(934026).pointInBox,
        a = i(197062).LineSourcePaneView,
        l = i(707555).SelectionRenderer,
        d = i(353795).HitTestResult,
        h = i(353795).HitTarget,
        c = i(734792).CompositeRenderer,
        u = i(32240),
        p = i(620218).calcTextHorizontalShift,
        _ = i(710263).isRtl,
        g = i(104947).MediaCoordinatesPaneRenderer,
        f = i(526019);
      class v extends g {
        constructor(e, t) {
          super(),
        ...
        _drawImpl(e) {
          if (null !== this._data && null !== this._points && 0 !== this._points.length) {
            ...
            this._measureCache &&
              ...
              t.arcTo(s, o, 0, o, 3),
              t.lineTo(12, o),
              (t.fillStyle = u.generateColor(this._data.backgroundColor, this._data.transparency)),
              t.fill(),
              (t.strokeStyle = this._data.borderColor),
              (t.lineWidth = 2),
              t.stroke(),
              ...
              (t.fillStyle = this._data.color),
              t.fillText(this._data.label, n + d, o / 2 + Math.floor(0.35 * this._data.fontSize)),
              t.translate(-0.5, -0.5),
              t.beginPath(),
              t.arc(-9, o + 15, 2.5, 0, 2 * Math.PI, !1),
              (t.fillStyle = u.generateColor(this._data.borderColor, this._data.transparency)),
              t.fill(),
        ...
        hitTest(e) {
          ...
          var t = this._points[0].x - this._measureCache.tailLeft,
            i =
              this._points[0].y - (this._measureCache.innerHeight + this._measureCache.tailHeight),
            n = s(
              new r(t, i),
              new r(t + this._measureCache.innerWidth, i + this._measureCache.innerHeight),
            );
    ...
    863820: (e, t, i) => {
      ...
      class m extends l.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          const d = (0, n.ensureNotNull)(this._source.ownerSource()).firstValue();
          if (null === d) return;
          const h = this._source.properties().childs(),
          ...
          if (h.showLabel && h.showLabel.value()) {
            ...
            this._customLabelRenderer.setData(v),
              ...
              'middle' === c &&
                (_.excludeBoundaries =
                  null !== (i = (0, a.getTextBoundaries)(this._customLabelRenderer, t, e)) &&
                  void 0 !== i
                    ? i
                    : void 0);
          }
      ...
      class v extends g.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          let y = m,
            T = w;
          y === T && (h && (y -= 1), g && (T += 1)),
            R(this._topBorderRenderer, new r.Point(y, v.y), new r.Point(T, v.y)),
            R(this._bottomBorderRenderer, new r.Point(y, x.y), new r.Point(T, x.y));
          const b = Math.round((v.x + x.x) / 2),
            P = new r.Point(b, v.y),
            L = new r.Point(b, x.y),
          ...
          this._distanceRenderer.setData({
            ...
            leftend: u.LineEnd.Normal,
            rightend:
              Math.abs(P.y - L.y) >= 15 * d.linewidth.value() ? u.LineEnd.Arrow : u.LineEnd.Normal,
            excludeBoundaries: null != S ? S : void 0,
          }),
            this._renderer.append(this._distanceRenderer);
          const C = this._source.points()[0].price,
          ...
          const N = (0, n.ensureNotNull)(this._source.ownerSource()).formatter(),
            D =
              null !==
                (a = null === (i = N.formatChange) || void 0 === i ? void 0 : i.call(N, M, C)) &&
              void 0 !== a
                ? a
                : N.format(I),
            B = (0, s.forceLTRStr)(
          ...
          (null === (l = d.fillLabelBackground) || void 0 === l ? void 0 : l.value()) &&
            ((O.boxShadow = { shadowColor: d.shadow.value(), shadowBlur: 4, shadowOffsetY: 1 }),
            (O.backgroundColor = d.labelBackgroundColor.value())),
            this._labelRenderer.setData(O);
          const V = this._labelRenderer.measure(),
    ...
    54840: (e, t, i) => {
      'use strict';
      var n = i(410055).ArcWedgeRenderer,
        r = i(826524).FibWedgePaneView,
        s = i(305227).TrendLineRenderer,
        o = i(734792).CompositeRenderer,
        a = i(243939).LineEnd;
      ...
      class h extends l.LineSourcePaneView {
        ...
        _addAnchors(e, t, i) {
          ...
          const c = e.x - t.x,
            ...
            p = Math.sign(c * u),
            _ = [
              p < 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize,
              p < 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize,
              p > 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize,
              p > 0 ? d.PaneCursorType.DiagonalNeSwResize : d.PaneCursorType.DiagonalNwSeResize,
              d.PaneCursorType.HorizontalResize,
          ...
          i.append(
            this.createLineAnchor({ points: [e, t, r, s, o, a, l, h], pointsCursorType: _ }, 0),
          );
        }
      }
    },
    790727: (e, t, i) => {
      ...
      class g extends _.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const e = new o.CompositeRenderer();
          let t = [];
          const i = [this._data.lines[1], this._data.lines[0], this._data.lines[2]].filter(
              e => !!e,
            ),
          ...
          for (let t = 1; t < i.length; t++) {
            const n = {
              ...
              r = new a.ParallelChannelRenderer(new s.HitTestResult(s.HitTarget.Regular));
    ...
    149089: (e, t, i) => {
      ...
      const T = [
        ...
        P = s.t(null, { context: 'line_tool_position' }, i(550140)),
        L = s.t(null, { context: 'line_tool_position' }, i(144143)),
      ...
      class A extends o.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          const E = new n.Point(C, D.y);
          (E.data = 1), (E.square = !0), (E.snappingIndex = h.index);
          const H = { points: [D, E, B, z], pointsCursorType: T };
        ...
        _createBackgroundRenderers(e, t) {
          ...
          if (e.pl < 0 && e.entryX !== e.right) {
            ...
            this._stopBgRenderer.setData(a), this._renderer.append(this._stopBgRenderer);
          }
          {
            const t = {
          ...
          if (e.pl > 0 && e.entryX !== e.right) {
            ...
            this._targetBgRenderer.setData(a), this._renderer.append(this._targetBgRenderer);
          }
        }
        ...
        _creareMiddleLabel(e, t, i) {
          ...
          const R = _.qty.value() / _.lotSize.value(),
            y =
              'futures' === i.type || (0, w.hasCryptoTypespec)(i.typespecs || [])
                ? Math.round(1e3 * R) / 1e3
                : Math.floor(R);
          if (_.compact.value()) (v += x ? x + ' ~ ' : ''), (v += y + '\n'), (v += m);
          else {
            const e = u ? L : P;
            (v += x ? b.format({ status: e, pnl: x }) + ', ' : ''),
              (v += I.format({ qty: '' + y }) + '\n'),
              (v += S.format({ ratio: m }) + ' ');
          }
          let T = _.linecolor.value();
          return (
            d < 0 ? (T = _.stopBackground.value()) : d > 0 && (T = _.profitBackground.value()),
        ...
        _createStopLabel(e, t) {
          var i, s;
          const { stopPrice: o, entryPrice: a, left: l, edge: d, stopLevel: h } = e,
    ...
    205809: (e, t, i) => {
      'use strict';
      var n = i(86441).Point,
        r = i(204652).distanceToLine,
        s = i(197062).LineSourcePaneView,
        o = i(197062).thirdPointCursorType,
        a = i(305227).TrendLineRenderer,
        l = i(596184).PolygonRenderer,
        d = i(734792).CompositeRenderer,
        h = i(243939).LineEnd,
        c = i(131616).PaneCursorType;
      const { LINESTYLE_SOLID: u } = i(549696);
      t.RotatedRectanglePaneView = class extends s {
        ...
        _updateImpl() {
          if (
            ...
            l.append(this.createLineAnchor({ points: R, pointsCursorType: y }, 0)),
              (this._renderer = l);
          }
        }
        renderer(e, t) {
    ...
    840777: (e, t, i) => {
      ...
      class R {
        ...
        setData(e) {
          ...
          this._data = { ...e, labelHeight: 0, labelRenderer: new g.TextRenderer() };
          const t = this._data,
            i = t.label,
            r = {
              offsetX: 0,
        ...
        hitTest(e, t) {
          ...
          const [i, r, s] = (function (e, t) {
            const i = (0, _.lastMouseOrTouchEventInfo)().isTouch ? 20 : 3,
              ...
              s = e.plate,
              o =
                (0, c.distanceToSegment)(new n.Point(r, x(e)), new n.Point(r, m(e)), t).distance <
                i;
            let a = !1;
            if (!o && void 0 !== s) {
          ...
          if (i || r || s) {
            ...
            return (
              s ? (e.areaName = a.AreaName.Text) : r && (e.areaName = a.AreaName.Style),
              ...
              e.lineTo(
                ...
                Math.round(
                  (function (e) {
                    ...
                    const n =
                      null !==
                        (i = null === (t = e.plate) || void 0 === t ? void 0 : t.poleTailHeight) &&
                      void 0 !== i
                        ? i
                        : 0;
                    return e.inverseAnchorPosition
              ...
              (function (e, t, i, n, r) {
                ...
                const h = (0, f.fillScaledRadius)(o, s),
                  ...
                  u = t.inverseAnchorPosition
                    ? Math.round(t.anchorY * s) + Math.round(o * s) * t.direction
                ...
                if (
                  ...
                  t.svgRenderer.render(e, {
                    targetViewBox: { x: _ - i / 2, y: g - i / 2, width: i, height: i },
                  });
                }
      ...
      class L extends l.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            ...
            (this._destroyed = !1),
            (this._signpostRenderer = new R(a.HitTarget.MovePoint, e.isPhantom())),
        ...
        _updateImpl(e, t) {
          if ((super._updateImpl(), this._renderer.clear(), !this._updateTimelineRenderer(e)))
            return;
          ...
          (s.data = r.data),
            ...
            this._renderer.append(
              this.createLineAnchor(
                { points: [s], pointsCursorType: [o.PaneCursorType.VerticalResize] },
                0,
              ),
            );
        }
        ...
        _updateTimelineRenderer(e) {
          ...
          const o = this._model.dark().value() ? b : P,
          ...
          const x = p.visualDirection !== p.positionPointDirection,
            ...
            w = {
              ...
              svgRenderer:
                null === (t = this._emojiCache) || void 0 === t ? void 0 : t.emojiSvgRenderer,
              itemIndex: 1,
              label: {
                labelIndex: 1,
        ...
        async _updateEmoji() {
          ...
          null !== this._emojiCache &&
            (null === (e = this._emojiCache.abortController) || void 0 === e || e.abort(),
            (this._emojiCache.abortController = void 0));
          const n = (0, y.getTwemojiUrl)(t, 'svg'),
            r = new AbortController(),
            s = (0, T.fetch)(n, { signal: r.signal }).then(e => e.text()),
            o = { emoji: t, abortController: r };
          this._emojiCache = o;
          const [a, { svgRenderer: l }] = await Promise.all([s, i.e(2616).then(i.bind(i, 586687))]);
          !this._destroyed &&
            o.abortController &&
            ((o.emojiSvgRenderer = l(a)), this._model.updateSource(this._source));
        }
      }
    },
    286847: (e, t, i) => {
      ...
      class d extends o.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          return (
            ...
            Math.abs(n - e.y) <= 3 ? new a.HitTestResult(a.HitTarget.MovePoint) : null
          );
        }
        _drawImpl(e) {
          const t = e.context;
          ...
          for (let e = 1; e <= n; e += i) {
            ...
            t.lineTo(this._data.point.x + e, this._data.point.y + n + this._data.height / 2);
          }
          t.stroke();
        }
      }
      ...
      class g extends d.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          this._iconRenderer.setData(o),
            this._iconRenderer.isOutOfScreen(e, t) || this._renderer.append(this._iconRenderer);
          ...
          this._renderer.append(
            this.createLineAnchor({ points: [_, g, f, v], pointsCursorType: m }, 0),
          );
        }
        _calculateBackgroundColor() {
          return (0, o.generateColor)(
            this._model.backgroundColorAtYPercentFromTop(
              this._points[0].y /
                (0, s.ensureNotNull)(this._model.paneForSource(this._source)).height(),
            ),
            60,
            !0,
          );
    ...
    487620: (e, t, i) => {
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (
            ((_.points = i.isFixed() ? [(0, n.ensureDefined)(i.fixedPoint())] : this._points),
            a.fillBackground &&
              a.fillBackground.value() &&
              (_.backgroundColor = a.backgroundColor.value()),
            a.drawBorder && a.drawBorder.value() && (_.borderColor = a.borderColor.value()),
            a.wordWrap && a.wordWrap.value() && (_.wordWrapWidth = a.wordWrapWidth.value()),
            ...
            i.isPriceDencityLog() &&
              !o.isLog() &&
              (t = o.height() / ((0, h.toLog)(e.maxValue(), r) - (0, h.toLog)(e.minValue(), r))),
              !i.isPriceDencityLog() &&
                o.isLog() &&
                (t =
                  o.height() / ((0, h.fromLog)(e.maxValue(), r) - (0, h.fromLog)(e.minValue(), r)));
            const s = i.priceDencity();
            void 0 !== s && (_.scaleY = t / s),
              (void 0 === s || void 0 === _.scaleY || _.scaleY <= 0) && delete _.scaleY;
          }
          ...
          if (g && !this._noSelection) {
            ...
            if (_.wordWrapWidth) {
              ...
              (i.data = 1),
                e.append(this.createLineAnchor({ points: [i], pointsCursorType: p }, 1));
            }
    ...
    762586: (e, t, i) => {
      ...
      class h extends d.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          const t = new n.Point(this._data.point.x + this._data.width / 2, this._data.point.y);
          let i = e.subtract(t);
        ...
        _drawImpl(e) {
          ...
          (t.strokeStyle = this._data.color),
            ...
            t.stroke(),
            this._data.fillBackground &&
              ((t.fillStyle = (0, o.generateColor)(this._data.backcolor, this._data.transparency)),
              t.fill());
        }
      }
      class c extends s.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const f = [];
          for (let e = s; g > -c; e -= a) (g = _.indexToCoordinate(e)), f.push(g);
          g = Math.max(l.x, d.x);
          for (let e = o; g < _.width(); e += a) (g = _.indexToCoordinate(e)), f.push(g);
      ...
      class m extends x.TrendToolWithStatsPaneView {
        ...
        _updateImpl(e, t) {
          ...
          m.showBarsRange.value() ||
            ...
            ((this._label = null), this._labelData && (this._labelData.text = ''));
          ...
          m.statsPosition.value() === h.StatsPosition.Auto &&
            (T = (0, r.equalPoints)(v, x)
              ? !(0, o.pointInBox)(v, y)
              : null === (0, s.intersectLineSegmentAndBox)((0, r.lineSegment)(v, x), y));
          if (
            (this.isHoveredSource() || this.isSelectedSource() || m.alwaysShowStats.value()) &&
            !T &&
            2 === this._points.length
          ) {
          ...
          const b =
            (this.isHoveredSource() || this.isSelectedSource()) && m.showMiddlePoint.value();
          this._middlePoint &&
            this._renderer.append(
          ...
          this._angleLabelRenderer.setData(S),
            this._renderer.append(this._angleLabelRenderer),
            R.points.length >= 2 && this._addAlertRenderer(this._renderer, R.points);
          const C = new r.Point(this._secondPoint.x, this._secondPoint.y);
          (C.data = 1), this._renderer.append(this.createLineAnchor({ points: [v, C] }, 0));
        }
      }
    },
    689573: (e, t, i) => {
      ...
      class u extends c.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e, t) {
          ...
          if (3 === this._source.points().length) {
            ...
            let o = !1;
            p.reverse && p.reverse.value() && (o = p.reverse.value()), (this._levels = []);
          ...
          if (x)
            for (let e = 0; e < this._levels.length; e++)
              if (e > 0 && x) {
                const t = this._levels[e - 1],
                  i = {
                    points: [new n.Point(f, this._levels[e].y), new n.Point(v, t.y)],
                    color: this._levels[e].color,
                    linewidth: 0,
                    backcolor: this._levels[e].color,
                    fillBackground: !0,
                ...
                this._rectangleRenderers.hasOwnProperty(e) ||
                  (this._rectangleRenderers[e] = new r.RectangleRenderer(void 0, void 0, !0));
          ...
          for (let i = 0; i < this._levels.length; i++) {
            const r = new n.Point(y, this._levels[i].y),
              d = new n.Point(T, this._levels[i].y);
            let c;
            ...
            null !== u &&
              ...
              'middle' === p.vertLabelsAlign.value() &&
                (c =
                  null !== (a = (0, h.getTextBoundaries)(u, e, t)) && void 0 !== a ? a : void 0));
            const _ = {
              points: [r, d],
              color: this._levels[i].color,
              linewidth: this._levels[i].linewidth,
            ...
            this._hlevelLineRenderers.hasOwnProperty(i) ||
        ...
        _updateImpl(e, t) {
          ...
          if (a.fillBackground.value()) {
            ...
            for (let i = 1; i < this._levels.length; i++) {
              const r = this._levels[i - 1],
                s = {
                  points: [new n.Point(r.x, 0), new n.Point(this._levels[i].x, e)],
                  color: this._levels[i].color,
                  linewidth: 0,
                  backcolor: this._levels[i].color,
                  fillBackground: !0,
          ...
          for (let o = 0; o < this._levels.length; o++) {
            ...
            if (m) {
              ...
              this._needLabelExclusionPath(d) &&
                (a = null !== (i = (0, s.getTextBoundaries)(d, t, e)) && void 0 !== i ? i : void 0),
                u.append(d);
            }
            const d = {
                x: this._levels[o].x,
              ...
              h = new l.HitTestResult(l.HitTarget.MovePoint, void 0, this._levels[o].index),
        ...
        _updateImpl(e, t) {
          ...
          if (x.showLabel && x.showLabel.value() && x.text.value().length > 0) {
            ...
            this._labelRenderer.setData(c),
              ...
              this._needLabelExclusionPath(this._labelRenderer) &&
                (R =
                  null !== (i = (0, l.getTextBoundaries)(this._labelRenderer, t, e)) && void 0 !== i
                    ? i
                    : void 0);
          }
          ...
          this._trendRenderer.setData(T), this._renderer.append(this._trendRenderer);
          const b = (0, r.box)(new r.Point(0, 0), new r.Point(t, e));
          let P = !1;
          x.statsPosition.value() === d.StatsPosition.Auto &&
            (P = (0, r.equalPoints)(m, w)
              ? !(0, s.pointInBox)(m, b)
              : null === (0, o.intersectLineSegmentAndBox)((0, r.lineSegment)(m, w), b));
          if (
          ...
          const L =
            (this.isHoveredSource() || this.isSelectedSource()) && x.showMiddlePoint.value();
          this._middlePoint &&
            this._renderer.append(
              new h.SelectionRenderer({
                points: [this._middlePoint],
            ...
            this.addAnchors(this._renderer),
            T.points.length >= 2 && this._addAlertRenderer(this._renderer, T.points);
        }
      }
    },
    176806: (e, t, i) => {
      'use strict';
      i.d(t, { TrendToolWithStatsPaneView: () => V });
      var n = i(650151),
        r = i(86441),
        s = i(5531),
        o = i(509806),
        ...
        L = new (class {
          constructor(e, t) {
            ...
            e.forEach(e => {
              ...
              n.set(e.theme, new T(e.imageData, t, i)), this._icons.set(e.name, n);
            });
          }
          getIcon(e, t) {
      ...
      class C {
          ...
          (this._fontSize = 0),
            ...
            (this._lineSpacing =
              (0, w.isNumber)(this._data.lineSpacing) && this._data.lineSpacing
                ...
                : 0),
            (e.lines = this._lines =
              null === e.text ? [] : (0, v.wordWrap)(e.text, this.fontStyle(), e.wordWrapWidth)),
          ...
          if (this._rect) {
            if (
              ...
              this._data.backgroundRoundRect
                ? ((0, m.drawRoundRect)(e, r.x, r.y, r.w, r.h, this._data.backgroundRoundRect),
              ...
              for (const n of this._data.icons) {
                ...
                this._drawIcon(e, l, d, n, Boolean(this._data.isDark), t), (s += 1);
              }
            }
          } else
        ...
        hitTest(e) {
          return 0 === this._data.points.length
            ? null
            : (this._preRender(),
              this._boundingBox && (0, g.pointInBox)(e, this._boundingBox) ? this._hittest : null);
        }
        _preRender() {
          ...
          if (((i += c.left), (s += c.top), this._data.icons)) {
            const e =
              void 0 !== this._data.textPadding ? this._data.textPadding : Math.round(o / 2);
            (i += P + e), (u.w += P + e);
          }
          if ('bottom' === this._data.vertAlign || 'middle' === this._data.vertAlign) {
            const e = 'middle' === this._data.vertAlign ? n - u.h / 2 : n - u.h - (u.y - n);
            (s += e - u.y), (u.y = e);
          }
          if ('right' === this._data.horzAlign || 'center' === this._data.horzAlign) {
            const n = 'center' === this._data.horzAlign ? t - u.w / 2 : t - u.w - (u.x - t);
            (i += n - u.x),
              (u.x = n),
              !0 !== this._data.doNotAlignText &&
                ('right' === this._data.horzAlign
        ...
        _drawIcon(e, t, i, r, s, o) {
          ...
          if (!l) {
            ...
            e.setTransform(1, 0, 0, 1, 0, 0), f.isEdge || e.scale(o.pixelRatio, o.pixelRatio);
            const t = L.getIcon(r, s ? 'dark' : 'light');
            t.ready() && (e.drawImage(t.image(), 0, 0), S.set(a, l));
          }
      ...
      function E(e, t) {
        return (
          !(!e && !t) && (!(!e || t) || !(e || !t) || e.index !== t.index || e.price !== t.price)
        );
      }
      class H {
        constructor(e) {
        ...
        updateSource(e, t) {
          ...
          if (!this._effectiveStatesEquals(s, o)) {
            const e = t();
            this._repaintSource(n, r.rowIndex, e), (r.effectiveState = o);
          }
          return r;
        }
        _findEmptyRow(e) {
        ...
        _repaintSource(e, t, i) {
          ...
          (0, R.drawScaled)(this._ctx, s, s, () => {
            ...
            const r = new C(i, { widths: [] }).draw(this._ctx, this._params);
        ...
        _recreateCanvas() {
          (this._canvas = (0, n.ensureNotNull)(document.createElement('canvas'))),
            ...
            (this._canvas.height =
              this._maxRowHeight * this._actualCapacity * this._params.pixelRatio),
      ...
      var O = i(571787);
      class V extends A.AlertableLineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            (this._renderer = new l.CompositeRenderer()),
        ...
        getCacheRects(e, t) {
          ...
          p ? (u -= 10 + d.height) : (u += 10),
            a !== O.StatsPosition.Auto ||
              (0, r.equalPoints)(l[O.StatsPosition.Left], l[O.StatsPosition.Right]) ||
              (c < 0 ? (c = 0) : c + d.width > e.cssWidth && (c = e.cssWidth - d.width),
              u < 0 ? (u = 0) : u + d.height > e.cssHeight && (u = e.cssHeight - d.height),
              (0, s.intersectLineSegmentAndBox)(
                (0, r.lineSegment)(l[O.StatsPosition.Left], l[O.StatsPosition.Right]),
                (0, r.box)((0, r.point)(c, u), (0, r.point)(c + d.width, u + d.height)),
              ) &&
                ((u = p ? l[h].y + 10 : l[h].y - 10 - d.height),
                (c = Math.min(l[O.StatsPosition.Center].x, e.cssWidth) - d.width)));
          return {
            cacheRect: d,
            targetRect: {
              left: Math.floor(c),
        ...
        _statLabelData() {
          ...
          if (x || v) {
            ...
            (u = (0, n.ensureNotNull)(this._source.pointToScreenPoint(t)).subtract(i)),
          ...
          if (g || f || v) {
            ...
            v &&
              (l && (l += ', '),
              (l += o.t(null, void 0, i(326273)).format({
          ...
          this._label = [(0, a.forceLTRStr)(_), l, d].filter(e => null != e).join('\n') || null;
    ...
    508626: (e, t, i) => {
      'use strict';
      var n = i(197062).LineSourcePaneView,
        r = i(734792).CompositeRenderer,
        s = i(974179).TriangleRenderer;
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            if ('horizontal' === o.textOrientation.value()) {
              ...
              switch (((r = -Math.PI / 2), (d = 0), o.horzLabelsAlign.value())) {
                case 'left':
                  p = 'bottom';
                  break;
                case 'right':
          ...
          if (
            ...
            if (1 === this._points.length) {
              ...
              (t.data = 0),
                ...
                a.append(this.createLineAnchor({ points: [t], pointsCursorType: c }, 0));
            }
            this._renderer = a;
          }
        }
      ...
      class o extends s.MediaCoordinatesPaneRenderer {
        constructor() {
          super(...arguments),
            ...
            (this._backHitTest = new n.HitTestResult(n.HitTarget.MovePointBackground));
        }
        setData(e) {
          this._data = e;
        }
        ...
        _drawImpl(e) {
          ...
          if (
            ...
            if (
              ...
              e.addColorStop(0, (0, r.generateColor)(this._data.color1, this._data.transparency)),
                e.addColorStop(1, (0, r.generateColor)(this._data.color2, this._data.transparency)),
                (t.fillStyle = e);
            } else
              t.fillStyle = (0, r.generateColor)(this._data.color, this._data.transparency, !0);
            t.fill();
    ...
    373912: (e, t, i) => {
      ...
      function s(e, t, i, r, s, o) {
        const a = i.subtract(e).length() + r.subtract(i).length() + t.subtract(r).length(),
          l = Math.max(3 / a, 0.02);
        let d;
        for (let a = 0; ; a += l) {
          a > 1 && (a = 1);
          const l = e.scaled((1 - a) * (1 - a) * (1 - a)),
            h = i.scaled(3 * (1 - a) * (1 - a) * a),
            c = r.scaled(3 * (1 - a) * a * a),
            u = t.scaled(a * a * a),
      ...
      function o(e, t, i, n, r) {
        ...
        const o = (function (e, t, i, n, r) {
          ...
          for (let r = 0; r < o.length; r++) {
            const a = l(e.x, t.x, i.x, o[r]);
            a >= 0 && a <= n && s.push(o[r]);
          }
          const d = a(e.x, t.x, i.x, 0).concat(a(e.x, t.x, i.x, n));
          for (let n = 0; n < d.length; n++) {
            const o = l(e.y, t.y, i.y, d[n]);
            o >= 0 && o <= r && s.push(d[n]);
          }
          return s;
        })(e, t, i, n, r)
        ...
        for (let n = 0; n < o.length - 1; n += 2) {
          ...
          for (; s <= a; ) {
            const n = e.scaled((1 - s) * (1 - s)),
              ...
              h = n.add(o).add(d);
            if (l.length > 0) {
              l[l.length - 1].subtract(h).length() < 2 && ((a += r), (r *= 2));
            }
            l.push(h), (s += r);
          }
          l.length > 0 && h.push(l);
      ...
      function a(e, t, i, n) {
        ...
        if (Math.abs(s) > 1e-8) {
          const e = o * o - 4 * s * a;
          e >= 0 && (r.push((-o + Math.sqrt(e)) / (2 * s)), r.push((-o - Math.sqrt(e)) / (2 * s)));
        } else r.push(-a / o);
        return r;
      }
      function l(e, t, i, n) {
    ...
    56520: (e, t, i) => {
      ...
      class u extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          const i = this._visiblePolygon((0, n.size)({ width: t.cssWidth, height: t.cssHeight }));
          return null !== i && (0, o.pointInPolygon)(e, i)
            ? new d.HitTestResult(d.HitTarget.MovePointBackground)
            : null;
        }
        _drawImpl(e) {
          if (null === this._data) return;
          ...
          if (null !== i) {
            ...
            (t.fillStyle = (0, h.generateColor)(this._data.color, this._data.transparency, !0)),
              t.fill();
          }
        }
        _visiblePolygon(e) {
          ...
          return (
            (d = p(d, i, n, [l, o])),
            (d = p(d, l, o, [i, n])),
            (0, s.equalPoints)(o, i) || t.extendLeft || (d = p(d, o, i, [n, l])),
            d
          );
        }
      }
      function p(e, t, i, n) {
        ...
        return null !== e && null !== r
          ? (0, l.intersectPolygonAndHalfplane)(
              e,
              (0, s.halfplaneThroughPoint)((0, s.lineThroughPoints)(t, i), r),
            )
          : null;
      }
    },
    71960: (e, t, i) => {
      ...
      class _ {
        constructor() {
          (this._parallelChannelRenderer = new c.ParallelChannelRenderer()),
            (this._disjointChannelIntersectionRenderer = new g()),
        ...
        setData(e) {
          ...
          if (
            ...
            null !==
            (0, l.intersectLines)((0, s.lineThroughPoints)(t, i), (0, s.lineThroughPoints)(n, r))
      ...
      function v(e, t, i) {
        return null !== e
          ? (0, l.intersectPolygonAndHalfplane)(
              e,
              (0, s.halfplaneThroughPoint)(((n = t), (0, s.line)(1, 0, -n)), new s.Point(i, 0)),
            )
          : null;
        var n;
      }
      ...
      class d extends a.MediaCoordinatesPaneRenderer {
        constructor(e, t, i) {
          super(),
            ...
            (this._backgroundHitTest = i || new n.HitTestResult(n.HitTarget.MovePointBackground));
        }
        hitTest(e) {
          if (this._data.points.length < 2) return null;
          const t = this._data.points[0],
        ...
        _drawImpl(e) {
          ...
          (t.lineCap = 'butt'),
            (t.strokeStyle = this._data.color),
            (t.lineWidth = this._data.linewidth),
            void 0 !== this._data.linestyle && (0, l.setLineStyle)(t, this._data.linestyle);
          const i = this._data.points[0],
            n = this._data.points[1],
            r = Math.abs(i.x - n.x),
            s = Math.abs(i.y - n.y),
          ...
          t.save(),
            ...
            this._data.fillBackground &&
              (this._data.wholePoints &&
                (t.translate(a.x, a.y), t.scale(1, s / r), t.arc(0, 0, d / 2, 0, 2 * Math.PI, !0)),
    ...
    422452: (e, t, i) => {
      ...
      class x extends c.BitmapCoordinatesPaneRenderer {
        ...
        _drawPoints(e, t, i, n, r) {
          const { context: o, horizontalPixelRatio: l, verticalPixelRatio: d } = e,
          ...
          for (let e = 0; e < t.length; ++e) {
            const s = t[e];
            o.fillStyle = i[e];
            if (!((0, a.isInteger)(s.data) && c.linePointBeingEdited === s.data)) {
              if (
                (n(
                  o,
                  new u(Math.round(s.x * l) + x, Math.round(s.y * d) + x, s.data, s.square),
                  v / 2,
                  g,
                ),
    ...
    430367: (e, t, i) => {
      'use strict';
      i.d(t, { ParallelChannelRenderer: () => p });
      var n = i(327714),
        r = i(650151),
        s = i(86441),
        o = i(204652),
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        constructor(e, t) {
          super(),
            (this._data = null),
            (this._hittestResult = e || new l.HitTestResult(l.HitTarget.MovePoint)),
            (this._backHittestResult = t || new l.HitTestResult(l.HitTarget.MovePointBackground));
        }
        setData(e) {
          this._data = e;
        }
        hitTest(e, t) {
          if (null === this._data || this._data.points.length < 2) return null;
          const i = (0, n.size)({ width: t.cssWidth, height: t.cssHeight }),
            [r, s] = this._data.points,
            o = this._extendAndHitTestLineSegment(e, r, s, i);
          if (null !== o) return o;
          if (4 === this._data.points.length && !this._data.skipTopLine) {
            const [, , t, n] = this._data.points,
              o = this._extendAndHitTestLineSegment(e, t, n, i);
            if (null !== o) return o;
            if (this._data.showMidline && !this._data.skipLines) {
              const o = r.add(t).scaled(0.5),
                a = s.add(n).scaled(0.5),
                l = this._extendAndHitTestLineSegment(e, o, a, i);
              if (null !== l) return l;
            }
          }
        ...
        _drawImpl(e) {
          ...
          if (this._data.points.some(e => !isFinite(e.y)))
            this._extendAndDrawLineSegment(t, i, n, e.mediaSize);
          else if (
            (this._data.skipLines || this._extendAndDrawLineSegment(t, i, n, e.mediaSize),
            ...
            if (
              (this._data.skipLines ||
                ...
                this._extendAndDrawLineSegment(t, r, s, e.mediaSize),
              this._data.fillBackground && this._drawBackground(t, this._data.points, e.mediaSize),
              this._data.showMidline && !this._data.skipLines)
            ) {
              (t.strokeStyle = this._data.midcolor),
                (t.lineWidth = this._data.midlinewidth),
                (0, u.setLineStyle)(t, this._data.midlinestyle);
              const o = i.add(r).scaled(0.5),
                a = n.add(s).scaled(0.5);
              this._extendAndDrawLineSegment(t, o, a, e.mediaSize);
            }
          }
        }
        _getColor() {
        ...
        _extendAndClipLineSegment(e, t, i) {
          const n = (0, r.ensureNotNull)(this._data);
        ...
        _drawBackground(e, t, i) {
          ...
          if (
            (0, s.equalPoints)(a, l) ||
            (0, s.equalPoints)(d, h) ||
            (0, o.distanceToLine)(a, l, d).distance < 1e-6 ||
            (0, o.distanceToLine)(a, l, h).distance < 1e-6
          )
            return;
          ...
          if (
            ((c = _(c, a, l, h)),
            n.extendright || (c = _(c, l, h, d)),
            (c = _(c, h, d, a)),
            n.extendleft || (c = _(c, d, a, l)),
            null !== c)
          ) {
      ...
      function _(e, t, i, n) {
        return null !== e
          ? (0, a.intersectPolygonAndHalfplane)(
              e,
              (0, s.halfplaneThroughPoint)((0, s.lineThroughPoints)(t, i), n),
            )
          : null;
      }
    },
    596184: (e, t, i) => {
      ...
      class p extends d.MediaCoordinatesPaneRenderer {
        constructor(e) {
          super(),
            (this._data = null),
            (this._backHittest = new a.HitTestResult(a.HitTarget.MovePointBackground)),
            (this._points = []),
            (this._hittest = null != e ? e : new a.HitTestResult(a.HitTarget.MovePoint));
        }
        setData(e) {
          (this._data = e), (this._points = e.points);
        }
        ...
        _drawImpl(e) {
          ...
          n.beginPath();
          const a = this._data.linestyle === u.LINESTYLE_SOLID ? 'round' : 'butt',
            d = null !== (t = this._data.linecap) && void 0 !== t ? t : a;
          (n.lineCap = d),
            (n.strokeStyle = this._data.color),
            (n.lineWidth = this._data.linewidth),
            (n.lineJoin = null !== (i = this._data.linejoin) && void 0 !== i ? i : 'round'),
          ...
          if (
            (this._data.filled &&
              this._data.fillBackground &&
              ((n.fillStyle = (0, l.generateColor)(this._data.backcolor, this._data.transparency)),
              n.fill()),
            this._data.filled && !this._data.skipClosePath && n.closePath(),
            r > 1)
          ) {
            if (this._data.leftend === o.LineEnd.Arrow) {
              const e = this._correctArrowPoints(this._points[1], this._points[0], n.lineWidth, d);
    ...
    974179: (e, t, i) => {
      ...
      class c extends s.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          const a = (0, l.interactionTolerance)().line;
          ...
          return (
            (s = (0, n.distanceToSegment)(i, d, e)),
            s.distance <= a
              ? new o.HitTestResult(o.HitTarget.MovePoint)
              : ((s = (0, n.distanceToSegment)(d, t, e)),
                s.distance <= a
                  ? new o.HitTestResult(o.HitTarget.MovePoint)
                  : this._data.fillBackground && (0, r.pointInTriangle)(e, t, i, d)
                  ? new o.HitTestResult(o.HitTarget.MovePointBackground)
                  : null)
          );
        }
        _drawImpl(e) {
          ...
          const i = e.context,
            n =
              (null !== (t = this._data.linestyle) && void 0 !== t ? t : h.LINESTYLE_SOLID) ===
              h.LINESTYLE_SOLID
                ? 'round'
                : 'butt';
          (i.lineCap = n),
          ...
          i.beginPath(),
            ...
            i.lineTo(r.x, r.y),
            this._data.fillBackground &&
              ((i.fillStyle = (0, a.generateColor)(this._data.backcolor, this._data.transparency)),
              i.fill()),
            i.stroke();
        }
      }
