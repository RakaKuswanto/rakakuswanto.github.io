  ...
  [6265],
  {
    ...
    839246: (e, t, l) => {
      ...
      const r = n.forwardRef(function (e, t) {
        const { id: l, tabs: r, activeTab: i, onChange: s, className: a } = e;
        return n.createElement(
          'div',
          { className: a, ref: t },
          n.createElement(o.UnderlineButtonTabs, {
            id: l,
            items: r,
            isActive: function (e) {
              return e.id === i;
    ...
    334163: (e, t, l) => {
      ...
      class T extends o.PureComponent {
        constructor(e) {
          ...
          super(e),
            ...
            (this._renderFooterLeft = e => {
              ...
              if ((0, f.isLineTool)(t))
                return o.createElement(w.FooterMenu, { sources: [t], chartUndoModel: l });
              if ((0, g.isStudy)(t))
                return o.createElement(h.StudyDefaultsManager, {
                  model: l,
                  source: t,
          ...
          const { pages: l, initialActiveTab: n } = this.props,
            r = null !== (t = l.find(e => e.id === n)) && void 0 !== t ? t : l[0];
          this.state = { activeTabId: r.id };
        }
        render() {
          const { title: e, onCancel: t, onClose: l, shouldReturnFocus: n } = this.props;
          return o.createElement(m.AdaptiveConfirmDialog, {
        ...
        _renderChildren() {
          return ({ requestResize: e }) => {
            ...
            const { pages: l, source: n, model: r } = this.props,
              { activeTabId: i } = this.state,
              s = null !== (t = l.find(e => e.id === i)) && void 0 !== t ? t : l[0],
            ...
            return o.createElement(
              ...
              o.createElement(
                ...
                'Component' in s
                  ? o.createElement(s.Component, { source: n, model: r })
                  : o.createElement(b.PropertiesEditorTab, { page: a, tableKey: s.id }),
              ),
            );
          };
        }
      ...
      class _ extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._inputs = new S.MetaInfoHelper(
              this.props.source.metaInfo(),
            ).getUserEditableInputs());
        }
        render() {
          return o.createElement(E.InputsTabContent, {
      ...
      var k = l(414823),
        ...
        D = l(662949),
        M = l(252138);
      const V = new s.TranslatedString('change visibility', i.t(null, void 0, l(521511)));
        ...
        constructor() {
          super(...arguments),
            (this._onChange = e => {
              ...
              l && (0, M.setPropertyValue)(l, l => t(l, e, V));
            });
        }
        render() {
          const { id: e, title: t, visible: n, disabled: r } = this.props,
            s = (0, a.clean)(i.t(t, { context: 'input' }, l(788601)), !0);
          return o.createElement(D.BoolInputComponent, {
            label: s,
            disabled: r,
            input: { id: e, type: 'bool', defval: !0, name: 'visible' },
            value: !n || (0, M.getPropertyValue)(n),
            onChange: this._onChange,
          });
        }
      }
      R.contextType = I.StylePropertyContext;
      var N = l(966507),
        A = l(917850),
        W = l(321659),
        B = l(865588),
      ...
      const $ = {
        ...
        X = Object.values($)
          ...
          .map(e => ({
            value: e.type,
            selectedContent: o.createElement(B.DisplayItem, { icon: e.icon }),
            content: o.createElement(B.DropItem, { icon: e.icon, label: e.label }),
          })),
        Y = i.t(null, void 0, l(491492));
        ...
        render() {
          ...
          const a = {
            ...
            content: o.createElement(
              o.Fragment,
              null,
              o.createElement(W.MenuItemSwitcher, {
              ...
              o.createElement(A.PopupMenuSeparator, null),
            ),
          };
          return o.createElement(B.IconDropdown, {
            id: e,
            disabled: s,
            className: l,
            hideArrowButton: !0,
      ...
      var ee = l(14385),
        te = l(462433);
      const le = new s.TranslatedString('change plot type', i.t(null, void 0, l(215683))),
        ne = new s.TranslatedString('change price line visibility', i.t(null, void 0, l(867761)));
      class oe extends o.PureComponent {
        ...
        render() {
          ...
          return o.createElement(
            ...
            o.createElement(ee.ColorWithThicknessSelect, {
      ...
      oe.contextType = I.StylePropertyContext;
      var re = l(459837);
      function ie(e, t, l, n, i, s, a) {
        ...
        return Object.keys(c).map((t, l) =>
          o.createElement(oe, {
            ...
            paletteColorProps: (0, r.ensureDefined)(p[t]),
            styleProp: n,
            isLine: i,
      ...
      class se extends o.PureComponent {
        render() {
          ...
          return o.createElement(
            ...
            !i &&
              o.createElement(
                re.PropertyTable.Row,
                null,
                o.createElement(
                  re.PropertyTable.Cell,
                  { placement: 'first', colSpan: 2, offset: p },
                  a
                    ? o.createElement('div', null, h)
                    : o.createElement(R, { id: m, title: h, visible: s.visible }),
                ),
              ),
            ie(m, l, n, s, v, p),
            d && u && ie(m, d, u, s, v, p, !0),
            c && o.createElement(re.PropertyTable.GroupSeparator, null),
          );
        }
      }
      ...
      class ce extends o.PureComponent {
        constructor(e) {
          super(e), (this._visible = new ae.StudyPlotVisibleProperty(e.styleProp.display));
        }
        render() {
          const {
            title: e,
      ...
      class pe extends o.PureComponent {
        ...
        render() {
          ...
          return o.createElement(R, { id: e, title: t, disabled: l, visible: this._visible });
        }
        componentWillUnmount() {
          this._visible.destroy();
        }
      ...
      var de = l(554393);
      const ue = new s.TranslatedString('change plot type', i.t(null, void 0, l(215683))),
        he = new s.TranslatedString('change price line visibility', i.t(null, void 0, l(867761)));
      class me extends o.PureComponent {
        ...
        render() {
          ...
          return o.createElement(
            N.InputRow,
            { label: o.createElement(pe, { id: e, title: t, display: p }) },
            l && !n
        ...
        _getInputForRgb() {
          const { id: e, showLineWidth: t, property: l } = this.props,
            { linewidth: n, display: r } = l;
          return n && t
            ? o.createElement(de.LineWidthSelect, {
      ...
      me.contextType = I.StylePropertyContext;
      ...
      class ye extends o.PureComponent {
        render() {
          ...
          return o.createElement(
            N.InputRow,
            {
              label: c ? o.createElement(R, { id: e, title: l, visible: n, disabled: u }) : l,
              offset: p,
              grouped: d,
            },
            t
      ...
      ye.contextType = I.StylePropertyContext;
      ...
      ge.contextType = I.StylePropertyContext;
      class be extends o.PureComponent {
        render() {
          ...
          return o.createElement(ve.Consumer, null, a =>
            o.createElement(
              o.Fragment,
              null,
              o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement(pe, { id: e, title: Ze((0, r.ensureNotNull)(a), e), display: s }),
                ),
              ),
              !t &&
                o.createElement(
              ...
              o.createElement(re.PropertyTable.GroupSeparator, null),
            ),
          );
        }
      }
      be.contextType = I.StylePropertyContext;
      var fe = l(687795),
        we = l.n(fe),
        Pe = l(497754),
        Ce = l.n(Pe),
        ...
        Se = l(694454);
      const _e = {
          [Se.MarkLocation.AboveBar]: {
            value: Se.MarkLocation.AboveBar,
            content: i.t(null, void 0, l(541389)),
            order: 0,
          },
          [Se.MarkLocation.BelowBar]: {
            value: Se.MarkLocation.BelowBar,
            content: i.t(null, void 0, l(278626)),
            order: 1,
          },
          [Se.MarkLocation.Top]: {
            value: Se.MarkLocation.Top,
            content: i.t(null, void 0, l(865994)),
            order: 2,
          },
          [Se.MarkLocation.Bottom]: {
            value: Se.MarkLocation.Bottom,
            content: i.t(null, void 0, l(691757)),
            order: 3,
          },
          [Se.MarkLocation.Absolute]: {
            value: Se.MarkLocation.Absolute,
      ...
      class xe extends o.PureComponent {
        render() {
          const {
            ...
            className: l,
            menuItemClassName: n,
            shapeLocationChange: r,
            disabled: i,
          } = this.props;
          return o.createElement(Ee.Select, {
            id: e,
            disabled: i,
            className: l,
            menuItemClassName: n,
      ...
      const Le = new s.TranslatedString('change char', i.t(null, void 0, l(198491))),
        Ie = new s.TranslatedString('change location', i.t(null, void 0, l(138361)));
      class De extends o.PureComponent {
        constructor() {
          super(...arguments),
            (this._onCharChange = e => {
              ...
              t((0, r.ensureDefined)(this.props.property.childs().char), o, Le);
            }),
            (this._onLocationChange = e => {
              const { setValue: t } = this.context;
              t(this.props.property.childs().location, e, Ie);
            });
        }
        render() {
          var e;
          const { id: t, title: l, char: n, isRGB: i, property: s, hasPalette: a } = this.props,
            { color: c, transparency: p, char: d, location: u, display: h } = s.childs();
          return o.createElement(
            N.InputRow,
            { grouped: a, label: o.createElement(pe, { id: t, title: l, display: h }) },
            !a &&
              !i &&
              o.createElement(ee.ColorWithThicknessSelect, {
                disabled: 0 === h.value(),
            ...
            o.createElement(Te.InputControl, {
              disabled: void 0 === d || 0 === h.value(),
              className: te.smallStyleControl,
              value: (0, r.ensureDefined)(
                null !== (e = null == d ? void 0 : d.value()) && void 0 !== e ? e : n,
              ),
            ...
            o.createElement(xe, {
              ...
              disabled: 0 === h.value(),
              className: Pe(te.defaultSelect, te.additionalSelect),
      ...
      Object.keys(Me.plotShapesData).forEach(e => {
        ...
        Ne.push({
          id: t.id,
          value: t.id,
          selectedContent: o.createElement(B.DisplayItem, { icon: Re(t.icon) }),
          content: o.createElement(B.DropItem, { icon: Re(t.icon), label: t.guiName }),
        });
      });
      ...
      const We = new s.TranslatedString('change shape', i.t(null, void 0, l(486888))),
        Be = new s.TranslatedString('change location', i.t(null, void 0, l(138361)));
      class ze extends o.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._onLocationChange = e => {
              const { setValue: t } = this.context;
              t(this.props.property.childs().location, e, Be);
            });
        }
        render() {
          const { id: e, title: t, isRGB: l, hasPalette: n, property: r } = this.props,
            { color: i, transparency: s, plottype: a, location: c, display: p } = r.childs();
          return o.createElement(
            N.InputRow,
            { grouped: n, label: o.createElement(pe, { id: e, title: t, display: p }) },
            !n &&
              !l &&
              o.createElement(ee.ColorWithThicknessSelect, {
                disabled: 0 === p.value(),
        ...
        render() {
          ...
          if ('line' === u || 'bar_colorer' === u || 'bg_colorer' === u)
            return h && h.palette && h.paletteProps
              ...
              : o.createElement(me, {
                  id: a,
                  title: (0, r.ensureDefined)(
                    null === (l = null == p ? void 0 : p[a]) || void 0 === l ? void 0 : l.title,
                  ),
                  property: d,
                  isRGB: m,
                  isFundamental: false,
          ...
          if ('chars' === u || 'shapes' === u) {
            const e = (0, r.ensureDefined)(null == p ? void 0 : p[a]),
              t = e.title;
            return o.createElement(
              o.Fragment,
              null,
          ...
          if ((0, x.isOhlcPlot)(n)) {
            const e = n.target,
              ...
              l = (0, r.ensureDefined)((0, r.ensureDefined)(s.metaInfo().ohlcPlots)[e]),
        ...
        _getPlotSwitch(e, t, l) {
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(pe, { id: e, title: t, display: l }),
            ),
          );
        }
      }
      ...
      var qe = l(600052),
        Ke = l(796855);
      const $e = new s.TranslatedString('change line style', i.t(null, void 0, l(628691)));
      class Xe extends o.PureComponent {
        constructor() {
          super(...arguments),
            (this._onLineStyleChange = e => {
              ...
              (0, M.setPropertyValue)(l, l => t(l, e, $e));
            });
        }
        render() {
          const { lineStyle: e, ...t } = this.props;
          return o.createElement(Ke.LineStyleSelect, {
            ...t,
            lineStyle: (0, M.getPropertyValue)(e),
            lineStyleChange: this._onLineStyleChange,
          });
        }
      }
      Xe.contextType = I.StylePropertyContext;
      ...
      class Je extends o.PureComponent {
        ...
        render() {
          ...
          return o.createElement(
            N.InputRow,
            { labelAlign: 'adaptive', label: o.createElement(R, { id: e, title: t, visible: a }) },
            o.createElement(
              'div',
              { className: te.block },
              o.createElement(
              ...
              o.createElement(
                'div',
                { className: Pe(te.wrapGroup, te.defaultSelect, te.additionalSelect) },
                o.createElement(qe.FloatInputComponent, {
      ...
      Je.contextType = I.StylePropertyContext;
      ...
      et.contextType = I.StylePropertyContext;
      var tt = l(767822),
        lt = l(815300);
      const nt = new s.TranslatedString('change percent width', i.t(null, void 0, l(851081))),
        ot = new s.TranslatedString('change placement', i.t(null, void 0, l(847634))),
        rt = new s.TranslatedString('change values visibility', i.t(null, void 0, l(212628))),
        it = [
          { value: tt.HHistDirection.LeftToRight, content: i.t(null, void 0, l(619286)) },
          { value: tt.HHistDirection.RightToLeft, content: i.t(null, void 0, l(221141)) },
        ],
      ...
      class dt extends o.PureComponent {
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                re.PropertyTable.Cell,
                { placement: 'first', colSpan: 2, grouped: !0 },
                o.createElement(R, { id: a, title: a, visible: s }),
              ),
            ),
            o.createElement(
              N.InputRow,
              {
                label: o.createElement('div', { className: te.childRowContainer }, st),
                grouped: !0,
              },
              o.createElement(lt.IntegerInputComponent, {
            ...
            o.createElement(
              N.InputRow,
              {
                label: o.createElement('div', { className: te.childRowContainer }, at),
                grouped: !0,
              },
              o.createElement(Ee.Select, {
            ...
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement(D.BoolInputComponent, {
                  label: ct,
                  input: { id: a + '_showValues', type: 'bool', defval: !0, name: 'visible' },
                  value: !r || r.value(),
                  disabled: !s.value(),
            ...
            o.createElement(
              N.InputRow,
              {
                label: o.createElement('div', { className: te.childRowContainer }, pt),
                grouped: !0,
              },
              o.createElement(ee.ColorWithThicknessSelect, { disabled: s && !s.value(), color: i }),
            ),
            this._renderColors(),
            o.createElement(re.PropertyTable.GroupSeparator, null),
          );
        ...
        _renderColors() {
          const { property: e, hHistInfo: t } = this.props,
            { colors: l, transparencies: n, visible: r } = e.childs(),
            { titles: i } = t;
          return l.childNames().map(e =>
            o.createElement(
              N.InputRow,
              {
                key: e,
                grouped: !0,
                label: o.createElement('div', { className: te.childRowContainer }, i[+e]),
              },
              o.createElement(ee.ColorWithThicknessSelect, {
                disabled: !r.value(),
                color: l[+e],
      ...
      dt.contextType = I.StylePropertyContext;
      class ut extends o.PureComponent {
        render() {
          const { title: e, property: t } = this.props,
            { color: l, width: n, style: r, visible: i } = t.childs();
          return o.createElement(
            N.InputRow,
            { label: o.createElement(R, { id: e, title: e, visible: i }) },
            o.createElement(ee.ColorWithThicknessSelect, {
              disabled: !i.value(),
              color: l,
      ...
      class vt extends o.PureComponent {
        render() {
          const { graphicType: e, study: t } = this.props,
            ...
            s = (0, r.ensureDefined)(n[e]);
          return Object.keys(s).map((t, n) => {
            var s, a, c, p;
            const d = (0, r.ensureDefined)(
            ...
            return 'horizlines' === e || 'vertlines' === e
              ? o.createElement(ut, {
                  key: t,
                  title: (0, r.ensureDefined)(
                    null === (a = l.graphics[e]) || void 0 === a ? void 0 : a[t],
                  ).name,
                  property: d,
                })
              : 'lines' === e
              ? o.createElement(ut, {
                  key: t,
                  title: (0, r.ensureDefined)(
                    null === (c = l.graphics.lines) || void 0 === c ? void 0 : c[t],
                  ).title,
                  property: d,
                })
              : 'hhists' === e
              ? o.createElement(dt, {
                  key: t,
                  hHistInfo: (0, r.ensureDefined)(
                    null === (p = l.graphics.hhists) || void 0 === p ? void 0 : p[t],
                  ),
                  property: d,
                })
              : null;
      ...
      var yt = l(408525);
      const gt = new s.TranslatedString('change font size', i.t(null, void 0, l(907378))),
        bt = [10, 11, 12, 14, 16, 20, 24, 28, 32, 40].map(e => ({ value: e, title: e.toString() }));
      class ft extends o.PureComponent {
        constructor() {
          super(...arguments),
        ...
        render() {
          ...
          return o.createElement(yt.FontSizeSelect, {
            ...t,
            fontSizes: bt,
            fontSize: e.value(),
      ...
      ft.contextType = I.StylePropertyContext;
      const wt = new s.TranslatedString('change visibility', i.t(null, void 0, l(521511))),
        Pt = i.t(null, void 0, l(864606)),
        Ct = i.t(null, void 0, l(194420)),
        Tt = {
      ...
      class Et extends o.PureComponent {
        ...
        render() {
          ...
          return o.createElement(
            ...
            o.createElement(
              N.InputRow,
              { labelAlign: 'adaptive', label: o.createElement('span', null, Pt) },
              o.createElement(
                'div',
                { className: te.block },
                o.createElement(
                  'div',
                  { className: Pe(te.wrapGroup, te.additionalSelect) },
                  o.createElement(ft, {
        ...
        _renderColors() {
          const { levelsStyle: e, inputs: t } = this.props.property.childs(),
            ...
            { kind: s } = t.childs(),
            a = (0, r.ensureDefined)(Tt[s.value()]);
          return l
            .childNames()
            .filter(e => a.has(e))
            .map(e =>
      ...
      Et.contextType = I.StylePropertyContext;
      const St = i.t(null, void 0, l(621861)),
        _t = [
          { value: tt.HHistDirection.RightToLeft, content: i.t(null, void 0, l(221141)) },
          { value: tt.HHistDirection.LeftToRight, content: i.t(null, void 0, l(619286)) },
        ],
        kt = new s.TranslatedString('change visibility', i.t(null, void 0, l(521511))),
        xt = i.t(null, void 0, l(114414)),
        Lt = i.t(null, void 0, l(391322)),
        It = i.t(null, void 0, l(895247)),
        Dt = i.t(null, void 0, l(731577)),
        Mt = i.t(null, { context: 'input' }, l(323545)),
        Vt = i.t(null, { context: 'input' }, l(641596));
      class Rt extends o.PureComponent {
        ...
        render() {
          ...
          const { metaInfo: p } = this.props,
            ...
            b = (0, r.ensureDefined)(p.graphics.hhists),
            f = Object.keys(b),
            w = v.childs()[f[0]],
            P = w.childs().visible,
            C = f.map(e => v.childs()[e].childs().showValues),
            T = w.childs().percentWidth,
            E = w.childs().direction,
            S = f.map(e => v.childs()[e].childs().valuesColor),
            _ = null === (e = y.childs()) || void 0 === e ? void 0 : e.vahLines,
            k = null === (t = p.graphics.horizlines) || void 0 === t ? void 0 : t.vahLines,
            x = null === (n = y.childs()) || void 0 === n ? void 0 : n.valLines,
            L = null === (s = p.graphics.horizlines) || void 0 === s ? void 0 : s.valLines,
            I = y.childs().pocLines,
            M = (0, r.ensureDefined)(
              null === (a = p.graphics.horizlines) || void 0 === a ? void 0 : a.pocLines,
            ),
            V = u.childs().developingPoc,
            A = new ae.StudyPlotVisibleProperty(V.childs().display),
            W = (0, r.ensureDefined)(
              null === (c = p.styles) || void 0 === c ? void 0 : c.developingPoc,
            ),
            B = u.childs().developingVAHigh,
            z = new ae.StudyPlotVisibleProperty(B.childs().display),
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                re.PropertyTable.Cell,
                { placement: 'first' },
                o.createElement('div', { className: te.childRowContainer }, It),
              ),
              o.createElement(
                re.PropertyTable.Cell,
                {
            ...
            o.createElement(
              ...
              o.createElement(
                re.PropertyTable.Cell,
                { placement: 'first' },
                o.createElement('div', { className: te.childRowContainer }, St),
              ),
              o.createElement(
                re.PropertyTable.Cell,
                { placement: 'last' },
                    ...
                    return o.createElement(
                      N.InputRow,
                      {
                        ...
                        label: o.createElement(
                          'div',
                          { className: te.childRowContainer },
                          (r && i.t(r.titles[n], { context: 'input' }, l(788601))) || '',
                        ),
                      },
                      o.createElement(ee.ColorWithThicknessSelect, {
                        disabled: !P.value(),
            ...
            V &&
              o.createElement(
                ...
                {
                  id: 'developingPoc',
                  title: (W.title && i.t(W.title, { context: 'input' }, l(788601))) || '',
            ...
            B &&
              ...
              o.createElement(
                ye,
                {
                  id: 'developingPoc',
                  title: Dt,
                  color: [B.childs().color, F.childs().color],
                  visible: [z, H],
                  thickness: [B.childs().linewidth, F.childs().linewidth],
                },
                o.createElement(Xe, {
                  id: 'developing-VA-line-style-select',
                  disabled: !z.value() && !H.value(),
                  className: te.smallStyleControl,
                  lineStyle: [B.childs().linestyle, F.childs().linestyle],
                }),
              ),
            g &&
              o.createElement(
              ...
              o.createElement(
                ...
                h &&
                  o.createElement(
                    re.PropertyTable.Cell,
                    { placement: 'first', colSpan: 2 },
                    o.createElement(R, { id: 'showLabelsOnPriceScale', title: Vt, visible: h }),
                  ),
                m &&
                  o.createElement(
                    re.PropertyTable.Cell,
                    { placement: 'first', colSpan: 2 },
                    o.createElement(R, { id: 'showLegendValues', title: Mt, visible: m }),
                  ),
              ),
          );
        }
        _setHhistsProperty(e, t) {
          ...
          for (let n = 0; n < s.length; n++) {
            const o = i.childs()[s[n]].child(e);
            l((0, r.ensureDefined)(o), t, kt);
          }
        }
      }
      function Nt() {
        const e = (0, r.ensureNotNull)((0, o.useContext)(ve)),
          t = e.metaInfo(),
          l = e.properties();
        return o.createElement(Rt, { metaInfo: t, property: l });
      }
      Rt.contextType = I.StylePropertyContext;
      var At = l(947901);
      const Wt = {
        VbPFixed: Nt,
        PivotPointsStandard: function () {
          const e = (0, r.ensureNotNull)((0, o.useContext)(ve)).properties();
          return o.createElement(Et, { property: e });
        },
        VbPVisible: Nt,
        VbPAnchored: Nt,
      };
      class Bt extends o.PureComponent {
        render() {
          const e = (0, r.ensureNotNull)(this.context);
          return o.createElement(ve.Consumer, null, t =>
            o.createElement(
              I.StylePropertyContainer,
              { property: (0, r.ensureNotNull)(t).properties(), model: e },
              o.createElement(
                re.PropertyTable,
                null,
                this._renderCustomContent((0, r.ensureNotNull)(t).metaInfo().shortId),
              ),
            ),
          );
        }
      ...
      Bt.contextType = At.ModelContext;
      var zt = l(66247);
      const Ft = new s.TranslatedString('change precision', i.t(null, void 0, l(900164))),
        Ht = i.t(null, void 0, l(204329)),
        Gt = i.t(null, void 0, l(173947)),
        Ot = [{ value: 'default', content: Ht }];
      for (let e = 0; e <= 8; e++) Ot.push({ value: e, content: e.toString() });
      class Ut extends o.PureComponent {
        constructor() {
          super(...arguments),
            (this._onChange = e => {
      ...
      Ut.contextType = I.StylePropertyContext;
      const jt = new s.TranslatedString('change min tick', i.t(null, void 0, l(320834))),
      ...
      $t.contextType = I.StylePropertyContext;
      var Xt = l(39290),
        Yt = l(852830);
      class Jt extends o.PureComponent {
        render() {
          const {
            id: e,
            isRGB: t,
          ...
          return o.createElement(
            N.InputRow,
            {
              label: c ? o.createElement(R, { id: e, title: l, visible: n }) : l,
              offset: p,
              grouped: d,
            },
            t
              ...
              : o.createElement(
                  ...
                  r &&
                    o.createElement(
                      'div',
                      { className: Ce()(r && i && te.additionalSelect) },
                      o.createElement(ee.ColorWithThicknessSelect, {
                        disabled: n && !(Array.isArray(n) ? n[0].value() : n.value()),
                        color: r,
                        transparency: s,
      ...
      Jt.contextType = I.StylePropertyContext;
      ...
      class ol extends o.PureComponent {
        constructor() {
          super(...arguments),
        ...
        render() {
          const { study: e } = this.props,
            t = e.metaInfo();
          if ((0, zt.isCustomStudy)(t.shortId)) return o.createElement(Bt, null);
          ...
          return o.createElement(
            ...
            u &&
              o.createElement($t, { id: (0, k.createDomId)(t.id, 'min-tick-select'), minTick: i }),
            L.StudyMetaInfo.isScriptStrategy(t) && o.createElement(et, { orders: r.orders }),
            (d || p) &&
              o.createElement(
                re.PropertyTable.Row,
                null,
                o.createElement(re.PropertyTable.GroupSeparator, { size: 1 }),
                o.createElement(Yt.GroupTitleSection, { title: nl, name: nl }),
                d &&
                  o.createElement(Ut, {
                ...
                p &&
                  o.createElement(
                    ...
                    o.createElement(
                      re.PropertyTable.Cell,
                      { placement: 'first', colSpan: 2 },
                      o.createElement(R, { id: 'showLabelsOnPriceScale', title: ll, visible: s }),
                    ),
                    o.createElement(
                      re.PropertyTable.Cell,
                      { placement: 'first', colSpan: 2 },
                      o.createElement(R, { id: 'showLegendValues', title: tl, visible: a }),
                    ),
                  ),
              ),
          );
        ...
        _plotsElement() {
          ...
          return new S.MetaInfoHelper(t)
            ...
            .map(t => {
              ...
              return o.createElement(Qe, { key: t.id, plot: t, palettes: n, study: e });
            });
        }
        _bandsElement() {
          const { study: e } = this.props,
          ...
          return (
            ...
            t.map((e, t) => {
              if (!e.isHidden)
                return o.createElement(Je, { key: t, id: e.name, name: e.name, property: l[t] });
            })
          );
        }
                ...
                if (l.hasChild('fillType') && 'gradient' === l.childs().fillType.value()) {
                  ...
                  if (t.palette) {
                    const e = this._findPalettesByTargetId(t.id),
                      n = (0, r.ensureDefined)(e.main),
                      i = e.secondary;
                    return o.createElement(se, {
                      key: t.id,
                      title: t.title,
                      area: t,
                      palette: (0, r.ensureDefined)(n.palette),
                      paletteProps: (0, r.ensureDefined)(n.paletteProps),
                      secondaryPalette: null == i ? void 0 : i.palette,
                      secondaryPaletteProps: null == i ? void 0 : i.paletteProps,
                      styleProp: l,
                    });
                  }
                  return null;
        ...
        _graphicsElement() {
          ...
          return (
            t &&
            Object.keys(t).map((t, l) => o.createElement(vt, { key: t, graphicType: t, study: e }))
          );
        }
        _findPalettesByTargetId(e) {
          const { study: t } = this.props,
            ...
            i = {};
          for (const l of n) {
            if (((0, x.isPaletteColorerPlot)(l) || (0, x.isOhlcColorerPlot)(l)) && l.target === e) {
              if (i.main) {
                i.secondary = {
                  palette: o[l.palette],
              ...
              i.main = { palette: o[l.palette], paletteProps: t.properties().palettes[l.palette] };
            }
            (0, x.isUpColorerPlot)(l) &&
              l.target === e &&
              (i.up = { palette: o[l.palette], paletteProps: t.properties().palettes[l.palette] }),
      ...
      function rl(e) {
        return (0, I.bindPropertyContext)(ol, { ...e, property: e.study.properties() });
      }
      class il extends o.PureComponent {
        render() {
          return o.createElement(
            At.ModelContext.Provider,
            { value: this.props.model },
            o.createElement(
              ve.Provider,
              { value: this.props.source },
              o.createElement(rl, { study: this.props.source }),
            ),
          );
        }
      }
      ...
      class dl extends al.DialogRenderer {
        ...
        show(e = {}) {
          ...
          const r = this._source.metaInfo();
          if (
            ((0, f.isLineTool)(this._source) &&
              (0, u.trackEvent)('GUI', 'Drawing Properties', this._source.name()),
          ...
          let s = [];
          const h = new S.MetaInfoHelper(r);
          h.hasUserEditableInputs() &&
            s.push({ id: 'inputs', label: i.t(null, void 0, l(666304)), Component: _ }),
            h.hasUserEditableProperties(),
            h.hasUserEditableStyles() &&
              s.push({ id: 'style', label: i.t(null, void 0, l(832733)), Component: il }),
            this._propertyPages ||
              s.push({
                id: 'visibilities',
          ...
          const m = e.initialTab || c.getValue(this._activeTabSettingsName()) || 'inputs';
          let v = (0, a.clean)(r.shortDescription, !0);
          const y = null !== (t = s.find(e => e.id === m)) && void 0 !== t ? t : s[0];
          n.render(
            o.createElement(T, {
              title: v,
              model: this._model,
        ...
        _getPagesForStudyLineTool(e) {
          if (this._propertyPages) {
            ...
            return [...e, ...t.map(e => ({ id: e.id, label: e.title, page: e }))];
          }
          return e;
        }
    ...
    674609: (e, t, l) => {
      ...
      const u = {
        ...
        saveAsDefault: s.t(null, void 0, l(418229)),
        defaults: s.t(null, void 0, l(698938)),
      };
      class h extends n.PureComponent {
        ...
        _getPlaceHolderItem(e) {
          return e
            ? n.createElement(i.Icon, { className: d.defaultsButtonIcon, icon: p })
            : u.defaults;
        }
      }
    },
    944316: (e, t, l) => {
      ...
      function m(e) {
        return e.isTabletWidth
          ? n.createElement(c.Icon, { className: u.themesButtonIcon, icon: h })
          : n.createElement(n.Fragment, null, s.t(null, void 0, l(419611)));
      }
      function v(e) {
        return n.createElement(d.MatchMedia, { rule: 'screen and (max-width: 768px)' }, t =>
          n.createElement(
            p.ControlDisclosure,
            {
              className: !t && u.themesButtonText,
              hideArrowButton: t,
              buttonChildren: n.createElement(m, { isTabletWidth: t }),
            },
            e.children,
          ),
        );
      ...
      var y = l(192063),
        ...
        f = l(972535);
      function w(e) {
        const { name: t, onRemove: l, onClick: o } = e,
          [r, i] = (0, b.useHover)(),
          s = n.useCallback(() => o(t), [o, t]),
          a = n.useCallback(() => {
            l && l(t);
          }, [l, t]);
        return n.createElement(
          'div',
          { ...i },
          n.createElement(y.PopupMenuItem, {
            className: u.defaultsButtonItem,
            isActive: !1,
            label: t,
            onClick: s,
            toolbox:
              l && n.createElement(g.RemoveButton, { hidden: !f.mobiletouch && !r, onClick: a }),
          }),
        );
      }
      var P = l(917850),
      ...
      const k = (0, o.connect)(
        function (e, t) {
          return { templates: e.templates[t.toolName] };
        },
        function (e, t) {
          const { toolName: l, applyTemplate: n, getSourceTemplate: o } = t;
          return {
            getTemplates: () => e((0, _.getTemplates)(l)),
            loadTemplate: n ? t => e((0, _.loadTemplate)(l, t, n)) : void 0,
            removeTemplate: t => e((0, _.startRemoveTemplate)(l, t)),
            saveTemplate: o ? t => e((0, _.saveTemplate)(l, t, JSON.stringify(o()))) : void 0,
          };
        },
      )(function (e) {
        const {
          ...
          c = (0, n.useContext)(T.SlotContext);
        return (
          (0, n.useEffect)(() => {
            a && !t && o();
          }, [t, o, a]),
          n.createElement(
            ...
            i &&
              n.createElement(w, {
                onClick: function () {
                  window.runOrSignIn(
                    () => {
                      (0, C.showRename)(
                        {
                          title: s.t(null, void 0, l(504315)),
                          text: s.t(null, void 0, l(350912)) + ':',
                          maxLength: 64,
                          source: t || [],
                          ...
                          onRename: ({
                            ...
                            var a;
                            if (t && -1 !== t.indexOf(n)) {
                              const t = s.t(null, void 0, l(572405)).format({ name: n });
                              (0, C.showConfirm)(
                                {
                                  text: t,
                                  onConfirm: ({ dialogClose: t }) => {
                                    var l;
                                    null === (l = e.saveTemplate) || void 0 === l || l.call(e, n),
                                      t(),
                                      r();
                                  },
                                  onClose: o,
                              ...
                              null === (a = e.saveTemplate) || void 0 === a || a.call(e, n), r();
                          },
                        },
                        c,
                      );
                ...
                name: (0, E.appendEllipsis)(s.t(null, void 0, l(309908))),
              }),
            n.createElement(w, { onClick: r, name: s.t(null, void 0, l(473169)) }),
            a &&
              t &&
              t.length > 0 &&
              n.createElement(
                n.Fragment,
                null,
                n.createElement(P.PopupMenuSeparator, null),
                t.map(e => n.createElement(w, { key: e, name: e, onRemove: p, onClick: d })),
              ),
          )
        );
        function p(t) {
          window.runOrSignIn(
            () => {
              const n = s.t(null, void 0, l(506705)).format({ name: t });
              (0, C.showConfirm)(
                {
                  text: n,
                  onConfirm: ({ dialogClose: l }) => {
                    e.removeTemplate(t), l();
                  },
                },
                c,
              );
        ...
        function d(t) {
          var l;
          null === (l = e.loadTemplate) || void 0 === l || l.call(e, t);
        }
      });
      const x = new a.TranslatedString('apply drawing template', s.t(null, void 0, l(349037))),
        L = new a.TranslatedString('apply drawing template', s.t(null, void 0, l(349037)));
      function I(e) {
        const { sources: t, chartUndoModel: l } = e,
          o = (0, n.useMemo)(() => t.every(e => e.toolname === t[0].toolname), [t]);
        return n.createElement(k, {
          ...
          applyTemplate: o
            ? function (e) {
                1 === t.length
                  ? l.applyLineToolTemplate(t[0], e, x)
                  : (l.beginUndoMacro(L),
                    t.forEach(t => {
                      l.applyLineToolTemplate(t, e, null);
                    }),
                    l.endUndoMacro());
              }
            : void 0,
      ...
      function M(e) {
        return (0, r.onWidget)()
          ? n.createElement(D, { ...e })
          : n.createElement(o.Provider, { store: i.store }, n.createElement(I, { ...e }));
      }
    },
    380865: (e, t, l) => {
      'use strict';
          ...
          n.createElement(
            ...
            t &&
              n.createElement(
                ...
                t.definitions
                  .value()
                  .map(e => n.createElement(a.Section, { key: e.id, definition: e })),
              ),
          ),
        );
      }
    ...
    321659: (e, t, l) => {
      'use strict';
      l.d(t, { DEFAULT_MENU_ITEM_SWITCHER_THEME: () => m, MenuItemSwitcher: () => v });
      var n = l(50959),
        o = l(497754),
        r = l.n(o),
        i = l(234539),
      ...
      function v(e) {
        const {
          ...
          f = r()(y.label, l && !c && y.labelOn),
          w = r()(t, y.wrapper, l && y.wrapperWithOnLabel, s && y.wrapperWithDescription);
        return n.createElement(
          'label',
          { className: r()(w, b && y.withIcon), htmlFor: o, ref: m },
          void 0 !== b && n.createElement(d.Icon, { className: y.icon, icon: b }),
          n.createElement(
            'div',
            { className: y.labelRow },
            n.createElement('div', { className: f }, i),
    ...
    98361: (e, t, l) => {
      ...
      var n = l(650802);
      function o(e, t, l, o = null) {
        var r;
        const i = {
          id: t,
          title: l,
          definitions: new n.WatchedValue(e.definitions),
          visible: null !== (r = e.visible) && void 0 !== r ? r : new n.WatchedValue(!0).readonly(),
        };
        return null !== o && (i.icon = o), i;
      }
    },
    412548: (e, t, l) => {
      'use strict';
      ...
      const d = new o.TranslatedString(
        ...
        h = new o.TranslatedString('change {title} seconds from', n.t(null, void 0, l(602822))),
        m = new o.TranslatedString('change {title} seconds to', n.t(null, void 0, l(566161))),
        v = new o.TranslatedString(
          'change {title} visibility on minutes',
          n.t(null, void 0, l(64370)),
        ),
        y = new o.TranslatedString('change {title} minutes from', n.t(null, void 0, l(715106))),
        g = new o.TranslatedString('change {title} minutes to', n.t(null, void 0, l(891633))),
        b = new o.TranslatedString(
          'change {title} visibility on hours',
          n.t(null, void 0, l(468971)),
        ),
        f = new o.TranslatedString('change {title} hours from', n.t(null, void 0, l(435388))),
        w = new o.TranslatedString('change {title} hours to', n.t(null, void 0, l(478586))),
        P = new o.TranslatedString(
          'change {title} visibility on days',
          n.t(null, void 0, l(229088)),
        ),
        C = new o.TranslatedString('change {title} days from', n.t(null, void 0, l(541377))),
        T = new o.TranslatedString('change {title} days to', n.t(null, void 0, l(713355))),
        E = new o.TranslatedString(
          'change {title} visibility on weeks',
          n.t(null, void 0, l(324941)),
        ),
        S = new o.TranslatedString('change {title} weeks from', n.t(null, void 0, l(21339))),
        _ = new o.TranslatedString('change {title} weeks to', n.t(null, void 0, l(468643))),
        k = new o.TranslatedString(
          'change {title} visibility on months',
          n.t(null, void 0, l(606659)),
        ),
        x = new o.TranslatedString('change {title} months from', n.t(null, void 0, l(459635))),
        L = new o.TranslatedString('change {title} months to', n.t(null, void 0, l(974266))),
        I =
          (new o.TranslatedString(
            'change {title} visibility on ranges',
            n.t(null, void 0, l(229091)),
          ),
          n.t(null, void 0, l(130973))),
        D = n.t(null, void 0, l(371129)),
        M = n.t(null, void 0, l(928134)),
        V = n.t(null, void 0, l(463099)),
        R = n.t(null, void 0, l(422192)),
        N = n.t(null, void 0, l(621594)),
        A = n.t(null, void 0, l(695543)),
        W =
          (n.t(null, void 0, l(686672)),
          new o.TranslatedString('ticks', n.t(null, void 0, l(659523)))),
        B = new o.TranslatedString('seconds', n.t(null, void 0, l(132925))),
        z = new o.TranslatedString('seconds from', n.t(null, void 0, l(706049))),
        F = new o.TranslatedString('seconds to', n.t(null, void 0, l(939017))),
        H = new o.TranslatedString('minutes', n.t(null, void 0, l(516465))),
        G = new o.TranslatedString('minutes from', n.t(null, void 0, l(425586))),
        O = new o.TranslatedString('minutes to', n.t(null, void 0, l(872317))),
        U = new o.TranslatedString('hours', n.t(null, void 0, l(903143))),
        j = new o.TranslatedString('hours from', n.t(null, void 0, l(84775))),
        Q = new o.TranslatedString('hours to', n.t(null, void 0, l(711255))),
        Z = new o.TranslatedString('days', n.t(null, void 0, l(282211))),
        q = new o.TranslatedString('days from', n.t(null, void 0, l(914077))),
        K = new o.TranslatedString('days to', n.t(null, void 0, l(133486))),
        $ = new o.TranslatedString('weeks', n.t(null, void 0, l(193016))),
        X = new o.TranslatedString('weeks from', n.t(null, void 0, l(32002))),
        Y = new o.TranslatedString('weeks to', n.t(null, void 0, l(428091))),
        J = new o.TranslatedString('months', n.t(null, void 0, l(58964))),
        ee = new o.TranslatedString('months from', n.t(null, void 0, l(671770))),
        te = new o.TranslatedString('months to', n.t(null, void 0, l(737179))),
        le = (new o.TranslatedString('ranges', n.t(null, void 0, l(413604))), [1, 59]),
        ne = [1, 59],
        oe = [1, 24],
        re = [1, 366],
        ie = [1, 52],
      ...
      function ae(e, t, l) {
        ...
        if (r.enabled('tick_resolution')) {
          const o = (0, i.createCheckablePropertyDefinition)(
            { checked: (0, i.convertToDefinitionProperty)(e, t.ticks, d.format({ title: l })) },
            { id: 'IntervalsVisibilitiesTicks', title: I },
          );
          n.push(o);
        }
        if ((0, a.isSecondsEnabled)()) {
          const o = (0, i.createRangePropertyDefinition)(
            {
              checked: (0, i.convertToDefinitionProperty)(e, t.seconds, u.format({ title: l })),
              from: (0, i.convertToDefinitionProperty)(e, t.secondsFrom, h.format({ title: l })),
              to: (0, i.convertToDefinitionProperty)(e, t.secondsTo, m.format({ title: l })),
            },
            {
        ...
        const o = (0, i.createRangePropertyDefinition)(
            {
              checked: (0, i.convertToDefinitionProperty)(e, t.minutes, v.format({ title: l })),
              from: (0, i.convertToDefinitionProperty)(e, t.minutesFrom, y.format({ title: l })),
              to: (0, i.convertToDefinitionProperty)(e, t.minutesTo, g.format({ title: l })),
            },
            {
          ...
          c = (0, i.createRangePropertyDefinition)(
            {
              checked: (0, i.convertToDefinitionProperty)(e, t.hours, b.format({ title: l })),
              from: (0, i.convertToDefinitionProperty)(e, t.hoursFrom, f.format({ title: l })),
              to: (0, i.convertToDefinitionProperty)(e, t.hoursTo, w.format({ title: l })),
            },
            {
          ...
          p = (0, i.createRangePropertyDefinition)(
            {
              checked: (0, i.convertToDefinitionProperty)(e, t.days, P.format({ title: l })),
              from: (0, i.convertToDefinitionProperty)(e, t.daysFrom, C.format({ title: l })),
              to: (0, i.convertToDefinitionProperty)(e, t.daysTo, T.format({ title: l })),
            },
            {
        ...
        const W = (0, i.createRangePropertyDefinition)(
            {
              checked: (0, i.convertToDefinitionProperty)(e, t.weeks, E.format({ title: l })),
              from: (0, i.convertToDefinitionProperty)(e, t.weeksFrom, S.format({ title: l })),
              to: (0, i.convertToDefinitionProperty)(e, t.weeksTo, _.format({ title: l })),
            },
            {
          ...
          B = (0, i.createRangePropertyDefinition)(
            {
              checked: (0, i.convertToDefinitionProperty)(e, t.months, k.format({ title: l })),
              from: (0, i.convertToDefinitionProperty)(e, t.monthsFrom, x.format({ title: l })),
              to: (0, i.convertToDefinitionProperty)(e, t.monthsTo, L.format({ title: l })),
            },
            {
        ...
        return n.push(W, B), { definitions: n };
      }
      function ce(e, t) {
        const l = [];
        if (r.enabled('tick_resolution')) {
    ...
    855342: (e, t, l) => {
      ...
      var n = l(765827);
      function o(e, t) {
        return { type: n.GET_TEMPLATES, toolName: e, callback: t };
      }
      function r(e, t) {
        return { type: n.SET_TEMPLATES, templates: t, toolName: e };
      }
      function i(e, t) {
        return { type: n.ADD_TEMPLATE, templateName: t, toolName: e };
      }
      function s(e, t) {
        return { type: n.START_REMOVE_TEMPLATE, templateName: t, toolName: e };
      }
      function a(e, t) {
        return { type: n.REMOVE_TEMPLATE, templateName: t, toolName: e };
      }
      function c(e, t, l) {
        return { type: n.SAVE_TEMPLATE, templateName: t, toolName: e, content: l };
      }
      function p(e, t, l) {
        return { type: n.LOAD_TEMPLATE, toolName: e, templateName: t, callback: l };
      }
    },
    765827: (e, t, l) => {
      'use strict';
      ...
      l.d(t, {
        ...
        SAVE_TEMPLATE: () => a,
        SET_TEMPLATES: () => r,
        START_REMOVE_TEMPLATE: () => i,
      });
      const o = n('GET_TEMPLATES'),
        r = n('SET_TEMPLATES'),
        i = n('START_REMOVE_TEMPLATE'),
        s = n('REMOVE_TEMPLATE'),
        a = n('SAVE_TEMPLATE'),
        c = n('ADD_TEMPLATE'),
        p = n('LOAD_TEMPLATE');
    ...
    986661: (e, t, l) => {
      ...
      var d = l(362830);
      const u = (0, a.getLogger)('Chart.LineToolTemplatesList');
      function h(e, t) {
        return t;
      }
      function* m() {
        for (;;) {
          const {
            ...
            templateName: t,
            content: l,
          } = h(s.SAVE_TEMPLATE, yield (0, r.take)(s.SAVE_TEMPLATE));
          try {
            yield (0, r.call)(d.backend.saveDrawingTemplate, e, t, l),
      ...
      function* v() {
        for (;;) {
          const { toolName: e, templateName: t } = h(
            s.START_REMOVE_TEMPLATE,
            yield (0, r.take)(s.START_REMOVE_TEMPLATE),
          );
          try {
      ...
      function* y() {
        const e = new Map();
        for (;;) {
          const { toolName: l, callback: n } = h(
            s.GET_TEMPLATES,
            yield (0, r.take)(s.GET_TEMPLATES),
          );
          e.has(l)
            ? (0, i.ensureDefined)(e.get(l)).push(n)
            : (e.set(l, [n]), yield (0, r.fork)(t, l));
        }
        function* t(t) {
          try {
            const e = p(
          ...
          (0, i.ensureDefined)(e.get(t)).forEach(e => (null == e ? void 0 : e())), e.delete(t);
        }
      }
      function* g() {
        for (;;) {
          const {
            ...
            templateName: t,
            callback: l,
          } = h(s.LOAD_TEMPLATE, yield (0, r.take)(s.LOAD_TEMPLATE));
          try {
            const n = p(
      ...
      function* b() {
        yield (0, r.all)([(0, r.call)(y), (0, r.call)(m), (0, r.call)(v), (0, r.call)(g)]);
      }
      const f = { templates: {} };
      function w(e, t) {
      ...
      function P(e = f, t) {
        switch (t.type) {
          case s.ADD_TEMPLATE: {
            const { toolName: l, templateName: n } = t;
            if (!e.templates[l].includes(n)) {
              const t = [...e.templates[l], n].sort(w);
              return { ...e, templates: { ...e.templates, [l]: t } };
            }
            return e;
          }
          case s.SET_TEMPLATES: {
            const { toolName: l, templates: n } = t;
            return { ...e, templates: { ...e.templates, [l]: [...n].sort(w) } };
          }
          case s.REMOVE_TEMPLATE: {
            const { toolName: l, templateName: n } = t;
            return {
              ...e,
              templates: { ...e.templates, [l]: e.templates[l].filter(e => e !== n) },
            };
          }
          default:
            return e;
      ...
      const C = (function () {
        const e = (0, o.default)(),
          t = (0, n.createStore)(P, (0, n.applyMiddleware)(e));
        return e.run(b), t;
      })();
    },
    770366: (e, t, l) => {
      ...
      class c extends s() {
        ...
        unsubscribe(e, t) {
          ...
          const o = (0, n.ensureDefined)(
            null === (l = this._listenersMappers.find(l => l.obj === e && l.method === t)) ||
              void 0 === l
              ? void 0
              : l.callback,
          );
    ...
    410890: (e, t, l) => {
      'use strict';
      l.d(t, { StudyPlotVisibleProperty: () => r });
      var n = l(300962),
        o = l(466052);
      class r {
        constructor(e) {
          (this._subscribers = new o.Delegate()),
            ...
            this._displayProperty.subscribe(this, this._displayPropertyValueChanged);
        }
        destroy() {
          this._displayProperty.unsubscribe(this, this._displayPropertyValueChanged),
