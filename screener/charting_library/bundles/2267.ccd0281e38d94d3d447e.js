  ...
  [2267, 959, 6437],
  {
    259142: function (o, e) {
      ...
      (i = [e]),
          ...
          (o.disableBodyScroll = function (o, i) {
            if (n) {
              ...
              if (
                ...
                var u = { targetElement: o, options: i || {} };
                (t = [].concat(e(t), [u])),
                  ...
                  (o.ontouchmove = function (e) {
                    ...
                    1 === e.targetTouches.length &&
                      ((i = o),
                      (t = (l = e).targetTouches[0].clientY - r),
                      !d(l.target) &&
                        ((i && 0 === i.scrollTop && 0 < t) ||
                        ((n = i) && n.scrollHeight - n.scrollTop <= n.clientHeight && t < 0)
                          ? T(l)
                          : l.stopPropagation()));
                  }),
                  a ||
                    (document.addEventListener('touchmove', T, l ? { passive: !1 } : void 0),
                    (a = !0));
              }
            } else {
              (m = i),
            ...
            (o.clearAllBodyScrollLocks = function () {
              n
                ? (t.forEach(function (o) {
                  ...
                  a &&
                    (document.removeEventListener('touchmove', T, l ? { passive: !1 } : void 0),
                    (a = !1)),
                  (t = []),
                  (r = -1))
                : (u(), (t = []));
            ...
            (o.enableBodyScroll = function (o) {
              if (n) {
                ...
                1 === t.length && t[0].targetElement === o
                  ? (u(), (t = []))
                  : (t = t.filter(function (e) {
                      return e.targetElement !== o;
                    }));
        ...
        void 0 === (n = 'function' == typeof l ? l.apply(e, i) : l) || (o.exports = n);
    },
    488803: o => {
      o.exports = {
    ...
    72571: (o, e, l) => {
      ...
      l.d(e, { Icon: () => n });
      var i = l(50959);
      const n = i.forwardRef((o, e) => {
        const { icon: l = '', ...n } = o;
        return i.createElement('span', { ...n, ref: e, dangerouslySetInnerHTML: { __html: l } });
      });
    },
    111706: (o, e, l) => {
      'use strict';
    ...
    577687: (o, e, l) => {
      ...
      var i = l(509806),
        ...
        s = l(648010),
        c = l(214877);
      const d = { add: i.t(null, void 0, l(44629)), remove: i.t(null, void 0, l(572482)) };
      function T(o) {
        const { className: e, isFilled: l, isActive: i, onClick: T, ...u } = o;
        return n.createElement(a.Icon, {
          ...u,
          className: t(c.favorite, 'apply-common-tooltip', l && c.checked, i && c.active, e),
          icon: l ? r : s,
          onClick: T,
    ...
    695257: (o, e) => {
      ...
      var m = {
        ...
        L = {};
      function f(o, e, l) {
        (this.props = o), (this.context = e), (this.refs = L), (this.updater = l || m);
      }
      function g() {}
      function z(o, e, l) {
        (this.props = o), (this.context = e), (this.refs = L), (this.updater = l || m);
      ...
      (f.prototype.isReactComponent = {}),
        (f.prototype.setState = function (o, e) {
      ...
      var w = (z.prototype = new g());
      (w.constructor = z), v(w, f.prototype), (w.isPureReactComponent = !0);
      var p = Array.isArray,
      ...
      function I(o, e, i) {
        var n,
          ...
          r = null;
        if (null != e)
          for (n in (void 0 !== e.ref && (r = e.ref), void 0 !== e.key && (a = '' + e.key), e))
            N.call(e, n) && !b.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        if (o && o.defaultProps) for (n in (s = o.defaultProps)) void 0 === t[n] && (t[n] = s[n]);
        return { $$typeof: l, type: o, key: a, ref: r, props: t, _owner: y.current };
      }
      function x(o) {
        return 'object' == typeof o && null !== o && o.$$typeof === l;
      }
      var A = /\/+/g;
      function M(o, e) {
        ...
        if (((s = 0), (t = '' === t ? '.' : t + ':'), p(o)))
          ...
          ((d = (function (o) {
            return null === o || 'object' != typeof o
              ? null
              : 'function' == typeof (o = (h && o[h]) || o['@@iterator'])
              ? o
              : null;
          })(o)),
          'function' == typeof d)
        )
          for (o = d.call(o), c = 0; !(r = o.next()).done; )
            s += C((r = r.value), e, n, (d = t + M(r, c++)), a);
        else if ('object' === r)
          throw (
            ((e = String(o)),
            Error(
      ...
      function P(o) {
        if (-1 === o._status) {
          ...
          (e = e()).then(
            function (e) {
              (0 !== o._status && -1 !== o._status) || ((o._status = 1), (o._result = e));
            },
            function (e) {
              (0 !== o._status && -1 !== o._status) || ((o._status = 2), (o._result = e));
            },
          ),
            -1 === o._status && ((o._status = 0), (o._result = e));
        }
      ...
      var k = { current: null },
        R = { transition: null },
        E = { ReactCurrentDispatcher: k, ReactCurrentBatchConfig: R, ReactCurrentOwner: y };
      (e.Children = {
        map: S,
        forEach: function (o, e, l) {
          S(
            o,
            function () {
        ...
        (e.cloneElement = function (o, e, i) {
          ...
          if (null != e) {
            if (
              (void 0 !== e.ref && ((a = e.ref), (r = y.current)),
              void 0 !== e.key && (t = '' + e.key),
              o.type && o.type.defaultProps)
            )
              var s = o.type.defaultProps;
            for (c in e)
              N.call(e, c) &&
                !b.hasOwnProperty(c) &&
                (n[c] = void 0 === e[c] && void 0 !== s ? s[c] : e[c]);
          }
          ...
          return { $$typeof: l, type: o.type, key: t, ref: a, props: n, _owner: r };
        }),
        ...
        (e.isValidElement = x),
        (e.lazy = function (o) {
          return { $$typeof: u, _payload: { _status: -1, _result: o }, _init: P };
        }),
        (e.memo = function (o, e) {
          return { $$typeof: T, type: o, compare: void 0 === e ? null : e };
        }),
        ...
        (e.useCallback = function (o, e) {
          return k.current.useCallback(o, e);
        }),
        ...
        (e.useEffect = function (o, e) {
          return k.current.useEffect(o, e);
        }),
        (e.useId = function () {
          return k.current.useId();
        }),
        (e.useImperativeHandle = function (o, e, l) {
          return k.current.useImperativeHandle(o, e, l);
        }),
        (e.useInsertionEffect = function (o, e) {
          return k.current.useInsertionEffect(o, e);
        }),
        (e.useLayoutEffect = function (o, e) {
          return k.current.useLayoutEffect(o, e);
        }),
        (e.useMemo = function (o, e) {
          return k.current.useMemo(o, e);
        }),
        (e.useReducer = function (o, e, l) {
          return k.current.useReducer(o, e, l);
        }),
        (e.useRef = function (o) {
        ...
        (e.useSyncExternalStore = function (o, e, l) {
          return k.current.useSyncExternalStore(o, e, l);
        }),
      ...
      const r = (0, i.forwardRef)((o, e) => {
        ...
        return i.createElement(
          p,
          {
            ...
            className: n(
              ...
              T && r,
              {
                ...
                'common-tooltip-vertical': Boolean(g) && 'vertical' === w,
                [v.isActive]: T,
                [v.isGrayed]: u,
                [v.isHidden]: h,
                [v.isTransparent]: m,
            ...
            onKeyDown: f,
            title: g,
            'data-role': b ? void 0 : 'button',
            ref: e,
            tabIndex: N,
            'data-tooltip-hotkey': z,
            'aria-pressed': b ? T : void 0,
          ...
          i.createElement(
            ...
            d &&
              ('string' == typeof d
                ? i.createElement(t.Icon, { className: v.icon, icon: d })
    ...
    837850: (o, e, l) => {
      ...
      var i = l(509806),
        ...
        r = l(456765),
        s = l(180185);
      const c = (0, s.humanReadableModifiers)(s.Modifiers.Shift, !1),
        d = (0, s.humanReadableModifiers)(s.Modifiers.Alt, !1),
        T = (0, s.humanReadableModifiers)(s.Modifiers.Mod, !1),
        u = { keys: [c], text: i.t(null, void 0, l(240234)) },
        h = { keys: [c], text: i.t(null, void 0, l(468125)) },
        m = { keys: [c], text: i.t(null, void 0, l(481591)) },
        v = {
          ...
          LineToolComment: {
            icon: t.lineToolsIcons.LineToolComment,
          ...
          LineToolGannSquare: {
            ...
            hotKey: (0, n.hotKeySerialize)({ keys: [c], text: i.t(null, void 0, l(510289)) }),
          },
          ...
          LineToolEmoji: {
            icon: t.lineToolsIcons.LineToolEmoji,
          ...
          LineToolPath: {
            icon: t.lineToolsIcons.LineToolPath,
          ...
          LineToolRectangle: {
            ...
            hotKey: (0, n.hotKeySerialize)({ keys: [c], text: i.t(null, void 0, l(481591)) }),
          },
          LineToolCircle: {
            icon: t.lineToolsIcons.LineToolCircle,
          ...
          SyncDrawing: {
            icon: a.drawingToolsIcons.SyncDrawing,
            iconActive: a.drawingToolsIcons.SyncDrawingActive,
            localizedName: i.t(null, void 0, l(736551)),
          },
          arrow: { icon: a.drawingToolsIcons.arrow, localizedName: i.t(null, void 0, l(696237)) },
          cursor: { icon: a.drawingToolsIcons.cursor, localizedName: i.t(null, void 0, l(429908)) },
          dot: { icon: a.drawingToolsIcons.dot, localizedName: i.t(null, void 0, l(860925)) },
          drawginmode: {
            icon: a.drawingToolsIcons.drawginmode,
            iconActive: a.drawingToolsIcons.drawginmodeActive,
            localizedName: i.t(null, void 0, l(749421)),
          },
          eraser: { icon: a.drawingToolsIcons.eraser, localizedName: i.t(null, void 0, l(299289)) },
          group: { icon: a.drawingToolsIcons.group, localizedName: i.t(null, void 0, l(691977)) },
          hideAllDrawings: {
            icon: a.drawingToolsIcons.hideAllDrawings,
            iconActive: a.drawingToolsIcons.hideAllDrawingsActive,
            localizedName: i.t(null, void 0, l(717517)),
            hotKey: (0, n.hotKeySerialize)({ keys: [T, d, 'H'], text: '{0} + {1} + {2}' }),
          },
          lockAllDrawings: {
            icon: a.drawingToolsIcons.lockAllDrawings,
            iconActive: a.drawingToolsIcons.lockAllDrawingsActive,
            localizedName: i.t(null, void 0, l(537057)),
          },
          magnet: {
            icon: a.drawingToolsIcons.magnet,
            localizedName: i.t(null, void 0, l(937140)),
            hotKey: (0, n.hotKeySerialize)({ keys: [T], text: '{0}' }),
          },
          measure: {
            icon: a.drawingToolsIcons.measure,
            localizedName: i.t(null, void 0, l(659607)),
            hotKey: (0, n.hotKeySerialize)({ keys: [c], text: i.t(null, void 0, l(132868)) }),
          },
          removeAllDrawingTools: {
            icon: a.drawingToolsIcons.removeAllDrawingTools,
            localizedName: i.t(null, void 0, l(376091)),
          },
          showObjectsTree: {
            icon: a.drawingToolsIcons.showObjectTree,
            localizedName: i.t(null, void 0, l(551072)),
          },
          zoom: { icon: a.drawingToolsIcons.zoom, localizedName: i.t(null, void 0, l(38925)) },
          'zoom-out': {
            icon: a.drawingToolsIcons['zoom-out'],
            localizedName: i.t(null, void 0, l(949895)),
          },
        };
      v.LineToolGhostFeed = {
    ...
    110495: (o, e, l) => {
      'use strict';
      l.d(e, { LinetoolsFavoritesStore: () => r });
      var i = l(466052),
        n = l(870122);
      ...
      !(function (o) {
        function e() {
          ...
          o.favorites = [];
          let r = !1;
          const s = Boolean(void 0 === (0, n.getValue)('chart.favoriteDrawings')),
            c = (0, n.getJSON)('chart.favoriteDrawings', []);
          if (0 === c.length && s && 'undefined' != typeof window) {
            const o = JSON.parse(
              null !==
                (i = null === (e = window.urlParams) || void 0 === e ? void 0 : e.favorites) &&
                void 0 !== i
                ? i
                : '{}',
            ).drawingTools;
            o && Array.isArray(o) && c.push(...o);
          }
          c.forEach((e, i) => {
            const n = e.tool || e;
            l(n)
        ...
        function a(e) {
          ...
          null !== o.tweetToolPosition && l.splice(o.tweetToolPosition, 0, 'LineToolTweet'),
        ...
        (function (o) {
          function e(o) {
            return a.isValidLineToolName(o);
          }
          function l() {
          ...
          (o.favoriteAdded = new i.Delegate()),
            ...
            (o.favoritesSynced = a.favoritesSynced),
            ...
            (o.favorite = function (o) {
              return o < 0 || o >= l() ? '' : a.favorites[o];
            }),
            (o.addFavorite = function (l, i) {
              return (
                !(n(l) || !e(l)) &&
                (a.favorites.push(l), a.saveFavorites(i), o.favoriteAdded.fire(l), !0)
              );
            }),
            (o.removeFavorite = function (e, l) {
              const i = a.favoriteIndex(e);
              if (-1 === i) return !1;
              a.favorites.splice(i, 1);
              const n = a.tweetToolPosition;
              return (
                null !== n && n > i && (a.tweetToolPosition = n - 1),
                a.saveFavorites(l),
            ...
            (o.isFavorite = n),
            (o.moveFavorite = function (i, n, t) {
              if (n < 0 || n >= l() || !e(i)) return !1;
              const r = a.favoriteIndex(i);
              if (-1 === r || n === r) return !1;
              let s = a.tweetToolPosition;
              return (
                null !== s &&
                  (r < s && n > s ? s-- : n < s && r > s && s++, (a.tweetToolPosition = s)),
                a.favorites.splice(r, 1),
                a.favorites.splice(n, 0, i),
                a.saveFavorites(t),
                o.favoriteMoved.fire(i, r, n),
                !0
              );
            });
        })(r || (r = {}));
