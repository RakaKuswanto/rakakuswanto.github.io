  ...
  [7078],
  {
    259142: function (e, t) {
      ...
      (i = [t]),
                ...
                (l = [].concat(t(l), [h])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ((i = e),
                      (l = (a = t).targetTouches[0].clientY - r),
                      !d(a.target) &&
                        ((i && 0 === i.scrollTop && 0 < l) ||
                        ((n = i) && n.scrollHeight - n.scrollTop <= n.clientHeight && l < 0)
                          ? m(a)
                          : a.stopPropagation()));
                  }),
                  o ||
                    (document.addEventListener('touchmove', m, a ? { passive: !1 } : void 0),
                    (o = !0));
              }
            } else {
              (p = i),
            ...
            (e.clearAllBodyScrollLocks = function () {
              n
                ? (l.forEach(function (e) {
                  ...
                  o &&
                    (document.removeEventListener('touchmove', m, a ? { passive: !1 } : void 0),
                    (o = !1)),
                  (l = []),
                  (r = -1))
                : (h(), (l = []));
        ...
        void 0 === (n = 'function' == typeof a ? a.apply(t, i) : a) || (e.exports = n);
    },
    137463: e => {
    ...
    104502: (e, t, a) => {
      ...
      function d(e) {
        const { mode: t, className: a, ...n } = e,
          { isMobile: o, isTablet: s } = r(t),
          d = l()(c.container, s && c.isTablet, o && c.isMobile, a);
        return i.createElement('div', { ...n, className: d, 'data-role': 'dialog-sidebar' });
      }
      function m(e) {
        return i.createElement('div', { className: c.wrapper, ...e });
      }
      function h(e) {
        const { mode: t, title: a, icon: n, isActive: d, onClick: m, ...h } = e,
          { isMobile: u, isTablet: p } = r(t),
          g = d ? (null == n ? void 0 : n.active) : null == n ? void 0 : n.default;
        return i.createElement(
          'div',
          {
            ...h,
            className: l()(c.tab, p && c.isTablet, u && c.isMobile, d && c.active),
            onClick: m,
          },
          n && i.createElement(o.Icon, { className: c.icon, icon: g }),
          !p &&
            i.createElement(
              'span',
              { className: l()(c.title, !n && c.withoutIcon) },
              i.createElement('span', { className: c.titleText }, a),
              u && i.createElement(o.Icon, { className: c.nested, icon: s }),
            ),
        );
      }
    },
    61358: (e, t, a) => {
      'use strict';
      a.r(t), a.d(t, { GeneralChartPropertiesDialogRenderer: () => ee });
      var i = a(509806),
        n = a(50959),
        l = a(500962),
        o = a(805184),
      ...
      var S = a(630795),
        ...
        E = a(12009);
      function w(e) {
        const { themeName: t, chartWidgetCollection: a, onRemove: i, manager: l } = e,
          [o, r] = (0, L.useHover)(),
          s = n.useCallback(
            () =>
              (function (e, t, a) {
          ...
          c = n.useCallback(() => {
            (0, y.loadTheme)(a, { themeName: t, standardTheme: !1 }).then(() => {
              (0, x.trackEvent)('GUI', 'Switch to custom theme');
            });
          }, [t, a]);
        return n.createElement(
          'div',
          { ...r },
          n.createElement(v.PopupMenuItem, {
            'data-series-theme-item-theme-name': t,
            className: E.defaultsButtonItem,
            isActive: !1,
            label: t,
            onClick: c,
            toolbox: n.createElement(z.RemoveButton, { hidden: !A.mobiletouch && !o, onClick: s }),
          }),
        );
      }
      var D = a(844996);
      const I = i.t(null, void 0, a(419611)),
        M = i.t(null, void 0, a(473169)),
        P = (0, C.appendEllipsis)(i.t(null, void 0, a(309908))),
        j = i.t(null, void 0, a(775819)),
        N = _.enabled('chart_template_storage');
      class B extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleApplyDefaults = () => {
              ...
              const a = (0, y.getCurrentTheme)().name;
              (0, y.loadTheme)(t, {
                themeName: a,
                standardTheme: !0,
                applyOverrides: !0,
                ...
                window.runOrSignIn(
                  () =>
                    (async function (e, t) {
                      ...
                      i.showThemeSaveDialog(e, t, n);
                    })(e.model().theme(), this._syncThemeList),
        ...
        render() {
          return n.createElement(
            S.SlotContext.Consumer,
            null,
            e => (
              (this._manager = e),
              n.createElement(p.MatchMedia, { rule: 'screen and (max-width: 768px)' }, e =>
                n.createElement(
                  b.ControlDisclosure,
                  {
        ...
        _getPlaceHolderItem(e) {
          return e ? n.createElement(g.Icon, { className: E.themesButtonIcon, icon: D }) : I;
        }
        _getThemeItems(e) {
          const {
          ...
          return n.createElement(
            ...
            l.length > 0 &&
              n.createElement(
                n.Fragment,
                null,
                n.createElement(f.PopupMenuSeparator, { key: 'separator' }),
                l.map(e =>
                  n.createElement(w, {
                    key: e,
                    themeName: e,
      ...
      var F = a(462845);
      const K = 'properties_dialog.last_page_id';
      class X extends n.PureComponent {
        constructor(e) {
          ...
          super(e),
            ...
            (this._renderApplyToAllButton = () =>
              n.createElement(p.MatchMedia, { rule: U.DialogBreakpoints.TabletNormal }, e =>
            ...
            (this._onChangeActivePageDefinitions = () => {
              H.logger.logNormal('Definition collection was updated'),
          ...
          let o = null !== (t = l.find(e => e.id === i)) && void 0 !== t ? t : null;
          if (!o) {
            const e = h().getValue(K),
              t = l.find(t => t.id === e);
        ...
        render() {
          ...
          return n.createElement(p.MatchMedia, { rule: U.DialogBreakpoints.TabletSmall }, r =>
            n.createElement(s.AdaptiveConfirmDialog, {
              className: F.withSidebar,
              dataName: 'series-properties-dialog',
              onClose: t,
              isOpened: e,
              title: null !== o && r ? o.title : i.t(null, void 0, a(274207)),
              footerLeftRenderer: this._renderFooterLeft,
              additionalButtons: this._renderApplyToAllButton(),
              additionalHeaderElement:
                null !== o && r ? n.createElement(q, { onClick: this._handleBackClick }) : void 0,
        ...
        _renderTabContent(e) {
          ...
          if (a) {
            ...
            return n.createElement(
              ...
              { className: F.tabContent, onScroll: this._handleScroll },
              n.createElement(
                ...
                n.createElement(
                  ...
                  i.map(e => n.createElement(r.Section, { key: e.id, definition: e })),
                ),
              ),
            );
          }
        ...
        _renderTabs(e) {
          ...
          return n.createElement(p.MatchMedia, { rule: U.DialogBreakpoints.TabletNormal }, e =>
            n.createElement(p.MatchMedia, { rule: U.DialogBreakpoints.TabletSmall }, t => {
              const l = t ? 'mobile' : e ? 'tablet' : void 0;
              return n.createElement(
                V.DialogSidebarContainer,
                { mode: l, onScroll: this._handleScroll },
                a.map(e =>
                  n.createElement(V.DialogSidebarItem, {
                    key: e.id,
                    mode: l,
                    'data-name': e.id,
                    title: e.title,
      ...
      var Z = a(559410),
        J = a(19406),
        Q = a(562051);
      const $ = i.t(null, void 0, a(274207));
      class ee extends J.DialogRenderer {
        constructor(e) {
          super(),
            (this._handleClose = () => {
        ...
        show(e) {
          l.render(
            ...
            Z.emit('edit_object_dialog', {
              objectType: 'mainSeries',
              scriptTitle: this._model.mainSeries().title(Q.TitleDisplayTarget.StatusLine),
            });
        }
        _ensureCheckpoint(e) {
