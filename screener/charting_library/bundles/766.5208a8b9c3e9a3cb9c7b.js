  ...
  [766],
  {
      ...
      class h extends s.PureComponent {
        ...
        render() {
          const {
            ...
            u = o(h, l.dialog, t && l.rounded, e && l.shadowed, i && l.fullscreen, a && l.darker),
          ...
          return s.createElement(
            ...
            s.createElement(n.Slot, { reference: this._handleSlot }),
          );
        }
        _createStyles() {
          const {
          ...
          return { bottom: t, left: e, right: s, top: o, zIndex: n, maxWidth: i, height: a };
        }
      }
    },
    910549: (t, e, i) => {
    ...
    40766: (t, e, i) => {
      ...
      class g {
        ...
        _dragMove(t) {
          if (this._drag) {
            if (((this._drag.finishX = t.x), (this._drag.finishY = t.y), null !== this._frame))
              return;
        ...
        recalculateBounds() {
          ...
          const { clientHeight: e, clientWidth: i } = document.documentElement,
            ...
            o =
              null === (t = this._calculateDialogPosition) || void 0 === t
                ? void 0
                : t.call(this, this._dialog, { clientWidth: i, clientHeight: e }, { vertical: s });
          if (this._isFullscreen) {
            if (
              ...
              (this._dialog.style.transform = `translate(${Math.round(t)}px, ${Math.round(e)}px)`),
                i &&
                  ((this._dialog.style.width = `${i}px`), (this._dialog.style.minWidth = 'unset')),
                s &&
            ...
            const t = this._dialog.getBoundingClientRect(),
              o = e - 2 * s,
              n = d(t.left, t.width, 0, i),
              a = d(t.top, t.height, s, e);
            (this._dialog.style.top = '0px'),
              (this._dialog.style.left = '0px'),
              (this._dialog.style.transform = `translate(${Math.round(n)}px, ${Math.round(a)}px)`),
              (this._dialog.style.height = o < t.height ? o + 'px' : this._initialHeight);
          }
        }
        destroy() {
      ...
      class E extends s.PureComponent {
        ...
        componentDidMount() {
          ...
          if (t) {
            ...
            if (t && t instanceof HTMLElement) {
              const o = new g(s, t, { boundByScreen: Boolean(e), onDragStart: i });
        ...
        componentDidUpdate() {
          if (this._resize) {
            ...
            this._resize.updateOptions({ guard: t, calculateDialogPosition: e }),
              this._resize.setFullscreen(this._isFullScreen());
          }
          this._drag &&
        ...
        componentWillUnmount() {
          ...
          (this._isFullScreen() || this.props.fixedBody) && (0, y.setFixedBodyState)(!1);
        }
        focus() {
        ...
        _applyAppearanceAnimation(t) {
          if (this._resize && this._dialog) {
            ...
            this._dialog.style.setProperty('--animationTranslateStartX', `${e}px`),
              ...
              this._dialog.classList.add(D.dialogAnimatedAppearance);
          }
        }
        _handleTooltipFit() {
          0;
