(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1309],
  {
    ...
    805184: (e, t, s) => {
      ...
      function l(e) {
        const { intent: t, size: s, appearance: n, useFullWidth: r, icon: l, ...u } = e;
        return { ...u, color: i(t), size: a(s), variant: o(n), stretch: r, startIcon: l };
      }
      function u(e) {
    ...
    34735: (e, t, s) => {
      'use strict';
      s.d(t, { ControlSkeleton: () => _, InputClasses: () => g });
      var n = s(50959),
        r = s(497754),
        o = s(650151),
        i = s(525388),
      ...
      function p(e, t, s, n) {
        const {
          ...
          y = d(null != o ? o : (0, u.getGroupCellRemoveRoundBorders)(s));
        return r(
          h().container,
          h()[`container-${c}`],
          h()[`intent-${a}`],
      ...
      function v(e, t) {
        const {
          ...
          P = (function (e, t = null, s) {
            ...
            return (0, n.useEffect)(() => ((o.current = [e, t, s]), i(), a), [e, t, s]), l;
          })('wheel', N, f);
        return n.createElement(
          ...
          S,
          C,
          n.createElement('span', { className: m(e, R, D) }),
        );
      }
      v.displayName = 'ControlSkeleton';
      const _ = n.forwardRef(v);
    },
    102691: (e, t, s) => {
      'use strict';
      s.d(t, {
      ...
      function a(e) {
        ...
        return n.createElement('span', { className: r(i()['before-slot'], t) }, s);
      }
      function l(e) {
        const { className: t, interactive: s = !0, icon: o = !1, children: a } = e;
        return n.createElement(
          'span',
          { className: r(i()['inner-slot'], s && i().interactive, o && i().icon, t) },
          a,
        );
      }
      function u(e) {
      ...
      function h(e) {
        const { className: t, children: s } = e;
        return n.createElement('span', { className: r(i()['after-slot'], t) }, s);
      }
    },
    654936: (e, t, s) => {
      'use strict';
      s.d(t, { InputControl: () => _ });
      var n = s(50959),
        r = s(497754),
        o = s(800417),
        i = s(269842),
      ...
      function v(e) {
        const {
          ...
          H = (0, o.filterProps)(V, f),
          q = {
            ...(0, o.filterAriaProps)(V),
            ...(0, o.filterDataProps)(V),
            id: t,
            title: s,
            role: i,
            tabIndex: a,
      ...
      function _(e) {
        ...
        const {
          ...
          w = t ? void 0 : _ ? -1 : r,
          b = t ? void 0 : _ ? r : -1,
          { isMouseDown: S, handleMouseDown: C, handleMouseUp: E } = (0, h.useIsMouseDown)(),
          ...
          D = (0, i.createSafeMulticastEventHandler)(y.onBlur, d),
          k = (0, n.useCallback)(
            e => {
              (g.current = e),
    ...
    21778: (e, t, s) => {
      ...
      var n = s(269842),
        r = s(383836);
      function o(e) {
        const { onFocus: t, onBlur: s, intent: o, highlight: i, disabled: a } = e,
    ...
    525388: (e, t, s) => {
      'use strict';
      s.d(t, { useMergedRefs: () => o });
      var n = s(50959),
        r = s(273388);
      function o(e) {
        return (0, n.useCallback)((0, r.mergeRefs)(e), e);
      }
    },
    234404: (e, t, s) => {
      'use strict';
    ...
    73007: (e, t, s) => {
      ...
      class m extends r.PureComponent {
        constructor(e) {
          if (
            ...
            (this._handleCaretClick = () => {
              this.state.isOpened
                ? (this._close(), this.props.preventOnFocusOpen && this._focus())
                : this.props.preventOnFocusOpen
                ? this._open()
                : this._focus();
            }),
            (this._handleOutsideClick = () => {
              const { allowUserDefinedValues: e, value: t, onChange: s } = this.props,
            ...
            (this._handleChange = e => {
              ...
              if (t && '' === i)
                this.setState({ queryValue: i, isOpened: !1, active: void 0 }), o && o();
              else {
            ...
            (this._handleItemClick = e => {
              ...
              this.setState({ queryValue: g(this.props.source)[t] }),
            ...
            (this._handleKeyDown = e => {
              if (
                -1 ===
                [c.KeyCode.DownArrow, c.KeyCode.UpArrow, c.KeyCode.Enter, c.KeyCode.Escape].indexOf(
                  e.which,
                )
              )
                return;
              ...
              switch (e.which) {
                ...
                case c.KeyCode.UpArrow:
                  ...
                  if (void 0 === o) {
                    ...
                    h = 0;
                  } else h = u.indexOf(o) + (e.which === c.KeyCode.UpArrow ? -1 : 1);
                ...
                case c.KeyCode.Enter:
                  let m = o;
                  t && (i && m ? this.setState(this._valueToQuery(m)) : (m = a)),
                    void 0 !== m &&
                      (this._close(),
                      i || this._blur(),
                      m !== s ? n && n(m) : this.setState(this._valueToQuery(m)));
              }
            }),
        ...
        componentWillUnmount() {
          this._inputElement &&
            this._inputElement.removeEventListener('keyup', this._handleKeyUpEnter),
        ...
        render() {
          return r.createElement(
            ...
            e =>
              r.createElement(
                'div',
                { className: o(d.autocomplete, 'js-dialog-skip-escape'), ref: e },
                r.createElement(l.InputControl, {
                  ...
                  endSlot: Object.keys(this._suggestions(this.state.queryValue)).length
                    ? r.createElement(
                        ...
                        r.createElement(
                          'span',
                          { className: d.caret, onClick: this._handleCaretClick, tabIndex: -1 },
        ...
        static getDerivedStateFromProps(e, t) {
          ...
          const o = s ? n : '' === n ? '' : g(r)[n] || t.queryValue;
        ...
        _open() {
          ...
          this._focus(), this.setState({ isOpened: !0, active: this.props.value }), e && e();
        }
        _close() {
        ...
        _renderSuggestionsItems() {
          const e = this._suggestions(this.state.queryValue),
            ...
            i = r.createElement('li', { className: d.noResults }, n.t(null, void 0, s(356614)));
        ...
        _valueToQuery(e) {
          return { queryValue: g(this.props.source)[e] || '' };
        }
      }
      function g(e) {
        let t = {};
      ...
      function i(e) {
        ...
        return (
          ((n = class extends r.PureComponent {
            ...
            null !== (s = null !== (t = e.displayName) && void 0 !== t ? t : e.name) && void 0 !== s
              ? s
              : 'Component'
          })`),
          n
