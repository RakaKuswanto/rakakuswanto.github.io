  ...
  [3109],
  {
    ...
    788601: t => {
      (t.exports = Object.create(null)),
        ...
        (t.exports.Minimize_input = ['Свернуть']),
        ...
        (t.exports['Values in status line_input'] = ['Значения в строке статуса']),
        (t.exports['Labels on price scale_input'] = ['Метки на ценовой шкале']),
        (t.exports['Accumulation/Distribution_input'] = ['Накопление/Распределение']),
        ...
        (t.exports['Bollinger Bands Width_input'] = ['Ширина полос Боллинджера']),
        ...
        (t.exports['Detrended Price Oscillator_input'] = ['Детрендовый ценовой осциллятор']),
        ...
        (t.exports['Multi timeframe_input'] = ['Несколько интервалов']),
        (t.exports.Timeframe_input = ['Интервал']),
        (t.exports['Wait for timeframe closes_input'] = ['Дождаться закрытия интервала']),
        ...
        (t.exports['Conversion Line Periods_input'] = ['Периоды Линии переворота']),
        ...
        (t.exports['Use Upper Deviation_input'] = ['Использовать верхнее отклонение']),
        (t.exports['Use Lower Deviation_input'] = ['Использовать нижнее отклонение']),
        ...
        (t.exports['Simple ma(oscillator)_input'] = ['Прост. скольз.сред. (осциллятор)']),
        (t.exports['Simple ma(signal line)_input'] = ['Прост. скольз.сред. (линия сигнала)']),
        ...
        (t.exports['SMI Ergodic Oscillator_input'] = ['Осциллятор SMI Ergodic']),
        ...
        (t.exports['Developing Poc_input'] = ['Динамическая точка контроля (POC)']),
        ...
        (t.exports['Extend to last bar_input'] = ['Продолжить до последнего бара']),
    ...
    168716: t => {
      (t.exports = Object.create(null)),
        ...
        (t.exports['Bull Bear Power_study'] = ['«Сила быков» и «Сила медведей»']),
        (t.exports['Capital expenditures_study'] = ['Капиталовложения']),
        (t.exports['Cash to debt ratio_study'] = ['Денежные средства/Задолженность']),
        (t.exports['Debt to EBITDA ratio_study'] = ['Задолженность/EBITDA']),
        (t.exports['Directional Movement Index_study'] = ['Индекс направленного движения (DMI)']),
        (t.exports.DMI_study = 'DMI'),
        (t.exports['Dividend payout ratio %_study'] = ['Коэффициент выплаты дивиденда %']),
        (t.exports['Equity to assets ratio_study'] = ['Капитал/активы']),
        (t.exports['Enterprise value to EBIT ratio_study'] = ['Стоимость компании/EBIT']),
        (t.exports['Enterprise value to EBITDA ratio_study'] = ['Стоимость компании/EBITDA']),
        (t.exports['Enterprise value to revenue ratio_study'] = ['Стоимость компании/Выручка']),
        ...
        (t.exports['Price to book ratio_study'] = ['Цена/балансовая стоимость']),
        (t.exports['Price to cash flow ratio_study'] = ['Цена/Движение денежных средств']),
        ...
        (t.exports['Volume Weighted Average Price_study'] = ['Средневзвешенная цена объёма']),
        (t.exports['Volume Weighted Moving Average_study'] = [
          'Объёмно-взвешенное скользящее среднее',
        ]),
        (t.exports['Williams Percent Range_study'] = ['Процентный диапазон Вильямса']),
        ...
        (t.exports['Accounts receivables, gross_study'] = ['Дебиторская задолженность, валовая']),
        (t.exports['Accounts receivable - trade, net_study'] = [
          'Дебиторская задолженность - торговая, нетто',
        ]),
        (t.exports.Accruals_study = ['Начисления']),
        (t.exports['Accrued payroll_study'] = ['Задолженность по заработной плате']),
        (t.exports['Accumulated depreciation, total_study'] = ['Накопленная амортизация, итого']),
        (t.exports['Additional paid-in capital/Capital surplus_study'] = ['Добавочный капитал']),
        ...
        (t.exports['Amortization of intangibles_study'] = ['Амортизация нематериальных активов']),
        ...
        (t.exports['Average basic shares outstanding_study'] = ['Среднее число акций в обращении']),
        ...
        (t.exports['Basic earnings per share (Basic EPS)_study'] = ['Базовая прибыль на акцию']),
        (t.exports['Beneish M-score_study'] = ['Коэффициент Бениша']),
        (t.exports['Book value per share_study'] = ['Балансовая стоимость на акцию']),
        (t.exports['Buyback yield %_study'] = ['Доходность обратного выкупа акций, %']),
        ...
        (t.exports['Cash conversion cycle_study'] = ['Цикл обращения денежных средств']),
        (t.exports['Cash & equivalents_study'] = ['Денежные средства и их эквиваленты']),
        ...
        (t.exports['Change in accrued expenses_study'] = ['Изменения в начисленных расходах']),
        ...
        (t.exports['Change in taxes payable_study'] = ['Изменения в налогах к оплате']),
        (t.exports['Changes in working capital_study'] = ['Изменения оборотного капитала']),
        ...
        (t.exports['Cost of goods sold_study'] = ['Себестоимость реализованных товаров']),
        (t.exports['Current portion of LT debt and capital leases_study'] = [
          'Текущая часть долгосрочной зад-ти и обяз-в по аренде',
        ]),
        (t.exports['Current ratio_study'] = ['Коэффициент текущей ликвидности']),
        (t.exports['Days inventory_study'] = ['Период оборачиваемости запасов']),
        (t.exports['Days payable_study'] = ['Период погашения кредиторской задолженности']),
        ...
        (t.exports['Deferred income, current_study'] = ['Доходы будущих периодов, оборотные']),
        (t.exports['Deferred income, non-current_study'] = [
          'Доходы будущих периодов, внеоборотные',
        ]),
        (t.exports['Deferred tax assets_study'] = ['Отложенные налоговые активы']),
        (t.exports['Deferred taxes (cash flow)_study'] = [
          'Отложенный налог (движение денежных средств)',
        ]),
        (t.exports['Deferred tax liabilities_study'] = ['Отложенные налоговые обязательства']),
        (t.exports.Depreciation_study = ['Амортизация']),
        (t.exports['Deprecation and amortization_study'] = ['Износ и амортизация']),
        ...
        (t.exports['Diluted shares outstanding_study'] = ['Разводнённые акции в обращении']),
        (t.exports['Dilution adjustment_study'] = ['Корректировка на разводнение']),
        (t.exports['Discontinued operations_study'] = ['Прекращённые операции']),
        ...
        (t.exports.EBITDA_study = ['EBITDA (прибыль до вычета процентов, налогов и амортизации)']),
        ...
        (t.exports['EPS basic one year growth_study'] = ['Базовая приб./акцию — годовой рост']),
        (t.exports['EPS diluted one year growth_study'] = ['Разводн. приб./акцию — годовой рост']),
        (t.exports['EPS estimates_study'] = ['Оценка приб./акцию']),
        (t.exports['Equity in earnings_study'] = ['Доходы от участия в других организациях']),
        ...
        (t.exports['Free cash flow_study'] = ['Движение свободных денежных средств']),
        (t.exports['Free cash flow margin %_study'] = ['Маржа свободных денежных средств %']),
        (t.exports['Fulmer H factor_study'] = ['Фактор Fulmer H']),
        (t.exports['Funds from operations_study'] = ['Средства от основной деятельности']),
        ...
        (t.exports['Gross profit to assets ratio_study'] = ['Валовая прибыль/активы']),
        (t.exports['Gross property/plant/equipment_study'] = ['Основные средства, брутто']),
        (t.exports.Impairments_study = ['Обесценение активов']),
        (t.exports['Income Tax Credits_study'] = ['Вычет по налогу на прибыль']),
        (t.exports['Income tax, current_study'] = ['Налог на прибыль, текущий']),
        ...
        (t.exports['Income tax, deferred_study'] = ['Налог на прибыль, отложенный']),
        ...
        (t.exports['Interest capitalized_study'] = ['Капитализированные проценты']),
        ...
        (t.exports['Inventories - finished goods_study'] = ['Запасы — готовая продукция']),
        (t.exports['Inventories - progress payments & other_study'] = [
          'Запасы — постепенные платежи и другое',
        ]),
        (t.exports['Inventories - raw materials_study'] = ['Запасы — сырье и материалы']),
        ...
        (t.exports['Issuance of long term debt_study'] = ['Начисление долгосрочной задолж-ти']),
        ...
        (t.exports['Legal claim expense_study'] = ['Расходы по судебным разбирательствам']),
        ...
        (t.exports['Long term debt to total equity ratio_study'] = [
          'Долгосрочная задолж./совокуп. капитал',
        ]),
        (t.exports['Long term investments_study'] = ['Долгосрочные инвестиции']),
        ...
        (t.exports['Net income per employee_study'] = ['Чистая прибыль на одного работника']),
        (t.exports['Net intangible assets_study'] = ['Чистые нематериальные активы']),
        (t.exports['Net margin %_study'] = ['Рентабельность по чистой прибыли, %']),
        (t.exports['Net property/plant/equipment_study'] = ['Основные средства, нетто']),
        ...
        (t.exports['Non-operating income, total_study'] = ['Внеоперационные доходы, итого']),
        (t.exports['Non-operating interest income_study'] = [
          'Проценты к получению по внеоперационной деятельности',
        ]),
        (t.exports['Note receivable - long term_study'] = ['Вексель к получению — долгосрочный']),
        ...
        (t.exports['Operating lease liabilities_study'] = ['Обязательства по операционной аренде']),
        (t.exports['Operating margin %_study'] = ['Операционная рентабельность %']),
        (t.exports['Other COGS_study'] = ['Прочая себестоимость реализованной продукции']),
        (t.exports['Other common equity_study'] = ['Прочий основной капитал']),
        (t.exports['Other current assets, total_study'] = ['Прочие оборотные активы, итог']),
        (t.exports['Other current liabilities_study'] = ['Прочие текущие обязательства']),
        (t.exports['Other cost of goods sold_study'] = [
          'Прочая себестоимость реализованных товаров',
        ]),
        (t.exports['Other exceptional charges_study'] = ['Другие исключительные расходы']),
        (t.exports['Other financing cash flow items, total_study'] = [
          'Общее движение денежных средств от прочей финансовой деятельности',
        ]),
        (t.exports['Other intangibles, net_study'] = ['Прочие нематериальные активы, нетто']),
        ...
        (t.exports['Other liabilities, total_study'] = ['Прочие обязательства, итого']),
        (t.exports['Other long term assets, total_study'] = ['Другие долгосрочные активы, итого']),
        ...
        (t.exports['Other receivables_study'] = ['Прочая дебиторская задолженность']),
        (t.exports['Other short term debt_study'] = ['Прочая краткосрочная задолж-ть']),
        (t.exports['Paid in capital_study'] = ['Оплаченная часть акционерного капитала']),
        (t.exports['PEG ratio_study'] = ['Коэффициент PEG']),
        (t.exports['Piotroski F-score_study'] = ['Коэффициент Пиотровски']),
        (t.exports['Preferred dividends_study'] = ['Дивиденды по привилегированным акциям']),
        ...
        (t.exports['Pretax income_study'] = ['Прибыль (убыток) до налогообложения']),
        ...
        (t.exports['Purchase/acquisition of business_study'] = ['Покупка/приобретение бизнеса']),
        (t.exports['Purchase of investments_study'] = ['Приобретение финансовых вложений']),
        (t.exports['Purchase/sale of business, net_study'] = ['Покупка/продажа бизнеса, нетто']),
        (t.exports['Purchase/sale of investments, net_study'] = [
          'Приобретение/выбытие финансовых вложений, нетто',
        ]),
        (t.exports['Quality ratio_study'] = ['Коэфф. эффективности использования активов']),
        ...
        (t.exports['Research & development_study'] = ['Расходы на исследование и разработку']),
        (t.exports['Research & development to revenue ratio_study'] = [
          'Расходы на исследование и разработку/выручка',
        ]),
        (t.exports['Restructuring charge_study'] = ['Расходы на реструктуризацию']),
        (t.exports['Retained earnings_study'] = ['Нераспределённая прибыль']),
        (t.exports['Return on assets %_study'] = ['Коэффициент рентабельности активов, %']),
        ...
        (t.exports['Return on invested capital %_study'] = ['Доход на инвестированный капитал, %']),
        (t.exports['Return on tangible assets %_study'] = [
          'Прибыль на общ. сумму материальных активов, %',
        ]),
        (t.exports['Return on tangible equity %_study'] = ['Доход на материальный капитал, %']),
        (t.exports['Revenue estimates_study'] = ['Расчёт выручки']),
        (t.exports['Revenue one year growth_study'] = ['Годовой рост выручки']),
        (t.exports['Revenue per employee_study'] = ['Выручка на одного работника']),
        ...
        (t.exports['Shares buyback ratio %_study'] = ['Коэффициент выкупа акций %']),
        ...
        (t.exports['Short term investments_study'] = ['Краткосрочные инвестиции']),
        (t.exports['Sloan ratio %_study'] = ['Коэффициент Слоуна']),
        (t.exports['Springate score_study'] = ['Показатель Спрингейта']),
        (t.exports['Sustainable growth rate_study'] = ['Темп устойчивого роста']),
        ...
        (t.exports["Tobin's Q (approximate)_study"] = ['Коэффициент Тобина (приблизительно)']),
        ...
        (t.exports['Total current liabilities_study'] = ['Общая сумма текущих обязательств']),
        (t.exports['Total debt_study'] = ['Итого задолженность']),
        (t.exports['Total equity_study'] = ['Итого собственный капитал']),
        (t.exports['Total inventory_study'] = ['Итого товарно-материальные запасы']),
        ...
        (t.exports['Total non-current assets_study'] = ['Итого внеоборотные активы']),
        (t.exports['Total non-current liabilities_study'] = ['Итого долгосрочные обязательства']),
        (t.exports['Total operating expenses_study'] = ['Итого операционные расходы']),
        ...
        (t.exports['Unrealized gain/loss_study'] = ['Нереализованная прибыль/убыток']),
        (t.exports['Unusual income/expense_study'] = ['Нестандартные доходы/расходы']),
        (t.exports['Zmijewski score_study'] = ['Показатель Zmijewski']),
        (t.exports['Valuation ratios_study'] = ['Отношение рыночной цены акции к номиналу']),
        (t.exports['Profitability ratios_study'] = ['Коэффициенты рентабельности']),
        (t.exports['Liquidity ratios_study'] = ['Коэффициенты ликвидности']),
        (t.exports['Solvency ratios_study'] = ['Коэффициенты платежеспособности']),
        (t.exports['Key stats_study'] = ['Основные данные']),
        (t.exports['Accumulation/Distribution_study'] = ['Накопление/Распределение']),
        (t.exports['Accumulative Swing Index_study'] = ['Кумулятивный индекс колебаний']),
        (t.exports['Advance/Decline_study'] = ['Рост/падение']),
        (t.exports['Arnaud Legoux Moving Average_study'] = ['Скользящее среднее Арно Легу']),
        ...
        (t.exports['Awesome Oscillator_study'] = ['Чудесный осциллятор Билла Вильямса']),
        (t.exports['Balance of Power_study'] = ['Баланс силы']),
        (t.exports['Bollinger Bands %B_study'] = ['%B Полос Боллинджера']),
        (t.exports['Bollinger Bands Width_study'] = ['Ширина полос Боллинджера']),
        ...
        (t.exports['Chande Momentum Oscillator_study'] = ['Моментум-осциллятор Чанде']),
        (t.exports['Chop Zone_study'] = ['Индикатор Chop Zone']),
        (t.exports['Choppiness Index_study'] = ['Индекс переменчивости']),
        (t.exports['Commodity Channel Index_study'] = ['Индекс товарного канала']),
        (t.exports['Connors RSI_study'] = ['RSI Коннора']),
        (t.exports['Coppock Curve_study'] = ['Кривая Коппока']),
        (t.exports['Correlation Coefficient_study'] = ['Коэффициент корреляции']),
        (t.exports.CRSI_study = 'CRSI'),
        (t.exports['Detrended Price Oscillator_study'] = ['Детрендовый ценовой осциллятор']),
        (t.exports['Directional Movement_study'] = ['Индекс направленного движения']),
        (t.exports['Donchian Channels_study'] = ['Канал Дончиана']),
        (t.exports['Double EMA_study'] = ['Двойное экспоненц. скользящ. средн.']),
        (t.exports['Ease Of Movement_study'] = ['Легкость движения']),
        (t.exports['Elder Force Index_study'] = ['Индекс силы Элдера']),
        (t.exports['EMA Cross_study'] = ['Пересечение экспоненц. скользящих средних']),
        ...
        (t.exports['Fixed Range Volume Profile_study'] = ['Фиксированный профиль объема']),
        (t.exports['Guppy Multiple Moving Average_study'] = [
          'Множественное скользящее среднее Гуппи',
        ]),
        (t.exports['Historical Volatility_study'] = ['Историческая волатильность']),
        ...
        (t.exports['Linear Regression Curve_study'] = ['Кривая линейной регрессии']),
        ...
        (t.exports['McGinley Dynamic_study'] = ['Динамический индикатор МакГинли']),
        (t.exports.Median_study = ['Средняя линия']),
        (t.exports.Momentum_study = ['Моментум (Momentum)']),
        (t.exports['Money Flow_study'] = ['Денежный поток']),
        (t.exports['Moving Average Channel_study'] = ['Канал скользящей средней']),
        (t.exports['Moving Average Exponential_study'] = ['Скользящее среднее (эксп.)']),
        (t.exports['Moving Average Weighted_study'] = ['Взвешенное скользящее среднее']),
        (t.exports['Moving Average Simple_study'] = ['Простое скользящее среднее']),
        (t.exports['Net Volume_study'] = ['Чистый объём']),
        (t.exports['On Balance Volume_study'] = ['Балансовый объём']),
        (t.exports['Parabolic SAR_study'] = ['Параболическая система времени/цены']),
        (t.exports['Pivot Points Standard_study'] = ['Стандартные точки разворота']),
        (t.exports['Periodic Volume Profile_study'] = ['Профиль объёма за период']),
        ...
        (t.exports['Relative Strength Index_study'] = ['Индекс относительной силы']),
        (t.exports['Relative Vigor Index_study'] = ['Индекс относительной бодрости']),
        (t.exports['Relative Volatility Index_study'] = ['Относительный индекс волатильности']),
        (t.exports['Session Volume_study'] = ['Объём за сессию']),
        (t.exports['Session Volume HD_study'] = ['Объём за сессию HD']),
        (t.exports['Session Volume Profile_study'] = ['Профиль объёма за сессию']),
        (t.exports['Session Volume Profile HD_study'] = ['Профиль объёма за сессию HD']),
        (t.exports['SMI Ergodic Indicator/Oscillator_study'] = [
          'Индикатор/Осциллятор SMI Ergodic',
        ]),
        (t.exports['Smoothed Moving Average_study'] = ['Сглаженное скользящее среднее']),
        (t.exports.Stoch_study = ['Стох.']),
        (t.exports['Stochastic RSI_study'] = ['Стохастический индекс относительной силы']),
        (t.exports.Stochastic_study = ['Стохастический осциллятор']),
        (t.exports['Triple EMA_study'] = ['Скользящее среднее (тройное эксп.)']),
        (t.exports.TRIX_study = ['Скользящее среднее (тройное эксп. сглаженное)']),
        ...
        (t.exports['Visible Range Volume Profile_study'] = ['Профиль объёма видимой области']),
        ...
        (t.exports['Williams %R_study'] = ['Процентный диапазон Вильямса (%R)']),
        ...
        (t.exports['Linear Regression Channel_study'] = ['Линейный регрессионный канал']),
        (t.exports['Moving Average Ribbon_study'] = ['Лента скользящего среднего']),
        ...
        (t.exports['Up/Down Volume_study'] = ['Предельный объем (по верхней/нижней границе)']),
        (t.exports['Visible Average Price_study'] = ['Видимая средняя цена']),
        (t.exports['Williams Fractals_study'] = ['Фракталы Вильямса']),
        (t.exports['Keltner Channels Strategy_study'] = ['Канал Кельтнера — стратегия']),
        (t.exports['Rob Booker - ADX Breakout_study'] = ['Роб Букер — Прорыв ADX']),
        ...
        (t.exports['Auto Anchored Volume Profile_study'] = ['Профиль объёма (Auto Anchored)']),
        (t.exports['Auto Fib Extension_study'] = ['Автокоррекция по Фибоначчи']),
        (t.exports['Auto Fib Retracement_study'] = ['Автокоррекция по Фибоначчи']),
        (t.exports['Auto Pitchfork_study'] = ['Вилы (Авто)']),
        (t.exports['Bearish Flag Chart Pattern_study'] = ['Паттерн Медвежий флаг']),
        (t.exports['Bullish Flag Chart Pattern_study'] = ['Паттерн Бычий флаг']),
        (t.exports['Bearish Pennant Chart Pattern_study'] = ['Паттерн Медвежий вымпел']),
        (t.exports['Bullish Pennant Chart Pattern_study'] = ['Паттерн Бычий вымпел']),
        (t.exports['Double Bottom Chart Pattern_study'] = ['Паттерн Двойное дно']),
        (t.exports['Double Top Chart Pattern_study'] = ['Паттерн Двойная вершина']),
        (t.exports['Elliott Wave Chart Pattern_study'] = ['Паттерн Волны Эллиотта']),
        (t.exports['Falling Wedge Chart Pattern_study'] = ['Паттерн Нисходящий клин']),
        (t.exports['Head And Shoulders Chart Pattern_study'] = ['Паттерн Голова и плечи']),
        (t.exports['Inverse Head And Shoulders Chart Pattern_study'] = [
          'Паттерн Перевернутые голова и плечи',
        ]),
        (t.exports['Rectangle Chart Pattern_study'] = ['Паттерн Прямоугольник']),
        (t.exports['Rising Wedge Chart Pattern_study'] = ['Паттерн Восходящий клин']),
        (t.exports['Triangle Chart Pattern_study'] = ['Паттерн Треугольник']),
        (t.exports['Triple Bottom Chart Pattern_study'] = ['Паттерн Тройное дно']),
        (t.exports['Triple Top Chart Pattern_study'] = ['Паттерн Тройная вершина']),
        (t.exports['VWAP Auto Anchored_study'] = 'VWAP Auto Anchored'),
        (t.exports['*All Candlestick Patterns*_study'] = ['*Все паттерны японских свечей*']),
        (t.exports['Abandoned Baby - Bearish_study'] = ['Медвежий Брошенный младенец']),
        (t.exports['Abandoned Baby - Bullish_study'] = ['Бычий Брошенный младенец']),
        (t.exports['Dark Cloud Cover - Bearish_study'] = ['Завеса из тёмных облаков — медвежья']),
        (t.exports['Doji Star - Bearish_study'] = ['Медвежий Доджи']),
        (t.exports['Doji Star - Bullish_study'] = ['Бычий Доджи']),
        (t.exports['Downside Tasuki Gap - Bearish_study'] = ['Разрыв Тасуки вниз — медвежий']),
        (t.exports['Dragonfly Doji - Bullish_study'] = ['Бычья Доджи-стрекоза']),
        (t.exports['Engulfing - Bearish_study'] = ['Медвежье Поглощение']),
        (t.exports['Engulfing - Bullish_study'] = ['Бычье Поглощение']),
        (t.exports['Evening Doji Star - Bearish_study'] = ['Медвежья Вечерняя звезда Доджи']),
        (t.exports['Evening Star - Bearish_study'] = ['Медвежья вечерняя звезда']),
        (t.exports['Falling Three Methods - Bearish_study'] = ['Медвежий Метод трёх нисходящих']),
        (t.exports['Falling Window - Bearish_study'] = ['Медвежье нисходящее окно']),
        (t.exports['Gravestone Doji - Bearish_study'] = ['Могильный камень Доджи — медвежий']),
        ...
        (t.exports['Inverted Hammer - Bullish_study'] = ['Бычий Перевёрнутый молот']),
        (t.exports['Kicking - Bearish_study'] = ['Медвежий Кикер']),
        (t.exports['Kicking - Bullish_study'] = ['Бычий Кикер']),
        (t.exports['Long Lower Shadow - Bullish_study'] = ['Длинная тень снизу — бычья']),
        (t.exports['Long Upper Shadow - Bearish_study'] = ['Длинная тень сверху — медвежья']),
        (t.exports['Marubozu Black - Bearish_study'] = ['Медвежий Чёрный Марубозу']),
        (t.exports['Marubozu White - Bullish_study'] = ['Бычий Белый Марубозу']),
        (t.exports['Morning Doji Star - Bullish_study'] = ['Утренняя звезда Доджи — бычья']),
        ...
        (t.exports['Rising Three Methods - Bullish_study'] = ['Метод трёх восходящих — бычий']),
        (t.exports['Rising Window - Bullish_study'] = ['Бычье Восходящее окно']),
        (t.exports['Shooting Star - Bearish_study'] = ['Медвежья падающая звезда']),
        (t.exports['Three Black Crows - Bearish_study'] = ['Три черные вороны — медвежьи']),
        (t.exports['Three White Soldiers - Bullish_study'] = ['Три белых солдата — бычьи']),
        (t.exports['Tri-Star - Bearish_study'] = ['Три звезды — медвежьи']),
        (t.exports['Tri-Star - Bullish_study'] = ['Три звезды — бычьи']),
        (t.exports['Tweezer Top - Bearish_study'] = ['Верхний Пинцет — медвежий']),
        (t.exports['Upside Tasuki Gap - Bullish_study'] = ['Верхний гэп Тасуки — бычий']),
        ...
        (t.exports['Moving Average Double_study'] = ['Двойное скользящее среднее']),
        (t.exports['Moving Average Triple_study'] = ['Тройное скользящее среднее']),
        (t.exports['Moving Average Adaptive_study'] = ['Адаптивное скользящее среднее']),
        (t.exports['Moving Average Hamming_study'] = ['Скользящее среднее Хэмминга']),
        (t.exports['Moving Average Modified_study'] = ['Модифицированное скользящее среднее']),
        (t.exports['Moving Average Multiple_study'] = ['Множественное скользящее среднее']),
        (t.exports['Linear Regression Slope_study'] = ['Наклон линейной регрессии']),
        (t.exports['Standard Error_study'] = ['Стандартная ошибка']),
        (t.exports['Standard Error Bands_study'] = ['Полосы стандартных ошибок']),
        (t.exports['Correlation - Log_study'] = ['Корреляция - Лог.']),
        (t.exports['Standard Deviation_study'] = ['Стандартное отклонение']),
        (t.exports['Chaikin Volatility_study'] = ['Индикатор волатильности Чайкина']),
        (t.exports['Volatility Close-to-Close_study'] = ['Волатильность Close-to-Close']),
        ...
        (t.exports['Advance Decline Ratio_study'] = ['Коэффициент роста/падения']),
        (t.exports['Advance/Decline Ratio (Bars)_study'] = ['Коэффициент роста/падения (Бары)']),
        ...
        (t.exports.ChannelBreakOutStrategy_study = ['Стратегия Channel BreakOut']),
        ...
        (t.exports['Consecutive Up/Down Strategy_study'] = ['Стратегия Consecutive Up/Down']),
        (t.exports['Cumulative Volume Index_study'] = ['Кумулятивный индекс объёма']),
        ...
        (t.exports['Keltner Channel Strategy_study'] = ['Стратегия Канал Кельтнера']),
        (t.exports['Linear Regression_study'] = ['Кривая линейной регрессии']),
        (t.exports['MACD Strategy_study'] = ['Стратегия MACD']),
        (t.exports['Momentum Strategy_study'] = ['Стратегия моментум (Momentum)']),
        (t.exports['Moon Phases_study'] = ['Фазы Луны']),
        (t.exports['Moving Average Convergence/Divergence_study'] = [
          'Схождение/расхождение скользящих средних',
        ]),
        (t.exports['MovingAvg Cross_study'] = ['Пересечение скользящих средних']),
        (t.exports['MovingAvg2Line Cross_study'] = ['Пересечение 2 линий скользящих средних']),
        (t.exports['OutSide Bar Strategy_study'] = ['Стратегия OutSide Bar']),
        (t.exports.Overlay_study = ['Поверх основной серии']),
        (t.exports['Parabolic SAR Strategy_study'] = ['Параболическая остановка и разворот (SAR)']),
        (t.exports['Pivot Extension Strategy_study'] = ['Стратегия Pivot Extension']),
        (t.exports['Pivot Points High Low_study'] = ['Контрольные точки разворота']),
        (t.exports['Pivot Reversal Strategy_study'] = ['Стратегия контрольной точки разворота']),
        (t.exports['Price Channel Strategy_study'] = ['Стратегия ценовых каналов']),
        (t.exports['RSI Strategy_study'] = ['Стратегия RSI']),
        (t.exports['SMI Ergodic Indicator_study'] = ['Индикатор SMI Ergodic']),
        (t.exports['SMI Ergodic Oscillator_study'] = ['Осциллятор SMI Ergodic']),
        (t.exports['Stochastic Slow Strategy_study'] = ['Стратегия медленный стохастик']),
        (t.exports['Volatility Stop_study'] = ['Стоп по волатильности']),
        (t.exports['Volty Expan Close Strategy_study'] = ['Стратегия Volty Expan Close']),
    ...
    979393: t => {
      t.exports = ['Код изображения графика для вставки скопирован в буфер обмена {emoji}'];
    },
    59884: t => {
      t.exports = ['Чатем'];
    },
    ...
    330192: t => {
      t.exports = ['График с таким именем уже существует. Хотите переименовать?'];
    },
    532852: t => {
    ...
    107005: t => {
      t.exports = ['Добавить оповещение для {title} на {price}'];
    },
    303612: t => {
    ...
    655980: t => {
      t.exports = ['Добавить {symbol} в Список котировок'];
    },
    717365: t => {
      t.exports = ['Аделаида'];
    },
    ...
    838660: t => {
      t.exports = [
        'Симуляция рынка недоступна для этого временного интервала. Хотите выйти из режима симуляции?',
      ];
    },
    16812: t => {
      t.exports = ['Бары'];
    ...
    665287: t => {
      t.exports = ['Метки цен покупки и продажи'];
    },
    240548: t => {
      t.exports = ['Линии цен покупки и продажи'];
    },
    530251: t => {
      t.exports = ['Кисть'];
    },
    ...
    897065: t => {
      t.exports = ['Вы действительно хотите удалить шаблон индикаторов "{name}"?'];
    },
    59368: t => {
      t.exports = ['Двойная кривая'];
    },
    135273: t => {
      t.exports = ['Двойной клик по любому краю графика, чтобы сбросить настройки размеров'];
    },
    605828: t => {
    ...
    947542: t => {
      t.exports = ['Индикаторы фундаментального анализа на графиках более недоступны'];
    },
    916245: t => {
      t.exports = ['Калькутта'];
    },
    ...
    67927: t => {
      t.exports = ['Скрыть все объекты рисования, индикаторы, позиции и заявки'];
    },
    986306: t => {
    ...
    369085: t => {
      t.exports = ['Гистограмма слишком большая, увеличьте параметр "Размер строки".'];
    },
    808122: t => {
      t.exports = ['Гистограмма слишком большая, уменьшите параметр "Размер строки".'];
    },
    223450: t => {
    ...
    967861: t => {
      t.exports = ['Переместите точку, чтобы установить якорь, затем нажмите, чтобы разместить'];
    },
    745828: t => {
      t.exports = ['Переместить'];
    },
    456462: t => {
      t.exports = ['Сдвинуть график'];
    },
    844302: t => {
    ...
    901535: t => {
      t.exports = ['Обновления скрипта могут не сохраниться, если вы закроете страницу.'];
    },
    389517: t => {
      t.exports = ['Настройки'];
    },
    ...
    538293: t => {
      t.exports = ['Показать все объекты рисования, индикаторы, позиции и заявки'];
    },
    249982: t => {
    ...
    772973: t => {
      t.exports = ['Показывать последние новости'];
    },
    258669: t => {
    ...
    590537: t => {
      t.exports = ['Метка цены закрытия предыдущего дня'];
    },
    733606: t => {
    ...
    336857: t => {
      t.exports = ['Линия цены закрытия предыдущего дня'];
    },
    495921: t => {
    ...
    529198: t => {
      t.exports = ['Поставщик данных не предоставляет данные об объеме для этого инструмента.'];
    },
    308162: t => {
      t.exports = [
    ...
    874986: t => {
      t.exports = ['Доступ к этому скрипту ограничен. Запросите доступ у автора скрипта.'];
    },
    298538: t => {
    ...
    961022: t => {
      t.exports = ['Индикатор Профиль объёма доступен только в платных подписках.'];
    },
    115771: t => {
      t.exports = ['Ванкувер'];
    },
    ...
    717126: t => {
      t.exports = ['Нельзя использовать этот временной интервал точек разворота на этом интервале'];
    },
    157159: t => {
      t.exports = ['Новости'];
    },
    ...
    323783: t => {
      t.exports = ['изменение группы синхронизации'];
    },
    187510: t => {
    ...
    112707: t => {
      t.exports = ['изменение видимости предыдущего значения закрытия инструмента'];
    },
    765303: t => {
    ...
    799113: t => {
      t.exports = ['добавление инструмента рисования {lineTool} в группу {name}'];
    },
    240242: t => {
    ...
    665818: t => {
      t.exports = ['изменение расположения графиков'];
    },
    292831: t => {
    ...
    118562: t => {
      (t.exports = Object.create(null)),
        ...
        (t.exports['#AUDCAD-symbol-description'] = ['Австралийский доллар / Канадский доллар']),
        (t.exports['#AUDCHF-symbol-description'] = ['Австралийский доллар / Швейцарский франк']),
        (t.exports['#AUDJPY-symbol-description'] = ['Австралийский доллар / Японская иена']),
        (t.exports['#AUDNZD-symbol-description'] = [
          'Австралийский доллар / Новозеландский доллар',
        ]),
        (t.exports['#AUDRUB-symbol-description'] = ['Австралийский доллар / Российский рубль']),
        (t.exports['#AUDUSD-symbol-description'] = ['Австралийский доллар / Доллар США']),
        (t.exports['#BRLJPY-symbol-description'] = ['Бразильский реал / Японская иена']),
        (t.exports['#BTCCAD-symbol-description'] = ['Биткоин / Канадский доллар']),
        (t.exports['#BTCCNY-symbol-description'] = ['Биткоин / Китайский юань']),
        (t.exports['#BTCEUR-symbol-description'] = ['Биткоин / Евро']),
        (t.exports['#BTCKRW-symbol-description'] = ['Биткоин / Южнокорейская вона']),
        (t.exports['#BTCRUR-symbol-description'] = ['Биткоин / Российский рубль']),
        (t.exports['#BTCUSD-symbol-description'] = ['Биткоин / Доллар США']),
        (t.exports['#BVSP-symbol-description'] = ['Индекс BOVESPA']),
        (t.exports['#CADJPY-symbol-description'] = ['Канадский доллар / Японская иена']),
        (t.exports['#CB1!-symbol-description'] = ['Нефть марки Brent']),
        (t.exports['#CHFJPY-symbol-description'] = ['Швейцарский франк / Японская иена']),
        ...
        (t.exports['#GB10-symbol-description'] = ['10-летние облигации Британии']),
        (t.exports['#GBPAUD-symbol-description'] = ['Британский фунт / Австралийский доллар']),
        (t.exports['#GBPCAD-symbol-description'] = ['Британский фунт / Канадский доллар']),
        (t.exports['#GBPCHF-symbol-description'] = ['Британский фунт / Швейцарский франк']),
        (t.exports['#GBPEUR-symbol-description'] = ['Британский фунт / Евро']),
        (t.exports['#GBPJPY-symbol-description'] = ['Британский фунт / Японская иена']),
        (t.exports['#GBPNZD-symbol-description'] = ['Британский фунт / Новозеландский доллар']),
        (t.exports['#GBPRUB-symbol-description'] = ['Британский фунт / Российский рубль']),
        (t.exports['#GBPUSD-symbol-description'] = ['Британский фунт / Доллар США']),
        ...
        (t.exports['#JPYKRW-symbol-description'] = ['Японская иена / Южнокорейская вона']),
        (t.exports['#JPYRUB-symbol-description'] = ['Японская иена / Российский рубль']),
        ...
        (t.exports['#MNOD_ME.EQRP-symbol-description'] = ['ОАО ГМК Норильский никель (РЕПО)']),
        (t.exports['#MSFT-symbol-description'] = ['Microsoft Corporation (Майкрософт)']),
        ...
        (t.exports['#NZDJPY-symbol-description'] = ['Новозеландский доллар / Японская иена']),
        (t.exports['#NZDUSD-symbol-description'] = ['Новозеландский доллар / Доллар США']),
        ...
        (t.exports['#USDBRL-symbol-description'] = ['Доллар США / Бразильский реал']),
        (t.exports['#USDCAD-symbol-description'] = ['Доллар США / Канадский доллар']),
        (t.exports['#USDCHF-symbol-description'] = ['Доллар США / Швейцарский франк']),
        (t.exports['#USDCNY-symbol-description'] = ['Доллар США / Китайский юань']),
        (t.exports['#USDDKK-symbol-description'] = ['Доллар США / Датская крона']),
        (t.exports['#USDHKD-symbol-description'] = ['Доллар США / Гонконгский доллар']),
        (t.exports['#USDIDR-symbol-description'] = ['Доллар США / Индонезийская рупия']),
        (t.exports['#USDINR-symbol-description'] = ['Доллар США / Индийская рупия']),
        (t.exports['#USDJPY-symbol-description'] = ['Доллар США / Японская иена']),
        (t.exports['#USDKRW-symbol-description'] = ['Доллар США / Южнокорейская вона']),
        (t.exports['#USDMXN-symbol-description'] = ['Доллар США / Мексиканский песо']),
        (t.exports['#USDPHP-symbol-description'] = ['Доллар США / Филиппинское песо']),
        (t.exports['#USDRUB-symbol-description'] = ['Доллар США / Российский рубль']),
        (t.exports['#USDRUB_TOM-symbol-description'] = ['Доллар США / Российский рубль TOM']),
        (t.exports['#USDSEK-symbol-description'] = ['Доллар США / Шведская крона']),
        (t.exports['#USDSGD-symbol-description'] = ['Доллар США / Сингапурский доллар']),
        (t.exports['#USDTRY-symbol-description'] = ['Доллар США / Турецкая лира']),
        ...
        (t.exports['#ZS1-symbol-description'] = ['Фьючерсы на соевые бобы - ECBT']),
        (t.exports['#ZW1-symbol-description'] = ['Фьючерсы на пшеницу']),
        (t.exports['#BTCGBP-symbol-description'] = ['Биткоин / Британский фунт']),
        (t.exports['#MICEXINDEXCF-symbol-description'] = ['Индекс МосБиржи']),
        (t.exports['#BTCAUD-symbol-description'] = ['Биткоин / Австралийский доллар']),
        (t.exports['#BTCJPY-symbol-description'] = ['Биткоин / Японская иена']),
        (t.exports['#BTCBRL-symbol-description'] = ['Биткоин / Бразильская лира']),
        (t.exports['#PT10-symbol-description'] = ['10-летние облигации Португалии']),
        (t.exports['#TXSX-symbol-description'] = ['Индекс TSX 60']),
        (t.exports['#VIXC-symbol-description'] = ['Индекс TSX 60 VIX']),
        (t.exports['#USDPLN-symbol-description'] = ['Доллар США / Польский злотый']),
        (t.exports['#EURPLN-symbol-description'] = ['Евро / Польский злотый']),
        (t.exports['#BTCPLN-symbol-description'] = ['Биткоин / Польский злотый']),
        (t.exports['#CAC40-symbol-description'] = ['Индекс CAC 40']),
        (t.exports['#XBTCAD-symbol-description'] = ['Биткоин / Канадский доллар']),
        (t.exports['#ITI2!-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIF2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIF2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIF2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIG2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIG2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIG2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIH2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIH2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIH2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIJ2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIJ2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIJ2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIK2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIK2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIK2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIM2017-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIM2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIM2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIM2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIN2017-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIN2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIN2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIN2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIQ2017-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIQ2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIQ2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIQ2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIU2017-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIU2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIU2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIU2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIV2017-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIV2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIV2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIV2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIX2017-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIX2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIX2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIX2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIZ2017-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIZ2018-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIZ2019-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#ITIZ2020-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#AMEX:GXF-symbol-description'] = 'Global x FTSE Nordic Region ETF'),
        (t.exports['#ASX:XAF-symbol-description'] = ['Индекс S&P/ASX All Australian 50']),
        (t.exports['#ASX:XAT-symbol-description'] = ['Индекс S&P/ASX All Australian 200']),
        (t.exports['#BIST:XU100-symbol-description'] = ['Индекс BIST 100']),
        (t.exports['#GPW:WIG20-symbol-description'] = ['Индекс WIG20']),
        (t.exports['#INDEX:JKSE-symbol-description'] = ['Индекс Jakarta Composite']),
        (t.exports['#INDEX:KLSE-symbol-description'] = ['Индекс Bursa Malaysia KLCI']),
        (t.exports['#INDEX:NZD-symbol-description'] = ['Индекс NZX 50']),
        (t.exports['#INDEX:STI-symbol-description'] = ['Индекс STI']),
        (t.exports['#INDEX:XLY0-symbol-description'] = ['Индекс Shanghai Composite']),
        (t.exports['#MOEX:MICEXINDEXCF-symbol-description'] = ['Индекс МосБиржи']),
        (t.exports['#NYMEX:KT1!-symbol-description'] = ['Фьючерсы на кофе']),
        (t.exports['#OANDA:NATGASUSD-symbol-description'] = ['CFD на природный газ']),
        (t.exports['#OANDA:USDPLN-symbol-description'] = ['Доллар США / Польский злотый']),
        ...
        (t.exports['#TVC:ES10-symbol-description'] = ['10-летние облигации Испании']),
        (t.exports['#TVC:EUBUND-symbol-description'] = ['Еврооблигации']),
        (t.exports['#TVC:GB02-symbol-description'] = ['2-летние облигации Британии']),
        (t.exports['#TVC:GB10-symbol-description'] = ['10-летние облигации Британии']),
        (t.exports['#TVC:GOLD-symbol-description'] = ['CFD на золото (US$ / OZ)']),
        (t.exports['#TVC:ID03-symbol-description'] = ['3-летние облигации Индонезии']),
        (t.exports['#TVC:ID10-symbol-description'] = ['10-летние облигации Индонезии']),
        (t.exports['#TVC:PALLADIUM-symbol-description'] = ['CFD на палладий (US$ / OZ)']),
        (t.exports['#TVC:PT10-symbol-description'] = ['10-летние облигации Португалии']),
        (t.exports['#TVC:SILVER-symbol-description'] = ['CFD на серебро (US$ / OZ)']),
        (t.exports['#TVC:RUT-symbol-description'] = ['Индекс Russell 2000']),
        (t.exports['#TSX:TSX-symbol-description'] = ['Индекс S&P/TSX Composite']),
        (t.exports['#OANDA:CH20CHF-symbol-description'] = ['Индекс Swiss 20']),
        (t.exports['#TVC:SHCOMP-symbol-description'] = ['Индекс Shanghai Composite']),
        (t.exports['#NZX:ALLC-symbol-description'] = ['Индекс S&P/NZX ALL (Capital Index)']),
        (t.exports['#AMEX:SHYG-symbol-description'] = [
          'Доходность корпоративных облигаций США 0-5 лет',
        ]),
        (t.exports['#TVC:AU10-symbol-description'] = ['10-летние облигации Австралии']),
        (t.exports['#TVC:CN10-symbol-description'] = ['10-летние облигации Китая']),
        (t.exports['#TVC:KR10-symbol-description'] = ['10-летние облигации Кореи']),
        (t.exports['#NYMEX:RB1!-symbol-description'] = ['Фьючерсы на бензин RBOB']),
        (t.exports['#NYMEX:HO1!-symbol-description'] = ['Фьючерсы NY Harbor ULSD']),
        (t.exports['#NYMEX:AEZ1!-symbol-description'] = ['Фьючерсы на этанол']),
        (t.exports['#OANDA:XCUUSD-symbol-description'] = ['CFD на медь (US$ / lb)']),
        (t.exports['#COMEX:ZA1!-symbol-description'] = ['Фьючерсы на цинк']),
        (t.exports['#CBOT:ZW1!-symbol-description'] = ['Фьючерсы на пшеницу']),
        (t.exports['#NYMEX:KA1!-symbol-description'] = ['Фьючерсы на сахар США #11']),
        (t.exports['#CBOT:QBC1!-symbol-description'] = ['Фьючерсы на кукурузу']),
        (t.exports['#CME:E61!-symbol-description'] = ['Фьючерсы на Евро']),
        (t.exports['#CME:B61!-symbol-description'] = ['Фьючерсы на британский фунт']),
        (t.exports['#CME:QJY1!-symbol-description'] = ['Фьючерсы на японскую иену']),
        (t.exports['#CME:A61!-symbol-description'] = ['Фьючерсы на австралийский доллар']),
        (t.exports['#CME:D61!-symbol-description'] = ['Фьючерсы на канадский доллар']),
        (t.exports['#CME:SP1!-symbol-description'] = ['Фьючерсы на S&P 500']),
        (t.exports['#CME_MINI:NQ1!-symbol-description'] = ['Фьючерсы на NASDAQ 100 E-Mini']),
        (t.exports['#CBOT_MINI:YM1!-symbol-description'] = ['Фьючерсы на E-mini Dow Jones ($5)']),
        (t.exports['#CME:NY1!-symbol-description'] = ['Фьючерсы на индекс Nikkei 225']),
        (t.exports['#EUREX:DY1!-symbol-description'] = ['Индекс DAX']),
        (t.exports['#CME:IF1!-symbol-description'] = ['Фьючерсы на индекс IBOVESPA в US$']),
        ...
        (t.exports['#CBOT:FF1!-symbol-description'] = ['Фьючерсы на ставку по федеральным фондам']),
        ...
        (t.exports['#TVC:BXY-symbol-description'] = ['Индекс британского фунта']),
        (t.exports['#TVC:AXY-symbol-description'] = ['Индекс австралийского доллара']),
        (t.exports['#TVC:CXY-symbol-description'] = ['Индекс канадского доллара']),
        ...
        (t.exports['#BMFBOVESPA:IBOV-symbol-description'] = ['Индекс IBovespa']),
        ...
        (t.exports['#INDEX:HSCE-symbol-description'] = ['Индекс Hang Seng China Enterprises']),
        (t.exports['#NYMEX:CL1!-symbol-description'] = ['Фьючерсы на нефть WTI']),
        (t.exports['#OTC:IHRMF-symbol-description'] = 'Ishares MSCI Japan SHS'),
        (t.exports['#TVC:DAX-symbol-description'] = ['Индекс DAX']),
        (t.exports['#TVC:DE10-symbol-description'] = ['10-летние облигации Германии']),
        (t.exports['#TVC:DJI-symbol-description'] = ['Промышленный индекс Доу — Джонса']),
        (t.exports['#TVC:DXY-symbol-description'] = ['Индекс доллара США']),
        (t.exports['#TVC:FR10-symbol-description'] = ['10-летние облигации Франции']),
        ...
        (t.exports['#AMEX:SHY-symbol-description'] = ['Казначейские облигации США 1-3 года (ETF)']),
        (t.exports['#ASX:XJO-symbol-description'] = ['Индекс S&P/ASX 200']),
        (t.exports['#BSE:SENSEX-symbol-description'] = ['Индекс S&P BSE SENSEX']),
        (t.exports['#INDEX:MIB-symbol-description'] = ['Индекс MIB']),
        (t.exports['#INDEX:MOY0-symbol-description'] = ['Индекс Euro Stoxx 50']),
        (t.exports['#MOEX:RTSI-symbol-description'] = ['Индекс РТС']),
        (t.exports['#NSE:NIFTY-symbol-description'] = ['Индекс Nifty 50']),
        (t.exports['#NYMEX:NG1!-symbol-description'] = ['Фьючерсы на природный газ']),
        (t.exports['#NYMEX:ZC1!-symbol-description'] = ['Фьючерсы на кукурузу']),
        (t.exports['#TVC:IN10-symbol-description'] = ['10-летние облигации Индии']),
        (t.exports['#TVC:IT10-symbol-description'] = ['10-летние облигации Италии']),
        (t.exports['#TVC:JP10-symbol-description'] = ['10-летние облигации Японии']),
        ...
        (t.exports['#TVC:TR10-symbol-description'] = ['10-летние облигации Турции']),
        (t.exports['#TVC:UKOIL-symbol-description'] = ['Нефть марки Brent']),
        (t.exports['#TVC:UKX-symbol-description'] = ['Индекс UK 100']),
        (t.exports['#TVC:US02-symbol-description'] = ['2-летние облигации США']),
        (t.exports['#TVC:US05-symbol-description'] = ['5-летние облигации США']),
        (t.exports['#TVC:US10-symbol-description'] = ['10-летние облигации США']),
        (t.exports['#TVC:USOIL-symbol-description'] = ['Нефть марки WTI']),
        (t.exports['#NYMEX:ITI1!-symbol-description'] = ['Фьючерсы на железную руду']),
        ...
        (t.exports['#NASDAQ:AMD-symbol-description'] = ['AMD (Advanced Micro Devices Inc.)']),
        (t.exports['#NYSE:BABA-symbol-description'] = 'Alibaba Group Holdings Ltd.'),
        ...
        (t.exports['#NYSE:F-symbol-description'] = ['Ford Motor Company (Форд)']),
        ...
        (t.exports['#LSIN:MNOD-symbol-description'] = ['ОАО ГМК Норильский никель (РЕПО)']),
        ...
        (t.exports['#NYSE:PBR-symbol-description'] = ['Petroleo Brasileiro Petrobras SA']),
        ...
        (t.exports['#AMEX:SCHO-symbol-description'] = ['Краткосрочные облигации США SCHWAB ETF']),
        ...
        (t.exports['#TVC:VIX-symbol-description'] = ['Индекс волатильности S&P 500']),
        ...
        (t.exports['#CBOT:ZS1-symbol-description'] = ['Фьючерсы на соевые бобы']),
        (t.exports['#CBOT:ZW-symbol-description'] = ['Пшеница']),
        (t.exports['#CBOT:ZW1-symbol-description'] = ['Фьючерсы на пшеницу']),
        (t.exports['#NASDAQ:ITI-symbol-description'] = 'Iteris Inc'),
        (t.exports['#NYMEX:ITI2!-symbol-description'] = ['Фьючерсы на железную руду']),
        (t.exports['#CADUSD-symbol-description'] = ['Канадский доллар / Доллар США']),
        (t.exports['#CHFUSD-symbol-description'] = ['Швейцарский франк / Доллар США']),
        (t.exports['#GPW:ACG-symbol-description'] = 'Acautogaz'),
        (t.exports['#JPYUSD-symbol-description'] = ['Японская иена / Доллар США']),
        (t.exports['#USDAUD-symbol-description'] = ['Доллар США / Австралийский доллар']),
        (t.exports['#USDEUR-symbol-description'] = ['Доллар США / Евро']),
        (t.exports['#USDGBP-symbol-description'] = ['Доллар США / Британский фунт']),
        (t.exports['#USDNZD-symbol-description'] = ['Доллар США / Новозеландский доллар']),
        (t.exports['#UKOIL-symbol-description'] = ['Нефть марки Brent']),
        (t.exports['#USOIL-symbol-description'] = ['Нефть марки WTI']),
        (t.exports['#US30-symbol-description'] = ['Промышленный индекс Доу — Джонса']),
        (t.exports['#BCHUSD-symbol-description'] = ['Bitcoin Cash / Доллар США']),
        (t.exports['#ETCUSD-symbol-description'] = ['Эфириум Классик / Доллар США']),
        ...
        (t.exports['#ETCBTC-symbol-description'] = ['Эфириум Классик / Биткоин']),
        (t.exports['#ETHBTC-symbol-description'] = ['Эфириум / Биткоин']),
        (t.exports['#XRPBTC-symbol-description'] = ['XRP / Биткоин']),
        (t.exports['#TVC:US30-symbol-description'] = ['30-летние облигации США']),
        (t.exports['#COMEX:SI1!-symbol-description'] = ['Фьючерсы на серебро']),
        (t.exports['#BTGUSD-symbol-description'] = ['Bitcoin Gold / Доллар США']),
        (t.exports['#IOTUSD-symbol-description'] = ['IOTA / Доллар США']),
        (t.exports['#CME:BTC1!-symbol-description'] = ['Фьючерсы на биткоин (CME)']),
        ...
        (t.exports['#DJ:DJA-symbol-description'] = ['Индекс Dow Jones Composite Average']),
        (t.exports['#DJ:DJI-symbol-description'] = ['Промышленный индекс Доу — Джонса']),
        (t.exports['#ETHEUR-symbol-description'] = ['Эфириум / Евро']),
        (t.exports['#ETHGBP-symbol-description'] = ['Эфириум / Британский фунт']),
        (t.exports['#ETHJPY-symbol-description'] = ['Эфириум / Японская иена']),
        (t.exports['#EURNOK-symbol-description'] = ['Евро / Норвежская крона']),
        (t.exports['#GBPPLN-symbol-description'] = ['Британский фунт / Польский злотый']),
        (t.exports['#MOEX:BR1!-symbol-description'] = ['Фьючерсы на нефть Brent']),
        (t.exports['#NYMEX:KG1!-symbol-description'] = ['Фьючерсы на хлопок']),
        ...
        (t.exports['#USDZAR-symbol-description'] = ['Доллар США / Южноафриканский ранд']),
        (t.exports['#WHEATUSD-symbol-description'] = ['CFD на пшеницу']),
        (t.exports['#XRPEUR-symbol-description'] = ['XRP / Евро']),
        (t.exports['#CBOT:S1!-symbol-description'] = ['Фьючерсы на соевые бобы']),
        ...
        (t.exports['#TVC:PLATINUM-symbol-description'] = ['CFD на платину (US$ / OZ)']),
        (t.exports['#TVC:SSMI-symbol-description'] = ['Индекс Swiss Market']),
        (t.exports['#TVC:SXY-symbol-description'] = ['Индекс швейцарского франка']),
        (t.exports['#TVC:RUI-symbol-description'] = ['Индекс Russell 1000']),
        (t.exports['#MOEX:RI1!-symbol-description'] = ['Фьючерсы на индекс РТС']),
        (t.exports['#MOEX:MX1!-symbol-description'] = ['Фьючерсы на индекс МосБиржи']),
        (t.exports['#CBOE:BG1!-symbol-description'] = ['Фьючерсы на биткоин (CBOE)']),
        (t.exports['#TVC:MY10-symbol-description'] = ['10-летние облигации Малайзии']),
        (t.exports['#CME:S61!-symbol-description'] = ['Фьючерсы на швейцарский франк']),
        (t.exports['#TVC:DEU30-symbol-description'] = ['Индекс DAX']),
        (t.exports['#BCHEUR-symbol-description'] = ['Bitcoin Cash / Евро']),
        (t.exports['#TVC:ZXY-symbol-description'] = ['Индекс новозеландского доллара']),
        ...
        (t.exports['#FX:US30-symbol-description'] = ['Промышленный индекс Доу — Джонса']),
        (t.exports['#MOEX:RUAL-symbol-description'] = 'United Company RUSAL PLC'),
        (t.exports['#MOEX:MX2!-symbol-description'] = ['Фьючерсы на индекс МосБиржи']),
        ...
        (t.exports['#TVC:GB10Y-symbol-description'] = ['Доходность 10-летних облигаций Британии']),
        (t.exports['#TVC:AU10Y-symbol-description'] = ['Доходность 10-летних облигаций Австралии']),
        (t.exports['#TVC:CN10Y-symbol-description'] = ['Доходность 10-летних облигаций Китая']),
        (t.exports['#TVC:DE10Y-symbol-description'] = ['Доходность 10-летних облигаций Германии']),
        (t.exports['#TVC:ES10Y-symbol-description'] = ['Доходность 10-летних облигаций Испании']),
        (t.exports['#TVC:FR10Y-symbol-description'] = ['Доходность 10-летних облигаций Франции']),
        (t.exports['#TVC:IN10Y-symbol-description'] = ['Доходность 10-летних облигаций Индии']),
        (t.exports['#TVC:IT10Y-symbol-description'] = ['Доходность 10-летних облигаций Италии']),
        (t.exports['#TVC:JP10Y-symbol-description'] = ['Доходность 10-летних облигаций Японии']),
        (t.exports['#TVC:KR10Y-symbol-description'] = ['Доходность 10-летних облигаций Кореи']),
        (t.exports['#TVC:MY10Y-symbol-description'] = ['Доходность 10-летних облигаций Малайзии']),
        (t.exports['#TVC:PT10Y-symbol-description'] = [
          'Доходность 10-летних облигаций Португалии',
        ]),
        (t.exports['#TVC:TR10Y-symbol-description'] = ['Доходность 10-летних облигаций Турции']),
        (t.exports['#TVC:US02Y-symbol-description'] = ['Доходность 2-летних облигаций США']),
        (t.exports['#TVC:US05Y-symbol-description'] = ['Доходность 5-летних облигаций США']),
        (t.exports['#TVC:US10Y-symbol-description'] = ['Доходность 10-летних облигаций США']),
        (t.exports['#INDEX:TWII-symbol-description'] = ['Тайваньский взвешенный индекс']),
        (t.exports['#CME:J61!-symbol-description'] = ['Фьючерсы на японскую иену']),
        (t.exports['#CME_MINI:J71!-symbol-description'] = ['Фьючерсы на японскую иену (E-mini)']),
        (t.exports['#CME_MINI:WM1!-symbol-description'] = [
          'Фьючерсы на японскую иену / доллар США (E-micro)',
        ]),
        (t.exports['#CME:M61!-symbol-description'] = ['Фьючерсы на мексиканский песо']),
        (t.exports['#CME:T61!-symbol-description'] = ['Фьючерсы на южноафриканский ранд']),
        (t.exports['#CME:SK1!-symbol-description'] = ['Фьючерсы на шведскую крону']),
        ...
        (t.exports['#CME:L61!-symbol-description'] = ['Фьючерсы на бразильский реал']),
        (t.exports['#CME:WP1!-symbol-description'] = ['Фьючерсы на польский злотый']),
        (t.exports['#CME:N61!-symbol-description'] = ['Фьючерсы на новозеландский доллар']),
        ...
        (t.exports['#CME_MINI:E71!-symbol-description'] = ['Фьючерсы на евро (E-mini)']),
        ...
        (t.exports['#NYMEX_MINI:QU1!-symbol-description'] = ['Фьючерсы на бензин (E-mini)']),
        (t.exports['#NYMEX_MINI:QX1!-symbol-description'] = ['Фьючерсы на мазут (E-mini)']),
        (t.exports['#COMEX_MINI:QC1!-symbol-description'] = ['Фьючерсы на медь (E-mini)']),
        (t.exports['#NYMEX_MINI:QG1!-symbol-description'] = ['Фьючерсы на природный газ (E-mini)']),
        (t.exports['#CME:E41!-symbol-description'] = ['Фьючерсы на доллар США / турецкую лиру']),
        (t.exports['#COMEX_MINI:QI1!-symbol-description'] = ['Фьючерсы на серебро (мини)']),
        (t.exports['#CME:DL1!-symbol-description'] = ['Фьючерсы на молоко класса III']),
        (t.exports['#NYMEX:UX1!-symbol-description'] = ['Фьючерсы на уран']),
        (t.exports['#CBOT:BO1!-symbol-description'] = ['Фьючерсы на соевое масло']),
        (t.exports['#CME:HE1!-symbol-description'] = ['Фьючерсы на свинину']),
        (t.exports['#NYMEX:IAC1!-symbol-description'] = ['Фьючерсы на Newcastle Coal']),
        (t.exports['#NYMEX_MINI:QM1!-symbol-description'] = ['Фьючерсы на E-mini Light Crude Oil']),
        (t.exports['#NYMEX:JMJ1!-symbol-description'] = ['Фьючерсы на Mini Brent Financial']),
        (t.exports['#COMEX:AEP1!-symbol-description'] = ['Фьючерсы на Aluminium European Premium']),
        (t.exports['#CBOT:ZQ1!-symbol-description'] = [
          'Фьючерсы на 30-дневную процентную ставку по федеральным фондам',
        ]),
        (t.exports['#CME:LE1!-symbol-description'] = ['Фьючерсы на живой скот']),
        ...
        (t.exports['#CME:GF1!-symbol-description'] = ['Фьючерсы на крупный рогатый скот']),
        (t.exports['#CBOT:UD1!-symbol-description'] = ['Фьючерсы на Ultra T-Bond']),
        ...
        (t.exports['#CBOT:ZM1!-symbol-description'] = ['Фьючерсы на соевую муку']),
        (t.exports['#CBOT_MINI:XN1!-symbol-description'] = ['Фьючерсы на кукурузу (мини)']),
        (t.exports['#CBOT:ZC1!-symbol-description'] = ['Фьючерсы на кукурузу']),
        (t.exports['#CME:LS1!-symbol-description'] = ['Фьючерсы на лесоматериалы']),
        (t.exports['#CBOT_MINI:XW1!-symbol-description'] = ['Фьючерсы на пшеницу (мини)']),
        (t.exports['#CBOT_MINI:XK1!-symbol-description'] = ['Фьючерсы на соевые бобы (мини)']),
        (t.exports['#CBOT:ZS1!-symbol-description'] = ['Фьючерсы на соевые бобы']),
        (t.exports['#NYMEX:PA1!-symbol-description'] = ['Фьючерсы на палладий']),
        (t.exports['#CME:FTU1!-symbol-description'] = ['Фьючерсы на E-mini FTSE 100 Index USD']),
        (t.exports['#CBOT:ZR1!-symbol-description'] = ['Фьючерсы на рис']),
        (t.exports['#COMEX_MINI:GR1!-symbol-description'] = ['Фьючерсы на золото (E-micro)']),
        (t.exports['#COMEX_MINI:QO1!-symbol-description'] = ['Фьючерсы на золото (мини)']),
        (t.exports['#CME_MINI:RL1!-symbol-description'] = ['Фьючерсы на E-mini Russell 1000']),
        (t.exports['#CME_MINI:EW1!-symbol-description'] = ['Фьючерсы на S&P 400 Midcap E-mini']),
        (t.exports['#COMEX:LD1!-symbol-description'] = ['Фьючерсы на свинец']),
        (t.exports['#CME_MINI:ES1!-symbol-description'] = ['Фьючерсы на E-mini S&P 500']),
        (t.exports['#TVC:SA40-symbol-description'] = ['Индекс South Africa Top 40']),
        ...
        (t.exports['#BVL:SPBLPGPT-symbol-description'] = ['Индекс S&P / BVL Peru General (PEN)']),
        (t.exports['#EGX:EGX30-symbol-description'] = ['Индекс EGX 30 Price Return']),
        ...
        (t.exports['#NZX:NZ50G-symbol-description'] = ['Индекс S&P / NZX 50 Gross']),
        (t.exports['#SIX:SMI-symbol-description'] = ['Индекс Swiss Market']),
        (t.exports['#SZSE:399001-symbol-description'] = ['Индекс SZSE Component']),
        (t.exports['#TADAWUL:TASI-symbol-description'] = ['Индекс Tadawul All Shares']),
        (t.exports['#IDX:COMPOSITE-symbol-description'] = ['Индекс IDX Composite']),
        (t.exports['#EURONEXT:PX1-symbol-description'] = ['Индекс CAC 40']),
        (t.exports['#OMXHEX:OMXH25-symbol-description'] = ['Индекс OMX Helsinki 25']),
        ...
        (t.exports['#TVC:KOSPI-symbol-description'] = ['Индекс Korea Composite Stock Price']),
        (t.exports['#FTSEMYX:FBMKLCI-symbol-description'] = ['Индекс FTSE Bursa Malaysia KLCI']),
        (t.exports['#TASE:TA35-symbol-description'] = ['Индекс TA-35']),
        (t.exports['#OMXSTO:OMXS30-symbol-description'] = ['Индекс OMX Stockholm 30']),
        (t.exports['#OMXICE:OMXI8-symbol-description'] = ['Индекс OMX Iceland 8']),
        (t.exports['#NSENG:NSE30-symbol-description'] = ['Индекс NSE 30']),
        (t.exports['#BAHRAIN:BSEX-symbol-description'] = ['Индекс Bahrain All Share']),
        (t.exports['#OMXTSE:OMXTGI-symbol-description'] = ['Индекс OMX Tallinn GI']),
        (t.exports['#OMXCOP:OMXC25-symbol-description'] = ['Индекс OMX Copenhagen 25']),
        (t.exports['#OMXRSE:OMXRGI-symbol-description'] = ['Индекс OMX Riga GI']),
        (t.exports['#BELEX:BELEX15-symbol-description'] = ['Индекс BELEX 15']),
        (t.exports['#OMXVSE:OMXVGI-symbol-description'] = ['Индекс OMX Vilnius GI']),
        (t.exports['#EURONEXT:AEX-symbol-description'] = ['Индекс AEX']),
        (t.exports['#CBOE:VIX-symbol-description'] = ['Индекс волатильности S&P 500']),
        (t.exports['#NASDAQ:XAU-symbol-description'] = ['Индекс PHLX Gold and Silver Sector']),
        (t.exports['#DJ:DJUSCL-symbol-description'] = ['Индекс Dow Jones U.S. Coal']),
        (t.exports['#DJ:DJCIKC-symbol-description'] = ['Индекс Dow Jones Commodity Coffee']),
        (t.exports['#DJ:DJCIEN-symbol-description'] = ['Индекс Dow Jones Commodity Energy']),
        (t.exports['#NASDAQ:OSX-symbol-description'] = ['Индекс PHLX Oil Service Sector']),
        (t.exports['#DJ:DJCISB-symbol-description'] = ['Индекс Dow Jones Commodity Sugar']),
        (t.exports['#DJ:DJCICC-symbol-description'] = ['Индекс Dow Jones Commodity Cocoa']),
        (t.exports['#DJ:DJCIGR-symbol-description'] = ['Индекс Dow Jones Commodity Grains']),
        (t.exports['#DJ:DJCIAGC-symbol-description'] = [
          'Индекс Dow Jones Commodity Agriculture Capped Component',
        ]),
        (t.exports['#DJ:DJCISI-symbol-description'] = ['Индекс Dow Jones Commodity Silver']),
        (t.exports['#DJ:DJCIIK-symbol-description'] = ['Индекс Dow Jones Commodity Nickel']),
        (t.exports['#NASDAQ:HGX-symbol-description'] = ['Индекс PHLX Housing Sector']),
        (t.exports['#DJ:DJCIGC-symbol-description'] = ['Индекс Dow Jones Commodity Gold']),
        (t.exports['#SP:SPGSCI-symbol-description'] = ['Индекс S&P Goldman Sachs Commodity']),
        (t.exports['#NASDAQ:UTY-symbol-description'] = ['Индекс PHLX Utility Sector']),
        (t.exports['#DJ:DJU-symbol-description'] = ['Индекс Dow Jones Utility Average']),
        ...
        (t.exports['#NASDAQ:SOX-symbol-description'] = ['Индекс Philadelphia Semiconductor']),
        (t.exports['#RUSSELL:RUI-symbol-description'] = ['Индекс Russell 1000']),
        (t.exports['#RUSSELL:RUA-symbol-description'] = ['Индекс Russell 3000']),
        (t.exports['#RUSSELL:RUT-symbol-description'] = ['Индекс Russell 2000']),
        (t.exports['#NYSE:XMI-symbol-description'] = ['Индекс NYSE ARCA Major Market']),
        (t.exports['#NYSE:XAX-symbol-description'] = ['Индекс AMEX Composite']),
        (t.exports['#NASDAQ:NDX-symbol-description'] = ['Индекс Nasdaq 100']),
        (t.exports['#NASDAQ:IXIC-symbol-description'] = ['Индекс Nasdaq Composite']),
        (t.exports['#DJ:DJT-symbol-description'] = ['Индекс Dow Jones Transportation Average']),
        (t.exports['#NYSE:NYA-symbol-description'] = ['Индекс NYSE Composite']),
        (t.exports['#NYMEX:CJ1!-symbol-description'] = ['Фьючерсы на какао']),
        (t.exports['#USDILS-symbol-description'] = ['Доллар США / Израильский шекель']),
        (t.exports['#TSXV:F-symbol-description'] = 'Fiore Gold Inc'),
        (t.exports['#SIX:F-symbol-description'] = ['Ford Motor Company (Форд)']),
        (t.exports['#BMV:F-symbol-description'] = ['Ford Motor Company (Форд)']),
        (t.exports['#TWII-symbol-description'] = ['Тайваньский взвешенный индекс']),
        (t.exports['#TVC:PL10Y-symbol-description'] = ['Доходность 10-летних облигаций Польши']),
        (t.exports['#TVC:PL05Y-symbol-description'] = ['Доходность 5-летних облигаций Польши']),
        ...
        (t.exports['#BYBIT:ETHUSD-symbol-description'] = ['ETHUSD Бессрочный контракт']),
        (t.exports['#BYBIT:XRPUSD-symbol-description'] = ['XRPUSD Бессрочный контракт']),
        (t.exports['#BYBIT:BTCUSD-symbol-description'] = ['BTCUSD Бессрочный контракт']),
        (t.exports['#BITMEX:ETHUSD-symbol-description'] = ['ETHUSD Бессрочный контракт']),
        (t.exports['#DERIBIT:BTCUSD-symbol-description'] = ['BTCUSD Бессрочный контракт']),
        (t.exports['#DERIBIT:ETHUSD-symbol-description'] = ['ETHUSD Бессрочный контракт']),
        (t.exports['#USDHUF-symbol-description'] = ['Доллар США / Венгерский форинт']),
        (t.exports['#USDTHB-symbol-description'] = ['Доллар США / Тайский бат']),
        ...
        (t.exports['#BITMEX:XBT-symbol-description'] = ['Биткоин / Индекс доллара США']),
        ...
        (t.exports['#ICEUS:DX1!-symbol-description'] = ['Фьючерсы на Индекс доллара США']),
        (t.exports['#NYMEX:TT1!-symbol-description'] = ['Фьючерсы на хлопок']),
        (t.exports['#PHEMEX:BTCUSD-symbol-description'] = ['BTC ETHUSD Бессрочный контракт']),
        (t.exports['#PHEMEX:ETHUSD-symbol-description'] = ['ETH Бессрочный контракт']),
        (t.exports['#PHEMEX:XRPUSD-symbol-description'] = ['XRP Бессрочный контракт']),
        (t.exports['#PHEMEX:LTCUSD-symbol-description'] = ['LTC Бессрочный контракт']),
        ...
        (t.exports['#TVC:CA10-symbol-description'] = ['Гособлигации Канады, 10 лет']),
        (t.exports['#TVC:CA10Y-symbol-description'] = ['Доходность 10-летних облигаций Канады']),
        (t.exports['#TVC:ID10Y-symbol-description'] = ['Доходность 10-летних облигаций Индонезии']),
        (t.exports['#TVC:NL10-symbol-description'] = ['Гособлигации Нидерландов, 10 лет']),
        (t.exports['#TVC:NL10Y-symbol-description'] = [
          'Доходность 10-летних облигаций Нидерландов',
        ]),
        (t.exports['#TVC:NZ10-symbol-description'] = ['Гособлигации Новой Зеландии, 10 лет']),
        ...
        (t.exports['#LTCBRL-symbol-description'] = ['Лайткоин / Бразильский реал']),
        (t.exports['#ETCEUR-symbol-description'] = ['Эфириум Классик / Евро']),
        (t.exports['#ETHKRW-symbol-description'] = ['Эфириум / Южнокорейская вона']),
        (t.exports['#BTCRUB-symbol-description'] = ['Биткоин / Российский рубль']),
        (t.exports['#BTCTHB-symbol-description'] = ['Биткоин / Тайский бат']),
        (t.exports['#ETHTHB-symbol-description'] = ['Эфириум / Тайский бат']),
        (t.exports['#TVC:EU10YY-symbol-description'] = ['Доходность 10-летних еврооблигаций']);
    },
  },
]);
