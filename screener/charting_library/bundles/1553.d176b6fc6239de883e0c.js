    ...
    111553: (t, e, i) => {
      ...
      !(function (r, s, o, a) {
          ...
          (i.isFirst = !!s),
            ...
            (function (t, e) {
              ...
              (e.overallVelocityX = c.x),
                ...
                (e.scale = o
                  ? ((l = o.pointers), (v = n), B(v[0], v[1], L) / B(l[0], l[1], L))
                  : 1),
                (e.rotation = o
                  ? (function (t, e) {
                      return $(e[1], e[0], L) + $(t[1], t[0], L);
                    })(o.pointers, n)
                  : 0),
        ...
        function V(t) {
          ...
          return { timeStamp: f(), pointers: e, center: j(e), deltaX: t.deltaX, deltaY: t.deltaY };
        }
        function j(t) {
          var e = t.length;
        ...
        var J = { mousedown: 1, mousemove: 2, mouseup: 4 },
          ...
          Q = 'mousemove mouseup';
        function tt() {
          (this.evEl = K), (this.evWin = Q), (this.pressed = !1), H.apply(this, arguments);
        }
        E(tt, H, {
          handler: function (t) {
            var e = J[t.type];
        ...
        var et = { pointerdown: 1, pointermove: 2, pointerup: 4, pointercancel: 8, pointerout: 8 },
          it = { 2: F, 3: 'pen', 4: k, 5: 'kinect' },
          nt = 'pointerdown',
        ...
        r.MSPointerEvent &&
          !r.PointerEvent &&
          ((nt = 'MSPointerDown'), (rt = 'MSPointerMove MSPointerUp MSPointerCancel')),
          E(st, H, {
            handler: function (t) {
              var e = this.store,
                i = !1,
        ...
        function ut() {
          (this.evTarget = at), (this.evWin = ht), (this.started = !1), H.apply(this, arguments);
        }
        function ct(t, e) {
          var i = x(t.touches),
        ...
        var lt = { touchstart: 1, touchmove: 2, touchend: 4, touchcancel: 8 },
        ...
        function vt(t, e) {
          ...
          for (r = 0; r < o.length; )
            n[o[r].identifier] && a.push(o[r]), 12 & e && delete n[o[r].identifier], r++;
        ...
        Dt.prototype = {
          set: function (t) {
            t == It && (t = this.compute()),
              Et && this.manager.element.style && Pt[t] && (this.manager.element.style[yt] = t),
          ...
          preventDefaults: function (t) {
            ...
            if (this.manager.session.prevented) e.preventDefault();
              ...
              if (!o || !s) return r || (s && 6 & i) || (o && i & W) ? this.preventSrc(e) : void 0;
            }
          },
        ...
        function qt(t, e) {
          return ((e = e || {}).recognizers = C(e.recognizers, qt.defaults.preset)), new Lt(t, e);
        }
        (xt.prototype = {
          defaults: {},
          set: function (t) {
          ...
          requireFailure: function (t) {
            ...
            return -1 === w(e, (t = Mt(t, this))) && (e.push(t), t.requireFailure(this)), this;
          },
          ...
          recognize: function (t) {
            var e = h({}, t);
            if (!A(this.options.enable, [this, e])) return this.reset(), void (this.state = wt);
        ...
        function Lt(t, e) {
          ...
          (this.options = h({}, qt.defaults, e || {})),
            ...
            (this.oldCssProps = {}),
            (this.element = t),
            (this.input = new ((i = this).options.inputClass || (X ? st : Y ? ft : N ? dt : tt))(
              i,
              U,
            )),
