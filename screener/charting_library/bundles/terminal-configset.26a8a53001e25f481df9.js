(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8179, 959, 6437],
  {
      ...
      function i(e) {
        ...
        return {
          promise: new Promise((n, i) => {
            e.then(e => (t ? i(new r()) : n(e))), e.catch(e => i(t ? new r() : e));
          }),
          cancel() {
            t = !0;
          },
    ...
    695257: (e, t) => {
      ...
      var v = (T.prototype = new m());
      (v.constructor = T), f(v, _.prototype), (v.isPureReactComponent = !0);
      var k = Array.isArray,
      ...
      function O(e, t, r) {
        ...
        if (null != t)
          for (i in (void 0 !== t.ref && (s = t.ref), void 0 !== t.key && (o = '' + t.key), t))
            P.call(t, i) && !L.hasOwnProperty(i) && (a[i] = t[i]);
        ...
        return { $$typeof: n, type: e, key: o, ref: s, props: a, _owner: b.current };
      }
      function y(e) {
      ...
      var z = { current: null },
        A = { transition: null },
        x = { ReactCurrentDispatcher: z, ReactCurrentBatchConfig: A, ReactCurrentOwner: b };
      (t.Children = {
        map: I,
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          if (null != t) {
            if (
              (void 0 !== t.ref && ((o = t.ref), (s = b.current)),
    ...
    350159: e => {
      e.exports = {
        ...
        tradeButtonWrapper: 'tradeButtonWrapper-RoCcHn9S',
        tradeButton: 'tradeButton-RoCcHn9S',
      };
    },
    311138: e => {
    ...
    534771: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { getTerminalConfigSet: () => P });
      var r = n(509806);
      const i = {
        paper_trading: {
          name: 'paper_trading',
          ...
          (this._contentRenderer = Promise.resolve()),
            ...
            (0, o.waitTradingService)().then(e => {
              (this._trading = e),
                ...
                this._trading.onConnectionStatusChange.subscribe(this, this.onStatusChange);
            }),
            n
              .e(7102)
            ...
            (0, s.renderOfflineScreen)((0, a.ensureDefined)(this._offlineScreenContainer));
        }
        activate() {
          ...
          this._connectStatus !== e &&
            ...
            window.navigator.onLine
              ? ((this._contentRenderer = Promise.resolve()),
                ...
                3 !== e && 4 !== e
                  ? 1 === e && this._renderAccountManager(this._trading.activeBroker())
                  : this._renderSpinner())
      ...
      var c = n(50959),
        ...
        g = n(17212),
        f = n(350159);
      const S = r.t(null, void 0, n(477660)),
        _ = r.t(null, void 0, n(537435)),
        m =
          (r.t(null, void 0, n(287085)),
          { 4: 'failed', 2: 'connecting', 1: 'connected', 3: 'disconnected' }),
        T = {
          ...
          super(e),
            ...
            (this._update = () => {
              const e = this._trading,
                ...
                r = null !== e && e.tradingPanel.isOpeningAvailable.value();
              window.is_authenticated && !d.enabled('trading_terminal') && e && t && 1 === n
                ? this.setState({
                    status: n,
                    hasActiveBroker: !0,
                    title: t.accountManagerInfo().accountTitle,
                    isOpeningTradingPanelAvailable: r,
                  })
                : this.setState({
                    status: n,
                    hasActiveBroker: !1,
            ...
            (this._handleClickTradeButton = () => {
              null !== this._trading && this._trading.toggleTradingPanelVisibility();
            }),
            (this.state = {
              status: 3,
              hasActiveBroker: !1,
              title: d.enabled('trading_terminal') ? _ : S,
              isOpeningTradingPanelAvailable: !1,
              tradeButtonWidth: 0,
            });
        }
        componentDidMount() {
          if (d.enabled('trading_terminal')) return;
          const e = (0, o.tradingService)();
          null === e
            ? ((this._tradingServiceCancelable = (0, p.makeCancelable)(
                (0, o.waitTradingService)(),
              )),
              this._tradingServiceCancelable.promise.then(this._onTradingService.bind(this)))
            : this._onTradingService(e);
        }
        componentWillUnmount() {
          d.enabled('trading_terminal') ||
            (this._cancelWaitingTrading(),
            null !== this._trading &&
              (this._trading.onBrokerChange.unsubscribe(this, this._update),
              this._trading.onConnectionStatusChange.unsubscribe(this, this._update),
              this._trading.tradingPanel.isOpeningAvailable.unsubscribe(this._update)));
        }
        render() {
          const {
              status: e,
          ...
          return c.createElement(
            ...
            c.createElement(
              ...
              c.createElement('div', {
                className: u(f.indicator, 'apply-common-tooltip'),
                title: T[e],
              }),
            ),
            false,
      ...
      function c(e) {
        ...
        return r.createElement(
          p,
          {
            ...
            'data-tooltip': t,
            className: a()(l.tab, s.PLATFORM_ACCESSIBILITY_ENABLED && l.accessible, i),
          },
          n,
        );
      }
    ...
    112235: (e, t, n) => {
      ...
      function s() {
        return r.createElement(
          'div',
          { className: o.wrapper },
          r.createElement('p', { className: o.text }, a.t(null, void 0, n(394021))),
        );
      }
      function l(e) {
    ...
    656846: (e, t, n) => {
      'use strict';
      var r, i, a, o, s, l, c, u, d, p, h, g, f, S, _;
      n.d(t, {
        BracketType: () => u,
        DisconnectType: () => f,
    ...
    484095: (e, t, n) => {
      ...
      class i extends Error {
        constructor({ detailedErrorMessage: e, userFriendlyMessage: t, cause: n }) {
          super(t),
    ...
    637401: (e, t, n) => {
      ...
      n.d(t, {
        ...
        makeNonTradableSymbolText: () => L,
        orderStatusToText: () => S,
        orderTypeToText: () => T,
        positionSideToText: () => b,
        roundDownToPowerOf10: () => k,
        roundToStepByPriceTypeAndSide: () => v,
        sideToText: () => m,
      });
      var r = n(509806),
        i = n(960521),
      ...
      function _() {
        f ||
          ((f = !0),
          (u[2][2] = r.t(null, { context: 'Market order' }, n(610952))),
          (u[2][1] = r.t(null, { context: 'Limit order' }, n(382377))),
          (u[2][3] = r.t(null, { context: 'order' }, n(608921))),
          (u[2][4] = r.t(null, { context: 'Stop limit order' }, n(779062))),
          (u[1][2] = r.t(null, void 0, n(359758))),
          (u[1][1] = r.t(null, void 0, n(398157))),
          (u[1][3] = r.t(null, { context: 'order' }, n(7122))),
          (u[1][4] = r.t(null, void 0, n(900853))),
          (d[2][a.BracketType.TakeProfit] = r.t(null, { context: 'Take profit order' }, n(347947))),
          (d[2][a.BracketType.StopLoss] = r.t(null, { context: 'Stop loss order' }, n(15307))),
          (d[2][a.BracketType.TrailingStop] = r.t(
            null,
            { context: 'Trailing stop order' },
            n(154462),
          )),
          (d[1][a.BracketType.TakeProfit] = r.t(null, void 0, n(129266))),
          (d[1][a.BracketType.StopLoss] = r.t(null, void 0, n(241648))),
          (d[1][a.BracketType.TrailingStop] = r.t(null, void 0, n(86430))),
      ...
      function T(e) {
        const { orderType: t, uppercase: n, shorten: r, parentId: i, stopType: s } = e;
        _();
        const l = r ? 2 : 1;
        let c = u,
          p = t;
      ...
      function y(e) {
        return e instanceof c.UserFriendlyError ? (0, l.removeTags)(e.detailedErrorMessage) : O(e);
      }
      a.BracketType.StopLoss,
      ...
      function E(e) {
        return (0, c.isUserFriendlyError)(e) && void 0 !== e.cause ? [...E(e.cause), e.cause] : [e];
      }
    },
    481330: (e, t, n) => {
      'use strict';
      n.d(t, {
        adjustSavedCustomFieldsValues: () => N,
        bottomTradingTabClassName: () => h,
        brokersListFromPlans: () => g,
        checkIsExistingPosition: () => K,
        convertActionDescriptionsToActions: () => _,
        executionText: () => S,
        filterDurationsByOrderType: () => x,
        filterDurationsBySymbolDurations: () => A,
        findDurationMetaInfo: () => C,
        getAsk: () => j,
        getBid: () => Y,
        getCurrency: () => k,
        ...
        getTimestamp: () => B,
        isBatsQuotes: () => y,
        isBrokerSupportOrderModification: () => b,
        isDefined: () => E,
        isMintickMultiple: () => w,
        isModifyOrderSupported: () => L,
        isMoveOrderSupported: () => O,
        isNoQuotes: () => H,
        isOAuthAuthType: () => f,
        isOrderActive: () => m,
        makeBrokerSideMaintananceFeatureToggleName: () => T,
        makeDatePlus24UTCHours: () => M,
        makeInitialOrderDuration: () => D,
        makeMaintananceFeatureToggleName: () => v,
        makeOrderDuration: () => z,
        orderStatusToText: () => d.orderStatusToText,
        roundToStepRequired: () => V,
      });
      var r = n(960521),
        i = n(650151),
        a = n(372605),
        ...
        d = n(637401);
      const p = 'Paper',
        h = 'js-bottom-trading-tab';
      function g(e, t) {
        const n = new Map(e.map(e => [e.id, e])),
          r = new Map(t.map(e => [e.slug_name, e])),
          a = [{ metainfo: (0, i.ensureDefined)(n.get(p)) }];
        return (
          t.forEach(e => {
            n.has(e.slug_name) &&
              a.push({ metainfo: (0, i.ensureDefined)(n.get(e.slug_name)), brokerPlan: e });
          }),
          e.forEach(e => {
            r.has(e.id) || e.id === p || a.push({ metainfo: e });
          }),
          a
        );
      }
      ...
      function S(e, t) {
        const n = (0, d.sideToText)(e.side) + ' ' + e.qty + ' @ ' + t.format(e.price);
      ...
      function L(e, t) {
        const n = 2 !== e.type && void 0 === e.parentId && b(t),
          r = P(e, t);
        return n || r;
      }
      function O(e, t) {
      ...
      function I(e) {
        ...
        const o = (function (e) {
          const { duration: t, orderDurations: n, orderType: r, symbolDurations: i } = e;
          if (null === t || void 0 === n) return null;
          const a = A(n, i),
            o = C(x(a, null != r ? r : null), t.type);
      ...
      function D(e, t, n) {
        ...
        return z(null !== (r = i.find(e => e.default)) && void 0 !== r ? r : i[0]);
      }
      function z(e) {
        const t = { type: e.value };
        return Boolean(e.hasTimePicker || e.hasDatePicker) && (t.datetime = B(M())), t;
      }
      function A(e, t) {
      ...
      function w(e, t) {
        if (0 === t) return !1;
        const n = Math.round(1e12 * t) / 1e12,
          i = new r.Big(e),
          a = new r.Big(n);
        return i.mod(a).eq(0);
      }
      function j(e) {
        return (0, a.isNumber)(e.ask) ? e.ask : (0, a.isNumber)(e.trade) ? e.trade : 0;
      }
      function Y(e) {
        return (0, a.isNumber)(e.bid) ? e.bid : (0, a.isNumber)(e.trade) ? e.trade : 0;
      }
      function U(e) {
      ...
      function W(e) {
        ...
        return 1 === t && void 0 !== a
          ...
          ? o
          : void 0 !== i && void 0 !== r
          ? (0, u.getMinTick)({ minTick: n, price: r, variableMinTickData: i })
          : n;
      }
      function V(e) {
        const { priceType: t, minTick: n, limitPriceStep: r, stopPriceStep: i } = e;
        return 1 === t && void 0 !== r ? r !== n : 2 === t && void 0 !== i && i !== n;
      }
      function K(e) {
    ...
    906052: e => {
      e.exports = {
        ...
        pt: ['Fechar gerenciador da conta'],
    ...
    781414: e => {
      e.exports = {
        ...
        ro: 'Open Pine Editor',
        ru: ['Открыть редактор Pine Script™ в новой вкладке'],
    ...
    199345: e => {
      e.exports = {
        ar: 'Order Panel & DOM',
        ca_ES: 'Order Panel & DOM',
        cs: 'Order Panel & DOM',
        de: ['Order-Panel & DOM'],
        el: 'Order Panel & DOM',
        en: 'Order Panel & DOM',
        es: ['Panel de órdenes o DOM'],
        fa: 'Order Panel & DOM',
        fr: ["Panneau d'ordres & DOM"],
        he_IL: ['לוח פקודות ו-DOM'],
        hu_HU: 'Order Panel & DOM',
        id_ID: ['Panel Order & DOM'],
        it: 'Order Panel & DOM',
        ja: ['注文パネル＆板情報'],
        ko: ['주문 패널 및 DOM'],
        ms_MY: ['Panel Pesanan & DOM'],
        nl_NL: 'Order Panel & DOM',
        pl: 'Order Panel & DOM',
        pt: ['Painel de Ordens & DOM'],
        ro: 'Order Panel & DOM',
        ru: ['Панель заявок и Стакан заявок (DOM)'],
        sv: 'Order Panel & DOM',
        th: 'Order Panel & DOM',
        tr: 'Order Panel & DOM',
        vi: 'Order Panel & DOM',
        zh: ['订单面板和DOM'],
        zh_TW: 'Order Panel & DOM',
      };
    },
    394021: e => {
      e.exports = {
    ...
    629208: e => {
      e.exports = {
        ar: 'Place an order via Order Panel or DOM',
        ...
        es: ['Enviar una orden a través del Panel de órdenes o DOM'],
        ...
        it: 'Place an order via Order Panel or DOM',
        ja: ['注文パネル／板情報で注文する'],
        ...
        pl: 'Place an order via Order Panel or DOM',
        ...
        tr: 'Place an order via Order Panel or DOM',
        vi: 'Place an order via Order Panel or DOM',
        zh: ['通过订单面板或DOM下订单'],
        zh_TW: 'Place an order via Order Panel or DOM',
      };
    },
    129266: e => {
      e.exports = {
    ...
    328523: e => {
      e.exports = {
        ...
        hu_HU: ['Ismeretlen hiba'],
        id_ID: ['Kesalahan tidak diketahui'],
        it: ['Errore sconosciuto'],
        ja: ['不明のエラー'],
        ko: ['알수 없는 에러'],
        ms_MY: ['Ralat yang tidak diketahui'],
        nl_NL: 'Unknown error',
        pl: ['Nieznany błąd'],
    ...
    514018: e => {
      e.exports = {
        ar: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        ca_ES: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        cs: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        de: [
          'Sie können Order im Order-Panel & DOM platzieren, indem Sie den {tradeButtonText} Button verwenden',
        ],
        el: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        en: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        es: [
          'Puede enviar órdenes a través del Panel de órdenes y DOM utilizando el botón {tradeButtonText}',
        ],
        fa: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        fr: [
          "Vous pouvez passer des ordres via le panneau d'ordres et le DOM en utilisant le bouton {tradeButtonText}",
        ],
        he_IL: ['אתה יכול למקם פקודות דרך לוח הפקודות ו-DOM באמצעות הלחצן {tradeButtonText}'],
        hu_HU: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        id_ID: [
          'Anda dapat meletakkan order melalui Panel Order & DOM menggunakan tombol {tradeButtonText}',
        ],
        it: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        ja: ['{tradeButtonText}ボタンを利用して、注文パネルまたは板情報から注文することができます'],
        ko: ['{tradeButtonText} 버튼을 사용하여 주문 패널 및 DOM을 통해 주문할 수 있습니다.'],
        ms_MY: [
          'Anda boleh melakukan pesanan menerusi Panel Pesanan & DOM menggunakan butang {tradeButtonText}',
        ],
        nl_NL: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        pl: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        pt: [
          'Você pode colocar ordens por meio do Painel de Ordens & DOM usando o botão {tradeButtonText}',
        ],
        ro: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        ru: [
          'Вы можете размещать заявки через Панель заявок и Стакан заявок (DOM) с помощью кнопки {tradeButtonText}',
        ],
        sv: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        th: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        tr: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        vi: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
        zh: ['您可以使用{tradeButtonText}按钮，通过订单面板和DOM下订单'],
        zh_TW: 'You can place orders through Order Panel & DOM using the {tradeButtonText} button',
      };
    },
    221456: e => {
      e.exports = {
        ar: ['لا يمكنك تداول الرمز {symbol} على ‎{broker}‎ من خلال Tradingview.'],
        ca_ES: ['No podeu negociar el símbol {symbol} a TradingView a través de {broker}.'],
        cs: "You can't trade the symbol {symbol} at TradingView via {broker}.",
        de: ['Sie können das Symbol {symbol} bei TradingView nicht mit {broker} handeln.'],
        ...
        es: ['No puede negociar el símbolo {symbol} en TradingView a través de {broker}.'],
        ...
        he_IL: ['אינך יכול לסחור בסימול {symbol} ב TradingView באמצעות {broker}.'],
        hu_HU: "You can't trade the symbol {symbol} at TradingView via {broker}.",
        id_ID: [
        ...
        ja: ['TradingViewでシンボル {symbol} を {broker} で取引することはできません。'],
        ko: [
        ...
        nl_NL: "You can't trade the symbol {symbol} at TradingView via {broker}.",
        pl: ['Na TradingView nie możesz handlować na {symbol} za pośrednictwem {broker}.'],
        pt: ['Você não pode negociar esse símbolo {symbol} no TradingView por meio da {broker}.'],
        ...
        th: ['คุณไม่สามารถทำการซื้อขายสัญลักษณ์ {symbol} บน TradingView ผ่าน {broker} ได้'],
        tr: ['{symbol} sembolünde {broker} aracılığıyla işlem yapamazsınız.'],
        vi: ['Bạn không thể giao dịch mã {symbol} trên Tradingview thông qua {broker}.'],
