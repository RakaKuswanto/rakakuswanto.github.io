  ...
  [8643],
  {
    ...
    759339: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        u = o(966076);
      function m(e) {
        const { position: t = 'Bottom', onClose: o, children: d, className: m, theme: v = u } = e,
          f = (0, r.ensureNotNull)((0, n.useContext)(i.DrawerContext)),
    ...
    624216: (e, t, o) => {
      ...
      function m(e) {
        const {
          ...
          y = (0, n.useContext)(i.CloseDelegateContext),
          b = n.useContext(u),
          C = (0, n.useContext)(c),
    ...
    742554: (e, t, o) => {
      ...
      const l = (0, n.forwardRef)((e, t) => {
        const { children: o, ...a } = e,
          l = (0, n.useRef)(null);
        return (
          (0, n.useImperativeHandle)(t, () => l.current),
          (0, n.useLayoutEffect)(() => {
            if (s.CheckMobile.iOS())
              return (
                null !== l.current && (0, r.disableBodyScroll)(l.current, { allowTouchMove: i(l) }),
                () => {
                  null !== l.current && (0, r.enableBodyScroll)(l.current);
                }
              );
          }, []),
          n.createElement('div', { ref: l, ...a }, o)
        );
      });
      function i(e) {
        return t => {
    ...
    993135: (e, t, o) => {
      ...
      function w(e) {
        ...
        const o = t.map(t => {
          ...
          return (
            ...
            n.createElement(
              'div',
              { key: h.get(t), className: d(f.popupWidget, f[p], e.isMobile && f.mobile) },
              ...
              n.createElement(
                ...
                n.createElement(
                  'span',
                  { style: { color: r || void 0 }, className: d(f.title, f[p]) },
                  o,
                ),
                l &&
                  n.createElement(
                ...
                i &&
                  n.createElement(
                    'span',
                    {
                      className: d(i.tooltip && 'apply-common-tooltip', f.action, f[p]),
                      onClick: () => {
                        e.onClose(), null == i || i.onClick();
                      },
                      title: i.tooltip,
                    },
                    i.text,
      ...
      const E = new WeakMap();
      function y(e) {
        const { statusWidgetInfos: t, matchMediaRule: o = 'screen and (min-width: 431px)' } = e;
        return n.createElement(
          i.DrawerManager,
          null,
          n.createElement(s.MatchMedia, { rule: o }, o =>
            o
              ? n.createElement(
                  ...
                  n.createElement(b, { widgetInfo: t, onClose: e.onClose, isMobile: !o }),
                )
              : n.createElement(
                  l.Drawer,
      ...
      function C(e) {
        ...
        t ? r.render(n.createElement(y, { ...a }), o) : r.unmountComponentAtNode(o);
      }
    },
  },
]);
