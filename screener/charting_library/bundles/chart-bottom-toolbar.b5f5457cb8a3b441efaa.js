  ...
  [7260],
  {
      ...
      class c extends a.PureComponent {
        ...
        render() {
          ...
          return a.createElement(
            ...
            a.createElement('span', { className: i }),
            a.createElement('span', { className: i }),
            a.createElement('span', { className: i }),
          );
        }
    ...
    729624: (e, t, s) => {
      ...
      function p(e) {
        const {
          ...
          w = (0, r.useContext)(l.EmptyIconsContext),
          A = !!k.length;
        return a
          ? r.createElement(
              'li',
          ...
          : r.createElement(
              ...
              r.createElement('span', { className: n()(m.label) }, null != M ? M : C),
              !!T &&
                r.createElement(i.Icon, {
                  onClick: function () {
                    T && T.action();
              ...
              !A && S && r.createElement(c.Hint, { className: m.shortcut, text: S }),
              A && r.createElement(i.Icon, { className: m.nested, icon: h }),
              E,
            );
      }
    },
    ...
    494707: (e, t, s) => {
      ...
      var r = s(50959),
        ...
        n = s(345719);
      function i(e) {
        return r.createElement('div', { className: a(n.separator, e.className) });
      }
    },
    917850: (e, t, s) => {
      'use strict';
    ...
    163915: (e, t, s) => {
      ...
      var r = s(50959),
        ...
        n = s(144242);
      function i(e) {
        return r.createElement('div', { className: a(e.className, n.title) }, e.children);
      }
    },
    501836: (e, t, s) => {
      'use strict';
    ...
    622614: (e, t, s) => {
      ...
      const h = (0, r.forwardRef)(function (e, t) {
        const { onKeyDown: s, orientation: h, ...u } = e,
          m = o.PLATFORM_ACCESSIBILITY_ENABLED ? { role: 'toolbar', 'aria-orientation': h } : {},
          p = (0, c.useFunctionalRefObject)(t);
        return (
          (0, r.useLayoutEffect)(() => {
            if (!o.PLATFORM_ACCESSIBILITY_ENABLED) return;
            const e = (0, a.ensureNotNull)(p.current),
              t = () => {
    ...
    452015: (e, t, s) => {
      'use strict';
      s.r(t), s.d(t, { BottomToolbarRenderer: () => ft });
      var r = s(50959),
        a = s(500962),
        n = s(509806),
        i = s(719036),
        ...
        f = s(628589);
      const S = e =>
          n.t(null, { plural: '{str} minutes', count: e, replace: { str: `${e}` } }, s(860144)),
        k = e =>
          n.t(null, { plural: '{str} hours', count: e, replace: { str: `${e}` } }, s(217174)),
        C = e =>
          n.t(null, { plural: '{str} months', count: e, replace: { str: `${e}` } }, s(128039)),
        x = {
          ...
          '1D': {
            ...
            text:
              ((M = 1),
              n.t(null, { plural: '{str} days', count: M, replace: { str: `${M}` } }, s(774262))),
          },
          '1W': {
            resolution: '1W',
            text:
              ((T = 1),
              n.t(null, { plural: '{str} weeks', count: T, replace: { str: `${T}` } }, s(14074))),
          },
          '1M': { resolution: '1M', text: C(1) },
          '3M': { resolution: '3M', text: C(3) },
          '6M': { resolution: '6M', text: C(6) },
          '12M': {
            resolution: '12M',
            text:
              ((E = 1),
              n.t(null, { plural: '{str} years', count: E, replace: { str: `${E}` } }, s(408222))),
          },
        };
      var E, T, M;
      function z(e) {
        const t = (function (e) {
            ...
            if (!r.isValid()) {
              if ('YTD' === t) return n.t(null, { context: 'timeframe_title' }, s(987556));
              if ('ALL' === t) return n.t(null, { context: 'timeframe_title' }, s(574944));
              if ('LASTSESSION' === t) return w(1);
            }
            if (r.isMinutes()) {
            ...
            var a;
            var i;
            if (r.isDays()) return w(r.multiplier());
            if (r.isWeeks())
              return (e =>
                n.t(
                  null,
        ...
        return n.t(
          null,
          { replace: { timePeriod: t, timeInterval: r }, context: 'timeframe_title' },
          s(829505),
        );
      }
      const w = e =>
        n.t(
          null,
          { plural: '{str} days', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
          s(942908),
        );
      class A {
        constructor(e) {
        ...
        _updateAvailableRanges() {
          ...
          const s = t.model().mainSeries(),
            r = s.status();
          if (2 === r || 1 === r) return;
          const a = e(s.symbolInfo(), s.status()).map(e => ({ ...e, description: z(e) }));
            ...
            constructor(e, t) {
              super(e, t),
                ...
                (this._handleSelectRange = e => {
                  var t, s;
                  (0, _.trackEvent)('GUI', 'Chart Bottom Toolbar', `range ${e.value}`),
                ...
                L.has(t.chartWidget) || L.set(t.chartWidget, new A(t));
              const s = (this._binding = (0, v.ensureDefined)(L.get(t.chartWidget)));
              this.state = s.state();
            }
            componentDidMount() {
      ...
      function H(e) {
        ...
        return r.createElement(
          ...
          null,
          t.map(e =>
            r.createElement(B.ContextMenuItem, {
              key: e.value.value,
      ...
      function U(e) {
        ...
        return r.createElement(
          r.Fragment,
          null,
          r.createElement(j.Separator, { className: P.separator }),
          r.createElement(B.ContextMenuItem, {
            icon: R,
            label: (0, N.appendEllipsis)(n.t(null, void 0, s(369))),
            onClick: t,
            active: !1,
            checked: !1,
            checkable: !1,
      ...
      const F = {
          title: n.t(null, void 0, s(660222)),
          goToDate: (0, N.appendEllipsis)(n.t(null, void 0, s(369))),
        },
      ...
      class Y extends r.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (this._renderChildren = e => {
              const { ranges: t, activeRange: s, goToDateButton: a } = this.props;
              return e
                ? r.createElement(
                    r.Fragment,
                    null,
                    ...
                    a && r.createElement(U, { onGoToDateClick: this._handleGoToDateClick }),
                  )
                : r.createElement(
                    r.Fragment,
                    null,
        ...
        render() {
          return r.createElement(m.MatchMedia, { rule: 'screen and (max-width: 430px)' }, e =>
            r.createElement(
              d.ToolbarMenuButton,
              {
      ...
      function V(e) {
        return class extends r.PureComponent {
          ...
          componentDidUpdate() {
            ((0, v.ensureNotNull)(this._slider).style.transition = 'transform 350ms'),
      ...
      V(function (e) {
        return r.createElement('div', { className: X.slider, ref: e.reference });
      });
      var q = s(493173),
        Z = s(501836),
        $ = s(791348);
        ...
        constructor(e, t) {
          super(e, t),
            (this._timeFormatter = new pe.TimeFormatter(
              (0, _e.getHourMinuteSecondFormat)(be.timeHoursFormatProperty.value()),
            )),
            ...
            (this._showMenu = () => {
              if (this._preventShowingMenu) return void ye.ContextMenuManager.hideAll();
          ...
          (this._tickInterval = setInterval(this._tickClock, 1e3)),
            e.withModel(null, () => {
              ...
              t
                ...
                be.timeHoursFormatProperty.subscribe(this, this._timeHoursFormatPropertyChanged);
            });
        }
        componentWillUnmount() {
          const { chartWidget: e } = this.context;
          clearInterval(this._tickInterval),
            e.withModel(null, () => {
              ...
              t
                ...
                be.timeHoursFormatProperty.unsubscribe(this, this._timeHoursFormatPropertyChanged);
            });
        }
        render() {
          ...
          return r.createElement(Z.ToolbarButton, {
            ...
            tooltip: t ? n.t(null, void 0, s(587492)) : void 0,
            className: e,
            text: a && i && `${a} (${i})`,
          });
        }
      ...
      var xe = s(856812);
      function Ee(e) {
        return r.createElement('span', { className: o(xe.separator, e.className) });
      }
      var Te = s(622614),
        Me = s(664902),
        ze = s(601227);
      ...
      const Ae = (0, b.registryContextType)(),
        De = new Me.TranslatedString('toggle log scale', n.t(null, void 0, s(160166)));
      const Ie = (0, b.registryContextType)(),
        Le = new Me.TranslatedString('toggle auto scale', n.t(null, void 0, s(863060)));
      const We = (0, b.registryContextType)(),
        Be = new Me.TranslatedString('toggle percentage scale', n.t(null, void 0, s(568642)));
      const je = (0, b.registryContextType)();
      var Ne = s(670086),
        Re = s(199663),
        Pe = s(163915),
        He = s(471453),
        Ue = s(97086);
      const Fe = new Me.TranslatedString('change session', n.t(null, void 0, s(765303))),
        Oe = { hint: n.t(null, void 0, s(25866)), headerMenuText: n.t(null, void 0, s(644794)) },
        Ye = (0, b.registryContextType)();
      ...
      class $e extends r.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleClick = () => {
              ...
              t.setViewMode(Xe.CollectionViewMode.Multichart), e.exitFullscreen();
            }),
            (0, b.validateRegistry)(t, {
              chartWidgetCollection: i.any.isRequired,
        ...
        render() {
          ...
          return r.createElement(Ve.ToolWidgetButton, {
            icon: qe,
            className: e,
            onClick: this._handleClick,
          });
      ...
      var Ke = s(821868),
        ...
        tt = s(264264);
      const st = {
          extLabel: n.t(null, void 0, s(208877)),
          extHint: n.t(null, void 0, s(441421)),
          percentageHint: n.t(null, void 0, s(843737)),
          logLabel: n.t(null, { context: 'scale' }, s(700885)),
          logHint: n.t(null, void 0, s(21329)),
          autoLabel: n.t(null, { context: 'scale' }, s(399247)),
          autoHint: n.t(null, void 0, s(860879)),
          fullscreenHint: n.t(null, void 0, s(98948)),
          adjLabel: n.t(null, { context: 'adjustments' }, s(125988)),
          adjHint: n.t(null, void 0, s(909994)),
          adjForDividendsOnlyHint: n.t(null, void 0, s(601217)),
          adjForSplitsOnlyHint: n.t(null, void 0, s(418540)),
          backAdjustLabel: n.t(null, { context: 'adjustments' }, s(224717)),
          backAdjustHint: n.t(null, void 0, s(710989)),
          settlementAsCloseLabel: n.t(null, { context: 'adjustments' }, s(411987)),
          settlementAsCloseHint: n.t(null, void 0, s(999983)),
        },
        rt =
          ((at = e =>
            r.createElement(Z.ToolbarButton, {
              ...
              onClick: pt(e.onClick, 'log', e.isLogarithm),
              onMouseEnter: e.onMouseEnter,
              onMouseLeave: e.onMouseLeave,
              'data-name': 'logarithm',
            })),
          ((nt = class extends r.PureComponent {
            constructor(e, t) {
              super(e, t),
                ...
                (this._handleSelect = () => {
                  const e = this.context.chartWidget.model(),
                    ...
                    s = t.priceScale(),
                    r = s.mode();
                  t.priceScale().isLockScale() || e.setPriceScaleMode({ log: !r.log }, s, De);
                }),
                (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired }),
                (this.state = { isActive: !1, series: null }),
                (this._priceAxisHighlighter = new we(
      ...
      const it = (function (e) {
                ...
                super(e, t),
                  ...
                  (this._handleSelect = () => {
                    const e = this.context.chartWidget.model(),
                      ...
                      s = t.mode();
                    e.setPriceScaleMode({ autoScale: !s.autoScale }, t, Le);
                  }),
                  (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new we(
          ...
          r.createElement(Z.ToolbarButton, {
            ...
            onClick: pt(e.onClick, 'auto', e.isAuto),
            onMouseEnter: e.onMouseEnter,
            onMouseLeave: e.onMouseLeave,
            'data-name': 'auto',
          }),
        ...
        ot = (function (e) {
                ...
                super(e, t),
                  ...
                  (this._handleSelect = () => {
                    ...
                    t.priceScale().isLockScale() ||
                      e.setPriceScaleMode({ percentage: !r.percentage }, s, Be);
                  }),
                  (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new we(
          ...
          r.createElement(Z.ToolbarButton, {
            icon: Ke,
            tooltip: st.percentageHint,
            className: e.className,
            isActive: e.isPercentage,
            'aria-pressed': e.isPercentage,
            isDisabled: e.isDisabled,
            onClick: pt(e.onClick, 'percent', e.isPercentage),
            onMouseEnter: e.onMouseEnter,
            onMouseLeave: e.onMouseLeave,
            'data-name': 'percentage',
          }),
        );
      const lt = (0, ae.hotKeySerialize)({
        ...
        ct = (function (e) {
          ...
          r.createElement(Z.ToolbarButton, {
            icon: e.isFullscreen ? et : Qe,
            tooltip: st.fullscreenHint,
            className: e.className,
            isActive: e.isFullscreen,
            onClick: pt(e.onClick, 'maximize chart', e.isFullscreen),
            'data-tooltip-hotkey': lt,
            'data-name': 'fullscreen',
          }),
        ),
        dt = { fullscreen: !0, preventPhoneLayout: !0 },
        ht = {
      ...
      const gt = {
        ...
        vt = (0, b.registryContextType)();
      class _t extends r.PureComponent {
        constructor(e, t) {
          var s, n;
          super(e, t),
            (this._timezoneButtonRef = null),
            (this._layout = Object.assign({}, gt)),
            (this._raf = null),
            (this._toolbar = null),
              ...
              (e, t, a) => {
                if (r.isValidElement(e) && 'string' != typeof e.type) {
                  ...
                  if ('string' == typeof i.className) {
                    const l = { className: o(i.className, t === a.length - 1 && tt.last) },
                      c = s(),
                      d = (0, v.ensureDefined)(ut.get(e.type));
                    return r.createElement(
                      'div',
                      {
                        key: null === e.key ? void 0 : e.key,
                        className: o(tt.inline, c[d] && tt.collapsed),
                        ref: e => n(e, d),
                        onClick: () => mt(),
                      },
                      r.cloneElement(e, l),
            ...
            (this._updateButtonsVisibility = () => {
              ...
              if (s.symbolResolvingActive().value())
                return void this._setStateWithResize({ intervalAllowsSessionButton: a });
              const n =
                ((null == r ? void 0 : r.subsessions) || []).filter(e => !e.private).length > 1;
              ...
              null === this._raf &&
                (this._raf = requestAnimationFrame(() => {
                  ...
                  if ((Object.assign(e, { dateRangeMode: c }), 'expanded' !== c)) {
                    const t = i - (0, v.ensureNotNull)(this._rangeCollapsed).offsetWidth - 0;
                    let s = 0,
                      a = 0;
                    for (const n of r)
                      (s += n.width),
        ...
        componentDidMount() {
          ...
          e.subscribe(this, this._handleResize),
            Ge.mediaState.on('changeDevice', this._handlePreventPhoneLayoutButtonVisibility),
            s.viewMode.subscribe(this._handlePreventPhoneLayoutButtonVisibility),
        ...
        componentWillUnmount() {
          ...
          t.unsubscribe(this, this._handleResize),
            Ge.mediaState.off('changeDevice', this._handlePreventPhoneLayoutButtonVisibility),
            r.viewMode.unsubscribe(this._handlePreventPhoneLayoutButtonVisibility),
        ...
        render() {
          ...
          return r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  'div',
                  {
                    className: o(
                      tt.dateRangeWrapper,
                      'collapsed' !== e.dateRangeMode && tt.collapsed,
                    ),
                    ref: this._handleRangeCollapsedRef,
                  },
                  r.createElement(
                    'div',
                    { className: o(tt.dateRangeCollapsed) },
                    r.createElement(J, {
                      goToDateButton: this.props.goToDateEnabled,
                      className: tt.dateRange,
                    }),
                  ),
                ),
                r.createElement(
                  'div',
                  {
                    className: o(
                      tt.dateRangeWrapper,
                      'expanded' !== e.dateRangeMode && tt.collapsed,
                    ),
                    ref: this._handleRangeExpandedRef,
                  },
                  r.createElement(
                    'div',
                    { className: o(tt.dateRangeExpanded) },
                    r.createElement(re, {
            ...
            r.createElement(
              'div',
              { className: tt.seriesControlWrapper },
              s &&
                r.createElement(
                  'div',
                  {
                    className: o(tt.inline, e.timeZones && tt.collapsed),
                    ref: this._handleTimeZonesRef,
                  },
                  r.createElement(
                    'div',
                    { className: tt.inline, onClick: this._trackTimezonesButtonClick },
                    r.createElement(Ce, {
                      className: tt.item,
              ...
              this.props.sessionIdButtonEnabled &&
                ...
                r.createElement(
                  'div',
                  {
                    className: o(tt.inline, e.session && tt.collapsed),
              ...
              r.createElement(
                'div',
                {
                  ...
                  className: o(tt.inline, e.separator && tt.collapsed),
                },
              ...
              r.createElement(
                ...
                a &&
                  ...
                  r.createElement(ot, { className: tt.item }),
                n && r.createElement(rt, { className: tt.item }),
                i && r.createElement(it, { className: tt.item }),
                l &&
                ...
                this.props.fullscreenButtonEnabled &&
                  ...
                  r.createElement($e, { className: tt.item }),
              ),
            ),
          );
        }
        ...
        _applyResizing() {
          ...
          this._rangeExpanded &&
            this._rangeExpanded.classList.toggle(tt.collapsed, 'expanded' !== e),
            this._rangeCollapsed &&
              this._rangeCollapsed.classList.toggle(tt.collapsed, 'collapsed' !== e);
          let s = !1,
            r = !1;
          Object.keys(t).forEach(e => {
            ...
            if ('separator' !== a) {
              const e = this._seriesComponents[a],
                n = !0 === t[a];
              e &&
                ('timeZones' === a || 'session' === a ? (s = s || !n) : (r = r || !n),
                e.classList.toggle(tt.collapsed, n));
            }
          });
          const a = this._seriesComponents.separator;
          if (a) {
            const e = !s || !r || !0 === t.separator;
            a.classList.toggle(tt.collapsed, e);
          }
        }
        _isPreventPhoneLayoutButton() {
          {
            const { chartWidgetCollection: e, resizerDetacher: t } = this.context;
            return (
              t.fullscreenable.value() &&
              ze.CheckMobile.any() &&
              Ge.mediaState.isPhoneSizeDevice() &&
              e.viewMode.value() === Xe.CollectionViewMode.ForceFullscreen
            );
          }
        }
      }
      ...
      class yt extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            b.RegistryProvider,
            { validation: bt, value: this._registry },
            r.createElement(_t, { key: e.id(), ...s }),
          );
        }
        _defineRegistry(e) {
          const {
    ...
    21212: e => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" width="18" height="18"><path fill="currentColor" d="M11 2v2.5A2.5 2.5 0 0 0 13.5 7H16V6h-2.5A1.5 1.5 0 0 1 12 4.5V2h-1zm2.5 9a2.5 2.5 0 0 0-2.5 2.5V16h1v-2.5c0-.83.67-1.5 1.5-1.5H16v-1h-2.5zm-9 1H2v-1h2.5A2.5 2.5 0 0 1 7 13.5V16H6v-2.5c0-.83-.67-1.5-1.5-1.5zM7 4.5V2H6v2.5C6 5.33 5.33 6 4.5 6H2v1h2.5A2.5 2.5 0 0 0 7 4.5z"/></svg>';
    },
    339750: e => {
      e.exports =
