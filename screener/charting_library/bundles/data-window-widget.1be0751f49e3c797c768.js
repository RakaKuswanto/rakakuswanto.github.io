(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1205],
  {
    ...
    656658: e => {
      e.exports = { container: 'container-UNtFS6lU', divider: 'divider-UNtFS6lU' };
    },
    982434: e => {
        ...
        return r.createElement(
          ...
          g &&
            r.createElement(
              'div',
              { className: y.header },
              h && r.createElement(w.Icon, { className: y.headerIcon, icon: h }),
              r.createElement(
                'span',
                {
              ...
              c &&
                r.createElement(E.ListItemButton, {
                  ...
                  title: s ? l.t(null, void 0, n(526705)) : l.t(null, void 0, n(817582)),
                }),
            ),
          s &&
            S.length > 0 &&
            r.createElement(
              'div',
              { className: y.values },
              S.map((e, t) => r.createElement(H, { key: t, item: e, theme: m })),
            ),
        );
      }
      function H(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            'div',
            null,
            r.createElement('span', { style: { color: o && W(o, a) ? o : void 0 } }, t.value()),
          ),
        );
      }
      function W(e, t) {
      ...
      function j(e) {
          ...
          (0, r.useEffect)(() => {
            function e(e) {
              ...
              const o =
                ...
                l = null === (n = E.current) || void 0 === n ? void 0 : n.getBoundingClientRect();
              o &&
                l &&
                a &&
                ...
                return (
                  e instanceof s.SeriesDataWindowView
                    ...
                    : (e instanceof c.StudyDataWindowView ||
                      ...
                      ((p = e.study()), (f = (0, L.isStudyStrategy)(p) ? V : x)),
                  r.createElement(
                    r.Fragment,
                    { key: a },
                    0 !== a && r.createElement('div', { className: B.divider }),
                    p
                      ? r.createElement(T, {
                          'data-id': p.id(),
                          view: e,
                              ...
                              t.model().setProperty(
                                ...
                                (o
                                  ? new d.TranslatedString(
                                      'show {title}',
                                      l.t(null, void 0, n(787358)),
                                    )
                                  : new d.TranslatedString(
                                      'hide {title}',
                                      l.t(null, void 0, n(470301)),
                                    )
                                ).format({
                                  title: new d.TranslatedString(
                                    e.name(),
                                    e.title(i.TitleDisplayTarget.DataWindow),
                                  ),
                                }),
                              );
                            })((0, o.ensureDefined)(p)),
                            ...
                            (function (e, n) {
                              ...
                              D(n),
                                n instanceof v.Series
                                  ? (function (e, n) {
                                      const r = t.actions(),
                                        a = n.properties().visible.value(),
                                        l = a ? void 0 : M(n);
                                      m.ContextMenuManager.showMenu(
                                        [r.format, a ? r.seriesHide : (0, o.ensureDefined)(l)],
                                        e,
                                        void 0,
                                        {
                                          menuName: 'DataWindowWidgetSeriesContextMenu',
                                          detail: { type: 'series', id: n.instanceId() },
                                        },
                                        () => {
                                          var e;
                                          null === (e = null == l ? void 0 : l.getBinding()) ||
                                            void 0 === e ||
                                            e.destroy();
                                        },
                                      );
                                  ...
                                  : n instanceof h.Study &&
                                    (function (e, n) {
                                      ...
                                      m.ContextMenuManager.showMenu(
                                        [
                                          r.format,
                                          a ? r.studyHide : (0, o.ensureDefined)(l),
                                          r.studyRemove,
                                        ],
                                        e,
                                        void 0,
        ...
        function M(e) {
          const r = new p.Action({
            ...
            label: l.t(null, void 0, n(581428)),
            icon: k,
            checkable: !0,
          });
          return (
            r.setBinding(
              new f.ActionBinder(
                ...
                t.model(),
                new d.TranslatedString('change visibility', l.t(null, void 0, n(521511))),
              ),
            ),
    ...
    73288: (e, t, n) => {
      ...
      function v(e) {
        ...
        (0, r.useEffect)(() => {
          const e = (0, i.ensureNotNull)(b.current).ownerDocument;
          return (
            S
              ? (p && p(),
                e && (e.addEventListener('mousemove', B), e.addEventListener('mouseup', j)))
              : f && f(),
            () => {
              e && (e.removeEventListener('mousemove', B), e.removeEventListener('mouseup', j));
            }
          );
        }, [S]);
        const H = t / n || 0,
          ...
          x = C ? -k : 0,
          V = C ? 0 : k,
          I = Y((0, s.clamp)(l, x, V)) || 0;
        return r.createElement(
          'div',
          {
            ref: b,
            className: a()(m.wrap, E && m['wrap--horizontal']),
            style: { [D]: t },
            onMouseDown: function (e) {
              if (e.isDefaultPrevented()) return;
              e.preventDefault();
              const t = R(e.nativeEvent, (0, i.ensureNotNull)(b.current)),
                n = Math.sign(t),
                r = (0, i.ensureNotNull)(w.current).getBoundingClientRect();
              z.current = (n * r[D]) / 2;
              let o = Math.abs(t) - Math.abs(z.current);
              const a = Y(k);
              o < 0 ? ((o = 0), (z.current = t)) : o > a && ((o = a), (z.current = t - n * a));
              v(O(n * o)), N(!0);
            },
          },
          r.createElement(
            ...
            {
              ref: w,
              className: a()(m.bar, E && m['bar--horizontal']),
              style: { [M]: g, [D]: _, transform: `${T}(${I}px)` },
              onMouseDown: function (e) {
                e.preventDefault(),
                  (z.current = R(e.nativeEvent, (0, i.ensureNotNull)(w.current))),
                  N(!0);
              },
            },
            r.createElement('div', { className: a()(m.barInner, E && m['barInner--horizontal']) }),
          ),
        );
        function B(e) {
          const t = R(e, (0, i.ensureNotNull)(b.current)) - z.current;
          v(O(t));
        }
        function j() {
          N(!1);
    ...
    109955: (e, t, n) => {
      ...
      function c(e) {
        const {
          ...
          [v, h, m, p] = (0, i.useOverlayScroll)(u, c);
        return (
          (0, r.useImperativeHandle)(o, () => ({ updateScrollState: p })),
          r.createElement(
            'div',
            { ...d, ...h, className: a()(s.container, n) },
            r.createElement(l.OverlayScrollContainer, { ...v, className: s.overlayScrollWrap }),
            r.createElement(
              'div',
              {
                className: s.wrapper,
    ...
    139043: (e, t, n) => {
      ...
      function s(e, t = l.CheckMobile.any()) {
        const n = (0, r.useRef)(null),
          ...
          [d, v] = (0, r.useState)({
            ...
            onVerticalChange: function (e) {
              v(t => ({ ...t, scrollPosTop: e })), ((0, o.ensureNotNull)(s.current).scrollTop = e);
            },
