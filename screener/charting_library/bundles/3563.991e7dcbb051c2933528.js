  ...
  [3563],
  {
    ...
    759339: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        u = n(966076);
      function v(e) {
        const { position: t = 'Bottom', onClose: n, children: m, className: v, theme: h = u } = e,
    ...
    611005: (e, t, n) => {
      ...
      const M = [
        {
          title: o.t(null, { context: 'emoji_group' }, n(415426)),
          emojis: [],
          content: r.createElement(a.IconItem, { icon: i }),
        },
        {
          title: o.t(null, { context: 'emoji_group' }, n(396330)),
          emojis: p,
          content: r.createElement(a.IconItem, { icon: c }),
        },
        {
          title: o.t(null, { context: 'emoji_group' }, n(360558)),
          emojis: f,
          content: r.createElement(a.IconItem, { icon: l }),
        },
        {
          title: o.t(null, { context: 'emoji_group' }, n(935305)),
          emojis: E,
          content: r.createElement(a.IconItem, { icon: s }),
        },
        {
          title: o.t(null, { context: 'emoji_group' }, n(414232)),
          emojis: w,
          content: r.createElement(a.IconItem, { icon: m }),
        },
        {
          title: o.t(null, { context: 'emoji_group' }, n(715395)),
          emojis: g,
          content: r.createElement(a.IconItem, { icon: u }),
        },
        {
          title: o.t(null, { context: 'emoji_group' }, n(572302)),
          emojis: b,
          content: r.createElement(a.IconItem, { icon: v }),
        },
        {
          title: o.t(null, { context: 'emoji_group' }, n(906878)),
          emojis: C,
          content: r.createElement(a.IconItem, { icon: d }),
        },
        {
          title: o.t(null, { context: 'emoji_group' }, n(149546)),
          emojis: z,
    ...
    168233: (e, t, n) => {
      ...
      function d(e) {
        ...
        const p = (0, r.useCallback)(e => ('title' === a[e].type ? 30 : i), [a, i]),
          f = (0, r.useCallback)(
            ({ visibleStartIndex: e }) => {
        ...
        return r.createElement(
          ...
          {
            value: (0, r.useMemo)(
              () => ({ size: i, onSelect: c, ItemComponent: s, RowComponent: m }),
              [i, c, s, m],
            ),
          },
      ...
      const h = r.memo(e => {
        ...
        return 'title' === a.type
          ? r.createElement('div', { style: t }, r.createElement(l, { title: a.relatedTitle }))
          : r.createElement(
              'div',
              { style: t },
              r.createElement(d, {
    ...
    499547: (e, t, n) => {
      ...
      function E(e) {
                ...
                return (
                  e.forEach(({ title: e, emojis: r }) => {
                    ...
                    for (const a of r)
                      o.length < t
                        ? o.push(a)
                        : (n.push({ type: 'emojiRow', relatedTitle: e, content: o }), (o = [a]));
        ...
        (0, r.useEffect)(() => {
          ...
          (0, r.useLayoutEffect)(() => {
            ...
            const e = (0, i.ensureNotNull)(L.current),
              t = () => {
                const t = (0, u.queryTabbableElements)(e).sort(u.navigationOrderComparator);
                if (
                  0 === t.length ||
                  (t[0].parentElement && !b(t[0].parentElement, (0, i.ensureNotNull)(L.current)))
                ) {
                  const n = (function (e) {
                    const t = g(e)
        ...
        return r.createElement(
          ...
          r.createElement(l.GroupTabs, {
            ...
            onTabClick: function (e) {
              ...
              D(
                (function (e) {
                  return j.findIndex(({ relatedTitle: t, type: n }) => 'title' === n && t === e);
                })(e),
              );
            },
          }),
            ...
            'div',
            {
              ...
              onKeyDown: function (e) {
                ...
                const r = e.currentTarget,
                  o = ((a = r),
                  Array.from(a.querySelectorAll('button:not([disabled], [aria-disabled])')).filter(
                    (0, u.createScopedVisibleElementFilter)(a),
                  )).sort(u.navigationOrderComparator);
                var a;
                ...
                const c = t => {
                  ...
                  if (!o) return;
                  const a = Array.from(o.children).indexOf(document.activeElement);
                  if (-1 === a) return;
                  const i = n['down' === t ? n.indexOf(o) + 1 : n.indexOf(o) - 1];
                  if (!i) return;
        ...
        function D(e) {
          var t;
          m.CheckMobile.iOS() && L.current && (L.current.style.overflow = 'hidden'),
            (N.current = !0),
            null === (t = y.current) || void 0 === t || t.scrollToItem(e, 'start'),
            requestAnimationFrame(() => {
              var t;
              null === (t = y.current) || void 0 === t || t.scrollToItem(e, 'start'),
                m.CheckMobile.iOS() && L.current && (L.current.style.overflow = 'auto'),
                (N.current = !1);
            });
        }
      }
      ...
      function C(e) {
        document.activeElement && (0, d.becomeSecondaryElement)(document.activeElement),
    ...
    723407: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        c = n(911123);
      const l = r.memo(e => {
        const { emojis: t, itemSize: n, onEmojiClick: o, ItemComponent: l, className: s } = e;
        return r.createElement(
          'div',
    ...
    65559: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        s = n(117373);
      function m(e) {
        const { tab: t, isActive: n, onTabClick: o, children: i, className: m } = e,
      ...
      var u = n(712134);
      function v(e) {
        const { activeTab: t, tabs: n, onTabClick: o, className: c, tabClassName: l } = e;
        return r.createElement(
          i.Toolbar,
          ...
          n.map(({ title: e, content: n }) =>
            r.createElement(
              m,
              { key: e, tab: e, className: l, isActive: t === e, onTabClick: o },
              n,
            ),
          ),
        );
    ...
    134640: (e, t, n) => {
      ...
      const v = 34;
      function d(e) {
        const { className: t, emoji: n, size: o = v, onClick: i, ItemComponent: c = l } = e,
        ...
        return s.PLATFORM_ACCESSIBILITY_ENABLED
          ...
          : r.createElement(
              'div',
              { className: a()(u.wrapper, t), style: { width: o, height: o }, onClick: p },
              r.createElement(c, { emoji: n }),
            );
        function p() {
          i(n);
    ...
    622614: (e, t, n) => {
      ...
      const u = (0, r.forwardRef)(function (e, t) {
        const { onKeyDown: n, orientation: u, ...v } = e,
          d = c.PLATFORM_ACCESSIBILITY_ENABLED ? { role: 'toolbar', 'aria-orientation': u } : {},
        ...
        return (
          (0, r.useLayoutEffect)(() => {
            ...
            const e = (0, o.ensureNotNull)(h.current),
              t = () => {
                const t = (0, c.queryTabbableElements)(e).sort(c.navigationOrderComparator);
                if (0 === t.length) {
          ...
          r.createElement('div', {
            ...
            onKeyDown: (0, a.createSafeMulticastEventHandler)(function (e) {
              ...
              const n = e.currentTarget,
                r = (0, c.queryFocusableElements)(n).sort(c.navigationOrderComparator);
              ...
              const a = () => {
                  ...
                  (0, l.becomeSecondaryElement)(r[o]), (0, l.becomeMainElement)(r[e]), r[e].focus();
                },
                s = () => {
                  const e = (o + r.length + 1) % r.length;
                  (0, l.becomeSecondaryElement)(r[o]), (0, l.becomeMainElement)(r[e]), r[e].focus();
